...
# optional - assign the PC to this Location - take the location_id from Open-AudIT interface
location_id=''

# optional - assign the PC to this Org - take the org_id from Open-AudIT interface
org_id=''
