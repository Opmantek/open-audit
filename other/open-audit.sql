...
INSERT INTO `discovery_scan_options` VALUES (1,'UltraFast',1,'Approximately 1 second per target. Scan only the ports that Open-AudIT needs to use to talk to the device and detect an IOS device (WMI, SSH, SNMP, Apple Sync). An open|filtered port is considered closed. Device must respond to an Nmap ping. Use aggressive timing.','y','n','y','n',0,0,0,0,0,4,0,0,'22,135,62078','161','','','','22','','n',0,'','system','2000-01-01 00:00:00');
...
INSERT INTO `widgets` VALUES (55,'Windows 2025 Server Latest Build',1,'','traffic','','85','','84','LATEST BUILD SERVER 2025','Without / With the latest Windows 2025','fa-brands fa-windows',0,'','','','system','2001-01-01 00:00:00');
