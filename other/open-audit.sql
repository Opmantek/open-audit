...
INSERT INTO standards_policies VALUES (null, 'ISO 27001', 'Organizational controls', '5.2', 'Review of the policies for information security ', 'Infromation security roles and responsibilities shall be defined and allocated according to the organization needs.', 'system', NOW());
...
INSERT INTO standards_policies VALUES (null, 'ISO 27001', 'Organizational controls', '5.13', 'Labelling of infromation', 'An appropriate set of procedures for information labelling shall be developea and Implemented in accordance wit the Information clas sification scheme adopted by the organization', 'system', NOW());
INSERT INTO standards_policies VALUES (null, 'ISO 27001', 'Organizational controls', '5.14', 'Infromation transfer', 'Information transfer rules, procedures, or agreements shall be in place for all types of transter facilities within the organization and between the organization and other parties', 'system', NOW());
...
INSERT INTO standards_policies VALUES (null, 'ISO 27001', 'Organizational controls', '5.20', 'Addressing infromation security within supplier agreements', 'Relevant information security requirements shall be established and agreed with each supplier based on the type of supplier relationship', 'system', NOW());
...
INSERT INTO standards_policies VALUES (null, 'ISO 27001', 'Organizational controls', '5.25', 'Assessment and decision on information security events', 'The organization shall assess information security events and decide if they are to be categorized as infromation security incidents.', 'system', NOW());
INSERT INTO standards_policies VALUES (null, 'ISO 27001', 'Organizational controls', '5.26', 'Response to information security incidents', 'Infromation security incidents shall be responded to in accordance with the documented procedures', 'system', NOW());
INSERT INTO standards_policies VALUES (null, 'ISO 27001', 'Organizational controls', '5.27', 'Learning from infromation security incidents', 'Knowledge gained from infromation security incidents shall be used to strangthen and improve the infromation security controls.', 'system', NOW());
...
INSERT INTO standards_policies VALUES (null, 'ISO 27001', 'Organizational controls', '5.29', 'Infromation security during disruption', 'The organization shall plan how to maintain infromation security at an appropriate level during disruption', 'system', NOW());
...
INSERT INTO standards_policies VALUES (null, 'ISO 27001', 'People controls', '6.5', 'Responsibilities after termination or change of employment', 'Infromation security responsibilities and duties that remain valid after termination or change of employment shall be defined, enforced and communicated to relevant personnel and other interested parties.', 'system', NOW());
...
INSERT INTO standards_policies VALUES (null, 'ISO 27001', 'Physical controls', '7.7', 'Clear desk and clear screen', 'Clear desk rules for papers and removable storage media and clear screen rules for infromation processing facilities shall be defined and appropriately enforced.', 'system', NOW());
