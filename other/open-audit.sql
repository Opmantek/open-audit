...
INSERT INTO `configuration` VALUES (NULL,'default_geocode','Uluru, Northern Territory, Australia','text','y','system','2000-01-01 00:00:00','When executing an Integration and the target system requires a GeoCode, use this if we cannot make one from the existing data.');
...
INSERT INTO `configuration` VALUES (NULL,'delete_noncurrent_arp','y','bool','y','system','2000-01-01 00:00:00','Should we delete non-current arp data.');
...
INSERT INTO `configuration` VALUES (NULL,'devices_default_sort','name','text','y','system','2000-01-01 00:00:00','The default sort on the Devices List page.');
...
INSERT INTO `configuration` VALUES (NULL,'feature_syslog_vulnerabilities','n','bool','y','system','2000-01-01 00:00:00','Should Open-AudIT create an entry in syslog if a device has a vulnerability detected.');
...
INSERT INTO `queries` VALUES (NULL,1,'NMIS','Device','y','NMIS Export query','SELECT devices.id AS `devices.id`, devices.name AS `devices.name`, devices.ip AS `devices.ip`, devices.hostname AS `devices.hostname`, devices.fqdn AS `devices.fqdn`, devices.dns_hostname AS `devices.dns_hostname`, devices.omk_uuid AS `devices.omk_uuid`, devices.nmis_name AS `devices.nmis_name`, devices.nmis_group AS `devices.nmis_group`, devices.nmis_role AS `devices.nmis_role`, devices.nmis_manage AS `devices.nmis_manage`, devices.nmis_business_service AS `devices.nmis_business_service`, devices.nmis_poller AS `devices.nmis_poller` FROM `devices` WHERE @filter AND devices.nmis_manage = \'y\'','','n','n','system','2000-01-01 00:00:00');
...
INSERT INTO `tasks` VALUES (null, 'Run All Vulnerabilities', 1, 'Execute all vulnerabilities for all Orgs and Devices.', 0, '', 'y', 'vulnerabilities_all', FLOOR(RAND()*(55-5)+5), FLOOR(RAND()*(5)+1), '*', '*', '*', 0, 0, '2000-01-01 00:00:00', '2000-01-01 00:00:00', '', '', 0, 'system', '2000-01-01 00:00:00');
...
INSERT INTO `widgets` VALUES (41,'Windows Clients Without AntiVirus',1,'Windows clients with no registered AntiVirus.','traffic','',(SELECT id FROM queries WHERE name = 'Windows Clients Without AntiVirus' LIMIT 1),'','','NO ANTIVIRUS','Windows 10 & 11','antivirus',0,'','','','system','2001-01-01 00:00:00');
INSERT INTO `widgets` VALUES (42,'Windows Clients Without Firewall',1,'Windows clients with no registered Firewall.','traffic','',(SELECT id FROM queries WHERE name = 'Windows Clients Without Firewall' LIMIT 1),'','','NO FIREWALL','Windows 10 & 11','firewall',0,'','','','system','2001-01-01 00:00:00');
INSERT INTO `widgets` VALUES (43,'Windows 11 Not Latest Build',1,'Windows 11 devices not running the latest available version from Microsoft.','traffic','',(SELECT id FROM queries WHERE name = 'Windows 11 Not Latest Build' LIMIT 1),'','','OLD VERSION','Not the latest Windows 11','windows',0,'','','devices?devices.os_family=Windows 11&properties=devices.id,devices.icon,devices.type,devices.os_group,devices.name,devices.domain,devices.ip,devices.os_family,devices.last_seen','system','2001-01-01 00:00:00');
INSERT INTO `widgets` VALUES (44,'Windows 10 Not Latest Build',1,'Windows 10 devices not running the latest available version from Microsoft.','traffic','',(SELECT id FROM queries WHERE name = 'Windows 10 Not Latest Build' LIMIT 1),'','','OLD VERSION','Not the latest Windows 10','windows',0,'','','devices?devices.os_family=Windows 10&properties=devices.id,devices.icon,devices.type,devices.os_group,devices.name,devices.domain,devices.ip,devices.os_family,devices.last_seen','system','2001-01-01 00:00:00');
INSERT INTO `widgets` VALUES (45,'Windows 2019 Server Not Latest Build',1,'Windows 2019 devices not running the latest available version from Microsoft.','traffic','',(SELECT id FROM queries WHERE name = 'Windows 2019 Not Latest Build' LIMIT 1),'','','OLD VERSION','Without the latest Windows 2019','windows',0,'','','devices?devices.os_family=Windows 2019&properties=devices.id,devices.icon,devices.type,devices.os_group,devices.name,devices.domain,devices.ip,devices.os_family,devices.last_seen','system','2001-01-01 00:00:00');
INSERT INTO `widgets` VALUES (46,'Windows 2022 Server Not Latest Build',1,'Windows 2022 devices not running the latest available version from Microsoft.','traffic','',(SELECT id FROM queries WHERE name = 'Windows 2022 Not Latest Build' LIMIT 1),'','','OLD VERSION','Without the latest Windows 2022','windows',0,'','','devices?devices.os_family=Windows 2022&properties=devices.id,devices.icon,devices.type,devices.os_group,devices.name,devices.domain,devices.ip,devices.os_family,devices.last_seen','system','2001-01-01 00:00:00');
INSERT INTO `widgets` VALUES (47,'Windows Server Without Firewall',1,'Windows servers with no detected Firewall.','traffic','',(SELECT id FROM queries WHERE name = 'Windows Servers Firewalls Not Installed' LIMIT 1),'','','NO FIREWALL','Windows Server','firewall',0,'','','','system','2001-01-01 00:00:00');
INSERT INTO `widgets` VALUES (48,'Windows Server Without AntiVirus',1,'Windows servers with no detected AntiVirus.','traffic','',(SELECT id FROM queries WHERE name = 'Windows Servers AntiVirus Not Installed' LIMIT 1),'','','NO ANTIVIRUS','Windows Server','antivirus',0,'','','','system','2001-01-01 00:00:00');
INSERT INTO `widgets` VALUES (49,'Software',1,'','traffic','','57','59','58','SOFTWARE','Banned / Ignored / Approved','software',0,'','','','system','2001-01-01 00:00:00');
INSERT INTO `widgets` VALUES (50,'Windows Client Devices Without OS Updates',1,'','traffic','','81','','','CLIENT OS UPDATES','Windows 10 & 11, Last Checked For Updates > 2 weeks','update',0,'','','','system','2001-01-01 00:00:00');
INSERT INTO `widgets` VALUES (51,'Devices Not Seen for 30 / 7 / Less than 7 Days',1,'','traffic','','63','62','61','DEVICES NOT SEEN','Not Seen for 30 / 7 / Less than 7 Days','discoveries',0,'','','','system','2001-01-01 00:00:00');
INSERT INTO `widgets` VALUES (52,'Open Windows Shares',1,'','traffic','','80','','','OPEN SHARES','Anyone can write here','folder',0,'','','','system','2001-01-01 00:00:00');
INSERT INTO `widgets` VALUES (53,'Windows Server Devices Without OS Updates',1,'','traffic','','82','','','SERVER OS UPDATES','Windows 2019 & 2022, Last Checked For Updates > 2 weeks','update',0,'','','','system','2001-01-01 00:00:00');
INSERT INTO `widgets` VALUES (54,'Windows Devices Not Seen',1,'','traffic','','66','65','64','WINDOWS DEVICES NOT SEEN','Not Seen for 30+, 7+ and less than 7 Days','discovery',0,'','','','system','2001-01-01 00:00:00');
INSERT INTO `widgets` VALUES (55,'Windows 2025 Server Not Latest Build',1,'Windows 2025 devices not running the latest available version from Microsoft.','traffic','',(SELECT id FROM queries WHERE name = 'Windows 2025 Not Latest Build' LIMIT 1),'','','OLD VERSION','Without the latest Windows 2025','windows',0,'','','','system','2001-01-01 00:00:00');
INSERT INTO `widgets` VALUES (56,'Top 10 Vulnerable Devices',1,'','pie','','','','','Devices','','',0,'','SELECT devices.id AS `description`, devices.name AS `name`, LENGTH(devices.cve) - LENGTH(REPLACE(devices.cve, \',\', \'\')) AS `count` FROM devices WHERE @filter AND devices.cve > \'\' ORDER BY (LENGTH(devices.cve) - LENGTH(REPLACE(devices.cve, \',\', \'\'))) DESC LIMIT 10','devices?devices.id=@description','system','2000-01-01 00:00:00');
INSERT INTO `widgets` VALUES (57,'Top 10 Vendors of Vulnerabilities',1,'','pie','','','','','Devices','','',0,'','SELECT vulnerabilities.vendor AS `description`, vulnerabilities.vendor AS `name`, COUNT(vulnerabilities.id) AS `count` FROM `vulnerabilities` LEFT JOIN `orgs` ON `vulnerabilities`.`org_id` = `orgs`.`id`  WHERE @filter GROUP BY vulnerabilities.vendor ORDER BY `count` LIMIT 10','vulnerabilities?vulnerabilities.vendor=@description','system','2000-01-01 00:00:00');
INSERT INTO `widgets` VALUES (58,'Vulnerabilities Outstanding from Microsoft',1,'','pie','','','','','Devices','','',0,'','SELECT vulnerabilities.base_severity AS `name`, COUNT(vulnerabilities_cache.vulnerability_id) AS `count`, \'\' AS `description` FROM vulnerabilities_cache LEFT JOIN vulnerabilities ON (vulnerabilities_cache.vulnerability_id = vulnerabilities.id) WHERE @filter AND vulnerabilities.vendor = \'microsoft\' GROUP BY base_severity','vulnerabilities?vulnerabilities.base_severity=@name&vulnerabilities.vendor=microsoft&count=>0','system','2000-01-01 00:00:00');
INSERT INTO `widgets` VALUES (59,'Vulnerabilities By Severity',1,'','pie','','','','','Devices','','',0,'','SELECT vulnerabilities.base_severity AS `name`, COUNT(vulnerabilities_cache.vulnerability_id) AS `count`, \'\' AS `description` FROM vulnerabilities_cache LEFT JOIN vulnerabilities ON (vulnerabilities_cache.vulnerability_id = vulnerabilities.id) WHERE @filter GROUP BY base_severity','vulnerabilities?vulnerabilities.base_severity=@name&count=>0','system','2000-01-01 00:00:00');
INSERT INTO `widgets` VALUES (60,'Windows Client Not Latest Build',1,'Windows 10 and 11 devices not running the latest available version from Microsoft.','traffic','',(SELECT id FROM queries WHERE name = 'Windows Client Not Latest Build' LIMIT 1),'','','OLD VERSION','Without the latest Windows 10 or 11','windows',0,'','','','system','2001-01-01 00:00:00');
INSERT INTO `widgets` VALUES (61,'Windows Server Not Latest Build',1,'Windows 2016 to 2025 devices not running the latest available version from Microsoft.','traffic','',(SELECT id FROM queries WHERE name = 'Windows Server Not Latest Build' LIMIT 1),'','','OLD VERSION','Not the latest Server','windows',0,'','','','system','2001-01-01 00:00:00');
INSERT INTO `widgets` VALUES (62,'Windows 2016 Server Not Latest Build',1,'Windows 2016 devices not running the latest available version from Microsoft.','traffic','',(SELECT id FROM queries WHERE name = 'Windows 2016 Not Latest Build' LIMIT 1),'','','OLD VERSION','Without the latest Windows Server 2016','windows',0,'','','','system','2001-01-01 00:00:00');
INSERT INTO `widgets` VALUES (63,'Windows Clients Without OS Updates for more than 30 Days',1,'Windows 10 and 11 devices that have not run Windows Update for 30 days or more.','traffic','',(SELECT id FROM queries WHERE name = 'Windows Clients Without OS Updates for more than 30 Days' LIMIT 1),'','','UPDATES','Clients 30 plus days','windows',0,'','','','system','2001-01-01 00:00:00');
INSERT INTO `widgets` VALUES (64,'Windows Servers Without OS Updates for more than 30 Days',1,'Windows Server devices that have not run Windows Update for 30 days or more.','traffic','',(SELECT id FROM queries WHERE name = 'Windows Servers Without OS Updates for more than 30 Days' LIMIT 1),'','','UPDATES','Servers 30 plus days','windows',0,'','','','system','2001-01-01 00:00:00');
INSERT INTO `widgets` VALUES (65,'Windows Clients Not Seen for more than 30 Days',1,'30 plus days.','traffic','',(SELECT id FROM queries WHERE name = 'Windows Clients Not Seen for more than 30 Days' LIMIT 1),'','','NOT SEEN','Clients 30 plus days.','windows',0,'','','devices?devices.os_family=IN(\'Windows 10\',\'Windows 11\')&properties=devices.id,devices.icon,devices.type,devices.os_group,devices.name,devices.domain,devices.ip,devices.os_family,devices.last_seen','system','2001-01-01 00:00:00');
INSERT INTO `widgets` VALUES (66,'Windows Servers Not Seen for more than 30 Days',1,'Windows Server devices not seen by Open-AudIT for more than 30 days.','traffic','',(SELECT id FROM queries WHERE name = 'Windows Servers Not Seen for more than 30 Days' LIMIT 1),'','','NOT SEEN','Servers 30 plus days.','windows',0,'','','devices?devices.os_family=IN(\'Windows 2016\',\'Windows 2019\',\'Windows 2022\',\'Windows 2025\')&properties=devices.id,devices.icon,devices.type,devices.os_group,devices.name,devices.domain,devices.ip,devices.os_family,devices.last_seen','system','2001-01-01 00:00:00');
