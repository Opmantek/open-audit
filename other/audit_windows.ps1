...
$result = @{}
$result.sys = @{}
$result.sys.script_version = '5.2.1'
$result.sys.id = ''
...
if ([int]$result.sys.form_factor -eq 1  ) { $result.sys.form_factor = 'Other' }
if ([int]$result.sys.form_factor -eq 2  ) { $result.sys.form_factor = 'Unknown' }
if ([int]$result.sys.form_factor -eq 3  ) { $result.sys.form_factor = 'Desktop' }
if ([int]$result.sys.form_factor -eq 4  ) { $result.sys.form_factor = 'Low Profile Desktop' }
if ([int]$result.sys.form_factor -eq 5  ) { $result.sys.form_factor = 'Pizza Box' }
if ([int]$result.sys.form_factor -eq 6  ) { $result.sys.form_factor = 'Mini Tower' }
if ([int]$result.sys.form_factor -eq 7  ) { $result.sys.form_factor = 'Tower' }
if ([int]$result.sys.form_factor -eq 8  ) { $result.sys.form_factor = 'Portable' }
if ([int]$result.sys.form_factor -eq 9  ) { $result.sys.form_factor = 'Laptop' }
if ([int]$result.sys.form_factor -eq 10 ) { $result.sys.form_factor = 'Notebook' }
if ([int]$result.sys.form_factor -eq 11 ) { $result.sys.form_factor = 'Hand Held' }
if ([int]$result.sys.form_factor -eq 12 ) { $result.sys.form_factor = 'Docking Station' }
if ([int]$result.sys.form_factor -eq 13 ) { $result.sys.form_factor = 'All in One' }
if ([int]$result.sys.form_factor -eq 14 ) { $result.sys.form_factor = 'Sub Notebook' }
if ([int]$result.sys.form_factor -eq 15 ) { $result.sys.form_factor = 'Space-Saving' }
if ([int]$result.sys.form_factor -eq 16 ) { $result.sys.form_factor = 'Lunch Box' }
if ([int]$result.sys.form_factor -eq 17 ) { $result.sys.form_factor = 'Main System Chassis' }
if ([int]$result.sys.form_factor -eq 18 ) { $result.sys.form_factor = 'Expansion Chassis' }
if ([int]$result.sys.form_factor -eq 19 ) { $result.sys.form_factor = 'SubChassis' }
if ([int]$result.sys.form_factor -eq 20 ) { $result.sys.form_factor = 'Bus Expansion Chassis' }
if ([int]$result.sys.form_factor -eq 21 ) { $result.sys.form_factor = 'Peripheral Chassis' }
if ([int]$result.sys.form_factor -eq 22 ) { $result.sys.form_factor = 'Storage Chassis' }
if ([int]$result.sys.form_factor -eq 23 ) { $result.sys.form_factor = 'Rack Mount Chassis' }
if ([int]$result.sys.form_factor -eq 24 ) { $result.sys.form_factor = 'Sealed-Case PC'}
if ([int]$result.sys.form_factor -eq 30 ) { $result.sys.form_factor = 'Tablet'}
if ([int]$result.sys.form_factor -eq 31 ) { $result.sys.form_factor = 'Convertible'}
if ([int]$result.sys.form_factor -eq 32 ) { $result.sys.form_factor = 'Detachable'}
if ([int]$result.sys.form_factor -eq 35 ) { $result.sys.form_factor = 'Mini PC'}
