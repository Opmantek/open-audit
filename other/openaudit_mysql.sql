...
(13, 'Open-AudIT Enterprise Managed Devices', '', 'SELECT distinct(system.system_id) FROM system WHERE system.man_status = \'production\' and man_oae_manage = \'y\'',1,'Any items that have their status attribute set to \'production\' and their oae_manage attribute set to \'y\'.', 'device', '', 'devices');
