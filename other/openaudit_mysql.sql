...
(8888, 'Open-AudIT Enterprise Managed Devices', '', 'SELECT distinct(system.system_id) FROM system WHERE system.man_status = \'production\' and man_oae_manage = \'y\'',1,'Any items that have their status attribute set to \'production\' and their oae_manage attribute set to \'y\'.', 'device', '', 'devices');
...
INSERT INTO `oa_group_user` (`group_user_id`,`user_id`,`group_id`,`group_user_access_level`) VALUES (2,1,1,10),(3,1,2,10),(4,1,8,10),(5,1,6,10),(6,1,3,10),(7,1,4,10),(8,1,7,10),(9,1,5,10),(10,3,1,10),(11,3,2,10),(12,3,8,10),(13,3,6,10),(14,3,3,10),(15,3,4,10),(16,3,7,10),(17,3,5,10),(18,1,9,10),(19,3,9,10),(20,1,10,10),(21,3,10,10),(23,2,1,3),(24,2,2,0),(25,2,8,0),(26,2,6,0),(27,2,9,0),(28,2,10,5),(29,2,3,0),(30,2,4,0),(31,2,7,0),(32,2,5,0),(33,1,8888,10),(34,2,8888,10),(35,3,8888,10); 

INSERT INTO oa_config (config_name, config_value, config_editable, config_description) VALUES ('internal_version', '20150126', 'n', 'The internal numerical version.');
INSERT INTO oa_config (config_name, config_value, config_editable, config_description) VALUES ('display_version', '1.5.4', 'n', 'The version shown on the web pages.');
