...
INSERT INTO `configuration` VALUES (NULL, 'display_version','1.14','n','system',NOW(),'The version shown on the web pages.');
...
INSERT INTO groups VALUES(NULL, 1, "Computers", "Devices with class = hypervisor.", "SELECT DISTINCT(system.id) FROM system WHERE @filter AND system.class = 'hypervisor'", "", "y", "system", NOW());
...
INSERT INTO groups VALUES(NULL, 1, "Printers", "Devices with type = computer.", "SELECT DISTINCT(system.id) FROM system WHERE @filter AND system.type = 'printer'", "", "y", "system", NOW());
...
INSERT INTO groups VALUES(NULL, 1, "Windows Workstations", "Devices with type = computer and os_name not like Server.", "SELECT DISTINCT(system.id) FROM system WHERE @filter AND system.type = 'computer' AND system.os_name not like '%server%')", "", "y", "system", NOW());
