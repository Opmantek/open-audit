...
(2, 'All Printers', '', 'SELECT distinct(system.system_id) FROM system WHERE system.man_status = \'production\' and (type = \'printer\' or man_type = \'printer\' or type = \'network printer\' or man_type = \'network printer\')', 1, 'Any items that have their status attribute set to \'production\' and have their type attribute set to \'printer\'.', 'device', 'SELECT system.system_id, system.hostname, system.man_description, system.man_manufacturer, system.man_model, system.man_serial, system.man_ip_address, system.man_type, system.man_icon FROM system LEFT JOIN oa_group_sys ON (system.system_id = oa_group_sys.system_id) WHERE oa_group_sys.group_id = ? group by system_id', 'printer'),
(3, 'Routers', '', 'SELECT distinct(system.system_id) FROM system WHERE (system.type = \'router\' or system.man_type = \'router\') AND system.man_status = \'production\'', 1, 'Any items that have their status attribute set to \'production\' and have their type attribute set to \'router\'.', 'device', 'SELECT system.system_id, system.hostname, system.man_description, system.man_ip_address, system.man_type, system.man_os_family, system.man_os_name, system.man_icon, system.man_manufacturer, system.man_model FROM system, oa_group_sys WHERE system.system_id = oa_group_sys.system_id AND oa_group_sys.group_id = ? GROUP BY system.system_id', 'router'),
(4, 'Switches', '', 'SELECT distinct(system.system_id) FROM system WHERE (system.type = \'switch\' or system.man_type = \'switch\') AND system.man_status = \'production\'', 1, 'Any items that have their status attribute set to \'production\' and have their type attribute set to \'switch\'.', 'device', 'SELECT system.system_id, system.hostname, system.man_description, system.man_ip_address, system.man_type, system.man_os_family, system.man_os_name, system.man_icon, system.man_manufacturer, system.man_model FROM system, oa_group_sys WHERE system.system_id = oa_group_sys.system_id AND oa_group_sys.group_id = ? GROUP BY system.system_id', 'switch'),
...
(8, 'Computers', '', 'SELECT distinct(system.system_id) FROM system WHERE system.man_status = \'production\' and (system.type = \'computer\' or system.man_type = \'computer\')', 1, 'Any items that have their status attribute set to \'production\' and have their type attribute set to \'computer\'.', 'device', 'SELECT system.man_icon, system.man_os_family, system.hostname, system.system_id, system.man_ip_address, system.man_manufacturer, system.man_model, system.man_description, system.man_os_name FROM system, oa_group_sys WHERE system.system_id = oa_group_sys.system_id AND oa_group_sys.group_id = ? GROUP BY system.system_id', 'computer'),
