                            ...
                            <?php if (!empty($data)) { ?>
                                ...
                                <tr>
                                    ...
                                    <?php foreach ($meta->data_order as $key) {
                                        ...
                                        } else if ($key === 'locations.name' and !empty($item->attributes->{'locations.id'})) {
                                            echo "<td><a href=\"" . url_to($meta->collection.'Collection') . "?" . $meta->collection . ".location_id=" . $item->attributes->{'locations.id'} . "\">" . $item->attributes->{$key} . "</a></td>\n";
                                        } else {
