...
INSERT INTO `configuration` VALUES (NULL,'display_version','4.4.2','text','n','system','2000-01-01 00:00:00','The version shown on the web pages.');
...
INSERT INTO `configuration` VALUES (NULL,'internal_version','20230208','number','n','system','2000-01-01 00:00:00','The internal numerical version.');
...
INSERT INTO `discoveries` (id, name, org_id, type, subnet, edited_date, edited_by) VALUES (1,'Default Discovery',1,'subnet','',NOW(),'system');
...
INSERT INTO `fields` VALUES (NULL,'activated_NMIS',1,1,'varchar','','system','Administrator',NOW());
INSERT INTO `fields` VALUES (NULL,'activated_opConfig',1,1,'varchar','','system','Administrator',NOW());
INSERT INTO `fields` VALUES (NULL,'activated_opEvents',1,1,'varchar','','system','Administrator',NOW());
...
INSERT INTO `roles` VALUES (1,'admin','This role can change global options.','{\"agents\":\"crud\",\"applications\":\"crud\",\"attributes\":\"crud\",\"baselines\":\"crud\",\"clusters\":\"r\",\"collectors\":\"crud\",\"components\":\"crud\",\"configuration\":\"ru\",\"dashboards\":\"crud\",\"database\":\"ru\",\"devices\":\"r\",\"groups\":\"crud\",\"ldap_servers\":\"crud\",\"logs\":\"crud\",\"orgs\":\"crud\",\"queue\":\"crud\",\"queries\":\"crud\",\"roles\":\"crud\",\"search\":\"crud\",\"summaries\":\"crud\",\"tasks\":\"crud\",\"users\":\"crud\",\"widgets\":\"crud\"}','open-audit_roles_admin','system','2000-01-01 00:00:00');
INSERT INTO `roles` VALUES (2,'org_admin','This role is used for administration of endpoints that contain an org_id.','{\"applications\":\"crud\",\"attributes\":\"crud\",\"baselines\":\"crud\",\"clouds\":\"crud\",\"clusters\":\"crud\",\"components\":\"crud\",\"connections\":\"crud\",\"credentials\":\"crud\",\"dashboards\":\"crud\",\"queue\":\"cr\",\"summaries\":\"r\",\"devices\":\"crud\",\"discoveries\":\"crud\",\"discovery_scan_options\":\"crud\",\"fields\":\"crud\",\"files\":\"crud\",\"groups\":\"r\",\"integrations\":\"crud\",\"licenses\":\"crud\",\"locations\":\"crud\",\"networks\":\"crud\",\"orgs\":\"crud\",\"queue\":\"cr\",\"queries\":\"r\",\"racks\":\"crud\",\"rack_devices\":\"crud\",\"roles\":\"r\",\"rules\":\"crud\",\"scripts\":\"crud\",\"search\":\"crud\",\"tasks\":\"crud\",\"users\":\"crud\",\"widgets\":\"crud\"}','open-audit_roles_org_admin','system','2000-01-01 00:00:00');
INSERT INTO `roles` VALUES (3,'user','A standard role that can read most endpoints that contain an org_id.','{\"applications\":\"r\",\"baselines\":\"r\",\"clouds\":\"r\",\"clusters\":\"r\",\"components\":\"r\",\"connections\":\"r\",\"credentials\":\"r\",\"dashboards\":\"r\",\"summaries\":\"r\",\"devices\":\"r\",\"fields\":\"r\",\"files\":\"r\",\"groups\":\"r\",\"licenses\":\"r\",\"locations\":\"r\",\"networks\":\"r\",\"orgs\":\"r\",\"queries\":\"r\",\"racks\":\"r\",\"rack_devices\":\"r\",\"rules\":\"r\",\"search\":\"crud\",\"widgets\":\"r\"}','open-audit_roles_user','system','2000-01-01 00:00:00');
...
INSERT INTO `rules` VALUES (NULL,'Form Factor based on Manufacturer (like VMware)',1,'Set the form factor based on the manufacturer.',90,'[{\"table\":\"system\",\"attribute\":\"manufacturer\",\"operator\":\"li\",\"value\":\"vmware\"}]','[{\"table\":\"system\",\"attribute\":\"form_factor\",\"value\":\"Virtual\",\"value_type\":\"string\"}]','system','2001-01-01 00:00:00');
INSERT INTO `rules` VALUES (NULL,'Form Factor based on Manufacturer (like Parallels)',1,'Set the form factor based on the manufacturer.',90,'[{\"table\":\"system\",\"attribute\":\"manufacturer\",\"operator\":\"li\",\"value\":\"parallels\"}]','[{\"table\":\"system\",\"attribute\":\"form_factor\",\"value\":\"Virtual\",\"value_type\":\"string\"}]','system','2001-01-01 00:00:00');
INSERT INTO `rules` VALUES (NULL,'Form Factor based on Manufacturer (like Systemtechnik)',1,'Set the form factor based on the manufacturer.',90,'[{\"table\":\"system\",\"attribute\":\"manufacturer\",\"operator\":\"li\",\"value\":\"PCS Systemtechnik GmbH\"}]','[{\"table\":\"system\",\"attribute\":\"form_factor\",\"value\":\"Virtual\",\"value_type\":\"string\"}]','system','2001-01-01 00:00:00');
INSERT INTO `rules` VALUES (NULL,'Form Factor based on Manufacturer (like Virtual)',1,'Set the form factor based on the manufacturer.',90,'[{\"table\":\"system\",\"attribute\":\"manufacturer\",\"operator\":\"li\",\"value\":\"virtual\"}]','[{\"table\":\"system\",\"attribute\":\"form_factor\",\"value\":\"Virtual\",\"value_type\":\"string\"}]','system','2001-01-01 00:00:00');
...
INSERT INTO `rules` VALUES (NULL,'NMIS Manage for SNMP devices',1,'Set nmis_manage to y if we detect an SNMP OID.',100,'[{\"attribute\":\"snmp_oid\",\"operator\":\"gt\",\"table\":\"system\",\"value\":\"\"}]','[{\"attribute\":\"nmis_manage\",\"table\":\"system\",\"value\":\"y\",\"value_type\":\"string\"}]','system','2001-01-01 00:00:00');
...
CREATE TABLE `users` (
  ...
  CONSTRAINT `CONSTRAINT_1` CHECK (json_valid(`roles`)),
  CONSTRAINT `CONSTRAINT_2` CHECK (json_valid(`orgs`)),
  CONSTRAINT `CONSTRAINT_3` CHECK (json_valid(`access_token`))
...
INSERT INTO `users` VALUES (1,'admin',1,''$2y$10$GOIVq6oRkN1/yP1bL7nab.FZ1rCx2RXlWR0F/UwShQ1PAdILScvnG%'','Administrator','admin@openaudit','[\"admin\",\"org_admin\"]','[1]','en','y','','user',1,'','icontext','[]','system','2000-01-01 00:00:00');
