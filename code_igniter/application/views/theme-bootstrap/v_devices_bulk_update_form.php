    ...
    <div class="panel-body">
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    <td style="text-align: center;"><a role="button" class="btn btn-sm btn-success" href="devices/<?php echo $item->id; ?>"><?php echo $item->id; ?></a></td>
                    <td style="text-align: center;"><img src="<?php echo str_replace("index.php", "", site_url()); ?>device_images/<?php echo strtolower(str_replace(" ", "_", $item->icon)); ?>.svg" style="border-width:0; width:24px;" title="icon" alt="icon"/></td>
