    ...
    <div class="panel-body">
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    <td style="text-align: center;"><a role="button" class="btn btn-sm btn-success" href="devices/<?php echo htmlentities($item->id); ?>"><?php echo htmlentities($item->id); ?></a></td>
                    <td style="text-align: center;"><img src="<?php echo str_replace("index.php", "", site_url()); ?>device_images/<?php echo strtolower(str_replace(" ", "_", htmlentities($item->icon))); ?>.svg" style="border-width:0px; width:24px;" title="icon" alt="icon"/></td>
