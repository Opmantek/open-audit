                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 input-group">
                            <input type="text" class="form-control" id="web_display_version" name="web_display_version" value="<?php echo htmlentities($this->config->item('web_display_version')); ?>" disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 input-group">
                            <input type="text" class="form-control" id="display_version" name="display_version" value="<?php echo htmlentities($this->config->item('display_version')); ?>" disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 input-group">
                            <input type="text" class="form-control" id="hostname" name="hostname" value="<?php echo htmlentities(php_uname('n')); ?>" disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 input-group">
                            <input type="text" class="form-control" id="host_os" name="host_os" value="<?php echo htmlentities($operating_system); ?>" disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 input-group">
                            <input type="text" class="form-control" id="database_platform" name="database_platform" value="<?php echo htmlentities($this->db->platform()); ?>" disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 input-group">
                            <input type="text" class="form-control" id="database_version" name="database_version" value="<?php echo htmlentities($this->db->version()); ?>" disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 input-group">
                            <input type="text" class="form-control" id="web_server" name="web_server" value="<?php echo htmlentities(getenv("SERVER_SOFTWARE")); ?>" disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 input-group">
                            <input type="text" class="form-control" id="php_server" name="php_server" value="<?php echo htmlentities(phpversion()); ?>" disabled>
                        </div>
                    </div>
                </div>
            </div>
