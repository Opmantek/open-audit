                ...
                <tbody>
                    <?php foreach ($this->response->data as $item): ?>
                        <tr>
                            ...
                            <td><span class="small glyphicon glyphicon-filter" aria-hidden="true" data-html="true" data-toggle="popover" title="Refine" data-content="<a href='<?php echo $refine_link; ?>system.nmis_manage=!=<?php echo urlencode($item->attributes->nmis_manage); ?>'><?php echo __('Exclude'); ?></a><br /><a href='<?php echo $refine_link; ?>system.nmis_manage=<?php echo urlencode($item->attributes->nmis_manage); ?>'>Include</a><br />"></span>&nbsp;<?php echo htmlspecialchars($item->attributes->nmis_manage, REPLACE_FLAGS, CHARSET); ?></td>

                            <td><span class="small glyphicon glyphicon-filter" aria-hidden="true" data-html="true" data-toggle="popover" title="Refine" data-content="<a href='<?php echo $refine_link; ?>system.nmis_group=!=<?php echo urlencode($item->attributes->group); ?>'><?php echo __('Exclude'); ?></a><br /><a href='<?php echo $refine_link; ?>system.nmis_group=<?php echo urlencode($item->attributes->group); ?>'>Include</a><br />"></span>&nbsp;<?php echo htmlspecialchars($item->attributes->group, REPLACE_FLAGS, CHARSET); ?></td>

                            <td><span class="small glyphicon glyphicon-filter" aria-hidden="true" data-html="true" data-toggle="popover" title="Refine" data-content="<a href='<?php echo $refine_link; ?>nmis_role=!=<?php echo urlencode($item->attributes->role); ?>'><?php echo __('Exclude'); ?></a><br /><a href='<?php echo $refine_link; ?>system.nmis_role=<?php echo urlencode($item->attributes->role); ?>'>Include</a><br />"></span>&nbsp;<?php echo htmlspecialchars($item->attributes->role, REPLACE_FLAGS, CHARSET); ?></td>

                            <td><span class="small glyphicon glyphicon-filter" aria-hidden="true" data-html="true" data-toggle="popover" title="Refine" data-content="<a href='<?php echo $refine_link; ?>system.nmis_notes=!=<?php echo urlencode($item->attributes->notes); ?>'><?php echo __('Exclude'); ?></a><br /><a href='<?php echo $refine_link; ?>system.nmis_notes=<?php echo urlencode($item->attributes->notes); ?>'>Include</a><br />"></span>&nbsp;<?php echo htmlspecialchars($item->attributes->notes, REPLACE_FLAGS, CHARSET); ?></td>

                            <td><span class="small glyphicon glyphicon-filter" aria-hidden="true" data-html="true" data-toggle="popover" title="Refine" data-content="<a href='<?php echo $refine_link; ?>system.nmis_business_service=!=<?php echo urlencode($item->attributes->businessService); ?>'><?php echo __('Exclude'); ?></a><br /><a href='<?php echo $refine_link; ?>system.nmis_business_service=<?php echo urlencode($item->attributes->businessService); ?>'>Include</a><br />"></span>&nbsp;<?php echo htmlspecialchars($item->attributes->businessService, REPLACE_FLAGS, CHARSET); ?></td>
