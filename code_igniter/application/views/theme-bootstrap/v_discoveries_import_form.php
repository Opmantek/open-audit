...
<?php echo form_open_multipart($this->response->meta->collection.'/import');?>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-md-12">
                    <p>Below is an example of the required csv format. The minimum required attributes for <?php echo $this->response->meta->collection; ?> are name, org_id, network_address and subnet. You should not include the id, created_by, created_on or updated_on fields. These will be automatically set. All other columns are optional.</p>
                    ...
                    <samp>
                        "name","org_id","network_address","subnet"<br />
                        "My Test Discovery","1","http://SERVER/open-audit/","192.168.1.1"
                    </samp>
                </div>
            </div>
        </div>
