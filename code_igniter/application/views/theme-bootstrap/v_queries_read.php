        ...
        <div class="panel-body">
            <div class="row">
                ...
                <strong><?php echo __("Query Creation Rules"); ?></strong>
                    ...
                    <p>An example<br /><pre class="wrap">SELECT system.id AS `system.id`, system.icon AS `system.icon`, system.type AS `system.type` system.name AS `system.name`, system.os_name AS `system.os_name` FROM system WHERE @filter AND system.os_group = 'Linux'</pre></p>
                </div>
