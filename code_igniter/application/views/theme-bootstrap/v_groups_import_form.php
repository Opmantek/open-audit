        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <samp>
                        "org_id","name","description","sql","link","expose"<br />
                        "1","Test Group","Ubuntu Machines","SELECT DISTINCT(system.id) FROM system WHERE @filter AND os_family LIKE 'Ubuntu'","","y"<br />
                    </samp>
                </div>
            </div>
        </div>
