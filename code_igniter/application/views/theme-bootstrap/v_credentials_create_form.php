...
$(document).ready(function(){
    var $snmp_text = '        <div class="form-group">\
            <label for="data[attributes][credentials][community]" class="col-sm-3 control-label">Community</label>\
            <div class="col-sm-8 input-group">\
    ...
    var $snmp_v3_text = '        <div class="form-group">\
        ...
        <div class="form-group">\
            <label for="data[attributes][credentials][security_level]" class="col-sm-3 control-label">Security Level</label>\
            <div class="col-sm-8 input-group">\
        ...
        <div class="form-group">\
            <label for="data[attributes][credentials][authentication_protocol]" class="col-sm-3 control-label">Authentication Protocol</label>\
            <div class="col-sm-8 input-group">\
        ...
        <div class="form-group">\
            <label for="data[attributes][credentials][privacy_protocol]" class="col-sm-3 control-label">Privacy Protocol</label>\
            <div class="col-sm-8 input-group">\
        ...
        <div class="form-group">\
            <label for="data[attributes][credentials][privacy_passphrase]" class="col-sm-3 control-label">Privacy Passphrase</label>\
            <div class="col-sm-8 input-group">\
    ...
    var $ssh_text = '        <div class="form-group">\
            <label for="data[attributes][credentials][username]" class="col-sm-3 control-label">Username</label>\
            <div class="col-sm-8 input-group">\
        ...
        <div class="form-group">\
            <label for="data[attributes][credentials][password]" class="col-sm-3 control-label">Password</label>\
            <div class="col-sm-8 input-group">\
    ...
    var $ssh_key_text = '        <div class="form-group">\
        ...
        <div class="form-group">\
            <label for="data[attributes][credentials][ssh_key]" class="col-sm-3 control-label">Key</label>\
            <div class="col-sm-8 input-group">\
