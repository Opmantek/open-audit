...
<form action="<?php echo $this->response->meta->collection; ?>/import" method="post" enctype="multipart/form-data">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-md-12">
                    <p>Below is an example of the required csv format. The minimum required attributes for attributes are org_id, resource, type, name and value. You should not include the id, edited_by and edited_date fields. These will be automatically set.</p>
                    ...
                    <samp>
                        "1",resource","type","name","value"<br />
                        "1","devices","device_class","Virtual Device","virtual device"<br />
                        "1","devices","device_class","Special Class","special class"
                    </samp>
                </div>
            </div>
        </div>
