            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 input-group">
                            <input type="text" class="form-control" id="values" name="values" value="<?php echo $item->attributes->values; ?>" disabled>
                            <?php if (!empty($edit)) { ?>
                            <span class="input-group-btn">
                            ...
                            <select class="form-control" id="group_id" name="group_id" disabled>
                                ...
                                foreach ($this->response->included as $group) {
                                    if ($group->type == 'groups') { ?>
                                        <option value="<?php echo $group->id; ?>"<?php if ($item->attributes->group_id == $group->id) { echo " selected"; } ?>><?php echo $group->attributes->name; ?></option>
                                <?php
                                    }
                                } ?>
                                </select>
