    ...
    <div class="panel-body">
        ...
        <table class="table table-striped table-hover">
            ...
            <tbody>
                ...
                <tr>
                    <td class="text-center"><a class="btn btn-sm btn-primary" href="connections/<?php echo $item->id; ?>"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span></a></td>
