	...
	<table class="table">
		...
		<tbody>
			...
			<tr>
                ...
                <td style='text-align:center;'><a class="btn btn-sm btn-primary" href="<?php echo $item->links->self; ?>?action=execute"><span class="glyphicon glyphicon-download" aria-hidden="true"></span></a></td>
