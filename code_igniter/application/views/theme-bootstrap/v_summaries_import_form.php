...
<form action="<?php echo $this->response->meta->collection; ?>/import" method="post" enctype="multipart/form-data">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-md-12">
                    <p>Below is an example of the required csv format. The minimum required attributes for <?php echo $this->response->meta->collection; ?> are org_id, name and table and column. You should not include the id, edited_by or edited_date fields. These will be automatically set. All other columns are optional.</p>
                    ...
                    <samp>
                        "org_id","name","table","column"<br />
                        "1","Bios Manufacturers","bios","manufacturer"
                    </samp>
                </div>
            </div>
        </div>
