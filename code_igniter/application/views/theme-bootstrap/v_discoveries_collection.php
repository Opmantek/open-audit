...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title">
            <span class="text-left">Discoveries</span>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style='text-align:center;'><a class="btn btn-sm btn-primary" href="discoveries/<?php echo intval($item->id); ?>?action=execute"><span class="glyphicon glyphicon-play" aria-hidden="true"></span></a></td>
                    <td style='text-align:center;'><a class="btn btn-sm btn-info" href="discoveries/<?php echo intval($item->id); ?>?action=update"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a></td>
