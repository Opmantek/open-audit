...
<form action="<?php echo $this->response->meta->collection; ?>/import" method="post" enctype="multipart/form-data">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-md-12">
                    <p>Below is an example of the required csv format. The minimum required attributes for <?php echo $this->response->meta->collection; ?> are name and org_id. You should not include the id, created_by, created_on or updated_on fields. These will be automatically set. All other columns are optional.</p>
                    ...
                    <samp>
                        "name","org_id","description"<br />
                        "192.168.1.0/24","1","My Home Network"
                    </samp>
                </div>
            </div>
        </div>
