 ...
 */
$nondelete = ' admin org_admin reporter user ';
?>
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title">
            <span class="text-left">Roles</span>
            ...
            <tbody>
                <?php foreach ($this->response->data as $item): ?>
                    <tr>
                        ...
                        <td style='text-align:center;'><a class="btn btn-sm btn-info" href="roles/<?php echo intval($item->id); ?>?action=update"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a></td>
