                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 input-group">
                             <input required="true" type="text" class="form-control" id="data[attributes][name]" name="data[attributes][name]" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 input-group">
                            <select class="form-control" id="data[attributes][org_descendants]" name="data[attributes][org_descendants]" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 input-group">
                             <input required="true" type="text" class="form-control" id="data[attributes][purchase_count]" name="data[attributes][purchase_count]" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 input-group">
                             <input required="true" type="text" class="form-control" id="data[attributes][match_string]" name="data[attributes][match_string]" required>
                        </div>
                    </div>
