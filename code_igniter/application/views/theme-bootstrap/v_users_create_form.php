  ...
  <div class="panel-body">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <label for="data[attributes][full_name]" class="col-sm-2 control-label">Full Name</label>
                    <div class="col-sm-8">
                        <div class="col-sm-12 input-group">
                ...
                <div class="form-group">
                    <label for="data[attributes][password]" class="col-sm-2 control-label">Password</label>
                    <div class="col-sm-8">
                        <div class="col-sm-12 input-group">
                ...
                <div class="form-group">
                    <label for="data[attributes][email]" class="col-sm-2 control-label">Email</label>
                    <div class="col-sm-8">
                        <div class="col-sm-12 input-group">
                ...
                <div class="form-group">
                    <label for="data[attributes][lang]" class="col-sm-2 control-label">Language</label>
                    <div class="col-sm-8">
                        <div class="col-sm-12 input-group">
                ...
                <div class="form-group">
                    <label for="data[attributes][active]" class="col-sm-2 control-label">Active</label>
                    <div class="col-sm-8">
                        <div class="col-sm-12 input-group">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <label for="data[attributes][roles]" class="col-sm-2 control-label">Roles</label>
                    <div class="col-sm-8">
                        <div class="col-sm-12 input-group">
...
foreach ($this->response->included as $org) {
    if ($org->type == 'orgs') {
        ...
        ?>                  <tr>
                    ...
                    <td style="text-align:center;"><input id="data[attributes][orgs][]" name="data[attributes][orgs][]" type="checkbox" value="<?php echo $org->id; ?>"></td>
                    </tr>
        <?php
    }
}
