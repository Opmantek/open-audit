            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="row">
                        ...
                        <?php if (!empty($this->config->config['default_network_address']) and strpos($this->config->config['default_network_address'], '127.0.0.1') === false and strpos($this->config->config['default_network_address'], 'localhost') === false and !empty($this->config->config['default_network_address'])) { ?>
                        <span align='center'>
                            <br />
