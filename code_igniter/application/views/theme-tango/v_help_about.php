...
$upgrade_message = "";
if ($this->config->item('display_version') != $this->config->item('web_display_version') and ($this->m_users->get_user_permission($this->user->id, 'database', 'u'))) {
...
<form action="vars.php" method="post" class='niceforms'>
	<fieldset id="about" class='niceforms'>
		...
		<?php if ($this->m_users->get_user_permission('', 'database', 'u')) { ?>
