...
<div id="header" style='height: 70px; margin-left: auto; margin-right: auto; padding: 0px 0px 0px 0px; text-align: left;'>
	<div style="width:260px; float: left; text-align: left;">
		<a href="<?php echo $this->config->item('oa_web_index'); ?>/main/list_groups">
			...
			<img src='<?php echo $oa_theme_images; ?>/logo-banner-<?php echo $this->config->item('logo'); ?>.png' alt='logo' style='border-width:0px;' />
			<?php } else { ?>
	...
	<?php if (isset($this->config->config['mis_url']) AND $this->config->config['nmis_url'] > "") { ?>
		<br />NMIS<br /><a href="<?php echo $this->config->item('nmis_url'); ?>" target="_blank"><img alt="" style="height:30px" src="<?php echo $oa_theme_images; ?>/logo-nmis.png" /></a>
	<?php } else { ?>
	...
	<?php if (isset($this->config->config['maps_url']) and $this->config->config['maps_url'] > "") { ?>
		<br />Map<br /><a href="<?php echo $this->config->item('maps_url'); ?>"  target="_blank" ><img alt="" style="height:30px" src="<?php echo $oa_theme_images; ?>/logo-opmaps.png" /></a>
	<?php } else { ?>
