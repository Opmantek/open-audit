...
<table cellspacing="1" class="tablesorter">
	...
	<tbody>
        ...
        foreach ($this->response->data as $item):
            ...
            $edit_pic = "<a href=\"files/".intval($item->id)."?action=edit\"><img src='".$oa_theme_images."/16_edit.png' alt='' title='' style='width:16'/></a>";
            ...
            ?>
		<tr>
            <td><a href="files/<?php echo intval($item->id)?>"><?php echo intval($item->id)?></td>
            <td><?php echo intval($item->org_id)?></td>
			<td><span style="display: none"><?php echo htmlentities($item->path); ?></span><?php echo htmlentities($item->path); ?></td>
...
$('.delete_link').click(function() {
	...
	var $url = '/open-audit/index.php/files/'+$id;
	$.ajax({
		type: 'DELETE',
		url: $url,
	error: function() {
