...
echo form_open('files/' . $this->response->id)."\n"; ?>
	...
	<table cellpadding = "0" cellspacing="0">
		<tr>
			<td>
				...
				<p><label for='data[path]'><?php echo __("Path")?>: </label><input type='text' id='data[path]' name='data[path]' tabindex='2' title='Path' value="<?php echo $item->path; ?>" /><?php echo $error_message; ?></p>
