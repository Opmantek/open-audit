...
?>
	...
	<form action="../../admin_system/system_add_credentials" method="post" class="niceforms">
		<fieldset id="summary_credentials_details" class="niceforms">
			...
			<div style="float:right; width: 120px; text-align:center">
				<img style='margin; 10px; ' src='<?php echo $oa_theme_images;
    ?>/48_credentials.png' alt='' title='' width='48'/>
    ...
    ?>
			...
			<div id="credentials">
				<p><label for='credentials_ip_address'>IP Address: </label><span id='credentials_ip_address'><?php echo print_something($decoded_access_details->ip_address);
    ?></span></p>

				<p><label for='credentials_ip_address'>SNMP Version: </label><span id='credentials_snmp_version'><?php echo print_something($decoded_access_details->snmp_version);
    ?></span></p>
				<p><label for='credentials_ip_address'>SNMP Community: </label><span id='credentials_snmp_community'><?php echo print_something($snmp_community);
    ?></span></p>

				<p><label for='credentials_ssh_username'>SSH Username: </label><span id='credentials_ssh_username'><?php echo print_something($decoded_access_details->ssh_username);
    ?></span></p>
				<p><label for='credentials_ssh_password'>SSH Password: </label><span id='credentials_ssh_password'><?php echo print_something($ssh_password);
    ?></span></p>

				<p><label for='credentials_windows_username'>Windows Username: </label><span id='credentials_windows_username'><?php echo print_something($decoded_access_details->windows_username);
    ?></span></p>
				<p><label for='credentials_windows_password'>Windows Password: </label><span id='credentials_windows_password'><?php echo print_something($windows_password);
    ?></span></p>
				<p><label for='credentials_windows_domain'>Windows Domain: </label><span id='credentials_windows_domain'><?php echo print_something($decoded_access_details->windows_domain);
    ?></span></p>
			</div>
    ...
    ?>
		...
		<form action="#" method="post" class="niceforms">
			<fieldset id="summary_audit_log">
				...
				<div style="min-width: 50px; float: right;">
				<img style='float: right; margin; 10px; ' src='<?php echo $oa_theme_images;
    ?>/48_audit_log.png' alt='' title='' width='48'/>
				</div>
				<div style="width: 90%; float:left;">
				<table cellspacing="1" class="tablesorter" width="100%">
					<thead>
    ...
    ?>
		...
		<form action="#" method="post" class="niceforms">
			<fieldset id="summary_alert_log">
				...
				<div style="min-width: 50px; float: right;">
				<img style='float: right; margin; 10px; ' src='<?php echo $oa_theme_images;
    ?>/48_alerts.png' alt='' title='' width='48'/>
				</div>
				<div style="width: 90%; float:left;">
				<table cellspacing="1" class="tablesorter" width="100%">
					<thead>
	...
	<form action="#" method="post" class="niceforms">
		<fieldset id="summary_network_details" class="niceforms">
			...
			<img style='float: right; margin; 10px; ' src='<?php echo $oa_theme_images;
    ?>/48_network_wireless.png' alt='' title='' width='48'/>
			<?php foreach ($system as $key): ?>
				<p><label for="man_switch_id"><?php echo __('Switch ID')?>: </label><span id="man_switch_id" <?php echo $edit?>><?php echo print_something($key->man_switch_id)?></span><?php echo $edit_icon;
    ?></p>
				<p><label for="man_switch_port"><?php echo __('Switch Port')?>: </label><span id="man_switch_port" <?php echo $edit?>><?php echo print_something($key->man_switch_port)?></span><?php echo $edit_icon;
    ?></p>
				<p><label for="man_patch_panel"><?php echo __('Patch Panel')?>: </label><span id="man_patch_panel" <?php echo $edit?>><?php echo print_something($key->man_patch_panel)?></span><?php echo $edit_icon;
    ?></p>
				<p><label for="man_wall_port"><?php echo __('Wall Port')?>: </label><span id="man_wall_port" <?php echo $edit?>><?php echo print_something($key->man_wall_port)?></span><?php echo $edit_icon;
    ?></p>
			<?php
            endforeach;
	...
	<form action="#" method="post" class="niceforms">
		<fieldset id="summary_phone_details" class="niceforms">
			...
			<img style='float: right; margin; 10px; ' src='<?php echo $oa_theme_images;
    ?>/48_phone.png' alt='' title='' width='48'/>
			<?php foreach ($system as $key): ?>
				<p><label for="man_service_number"><?php echo __('Phone Number')?>: </label><span id="man_service_number" <?php echo $edit?>><?php echo print_something($key->man_service_number)?></span><?php echo $edit_icon;
    ?></p>
				<p><label for="man_service_provider"><?php echo __('Provider')?>: </label><span id="man_service_provider" <?php echo $edit?>><?php echo print_something($key->man_service_provider)?></span><?php echo $edit_icon;
    ?></p>
				<p><label for="man_service_type"><?php echo __('Type')?>: </label>
				<?php if ($access_level > 7) {
    ?>
					<span id="man_service_type_select" style="color:blue;"><span onclick="display_service_type();"><?php echo print_something($key->man_service_type)?>&nbsp;&nbsp;<?php echo $edit_icon;
    ?></span></span></p>
				<?php 
} else {
    ?>
    ...
    ?>
				<p><label for="man_service_provider"><?php echo __('Network Provider')?>: </label><span id="man_service_provider" <?php echo $edit?>><?php echo print_something($key->man_service_provider)?></span><?php echo $edit_icon;
    ?></p>
				<p><label for="man_service_plan"><?php echo __('Plan')?>: </label><span id="man_service_plan" <?php echo $edit?>><?php echo print_something($key->man_service_plan)?></span><?php echo $edit_icon;
    ?></p>
				<p><label for="man_service_network"><?php echo __('Network')?>: </label><span id="man_service_network" <?php echo $edit?>><?php echo print_something($key->man_service_network)?></span><?php echo $edit_icon;
    ?></p>
				<p><label for="man_unlock_pin"><?php echo __('Unlock PIN')?>: </label><span id="man_unlock_pin" <?php echo $edit?>><?php if ($access_level >= 7) {
    echo print_something($key->man_unlock_pin);
} else {
    echo "******";
}
    ?></span><?php echo $edit_icon;
    ?></p>
				<p><label for="man_serial_imei"><?php echo __('IMEI Serial')?>: </label><span id="man_serial_imei" <?php echo $edit?>><?php echo print_something($key->man_serial_imei)?></span><?php echo $edit_icon;
    ?></p>
				<p><label for="man_serial_sim"><?php echo __('SIM Serial')?>: </label><span id="man_serial_sim" <?php echo $edit?>><?php echo print_something($key->man_serial_sim)?></span><?php echo $edit_icon;
    ?></p>
			<?php
            endforeach;
    ...
    ?>
				...
				<tbody>
					...
					<tr>
						...
						<td><?php echo print_something($key->timestamp)?></td>
						<td align="center"><a href="<?php echo base_url();
    ?>index.php/main/show_attachment/<?php echo print_something($key->att_id)?>"><img src='<?php echo $oa_theme_images;
    ?>/16_word.png' alt='' title='' /></a></td>
						<td align="center"><a href="<?php echo base_url();
    ?>index.php/main/download_attachment/<?php echo print_something($key->att_id)?>"><img src='<?php echo $oa_theme_images;
    ?>/16_link.png' alt='' title='' /></a></td>
						<?php if ($access_level > 7) {
    ?>
						<td align="center"><a href="<?php echo base_url();
    ?>index.php/main/delete_attachment/<?php echo print_something($key->att_id)?>"><img src='<?php echo $oa_theme_images;
    ?>/16_delete.png' alt='' title='' /></a></td>
						<?php 
}
    ?>
					</tr>
		...
		<form action="#" method="post" class="niceforms">
			<fieldset id="summary_nmis">
				...
				<div style="width: 90%; float:left;">
					...
					<p><label for="nmis_export"><?php echo __('NMIS Export')?>: </label><input id="nmis_export" onClick="check_nmis_export();" type="checkbox"<?php if ($system[0]->nmis_export == 'true') {
    echo " checked";
    ...
    ?><tr>
							<td align="center"><?php echo $icon;
    ?></td>
							<td><?php echo $link;
    ?></td>
							<!-- <td><?php echo $key->vm_group;
    ?></td> -->
							<td align="center"><?php echo $key->memory;
    ?></td>
							<td align="center"><?php echo $key->cpu;
    ?></td>
							<td align="center"><?php echo $status;
    ?></td>
							<td><?php echo $key->uuid;
    ?></td>
							<td><?php echo $key->config_file;
    ?></td>
						</tr>
					<?php 
}
    ?>
				...
				Note - Status as at <?php echo $system[0]->last_seen;
    ?>.<br />Note - Click icon to view guest details.
			</fieldset>
			<br />
		</form>
	<?php 
    ...
    ?><tr>
								<td><?php echo $key->net_index;
    ?></td>
								<td><?php echo $key->net_mac_address;
    ?></td>
								<td><?php echo $key->net_connection_id;
    ?></td>
								<td><?php echo $key->net_description;
    ?></td>
								<td><?php echo $key->net_alias;
    ?></td>
								<td><?php echo $key->net_adapter_type;
    ?></td>
								<td><?php echo $key->net_ip_enabled;
    ?></td>
    ...
    if ($ip_address->net_connection_id != '') {
        $ip_address->net_connection_id = $ip_address->net_connection_id." - ";
    }
    ?><tr>
							<td><?php echo $ip_address->net_index;
    ?></td>
							<td><?php echo $ip_address->net_mac_address;
    ?></td>
							<td><?php echo $ip_address->net_connection_id.$ip_address->net_description;
    ?></td>
