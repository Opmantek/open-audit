...
<ul id="nav">
		...
		<ul>
			...
			<li><a href='javascript:void(0)'><?php echo __('Connections')?></a>
				<ul>
					...
					<!-- <li><a href='<?php echo $oa_web_index; ?>/admin_connection/add_connections'><?php echo __('Add Multiple Connections')?></a></li> -->
				</ul>
			</li>
	...
	<li><a href='#'><?php echo mb_strtoupper(__('NMIS'))?></a>
		<ul>
			...
			<li><a href='<?php echo $oa_web_index; ?>/admin/export_nmis/<?php echo $group_id; ?>'><?php echo __('Export')?></a></li>
			<?php } ?>
		</ul>
	</li>
	<?php
	...
	<?php if (isset($export_report)) { ?>
		...
		if (isset($column)){
			...
			if ($hit == 'y'){ ?>
				<li style="float: right; position: relative; top:-1px; padding-right: 6px;"><a href="<?php echo current_url(); ?>/username/<?php echo $this->user->user_name; ?>/password/YOUR_PASSWORD/rss"><img src="<?php echo $oa_theme_images; ?>/16_rss.png" alt="RSS Link" title="RSS Link"/></a></li>
			<?php } 
		} ?>
