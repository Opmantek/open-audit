...
<fieldset id="location_details" class='niceforms'>
	...
	<table style='width:780' cellpadding='0' cellspacing='0'>
		<tr>
			<td style='width:50%'>
				...
				<p><label for='location_suite'><?php echo __("Suite")?>: </label><input type='text' id='location_suite' name='location_suite' tabindex='4' title='Suite'  value="<?php echo print_something($key->location_suite); ?>"/></p>
				<p><label for='location_room'><?php echo __("Room")?>: </label><input type='text' id='location_room' name='location_room' tabindex='5' title='Room'  value="<?php echo print_something($key->location_room); ?>"/></p>
				<p><label for='location_address'><?php echo __("Street Address")?>: </label><input type='text' id='location_address' name='location_address' tabindex='6' title='Street Address'  value="<?php echo print_something($key->location_address); ?>"/></p>
				<p><label for='location_city'><?php echo __("City")?>: </label><input type='text' id='location_city' name='location_city' tabindex='7' title='City'  value="<?php echo print_something($key->location_city); ?>"/></p>
			</td>
			<td width="50%">
				<p><label for='location_state'><?php echo __("State")?>: </label><input type='text' id='location_state' name='location_state' tabindex='8' title='State'  value="<?php echo print_something($key->location_state); ?>"/></p>
				<p><label for='location_country'><?php echo __("Country")?>: </label><input type='text' id='location_country' name='location_country' tabindex='9' title='Country'  value="<?php echo print_something($key->location_country); ?>"/></p>
    ...
    ?></p>
	<?php } ?>
	<input type="hidden" value="<?php echo print_something($key->location_id); ?>" name="location_id" id="location_id" />
</fieldset>
<?php echo form_close(); ?>
</div>
</div>
