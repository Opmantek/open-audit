...
<div id="content_column" style="margin-left: 200px;">
	...
	<form action="#" method="post" class="niceforms">
		<fieldset id="system_details" class="niceforms">
				...
				<?php foreach($system as $key): ?>
					...
					<div>
						<div style="float:left; width:50%;">
							<p><label for="hostname"><?php echo __('Hostname')?>: </label><span id="hostname" <?php echo $edit?>><?php echo print_something($key->hostname)?></span><?php echo $edit_icon; ?></p>
							...
							<p><label for="man_class"><?php echo __('Class')?>: </label><span id="man_class" <?php echo $edit?>><?php echo print_something($key->man_class)?></span><?php echo $edit_icon; ?></p>
							<!-- <p><label for="man_icon"><?php echo __('Icon')?>: </label><span id="man_icon" <?php echo $edit?>><?php echo print_something($key->man_icon)?></span></p> -->
							<p><label for="man_os_group"><?php echo __('OS Group')?>: </label><span id="man_os_group" <?php echo $edit?>><?php echo print_something($key->man_os_group)?></span><?php echo $edit_icon; ?></p>
							<p><label for="man_os_family"><?php echo __('OS Family')?>: </label><span id="man_os_family" <?php echo $edit?>><?php echo print_something($key->man_os_family)?></span><?php echo $edit_icon; ?></p>
						</div>
						<div style="float:right; width:50%;">
							...
							<p><label for="man_form_factor"><?php echo __('Form Factor')?>: </label><span id="man_form_factor" <?php echo $edit?>><?php echo print_something($key->man_form_factor)?></span><?php echo $edit_icon; ?></p>
							...
							<p><label for="man_function"><?php echo __('Function')?>: </label><span id="man_function" <?php echo $edit?>><?php echo print_something($key->man_function)?></span><?php echo $edit_icon; ?></p>
							
							<?php if(mb_strpos($key->manufacturer, 'VMware') !== false ){ ?>
								<p><label for="man_vm_server_name"><?php echo __('Physical Host')?>: </label><span id="man_vm_server_name" <?php echo $edit?>><?php echo print_something($key->man_vm_server_name)?></span><?php echo $edit_icon; ?></p>
								<p><label for="man_vm_group"><?php echo __('Virtual Machine Group')?>: </label><span id="man_vm_group" <?php echo $edit?>><?php echo print_something($key->man_vm_group)?></span><?php echo $edit_icon; ?></p>
							<?php } else { ?>
								...
								<p><label for="man_icon"><?php echo __('Icon')?>: </label>
									<span id="man_icon">
										<a href="#" onclick="window.open('<?php echo base_url(); ?>index.php/admin_system/system_icon/<?php echo $system_id; ?>', 'Icon Picker', 'height=300,left=100,location=no,menubar=no,resizable=no,scrollbars=yes,status=no,titlebar=no,toolbar=no,top=100,width=400');" alt="Click to edit">
											<img src="<?php echo base_url()?>theme-tango/tango-images/16_<?php echo $key->man_icon?>.png" /> (<span style="color: blue;"><?php echo str_replace('16_', '', str_replace('_', ' ', $key->man_icon)); ?>) </span></a></span><?php echo $edit_icon; ?></p>
							<?php } else { ?>
			...
			<div style="margin-right: 120px;">
				<label for="man_os_name"><?php echo __('OS Name')?>: </label><span id="man_os_name" <?php echo $edit?>><?php echo print_something($os_name)?></span><?php echo $edit_icon; ?>
			</div>
