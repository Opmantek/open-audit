...
$get_oid_details = function($details){
	...
	if ($details->snmp_oid == '1.3.6.1.4.1.2011.2.170.2') { $details->model = 'S9306 Terabit Routing Switch'; $details->type = 'switch'; }
	...
	if ($details->snmp_oid == '1.3.6.1.4.1.2011.2.220.3') { $details->model = 'ATN 910'; $details->type = 'router'; }
	if ($details->snmp_oid == '1.3.6.1.4.1.2011.2.220.4') { $details->model = 'ATN 950'; $details->type = 'router'; }
	...
	if ($details->snmp_oid == '1.3.6.1.4.1.2011.2.87.18') { $details->model = 'CX600-X8 Carrier Switch'; $details->type = 'switch'; }
	if ($details->snmp_oid == '1.3.6.1.4.1.2011.2.87.20') { $details->model = 'CX600-X1 Carrier Switch'; $details->type = 'switch'; }
	if ($details->snmp_oid == '1.3.6.1.4.1.2011.2.87.21') { $details->model = 'CX600-X2 Carrier Switch'; $details->type = 'switch'; }
