...
if (! function_exists('inputRead')) {
    ...
    function inputRead()
    {
        ...
        $collections = ' charts configuration connections credentials dashboards database devices discovery discoveries fields files groups ldap_servers licenses locations networks nmis orgs queries roles scripts users ';
        $collection = '';
