...
if (! function_exists('set_collection')) {
    function set_collection()
    {
        ...
        $collections = array('agents','applications','attributes','charts','clouds','collectors','configuration','connections','credentials','dashboards','database','devices','discovery','discoveries','errors','fields','files','groups','ldap_servers','licenses','locations','logs','networks','nmis','orgs','queries','racks','reports','roles','scripts','search','summaries','tasks','users','widgets');
...
if (! function_exists('inputRead')) {
    ...
    function inputRead()
    {
        ...
        $collections = ' agents applications attributes charts clouds collectors configuration connections credentials dashboards database devices discovery discoveries errors fields files groups ldap_servers licenses locations logs networks nmis orgs queries reports roles scripts search summaries tasks users widgets ';
        $collection = '';
