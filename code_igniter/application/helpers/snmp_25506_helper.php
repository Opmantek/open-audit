...
$get_oid_details = function($details){
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.1') { $details->model = 'S5500-28C-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.10') { $details->model = 'S5500-28C-PWR-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.11') { $details->model = 'S5500-52C-PWR-SI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.12') { $details->model = 'S5510-24P'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.13') { $details->model = 'S5510-24F'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.14') { $details->model = 'S3610-28P'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.147') { $details->model = 'S9502'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.148') { $details->model = 'S9505'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.149') { $details->model = 'S9508'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.15') { $details->model = 'S3610-52P'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.150') { $details->model = 'S9508V'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.151') { $details->model = 'S9512'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.159') { $details->model = 'S7510E'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.16') { $details->model = 'S3610-28TP'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.160') { $details->model = 'S5100-24P-SI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.161') { $details->model = 'S5100-48P-SI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.162') { $details->model = 'S5100-8P-SI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.163') { $details->model = 'S5100-16P-SI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.164') { $details->model = 'S5100-8P-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.165') { $details->model = 'S5100-16P-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.166') { $details->model = 'S5100-8P-PWR-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.167') { $details->model = 'S5100-16P-PWR-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.168') { $details->model = 'S5100-26C-PWR-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.169') { $details->model = 'S5100-50C-PWR-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.17') { $details->model = 'S3610-28F'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.170') { $details->model = 'S3108TP-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.171') { $details->model = 'S3116TP-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.172') { $details->model = 'S3126TP-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.173') { $details->model = 'S3108TP-EI-PWR'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.174') { $details->model = 'S3116TP-EI-PWR'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.175') { $details->model = 'S3126TP-EI-PWR'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.176') { $details->model = 'S7502M'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.180') { $details->model = 'S9505-V5'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.181') { $details->model = 'S9512-V5'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.182') { $details->model = 'S9508-V5'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.183') { $details->model = 'S9508V-V5'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.184') { $details->model = 'S9502-V5'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.189') { $details->model = 'S3100-52P'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.191') { $details->model = 'S2008'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.192') { $details->model = 'S2026'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.195') { $details->model = 'S3100-8TP-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.196') { $details->model = 'S3100-8TP-PWR-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.197') { $details->model = 'S3100-16TP-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.198') { $details->model = 'S3100-15TP-PWR-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.199') { $details->model = 'S3100-26TP-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.2') { $details->model = 'S5500-52C-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.200') { $details->model = 'S3100-26TP-PWR-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.201') { $details->model = 'S7502-V5'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.207') { $details->model = 'S7503E'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.208') { $details->model = 'S7503E'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.209') { $details->model = 'S7506E'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.21') { $details->model = 'S3100-8C-SI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.210') { $details->model = 'S7506E-V'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.213') { $details->model = 'S3100-8TP-SI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.214') { $details->model = 'S3100-16TP-SI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.216') { $details->model = 'S3100-26TP-SI-B'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.219') { $details->model = 'S2126-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.22') { $details->model = 'S3100-16C-SI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.23') { $details->model = 'S3100-26C-SI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.230') { $details->model = 'MSR20-11'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.236') { $details->model = 'S3610-52M'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.24') { $details->model = 'S3100-8T-SI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.240') { $details->model = 'S5024P'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.241') { $details->model = 'S5016P'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.244') { $details->model = 'S3100-8TP-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.245') { $details->model = 'S3100-16TP-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.246') { $details->model = 'S3100-26TP-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.25') { $details->model = 'S3100-16T-SI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.256') { $details->model = 'S3100-52TP'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.258') { $details->model = 'S1550E'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.259') { $details->model = 'S1550'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.26') { $details->model = 'S3100-26T-SI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.260') { $details->model = 'S1526-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.264') { $details->model = 'WX6103'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.265') { $details->model = 'WX6100LSQ'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.266') { $details->model = 'WX6100SB'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.267') { $details->model = 'WX6100SW'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.27') { $details->model = 'S3100-26TP-SI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.274') { $details->model = 'S7501M-24T'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.275') { $details->model = 'S7501M-24TP'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.276') { $details->model = 'S7502M'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.277') { $details->model = 'S7503M'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.278') { $details->model = 'S7506M'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.279') { $details->model = 'S7506M-V'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.28') { $details->model = 'S5100-24P-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.280') { $details->model = 'S7510M'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.29') { $details->model = 'S5100-26C-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.290') { $details->model = 'S5520TP-SI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.297') { $details->model = 'S3100-52TP-SI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.3') { $details->model = 'S5500-28C-PWR-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.30') { $details->model = 'S5100-50C-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.31') { $details->model = 'S5100-48P-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.318') { $details->model = 'S5024E'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.319') { $details->model = 'S5048E'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.32') { $details->model = 'S3600-28P-SI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.325') { $details->model = 'S7501E'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.326') { $details->model = 'S3100-8C-EPON-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.327') { $details->model = 'S3100-16C-EPON-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.328') { $details->model = 'S3100-26C-EPON-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.33') { $details->model = 'S3600-52P-SI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.334') { $details->model = 'S5800-32C'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.335') { $details->model = 'S5800-56C'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.336') { $details->model = 'S5800-32C-PWR'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.337') { $details->model = 'S5800-56C-PWR'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.338') { $details->model = 'S5800-60C-PWR'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.339') { $details->model = 'S5800-32F'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.34') { $details->model = 'S3600-28TP-SI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.340') { $details->model = 'S5800X-28C'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.341') { $details->model = 'S5800X-28S'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.35') { $details->model = 'S3600-28P-PWR-SI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.358') { $details->model = 'S7602'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.359') { $details->model = 'S7603'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.36') { $details->model = 'S3600-52P-PWR-SI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.360') { $details->model = 'S7606'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.361') { $details->model = 'S7606-V'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.362') { $details->model = 'S7610'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.37') { $details->model = 'S3600-28P-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.370') { $details->model = 'S7503E-S'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.38') { $details->model = 'S3600-52P-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.388') { $details->model = 'S9505E'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.389') { $details->model = 'S9508E-V'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.39') { $details->model = 'S3600-28P-PWR-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.390') { $details->model = 'S9512E'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.391') { $details->model = 'S12508'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.392') { $details->model = 'S12518'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.395') { $details->model = 'S2008TP-EA'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.396') { $details->model = 'S2016TP-EA'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.397') { $details->model = 'S2403TP-EA'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.4') { $details->model = 'S5500-52C-PWR-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.40') { $details->model = 'S3600-52P-PWR-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.400') { $details->model = 'S3528P-EA'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.401') { $details->model = 'S3552P-EA'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.402') { $details->model = 'S3552F-EA'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.403') { $details->model = 'S3528F-EA'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.404') { $details->model = 'S3528TP-EA'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.41') { $details->model = 'S3600-28F-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.42') { $details->model = 'S5600-26C'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.43') { $details->model = 'S5600-50C'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.439') { $details->model = 'S3620-28TP-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.44') { $details->model = 'S5600-26C-PWR'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.440') { $details->model = 'S3620-28P-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.441') { $details->model = 'S3620-52P-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.442') { $details->model = 'S3620-28P-PWR-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.443') { $details->model = 'S3820-52P-PWR-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.444') { $details->model = 'S3620-28F-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.445') { $details->model = 'S3620-52M'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.446') { $details->model = 'S3620-52M-DC'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.447') { $details->model = 'S3620-28C-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.45') { $details->model = 'S5600-50C-PWR'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.453') { $details->model = 'S5810-50S'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.46') { $details->model = 'S5600-26F'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.461') { $details->model = 'S5120-20P-SI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.462') { $details->model = 'S5120-28P-SI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.463') { $details->model = 'S5120-52P-SI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.464') { $details->model = 'S5120-28P-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.465') { $details->model = 'S5120-52P-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.466') { $details->model = 'S5120-28P-LPWR-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.467') { $details->model = 'S5120-29P-PWR-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.468') { $details->model = 'WX6100LSR'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.469') { $details->model = 'S7506E'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.47') { $details->model = 'S3600-52G-HI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.472') { $details->model = 'S1626'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.473') { $details->model = 'S1650'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.474') { $details->model = 'S1626P'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.48') { $details->model = 'S3600-52P-HI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.49') { $details->model = 'S3600-28G-HI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.499') { $details->model = 'S7602S'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.5') { $details->model = 'S5500-28F-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.50') { $details->model = 'S3600-28P-HI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.500') { $details->model = 'S7603-ES'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.501') { $details->model = 'S7606-ES'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.51') { $details->model = 'S3600-52M-HI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.512') { $details->model = 'S2008TP-EA(SI)'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.513') { $details->model = 'S2016TP-EA(SI)'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.514') { $details->model = 'S2403TP-EA(SI)'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.515') { $details->model = 'S5120-24P-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.516') { $details->model = 'S5120-48P-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.517') { $details->model = 'S5120-28C-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.518') { $details->model = 'S5120-52C-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.519') { $details->model = 'S5120-28C-PWR-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.52') { $details->model = 'S7502'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.520') { $details->model = 'S5120-52C-PWR-EI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.53') { $details->model = 'S7503'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.54') { $details->model = 'S7506'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.55') { $details->model = 'S7506R'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.6') { $details->model = 'S5500-28C-EI-DC'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.7') { $details->model = 'S6100-20Q-SI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.8') { $details->model = 'S5500-28C-SI'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.25506.1.9') { $details->model = 'S5500-52C-SI'; $details->type = 'unknown'; }
