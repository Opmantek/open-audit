...
$get_oid_details = function($details){
	if ($details->snmp_oid =='1.3.6.1.4.1.2636.1.1.1.1.1') { $details->model = 'M-40 Router'; $details->type = 'router'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.2636.1.1.1.1.2') { $details->model = 'M-20 Router'; $details->type = 'router'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.2636.1.1.1.1.3') { $details->model = 'M-160 Router'; $details->type = 'router'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.2636.1.1.1.1.4') { $details->model = 'M-10 Router'; $details->type = 'router'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.2636.1.1.1.1.5') { $details->model = 'M-5 Router'; $details->type = 'router'; }
	...
	if ($details->snmp_oid =='1.3.6.1.4.1.2636.1.1.1.2.76') { $details->model = 'EX3300'; $details->type = 'unknown'; }
	...
	if ($details->snmp_oid =='1.3.6.1.4.1.2636.1.1.1.2.90') { $details->model = 'MX5'; $details->type = 'unknown'; }
	if ($details->snmp_oid =='1.3.6.1.4.1.2636.3.41.1.1.5.5') { $details->model = 'WXC-2600'; $details->type = 'unknown'; }
