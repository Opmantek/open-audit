...
/**
* Base Object DiscoveryScanOptions
*
* @access   public
* @category Controller
* @package  Discoveries
...
* @link     http://www.open-audit.org
 */
class Discovery_scan_options extends MY_Controller
{
    /**
    * Constructor
    *
    ...
    */
    public function import_form()
    {
        ...
        $this->response->data = $this->m_database->read('discovery_scan_options');
...
// End of file discovery_scan_options.php
// Location: ./controllers/discovery_scan_options.php
