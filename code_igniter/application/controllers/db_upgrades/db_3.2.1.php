...
UPDATE `configuration` SET `value` = '20190919' WHERE `name` = 'internal_version';

UPDATE `configuration` SET `value` = '3.2.1' WHERE `name` = 'display_version';
*/

$this->log_db('Upgrade database to 3.2.1 commenced');
...
$this->config->config['display_version'] = '3.2.1';
