...
$this->db_log('Upgrade database to 1.12.6 commenced');

$this->drop_foreign_key('sys_man_additional_fields', 'sys_man_additional_fields_group_id');
$this->drop_foreign_key('sys_man_additional_fields', 'sys_man_additional_fields_group');
...
$this->alter_table('oa_user', 'user_change', "DROP user_change");
...
$this->alter_table('service', 'count', "DROP count");
...
$this->alter_table('system', 'dbus_identifier', "`dbus_identifier` varchar(255) NOT NULL DEFAULT '' AFTER uuid", 'add');
...
$this->db_log('Upgrade database to 1.12.6 completed');
