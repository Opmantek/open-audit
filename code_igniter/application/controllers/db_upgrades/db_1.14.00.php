...
if ($result[0]->count > 0) {
    ...
    if ($result[0]->count == 0) {
        // Insert the default Org
        $sql = "INSERT INTO `oa_location` VALUES (1,'Default Location',1,'Office','','','','','','Gold Coast','','','','Queensland','','Australia','','','',-28.017260,153.425705,'','Default location','office','system','2000-01-01 00:00:00')";
        $query = $this->db->query($sql);
        $this->log_db($this->db->last_query());
    }
}
