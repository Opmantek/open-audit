...
DELETE FROM `rules` WHERE `edited_by` = 'system'
...
UPDATE `configuration` SET `value` = '20190923' WHERE `name` = 'internal_version';

UPDATE `configuration` SET `value` = '3.2.2' WHERE `name` = 'display_version';
*/

$this->log_db('Upgrade database to 3.2.2 commenced');
...
$this->log_db("Upgrade database to 3.2.2 completed");
$this->config->config['internal_version'] = '20190923';
$this->config->config['display_version'] = '3.2.2';
