...
$this->alter_table('system', 'nmis_export', "`nmis_manage` enum('y','n') NOT NULL DEFAULT 'n'");
$this->alter_table('system', 'nmis_notes', "ADD `nmis_notes` TEXT NOT NULL AFTER `nmis_manage`", 'add');
$this->alter_table('system', 'nmis_business_service', "ADD `nmis_business_service` varchar(50) NOT NULL DEFAULT '' AFTER `nmis_notes`", 'add');
