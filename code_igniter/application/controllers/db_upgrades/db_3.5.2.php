...
UPDATE `configuration` SET `value` = '3.5.2' WHERE `name` = 'display_version';
*/
...
$this->log_db('Upgrade database to 3.5.2 completed');
$this->config->config['internal_version'] = '20201115';
$this->config->config['display_version'] = '3.5.2';
