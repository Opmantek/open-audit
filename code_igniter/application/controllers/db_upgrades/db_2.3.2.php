...
$sql = "INSERT INTO `configuration` VALUES (NULL,'discovery_default_preset','1','number','n','system','2000-01-01 00:00:00','The default discovery preset for Nmap settings.')";
$this->db->query($sql);
$this->log_db($this->db->last_query());
