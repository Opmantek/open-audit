...
$sql[] = "DELETE FROM `queries` WHERE name = 'Billing Report'";
...
$sql[] = "DELETE FROM `queries` WHERE name = 'Installed - Acrobat'";
$sql[] = "INSERT INTO `queries` VALUES (NULL,1,'Installed - Acrobat','Adobe Acrobat installations (software name contains 'acrobat' or 'adobe reader').',\"SELECT system.id AS `system.id`, system.icon AS `system.icon`, system.type AS `system.type`, system.name AS `system.name`, system.domain AS `system.domain`, system.ip AS `system.ip`, system.class AS `system.class`, system.os_family AS `system.os_family`, orgs.name AS `orgs.name`, windows.user_name AS `windows.user_name`, software.name as `software.name`, software.version AS `software.version`, software.id as `software.id` FROM software LEFT JOIN system ON (software.system_id = system.id AND software.current = 'y' AND (software.name LIKE '%acrobat%' OR software.name LIKE 'adobe reader%')) LEFT JOIN orgs ON (orgs.id = system.org_id) LEFT JOIN windows ON (windows.system_id = system.id AND windows.current = 'y') WHERE @filter\", \"\", \"y\", \"system\", '2000-01-01 00:00:00')";

$sql[] = "DELETE FROM `queries` WHERE name = 'Installed - Antivirus'";
$sql[] = "INSERT INTO `queries` VALUES (NULL,1,'Installed - Antivirus','Installed AntiVirus software (software name contains 'virus' or 'trend micro' or 'endpoint').',\"SELECT system.id AS `system.id`, system.icon AS `system.icon`, system.type AS `system.type`, system.name AS `system.name`, system.domain AS `system.domain`, system.ip AS `system.ip`, system.class AS `system.class`, system.os_family AS `system.os_family`, orgs.name AS `orgs.name`, windows.user_name AS `windows.user_name`, software.name as `software.name`, software.version AS `software.version` FROM system LEFT JOIN software ON (software.system_id = system.id AND software.current = 'y' AND (software.name LIKE '%virus%' or software.name LIKE '%trend micro%' or software.name LIKE '%endpoint%')) LEFT JOIN orgs ON (orgs.id = system.org_id) LEFT JOIN windows ON (windows.system_id = system.id AND windows.current = 'y') WHERE @filter AND system.type = 'computer'\", \"\", \"y\", \"system\", '2000-01-01 00:00:00')";

$sql[] = "DELETE FROM `queries` WHERE name = 'Installed - MS FrontPage'";
...
$sql[] = "DELETE FROM `queries` WHERE name = 'Installed - MS Office'";
$sql[] = "INSERT INTO `queries` VALUES (NULL,1,'Installed - MS Office','MS Office installations.',\"SELECT system.id AS `system.id`, system.icon AS `system.icon`, system.type AS `system.type`, system.name AS `system.name`, system.domain AS `system.domain`, system.ip AS `system.ip`, system.class AS `system.class`, system.os_family AS `system.os_family`, orgs.name AS `orgs.name`, windows.user_name AS `windows.user_name`, software.name as `software.name`, software.version AS `software.version`, software.id as `software.id` FROM software LEFT JOIN system ON (software.system_id = system.id AND software.current = 'y' AND software.name LIKE 'Microsoft Office%') LEFT JOIN orgs ON (orgs.id = system.org_id) LEFT JOIN windows ON (windows.system_id = system.id AND windows.current = 'y') WHERE @filter\", \"\", \"y\", \"system\", '2000-01-01 00:00:00')";


$sql[] = "DELETE FROM `queries` WHERE name = 'Installed - MS Project'";
...
$sql[] = "DELETE FROM `queries` WHERE name = 'Installed - MS Visio'";
$sql[] = "INSERT INTO `queries` VALUES (NULL,1,'Installed - MS Visio','MS Visio installations (software name contains 'Microsoft Visio').',\"SELECT system.id AS `system.id`, system.icon AS `system.icon`, system.type AS `system.type`, system.name AS `system.name`, system.domain AS `system.domain`, system.ip AS `system.ip`, system.class AS `system.class`, system.os_family AS `system.os_family`, orgs.name AS `orgs.name`, windows.user_name AS `windows.user_name`, software.name as `software.name`, software.version AS `software.version`, software.id as `software.id` FROM software LEFT JOIN system ON (software.system_id = system.id AND software.current = 'y' AND software.name LIKE 'Microsoft%Visio%') LEFT JOIN orgs ON (orgs.id = system.org_id) LEFT JOIN windows ON (windows.system_id = system.id AND windows.current = 'y') WHERE @filter\", \"\", \"y\", \"system\", '2000-01-01 00:00:00')";
