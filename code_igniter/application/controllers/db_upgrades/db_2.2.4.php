...
$sql = "UPDATE `configuration` SET `value` = '2.2.4' WHERE `name` = 'display_version'";
$this->db->query($sql);
$this->log_db($this->db->last_query());

$this->log_db("Upgrade database to 2.2.4 completed");
$this->config->config['internal_version'] = '20180630';
$this->config->config['display_version'] = '2.2.4';
