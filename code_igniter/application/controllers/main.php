...
class Main extends MY_Controller
{
    ...
    */
    ...
    public function summary()
    {
        ...
        $items = array();
        $items[] = array('name' => 'applications', 'icon' => 'fa-snowflake-o');
        ...
        $items[] = array('name' => 'dashboards', 'icon' => 'fa-dashboard');
        ...
        //$items[] = array('name' => 'discovery_scan_options', 'icon' => 'fa-random');
        $items[] = array('name' => 'fields', 'icon' => 'fa-comments-o');
        $items[] = array('name' => 'files', 'icon' => 'fa-file-image-o');
        //$items[] = array('name' => 'floors', 'icon' => 'fa-sort-numeric-desc');
        ...
        $items[] = array('name' => 'locations', 'icon' => 'fa-building');
        ...
        // $items[] = array('name' => 'rooms', 'icon' => 'fa-plus-square-o');
        // $items[] = array('name' => 'rows', 'icon' => 'fa-hashtag');
        $items[] = array('name' => 'rules', 'icon' => 'fa-map-signs');
        $items[] = array('name' => 'scripts', 'icon' => 'fa-code');
        $items[] = array('name' => 'summaries', 'icon' => 'fa-pie-chart');
    ...
    public function api_node_config_new()
    {
        ...
        if (isset($system_id) and $system_id != '') {
            ...
            $tables = array('bios', 'credentials', 'disk', 'dns', 'ip', 'memory', 'module', 'monitor', 'motherboard', 'netstat', 'network', 'optical', 'pagefile', 'partition', 'print_queue', 'processor', 'radio', 'route', 'san', 'scsi', 'service', 'server', 'server_item', 'share', 'software', 'software_key', 'sound', 'task', 'user', 'user_group', 'variable', 'video', 'vm', 'windows');
