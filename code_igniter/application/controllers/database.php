...
class Database extends MY_Controller
{
    ...
    */
    ...
    public function update()
    {
        ...
        if (($db_internal_version < '20220620') and ($this->db->platform() == 'mysql' or $this->db->platform() == 'mysqli')) {
            # upgrade for 4.3.4
        ...
        if (($db_internal_version < '20230126') and ($this->db->platform() == 'mysql' or $this->db->platform() == 'mysqli')) {
            # upgrade for 4.4.1
            include "db_upgrades/db_4.4.1.php";
        }

        if (($db_internal_version < '20230208') and ($this->db->platform() == 'mysql' or $this->db->platform() == 'mysqli')) {
            # upgrade for 4.4.2
            include "db_upgrades/db_4.4.2.php";
        }
