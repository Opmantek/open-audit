...
class Collectors extends MY_Controller
{
    ...
    */
    ...
    {
        $this->response->dictionary = $this->m_collectors->dictionary();
        $this->load->model('m_orgs');
        $this->response->included = array_merge($this->response->included, $this->m_orgs->collection($this->user->id));
        output($this->response);
    }
    ...
    */
    public function import_form()
    {
        ...
        $this->response->data = $this->m_database->read('collectors');
...
// End of file collectors.php
// Location: ./controllers/collectors.php
