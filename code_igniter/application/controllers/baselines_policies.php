...
* @link     http://www.open-audit.org
 */
class Baselines_policies extends MY_Controller
{
    /**
    * Constructor
    *
    ...
    */
    ...
    {
        parent::__construct();
        $this->load->model('m_baselines_policies');
        // inputRead();
    ...
    */
    ...
    {
        $this->response->dictionary = $this->m_baselines_policies->dictionary();
        $this->load->model('m_orgs');
        $this->response->included = array_merge($this->response->included, $this->m_orgs->collection($this->user->id));     
        output($this->response);
    }
}
// End of file baselines_policies.php
// Location: ./controllers/baselines_policies.php
