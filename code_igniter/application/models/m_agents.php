...
class M_agents extends MY_Model
{
    ...
    */
    ...
    {
        if ($id = $this->insert_collection('agents', $data)) {
            return intval($id);
        } else {
            return false;
        }
    ...
    public function count()
    {
        ...
        $sql = 'SELECT COUNT(id) AS `count` FROM agents WHERE org_id IN (' . implode(',', $org_list) . ')';
    ...
    public function dictionary()
    {
        ...
        $dictionary->columns->check_minutes = '';
        $dictionary->columns->user_id = '';
        $dictionary->columns->uuid = '';
