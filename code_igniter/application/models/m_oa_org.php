...
class M_oa_org extends MY_Model
{
    ...
    public function check_org_name($org_name, $org_id)
    {
    ...
    public function get_group_id($org_id)
    {
    ...
    public function set_group_id($org_id, $group_id)
    {
    ...
    public function select_org($org_name)
    {
    ...
    public function add_org($details)
    {
        $sql = "INSERT INTO
				oa_org
				(org_name,
    ...
    public function edit_org($details)
    {
        $sql = "UPDATE
				oa_org
			SET
    ...
    public function list_devices_in_org($org_id = 0, $user_id = 0)
    {
