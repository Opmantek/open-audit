...
class ApplicationsComponentsModel extends BaseModel
{
     ...
     * builder to target the 'applications_components' table.
     */
     ...
     *
     * @param  int|null $id    The ID of the applications_component to delete
    ...
    /**
     * Return supplementary data for a single applications_component's read view (stub)
     *
    ...
    /**
     * Return supplementary data for the applications_component collection view (stub)
     *
     * Reserved for future implementation. Currently returns an empty array.
     *
     * @return array  An empty array
    ...
    /**
     * Return supplementary data for the applications_component create/edit form (stub)
     *
     * Reserved for future implementation. Currently returns an empty array;
     * no data is fetched from the database.
     *
     ...
     *
     * @return array        An array of formatted applications_components entries
     */
    ...
    /**
     * Read every applications_component from the database with no org-based filtering
     *
     * Returns all rows from the `applications_components` table with no additional filtering.
     * Use {@see listUser()} when results should be restricted to the current user's accessible orgs.
     *
     * @return array  Array of stdClass objects representing every applications_component row
     */
    ...
    /**
     * Truncate the applications_components table, removing all rows
     *
     * The $table parameter is accepted for interface compatibility but is
     * ignored; the method always resets the 'applications_components' table.
     *
     ...
     *
     * @param  int|null          $id   The ID of the applications_component to update
    ...
    /**
     * Build and return the data dictionary for the applications_components collection
     *
     * Constructs a stdClass describing the `applications_components` table for use by the
     * framework's help, validation, and API-documentation systems.
     * The returned object includes:
     *  - table       : the collection name ('applications_components')
