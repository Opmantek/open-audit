...
class NetworksModel extends BaseModel
{
    ...
    public function dictionary(): object
    {
        ...
        $dictionary->attributes->create = array('name', 'org_id', 'type', 'network'); # We MUST have each of these present and assigned a value # TODO - wiki says name, org_id, network. Check this.
