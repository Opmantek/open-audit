...
class LicensesModel extends BaseModel
{
     ...
     * builder to target the 'licenses' table.
     */
     ...
     *
     * @param  int|null $id    The ID of the license to delete
    ...
    /**
     * Return supplementary data for a single license's read view (stub)
     *
    ...
    /**
     * Return supplementary data for the license create/edit form (stub)
     *
     * Reserved for future implementation. Currently returns an empty array;
     * no data is fetched from the database.
     *
     ...
     *
     * @return array        An array of formatted licenses entries
     */
    ...
    /**
     * Read every license from the database with no org-based filtering
     *
     * Returns all rows from the `licenses` table with no additional filtering.
     * Use {@see listUser()} when results should be restricted to the current user's accessible orgs.
     *
     * @return array  Array of stdClass objects representing every license row
     */
    ...
    /**
     * Truncate the licenses table, removing all rows
     *
     * The $table parameter is accepted for interface compatibility but is
     * ignored; the method always resets the 'licenses' table.
     *
     ...
     *
     * @param  int|null          $id   The ID of the license to update
    ...
    /**
     * Build and return the data dictionary for the licenses collection
     *
     * Constructs a stdClass describing the `licenses` table for use by the
     * framework's help, validation, and API-documentation systems.
     * The returned object includes:
     *  - table       : the collection name ('licenses')
