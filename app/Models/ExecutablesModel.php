...
class ExecutablesModel extends BaseModel
{
     ...
     * builder to target the 'executables' table.
     */
     ...
     *
     * @param  int|null $id    The ID of the executable to delete
    ...
    /**
     * Return supplementary data for a single executable's read view (stub)
     *
    ...
    /**
     * Return supplementary data for the executable create/edit form (stub)
     *
     * Reserved for future implementation. Currently returns an empty array;
     * no data is fetched from the database.
     *
     ...
     *
     * @return array        An array of formatted executables entries
     */
    ...
    /**
     * Read every executable from the database with no org-based filtering
     *
     * Returns all rows from the `executables` table with no additional filtering.
     * Use {@see listUser()} when results should be restricted to the current user's accessible orgs.
     *
     * @return array  Array of stdClass objects representing every executable row
     */
    ...
    /**
     * Truncate the executables table, removing all rows
     *
     * The $table parameter is accepted for interface compatibility but is
     * ignored; the method always resets the 'executables' table.
     *
     ...
     *
     * @param  int|null          $id   The ID of the executable to update
    ...
    /**
     * Build and return the data dictionary for the executables collection
     *
     * Constructs a stdClass describing the `executables` table for use by the
     * framework's help, validation, and API-documentation systems.
     * The returned object includes:
     *  - table       : the collection name ('executables')
