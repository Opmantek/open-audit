...
class VulnerabilitiesModel extends BaseModel
{
     ...
     * builder to target the 'vulnerabilities' table.
     */
     ...
     *
     * @param  int|null $id    The ID of the vulnerability to delete
    ...
    /**
     * Return supplementary data for the vulnerability create/edit form
     *
     * @param  int   $id The ID of the vulnerability whose supplementary data to load
     *
    ...
    /**
     * Return supplementary data for a single vulnerability's read view
     *
     * @param  int   $id The ID of the vulnerability whose supplementary data to load
     *
     ...
     *
     * @return array        An array of formatted vulnerabilities entries
     */
    ...
    /**
     * Read every vulnerability from the database with no org-based filtering
     *
     * Returns all rows from the `vulnerabilities` table with no additional filtering.
     * Use {@see listUser()} when results should be restricted to the current user's accessible orgs.
     *
     * @return array  Array of stdClass objects representing every vulnerability row
     */
    ...
    /**
     * Truncate the vulnerabilities table, removing all rows
     *
     * The $table parameter is accepted for interface compatibility but is
     * ignored; the method always resets the 'vulnerabilities' table.
     *
     ...
     *
     * @param  int|null          $id   The ID of the vulnerability to update
    ...
    /**
     * Build and return the data dictionary for the vulnerabilities collection
     *
     * Constructs a stdClass describing the `vulnerabilities` table for use by the
     * framework's help, validation, and API-documentation systems.
     * The returned object includes:
     *  - table       : the collection name ('vulnerabilities')
