...
class DiscoveryScanOptionsModel extends BaseModel
{
     ...
     * builder to target the 'discovery_scan_options' table.
     */
     ...
     *
     * @param  int|null $id    The ID of the discovery_scan_option to delete
    ...
    /**
     * Return supplementary data for a single discovery_scan_option's read view (stub)
     *
    ...
    /**
     * Return supplementary data for the discovery_scan_option create/edit form (stub)
     *
     * Reserved for future implementation. Currently returns an empty array;
     * no data is fetched from the database.
     *
     ...
     *
     * @return array        An array of formatted discovery_scan_options entries
     */
    ...
    /**
     * Read every discovery_scan_option from the database with no org-based filtering
     *
     * Returns all rows from the `discovery_scan_options` table with no additional filtering.
     * Use {@see listUser()} when results should be restricted to the current user's accessible orgs.
     *
     * @return array  Array of stdClass objects representing every discovery_scan_option row
     */
    ...
    /**
     * Truncate the discovery_scan_options table, removing all rows
     *
     * The $table parameter is accepted for interface compatibility but is
     * ignored; the method always resets the 'discovery_scan_options' table.
     *
     ...
     *
     * @param  int|null          $id   The ID of the discovery_scan_option to update
    ...
    /**
     * Build and return the data dictionary for the discovery_scan_options collection
     *
     * Constructs a stdClass describing the `discovery_scan_options` table for use by the
     * framework's help, validation, and API-documentation systems.
     * The returned object includes:
     *  - table       : the collection name ('discovery_scan_options')
