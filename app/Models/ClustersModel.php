...
class ClustersModel extends BaseModel
{
     ...
     * builder to target the 'clusters' table.
     */
     ...
     *
     * @param  int|null $id    The ID of the cluster to delete
    ...
    /**
     * Return supplementary data for a single cluster's read view (stub)
     *
    ...
    /**
     * Return supplementary data for the cluster create/edit form
     *
     * @param  int   $id The ID of the cluster whose supplementary data to load
     *
     ...
     *
     * @return array        An array of formatted clusters entries
     */
    ...
    /**
     * Read every cluster from the database with no org-based filtering
     *
     * Returns all rows from the `clusters` table with no additional filtering.
     * Use {@see listUser()} when results should be restricted to the current user's accessible orgs.
     *
     * @return array  Array of stdClass objects representing every cluster row
     */
    ...
    /**
     * Truncate the clusters table, removing all rows
     *
     * The $table parameter is accepted for interface compatibility but is
     * ignored; the method always resets the 'clusters' table.
     *
     ...
     *
     * @param  int|null          $id   The ID of the cluster to update
    ...
    /**
     * Build and return the data dictionary for the clusters collection
     *
     * Constructs a stdClass describing the `clusters` table for use by the
     * framework's help, validation, and API-documentation systems.
     * The returned object includes:
     *  - table       : the collection name ('clusters')
