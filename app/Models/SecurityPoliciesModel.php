...
class SecurityPoliciesModel extends BaseModel
{

    public function __construct()
    {
        $this->db = db_connect();
        $this->builder = $this->db->table('security_policies');
    ...
    public function create($data = null): ?int
    {
        ...
        $data = $this->createFieldData('security_policies', $data);
        if (empty($data)) {
            return null;
        }
    ...
    public function listUser($where = array(), $orgs = array()): array
    {
        ...
        $properties = array();
        $properties[] = 'security_policies.*';
        $properties[] = 'orgs.name as `orgs.name`';
        $this->builder->select($properties, false);
        $this->builder->join('orgs', 'security_policies.org_id = orgs.id', 'left');
        ...
        return format_data($query->getResult(), 'security_policies');
    }
    ...
    {
        if ($this->tableReset('security_policies')) {
            return true;
        }
        return false;
    }
    ...
    {
        $data = $this->updateFieldData('security_policies', $data);
    ...
    public function dictionary(): object
    {
        ...
        $dictionary->columns->security_id = 'Links to <code>security.id</code>.';
        $dictionary->columns->external_ident = 'The ID from the imported security policy.';
