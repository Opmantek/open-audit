...
$get_oid_details = function ($ip, $credentials, $oid) {
    ...
    $details->os_family = 'Pan-OS';
    $details->os_group = 'Pan-OS';
    $details->os_version = my_snmp_get($ip, $credentials, "1.3.6.1.4.1.25461.2.1.2.1.1.0");
    $details->os_name = 'Pan-OS';
    $details->os_cpe = !empty($details->os_version) ? 'cpe:2.3:o:paloaltonetworks:pan-os:' . $details->os_version : 'cpe:2.3:o:paloaltonetworks:pan-os';
    return($details);
};
