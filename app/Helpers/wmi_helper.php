...
if (! function_exists('copy_to_windows')) {
     ...
     * @return    false || true
     */
    function copy_to_windows($ip = '', $credentials = null, $share = '', $source = '', $destination = '', $log = null)
    {
        $log->file = 'wmi_helper';
...
if ( ! function_exists('copy_from_windows')) {
     ...
     */
    function copy_from_windows($ip = '', $credentials = null, $source = '', $destination = '', $log = null)
    {
        $log->file = 'wmi_helper';
...
if (! function_exists('wmi_command')) {
     ...
     * @return    false || $return array containing the output and status flag
     */
    function wmi_command($ip = '', $credentials = null, $command = '', $log = null)
    {
...
if ( ! function_exists('windows_ips_found')) {
     ...
     */
    function windows_ips_found($ip = '', $credentials = null, $discovery_id = null)
    {
        $log = new \StdClass();
...
if ( ! function_exists('wmi_audit')) {
     ...
     * @return [type]               [description]
     */
    function wmi_audit($ip = '', $credentials = null, $log = null, $discovery_id = null)
    {
        if (is_null($log)) {
            $log = new \StdClass();
        }
