...
function ssg_definitions()
{
    ...
    $item->file = 'ssg-debian10-ds-1.2.xml';
    ...
    $item->os_family = 'Debian';
    $item->os_version = '10';
    $item->title = 'Standard System Security Profile for Debian 10';
    $item->file = 'ssg-debian10-ds-1.2.xml';
    $item->benchmark = 'xccdf_org.ssgproject.content_profile_standard';
    $ssg_definitions[] = $item;
    ...
    $item->os_version = '11';
    $item->title = 'Profile for ANSSI DAT-NT28 Average (Intermediate) Level';
    $item->file = 'ssg-debian11-ds-1.2.xml';
    $item->benchmark = 'xccdf_org.ssgproject.content_profile_anssi_np_nt28_average';
    $ssg_definitions[] = $item;
    ...
    $item->os_family = 'Debian';
    $item->os_version = '11';
    $item->title = 'Standard System Security Profile for Debian 11';
    $item->file = 'ssg-debian11-ds-1.2.xml';
    $item->benchmark = 'xccdf_org.ssgproject.content_profile_standard';
    $ssg_definitions[] = $item;
    ...
    $item = new \stdClass();
    $item->os_family = 'Oracle';
    $item->os_version = '7';
    $item->title = 'ANSSI-BP-028 (enhanced)';
    $item->file = 'ssg-ol7-ds-1.2.xml';
    $item->benchmark = 'xccdf_org.ssgproject.content_profile_anssi_nt28_enhanced';
    $ssg_definitions[] = $item;
    ...
    $item->os_family = 'Oracle';
    $item->os_version = '7';
    $item->title = 'DRAFT - ANSSI-BP-028 (high)';
    $item->file = 'ssg-ol7-ds-1.2.xml';
    $item->benchmark = 'xccdf_org.ssgproject.content_profile_anssi_nt28_high';
    $ssg_definitions[] = $item;
    ...
    $item->os_family = 'Oracle';
    $item->os_version = '7';
    $item->title = 'DRAFT - Australian Cyber Security Centre (ACSC) Essential Eight';
    $item->file = 'ssg-ol7-ds-1.2.xml';
    $item->benchmark = 'xccdf_org.ssgproject.content_profile_e8';
    $ssg_definitions[] = $item;
    ...
    $item->os_family = 'Oracle';
    $item->os_version = '7';
    $item->title = 'PCI-DSS v3.2.1 Control Baseline Draft for Oracle Linux 7';
    $item->file = 'ssg-ol7-ds-1.2.xml';
    $item->benchmark = 'xccdf_org.ssgproject.content_profile_pci-dss';
    $ssg_definitions[] = $item;
    ...
    $item->os_family = 'Oracle';
    $item->os_version = '7';
    $item->title = 'Security Profile of Oracle Linux 7 for SAP';
    $item->file = 'ssg-ol7-ds-1.2.xml';
    $item->benchmark = 'xccdf_org.ssgproject.content_profile_sap';
    $ssg_definitions[] = $item;

    $item = new \stdClass();
    $item->os_family = 'Oracle';
    $item->os_version = '7';
    $item->title = 'Standard System Security Profile for Oracle Linux 7';
    $item->file = 'ssg-ol7-ds-1.2.xml';
    $item->benchmark = 'xccdf_org.ssgproject.content_profile_standard';
    $ssg_definitions[] = $item;
    ...
    $item->os_family = 'Oracle';
    $item->os_version = '7';
    $item->title = 'DISA STIG for Oracle Linux 7';
    $item->file = 'ssg-ol7-ds-1.2.xml';
    $item->benchmark = 'xccdf_org.ssgproject.content_profile_stig';
    $ssg_definitions[] = $item;
    ...
    $item->os_family = 'Oracle';
    $item->os_version = '7';
    $item->title = 'DISA STIG with GUI for Oracle Linux 7';
    $item->file = 'ssg-ol7-ds-1.2.xml';
    $item->benchmark = 'xccdf_org.ssgproject.content_profile_stig_gui';
    $ssg_definitions[] = $item;
    ...
    $item->os_family = 'Oracle';
    $item->os_version = '8';
    $item->title = 'PCI-DSS v4.0 Control Baseline for Oracle Linux 8';
    $item->file = 'ssg-ol8-ds-1.2.xml';
    $item->benchmark = 'xccdf_org.ssgproject.content_profile_pci-dss';
    $ssg_definitions[] = $item;
    ...
    $item->os_family = 'Oracle';
    $item->os_version = '8';
    $item->title = 'Standard System Security Profile for Oracle Linux 8';
    $item->file = 'ssg-ol8-ds-1.2.xml';
    $item->benchmark = 'xccdf_org.ssgproject.content_profile_standard';
    $ssg_definitions[] = $item;
    ...
    $item->os_family = 'Oracle';
    $item->os_version = '8';
    $item->title = 'DISA STIG for Oracle Linux 8';
    $item->file = 'ssg-ol8-ds-1.2.xml';
    $item->benchmark = 'xccdf_org.ssgproject.content_profile_stig';
    $ssg_definitions[] = $item;
    ...
    $item->os_family = 'Oracle';
    $item->os_version = '8';
    $item->title = 'DISA STIG with GUI for Oracle Linux 8';
    $item->file = 'ssg-ol8-ds-1.2.xml';
    $item->benchmark = 'xccdf_org.ssgproject.content_profile_stig_gui';
    $ssg_definitions[] = $item;
    ...
    $item->os_family = 'Oracle';
    $item->os_version = '9';
    $item->title = 'PCI-DSS v4.0 Control Baseline for Oracle Linux 9';
    $item->file = 'ssg-ol9-ds-1.2.xml';
    $item->benchmark = 'xccdf_org.ssgproject.content_profile_pci-dss';
    $ssg_definitions[] = $item;
    ...
    $item->os_family = 'Oracle';
    $item->os_version = '9';
    $item->title = 'Standard System Security Profile for Oracle Linux 9';
    $item->file = 'ssg-ol9-ds-1.2.xml';
    $item->benchmark = 'xccdf_org.ssgproject.content_profile_standard';
    $ssg_definitions[] = $item;
    ...
    $item->os_family = 'Oracle';
    $item->os_version = '9';
    $item->title = 'DRAFT - DISA STIG for Oracle Linux 9';
    $item->file = 'ssg-ol9-ds-1.2.xml';
    $item->benchmark = 'xccdf_org.ssgproject.content_profile_stig';
    $ssg_definitions[] = $item;
    ...
    $item->os_family = 'Oracle';
    $item->os_version = '9';
    $item->title = 'DRAFT - DISA STIG with GUI for Oracle Linux 9';
    $item->file = 'ssg-ol9-ds-1.2.xml';
    $item->benchmark = 'xccdf_org.ssgproject.content_profile_stig_gui';
    $ssg_definitions[] = $item;
    ...
    $item->os_version = '16.04';
    $item->title = 'Profile for ANSSI DAT-NT28 Average (Intermediate) Level';
    $item->file = 'ssg-ubuntu1604-ds-1.2.xml';
    $item->benchmark = 'xccdf_org.ssgproject.content_profile_anssi_np_nt28_average';
    $ssg_definitions[] = $item;
    ...
    $item->os_family = 'Ubuntu';
    $item->os_version = '16.04';
    $item->title = 'Standard System Security Profile for Ubuntu 16.04';
    $item->file = 'ssg-ubuntu1604-ds-1.2.xml';
    $item->benchmark = 'xccdf_org.ssgproject.content_profile_standard';
    $ssg_definitions[] = $item;
    ...
    $item = new \stdClass();
    $item->os_family = 'Ubuntu';
    $item->os_version = '18.04';
    $item->title = 'Profile for ANSSI DAT-NT28 Average (Intermediate) Level';
    $item->file = 'ssg-ubuntu1804-ds-1.2.xml';
    $item->benchmark = 'xccdf_org.ssgproject.content_profile_anssi_np_nt28_average';
    $ssg_definitions[] = $item;
    ...
    $item->os_family = 'Ubuntu';
    $item->os_version = '18.04';
    $item->title = 'CIS Ubuntu 18.04 LTS Benchmark';
    $item->file = 'ssg-ubuntu1804-ds-1.2.xml';
    $item->benchmark = 'xccdf_org.ssgproject.content_profile_cis';
    $ssg_definitions[] = $item;
    ...
    $item->os_family = 'Ubuntu';
    $item->os_version = '18.04';
    $item->title = 'Standard System Security Profile for Ubuntu 18.04';
    $item->file = 'ssg-ubuntu1804-ds-1.2.xml';
    $item->benchmark = 'xccdf_org.ssgproject.content_profile_standard';
    $ssg_definitions[] = $item;
