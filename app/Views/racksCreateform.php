...
$tooltip = '<a href="#" style="color: #16325c;" class="float-end" data-bs-container="body" data-bs-toggle="popover" data-bs-trigger="focus" data-bs-content="' . __('Please note that the select box will override the text input box.') . '"><span class="icon-circle-question-mark"></span></a><br>';
?>
