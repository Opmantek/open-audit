                        ...
                        <table class="table <?= $GLOBALS['table'] ?> table-striped table-hover dataTable" data-order='[[3,"asc"]]'>
                            ...
                            <?php if (!empty($data)) { ?>
                                ...
                                <tr>
                                    ...
                                    <?= "<td class=\"text-center\"><a class=\"btn " . $GLOBALS['button'] . " btn-warning\" title=\"" . __('Results') . "\" role=\"button\" href=\"" . url_to('baselines_resultsCollection') . "?baselines.id=" . $item->attributes->id . "\"><span style=\"width:1rem;\" class=\"icon-list\" aria-hidden=\"true\"></span></a></td>" ?>
