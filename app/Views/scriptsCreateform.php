    ...
    $(document).ready(function() {
        ...
        create_file_text = '                                <div class="row" style="padding-top:16px;">\
                                <div class="offset-2 col-8" style="position:relative;">\
                                    ...
                                    <?= __('Should we create a file based on the audit result.') ?>\
                                </div>\
                            </div>\
                            <br>\
                            ';
        ...
        debugging_text = '                                <div class="row" style="padding-top:16px;">\
                                <div class="offset-2 col-8" style="position:relative;">\
                                    ...
                                    <?= __('The debug level (will output to command prompt window). Lower means less output with 0 being no output.') ?>\
                                </div>\
                            </div>\
                            <br>\
                            ';
        ...
        org_id_text = '                                <div class="row" style="padding-top:16px;">\
                                <div class="offset-2 col-8" style="position:relative;">\
                                    ...
                                    <?= __('Assign any audited devices to this Org. Leave blank to leave device in currently assigned Org (or to set default).') ?>\
                                </div>\
                            </div>\
                            <br>\
                            ';
        ...
        system_id_text = '                                <div class="row" style="padding-top:16px">\
                                <div class="offset-2 col-8">\
                                    <label for="data[attributes][options][system_id]" class="form-label">Device ID</label><br>\
                                    <input class="form-control" type="number" id="data[attributes][options][system_id]" name="data[attributes][options][system_id]">\
                                    <?= __('Set by the Discovery function - do not normally set this manually.') ?>\
                                </div>\
                            </div>\
                            <br>\
                            ';
        ...
        url_text = '                                <div class="row" style="padding-top:16px">\
                                <div class="offset-2 col-8">\
                                    ...
                                    <?= __('The address of the Open-AudIT server submit page.') ?>\
                                </div>\
                            </div>\
                            <br>\
                            ';
        ...
        ignore_invalid_ssl_text = '                                <div class="row" style="padding-top:16px;">\
                                <div class="offset-2 col-8" style="position:relative;">\
                                    ...
                                    <?= __('Should we ignore an invalid or self signed SSL certificate and submit the result anyway.') ?>\
                                </div>\
                            </div>\
                            <br>\
                            ';
        ...
        self_delete_text = '                                <div class="row" style="padding-top:16px;">\
                                <div class="offset-2 col-8" style="position:relative;">\
                                    ...
                                    <?= __('Once the script has run on a target, should the script delete itself.') ?>\
                                </div>\
                            </div>\
                            <br>\
                            ';
                ...
                case "audit_windows.vbs":
                    ...
                    based_on_text = based_on_text + '                                <div class="row" style="padding-top:16px;">\
                                            <div class="offset-2 col-8" style="position:relative;">\
                                                ...
                                                <?= __('Should we retrieve all DNS names') ?>.\
                                            </div>\
                                        </div>\
                                        <br>\
                                        \
                                        <div class="row" style="padding-top:16px;">\
                                            <div class="offset-2 col-8" style="position:relative;">\
                                                ...
                                                <?= __('Should we audit mount points.') ?>\
                                            </div>\
                                        </div>\
                                        <br>\
                                        \
                                        <div class="row" style="padding-top:16px;">\
                                            <div class="offset-2 col-8" style="position:relative;">\
                                                ...
                                                <?= __('Should we audit netstat ports (yes, no, servers only).') ?>\
                                            </div>\
                                        </div>\
                                        <br>\
                                        \
                                        <div class="row" style="padding-top:16px;">\
                                            <div class="offset-2 col-8" style="position:relative;">\
                                                ...
                                                <?= __('Should we audit the installed software.') ?>\
                                            </div>\
                                        </div>\
                                        <br>\
                                        \
                                        <div class="row" style="padding-top:16px;">\
                                            <div class="offset-2 col-8" style="position:relative;">\
                                                ...
                                                <?= __('Should we use the win32_product WMI class (not recommended by Microsoft) when retrieving installed software.') ?>\
                                            </div>\
                                        </div>\
                                        <br>\
                                        \
                                        <div class="row" style="padding-top:16px;">\
                                            <div class="offset-2 col-8" style="position:relative;">\
                                                ...
                                                <?= __('Should we convert the hostname to lowercase.') ?>\
                                            </div>\
                                        </div>\
                                        <br>\
                                        \
                                        <div class="row" style="padding-top:16px;">\
                                            <div class="offset-2 col-8" style="position:relative;">\
                                                ...
                                                <?= __('Should we hide the audit script window when executing.') ?>\
                                            </div>\
                                        </div>\
                                        <br>\
                                        \
                                        ...
                                        <div class="row" style="padding-top:16px">\
                                            <div class="offset-2 col-8">\
                                                ...
                                                <?= __('Set by the audit_domain or discover_domain scripts. Do not set.') ?>\
                                            </div>\
                                        </div>\
                                        <br>\
                                        \
                                        <div class="row" style="padding-top:16px">\
                                            <div class="offset-2 col-8">\
                                                ...
                                                <?= __('Set this if you wish to insert systems from AD that may not be contactable, but have been seen by AD since that date.') ?>\
                                            </div>\
                                        </div>\
                                        <br>\
                                        \
                                        <div class="row" style="padding-top:16px;">\
                                            <div class="offset-2 col-8" style="position:relative;">\
                                                ...
                                                <?= __('Attempt to ping the device if we are not auditing localhost.') ?>\
                                            </div>\
                                        </div>\
                                        <br>\
                                        \
                                        <div class="row" style="padding-top:16px;">\
                                            <div class="offset-2 col-8" style="position:relative;">\
                                                ...
                                                <?= __('Should we audit a SAN if the management software is detected.') ?>\
                                            </div>\
                                        </div>\
                                        <br>\
                                        \
                                        <div class="row" style="padding-top:16px;">\
                                            <div class="offset-2 col-8" style="position:relative;">\
                                                ...
                                                <?= __('If we detect the san management software, should we run an auto-discover before the query.') ?>\
                                            </div>\
                                        </div>\
                                        <br>\
                                        \
                                        <div class="row" style="padding-top:16px">\
                                            <div class="offset-2 col-8">\
                                                ...
                                                <?= __('The target computer to audit. "." means localhost.') ?>\
                                            </div>\
                                        </div>\
                                        <br>\
                                        \
                                        <div class="row" style="padding-top:16px">\
                                            <div class="offset-2 col-8">\
                                                ...
                                                <?= __('The password (if not using the user running the script).') ?>\
                                            </div>\
                                        </div>\
                                        <br>\
                                        \
                                        <div class="row" style="padding-top:16px">\
                                            <div class="offset-2 col-8">\
                                                ...
                                                <?= __('The username (if not using the user running the script).') ?>\
                                            </div>\
                                        </div>\
                                        <br>\
                                        \
                                        <div class="row" style="padding-top:16px;">\
                                            <div class="offset-2 col-8" style="position:relative;">\
                                                ...
                                                <?= __('Should we use the system or user level proxy to submit the audit result.') ?>\
                                            </div>\
                                        </div>\
                                        <br>\
                                        \
                                        <div class="row" style="padding-top:16px">\
                                            <div class="offset-2 col-8">\
                                                ...
                                                <?= __('Query this Active Directory attribute first to determine the users work unit.') ?>\
                                            </div>\
                                        </div>\
                                        <br>\
                                        \
                                        <div class="row" style="padding-top:16px">\
                                            <div class="offset-2 col-8">\
                                                ...
                                                <?= __('Query this Active Directory attribute second to determine the users work unit.') ?>\
                                            </div>\
                                        </div>\
                                        <br>\
                                        \
