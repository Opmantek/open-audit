                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            if ($resource->type === 'snmp') {
                                echo read_field('credentials.community', '', (!empty($resource->credentials->community)) ? $resource->credentials->community : '', $update, __('Community String'), '', '', 'password');
                            } elseif ($resource->type === 'ssh') {
                                echo read_field('credentials.username', (!empty($resource->credentials->username)) ? $resource->credentials->username : '', $dictionary->columns->username, $update, __('Username'));
                                ...
                                echo read_field('credentials.security_name', (!empty($resource->credentials->security_name)) ? $resource->credentials->security_name : '', $dictionary->columns->security_name, $update, __('Security Name')); ?>
                                    ...
                                    <?php echo read_field('credentials.context_name', (!empty($resource->credentials->context_name)) ? $resource->credentials->context_name : '', $dictionary->columns->context_name, $update, __('Context Name')); ?>
                                    <?php echo read_field('credentials.context_engine_id', (!empty($resource->credentials->context_engine_id)) ? $resource->credentials->context_engine_id : '', $dictionary->columns->context_engine_id, $update, __('Context Engine ID')); ?>
                            <?php } ?>
