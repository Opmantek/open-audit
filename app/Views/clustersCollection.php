                                ...
                                <tr>
                                    ...
                                    <?php foreach ($meta->data_order as $key) {
                                        ...
                                        if ($key === 'type') {
                                            ...
                                            echo "<td><a href=\"" . url_to($meta->collection.'Collection') . "?" . $meta->collection . ".purpose=" . $item->attributes->purpose . "\">" . $item->attributes->purpose . "</a></td>\n";
                                        } else if ($key === 'status') {
                                            echo "<td><a href=\"" . url_to($meta->collection.'Collection') . "?" . $meta->collection . ".status=" . $item->attributes->status . "\">" . $item->attributes->status . "</a></td>\n";
