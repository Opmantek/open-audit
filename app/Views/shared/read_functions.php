...
function read_card_header(string $collection = '', string $id = '', string $icon = '', object $user = null, string $name = ''): string
{
    ...
    if (($collection === 'baselines' or $collection === 'clouds' or $collection === 'dashboards' or $collection === 'discoveries' or $collection === 'integrations' or $collection === 'queries' or $collection === 'tasks') and !empty($id)) {
        if ($style === 'icontext') {
