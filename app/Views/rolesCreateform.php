...
$endpoints = array('agents','applications','applications_components','attributes','auth','baselines','benchmarks','benchmarks_exceptions','benchmarks_policies','certificates','clouds','clusters','collectors','components','configuration','connections','credentials','dashboards','database','devices','discoveries','discovery_scan_options','executables','fields','files','groups','integrations','licenses','locations','networks','orgs','packages','queries','racks','roles','rules','scripts','search','standards','standards_results','summaries','tasks','users','vendors','vulnerabilities','widgets');
