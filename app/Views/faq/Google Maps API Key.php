...
<br>' . __('For more information please see the following guide which includes a video. Use') . ' <a href="https://developers.google.com/maps/documentation/javascript/get-api-key?_gl=1*69x37q*_gcl_au*MzQ2MTQ4Njc3LjE3MjExMTIyNDI.">API Keys | Maps JavaScript API | Google Developers</a>.<br>

<br>' . __('If you are having issues with Google Maps API keys or your company does not have access to create Google Maps API keys, please contact the FirstWave support team.') . '<br><br></p>';
