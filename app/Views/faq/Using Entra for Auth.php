...
<p>' . __('Then create a new Auth method in Open-AudIT by going to menu -> Admin -> Auth Methods -> Create Auth. Provide a name and set the \'type\' to Entra.') . '</p>
<img src="' . base_url() . 'images/auth_az_14.png" class="img-thumbnail img-fluid">

<p><br><br><br>' . __('In a second tab or window sign-on to your <a href="https://entra.microsoft.com/#home" target="_blank">Entra console <i class="fa-solid fa-up-right-from-square"></i></a> and go to Applications -> Enterprise Applications (far left menu), then click \'New application\'.') . '</p>
<img src="' . base_url() . 'images/auth_az_01.png" class="img-thumbnail img-fluid">

<p><br><br><br>' . __('Next click \'Create your own application\'.') . '</p>
<img src="' . base_url() . 'images/auth_az_02.png" class="img-thumbnail img-fluid">

<p><br><br><br>' . __('And provide a name - we humbly recommend Open-AudIT &#128512;, but you can name it anything you like. Make sure the option for \'Integrate any other application you don\'t find in the gallery (Non-gallery)\' is selected. And then click \'Create\'.') . '</p>
<img src="' . base_url() . 'images/auth_az_03.png" class="img-thumbnail img-fluid">

<p><br><br><br>' . __('Copy the \'Application ID\' field and paste it into the Open-AudIT \'Client ID\' field for the new Auth Method.') . '</p>
<img src="' . base_url() . 'images/auth_az_04.png" class="img-thumbnail img-fluid">

<p><br><br><br>' . __('Click on \'Properties\' under the \'Manage\' header in the central menu column. Copy the \'User Access URL\'. Once copied, paste it into yout text editor. You will need to copy one section of this field.<br><br>
...
The section we need is <code>cf406343-1a96-4f7c-0cc6-46e86dddabf3</code> (the tenant ID). This is used in Open-AudIT as the \'Tenant\' field, so paste it in there.') . '</p>

<img src="' . base_url() . 'images/auth_az_05.png" class="img-thumbnail img-fluid">

<p><br><br><br>' . __('Go to the \'Single sign-on\' menu item and click SAML for \'Select a single sign-on method\'.') . '</p>
<img src="' . base_url() . 'images/auth_az_15.png" class="img-thumbnail img-fluid">

<p><br><br><br>' . __('Click the Edit button for \'Basic SAML Configuration\'.') . '</p>
...
<p><br><br><br>' . __('Go to the \'Applications\' -> \'App registrations\' menu item on the far left. Search for Open-AudIT. Click the Open-AudIT entry in the list (assuming you named the app Open-AudIT).') . '</p>
<img src="' . base_url() . 'images/auth_az_08.png" class="img-thumbnail img-fluid">

<p><br><br><br>' . __('Go to the \'Certificates and secrets\' menu item under \'Manage\' in the center menu.') . '</p>
<img src="' . base_url() . 'images/auth_az_09.png" class="img-thumbnail img-fluid">

<p><br><br><br>' . __('Click \'New client secret\'.') . '</p>
...
<p><br><br><br>' . __('Copy the value and paste it into the Open-AudIT form for the \'Client Secret\' field.') . '</p>
<img src="' . base_url() . 'images/auth_az_12.png" class="img-thumbnail img-fluid">

<p><br><br><br>' . __('And lastly click \'Submit\' to create your Open-AudIT Auth method for Entra.') . '</p>
<img src="' . base_url() . 'images/auth_az_13.png" class="img-thumbnail img-fluid">

<p><br><br><br>' . __('Your user should now be able to logon by clicking the \'Logon with Entra\' button on the Open-AudIT logon page. As mentioned above, if the logon fails, please check the logfile and verify the users \'preferred username\'.
<br><br>And that should be all there is too it. Now your users should have one less set of credentials to remember!
<br><br>As always, if you have troubles with this feature, please email') . ' <a href="mailto:support.nmis@firstwavecloud.com">support.nmis@firstwavecloud.com</a> ' . __('and a support ticket will be created and actioned.') . '</p>
';
