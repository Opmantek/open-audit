...
<p><br><br>' . __('In a second tab or window go to your OKTA console and click \'Create App Integration\'.') . '</p>
<img src="' . base_url() . 'images/auth_ok_02.png" class="img-thumbnail img-fluid">

<p><br><br>' . __('Use a \'Sign-in method\' of OIDC - OpenID Connect and an \'Application Type\' of Web Application. Click \'Next\'.') . '</p>
<img src="' . base_url() . 'images/auth_ok_03.png" class="img-thumbnail img-fluid">

<p><br><br>' . __('Provide a name - we humbly recommand Open-AudIT &#128512;, but you can name it anything you like.
...
Normally your Open-AudIT URL will look something like') . ' ' . base_url() . 'index.php, ' . __('with the Sign-On Redirect URI being') . ' ' . base_url() . 'index.php/logon/azure/auth ' . __('and the Sign-out redirect URI being') . ' ' . base_url() . 'index.php/logout<br></p>
<img src="' . base_url() . 'images/auth_ok_04.png" class="img-thumbnail img-fluid">

<p><br><br>' . __('Copy the \'Client ID\' and paste it into the Open-AudIT \'Client ID\' field.
...
<p><br><br>' . __('Select the \'Sign On\' tab and copy the value for \'Issuer\' (just the URL itself). Paste this into the Open-AudIT \'Issuer\' field.') . '<br></p>
<img src="' . base_url() . 'images/auth_ok_06.png" class="img-thumbnail img-fluid">

<p><br><br><br>' . __('Your user should now be able to logon by clicking the \'Logon with OKTA\' button on the Open-AudIT logon page. As mentioned above, if the logon fails, please check the logfile and verify the users \'name\'.
