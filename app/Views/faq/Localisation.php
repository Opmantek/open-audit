...
<p>The data stored in the database is not showing in the application translated. We leave the data as it is. However, there is nothing to stop you, the user, changing the name (for example) of an item in the database to your language.<br><br></p>
...
<h2>But I do not want to have to change the language file every time I update!</h2>

<p>Great, then <i>you</i> can help - send FirstWave the text shown in the GUI and what should be shown. We will include that in the language file so going forward, the translation is improved and you do not need to worry about updating it for every release!<br><br>
<br><br></p>
';
