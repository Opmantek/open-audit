...
<br>' . __('NOTE: As of version 6.0.3, if Nmap is not installed, Open-AudIT will attempt to run discoveries without it. Discovery results may be incomplete or inaccurate, but some data should still be collected.') . __('You should attempt to install Nmap as soon as possible for the best discovery results.') . '
</p>';
