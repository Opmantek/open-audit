...
$intro = '<p>
<i><strong>' . __('If you are running an Open-AudIT server on Linux, this does not affect you.') . '</strong></i><br>
...
<br>' . __('Select the Start menu and type <i>services<.i>. Click the Services icon.') . '<br><br>
