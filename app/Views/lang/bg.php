...
$GLOBALS["lang"][' is now supported with a language file. To change your user to use this language, click '] = ' Именно. ';
...
$GLOBALS["lang"][', you <i>must</i> be using https on your Open-AudIT server to use Entra for Auth. Please configure Apache to use <strong>https</strong> before configuring Entra for auth.'] = '.. <i>.</i> - Да. <strong>Бакъ</strong> ..';
...
$GLOBALS["lang"]['30 Minutes'] = '30  год.';
...
$GLOBALS["lang"]['<p>A summary will display a list of items, grouped by the distinct values of the attribute specified by the <code>table</code> and <code>column</code> attributes.<br> <br>When a summary is executed, the result will be a list of distinct values for that <code>table</code> and <code>column</code>. There will be links on the values that allow the user to see the matching devices.<br> <br>If the attribute of <code>extra_columns</code> is populated, the resulting page will contain these columns in addition to the standard device columns.<br> <br></p>'] = '<p>- Да. <code>table</code> Qeydiyyat <code>column</code> - Да.<br/> <br/>.. <code>table</code> Qeydiyyat <code>column</code>. - Да.<br/> <br/>. <code>extra_columns</code> - Да.<br/> <br/></p>';

$GLOBALS["lang"]['<p>Agents let you audit PCs without a discovery. Install the agent and it will check-in with the server each day and audit itself. It does not matter if your computers are firewalled, audit data will still appear in Open-AudIT.</p><p>When testing <strong>if</strong> an agent should perform actions, all three tests must pass (if the test is set). <strong>Then</strong> the actions are taken.</p>'] = '<p>Именно.</p><p>. <strong>..</strong> да го направим, да го направим. <strong>..</strong> - Да.</p>';
...
$GLOBALS["lang"]['<p>Open-AudIT can store information in custom fields that are associated with each device.<br> <br>Once an Additional Field has been created it can be used in queries and groups just like any other attribute in the database.<br> <br></p>'] = '<p>..<br/> <br/>Именно.<br/> <br/></p>';
...
$GLOBALS["lang"]['<p>Simple, intuitive, accurate geographic mapping provided by Google Maps. Open-AudIT leverages Google Maps to provide live, interactive geographic mapping of device locations. Automated conversion of street addresses to geocodes and longitude / latitude.<br> <br>
        </p>'] = '<p>Google Maps t гор! . Google Maps canlı, interaktiv cografi xidm ..<br/> <br/></p>';
...
$GLOBALS["lang"]['<p>The network should be in the format 192.168.1.0/24.<br> <br></p>'] = '<p>APOL формат 192.168.1.0/24 olmalıdır.<br/> <br/></p>';
...
<br>
See our page on enabling <a href="/index.php/faq?name=Running Open-AudIT Apache Service Under Windows">Running Open-AudIT Apache Service Under Windows</a></p>'] = '<p>..<br/><br/>Именно. Bu hesab uzaq (въз основа на мрежа) recursuna daxil deyil. Именно.<br/><br/> да го направим, да го направим. <a href="/index.php/faq?name=Running Open-AudIT Apache Service Under Windows">. Apache  големоглавец</a></p>';

$GLOBALS["lang"]['<p>These are the devices that live within a rack.<br> <br></p>'] = '<p>- Не, не.<br/> <br/></p>';

$GLOBALS["lang"]['<p>This endpoint enables you to add your cloud infrastructure details. Open-AudIT will then reach out to your clouds using their native API and return your servers, just like any other device in Open-AudIT.<br> <br><em>NOTE</em> - To use this feature, we <em>must</em> enable the configuration items match_mac (for AWS) and match_hostname (for Azure). This will be done automatically the first time a cloud discovery is executed.<br> <br>Credentials for your cloud (<a href="/index.php/faq?name=Credentials for Microsoft Azure used in Cloud Discovery">Azure</a> or <a href="/index.php/faq?name=Credentials for Amazon AWS used in Cloud Discovery">AWS</a>) are required.<br> <br></p>'] = '<p>Не, не.<br/> <br/><em>- Да.</em> .. <em>.</em> ( год.) ..<br/> <br/>..<a href="/index.php/faq?name=Credentials for Microsoft Azure used in Cloud Discovery"> Azure</a> . <a href="/index.php/faq?name=Credentials for Amazon AWS used in Cloud Discovery">Даксил ол</a>- Да.<br/> <br/></p>';

$GLOBALS["lang"]['<p>Vulnerabilities reporting based on the NIST CVE feed.<br> <br></p>'] = '<p>NIST CVE feed  гонитба.<br/> <br/></p>';

$GLOBALS["lang"]['<p>We initially setup the default list of scripts with the default options. These default scripts cannot be deleted. You can create additional scripts for use by you as required. Your script will be based on one of the existing scripts and have custom options applied. The scripts can then be downloaded from the list page at menu -> Discover -> Audit Scripts -> List Audit Scripts<br> <br></p>'] = '<p>Именно.<br/> <br/></p>';

$GLOBALS["lang"]['<p>When using Regex for matching, a helpful page can be found on the <a href="https://www.php.net/manual/en/regexp.reference.meta.php" target="_blank"> PHP website</a>. Some differences to Perl Regex can be found <a href="https://www.php.net/manual/en/reference.pcre.pattern.differences.php" target="_blank">here</a>.</p>'] = '<p> да го направим. <a href="https://www.php.net/manual/en/regexp.reference.meta.php" target="_blank"> PHP saytında</a>.. <a href="https://www.php.net/manual/en/reference.pcre.pattern.differences.php" target="_blank">- Да.</a>.</p>';
...
$GLOBALS["lang"]['<p>With Open-AudIT Professional and Enterprise you can automate and schedule discoveries, report generation, or baseline checks to run when you want, and as often as you need. Schedule your discoveries to run nightly and reports to be generated and emailed to key personnel each morning. Complex or simple schedules, device discovery and report generation is just a click away.<br> <br>Create individual discovery schedules for each subnet or AD controller, add in reports to be created for targeted audiences. Develop simple or complex schedules to support company needs, avoid backups or impact to operations, or simply to spread the load and speed-up audit completion.<br> <br></p>'] = '<p>..<br/> <br/>Именно.<br/> <br/></p>';

$GLOBALS["lang"]['<p>You can create a script with all the options for any of the existing audit scripts - not just Windows. AIX, ESX, Linux, OSX and Windows are all covered.<br> <br></p>'] = '<p> год.<br/> <br/></p>';

$GLOBALS["lang"]['<p>You can use the percent % sign as a wildcard in the match_string.<br> <br></p>'] = '<p>Именно.<br/> <br/></p>';

$GLOBALS["lang"]['<p>Your racks help refine exactly where your devices are located.<br> <br></p>'] = '<p>Не, не.<br/> <br/></p>';

$GLOBALS["lang"]['<strong>NOTE</strong> - You are accessing this URL from the local Open-AudIT server. The downloaded script will not be able to submit when run on any other machine. If you need to audit other machines, please download the script from any remote machine, not using a browser on the Open-AudIT server itself.'] = '<strong>- Да.</strong> - Не, не, не. ..';

$GLOBALS["lang"]['A CVE item that does not contain a filter to determine the affected item(s).'] = '"Стифад... олунан мадид... .."';

$GLOBALS["lang"]['A Google Maps API Key is required for this function.'] = 'АПИ, АПИ, АПИ.';

$GLOBALS["lang"]['A JSON array of device IDs that will have this benchmark executed.'] = '..';

$GLOBALS["lang"]['A JSON array of objects matching the software name taken from the CVE, enriched with the software name retrieved by Open-AudIT.'] = 'CVE-dan alınan proqram adı il... uyğun olaraq, Open-AudIT t...r...find...n alınan proqram adı uyğunlaşdırılmışdır.';

$GLOBALS["lang"]['A JSON array of values to test for this vulnerability.'] = 'Bu boşluğu test üçün qiym...tl...r JSON sıra.';

$GLOBALS["lang"]['A JSON document containing the Orgs assigned to this user. IDs taken from <code>orgs.id</code>. If a user has access to an Org, they have access to that Orgs descendants.'] = 'Bu istifad...çi üçün Orgs daxil olan bir JSON s...rgisi. - Да. <code>orgs.id</code>. ..';

$GLOBALS["lang"]['A JSON document containing the required attributes depending on <code>scripts.type</code>.'] = 'T при nümayişi <code>scripts.type</code>.';

$GLOBALS["lang"]['A JSON document containing the required attributes overriding the chosen discovery_scan_options.'] = 'Seçilmiş m... lumat_scan_options üz...rind... lodenım olan xüsusiyyy... tl...ri olan JSON nümayişi.';
...
$GLOBALS["lang"]['A JSON document containing the roles assigned to this user. Role names taken from <code>roles.name</code>.'] = 'Bu istifad по дяволите, verilmiş rollar daxil olan bir JSON s.rgisi. Не, не. <code>roles.name</code>.';

$GLOBALS["lang"]['A JSON object containing an array of attributes to change if the match occurs.'] = 'Mac meydana çıxırsa, bir sıra xüsusiyyyyy...';

$GLOBALS["lang"]['A JSON object containing an array of attributes to match.'] = 'Bir sıra xüsusiyyyy';

$GLOBALS["lang"]['A JSON object containing collection specific options.'] = 'Kolleksiya xüsusi versionları olan JSON Obkt.';

$GLOBALS["lang"]['A JSON object populated via a Cloud discovery.'] = 'Bir JSON Objektiki Cloud Keçmiş.';

$GLOBALS["lang"]['A JSON representation containing the details of the queue item to be executed.'] = 'Qırmızı m гошсулун мулматлару олан бир JSON nümaeiş edilib.';

$GLOBALS["lang"]['A JSON representation of the fields for this integration.'] = 'Bu inteqrasiya üçün sah... l...';

$GLOBALS["lang"]['A JSON representation of the individual tests and their results on all devices this baseline has been run against.'] = 'A JSON müxt... lif testl...rin t...sviri v... bütün cihazlar üz...';
...
$GLOBALS["lang"]['A Metropolitan area network (MAN) is a large computer network that usually spans a city or a large campus.'] = 'A Metropolitan sah...si (MAN) bir ş...h...r. v... ya böyük bir kampaniya yayılmış böyük kompüter ş...h...ridir.';

$GLOBALS["lang"]['A Seed discovery uses an initial IP to retrieve the IPs of any other devices it knows about, adds those IPs to the list and scans those - again asking for any IPs those additional devices knows about. Rinse and repeat. It is intelligent enough to know if it has already scanned a given IP in its execution and discards any already scanned (or even on the list to be scanned).'] = 'Именно. Bu, h';

$GLOBALS["lang"]['A Subnet discovery will scan the IPs provided.'] = 'Именно.';

$GLOBALS["lang"]['A URL provided to the agent which will then download the file and store it on the local disk.'] = 'Daha sonra faylını yükl';

$GLOBALS["lang"]['A URL to a file to download.'] = 'URL адрес на Yükl...';

$GLOBALS["lang"]['A backbone network is part of a computer network infrastructure that provides a path for the exchange of information between different LANs or sub-networks. A backbone can tie together diverse networks within the same building, across different buildings, or over a wide area.<br><br>For example, a large company might implement a backbone network to connect departments that are located around the world. The equipment that ties together the departmental networks constitutes the network backbone. When designing a network backbone, network performance and network congestion are critical factors to take into account. Normally, the backbone network capacity is greater than that of the individual networks connected to it.<br><br>Another example of a backbone network is the Internet backbone, which is the set of wide area networks (WANs) and core routers that tie together all networks connected to the Internet.'] = 'Именно.<br/><br/>Именно.<br/><br/>..';

$GLOBALS["lang"]['A calculated field that displays the number of times this piece of software was found on the computers in the selected Org (and its descendants if configured).'] = 'Bu proqram nömr... sininin nömr...sini göst...rdiyi hesablanmış sah...si seçilmiş Org (ve onun qonaqları)';

$GLOBALS["lang"]['A campus area network (CAN) is made up of an interconnection of LANs within a limited geographical area. The networking equipment (switches, routers) and transmission media (optical fiber, copper plant, Cat5 cabling, etc.) are almost entirely owned by the campus tenant / owner (an enterprise, university, government, etc.).<br><br>For example, a university campus network is likely to link a variety of campus buildings to connect academic colleges or departments, the library, and student residence halls.'] = 'Bir kampaniya sah...si (CAN) müxt...lif cografi sah...sind... И ако не е така, тогава ще е по-добре да го направим.<br/><br/>Ünvan: Az...rbaycan Respublikasın Prezidenti, Az...rbaycan Respublikası, Az...rbaycan Respublikasının Prezidenti, Az...rbaycan Respublikasın Presidenti, Az...rbaycan Respublikasınınının Prezidenti, Az...rbaycan Respublikasın Prezidenti, Az...rbaycan Respublikasının Prezidenti, Az...rbaycan Respublikının Prezidenti, Azrbaycan Respublikasın Prezidnti, Azrbayjan Respublikasının Presınti, Azzlnınti, Azrgnınınti, Azzzlnti, Azrbaycan';

$GLOBALS["lang"]['A closed port is accessible (it receives and responds to Nmap probe packets), but there is no application listening on it. They can be helpful in showing that a host is up on an IP address (host discovery, or ping scanning), and as part of OS detection. Because closed ports are reachable, it may be worth scanning later in case some open up. Administrators may want to consider blocking such ports with a firewall. Then they would appear in the filtered state, discussed next.'] = 'Daxili bir port erişilebilirdir (Nmap provincepackets almaq v Именно.';
...
$GLOBALS["lang"]['A dashboard is made up of three columns and two rows of what we call <i>widgets</i>. A widget is very similar to a summary, only we take the summary concept a bit further. Widgets are created in a simple fashion using a couple of drop down boxes - or you can elect to use your own SQL for complete customisability.'] = '.. <i>- Да.</i>. Именно.';

$GLOBALS["lang"]['A filtered port is considered open (and will trigger device detection).'] = 'Не, не.';

$GLOBALS["lang"]['A global area network (GAN) is a network used for supporting mobile across an arbitrary number of wireless LANs, satellite coverage areas, etc. The key challenge in mobile communications is handing off user communications from one local coverage area to the next. In IEEE Project 802, this involves a succession of terrestrial wireless LANs.'] = 'Проект 802-дии, бу, автоматик LANların uGOurlu olmasını edir.';

$GLOBALS["lang"]['A home area network (HAN) is a residential LAN used for communication between digital devices typically deployed in the home, usually a small number of personal computers and accessories, such as printers and mobile computing devices. An important function is the sharing of Internet access, often a broadband service through a cable TV or digital subscriber line (DSL) provider.'] = 'Bir ev sah...si... olunan bir yaşayış LAN, tez-tez v... mobil avadalıq cihazları kimi, xüsusi kompüter v... aksesuarların kiçik bir sayır. - Да.';
...
$GLOBALS["lang"]['A vulnerability can be editied and more specific package names provided where the enrichment data is insufficient or the generated SQL is not quite correct.'] = 'Bir çatışmazlıgı d...st...kl...ndirilmiş v... daha xüsusi paketi adlarını d...st...kl...y... bil...r.';

$GLOBALS["lang"]['A vulnerability item in Open-AudIT can be thought of as essentially a query against your database to determine your potential exposure to a given CVE report. A vulnerability is made up of the CVE report, along with enrichment data from FirstWave. These two items are combined to produce a suitable query that is automatically downloaded from FirstWave.'] = ' год.  да го направим, да го направим.';

$GLOBALS["lang"]['A wide area network (WAN) is a computer network that covers a large geographic area such as a city, country, or spans even intercontinental distances. A WAN uses a communications channel that combines many types of media such as telephone lines, cables, and air waves. A WAN often makes use of transmission facilities provided by common carriers, such as telephone companies. WAN technologies generally function at the lower three layers of the OSI reference model: the physical layer, the data link layer, and the network layer.'] = 'Geniş sah...sin ş...h...ri (WAN) bir ş...h...r, ölk... ölk..., ölk..., v... ya s...naye s...viyy...tl...ri kimi böyük coigrafi sah...sind... bir kommpüter ş...h...ridir. Bir WAN telefon xüsusiyyyyy...tl...ri, kabell...r... hava dalgaları kimi media bir çox növl...ri birl...şdir...n bir kommpüter kanal istifad... edir. Именно.';
...
$GLOBALS["lang"]['API / Web Access'] = 'Достъп API/Web';

$GLOBALS["lang"]['API Documentation'] = 'АПИ';
...
$GLOBALS["lang"]['Access to the admin$ share and RPC uses the SMB2 protocol.'] = 'admin$ payı v... RPC giriş SMB2 protokol istifad... Edir.';
...
$GLOBALS["lang"]['action_devices_assigned_to_location'] = 'Именно.';

$GLOBALS["lang"]['Action Devices Assigned To Location'] = 'Именно.';
...
$GLOBALS["lang"]['action_uninstall'] = 'Не, не. italyprovince. kgm';

$GLOBALS["lang"]['Action Uninstall'] = 'Не, не. italyprovince. kgm';
...
$GLOBALS["lang"]['Active Directory Domain'] = 'Именно.';
...
$GLOBALS["lang"]['Address audit findings and corrective actions'] = 'Именно.';
...
$GLOBALS["lang"]['After an Integration has been created, when you view the details of an Integration you will notice a field named Debug. This is set to no by default. Changing it to yes provides extra logging when an Integration is executed. Debug should not be left as yes. This is because the debug output will contain everything retrieved from external systems - including items such as WMI and SNMP credentials. The debug option should be used only when an issue has occurred and you wish to dig deeper in to see if you can determine why.'] = 'Именно.';
...
$GLOBALS["lang"]['All Queued Items'] = '"Трафлъ мхсулар"';
...
$GLOBALS["lang"]['All tasks can be created the same in Windows and Linux. Tasks use the CRON method for scheduling execution.'] = 'Именно.';
...
$GLOBALS["lang"]['Amazon AWS Fields'] = 'Amazon AWS  год.';
...
$GLOBALS["lang"]['An indication of the level of service required by this site.'] = 'Bu site t';
...
$GLOBALS["lang"]['And lastly, not so much a security issue - more peace of mind. The data structures are open and documented. You can view them'] = 'Именно. Не, не.';

$GLOBALS["lang"]['And provide a name - we humbly recommend Open-AudIT &#128512;, but you can name it anything you like. Make sure the option for <i>Integrate any other application you do not find in the gallery (Non-gallery)</i> is selected. And then click <i>Create<i>.'] = '- Да. <i>..</i> .. <i>Qeydiyyat<i>.</i></i>';
...
$GLOBALS["lang"]['Any attributes followed by a * indicate that CVSS data less than v4 was used to complete this field. By default, we attempt to use v4 fields, however if they are not populated we will fallback to the previous version(s) for attributes.'] = 'Именно. - Да.';

$GLOBALS["lang"]['Any devices will be assigned to this Org when they run their audit script (if set).'] = '..';

$GLOBALS["lang"]['Any devices will be assigned to this Org when they run their audit script (if set). Links to <code>orgs.id</code>.'] = 'Именно. <code>orgs.id</code>.';
...
$GLOBALS["lang"]['Applications are being introduced in Open-AudIT 2.2 with a view to expand on the concept as further development is made.'] = 'Именно.';
...
$GLOBALS["lang"]['Are you sure? This will remove all queue entries and prevent the remaining IPs from being discovered.'] = '.. Bu, bütün sıra girişl...ri aradan qaldıracaq v... qeyd edilmiş IPs qarşısını alır.';
...
$GLOBALS["lang"]['As a result, we <strong>must</strong> have the admin$ share available to the discovery credentials user. Please check the target Windows machine provides <i>write</i> access for the discovery credentials user.<br>'] = '.. <strong>.</strong> Именно. <i>Не, не, не.</i> Именно.<br/>';
...
$GLOBALS["lang"]['As we run Discoveries and collect device results we populate the list of networks. The Blessed Subnets feature uses this list of networks to only accept data from devices on those networks.'] = '- Да. Happy Subnets xüsusiyyyäti bu ş';
...
$GLOBALS["lang"]['Assign Devices to Organisation'] = 'Именно.';
...
$GLOBALS["lang"]['Attributes are stored for Open-AudIT to use for particular fields, at present all fields are based on the devices, locations, orgs and queries tables. The attributes you can edit are associated with the following columns: Class, Environment, Status & Type.'] = 'Именно.';
...
$GLOBALS["lang"]['Audit Win32 Product'] = 'Именно.';
...
$GLOBALS["lang"]['auto_renew'] = 'Автомобил Йени';

$GLOBALS["lang"]['Auto Renew'] = 'Автомобил Йени';
...
$GLOBALS["lang"]['Benchmarks are created by providing an operating system and Version, combined with a specific guide and a list of machines to execute it upon. After creation, benchmarks are executed against the list of machines on a schedule.'] = 'Именно.';

$GLOBALS["lang"]['Benchmarks for Best Practise Configuration'] = ' да го направим, да го направим.';

$GLOBALS["lang"]['Benchmarks provide security recommendations for your computers, utilising the OpenSCAP tools and policies.</p><p><i>From the OpenSCAP homepage:</i>  In the ever-changing world of computer security where new vulnerabilities are being discovered and patched every day, enforcing security compliance must be a continuous process. It also needs to include a way to make adjustments to policies, as well as periodic assessment and risk monitoring. The OpenSCAP ecosystem provides tools and customizable policies for a quick, cost-effective and flexible implementation of these processes.'] = '..<p><i>OpenSCAP анадан:</i> Именно.</p>';
...
$GLOBALS["lang"]['best_practises'] = 'Best Pracktiss';

$GLOBALS["lang"]['Best Practises'] = 'Best Pracktiss';
...
$GLOBALS["lang"]['Bouvet Island (Bouvetoya)'] = '[Смях]';
...
$GLOBALS["lang"]['Browse down the tree to Console Root -> Component Services -> Computers -> My Computer<br><br>Right click on <i>My Computer</i> and select properties<br><br>Select the <i>Default Properties</i> tab'] = '..<br/><br/>. <i>- Да.</i> ..<br/><br/>Не, не, не. <i>.</i> подпрозорец';
...
$GLOBALS["lang"]['Bulk Editing Device Attributes'] = 'Avtomatlaşdırma Атрибути на устройството';
...
$GLOBALS["lang"]['CVE'] = 'Бакъ';

$GLOBALS["lang"]['CVEs with a status of received, awaiting analysis, undergoing analysis, rejected. These CVEs (mostly) do not contain sufficient information to enable us to generate a correct SQL query.'] = 'Alınan bir statela CVEs, analiz altında, analiz altında, redakt. ..';
...
$GLOBALS["lang"]['Can be set by discovery or user. Uses the ID from the locations table.'] = 'Именно.';
...
$GLOBALS["lang"]['Chinese (traditional)'] = '[Смях]';

$GLOBALS["lang"]['Choose'] = '- Да.';

$GLOBALS["lang"]['Choose (select OS first)'] = '[Смях]';
...
$GLOBALS["lang"]['Click the Edit button for <i>Basic SAML Configuration</i>.'] = '.. <i>Basic SAML  голота</i>.';
...
$GLOBALS["lang"]['Cocos (Keeling) Islands'] = '(Кийлинг)';
...
$GLOBALS["lang"]['Collector / Server is an Enterprise only feature. Enterprise customers receive one Collector license for free. Additional Collector licenses can be purchased as required.'] = 'Именно.';

$GLOBALS["lang"]['Collector / Server is designed so that you can have a remote or <i>collector</i>  instance of Open-AudIT running on a remote machine. That collector instance might be in another security zone, subnet, cloud hosting instance or at a customer site.  The remote collector is then doing all the discovering and auditing of devices locally avoiding networking and firewalling complexity.  The Collector once it has registered is completely controlled by the <i>server</i>.  This means you only need an HTTP or HTTPS connection from that Collector to the Server.'] = '.. <i>.</i> Именно. <i>.</i>. ..';
...
$GLOBALS["lang"]['Company'] = 'Şirk';

$GLOBALS["lang"]['Complete these steps.'] = '..';

$GLOBALS["lang"]['Complexity of the attack (Low or High).'] = 'hücum Kompelksi (Aşagı v год. ya yüksk).';
...
$GLOBALS["lang"]['Credentials are stored in the <i>credentials</i> database table. The actual credential information is encrypted in storage. When a Discovery is run, a device has its specific credentials retrieved from the database, decrypted and tested. If these fail the list of credentials is also retrieved, decrypted and then tested against the device starting with credentials known to have worked previously. Device specific credentials are stored at an individual device level in the <i>credential</i> table (note - no <i>s</i> in the table name). SSH keys are tested before SSH username / password. When testing SSH, credentials will also be marked as working with sudo or being root.'] = '- Да. <i>- Да.</i> Именно. <i>- Да.</i> . <i> </i> год. Именно.';

$GLOBALS["lang"]['Credentials can have one of a few different types - snmp v.1 / v.2, snmp v.3, ssh, ssh key, windows are all implemented. CAVEAT - ssh keys are not implemented for Windows Open-AudIT servers as yet.'] = '- Уау.';

$GLOBALS["lang"]['Credentials for Amazon AWS used in Cloud Discovery'] = 'Именно.';
...
$GLOBALS["lang"]['Date Now'] = ' да го направя.';
...
$GLOBALS["lang"]['DateTime Now'] = ' да го направя.';

$GLOBALS["lang"]['DateTime Y-M-D H:M:S'] = '- Да. Y-M-D H:M:S';
...
$GLOBALS["lang"]['Default Authentication Level - Set to Connect'] = '.. Qeydiyyat';
...
$GLOBALS["lang"]['Define the context of the organization (internal/external issues)'] = '[Смях]';
...
$GLOBALS["lang"]['Determine risk treatment options'] = 'Именно.';
...
$GLOBALS["lang"]['Device Seed Discoveries are a good option if you know that your network consists of a range of subnets, but you are unsure what they are. Seed the discovery with a local router and watch your network unfold before your eyes.'] = 'Domen adı qeydiyyatdan keçirt ';
...
$GLOBALS["lang"]['devices_assigned_to_location'] = 'Именно.';

$GLOBALS["lang"]['Devices Assigned To Location'] = 'Именно.';
...
$GLOBALS["lang"]['Devices Not Audited'] = 'Именно.';

$GLOBALS["lang"]['Devices Not Seen 30 Days'] = '..';

$GLOBALS["lang"]['Devices Not Seen 7 Days'] = ' да го направим.';
...
$GLOBALS["lang"]['Devices are not being benchmarked.'] = ' да го направим.';

$GLOBALS["lang"]['Devices could be benchmarked.'] = '- Да.';

$GLOBALS["lang"]['Devices from Open-AudIT'] = '.';

$GLOBALS["lang"]['Devices in Running State'] = 'Именно.';
...
$GLOBALS["lang"]['Devices with Expired Warranties'] = 'Именно.';
...
$GLOBALS["lang"]['dhcp_lease_obtained'] = 'Dhcp лизинг almaq';

$GLOBALS["lang"]['Dhcp Lease Obtained'] = 'Dhcp лизинг almaq';
...
$GLOBALS["lang"]['Displays a standard web form for submission to POST /{collection}/import.'] = 'POST / {collection} / Import üçün standart web formasını göstбrin.';
...
$GLOBALS["lang"]['domain'] = 'Бакъ';

$GLOBALS["lang"]['Domain'] = 'Бакъ';

$GLOBALS["lang"]['domain_controller_address'] = 'Именно.';

$GLOBALS["lang"]['Domain Controller Address'] = 'Именно.';

$GLOBALS["lang"]['domain_controller_name'] = 'Именно.';

$GLOBALS["lang"]['Domain Controller Name'] = 'Именно.';

$GLOBALS["lang"]['domain_role'] = ' да го направим.';

$GLOBALS["lang"]['Domain Role'] = ' да го направим.';
...
$GLOBALS["lang"]['EULA'] = 'АБШ';

$GLOBALS["lang"]['Each IP is scanned with the discovery configured options (see Discovery Scan Options and Discovery - Community vs Professional vs Enterprise on the wiki). In general, Nmap will test for ports 22 (ssh), 135 (wmi), 62078 (iPhone) and UDP 161 (snmp). If 22, 135 or 161 respond the credential list is retrieved and each credential tested in turn. The first working credentials are used for further queries directly from the device. Note - if a device has previously been discovered and has working credentials, those credentials are tested first. Only if those fail are the other credentials then attempted.'] = 'Именно. Nmap portlar üçün test ed.c.c.k. 22 (sh), 135 (wmi), 62078 (iPhone) v  по UDP 161 (snmp). Именно.';

$GLOBALS["lang"]['Each time a device is discovered or an audit result is processed, all rules are retrieved from the database and run against the attributes of the specific device. Rules run against one device at a time - there is no facility to say <i>Run the rules against all devices<i> or <i>Run the rules against these devices<i>. An individual rule will test one or more attributes of the device and if they match the rule, the result will be applied. Several attributes can be tested. Several attributes can be set. Think of this as an If This, Then That system for Open-AudIT.'] = ' гонката, която е по-голяма от това, което се случва. <i>..<i> . <i>..<i>. Именно.</i></i></i></i>';
...
$GLOBALS["lang"]['Enable Distributed COM on this computer - Option is checked'] = 'Bu kompüter üzr... asan Dağlıq COM - Seçki';
...
$GLOBALS["lang"]['Enrichment is complete. The CVE has full metadata and is considered stable.'] = 'Сабит sayır.';
...
$GLOBALS["lang"]['Example Org Chart with Access'] = 'Достъп до картата на Орг';
...
$GLOBALS["lang"]['exclude_ip'] = 'ИП.';

$GLOBALS["lang"]['Exclude IP'] = 'ИП.';

$GLOBALS["lang"]['Exclude IP Addresses'] = 'E-poçt';

$GLOBALS["lang"]['Exclude IP Addresses (individual IP - 192.168.1.20, ranges - 192.168.1.30-40 or subnets - 192.168.1.100/30) listed from being scanned. Comma seperated, no spaces.'] = 'E-poçt ünvanı ..';

$GLOBALS["lang"]['Exclude TCP Ports'] = 'TCP Ports';
...
$GLOBALS["lang"]['Exclude any ports listed from being scanned. Comma seperated, no spaces.'] = 'Именно.';
...
$GLOBALS["lang"]['Export by Device'] = 'City in Italy';
...
$GLOBALS["lang"]['Extra and Time based Reporting'] = 'Именно.';
...
$GLOBALS["lang"]['Falkland Islands (Malvinas)'] = '[Смях]';
...
$GLOBALS["lang"]['first_seen'] = 'Илк Баксъш';

$GLOBALS["lang"]['First Seen'] = 'Илк Баксъш';
...
$GLOBALS["lang"]['For <i>Type</i> make sure to select Baseline, and for Group you should select a Group of devices, if applicable to this baseline, that best represent the devices to apply the baseline against. This will prevent erroneous entries.'] = 'Axtarış <i>- Да.</i> Именно.';

$GLOBALS["lang"]['For Debian/Ubuntu run, including setting dpkg to remember your override so an apt-get upgrade will not break'] = '.';

$GLOBALS["lang"]['For SNMP Open-AudIT can use v1, v2 and v3 credentials. The device is queried regardless of it being a router, switch (regular network devices) or a computer (Linux and Windows often run SNMP for monitoring tools).'] = 'Именно.';

$GLOBALS["lang"]['For a primer on cron, see this Wikipedia page'] = '..';

$GLOBALS["lang"]['For a seed discovery, should I only discover IPs in the private IP address space.'] = 'Именно.';

$GLOBALS["lang"]['For a seed discovery, should I only discover IPs on the chosen subnet.'] = 'Именно.';

$GLOBALS["lang"]['For a seed discovery, should I ping the subnet before running the discovery.'] = '..';

$GLOBALS["lang"]['For advanced entry of a raw SQL query. As per Queries, you must include <code>WHERE @filter AND<code> in your SQL.'] = 'Именно. <code>WHERE @filter AND<code> in your SQL.</code></code>';
...
$GLOBALS["lang"]['From 100 Devices'] = '100  год.';

$GLOBALS["lang"]['From 500 Devices'] = ' год. 500';
...
$GLOBALS["lang"]['Gap Analysis (optional)'] = '[Смях]';
...
$GLOBALS["lang"]['Go back to your Open-AudIT server and create a discovery with the target Windows computers IP Address as the subnet (this will save having to discover the entire subnet again). Run the discovery, taking note of any issues. For any issues found, take appropriate actions.'] = 'Именно.';
...
$GLOBALS["lang"]['Go to the <i>Applications</i> -> <i>App registrations</i> menu item on the far left. Search for Open-AudIT. Click the Open-AudIT entry in the list (assuming you named the app Open-AudIT).'] = '.. <i>- Да.</i> - <i>.</i> да го направим, да го направим.';

$GLOBALS["lang"]['Go to the <i>Certificates and secrets</i> menu item under <i>Manage</i> in the center menu.'] = '.. <i>.</i> . <i>Qeydiyyat</i> голи са.';
...
$GLOBALS["lang"]['Great, then you can help! Send FirstWave the text shown in the GUI and what should be shown. We will include that in the language file so going forward, the translation is improved and you do not need to worry about updating it for every release!'] = 'Именно.';
...
$GLOBALS["lang"]['Help and Frequently Asked Questions'] = 'Именно.';
...
$GLOBALS["lang"]['How the vulnerability is exploited (e.g., Network, Adjacent, Local, Physical).'] = 'Qarışıq nec... istismar edilir (напр. Network, Adjacent, Local, Fizik).';
...
$GLOBALS["lang"]['Icon only, text only or icon and text.'] = 'Yalnız, m.hsul yalnız v. . . . . .';
...
$GLOBALS["lang"]['identification'] = ' да го направим.';
...
$GLOBALS["lang"]['Identifying and evaluating security risks'] = 'Именно.';
...
$GLOBALS["lang"]['If a new Org is created, an LDAP group name is automatically derived from the name. For example, if a new Org is created and is named Test, the corresponding LDAP group will be named open-audit_orgs_test.'] = 'Йени Org yaradılırsa, bir LDAP qrup adı addan avtomatik olarac yaranılır. Йени Org yaradılırsa v... Тест adlandırılsa, müxt голиф LDAP qrupu açıq-одит_orgs_test adlandırılacaq.';
...
$GLOBALS["lang"]['If any of these (comma seperated, no spaces) ports are detected, assume SSH is running on them and use them for auditing. No need to add this port to the Custom TCP ports - it will be added automatically.'] = 'Bu (komma seperated, heç bir yerl горл горльшдирилмъ) limanları hesablanırsa, SSH onları işl гольйр вааа онларъ одит üçün istifad год. Xüsusi TCP portlarına bu port  год.';

$GLOBALS["lang"]['If no operator is specified, the default is =. Properties should be fully qualified - ie, devices.hostname (not just hostname).'] = 'Именно.';

$GLOBALS["lang"]['If no value is present, supply this value. EG: for system.nmis_group / configuraion.group we use'] = ' год.: sistem üçün.nmis_group /configuraion. Не, не.';
...
$GLOBALS["lang"]['If the Open-AudIT Server has Collectors reporting to it, an additional drop down is provided. You can select this to specify which Collector the task should run on. Only Discovery tasks are supported for Collectors.'] = 'Open- AudIT Server\'n buraxdııı kollektorlar varsa,  гор damla verilir. Именно.';
...
$GLOBALS["lang"]['If the following conditions are met:<br><ul><li>a Role has an assigned ad_group</li><li>an Org has an assigned ad_group</li><li>an LDAP Server has use_roles set to y</li><li>a user exists in LDAP (be it Active Directory or OpenLDAP) and is in the assigned ad_groups</li></ul>That user can log on to Open-AudIT without an account in Open-AudIT needing to be created. Open-AudIT will query the LDAP in question and if the user is in the required groups but not in Open-AudIT, their user attributes (name, full name, email,  roles, orgs, etc) within Open-AudIT will be automatically populated and they will be logged on.<br> <br>'] = '..<br/><ul><li>Rol ad_group t по şkil edir</li><li>- Да.</li><li>- Да.</li><li>bir istifad...çi LDAP var (bu aktiv Directory v... ya OpenLDAP) v... verilmiş ad_groups</li></ul>Именно.<br/> <br/>';

$GLOBALS["lang"]['If the local field is true (bool) or y (string) or Y (string) or 1 (integer) then set the external data to 1.'] = '- Да.';

$GLOBALS["lang"]['If the local field is true (bool) or y (string) or Y (string) or 1 (integer) then set the external data to y.'] = 'Yerli sah...sin doğru (bool) v... y y (string) v... y Y (istring) v... ya 1 (integer) olaraq xarici m...lumatları y.';

$GLOBALS["lang"]['If the primary IP (as reported by the device) is in this subnet, pass.</li>'] = '.';

$GLOBALS["lang"]['If the user account does not actually exist within Open-AudIT and <code>use_authorisation</code> is set, the user will be created. If it does exist, details such as email, full name, etc will be populated.'] = ' год. <code>use_authorisation</code> Именно.';
...
$GLOBALS["lang"]['If the user logging on to Open-AudIT does not have the access to search OpenLDAP, you can use another account which does have this access. Use the dn_account and dn_password to configure this.'] = 'Именно.';
...
$GLOBALS["lang"]['If your user does not have <i>Run as Administrator</i> rights, they can still download the agent (first command above) and run it to submit an audit as below. It will be a one-off audit without the Agent being installed or scheduled.'] = '.. <i>- Да.</i> Именно.';
...
$GLOBALS["lang"]['install_directory'] = 'Директору';

$GLOBALS["lang"]['Install Directory'] = 'Директору';
...
$GLOBALS["lang"]['Integrations can be scheduled as desired. This is left to the user.'] = 'Именно.';
...
$GLOBALS["lang"]['Internal JSON array of valid access tokens for this user.'] = 'Именно.';
...
$GLOBALS["lang"]['ip_scanned_count'] = 'Ип Сканирани sayı';

$GLOBALS["lang"]['Ip Scanned Count'] = 'Ип Сканирани sayı';
...
$GLOBALS["lang"]['LDAP was searched for this user and their account was not found. Check the LDAP server logs. The user credentials have worked, but the user was not found. Also check you have specified the correct Base DN attribute when you created the LDAP Server in Open-AudIT.'] = 'Именно.';
...
$GLOBALS["lang"]['ldap_dn_account'] = 'ДН';

$GLOBALS["lang"]['Ldap Dn Account'] = 'ДН';
...
$GLOBALS["lang"]['Level of privileges needed to exploit (None, Low, High).'] = 'istismara lozım olan imtiyazların  говмилии (None, Aşaı, Yüksk).';

$GLOBALS["lang"]['Liberia'] = '.';

$GLOBALS["lang"]['Libraries (ie, code that another program might include). These are typically items like Wordpress extensions, drupal extensions, node.js libraries, Android / iPhone / Windows libraries, python libraries, etc.'] = 'Въпреки това, това може да се дължи на факта, че е възможно да се види, че е възможно да се види, че е възможно да се види, че не е възможно да се направи това.';
...
$GLOBALS["lang"]['Limited to 100 rows.'] = ' да го направим.';
...
$GLOBALS["lang"]['Links this discovery to the associated cloud (if required). Links to <code>clouds.id</code>.'] = 'Именно. <code>clouds.id</code>.';
...
$GLOBALS["lang"]['List All NMAP Ports, Protocols and Programs for Each Device'] = 'Bütün NMAP Портове, Protokollar v  год.';
...
$GLOBALS["lang"]['Maintain records of risk assessments and treatments'] = 'Именно.';
...
$GLOBALS["lang"]['Matching Devices - Including OrgID'] = ' да го направим, а?';
...
$GLOBALS["lang"]['Measures the likelihood of the vulnerability being attacked, and is based on the current state of exploit techniques, exploit code availability, or active, “in-the-wild” exploitation.'] = 'Именно.';
...
$GLOBALS["lang"]['More elaborate SQL can used to group attributes within a range. Below shows the SQL for devices not seen in a pie chart grouped by last seen date ranges.'] = 'Именно.';
...
$GLOBALS["lang"]['Most of Open-AudIT is Licensed with GNU AGPL.'] = 'Open-AudIT . . . . . . . . .';
...
$GLOBALS["lang"]['Must Respond To Ping. If set, Nmap will fist attempt to send and listen for an ICMP response. If the device does not respond, no further scanning will occur.<br>Previously a device did not have to respond to a ping for Open-AudIT to continue scanning.'] = 'Именно.<br/>..';
...
$GLOBALS["lang"]['NOTE - You can prevent plain text credentials being displayed below by setting the configuration item for <code>decrypt_credentials</code> to <code>n</code>.'] = 'Именно. <code>decrypt_credentials</code> - Да. <code>n</code>.';
...
$GLOBALS["lang"]['No License for Professional or Enterprise'] = 'Professional срещу ya Enterprise üçün lisenziya';

$GLOBALS["lang"]['No Results'] = '.';

$GLOBALS["lang"]['No data in License Key'] = 'Lisenziya m при lumatları';
...
$GLOBALS["lang"]['Not every computer will be able to successfully complete a benchmark. We have seen in some fail in testing for reasons beyond our control. The logs should help point you in the right direction for these items.'] = ' гонката, която е по-голяма от това, което се случва.';

$GLOBALS["lang"]['Not in the (comma seperated) list'] = '.';

$GLOBALS["lang"]['Not normally used. If set, this requires the device to have an open port (as per Scan Options) to be considered responding. A MAC address, arp response or ping response is not considered sufficient to be considered responding. Useful if a router or firewall between the Open-AudIT server and target IP is responding to port scans on the IPs behalf.'] = ' год. ИП, ИП.';

$GLOBALS["lang"]['Note'] = '- Да.';

$GLOBALS["lang"]['Note - Selecting a parent will automatically provide access to its children (although it wont be shown here).'] = 'Qeyd - Bir uşaq seçm...k avtomatik olaraq uşaqlarına daxil ed...c...k (burada göst...rilm...';
...
$GLOBALS["lang"]['On the target Windows PC, run the DCOM utility and verify (or set) the below attributes. Start -> Run, Enter DCOMCNFG and press OK. This will open the DCOMCNFG window.'] = 'Windows PC haqqında, DCOM faydalı çalışır v... aşagıdakı xüsusiyyyyy... t...klif edir. ..';
...
$GLOBALS["lang"]['Once an Additional Field has been created it can be used in queries and groups just like any other attribute in the database.'] = 'Именно.';
...
$GLOBALS["lang"]['Once you have those items, in Open-AudIT Enterprise you can go to menu -> Discover -> Clouds -> Create Clouds, select the <i>Amazon AWS</i> type and paste them in. Done.'] = 'Именно. <i>AWS</i> ..';

$GLOBALS["lang"]['Once you have those items, in Open-AudIT Enterprise you can go to menu -> Discover -> Clouds -> Create Clouds, select the <i>Microsoft Azure</i> type and paste them in. Done.'] = 'Именно. <i>Microsoft Azure</i> ..';

$GLOBALS["lang"]['Once you have your cloud credentials, it is merely a matter of creating a new cloud and running the discovery - or scheduling first/future discoveries. Make sure you also have the credentials required to log on to your cloud machines, and it is all done for you just like a regular discovery. Credentials for your cloud'] = 'Именно.';
...
$GLOBALS["lang"]['One of Campus Area Network, Cloud Network, Enterprise Private Network, Home Area Network, Local Area Network, Metropolitan Area Network, Passive Optical Local Area Network, Personal Area Network, Storage-Area Network, System-Area Network, Virtual Private Network, Wide Area Network, Wireless Local Area Network.'] = 'Kampania M прирки , Cloud Network , Enterprise Private Network , Home Area Network , Local Area Network , Metropolitan Area Network , Пасивна оптична локална мрежа , Лична зона Мрежа , Storage-Area Network , Виртуална частна мрежа , Wide Area Network , Wireless Local Area Network';
...
$GLOBALS["lang"]['One of: antivirus, backup, firewall, approved, banned, ignored or other.'] = 'Biri: антивирус, поддръжка, защитна стена, t голюк...siz, göz...';
...
$GLOBALS["lang"]['Open-AudIT Enterprise. High-scale flexible discovery and audit solution for large networks. All the features of Professional plus: Baselines, File Auditing, Cloud Discovery, Rack Management, Configurable Role Based Access Control including Active Directory and LDAP.'] = 'Именно. Professional plus bütün xüsusiyyyyyy';

$GLOBALS["lang"]['Open-AudIT Field Name'] = 'Именно.';

$GLOBALS["lang"]['Open-AudIT Licenses'] = '- Да.';

$GLOBALS["lang"]['Open-AudIT Options'] = '..';

$GLOBALS["lang"]['Open-AudIT Professional and Enterprise include Enhanced Reporting features, including time-based, historical, and muti-query based reporting features in multiple formats.'] = 'Именно.';
...
$GLOBALS["lang"]['Open-AudIT can be configured to use LDAP servers (Microsoft Active Directory and/or OpenLDAP) to authenticate and authorize a user and in addition, to create a user account in Open-AudIT using assigned roles and orgs based on LDAP group membership. It can also use'] = 'Именно.';

$GLOBALS["lang"]['Open-AudIT can be run on your server in your data center. It does not need access to the internet at all. Even the installation on Linux where we use the distribution package manager for our prerequisites can be negated by you using an in-house and security team-approved package repository.<br><br>Open-AudIT does not store any of your data in the cloud. Even licensing information can be provided without having to access the internet from the Open-AudIT server.<br><br>Sure, it is easier to allow it to access the internet to download packages (including security fixes) for your distribution, but that is up to you and your security policies. Open-AudIT does not need the internet.'] = 'Именно.<br/><br/>Именно.<br/><br/>..';

$GLOBALS["lang"]['Open-AudIT can download, parse and use NIST CVE Vulnerability reports.'] = '..';

$GLOBALS["lang"]['Open-AudIT can show in one of several languages. How you can improve this?'] = 'Именно.';

$GLOBALS["lang"]['Open-AudIT can store information in additional fields that are associated with each device.'] = '..';

$GLOBALS["lang"]['Open-AudIT can use Microsoft Entra (previously known as Microsoft Azure Active Directory) as an authentication method. This means your user in Open-AudIT can click the Logon using Entra button on the logon page and use their Entra credentials to logon. That user will need to already exist within Open-AudIT (and be assigned'] = 'Именно.';

$GLOBALS["lang"]['Open-AudIT can use OKTA as an authentication method. This means your user in Open-AudIT can click the Logon using OKTA button on the logon page and use their OKTA credentials to logon. That user will need to already exist within Open-AudIT (and be assigned Roles and Orgs), but will not need to remember a separate set of logon credentials.'] = ' да го направим. Това е вярно.';
...
$GLOBALS["lang"]['Open-AudIT has a JSON Restful API to be used both in the web interface and via JSON requests.'] = 'И това е така, защото това не е вярно.';

$GLOBALS["lang"]['Open-AudIT has a granular permissions system to determine what a user within Open-AudIT can do, and the items he can do it to. Open-AudIT can be entirely self-contained, or use Active Directory or OpenLDAP for authentication and/or authorization.<br><br>It is entirely up to the administrator of Open-AudIT how they would like the Role Based Access Control to work.'] = '..<br/><br/>Именно.';

$GLOBALS["lang"]['Open-AudIT has a powerful change detection engine. Any device attributes that are added, removed or changed will be detected and stored. These changes can be reported upon and the relevant data confirmed as to what was expected from your company change and release process.<br><br>When a device is audited, attributes are divided into sections which correspond to tables in the database.<br><br>Each device (computer, router, printer, et al) has an entry in the <code>devices</code> table. Each entry in the devices table has an <code>id</code> column. This value is unique - it is an auto-incrementing id.<br><br>When the audit result is processed, each item in each section has its audit result compared to what is in the database.<br><br>For each section, if the key columns (see below table) contain the identical values, it is considered already installed and has its <code>last_seen</code> attribute updated. No change_log entry is created.<br><br>If any of the key columns do not match, it is considered a new attribute and is inserted. A <code>change_log</code> entry is created if the device had other attributes already present in the table.<br><br>At the completion of the audit processing, any database items that have not been updated (or inserted) are considered to not be present. The <code>current</code> attribute for this item is set to <i>n</i> and a change_log entry is generated.<br><br>So, we can determine if something is currently installed - the current column is <i>y</i>.<br><br>We can determine when something was initially detected - the <i>first_seen</i>.<br><br>We can determine if something was installed after the initial audit - first seen will be different in the component and device tables.<br><br>We can determine if something is not currently installed, but previously was - current = <i>n</i>.<br><br>We can determine the last time we detected an item - last_seen.<br><br>At any given point, we can determine what was on a system - by using the audit_log table and selecting the relevant components based on first_seen and last_seen.<br><br>Each section and its matching key columns are below.<br><br>NOTE - There are some exceptions as detailed below.<br><br>*1 - For network cards, if the computer is a VMware Esx machine it also uses the net_index and connection columns.<br><br>*2 - For partitions, f the computer is an AIX machine, we use the partition name.'] = 'Именно.<br/><br/>Именно.<br/><br/>. <code>devices</code> - Да. <code>id</code> да го направим.<br/><br/>Именно.<br/><br/>- Да. <code>last_seen</code> ..<br/><br/>.. <code>change_log</code> ..<br/><br/>Именно. Axtarış <code>current</code> - Не, не. <i> n</i> - Да.<br/><br/>.. <i> y</i>.<br/><br/>.. <i>- Да.</i>.<br/><br/>..<br/><br/>.. <i> n</i>.<br/><br/>..<br/><br/> за да се засече, че това може да се случи, ако не е възможно.  да го направим. Не, не, не.<br/><br/>..<br/><br/> да го направим, да го направим.<br/><br/> И това е, че това е нещо, което може да се случи.<br/><br/>*2 -  год.';

$GLOBALS["lang"]['Open-AudIT is a program designed to track and report on your IT and related assets details and configuration. Open-AudIT can tell \"What\\'] = 'Именно.';

$GLOBALS["lang"]['Open-AudIT makes it easy to edit the attributes of multiple devices at once.'] = '- Да.';

$GLOBALS["lang"]['Open-AudIT needs specific directory permissions to be able to create files, upload results, etc. Please set as below.'] = 'Именно.';

$GLOBALS["lang"]['Open-AudIT provides many built-in queries and makes it simple to create your own.'] = 'Именно.';

$GLOBALS["lang"]['Open-AudIT ships with inbuilt roles for admin, org_admin and user.<br><br>Generally, a user who is an administrator of the Open-AudIT application itself should have admin and possible org_admin roles.<br><br>A user can have multiple roles. The permission will be applied at the most permissive level - IE, if a user has the roles of user and org_admin, they will be able to create locations because org_admin grants this permission, even though the user role does not.<br><br>The admin role allows access to collections such as configuration, database, groups, ldap servers, logs, queries and roles. Global items that affect the entire application.<br><br>The org_admin role usually allows create, read, update and delete actions for any collection that contains the org_id column. Virtually all data except some of the collections mentioned above will contain an <code>org_id</code> column.<br><br>The user role generally allows read only access to all items with an org_id column.'] = 'Именно.<br/><br/>- Да.<br/><br/>Именно.<br/><br/>admin rol formasiya, baza, qruplar, ldap server, logs, sorgular v гол. ..<br/><br/>Org_admin rolu . . . . . . . . . Именно. <code>org_id</code> - Да.<br/><br/>..';

$GLOBALS["lang"]['Open-AudIT ships with inbuilt roles for admin, org_admin and user.<br><br>Generally, a user who is an administrator of the Open-AudIT application itself should have admin and possible org_admin roles.<br><br>A user can have multiple roles. The permission will be applied at the most permissive level - IE, if a user has the roles of user and org_admin, they will be able to create locations because org_admin grants this permission, even though the user role does not.<br><br>The admin role allows access to collections such as configuration, database, groups, ldap servers, logs, queries and roles. Global items that affect the entire application.<br><br>The org_admin role usually allows create, read, update and delete actions for any collection that contains the org_id column. Virtually all data except some of the collections mentioned above will contain an org_id column.<br><br>The user role generally allows read only access to all items with an org_id column.'] = 'Именно.<br/><br/>- Да.<br/><br/>Именно.<br/><br/>admin rol formasiya, baza, qruplar, ldap server, logs, sorgular v гол. ..<br/><br/>Org_admin rolu . . . . . . . . . Именно.<br/><br/>..';
...
$GLOBALS["lang"]['Option #2 - Change the translation file'] = ' год.';

$GLOBALS["lang"]['Optional Agent Based Auditing'] = 'Не, не, не.';

$GLOBALS["lang"]['Optional version as audited by Open-AudIT. Use the percent sign % as a wildcard.'] = 'Именно.';

$GLOBALS["lang"]['options'] = '- Да.';

$GLOBALS["lang"]['Options'] = '- Да.';

$GLOBALS["lang"]['Options, options, options'] = 'Именно.';
...
$GLOBALS["lang"]['Orgs in Open-AudIT are a key item. A user has a primary Org as well as a list of Orgs they can access. A user combines this with a list of assigned roles that define what actions they can take on items assigned to the Orgs they have access to. The combination of a users <i>orgs</i> and <i>roles</i> define what they can and cannot do within Open-AudIT.<br><br>Most items in Open-AudIT are assigned to an Org. Devices, Locations, Networks, etc, etc.<br><br>Orgs can have child Orgs. Think of an organisational chart (tree) structure. If a user has access to a specific Org, most of the time (not always) they also have access to that Orgs descendants.'] = '- Да. <i>.</i> Qeydiyyat <i>.</i> ..<br/><br/>(Pop-AudIT).<br/><br/>Именно. Бир истифад гохинин xüsusi Org daxil varsa, vaxtın  гон çoxu (heç... deyil) Orgs qбul edir.';
...
$GLOBALS["lang"]['Other than that restriction, you are free to select attributes as required. It is a good idea to use the menu'] = 'Именно.';

$GLOBALS["lang"]['Others'] = '.';

$GLOBALS["lang"]['Our default Integration also enables a discovery on any externally supplied devices. So we ship a default discovery for the Default Integration out of the box. These use the default matching rules, but also enable matching on IP address.'] = 'Именно.';
...
$GLOBALS["lang"]['Packages are used to report on things such as <i>banned software</i>, AntiVirus on servers, etc.<br><br>Open-AudIT provides widgets that build upon also supplied repots to detemine the status of antivirus, firewall and other software.'] = '.. <i>Не, не.</i>server, v... s.<br/><br/> готварската граница е, че тя може да се използва и за да се определи дали е способна да се справи с това.';
...
$GLOBALS["lang"]['Passive Optical Local Area Network'] = 'Именно.';
...
$GLOBALS["lang"]['Please send all three files to your support contact at Opmantek and describe your issue.'] = 'Именно.';
...
$GLOBALS["lang"]['Populated from DNS.'] = 'ДНС.';

$GLOBALS["lang"]['Populated from SNMP discovery.'] = 'СНМП.';
...
$GLOBALS["lang"]['Populated from the IP for the default route or the IP detected in discovery.'] = ' год.';
...
$GLOBALS["lang"]['ports_in_order'] = 'Сифариш';

$GLOBALS["lang"]['Ports In Order'] = 'Сифариш';

$GLOBALS["lang"]['ports_stop_after'] = '..';

$GLOBALS["lang"]['Ports Stop After'] = '..';

$GLOBALS["lang"]['Portugal, Portuguese Republic'] = 'Именно.';
...
$GLOBALS["lang"]['purchase_vendor'] = 'Сатъш';

$GLOBALS["lang"]['Purchase Vendor'] = 'Сатъш';
...
$GLOBALS["lang"]['Queries are an important part of Open-AudIT. They are what enables you to get meaningful information from all the device data you have discovered. Along with summaries and groups, they provide a powerful mechanism to extract crucial information.'] = 'Именно.';

$GLOBALS["lang"]['Queries for Groups should select only the'] = 'Qruplar üçün proqramlar yalnız seçm годир';

$GLOBALS["lang"]['Query'] = 'Бакъ';

$GLOBALS["lang"]['Query this Active Directory attribute first to determine the users work unit.'] = 'Bu Active Directory istifad...çil...';

$GLOBALS["lang"]['Query this Active Directory attribute second to determine the users work unit.'] = 'Bu Active Directory istifad...çil...';

$GLOBALS["lang"]['queue'] = 'Бакъ';

$GLOBALS["lang"]['Queue'] = 'Бакъ';

$GLOBALS["lang"]['Queue Limit'] = 'Калерея';

$GLOBALS["lang"]['Queued Device Audits'] = 'Именно.';
...
$GLOBALS["lang"]['raw'] = ' да го направим.';
...
$GLOBALS["lang"]['Report on your devices, networks and more'] = 'Sizin cihazlarınız, ş... h...rl...r. v... daha çox';
...
$GLOBALS["lang"]['Retrieve a list of devices with OS Name like Windows 2008'] = 'Windows 2008 kimi OS Adı il';
...
$GLOBALS["lang"]['Retrieve all devices with the standard columns'] = ' да го направим.';

$GLOBALS["lang"]['Retrieve the first 10 devices running Windows ordered by hostname'] = ' също така, например, може би, но не е възможно да се каже, че това не е вярно.';

$GLOBALS["lang"]['Retrieve the properties id, ip, hostname, domain, type from all devices'] = '..';

$GLOBALS["lang"]['retrieved'] = 'Бакъ';
...
$GLOBALS["lang"]['Retrieved from the device - Windows:Win32_ComputerSystemProduct, Linux:dmidecode, MacOS:system_profiler, ESXi:vim-cmd hostsvc/hostsummary, HP-UX:machinfo, Solaris:smbios, AIX:uname.'] = ' Retrieve: Win32_ComputerSystemProduct, Linux:dmidecode, MacOS:system_ profiler, ESXi: vim-cmd hostvc/hostsummary, HPUX-:machinfo, ';
...
$GLOBALS["lang"]['Running Open-AudIT Apache Service Under Windows'] = '. Apache  големоглавец';
...
$GLOBALS["lang"]['SQL Creation Statements'] = 'SQL jaradılması mбlumatları';

$GLOBALS["lang"]['SQL not containing this condition will result in the widget failing to be executed.'] = 'Bu xidm. ed.n SQL, widget-da icra olunacacq.';

$GLOBALS["lang"]['SSH'] = 'Калерея';

$GLOBALS["lang"]['SSH Key'] = 'SSH  големоглав';

$GLOBALS["lang"]['SW Revision'] = ' СУ';
...
$GLOBALS["lang"]['Save as Default'] = ' да го направим.';
...
$GLOBALS["lang"]['Scope is known as Authorization Scope, representing whether a vulnerability affects resources beyond the original security authority of the vulnerable component.<br><br>The only two valid values for this attribute are'] = 'Именно.<br/><br/>Именно.';
...
$GLOBALS["lang"]['See above. NOTE - This could also be caused by a self-signed certificate on the LDAP server. We are working to allow for this in a future release.'] = '- Да. Именно.';

$GLOBALS["lang"]['See our page on enabling'] = ' да го направим, да го направим.';

$GLOBALS["lang"]['Seed Discoveries'] = '..';

$GLOBALS["lang"]['seed_ip'] = 'ИП';

$GLOBALS["lang"]['Seed IP'] = 'ИП';
...
$GLOBALS["lang"]['Select and apply appropriate controls (Annex A)'] = 'Именно.';

$GLOBALS["lang"]['Select the <i>COM Security</i> tab<br><br>Click on Access Permissions Edit Default'] = 'Не, не, не. <i>.</i> подпрозорец<br/><br/>Достъп до Proqram';
...
$GLOBALS["lang"]['service_identifier'] = ' год.';

$GLOBALS["lang"]['Service Identifier'] = ' год.';
...
$GLOBALS["lang"]['Should this file (or pattern) be used to exclude files from being reported. Normally, to audit files, this is set to <code>y</code>.'] = 'Именно. <code>y</code>.';
...
$GLOBALS["lang"]['Should we audit a SAN if the management software is detected.'] = ' гон.';
...
$GLOBALS["lang"]['Should we run an audit and submit it (y/n).'] = 'Именно.';

$GLOBALS["lang"]['Should we test for SNMP using UDP port 161.'] = '..';

$GLOBALS["lang"]['Should we test for SSH using TCP port 22.'] = ' гонката е на TCP 22.';
...
$GLOBALS["lang"]['Should we use the win32_product WMI class (not recommended by Microsoft) when retrieving installed software.'] = 'Именно.';
...
$GLOBALS["lang"]['Should we use this method to populate a users roles. The field <code>use_auth</code> must be set to <code>y</code> to use this. Set to <code>y</code> or <code>n</code>.'] = '.. <code>use_auth</code> .. <code>y</code> - Да. - Да. <code>y</code> . <code>n</code>.';
...
$GLOBALS["lang"]['site_hours_b'] = 'Сайт Saatları B';

$GLOBALS["lang"]['Site Hours B'] = 'Сайт Saatları B';
...
$GLOBALS["lang"]['Slovakia (Slovak Republic)'] = '[Смях]';

$GLOBALS["lang"]['Slovenia'] = '- Да.';

$GLOBALS["lang"]['Slovenian'] = '[Смях]';
...
$GLOBALS["lang"]['software_key'] = 'Именно.';

$GLOBALS["lang"]['Software Key'] = 'Именно.';
...
$GLOBALS["lang"]['Solaris'] = 'Бакъ';

$GLOBALS["lang"]['Solomon Islands'] = '.';

$GLOBALS["lang"]['Somalia, Somali Republic'] = 'Именно.';
...
$GLOBALS["lang"]['Some other error has occurred when attempting to bind to the LDAP server. It is contactable (ie, the <i>connect</i> above has worked), but for some other reason, binding has not occurred. Check the logs on the LDAP server.'] = 'Именно. <i>- Не, не.</i> Именно.';
...
$GLOBALS["lang"]['Specific to OKTA.'] = '[Смях]';

$GLOBALS["lang"]['Specifies a comma-separated list of targets (no spaces) to be excluded from the scan. The list you pass in uses normal Nmap syntax, so it can include hostnames, CIDR netblocks, octet ranges, etc.'] = 'Именно.';
...
$GLOBALS["lang"]['sub_resource_id'] = ' год.';

$GLOBALS["lang"]['Sub Resource ID'] = ' год.';
...
$GLOBALS["lang"]['Sudo Password (optional)'] = '[Смях]';

$GLOBALS["lang"]['suite'] = 'Бакъ';
...
$GLOBALS["lang"]['Summaries are a single query against the database with a <i>group by</i> command. Using this simple method we can easily create a summary for virtually any attribute.<br><br>We no longer require a separate report for each <i>type</i> of a device. We now simply have a summary that groups by <i>devices.type</i> and shows the result. You can then click on a given type from the list and see the matching devices. In this case, one Summary replaces (potentially) 78 reports (there are 78 device types).<br><br>A summary is different to a query in that a summary is designed to group items by a given attribute then provide a <i>click through</i> link to the actual devices. A query is simply a list of items with no further links. As above - this of a Summary as a combined <i>report + subreport</i>, whereas a query is simply a single Report.<br><br>Summaries have a different collection template to the other resources within Open-AudIT. This template shows the Summary as you would expect and also shows buttons with counts of other resources. This page is designed to be the HomePage of Open-AudIT.'] = '- Да. <i>.</i> Именно.<br/><br/>.. <i>- Да.</i> .. <i>..</i> ..<br/><br/>Bir m <i>- Да.</i> Именно. <i>..</i>..<br/><br/>Именно.';

$GLOBALS["lang"]['Summaries are designed to group items by a particular matching column and then to provide a link to individual devices. In the previous versions of Open-AudIT, this would have been two different items - a report and subreport. We have now bundled these into what we call a Summary.'] = 'Именно.';

$GLOBALS["lang"]['Summaries provide drilldown reporting capabilities. Simple, intuitive, powerful.'] = 'Именно.';
...
$GLOBALS["lang"]['Supported types are <code>subnet</code>, <code>seed</code> and <code>active directory</code>.'] = '.. <code>subnet</code>.. <code>seed</code> Qeydiyyat <code>active directory</code>.';
...
$GLOBALS["lang"]['test_os'] = '- Да. Oxunub';

$GLOBALS["lang"]['Test Os'] = '- Да. Oxunub';
...
$GLOBALS["lang"]['The <i>Roles</i> endpoint allows you to manage the set of permissions(Create, Read, Update, Delete) that are granted to the users and are applied to each endpoint.'] = 'Axtarış <i>.</i> Не, не.';
...
$GLOBALS["lang"]['The Attributes endpoint allows you to add customized values to different attributes in Open-AudIT, at the moment this feature works on the Class, Environment, Status and Type attributes on Devices, the Type attribute for both Locations and Orgs as well as the Menu Category for Queries. If you view an item of one of the prvious types (say view a Lkocation) you will notice the Type attribute must be selected from a drop-down box. This is where those values are stored. Hence, if you would like to add a new Type to be chosen for a Location, add it using the Attributes feature.'] = 'Характеристики крайна точка Open-AudIT müxt... H.r.y.r.r.v.Orgs üçün Tip xüsusiyyyy.tl.ri, h.mçi üçün Menkulator Kateqoriyası. - Да.';
...
$GLOBALS["lang"]['The CVE has been marked as invalid or withdrawn in the CVE List. It remains in the NVD but is excluded from default search results.'] = 'CVE CVE siyahısı qeyd olunmuş v  го gieri alınmışdır. Bu NVD-da saxlayır, lakin original axtarış n...tic...l...ri Istina edilir.';

$GLOBALS["lang"]['The CVE has been published to the CVE List and included in the NVD dataset. Initial ingestion only.'] = 'Именно.';
...
$GLOBALS["lang"]['The CVE is actively being enriched with CVSS scores, CWE classifications, reference tags, and CPE applicability.'] = 'CVE, CVS puanları, CWE imtahanları,    год.';

$GLOBALS["lang"]['The CVE is not currently prioritized for enrichment due to resource constraints or other reasons.'] = 'Именно.';

$GLOBALS["lang"]['The CVE is queued for enrichment by NVD analysts. No detailed metadata yet.'] = 'CVE NVD analitikl...ri t...r...find...n z...ng üçün sıralanır. - Не, не.';
...
$GLOBALS["lang"]['The Discovery Scan Options we ship are detailed in the table below. As above, Enterprise users can create more of these or edit the shipped items.'] = 'Именно.';

$GLOBALS["lang"]['The Elevated User query'] = '- Да.';

$GLOBALS["lang"]['The Executables feature scans the disk of a device as part of the audit and checks that every executable file is known to the package manager. Because it uses the package manager, the feature applies to Linux target devices only, and further than that, only rpm or deb based distributions. Anything Redhat or Debian based should work.'] = 'Изпълнители xüsusi procedin bir his...si kimi bir al... - Уау.';

$GLOBALS["lang"]['The FROM'] = '- Да.';

$GLOBALS["lang"]['The Group used to run the Baseline. Links to <code>groups.id</code>.'] = 'Именно. <code>groups.id</code>.';
...
$GLOBALS["lang"]['The ID from the locations table (the locations.name will be displayed) of this end of the connection. Links to <code>locations.id</code>. The B location is usually the <code>TO</code> location.'] = '.. <code>locations.id</code>Б, Б. <code>TO</code> - Не, не.';
...
$GLOBALS["lang"]['The IP of the external interface.'] = 'ИП ..';

$GLOBALS["lang"]['The IP of the internal interface.'] = 'IP  год.';

$GLOBALS["lang"]['The ISO/IEC 27001 certification process and its key elements.'] = 'ISO/IEC 27001 sertifikatlaşdırma prosesi v готварски елемент';

$GLOBALS["lang"]['The ISP or Telco providing this link.'] = 'ISP срещу ya Telco bu linki t гомин edir.';

$GLOBALS["lang"]['The JSON record from Mitre.'] = '[Смях]';

$GLOBALS["lang"]['The JSON record from the NVD feed.'] = 'N.V.D. хранят JSON Rekord.';

$GLOBALS["lang"]['The LDAP OU of this user (if LDAP is used).'] = 'Bu istifad гончинин LDAP OU (ако LDAP istifad по olunur).';

$GLOBALS["lang"]['The LDAP server could not be connected to. At all. Check it is pingable from the Open-AudIT server. Check the correct port is open to the Open-AudIT server. An nmap from the Open-AudIT server will show this. Substitute your LDAP servers IP for $ip. Try:<code>nmap -vv $ip</code>'] = 'Именно.<code>nmap -vv $ip</code>';
...
$GLOBALS["lang"]['The National Institute of Standards and Technology is the federal technology agency. They advance official technology, measurement science and standards.'] = 'Standartlar v год. Texnologiya Мили Институ федерален агент Текнология. Не, не.';

$GLOBALS["lang"]['The Network to Discover'] = '.';

$GLOBALS["lang"]['The Nmap timing preset.'] = '.';

$GLOBALS["lang"]['The OS this package should be reported against. Blank for all. Use the percent sign % as a wildcard. Will be tested against os_group, os_family and os_name in that order.'] = 'Именно.';
...
$GLOBALS["lang"]['The Open-AudIT server code was exeucted within this file.'] = 'Именно.';

$GLOBALS["lang"]['The Open-AudIT server code was exeucted within this function.'] = '..';

$GLOBALS["lang"]['The OpenSCAP ecosystem provides multiple tools to assist administrators and auditors with assessment, measurement, and enforcement of security baselines including a wide variety of hardening guides and configuration baselines developed by the open source community, ensuring that you can choose a security policy which best suits the needs of your organization, regardless of its size.'] = 'Именно.';

$GLOBALS["lang"]['The OpenSCAP project is a collection of open source tools for implementing and enforcing this standard, and has been awarded the SCAP 1.2 certification by NIST in 2014.'] = 'OpenSCAP layih...si bu standart t... NIST t прищракване на SCAP 1.2 sertifikatlaşdırılmışdır.';
...
$GLOBALS["lang"]['The RU positon of the top of this device.'] = ' Именно.';

$GLOBALS["lang"]['The Racks feature is used to manage and visualize your rack use with an Organisation, Location, Building, Floor, Room and Row.'] = 'Racks xüsusiyyyyy... Да, Бина. Кат, Oda v год. Row il... d...st...k istifad...';

$GLOBALS["lang"]['The SCAP is a specification for expressing and manipulating security data in standardized ways. SCAP uses several individual specifications in concert to automate continuous monitoring, vulnerability management, and security policy compliance evaluation reporting'] = 'SCAP standartlaşdırılmış yollarla t голюк...sizliyi veril...nm... v... manipule etm...k üçün bir spesifikasiyadır. ..';

$GLOBALS["lang"]['The SELECT'] = 'Qeydiyyat';

$GLOBALS["lang"]['The SELECT section of the query should use full dot notation and also request the field with its full dot name. IE - SELECT devices.id AS `devices.id`. Each field should be selected in this fashion to enable GUI side attribute filtering.'] = 'Araşdırmanın SE bölm год. - Да.';
...
$GLOBALS["lang"]['The SNMP v3 Security Name.'] = 'СНМП 3.';

$GLOBALS["lang"]['The SNMPv3 context Engine ID (optional).'] = 'SNMPv3 konfrans maşın ID (по избор)';

$GLOBALS["lang"]['The SNMPv3 context Name (optional).'] = 'SNMPv3 konfransı adı (по избор)';

$GLOBALS["lang"]['The SQL cannot contain <strong>WHERE @filter OR</strong>. That SQL will not be executed, however <strong>WHERE @filter AND</strong> queries are allowed.'] = '.. <strong>КЪДЕ @филтър ИЛИ</strong>. <strong>Калерея</strong> - Да.';

$GLOBALS["lang"]['The SQL queries used in Open-AudIT require the use of the backtick - ` character and NOT the standard single quote for fields. On most US Windows keyboards the backtick key is located in the top-left of the keyboard along with the tilde ~. On a US Mac keyboard the backtick key is located next to the SHIFT key. The standard single quote is still used to enclose values as the examples below illustrate.'] = 'Open-AudIT istifad. edil. edil.n SQL sorguları geritick istifad. etm.k. ist.yir. ..';
...
$GLOBALS["lang"]['The URL the audit scripts should submit their result to.'] = 'URL-nine идар olunması ленивци.';
...
$GLOBALS["lang"]['The Windows log may say the following'] = ' да го направим.';

$GLOBALS["lang"]['The account must have a password; WMI does not allow blank passwords.'] = '..';

$GLOBALS["lang"]['The account password must NOT contain \" (double quotes). This is because cscript (and wscript) cannot parse argument values containing double quotes. They are simply stripped. No (before you ask) escaping will not work. This is a cscript limitation and nothing to do with Open-AudIT.'] = 'Именно.';

$GLOBALS["lang"]['The actual full name of this user.'] = 'Не, не.';

$GLOBALS["lang"]['The address of the Open-AudIT server submit page.'] = 'Open- AudIT сървър в ünvanı';

$GLOBALS["lang"]['The administrator supplied credentials that were successfully used to bind to LDAP.'] = '..';

$GLOBALS["lang"]['The administrator supplied credentials to bind to the LDAP server, but they have not been accepted by the LDAP sevrer. Double check the credentials work on the LDAP server, and then check (or reset them) in the Open-AudIT LDAP Server entry.'] = 'Именно.';
...
$GLOBALS["lang"]['The agent should download a fresh copy of the audit script, run it and submit the result to the server.'] = 'Агент одит скрипт Yeni bir nümun... Yükl...m...k lazelımdır, пуснете го на сървър q...';
...
$GLOBALS["lang"]['The attribute to test (must match an external field name from below).'] = 'Tesin xüsusiyyyyyy... (aşaıdan xarici bir sah...si adı il... eşl...yir).';
...
$GLOBALS["lang"]['The audit script will use the files[ ] array and retrieve the file details.'] = 'Audit script faylları istifad по-малко от [] mass v.';

$GLOBALS["lang"]['The audit scripts all accept a debugging argument. You can run the script utilizing that and see in more detail what the issue is. And if you cannot figure it out - that is what we are here for! Open a support case and we will get things running in no time.'] = 'Именно.';
...
$GLOBALS["lang"]['The calculated number of devices to be created externally.'] = 'Чихазларен хезабланмъш каза, че е ярадълмашъ.';
...
$GLOBALS["lang"]['The current date and time in the format: Y-m-d H:i:s.'] = 'Не, не. Y-m-d';

$GLOBALS["lang"]['The current date in Y-m-d format.'] = 'Y-m-d formationında cari tarix.';
...
$GLOBALS["lang"]['The database schema can be found in the application if the user has database::read permission by going to menu: Admin -> Database ->'] = 'Именно.';

$GLOBALS["lang"]['The database version and web version are inconsistent.'] = 'Web versiyası zövq edir.';
...
$GLOBALS["lang"]['The date the software no longer receives updates and is effectively discontinued altogether. Maintenance is discontinued.'] = 'proqram artıq yenil.ndirilm.si almaq срещу epektiv çıxış edir. - Да.';

$GLOBALS["lang"]['The date this item was changed or added (read only). NOTE - This is the timestamp from the server.'] = ' да го направим, да го направим. -';

$GLOBALS["lang"]['The date/time when this result was created.'] = 'Именно.';
...
$GLOBALS["lang"]['The default language assigned to any user created by this method.'] = 'Bu üsul t по-малко от 50.';
...
$GLOBALS["lang"]['The enterprise binary from FirstWave is required for a license. Please download Open-AudIT from'] = 'BirinciWave şirk...ti ikilisi lisenziya üçün t... ..';

$GLOBALS["lang"]['The entire associated baseline this result is from.'] = '- Да.';

$GLOBALS["lang"]['The exploited vulnerability can affect resources beyond the security authority of the vulnerable component. This usually means a privilege or trust boundary is crossed (for example, escaping from a container to the host OS).'] = 'Не, не. Bu, bir imtiyaz v го я  гом голиятт хаята keçirilir (örnegin, ev sahibi OS bir konteyner qarşısını almq).';

$GLOBALS["lang"]['The exploited vulnerability only impacts resources within the same security authority as the vulnerable component. In other words, the attacker’s actions stay within the original trust boundary.'] = 'Именно.';
...
$GLOBALS["lang"]['The foreign table to reference. Should be one of: devices, locations, orgs or queries.'] = 'Именно.';

$GLOBALS["lang"]['The format of your data should be in the form'] = '.';

$GLOBALS["lang"]['The format used for the output to be emailed.'] = '..';

$GLOBALS["lang"]['The fully qualified column upon which to group by. NOTE: When type = traffic, this represents the red query id.'] = 'Именно.';

$GLOBALS["lang"]['The fully qualified name returned by the external system. EG: for NMIS we use configuration.roleType.'] = 'Xarici sistem t  гор гонят там. E  готвех се да го направя.';

$GLOBALS["lang"]['The fully qualified table.column. Multiple may be provided, separated by a comma (no spaces).'] = '..';

$GLOBALS["lang"]['The generated SQL query to test for this vulnerability. This field can be edited to correct the query as required.'] = 'Bu boşluğu test üçün jaradılan SQL sorğu jaradılıb. Не, не.';

$GLOBALS["lang"]['The group of devices on which the baseline was run against.'] = 'bazalın qarşı işl гон cyhazlar qrupu.';
...
$GLOBALS["lang"]['The identifier column (integer) in the database (read only).'] = 'Именно.';

$GLOBALS["lang"]['The importance of this baseline (not used yet).'] = 'Bu üslubunun  говмилиии (heç istifad по етм...).';

$GLOBALS["lang"]['The integer of severity.'] = '.';

$GLOBALS["lang"]['The internal value, reformatted in this format.'] = 'Именно.';
...
$GLOBALS["lang"]['The name given to this item. Ideally it should be unique.'] = 'Именно.';

$GLOBALS["lang"]['The name given to this user (used to login). Ideally it should be unique.'] = 'Bu istifad...çiy... verilmiş adı (giriş etm...k üçün istifad... olunur). ..';

$GLOBALS["lang"]['The name of the associated cloud (if required).'] = '.';

$GLOBALS["lang"]['The name of the software package, as audited by Open-AudIT. Use the percent sign % as a wildcard.'] = 'Open-AudIT t гонят баксилан proqram paketinin adı. - Да.';
...
$GLOBALS["lang"]['The network subnet to execute the discovery on.'] = 'Именно.';
...
$GLOBALS["lang"]['The number of audited devices in this cloud. Links to <code>devices.cloud_id</code> and <code>devices.serial</code>.'] = '- Да. <code>devices.cloud_id</code> Qeydiyyat <code>devices.serial</code>.';
...
$GLOBALS["lang"]['The number of devices in this cloud with a state of running. Links to <code>devices.cloud_id</code> and <code>devices.instance_state</code>.'] = 'Именно. <code>devices.cloud_id</code> Qeydiyyat <code>devices.instance_state</code>.';

$GLOBALS["lang"]['The number of devices in this cloud with a state of stopped. Links to <code>devices.cloud_id</code> and <code>devices.instance_state</code>.'] = '.. <code>devices.cloud_id</code> Qeydiyyat <code>devices.instance_state</code>.';
...
$GLOBALS["lang"]['The number of low severity vulnerabilities held by FirstWave (not in your database).'] = 'Именно.';
...
$GLOBALS["lang"]['The only required permission / policy name (in our testing) is'] = 'Yalnız lodenım olan m';

$GLOBALS["lang"]['The optional secondary column. NOTE: When type = traffic, this represents the yellow query id.'] = 'Именно.';

$GLOBALS["lang"]['The optional third column. NOTE: When type = traffic, this represents the green query id.'] = 'Именно.';

$GLOBALS["lang"]['The order of information retrieval is snmp, ssh, wmi.'] = 'Именно.';
...
$GLOBALS["lang"]['The recommended process of addressing and fixing identified security vulnerabilities. This typically involves applying patches, updates, or other measures to eliminate the risk posed by the vulnerabilities.'] = 'Müasir t голюк... sizlik açıqlarını qarşılaşdırmaq v... qarşılaşdırma prosesi. Не, не.';

$GLOBALS["lang"]['The regular domain notation of your directory. Eg - <code>open-audit.lan</code>.'] = '.. Eg - <code>open-audit.lan</code>.';

$GLOBALS["lang"]['The requested properties should be in a comma-separated list. Properties should be fully qualified - ie, system.hostname (not just hostname).'] = '- Да. - Уау. Именно.';
...
$GLOBALS["lang"]['The search for group on the LDAP server failed. Check the LDAP server logs. Have you created these groups (for roles and orgs) on the LDAP server and assigned LDAP users to them?'] = 'LDAP serverind  год. qrup axtarışbaşarısız oldu. ..';
...
$GLOBALS["lang"]['The specific database column from the specified database table.'] = 'Qeyd edilmiş baszar masasından xüsusi bazası sütunu.';
...
$GLOBALS["lang"]['The target computer to audit. \".\" means localhost.'] = 'Именно.';
...
$GLOBALS["lang"]['The timestamp after which, this task should run. For example, run a task after the 1st June 2017 at 10am, set it to <code>2017-06-01 09:59:00</code>. This value should be zero padded (ie, 09, not 9). This value defaults to <code>2000-01-01 00:00:00</code> which means by default, a scheduled task will run at next scheduled execution time.'] = 'Sonrakı vaxtlar, bu qurgu işl год. . 10: <code>2017-06-01 09:59:00</code>. Именно. <code>2000-01-01 00:00:00</code> Именно.';

$GLOBALS["lang"]['The top 10, 100 or 1000 (or none) TCP ports commonly in use according to Nmap.'] = 'Топ 10, 100 v... 1000 (ya da heç bir) TCP portları Nmap gör... istifad... olunur.';

$GLOBALS["lang"]['The top 10, 100 or 1000 (or none) UDP ports commonly in use according to Nmap.'] = 'Топ 10, 100 v... 1000 (ya da heç bir) UDP portları Nmap gör... istifad... olunur.';
...
$GLOBALS["lang"]['The type of task to run. One of: baseline, benchmark, cloud discovery, discovery, integration, report, query.'] = 'Именно.';

$GLOBALS["lang"]['The type of the integration (usually named after the external system).'] = '..';

$GLOBALS["lang"]['The unfiltered state means that a port is accessible, but Nmap is unable to determine whether it is open or closed. Only the ACK scan, which is used to map firewall rulesets, classifies ports into this state. Scanning unfiltered ports with other scan types such as Window scan, SYN scan, or FIN scan, may help resolve whether the port is open.'] = 'Нефилтриран dövl.t bir portun erişilebilir olduğu anlamına gelir, lakin Nmap açıq v  го qarşılaşdırmaq olacaq. ..';

$GLOBALS["lang"]['The unique identifier of this server.'] = '- Да.';

$GLOBALS["lang"]['The user account this collector uses. Links to <code>users.id</code>.'] = 'Именно. <code>users.id</code>.';

$GLOBALS["lang"]['The user in Active Directory / OpenLDAP must be a direct member of the required Open-AudIT groups for Roles and Orgs. A member of a group that is a member another group that is a member of the Open-AudIT group will not work.'] = 'Active Directory / OpenLDAP istifad год. Open-AudIT qrupunun bir üzvü olan bir qrupun üzvüdür.';
...
$GLOBALS["lang"]['The user that was specified exists in LDAP, but Open-AudIT is not configured to consume the LDAP groups for roles and that user does not exist within Open-AudIT. Either select <i>Use LDAP for Roles</i> on the Open-AudIT LDAP Server screen or create this user within Open-AudIT and assign roles and orgs.'] = 'LDAP-da qeyd olunan istifad...çi, lakin Open-AudIT rollar üçün LDAP qruplarını istehsal etm...k üçün konfiqurasiya deyil v... bu istifad...çi Open-AudIT daxil deyil. .. <i>Rollar üçün LDAP istifad</i> Open-AudIT LDAP . . . . . . . .';

$GLOBALS["lang"]['The username (if not using the user running the script).'] = '.';

$GLOBALS["lang"]['The username used to access the external system.'] = 'Qeydiyyatdan istifad.';

$GLOBALS["lang"]['The users details were not retrieved from LDAP. Check the LDAP server logs.'] = 'Именно.';

$GLOBALS["lang"]['The users details were retrieved from LDAP.'] = 'Именно.';
...
$GLOBALS["lang"]['The web directory on the host that Open-AudIT is installed (requires a trailing slash).'] = 'Open-AudIT-nin quraşdırdıııı ev sah...sind... web klassikası (bir izl...şdirm...).';
...
$GLOBALS["lang"]['Their OrgIDs, ascendants and descendants'] = 'Именно.';

$GLOBALS["lang"]['Then'] = '..';

$GLOBALS["lang"]['Then create a new Auth method in Open-AudIT by going to menu -> Admin -> Auth Methods -> Create Auth. Provide a name and set the <i>type</i> to Entra.'] = 'Именно. <i>- Да.</i> .';
...
$GLOBALS["lang"]['This description is auto-populated and should ideally be left as-is.'] = 'Bu tarif auto-populated v го идеален olaraq sol olmalıdır.';
...
$GLOBALS["lang"]['This error indicates that SMB1 has been disabled or removed from the target machine. This is normal for modern version of Windows and you will only see this message when the SMB2 connection attempt has failed. If the SMB2 connection fails, we attempt SMB1 to enable discovery on old versions of Windows. If the target Windows machine <i>is</i> running an old version of Windows, it is likely your credentials have failed. In that case, see'] = 'Именно. <i>- Да.</i> - Да.';

$GLOBALS["lang"]['This error indicates that not enough virtual memory or paging file quota is available to complete the specified operation. You should try again later.'] = 'Именно.';
...
$GLOBALS["lang"]['This example creates a list of all Modules marked as'] = 'Бю нюмун КИМИ КЕЙД olunan bütün Modulların siyahısı jaradır';

$GLOBALS["lang"]['This example creates a list of devices and the open Ports, Protocols, and Programs found by the NMAP scan.'] = 'Bu s готварски cihazları v готварски портове, Protokolar срещу NAPA tarama t  голм';

$GLOBALS["lang"]['This example creates a list of devices where the Function or Description fields are blank OR the Purchase Date is the default.'] = 'Bu nümun... funksiya v... ya m... lumat sah...si boş olduğu v...';

$GLOBALS["lang"]['This example query retrieves a list of devices OVER 3 years old. The query uses today'] = 'Именно.';

$GLOBALS["lang"]['This example uses'] = '..';

$GLOBALS["lang"]['This feature requires a Professional or an Enterprise license.'] = '- Да.';

$GLOBALS["lang"]['This feature, because it has the ability to affect target devices more than usual must be manually enabled. To enable this feature, change the configuration item feature_executables to <i>yes</i>.'] = 'Именно. <i>.</i>.';

$GLOBALS["lang"]['This file tells Linux to poll the application to determine if there are any scheduled tasks that should be run.'] = 'Именно.';
...
$GLOBALS["lang"]['This is an optional configuration option, enabled by setting discovery_use_org_id_match in the global configuration.'] = 'Именно.';
...
$GLOBALS["lang"]['This is to be used as the first point of call when troubleshooting Open-AudIT issues. You can click the Export button on the top right to retrieve this as a JSON file (to be added to the support ticket / email.'] = 'Именно.';

$GLOBALS["lang"]['This issue is under investigation.'] = '- Да.';

$GLOBALS["lang"]['This item must match the value of the attribute selected or contains the ID of the query to be used.'] = 'Bu maddd';
...
$GLOBALS["lang"]['This state is used when Nmap is unable to determine whether a port is closed or filtered. It is only used for the IP ID idle scan.'] = 'Именно.';
...
$GLOBALS["lang"]['Timeout Per Target (Seconds)'] = '[Смях]';
...
$GLOBALS["lang"]['To a new file named .env (in the same directory). Now edit that new file and uncomment (remove the #) the line below (line 17)'] = 'Именно.';

$GLOBALS["lang"]['To actually execute the query, append a /execute, thus /open-audit/index.php/queries/{$id}/execute.'] = 'Sorğu icra etm год. üçün, proqram bir /екзекутират, bel го /open-одит/index.php/queries/{$id} / performate.';
...
$GLOBALS["lang"]['To audit a remote machine that is not in a domain, you must use the Administrator account (not <i>an</i> admin account, <i>the</i> Administrator account) on the target PC. #1 and #2'] = '.. <i>Axtarış</i> . <i> на</i> ..';
...
$GLOBALS["lang"]['To compare software we check the name and version. Because version numbers are not all standardised in format, when we receive an audit result we create a new attribute called software_padded which we store in the database along with the rest of the software details for each package. For this reason, baselines using software policies will not work when run against a device that has not been audited by 1.10 (at least). Software policies can test against the version being <i>equal to</i>, <i>greater than</i> or <i>equal to or greater than</i>.'] = 'Именно. <i>.</i>.. <i>.</i> . <i>..</i>.';
...
$GLOBALS["lang"]['To enable a remote machine (Vista or above) to be audited that is not on a domain, by an account in the Administrators group, other than the actual Administrator account see the below section on UAC.'] = ' (Смях)';
...
$GLOBALS["lang"]['To retrieve the Tenant ID. Open the Azure portal click on Azure Active Directory, Properties and the Tenant ID is displayed as your Directory ID - do not blame me for the name mismatch, that is how Microsoft roll.'] = 'Именно.';

$GLOBALS["lang"]['To retrieve your key, log in to the AWS Console and select your username, then My Security Credentials.'] = 'Именно.';
...
$GLOBALS["lang"]['To select devices to be integrated, we use nmis_manage = y, but you might like (for example) type = router. You can also use a Group or Query if you prefer something more complex.'] = 'Именно.';

$GLOBALS["lang"]['To sort by a database column, use'] = '..';

$GLOBALS["lang"]['To use this Enterprise feature, you first need to create your user in Open-AudIT as per usual. Assigning a password is not necessary. You do have to assign Roles and Orgs. The username in Open-AudIT should match the Entra <i>preferred username</i> attribute. There is no need for a Full Name or Email - these will be populated from Entra. If you do not know your users <i>preferred username</i>, fear not. You can create the new Auth Method in Open-AudIT and the Enterprise Application in Entra and when a user attempts to sign-on to Open-AudIT without a pre-existing user, check the logs and you will see their <i>preferred username</i> logged for your convienence.'] = 'Именно. <i>..</i> Именно. <i>..</i>.. <i>..</i> ..';

$GLOBALS["lang"]['To use this Enterprise feature, you first need to create your user in Open-AudIT as per usual. Assigning a password is not necessary. You do have to assign Roles and Orgs. The username in Open-AudIT should match the OKTA <i>name</i> attribute. There is no need for a Full Name or Email - these will be populated from OKTA. If you do not know your users <i>name<i>, fear not. You can create the new Auth Menthod in Open-AudIT and the Application in OKTA and when a user attempts to sign-on to Open-AudIT without a pre-existing user, check the logs and you will see their <i>name<i> logged for your convienence.<br></p><p>Then create a new Auth method in Open-AudIT by going to menu -> Admin -> Auth Methods -> Create Auth. Provide a name and set the <i>type</i> to Okta.'] = 'Именно. <i>- Да.</i> Именно. <i>- Да.<i>Именно. <i>- Да.<i> ..<br/><p>Именно. <i>- Да.</i> .</p></i></i></i></i>';

$GLOBALS["lang"]['To use this feature you must enable the configuration items match_mac (for AWS) and match_hostname (for Azure). This will be done automatically the first time a cloud discovery is executed. For more on Open-AudITs matching rules see HERE: Matching Devices'] = 'Именно.';

$GLOBALS["lang"]['To view the details of a query, the standard URL structure of /open-audit/index.php/queries/{$id} should be used.'] = 'Bir sorgounun m... lumatlarını, /open-одит/index standart URL strukturunu baxın. php/queries/ {$id} istifad . olunmalıdır.';
...
$GLOBALS["lang"]['Top Nmap TCP Ports. The top 10, 100, 1000 ports to scan as per Nmaps &quot;top ports&quot; options.'] = 'Именно.';
...
$GLOBALS["lang"]['Try Open-AudIT Enterprise, on us without a time limit. All the features of Enterprise. Limited to 20 devices.'] = 'Именно.';
...
$GLOBALS["lang"]['Undergo Stage 1 audit (documentation review)'] = 'Именно.';
...
$GLOBALS["lang"]['uninstall'] = 'italyprovince. kgm';
...
$GLOBALS["lang"]['United States Minor Outlying Islands'] = 'Америка Бирлщшмиш Штатларъ';
...
$GLOBALS["lang"]['Unused as at 5.2.0.'] = ' гол.';
...
$GLOBALS["lang"]['Update Open-AudIT Devices from '] = 'Update Open-AudIT ';

$GLOBALS["lang"]['Update Open-AudIT Devices from NMIS'] = 'Version Open-Aud IT ..';

$GLOBALS["lang"]['Update Vulnerabilities'] = ' да го направим, да го направим.';

$GLOBALS["lang"]['Update an attribute of a {collection} entry.'] = '{collection} giriş bir nümayişini yenil.';
...
$GLOBALS["lang"]['Use a <i>Sign-in method</i> of OIDC - OpenID Connect and an <i>Application Type</i> of Web Application. Click <i>Next</i>.'] = '- Да. <i>- Да.</i> OIDC - OpenID Connect v по Bir <i>- Да.</i> Уеб приложение. Axtar <i>- Да.</i>.';

$GLOBALS["lang"]['Use for Authentication'] = 'Не, не.';

$GLOBALS["lang"]['Use for Roles'] = '..';

$GLOBALS["lang"]['Use the standard install options when displayed and click the <i>I Agree</i>, <i>Next</i> and <i>Install</i> buttons to install Nmap.'] = 'Не, не, не. <i>.</i>.. <i>- Да.</i> Qeydiyyat <i>Даксил ол</i> Не, не, не.';
...
$GLOBALS["lang"]['Used when LDAP servers have been configured to populate a users details - this includes the Roles which they are assigned. If a user is in this LDAP group, they are assigned this role.'] = 'Именно. Bu LDAP qrupunda bir istifad...çi varsa, onlar bu rol q... bul edilir.';

$GLOBALS["lang"]['Used when searching OpenLDAP to match a users uid to a groups members. Default of <code>memberUid</code>. Used by OpenLDAP only.'] = 'Именно. - Да. <code>memberUid</code>Именно.';
...
$GLOBALS["lang"]['Users work similar to Netstat Ports. If a user exists with a matching name, status and password details (changeable, expires, required) then the policy passes.'] = 'Не, не. Bir istifad...çi uygoun adı, status v...';

$GLOBALS["lang"]['Users, Roles and Orgs'] = 'Именно.';
...
$GLOBALS["lang"]['Usually Mbs, to Location A.'] = 'Мб/с.';
...
$GLOBALS["lang"]['Values: In the case of a <i>list</i> field, this should be a comma separated list of valid values.'] = ' да го направим. <i>- Не, не.</i> ..';
...
$GLOBALS["lang"]['View Discovery'] = 'Бакъ';

$GLOBALS["lang"]['View Policy'] = 'Сифариш';

$GLOBALS["lang"]['View Racks'] = 'Хейванлар';

$GLOBALS["lang"]['View the'] = '- Да.';

$GLOBALS["lang"]['View the discovery in question, then click the Support button in the top right toolbar. This will provide the discovery settings, config items, the discovery device list as well as the logs for this particular discovery.'] = 'Именно.';
...
$GLOBALS["lang"]['vm_server_name'] = 'Vm сървър Adı';

$GLOBALS["lang"]['Vm Server Name'] = 'Vm сървър Adı';
...
$GLOBALS["lang"]['Vulnerabilities initially published before 1st January, 2025 (by default). We see no sense in returning vulnerabilities from years prior. This can be changed in the configuration.'] = 'Vulnerability ilkin 1 yanvardan  ..';
...
$GLOBALS["lang"]['WARNING - When creating a baseline using software policies, at present Centos and RedHat package the kernel using the names <i>kernel</i> and <i>kernel-devel</i>. There can be multiple packages with this name and different versions concurrently installed. Debian based distributions use names like <i>linux-image-3.13.0-24-generic</i>, note the version number is included in the package name. Because RedHat based operating systems use this format and subsequently have multiple identical package names with different versions we currently exclude <i>kernel</i> and <i>kernel-devel</i> from software policies. This may be addressed in a future update.'] = 'ВНИМАНИЕ - Proqram siyas.tl.rini istifad. etdiyiniz zaman, mövcud Centos v.... <i> Ядро</i> Qeydiyyat <i> Ядро-девел</i>. Именно. <i>Linux-image-3.13.0-0-generic</i>.. <i> Ядро</i> Qeydiyyat <i> Ядро-девел</i> ..';
...
$GLOBALS["lang"]['What about fields that I want from NMIS that are not in Open-AudIT? We have got you covered. Any fields in the external system (NMIS) that do not exist in Open-AudIT will be automatically created as Open-AudIT Custom fields.'] = 'Именно.';
...
$GLOBALS["lang"]['When investigating a Discovery, support will request the Exported Discovery Logs. To retrieve these, go to menu -> Discoveries ->'] = 'Именно.';

$GLOBALS["lang"]['When matching a Linux based device, we prefer to use the Dbus id concatenated with the hostname. We can also use other options as per the below table, but we can retrieve the Dbus ID without root. To retrieve the UUID (from the motherboard), we need to run dmidecode, which does require root. Unfortunately, when you clone an ESXi guest, the Dbus ID does not get recreated - hence our concatenating this with the hostname. There is a good article linked here that details the <i>why</i> of hardware IDs.'] = 'Именно. <i>- Да.</i> - Да.';

$GLOBALS["lang"]['When requesting JSON, by default no limit is set. When requesting screen display, the limit is set to 1000 by default. This can be changed in the configuration. See the \\'] = 'JSON t...r...find...n ist...y...n, heç bir limit t...şkil edir.  да го направим, да го направим.';

$GLOBALS["lang"]['When retrieve an external device, should we run discovery upon it?'] = '..';

$GLOBALS["lang"]['When running Open-AudIT on Windows the Apache service account must be that of a <i>regular</i> user (or the Administrator). This is because the <i>Local System</i> account normally used to run Apache has no access to any network resources. IE - We cannot use Apache when running as the Local System account account to copy the audit script to Windows PCs.'] = '(.) <i>Не, не, не.</i> .. . <i>..</i> .. Domen adı qeydiyyatdan keçirt . . IE - Biz Windows PCs одитен скрипт kopyalamaq üçün Yerli Sistem hesabı hesabı kimi çalışır zaman Apache istifad .';

$GLOBALS["lang"]['When the configuration option is set, we take this into account for devices for a certain defined subset of match rules where the configuration item has been enabled. These rules are:'] = 'Именно.';

$GLOBALS["lang"]['When the rules run in discovery, any matching rules will appear in the discovery log. See below for an example.'] = 'Именно.';

$GLOBALS["lang"]['When this benchmark is scheduled to be executed. Derived from the associated <code>tasks.type</code> and <code>tasks.sub_resource_id</code>.'] = '.. <code>tasks.type</code> Qeydiyyat <code>tasks.sub_resource_id</code>.';

$GLOBALS["lang"]['When this log was created.'] = '..';

$GLOBALS["lang"]['When this queue item started processing.'] = '- Да.';

$GLOBALS["lang"]['When using Open-AudIT Professional or Enterprise, widgets are available and customisable to be displayed on Dashboards.'] = 'И все пак, това, което не е вярно, е, че това, което не е вярно, е, че не е вярно.';

$GLOBALS["lang"]['When we are converting an internally selected device to an object for the external system, what should the external data be. EG: integer, string, etc.'] = ' год.';
...
$GLOBALS["lang"]['Why Windows Server Only?'] = '[Смях]';
...
$GLOBALS["lang"]['Windows may also have blocked the service from starting. On the target start the Windows Security applet and ensure the WinExeSvc executable is allowed to run (click Allow on Device and then Start Actions).'] = 'Именно.';

$GLOBALS["lang"]['Winexe page on Samba'] = 'Самба';
...
$GLOBALS["lang"]['You are able to define extra directories to be scanned as entries in the Executables collection. When defined, the directory and all sub-directories are scanned for files that are executable. You can also define directories and files to be excluded. When activated, these are injected into the linux audit script and performed whenever it is run (usually as part of a discovery). If you want these in a script you can manually copy to the target, use menu -> Discover -> Scripts -> List Scripts and download the script from there.'] = 'Именно.';

$GLOBALS["lang"]['You are always free to modify the audit scripts themselves to suit your specific requirements. You will need to (re)incorporate those changes whenever you upgrade as they will be overwritten by the default scripts. I would suggest saving a master copy of your modified script, upgrading Open-AudIT, then running a diff between the new default script and your modified script and applying the differences. The audit scripts are native scripts (Windows is VBScript, all others are Bash). Simple and easy to modify - just make sure to have a copy of your changes before you upgrade.'] = 'Именно.';

$GLOBALS["lang"]['You are running version'] = '..';

$GLOBALS["lang"]['You can access the collection using the normal Open-AudIT JSON based API. Just like any other collection. Please see'] = 'Именно.';
...
$GLOBALS["lang"]['You can always run the Firstwave VM on your virtual infrastructure (ESX, Azure, et al). The Firstwave VM runs Debian linux and is free from OS licensing concerns and limitations. Or install on your own Linux distro of choice. We support Redhat 9, Ubuntu 20.04, 22.04 and 24.04 as well as Debian 11 and 12.'] = '(ESX, Azure, et al). "Llkwave VM," "Debian Linux çalışır" срещу "OS lisenziya m... lumatları v...  год.';
...
$GLOBALS["lang"]['You can certainly run a discovery without any valid credentials on the devices within the network, however, the information retrieved will be a very small subset of what Open-AudIT has the ability to retrieve <i>with</i> credentials.'] = 'Именно. <i>..</i> - Да.';
...
$GLOBALS["lang"]['You can limit the Device Seed Discovery to fall within a strict set of parameters, including: <i>Restrict to Subnet</i> and <i>Restrict to Private</i>'] = '.. <i>Субнетектив</i> Qeydiyyat <i>Република</i>';

$GLOBALS["lang"]['You can manually assign devices using'] = 'Именно.';
...
$GLOBALS["lang"]['You can select the devices to be integrated by choosing any attribute in the system (device) table and matching (see menu → Admin → Database → List Tables → system for a list of fields). An attribute match can only match a single value.'] = 'Именно. Нарушена е отровата, която е била написана в началото.';

$GLOBALS["lang"]['You can turn any server into a collector by going to menu -> Admin -> Collectors -> Make this install a Collector. You will need credentials to log on to the server this install will report in to.'] = 'Именно.';
...
$GLOBALS["lang"]['You do not have the PHP SNMP extension installed. This extension is highly recommended.'] = ' год.';
...
$GLOBALS["lang"]['You must have working SSH credentials to execute a benchmark. The following Operating Systems are currently supported: Centos 7, Debian 12, Redhat 7, Redhat 8, Redhat 9, SLES 15, Ubuntu 20.04, Ubuntu 22.04. We plan to expand on these with further releases.'] = '.. Aşağıdakı  год.';
...
$GLOBALS["lang"]['Your AWS EC2 API key.'] = 'Именно.';
...
$GLOBALS["lang"]['Your Microsoft Azure Client Secret.'] = '[Смях]';
...
$GLOBALS["lang"]['Your access credentials, as per that clouds native API.'] = 'Именно.';

$GLOBALS["lang"]['Your data is your data. You can extract it any time you like. We even helpfully provide exports to CSV, JSON and XML. And we have a JSON API. And you can write custom reports and have those output in CSV, XML, and JSON! Again, it is your data - not anyone else. You can be confident that the security of your data is in your hands.'] = 'Именно. (надолу по-надолу, по-надолу, по-надолу, по-надолу, по-надолу.';
...
$GLOBALS["lang"]['a String'] = 'Напречен низ';
...
$GLOBALS["lang"]['and go to Applications -> Enterprise Applications (far left menu), then click <i>New application</i>.'] = 'Именно. <i>.</i>.';
...
$GLOBALS["lang"]['and the Sign-out redirect URI being'] = 'Именно.';
...
$GLOBALS["lang"]['column. The'] = '- Да. Axtarış';
...
$GLOBALS["lang"]['from Audit Script Result'] = ' да го направим.';
...
$GLOBALS["lang"]['have a working reverse DNS resolvable IP to the target Windows PC.'] = ' (Смях)';
...
$GLOBALS["lang"]['in Inputs can have the following values.'] = 'Giriş aşaıdıdakı qiym.tl.r.';
...
$GLOBALS["lang"]['installer will test for the presence of Nmap in its standard install locations of'] = 'Nmap-in standart quraşdırma yerl...rind...';
...
$GLOBALS["lang"]['list View, using the Create button'] = 'Именно.';
...
$GLOBALS["lang"]['page. Export your LDAP server from menu -> Admin -> LDAP Servers -> Details to JSON and save and include this data as well.'] = 'Именно.';
...
$GLOBALS["lang"]['predictable'] = ' да го направим.';

$GLOBALS["lang"]['query'] = 'Не, не.';

$GLOBALS["lang"]['rear'] = 'аркса';
...
$GLOBALS["lang"]['text. The first is the array index and should be left as-is. The index is used in the templates to lookup the translated text.'] = 'Именно.';
...
unassigned - The default until set.'] = ' год.
...
$GLOBALS["lang"]['uses the data collected from your devices and matches the software installed with the value provided, it counts the matches calculates how many licenses have been used and how many are left. It allows the use of wildcards on the <i>match string</i> field which matches the software.name attribute.'] = 'Именно. <i>- Да.</i> ..';
