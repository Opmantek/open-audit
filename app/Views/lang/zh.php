...
未指定 - 设定前的默认值 。',
  ...
  '5efb40d29d354ffa373b2a7864b97508dc4c2bca672d83f2ee647371b8ced339' => '这些属性存储在 Open-AudITs 配置中; 要访问它们选择的 Admin - > 配置 - > 从 Open-AudITs 菜单中列出配置,然后使用左边的搜索框来搜索匹配  或去菜单 发现 发现匹配选项. 默认值为 <strong>区域</strong> 和 <strong>无</strong> 仅仅意味着是和否。 我们将在描述中使用 " 是 " 和 " 否 " ,而不是 <strong>区域</strong> 和 <strong>无</strong>。存储的值应当始终是小写y或n。',
...
未指定 - 设定前的默认值 。',
  ...
  '37e3817a408d845c8c05fb5a5f48fc7d38ca0909172628a911676be1fac7ffb2' => '证书可以有几种不同的类型之一 - snmp v.1 / v.2, snmp v.3, ssh, 密钥,窗口全部实现. CAVET - Ssh 密钥尚未为 Windows Open-AudIT 服务器执行 。',
...
未指定 - 设定前的默认值 。',
  ...
  '7357f028d17c9820b65373896dea043079da006b3fbc3b5ad3e4325dc9b27587' => '曾将Entra Group ID与角色关联.',
  ...
  '03639607145231a06ddffdaff10de87c03f089c7f055d11179e0eb1c88336359' => '曾经将一个Entra GroupID与Org关联.',
