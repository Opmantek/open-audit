...
$GLOBALS["lang"][' If something does not work as expected, your first thing to do is check the logs.'] = ' Se io ne funkcias kiel atendite, via unua aĵo farendaĵo estas kontroli la tagalojn.';
...
$GLOBALS["lang"][', of which we supply over thirty as a default set. Professional users cannot alter these, but an Enterprise user has complete customisation abilities - including creating your own.'] = 'De kiu ni liveras pli ol tridek kiel defaŭlta aro. Profesiaj uzantoj ne povas ŝanĝi tiujn, sed Enterprise uzanto havas kompletajn specialadaptitajn kapablojn - inkluzive de kreado de via propra.';

$GLOBALS["lang"][', you <i>must</i> be using https on your Open-AudIT server to use Entra for Auth. Please configure Apache to use <strong>https</strong> before configuring Entra for auth.'] = 'Vi, vi <i>Devas</i> uzi https sur via Open-AudIT-servilo por uzi Entra por Auth. Bonvolu agordi apaĉo por uzi <strong>Https</strong> Antaŭ ol adapti Entra por Auth.';
...
$GLOBALS["lang"]['<strong>NOTE</strong> - You are accessing this URL from the local Open-AudIT server. The downloaded script will not be able to submit when run on any other machine. If you need to audit other machines, please download the script from any remote machine, not using a browser on the Open-AudIT server itself.'] = '<strong>Ne</strong> Vi aliris ĉi tiun URL de la loka Open-AudIT servilo. La elŝutita manuskripto ne povas submetiĝi kiam funkcii per iu alia maŝino. Se vi bezonas revizii aliajn maŝinojn, bonvolu elŝuti la manuskripton de iu malproksima maŝino, ne uzante retumilon sur la Open-AudIT-servilo mem.';
...
$GLOBALS["lang"]['A Metropolitan area network (MAN) is a large computer network that usually spans a city or a large campus.'] = 'Metropolitena arereto (MAN) estas granda komputilreto kiu kutime enhavas grandurbon aŭ grandan kampuson.';

$GLOBALS["lang"]['A Seed discovery uses an initial IP to retrieve the IPs of any other devices it knows about, adds those IPs to the list and scans those - again asking for any IPs those additional devices knows about. Rinse and repeat. It is intelligent enough to know if it has already scanned a given IP in its execution and discards any already scanned (or even on the list to be scanned).'] = 'A. A. A Seed-eltrovaĵo uzas komencan IP por preni la IPojn de iuj aliaj aparatoj kiujn ĝi scias, aldonas tiujn IPojn al la listo kaj skanas tiujn - denove petante iujn ajn IPojn tiuj kromaj aparatoj scias pri. Rinse kaj ripetu. Ĝi estas sufiĉe inteligenta por scii ĉu ĝi jam skanis antaŭfiksitan IP en sia ekzekuto kaj forĵetas ajnan jam skanitan (aŭ eĉ en la listo por esti skanita).';

$GLOBALS["lang"]['A Subnet discovery will scan the IPs provided.'] = 'Subnet-eltrovaĵo skanas la IPojn disponigitajn.';

$GLOBALS["lang"]['A URL provided to the agent which will then download the file and store it on the local disk.'] = 'URL disponigita al la agento kiu tiam elŝutas la dosieron kaj stokas ĝin en la loka disko.';

$GLOBALS["lang"]['A URL to a file to download.'] = 'URL al dosiero elŝuti.';

$GLOBALS["lang"]['A backbone network is part of a computer network infrastructure that provides a path for the exchange of information between different LANs or sub-networks. A backbone can tie together diverse networks within the same building, across different buildings, or over a wide area.<br><br>For example, a large company might implement a backbone network to connect departments that are located around the world. The equipment that ties together the departmental networks constitutes the network backbone. When designing a network backbone, network performance and network congestion are critical factors to take into account. Normally, the backbone network capacity is greater than that of the individual networks connected to it.<br><br>Another example of a backbone network is the Internet backbone, which is the set of wide area networks (WANs) and core routers that tie together all networks connected to the Internet.'] = 'Malantaŭa reto estas parto de komputilretinfrastrukturo kiu disponigas padon por la interŝanĝo de informoj inter malsamaj LANoj aŭ sub-retoj. spino povas ligi kune diversspecajn retojn ene de la sama konstruaĵo, trans malsamaj konstruaĵoj, aŭ super larĝa areo.<br/><br/>Ekzemple, granda firmao eble efektivigos spinoreton por ligi sekciojn kiuj situas ĉirkaŭ la mondo. La ekipaĵo kiu ligas kune la departementajn retojn konsistigas la sendostacian spinon. Dum dizajnado de sendostacia spino, retefikeco kaj sendostacia obstrukciĝo estas kritikaj faktoroj enkalkuli. Normale, la spino-retkapacito estas pli bonega ol tiu de la individuaj retoj ligitaj al ĝi.<br/><br/>Alia ekzemplo de spinoreto estas la Interreta spino, kiu estas la aro de larĝaj areretoj (WANoj) kaj kernvoj kiuj ligas kune ĉiujn retojn ligitajn al la Interreto.';
...
$GLOBALS["lang"]['A campus area network (CAN) is made up of an interconnection of LANs within a limited geographical area. The networking equipment (switches, routers) and transmission media (optical fiber, copper plant, Cat5 cabling, etc.) are almost entirely owned by the campus tenant / owner (an enterprise, university, government, etc.).<br><br>For example, a university campus network is likely to link a variety of campus buildings to connect academic colleges or departments, the library, and student residence halls.'] = 'kampusareoreto (CAN) konsistas el interligo de LANoj ene de limigita geografia areo. La interkonekta ekipaĵo (sorĉistinoj, itinerigiloj) kaj dissendamaskomunikilaro (optika fibro, kuproplanto, Cat5 chavi, ktp.) preskaŭ estas totale posedataj fare de la kampusluanto / posedanto ( entrepreno, universitato, registaro, ktp.).<br/><br/>Ekzemple, universitata kampusreto verŝajne interligas gamon da kampuskonstruaĵoj por ligi akademiajn altlernejojn aŭ sekciojn, la bibliotekon, kaj studentajn loĝejhalojn.';

$GLOBALS["lang"]['A closed port is accessible (it receives and responds to Nmap probe packets), but there is no application listening on it. They can be helpful in showing that a host is up on an IP address (host discovery, or ping scanning), and as part of OS detection. Because closed ports are reachable, it may be worth scanning later in case some open up. Administrators may want to consider blocking such ports with a firewall. Then they would appear in the filtered state, discussed next.'] = 'Fermita haveno estas alirebla (ĝi ricevas kaj reagas al Nmap probe-pakaĵetoj), sed ekzistas neniu aplikiĝo aŭskultanta sur ĝi. Ili povas esti helpemaj en montrado ke gastiganto estas supren sur IP-adreso (gasa eltrovaĵo, aŭ pingskanado), kaj kiel parto de OS-detekto. Ĉar fermitaj havenoj estas atingeblaj, ĝi povas esti valoro skanado poste en kazo iu malferma supren. Administrantoj povas deziri pripensi bloki tiajn havenojn kun fajromuro. Tiam ili aperus en la filtrita ŝtato, diskutita plej proksime.';
...
$GLOBALS["lang"]['A dashboard is made up of three columns and two rows of what we call <i>widgets</i>. A widget is very similar to a summary, only we take the summary concept a bit further. Widgets are created in a simple fashion using a couple of drop down boxes - or you can elect to use your own SQL for complete customisability.'] = 'Daŝboard konsistas el tri kolumnoj kaj du vicoj de kion ni nomas <i>dratoj</i>. Aĵo estas tre simila al resumo, nur ni prenas la resuman koncepton iomete plu. Widgets estas kreita en simpla modo uzanta paron da guto malsupren kestoj - aŭ vi povas elekti uzi vian propran SQL por kompleta kutimo.';

$GLOBALS["lang"]['A filtered port is considered open (and will trigger device detection).'] = 'filtrita haveno estas konsiderita malferma (kaj ellasos aparatodetekton).';

$GLOBALS["lang"]['A global area network (GAN) is a network used for supporting mobile across an arbitrary number of wireless LANs, satellite coverage areas, etc. The key challenge in mobile communications is handing off user communications from one local coverage area to the next. In IEEE Project 802, this involves a succession of terrestrial wireless LANs.'] = 'Tutmonda arereto (GAN) estas reto uzita por apogado de poŝtelefono trans arbitra nombro da sendrataj LANoj, satelitaj priraportadareoj, ktp. La esenca defio en movaj komunikadoj donas for uzantkomunikadojn de unu loka priraportadareo ĝis la venonta. En IEEE Project 802, tio implikas sinsekvon de surteraj sendrataj LANoj.';

$GLOBALS["lang"]['A home area network (HAN) is a residential LAN used for communication between digital devices typically deployed in the home, usually a small number of personal computers and accessories, such as printers and mobile computing devices. An important function is the sharing of Internet access, often a broadband service through a cable TV or digital subscriber line (DSL) provider.'] = 'hejmareoreto (HAN) estas loĝdoma LAN uzita por komunikado inter ciferecaj aparatoj tipe deplojitaj en la hejmo, kutime malmulto de personaj komputiloj kaj akcesoraĵoj, kiel ekzemple printiloj kaj movaj komputikaparatoj. Grava funkcio estas la dividado de retaliro, ofte larĝbenda servo tra kablotelevido aŭ cifereca abonlinio (DSL) provizanto.';
...
$GLOBALS["lang"]['A local area network (LAN) is a network that connects computers and devices in a limited geographical area such as a home, school, office building, or closely positioned group of buildings. Each computer or device on the network is a node. Wired LANs are most likely based on Ethernet technology. Newer standards such as ITU-T G.hn also provide a way to create a wired LAN using existing wiring, such as coaxial cables, telephone lines, and power lines.<br><br>The defining characteristics of a LAN, in contrast to a wide area network (WAN), include higher data transfer rates, limited geographic range, and lack of reliance on leased lines to provide connectivity. Current Ethernet or other IEEE 802.3LAN technologies operate at data transfer rates up to 100 Gbit/s, standardized by IEEE in 2010. Currently, 400 Gbit/s Ethernet is being developed.'] = 'Loka areoreto (LAN) estas reto kiu ligas komputilojn kaj aparatojn en limigita geografia areo kiel ekzemple hejmo, lernejo, oficejkonstruaĵo, aŭ proksime poziciigis grupon de konstruaĵoj. Ĉiu komputilo aŭ aparato sur la reto estas nodo. Wired LANoj estas plej verŝajnaj surbaze de Ethernet-teknologio. Pli novaj normoj kiel ekzemple ITU-T G.hn ankaŭ disponigas manieron krei dratigitan LAN uzantan ekzistantan drenadon, kiel ekzemple koaksiaj kabloj, telefonlinioj, kaj potenclinioj.<br/><br/>La difinaj karakterizaĵoj de LAN, kontraste al larĝa areoreto (WAN), inkludas pli altajn datentransigtarifojn, limigitan geografian intervalon, kaj mankon de dependeco sur lizitaj linioj por disponigi konekteblecon. Nuna Ethernet aŭ alia IEEE 802.3LAN teknologioj funkciigas ĉe datentransigtarifoj ĝis 100 Gbit/s, normigita fare de IEEE en 2010. Nuntempe, 400 Gbit/s Ethernet estas evoluigita.';

$GLOBALS["lang"]['A location is a physical address that can have devices associated with it. You can assign it coordinates and if there are devices assigned, the location will appear on the Map when you have an Open-AudIT Enterprise license.'] = 'Loko estas fizika adreso kiu povas havi aparatojn asociitajn kun ĝi. Vi povas asigni ĝin koordinatoj kaj se ekzistas aparatoj asignitaj, la loko aperos sur la Mapo kiam vi havas Open-AudIT Enterprise licenco.';
...
$GLOBALS["lang"]['A new user logged in to Open-AudIT and was authenticated and authorized by the LDAP sever. That user was then created in Open-AudIT and logged in. Success.'] = 'Nova uzanto registradis en al Open-AudIT kaj estis aŭtentikigita kaj rajtigita fare de la LDAP sever. Tiu uzanto tiam estis kreita en Open-AudIT kaj ensalutinta. Sukceso.';

$GLOBALS["lang"]['A package is a piece of installed softare. A package has a type - antivirus, approved, backup, banned, cloud, firewall, ignored, license or other.'] = 'pakaĵo estas peco de instalita molaro. pakaĵo havas tipon - kontraŭvirus, aprobita, rezervo, malpermesita, nubo, fajromuro, ignoris, licencon aŭ alian.';
...
$GLOBALS["lang"]['A person has an account in the Open-AudIT application. Their user account has a list of associated Roles and Organizations. The roles the user has determines WHAT they can do. The Organizations a user has determines WHICH items they can act upon.<br><br>When a user requests to perform an operation (create, read, update, delete) on a collection item, the roles are consulted to see if they are allowed to perform that action, then the orgs are consulted to determine if the collection item belongs to an org the user has permission to act on.'] = 'Persono havas raporton en la Open-AudIT-aplikaĵo. Ilia uzantkonto havas liston de rilataj roloj kaj organizoj. La roloj kiujn la uzanto determinas kion ili povas fari. La organizoj uzanto determinas WHICH erojn ili povas agi sur.<br/><br/>Kiam uzanto petas elfari operacion (krei, legi, ĝisdatigi, forigi) sur kolektobjektoj, la roloj estas konsultitaj por vidi ĉu ili estas permesitaj elfari tiun agon, tiam la orgs estas konsultitaj por determini ĉu la kolektoobjekto apartenas al org la uzanto havas permeson agi sur.';

$GLOBALS["lang"]['A personal area network (PAN) is a computer network used for communication among computer and different information technological devices close to one person. Some examples of devices that are used in a PAN are personal computers, printers, fax machines, telephones, PDAs, scanners, and even video game consoles. A PAN may include wired and wireless devices. The reach of a PAN typically extends to 10 meters. A wired PAN is usually constructed with USB and FireWire connections while technologies such as Bluetooth and infrared communication typically form a wireless PAN.'] = 'Persona arereto (PAN) estas komputila reto uzita por komunikado inter komputilo kaj malsamaj informoj teknologiaj aparatoj proksimaj al unu persono. Kelkaj ekzemploj de aparatoj kiuj estas uzitaj en PAN estas personaj komputiloj, printiloj, faksomaŝinoj, telefonoj, PDAoj, skaniloj, kaj eĉ videoludkonzoloj. PAN povas inkludi dratigitajn kaj sendratajn aparatojn. La atingo de PAN tipe etendiĝas al 10 metroj. Metita PAN estas kutime konstruita kun USB kaj FireWire ligoj dum teknologioj kiel ekzemple Bluetooth kaj infraruĝa komunikado tipe formas sendratan PAN.';

$GLOBALS["lang"]['A query is essentially a SQL statement. This statement is run against the database with the automatic addition of the limit, filtered to apply to only those requested items and only those items the user has permission to view. A Query can be created using menu -> Manage -> Queries -> Create Queries. Queries contain an org_id and are hence restricted to the appropriate users. A user must have the org_admin or reporter role(s) to create, update or delete a query. All users can execute a query. A query has a name attribute used for the menu item as well as a menu category attribute. This tells the Open-Audit GUI which submenu to place the query in. There is also menu display which should be set to <i>y</i> to enable the query in the GUI (<i>n</i> to prevent the query from appearing at all). The query would still run if called using its <code>id</code>, regardless of menu displays value.'] = 'query estas esence SQL-deklaro. Tiu deklaro estas prizorgita kontraŭ la datumbazo kun la aŭtomata aldono de la limo, filtrita por validi por nur tiuj petis erojn kaj nur tiujn erojn la uzanto havas permeson rigardi. Query povas esti kreita uzante menuon - Manaĝo -> La jenaj paĝoj ligas al Queries. Queries enhavas org_id kaj estas tial limigitaj al la konvenaj uzantoj. Uzanto havendaĵo la org_admin aŭ raportistorolon (j) krei, ĝisdatigi aŭ forigi query. Ĉiuj uzantoj povas efektivigi query. Aquery havas nomon atributon utiligitan por la menuobjektoj same kiel menuokategoriatributo. Tio rakontas la Open-Audit GUI kiu submenu por meti la atendon en. Ekzistas ankaŭ menuo ekrano kiu devus esti metita al <i>y y</i> Por ebligi la atendon en la GUI ( ()<i>n</i> Por malhelpi la atendon de aperado entute). La query daŭre kuris se vokite uzante ĝian <code>id</code>, nekonsiderante menuo elmontras valoron.';

$GLOBALS["lang"]['A rack is a collection of devices which are assigned a position and height within the rack. A device can optionally have a picture associated with it. A rack is placed in a row. We have created a very granular system for positioning of racks, which is as follows. At the top level (as always) is the Organisation (Org). An Org can have multiple locations (as has always been the case). With the addition of the Racks feature, a location can now contain one or more Buildings. A building can contain one or more Floors. A floor can contain one or more Rooms. A room can contain one or more Rows. This sounds like a lot of work, but defaults are created for you. Create a new Location and the sub-components will be automatically created for you. If you need more items (buildings, rooms, etc) you can add them as you like. A rack can also be part of a <i>pod</i> of racks. The pod attribute works as a tag, rather than a strict hierarchical inheritance model as per buildings, floors, etc.<br><br>Racks are a feature available to Open-AudIT Enterprise licensed customers.'] = 'Arako estas kolekto de aparatoj kiuj ricevas pozicion kaj altecon ene de la rako. Aparato povas laŭvole havi bildon asociitan kun ĝi. rako estas metita en vicon. Ni kreis tre grajnecan sistemon por poziciigado de rakoj, kiu estas kiel sekvas. Sur la supra nivelo (kiel ĉiam) estas la organizo (Org). Org povas havi multoblajn lokojn (kiel ĉiam estis la kazo). Kun la aldono de la Racks trajto, loko nun povas enhavi unu aŭ pluraj Konstruaĵojn. Konstruaĵo povas enhavi unu aŭ pluraj etaĝojn. planko povas enhavi unu aŭ pluraj ĉambrojn. Ĉambro povas enhavi unu aŭ pluraj religojn. Tio sonas kiel multe da laboro, sed defaŭltoj estas kreitaj por vi. Krei novan Lokon kaj la sub-komponantoj estos aŭtomate kreitaj por vi. Se vi bezonas pli da eroj (konstruaĵoj, ĉambroj, ktp) vi povas aldoni ilin kiel vi ŝatas. Arako ankaŭ povas esti parto de <i>balgo</i> rakoj. La podatributo funkcias kiel etikedo, prefere ol strikta hierarkia hereda modelo kiel per konstruaĵoj, plankoj, ktp.<br/><br/>Racks estas trajto havebla al Open-AudIT Enterprise aprobitaj klientoj.';
...
$GLOBALS["lang"]['A seed discovery is another type of discovery, where you provide the IP of a single <i>seed</i> device. This device is audited, and any IPs it knows are then added to the list of IPs to be audited. Then, those devices are audited and any IPs they know are also added to the list of IPs for auditing. This process then continues within the parameters configured by the user.'] = 'Semtrovaĵo estas alia speco de eltrovaĵo, kie vi disponigas la IP de unuopaĵo <i>semo</i> aparato. Tiu aparato estas reviziita, kaj ajna IPs ĝi scias tiam estas aldonita al la listo de IPs por esti reviziita. Tiam, tiuj aparatoj estas reviziitaj kaj ajnaj IPoj ili scias ankaŭ estas aldonitaj al la listo de IPoj por revizio. Tiu procezo tiam daŭras ene de la parametroj formitaj fare de la uzanto.';

$GLOBALS["lang"]['A short description of the log entry.'] = 'Mallonga priskribo de la loga eniro.';

$GLOBALS["lang"]['A storage area network (SAN) is a dedicated network that provides access to consolidated, block level data storage. SANs are primarily used to make storage devices, such as disk arrays, tape libraries, and optical jukeboxes, accessible to servers so that the devices appear like locally attached devices to the operating system. A SAN typically has its own network of storage devices that are generally not accessible through the local area network by other devices. The cost and complexity of SANs dropped in the early 2000s to levels allowing wider adoption across both enterprise and small to medium-sized business environments.'] = 'Stoka areoreto (SAN) estas diligenta reto kiu disponigas aliron al firmigita, blok-nivelaj datenstokado. SANoj estas ĉefe uzitaj por fari stokadaparatojn, kiel ekzemple diskaroj, glubendbibliotekoj, kaj optikaj diskogurdoj, alireblaj por serviloj tiel ke la aparatoj prezentiĝas kiel loke ligitaj aparatoj al la operaciumo. SAN tipe havas sian propran reton de stokadaparatoj kiuj estas ĝenerale ne alireblaj tra la loka areoreto de aliaj aparatoj. La kosto kaj komplekseco de SANoj falis en la fruaj 2000-aj jaroj al niveloj permesantaj pli larĝan adopton trans kaj entrepreno kaj malgrandaj al mezgrandaj komercmedioj.';
...
$GLOBALS["lang"]['A structured system for managing sensitive information'] = 'strukturita sistemo por administrado de sentemaj informoj';

$GLOBALS["lang"]['A timestamp.'] = 'Tempostampo.';

$GLOBALS["lang"]['A user has a primary Org as well as a list of Orgs they can access. A user combines this with a list of assigned roles that define what actions they can take on items assigned to the Orgs they have access to. The combination of a users <i>orgs</i> and <i>roles</i> define what they can and cannot do within Open-AudIT.'] = 'Uzantoj havas primaran Org same kiel liston de Orgs kiun ili povas aliri. uzanto kombinas tion kun listo de asignitaj roloj kiuj difinas kiujn agojn ili povas akcepti erojn asignitajn al la Orgs kiujn ili havas aliron al. La kombinaĵo de uzantoj <i>orgoj</i> kaj <i>rolojn</i> difinas kion ili povas kaj ne povas fari ene de Open-AudIT.';

$GLOBALS["lang"]['A user will have a list of associated organizations (orgs). Each org the user has will allow them to act upon items within that org as per their role(s).<br><br>All orgs except the default org have a parent. Think of an Org Chart. If a user has permission on an Org, they also have permission on any descendants of that Org.<br><br>Users are also allowed permission on a child org to see the items from parent orgs for certain collections. Those are: dashboards, discovery_scan_options, fields, files, groups, queries, reports, roles, rules, scripts, summaries, widgets.<br><br>Do not forget you have granular control over what users can see and do using Roles in Enterprise.'] = 'uzanto havos liston de rilataj organizoj (orgoj). Ĉiu org la uzanto permesos al ili agi sur eroj ene de tiu org kiel per ilia rolo (j).<br/><br/>Ĉiuj orgoj krom la defaŭlta org havas gepatron. Pensu pri Org Chart. Se uzanto havas permeson sur Org, ili ankaŭ havas permeson sur iuj posteuloj de tiu Org.<br/><br/>Uzantoj ankaŭ estas permesitaj permeson sur infano org por vidi la erojn de gepatrotroj por certaj kolektoj. Tiuj estas: dashboards, Discovery_scan_options, kampoj, dosieroj, grupoj, demandoj, raportoj, roloj, reguloj, manuskriptoj, resumoj, widgets.<br/><br/>Ne forgesu ke vi havas grajnecan kontrolon de kion uzantoj povas vidi kaj fari uzante rolojn en Enterprise.';

$GLOBALS["lang"]['A user will have a list of associated organizations (orgs). Each org the user has will allow them to act upon items within that org as per their role(s).<br><br>All orgs except the default org have a parent. Think of an Org Chart. If a user has permission on an Org, they also have permission on any descendants of that Org.<br><br>We have also allow a user with permission on a child org to see the items from parent orgs for certain collections. Those are: dashboards, discovery_scan_options, fields, files, groups, queries, roles, rules, scripts, summaries, widgets.<br><br>Do not forget you have granular control over what users can see and do using'] = 'uzanto havos liston de rilataj organizoj (orgoj). Ĉiu org la uzanto permesos al ili agi sur eroj ene de tiu org kiel per ilia rolo (j).<br/><br/>Ĉiuj orgoj krom la defaŭlta org havas gepatron. Pensu pri Org Chart. Se uzanto havas permeson sur Org, ili ankaŭ havas permeson sur iuj posteuloj de tiu Org.<br/><br/>Ni ankaŭ permesas uzanton kun permeso sur infano org por vidi la erojn de gepatroj orgoj por certaj kolektoj. Tiuj estas: dashboards, Discovery_scan_options, kampoj, dosieroj, grupoj, demandoj, roloj, reguloj, manuskriptoj, resumoj, widgets.<br/><br/>Ne forgesu ke vi havas grajnecan kontrolon de kion uzantoj povas vidi kaj fari uzante';

$GLOBALS["lang"]['A virtual private network (VPN) is an overlay network in which some of the links between nodes are carried by open connections or virtual circuits in some larger network (e.g., the Internet) instead of by physical wires. The data link layer protocols of the virtual network are said to be tunneled through the larger network when this is the case. One common application is secure communications through the public Internet, but a VPN need not have explicit security features, such as authentication or content encryption. VPNs, for example, can be used to separate the traffic of different user communities over an underlying network with strong security features.<br><br>VPN may have best-effort performance, or may have a defined service level agreement (SLA) between the VPN customer and the VPN service provider. Generally, a VPN has a topology more complex than point-to-point.'] = 'Virtuala privata reto (VPN) estas overlay reto en kiu kelkaj el la ligiloj inter nodoj estas portitaj per malfermaj ligoj aŭ virtualaj cirkvitoj en iu pli granda reto (ekz., la Interreto) anstataŭe de per fizikaj dratoj. La datenligtavolo protokolas de la virtuala reto laŭdire estas tunelita tra la pli granda reto kiam tio estas la kazo. Unu ofta aplikiĝo estas sekura komunikado tra la publika Interreto, sed VPN ne bezonas eksplicitajn sekurectrajtojn, kiel ekzemple konfirmo aŭ enhavĉifrado. VPNs, ekzemple, povas esti uzita por apartigi la trafikon de malsamaj uzantkomunumoj super subesta reto kun fortaj sekurectrajtoj.<br/><br/>VPN povas havi plej bonan efikecon, aŭ povas havi difinitan servan nivelinterkonsenton (SLA) inter la VPN-kliento kaj la VPN-servprovizanto. Ĝenerale, VPN havas topologion pli kompleksan ol punkto-al-punkta.';
...
$GLOBALS["lang"]['A vulnerability can be editied and more specific package names provided where the enrichment data is insufficient or the generated SQL is not quite correct.'] = 'vundebleco povas esti redaktita kaj pli specifaj pakaĵonomoj disponigitaj kie la riĉigdatenoj estas nesufiĉaj aŭ la generita SQL ne estas tre ĝusta.';

$GLOBALS["lang"]['A vulnerability item in Open-AudIT can be thought of as essentially a query against your database to determine your potential exposure to a given CVE report. A vulnerability is made up of the CVE report, along with enrichment data from FirstWave. These two items are combined to produce a suitable query that is automatically downloaded from FirstWave.'] = 'Nula objekto en Open-AudIT povas esti opiniita de kiel esence atendo kontraŭ via datumbazo determini vian eblan malkovron al antaŭfiksita CVE-raporto. vundebleco konsistas el la CVE-raporto, kune kun riĉigdatenoj de FirstWave. Tiuj du eroj estas kombinitaj por produkti taŭgan atendon kiu estas aŭtomate elŝutita de FirstWave.';

$GLOBALS["lang"]['A wide area network (WAN) is a computer network that covers a large geographic area such as a city, country, or spans even intercontinental distances. A WAN uses a communications channel that combines many types of media such as telephone lines, cables, and air waves. A WAN often makes use of transmission facilities provided by common carriers, such as telephone companies. WAN technologies generally function at the lower three layers of the OSI reference model: the physical layer, the data link layer, and the network layer.'] = 'Larĝa areoreto (WAN) estas komputila reto kiu kovras grandan geografian areon kiel ekzemple grandurbo, lando, aŭ enhavas eĉ interkontinentajn distancojn. WAN utiligas komunikadkanalon kiu kombinas multajn specojn de amaskomunikilaro kiel ekzemple telefonlinioj, kabloj, kaj aerndojn. WAN ofte faras uzon de transmisiinstalaĵoj disponigitaj fare de oftaj aviad-kompanioj, kiel ekzemple telefonaj firmaoj. WAN-teknologioj ĝenerale funkcias ĉe la pli malaltaj tri tavoloj de la OSI-referencomodelo: la fizika tavolo, la datenligtavolo, kaj la sendostacia tavolo.';
...
$GLOBALS["lang"]['Address any nonconformities'] = 'Direkti ajnan nekonformities';
...
$GLOBALS["lang"]['After an Integration has been created, when you view the details of an Integration you will notice a field named Debug. This is set to no by default. Changing it to yes provides extra logging when an Integration is executed. Debug should not be left as yes. This is because the debug output will contain everything retrieved from external systems - including items such as WMI and SNMP credentials. The debug option should be used only when an issue has occurred and you wish to dig deeper in to see if you can determine why.'] = 'Post kiam Integriĝo estis kreita, kiam vi rigardas la detalojn de Integriĝo vi rimarkos kampon nomitan Debug. Tio ne estas defaŭlta. Ŝanĝante ĝin al jes disponigas ekstran registradadon kiam integriĝo estas efektivigita. Debug ne devus esti lasita kiel jes. Tio estas ĉar la debug produktaĵo enhavos ĉion prenitan de eksteraj sistemoj - inkluzive de eroj kiel ekzemple WMI kaj SNMP-akreditaĵoj. La debug opcio devus esti uzita nur kiam temo okazis kaj vi deziras fosi pli profunde en vidi ĉu vi povas determini kial.';

$GLOBALS["lang"]['After completing the above, uninstall the agent.'] = 'Post kompletigado de ĉi-supra, malinstalu la agenton.';

$GLOBALS["lang"]['Agent? Discovery? Credentials?'] = 'agento? Ĉu la malkovro? Ĉu kreantoj?';

$GLOBALS["lang"]['agents'] = 'Agentoj';

$GLOBALS["lang"]['Agents'] = 'Agentoj';

$GLOBALS["lang"]['Agents entries can be created that specify a duration, a network and an operating system. If all tests match, the server then asks the agent to perform actions. If any test is not set, it is excluded from the <i>all must match</i> requirement.<br><br>You can create multiple agents and have the server check one or all agent entries. You might (for example) specify one agent that says <i>If the agent IP is in this subnet, set the location_id of the device</i>.<br><br>Another example might be not running an audit at all, rather download a script and run it. If the agent is installed with admin rights, you can now manage your machines without opening <strong>any</strong> ports from it to the world.</p><p>Enabling advanced agents means an agent can be instructed to download any file and execute any command. <strong>WARNING</strong>: This comes with security risks. This configuration will <strong>only</strong> function when running Open-AudIT using HTTPS and a valid (Certificate Authority provided) certificate for '] = 'Agentoj kontribuoj povas esti kreitaj tio precizigas tempodaŭron, reton kaj operaciumon. Se ĉiuj testoj egalas, la servilo tiam petas al la agento plenumi agojn. Se iu testo ne estas metita, ĝi estas ekskludita de la <i>Ĉiuj devas egali</i> postulo.<br/><br/>Vi povas krei plurajn agentojn kaj havi la servilon kontroli unu aŭ ĉiujn agentejkontribuojn. Vi eble (ekzemple) precizigas unu agenton kiu diras <i>Se la agento IP estas en tiu subreto, metis la loko_id de la aparato</i>.<br/><br/>Alia ekzemplo eble ne prizorgas revizion entute, prefere elŝutas manuskripton kaj prizorgas ĝin. Se la agento estas instalita kun admin rajtoj, vi nun povas administri viajn maŝinojn sen malfermi <strong>iu ajn</strong> havenoj de ĝi al la mondo.<p>Rajtigo progresintaj agentoj signifas agento povas esti instrukciita elŝuti ajnan dosieron kaj efektivigi ajnan komandon. <strong>→ Eventoj:</strong>: Tio venas kun sekureco riskoj. Ĉi tiu agordo estos <strong>nur nur</strong> funkcio dum prizorgado de Open-AudIT uzanta HTTPS kaj valida (Certificate Authority disponigis) atestilon por </p>';
...
$GLOBALS["lang"]['All collections URLs use the format'] = 'Ĉiuj kolektoj URLoj uzas la formaton';

$GLOBALS["lang"]['All device sub-tables contain a couple of important columns.'] = 'Ĉiuj aparatsubtabloj enhavas kelkajn gravajn kolonojn.';

$GLOBALS["lang"]['All devices with a type like computer.'] = 'Ĉiuj aparatoj kun tipo kiel komputilo.';

$GLOBALS["lang"]['All devices with a type of computer or router.'] = 'Ĉiuj aparatoj kun speco de komputilo aŭ itineranto.';

$GLOBALS["lang"]['All devices without a type of switch and printer.'] = 'Ĉiuj aparatoj sen speco de ŝaltilo kaj printilo.';

$GLOBALS["lang"]['All devices without a type of switch and printer. Essentially the same as the above query.'] = 'Ĉiuj aparatoj sen speco de ŝaltilo kaj printilo. Esence la sama kiel la supra demando.';

$GLOBALS["lang"]['All regular discovery options are also available for use in Device Seed Discoveries.'] = 'Ĉiuj regulaj malkovroelektoj ankaŭ estas haveblaj por uzo en Device Seed Discoveries.';

$GLOBALS["lang"]['All tasks can be created the same in Windows and Linux. Tasks use the CRON method for scheduling execution.'] = 'Ĉiuj taskoj povas esti kreitaj la sama en Fenestroj kaj Linukso. Taskoj uzas la CRON-metodon por planado de ekzekuto.';

$GLOBALS["lang"]['Along with this request for information, we send back to FirstWave datapoints that will give us some much needed information on feature use and your installation.'] = 'Kune kun tiu peto por informoj, ni sendas reen al FirstWave datenpunktoj kiuj donos al ni kelkajn necesajn informojn pri trajtouzo kaj via instalaĵo.';

$GLOBALS["lang"]['Also can be created from the'] = 'Ankaŭ povas esti kreita de la';
...
$GLOBALS["lang"]['An Active Directory discovery will query Active Directory for a list of networks and scan the associated IPs just like a regular Subnet discovery.'] = 'Aktiva Adresartrovaĵo sekvos Aktivan Adresaron por listo de retoj kaj skanas la rilatajn IPojn ekzakte kiel regula Subnet-eltrovaĵo.';
...
$GLOBALS["lang"]['An application is actively accepting TCP connections, UDP datagrams or SCTP associations on this port. Finding these is often the primary goal of port scanning. Security-minded people know that each open port is an avenue for attack. Attackers and pen-testers want to exploit the open ports, while administrators try to close or protect them with firewalls without thwarting legitimate users. Open ports are also interesting for non-security scans because they show services available for use on the network.'] = 'Apliko aktive akceptas TCP-ligojn, UDP-datengramojn aŭ SCTP-unuiĝojn sur tiu haveno. Trovante tiujn ofte estas la primara celo de havenoskanado. Sekureco-inklinaj homoj scias ke ĉiu malferma haveno estas avenuo por atako. Atakoj kaj skribiloj volas ekspluati la malfermajn havenojn, dum administrantoj provas fermi aŭ protekti ilin kun fajromuroj sen malsukcesigado de legitimaj uzantoj. Malfermaj havenoj ankaŭ estas interesaj por ne-sekurecskanadoj ĉar ili montras servojn haveblajn por uzo sur la reto.';
...
$GLOBALS["lang"]['An enterprise private network is a network that a single organization builds to interconnect its office locations (e.g., production sites, head offices, remote offices, shops) so they can share computer resources.'] = 'Entreprena privata reto estas reto kiu ununura organizo konstruas por interligi siajn oficejlokojn (ekz., produktadejoj, ĉefsidejoj, malproksimaj oficoj, butikoj) tiel ili povas dividi komputilresursojn.';

$GLOBALS["lang"]['An entry can be created using the web interface if the current user logged in has a role that contains the'] = 'Eniro povas esti kreita uzante la interretinterfacon se la nuna uzanto registradis en havas rolon kiu enhavas la';

$GLOBALS["lang"]['An example JSON POST body is below. This should be attached to the &quot;data&quot; form item.'] = 'Ekzemple, la korpo de JSON estas malsupre. Tio devus esti alkroĉita al la "daten" formobjekto.';

$GLOBALS["lang"]['An example widget SQL showing devices counted per location.'] = 'Ekzemplo widget SQL montranta aparatojn nombritajn per loko.';

$GLOBALS["lang"]['An existing Open-AudIT user was authenticated and authorized by the LDAP server. Success.'] = 'ekzistanta Open-AudIT-uzanto estis aŭtentikigita kaj rajtigita fare de la LDAP-servilo. Sukceso.';
...
$GLOBALS["lang"]['An open|filtered port is considered open (and will trigger device detection).<br>Previously, Open-AudIT considered an Nmap response of'] = 'Malfermita haveno estas konsiderita malferma (kaj ellasos aparatodetekton).<br/>Antaŭe, Open-Aud Ĝi estis konsiderita Nmap-respondo de';
...
$GLOBALS["lang"]['And finally, click Submit to execute this discovery.'] = 'Finfine, klaki Submit por efektivigi tiun eltrovaĵon.';

$GLOBALS["lang"]['And if Something Goes Wrong?'] = 'Se io malbonas?';

$GLOBALS["lang"]['And lastly click <i>Submit</i> to create your Open-AudIT Auth method for Entra.'] = 'Kaj finfine klaki <i>Submit</i> krei vian Open-AudIT Auth-metodon por Entra.';

$GLOBALS["lang"]['And lastly, not so much a security issue - more peace of mind. The data structures are open and documented. You can view them'] = 'Kaj finfine, ne tiel multe da sekureca temo - pli da paco de menso. La datenstrukturoj estas malfermaj kaj dokumentitaj. Vi povas vidi ilin';

$GLOBALS["lang"]['And provide a name - we humbly recommend Open-AudIT &#128512;, but you can name it anything you like. Make sure the option for <i>Integrate any other application you do not find in the gallery (Non-gallery)</i> is selected. And then click <i>Create<i>.'] = 'Ni humile rekomendas Open-AudIT 😀 certigi la opcion por <i>Integri ajnan alian aplikaĵon vi ne trovas en la galerio (Non-gallery)</i> estas elektita. Kaj poste klaki <i>Krei<i>.</i></i>';
...
$GLOBALS["lang"]['Annex A Controls'] = 'Aneksaĵo de kontroloj';
...
$GLOBALS["lang"]['Any attributes followed by a * indicate that CVSS data less than v4 was used to complete this field. By default, we attempt to use v4 fields, however if they are not populated we will fallback to the previous version(s) for attributes.'] = 'Ĉiuj atributoj sekvitaj per÷ indikas ke CVSS-datenoj malpli ol v4 kutimis kompletigi tiun kampon. defaŭlte, ni provas uzi v4 kampojn, aliflanke se ili ne estas loĝitaj ni revenos al la antaŭa versio (j) por atributoj.';

$GLOBALS["lang"]['Any devices will be assigned to this Org when they run their audit script (if set).'] = 'Ĉiuj aparatoj estos asignitaj al tiu Org kiam ili prizorgas sian reviziomanuskripton (se aro).';
...
$GLOBALS["lang"]['Any discovered devices will be assigned to this Location when they run their audit script (if set).'] = 'Ĉiuj malkovritaj aparatoj estos asignitaj al tiu loko kiam ili prizorgas sian reviziomanuskripton (se aro).';
...
$GLOBALS["lang"]['Any files found in this manner are stored in the <i>executable</i> table as per any other device component.'] = 'Ĉiuj dosieroj trovitaj en tiu maniero estas stokitaj en la <i>ekzekutebla</i> tablo kiel per iu alia aparato komponanto.';
...
$GLOBALS["lang"]['Any user uploaded images are placed here.'] = 'Ĉiu uzanto alŝutis bildojn ĉi tie.';
...
$GLOBALS["lang"]['Applications are being introduced in Open-AudIT 2.2 with a view to expand on the concept as further development is made.'] = 'Aplikoj estas lanĉitaj en Open-AudIT 2.2 kun vido disetendiĝi en la koncepto kiam plia evoluo estas farita.';
...
$GLOBALS["lang"]['Are you sure?'] = 'Ĉu vi certas?';
...
$GLOBALS["lang"]['As the audit script uses bash, you can use the wildcard of * when you are defining directories and exclusions.'] = 'Ĉar la reviziomanuskripto uzas lardon, vi povas uzi la sovaĝan karton de ÷ kiam vi difinas adresarojn kaj ekskludojn.';

$GLOBALS["lang"]['As usual, go to menu → Manage → Integrations → Create Integration. As above, if you are running on Linux and you have NMIS on the same server, you do not need to do anything other than click <i>Submit</i>. I cannot make it easier than that.'] = 'Kiel kutime, iru al menuo → Manaĝo → Integriĝo Se vi kuras sur Linukson kaj vi havas NMIS sur la sama servilo, vi ne bezonas fari ion ajn krom klako. <i>Submit</i>. Mi ne povas fari ĝin pli facila ol tio.';

$GLOBALS["lang"]['As we run Discoveries and collect device results we populate the list of networks. The Blessed Subnets feature uses this list of networks to only accept data from devices on those networks.'] = 'Ĉar ni prizorgas Eltrovaĵojn kaj kolektas aparatrezultojn ni populas la liston de retoj. La Blessed Subnets trajto utiligas tiun liston de retoj por nur akcepti datenojn de aparatoj sur tiuj retoj.';
...
$GLOBALS["lang"]['Assign an ISMS manager or team'] = 'Assignas ISMS-manaĝeron aŭ teamon';

$GLOBALS["lang"]['Assign an Operator'] = 'Suba maldekstra butono [戻る] estas por [送信] por [Sendi].';

$GLOBALS["lang"]['Assign any audited devices to this Org. Leave blank to leave device in currently assigned Org (or to set default).'] = 'Asignu iujn ajn reviziitajn aparatojn al tiu Org. Forlasaĵo por forlasi aparaton en nuntempe asignita Org (aŭ por meti defaŭlton).';
...
$GLOBALS["lang"]['Assigning Discovered Devices'] = 'Agordante Malkovritajn aparatojn';
...
$GLOBALS["lang"]['Attributes are stored for Open-AudIT to use for particular fields, at present all fields are based on the devices, locations, orgs and queries tables. The attributes you can edit are associated with the following columns: Class, Environment, Status & Type.'] = 'Atributoj estas stokitaj por Open-AudIT por uzi por specialaj kampoj, nuntempe ĉiuj kampoj estas bazitaj sur la aparatoj, lokoj, orgoj kaj esplortabloj. La atributoj vi povas redakti estas rilataj al la sekvaj kolonoj: Klaso, Environment, Status & Type.';
...
$GLOBALS["lang"]['Audit Software'] = 'Aŭtomata programaro';
...
$GLOBALS["lang"]['Authenticate only'] = 'Aŭtendante nur';

$GLOBALS["lang"]['Authentication Passphrase'] = 'Aŭtentigo Passphrase';

$GLOBALS["lang"]['Authentication Protocol'] = 'Aŭtentiga Protokolo';
...
$GLOBALS["lang"]['Backbone network'] = 'Malantaŭa reto';
...
$GLOBALS["lang"]['Baselines can compare netstat ports, users and software.'] = 'Bazlinioj povas kompari retstat havenojn, uzantojn kaj softvaron.';

$GLOBALS["lang"]['Baselines enable you to combine audit data with a set of attributes you have previously defined (your baseline) to determine compliance of devices.'] = 'Bazlinioj rajtigas vin kombini reviziodatenojn kun aro de atributoj kiujn vi antaŭe difinis (via bazlinio) determini observon de aparatoj.';

$GLOBALS["lang"]['Baselines for Device Comparison'] = 'Bazlinioj por Device Comparison';

$GLOBALS["lang"]['Basic'] = 'Baza Baza Baza Baza';

$GLOBALS["lang"]['Basque'] = 'La vaska';

$GLOBALS["lang"]['Because we try to be as transparent as possible, here is your actual data that we send.'] = 'Ĉar ni provas esti tiel travideblaj kiel eblaj, ĉi tie estas viaj faktaj datenoj kiujn ni sendas.';

$GLOBALS["lang"]['Being able to determine which machines are configured in the same way is a major part of systems administration and auditing – and now reporting on that will be made simple and automated. Once you define your baseline it will automatically run against a set of devices on a predetermined schedule. The output of these executed baselines will be available for web viewing, importing into a third party system or even as a printed report.<br><br>For auditing and management purposes it can be advantageous to baseline individual devices against a fixed, known good device. Baselines enable you to combine audit data with a set of attributes you have previously defined (your baseline) to determine compliance of devices.'] = 'Povas determini kiuj maŝinoj estas formitaj laŭ la saman manieron estas grava parto de sistemadministracio kaj revizio - kaj nun raportante pri tio estos farita simpla kaj aŭtomatigita. Post kiam vi difinas vian bazlinion ĝi aŭtomate kuros kontraŭ aro de aparatoj en predetermined horaro. La produktado de tiuj efektivigitaj bazlinioj estos havebla por interretspektado, importante en trian partian sistemon aŭ eĉ kiel presita raporto.<br/><br/>Por reviziado kaj administradceloj ĝi povas esti favora al bazlinio individuaj aparatoj kontraŭ fiksa, konata bona aparato. Bazlinioj rajtigas vin kombini reviziodatenojn kun aro de atributoj kiujn vi antaŭe difinis (via bazlinio) determini observon de aparatoj.';
...
$GLOBALS["lang"]['Below these lines are where the variables are injected into the script. Following on from our earlier example, the Linux audit script is populated with our directory like so'] = 'Sub tiuj linioj estas kie la variabloj estas injektitaj en la manuskripton. Sekvante de nia pli frua ekzemplo, la Linukso-revizia manuskripto estas loĝita kun nia adresaro kiel tiel';

$GLOBALS["lang"]['Below you can see an example Org Chart. If a user has permission on the <i>Finance A</i> Org, they also have permission on the descendant Orgs of Dept A, B & C. This is regardless of the collection requested.<br><br>If the collection requested allows ascendants, then the user will also have access to Company #1 and Default Org items. This is for (as above) queries, groups, et al.<br><br>Note - A user may have access to a query from Default Org, but that is the query itself not the result. The result will only show devices that the user has access to - IE devices from Finance A and Dept A, B & C.'] = 'Malsupre vi povas vidi ekzemplon Org Chart. Se uzanto havas permeson sur la <i>Financo</i> Org, ili ankaŭ havas permeson sur la posteulo Orgs de Dept A, B & C. Tio estas nekonsiderante la kolekto petis.<br/><br/>Se la kolekto petis permesas ascendantojn, tiam la uzanto ankaŭ havos aliron al firmao numero 1 kaj Default Org erojn. Tio estas por (kiel supre) demandoj, grupoj, et al.<br/><br/>Notu: uzanto povas havi aliron al demando de Default Org, sed tio estas la atendo mem ne la rezulto. La rezulto nur montras aparatojn kiujn la uzanto havas aliron al - IE aparatoj de Finance A kaj Dept A, B & C.';
...
$GLOBALS["lang"]['Benchmark Tasks are created automatically when a benchmark is created.'] = 'Benchmark Tasks estas kreita aŭtomate kiam komparnormo estas kreita.';
...
$GLOBALS["lang"]['Benchmarks are created by providing an operating system and Version, combined with a specific guide and a list of machines to execute it upon. After creation, benchmarks are executed against the list of machines on a schedule.'] = 'Benchmarks estas kreita disponigante operaciumon kaj Version, kombinita kun specifa gvidisto kaj listo de maŝinoj por efektivigi ĝin sur. Post kreado, komparnormoj estas efektivigitaj kontraŭ la listo de maŝinoj en horaro.';

$GLOBALS["lang"]['Benchmarks for Best Practise Configuration'] = 'Benchmarks por Best Practise Configuration';

$GLOBALS["lang"]['Benchmarks provide security recommendations for your computers, utilising the OpenSCAP tools and policies.</p><p><i>From the OpenSCAP homepage:</i>  In the ever-changing world of computer security where new vulnerabilities are being discovered and patched every day, enforcing security compliance must be a continuous process. It also needs to include a way to make adjustments to policies, as well as periodic assessment and risk monitoring. The OpenSCAP ecosystem provides tools and customizable policies for a quick, cost-effective and flexible implementation of these processes.'] = 'Benchmarks disponigas sekurecrekomendojn por viaj komputiloj, utiligante la OpenSCAP-ilojn kaj politikojn.<p><i>De la OpenSCAP hejmpaĝo:</i> En la iam-ajna-varia mondo de komputilsekureco kie novaj vundeblecoj estas malkovritaj kaj pecetigitaj ĉiun tagon, devigi sekurecobservon devas esti kontinua procezo. Ĝi ankaŭ devas inkludi manieron fari alĝustigojn al politikoj, same kiel periodan takson kaj riskmonitoradon. La OpenSCAP ekosistemo disponigas ilojn kaj adaptitajn politikojn por rapida, kostefika kaj fleksebla efektivigo de tiuj procezoj.</p>';
...
$GLOBALS["lang"]['Both forms of'] = 'Ambaŭ formoj de';
...
$GLOBALS["lang"]['Breaking it Down'] = 'Rompante ĝin malsupren';
...
$GLOBALS["lang"]['Browse down the tree to Console Root -> Component Services -> Computers -> My Computer<br><br>Right click on <i>My Computer</i> and select properties<br><br>Select the <i>Default Properties</i> tab'] = 'Browse laŭ la arbo al Console Root Komponetaj servoj -> Komputiloj -> mia komputilo<br/><br/>Rekte klaki sur <i>mia komputilo</i> kaj selektas trajtojn<br/><br/>Elektu la <i>Defaŭlaj Trajtoj</i> klaĉla klaĉla klako';
...
$GLOBALS["lang"]['Bulk edit selections wont stay selected after clicking next page.'] = 'Kuk redaktas selektadojn gajnitajn restas elektitaj post klakado de venonta paĝo.';
...
$GLOBALS["lang"]['But I do not want to have to change the language file every time I update!'] = 'Sed mi ne volas ŝanĝi la lingvan dosieron ĉiufoje kiam mi ĝisdatigas!';
...
$GLOBALS["lang"]['By default we integrate all devices with their nmis_manage attribute set to <i>y</i>. With 4.2.0 we also ship a Rule that says <i>If we discover a device and it has a valid SNMP OID, mark that device as managed by NMIS</i>. Obviously you can disable this if it is not what you want.'] = 'defaŭlte ni integras ĉiujn aparatojn kun sia nmis_manage atributo metita al <i>y y</i>. Kun 4.2.0 ni ankaŭ ekspedis Regulon kiu diras <i>Se ni malkovras aparaton kaj ĝi havas validan SNMP OID, markas tiun aparaton kiel administrite fare de NMIS</i>. Vi povas malfunkciigi tion se ĝi ne estas kion vi volas.';

$GLOBALS["lang"]['By default, we skip certificate validation because customers tend to use self-signed certificates. To enable certificate validation, edit the file below'] = 'De defaŭlto, ni saltas atestilon validigon ĉar klientoj tendencas uzi mem-subskribitajn atestilojn. Por ebligi atestilon validumado, redakti la dosieron sub';
...
$GLOBALS["lang"]['CVEs with a status of received, awaiting analysis, undergoing analysis, rejected. These CVEs (mostly) do not contain sufficient information to enable us to generate a correct SQL query.'] = 'CVEoj kun statuso de ricevita, atendante analizon, spertante analizon, malaprobis. Tiuj CVEoj (plejparte) ne enhavas sufiĉajn informojn por ebligi nin generi ĝustan SQL-demandadon.';
...
$GLOBALS["lang"]['Call up a command prompt by clicking Start and searching for <code>command</code>'] = 'Voki komando promptilon klakante Komencon kaj serĉadon <code>command</code>';
...
$GLOBALS["lang"]['Change'] = 'Ŝanĝoj ŝanĝiĝas';
...
$GLOBALS["lang"]['Change Logs'] = 'Ŝanĝoj';
...
$GLOBALS["lang"]['Chinese'] = 'ĉina ĉina ĉina';

$GLOBALS["lang"]['Chinese (traditional)'] = 'La ĉina (tradicia)';
...
$GLOBALS["lang"]['Choose the type of the task from the first drop down. This will configure the additional fields required depending on the type of task.'] = 'Elekti la specon de la tasko de la unua guto malsupren. Tio konformigos la kromajn kampojn necesajn depende de la speco de tasko.';
...
$GLOBALS["lang"]['Click the Edit button for <i>Basic SAML Configuration</i>.'] = 'Klaku la Edit butono por <i>Baza SAML Konfiguracio</i>.';
...
$GLOBALS["lang"]['Click the icon to the right of the field you wish to edit. Change the field and click the green icon to submit.'] = 'Klaku la ikonon dekstren de la kampo vi deziras redakti. Ŝanĝi la kampon kaj klaki la verdan ikonon por submetiĝi.';
...
$GLOBALS["lang"]['Cloud Discovery and Auditing'] = 'Nubo Discovery kaj Auditing';
...
$GLOBALS["lang"]['Clusters and Reporting'] = 'Clusters kaj Reporting';
...
$GLOBALS["lang"]['Collector / Server is an Enterprise only feature. Enterprise customers receive one Collector license for free. Additional Collector licenses can be purchased as required.'] = 'Servilo estas nur Enterprise. Enterprise klientoj ricevas unu kolektantlicencon por libera. Kromaj kolektantlicencoj povas esti aĉetitaj kiel postulate.';

$GLOBALS["lang"]['Collector / Server is designed so that you can have a remote or <i>collector</i>  instance of Open-AudIT running on a remote machine. That collector instance might be in another security zone, subnet, cloud hosting instance or at a customer site.  The remote collector is then doing all the discovering and auditing of devices locally avoiding networking and firewalling complexity.  The Collector once it has registered is completely controlled by the <i>server</i>.  This means you only need an HTTP or HTTPS connection from that Collector to the Server.'] = 'Servilo estas dizajnita tiel ke vi povas havi malproksiman aŭ <i>kolektanto</i> Ekzemplo de Open-AudIT kuranta sur malproksima maŝino. Tiu kolektantkazo eble estos en alia sekureczono, subreto, nubo gastiganta kazon aŭ en klientoloko. La malproksima kolektanto tiam faras la tutan malkovradon kaj revizion de aparatoj loke evitante interkonektadon kaj fajromurantan kompleksecon. La kolektanto post kiam ĝi registris estas tute kontrolita fare de la <i>servilo servilo servilo servilo servilo servilo</i>. Tio signifas ke vi nur bezonas HTTP aŭ HTTPS-ligon de tiu kolektanto al la Servilo.';
...
$GLOBALS["lang"]['Comment out the below line (about line 49 or so). Just place a hash # at the start of the line.'] = 'Komento de la sublinio (proksimume linio 49 aŭ tiel). Nur meti hash numero ĉe la komenco de la linio.';
...
$GLOBALS["lang"]['Complete these steps.'] = 'Kompletaj tiuj paŝoj.';
...
$GLOBALS["lang"]['Conduct management review meetings'] = 'Konduto-administrado revizias renkontiĝojn';

$GLOBALS["lang"]['Conduct regular surveillance audits (usually annually)'] = 'Faru regulajn gvatreviziojn (kutime ĉiujare)';
...
$GLOBALS["lang"]['Configuration Change Detection and Reporting'] = 'Konfiguracio Change Detection kaj Reporting';
...
$GLOBALS["lang"]['Consulting, implementation and other services are available through'] = 'Konsulo, efektivigo kaj aliaj servoj estas haveblaj tra';
...
$GLOBALS["lang"]['Continuously improve the ISMS'] = 'Daŭre plibonigi la ISMS';
...
$GLOBALS["lang"]['Copy the <i>Application ID</i> field and paste it into the Open-AudIT <i>Client ID</i> field for the new Auth Method.'] = 'Kopiu la <i>Identigi ID</i> kampo kaj pasto ĝi en la Open-AudIT <i>Kliento ID</i> kampo por la nova Auth Metodo.';

$GLOBALS["lang"]['Copy the <i>Client ID</i> and paste it into the Open-AudIT <i>Client ID</i> field.<br>If there is no secret, click <i>Generate new secret</i>, then copy the value and paste it into the Open-AudIT <i>Client Secret</i> field.'] = 'Kopiu la <i>Kliento ID</i> Kaj en la malferma-AudIT <i>Kliento ID</i> kampo.<br/>Se ne ekzistas sekreto, klako <i>Generi novan sekreton</i>Tiam kopii la valoron kaj paston ĝi en la Open-AudIT <i>La sekreta kliento</i> kampo.';

$GLOBALS["lang"]['Copy the value and paste it into the Open-AudIT form for the <i>Client Secret</i> field.'] = 'Kopio la valoro kaj pasto ĝi en la Open-AudIT-formularon por la <i>La sekreta kliento</i> kampo.';
...
$GLOBALS["lang"]['Creating Credentials'] = 'Kreanta Credentials';

$GLOBALS["lang"]['Creating Device'] = 'Krei Device';

$GLOBALS["lang"]['Creating Widgets'] = 'Kreanta Widgets';
...
$GLOBALS["lang"]['Creating a SQL Statement for Queries'] = 'Kreante SQL-deklaron por Queries';

$GLOBALS["lang"]['Creating an Integration'] = 'Krei integriĝon';
...
$GLOBALS["lang"]['Credentials are stored in the <i>credentials</i> database table. The actual credential information is encrypted in storage. When a Discovery is run, a device has its specific credentials retrieved from the database, decrypted and tested. If these fail the list of credentials is also retrieved, decrypted and then tested against the device starting with credentials known to have worked previously. Device specific credentials are stored at an individual device level in the <i>credential</i> table (note - no <i>s</i> in the table name). SSH keys are tested before SSH username / password. When testing SSH, credentials will also be marked as working with sudo or being root.'] = 'Credentials estas stokita en la <i>Akreditaĵoj</i> tablo de datumbazo. La faktaj lunarkinformoj estas ĉifritaj en stokado. Kiam Discovery estas prizorgita, aparato havas siajn specifajn akreditaĵojn prenitajn de la datumbazo, deĉifrita kaj testita. Se tiuj malsukcesas la liston de akreditaĵoj ankaŭ estas prenitaj, deĉifritaj kaj tiam testitaj kontraŭ la aparato komencanta kun akreditaĵoj konataj esti laborinta antaŭe. Device specifaj akreditaĵoj estas stokitaj sur individua aparatonivelo en la <i>→ Eventoj:</i> tablo (ne: ne <i>s</i> en la tablonomo). SSH-ŝlosiloj estas testitaj antaŭ SSH- uzantnomo / pasvorton. Dum testado de SSH, akreditaĵoj ankaŭ estos markitaj kiel laborado kun sekso aŭ esti radiko.';

$GLOBALS["lang"]['Credentials can have one of a few different types - snmp v.1 / v.2, snmp v.3, ssh, ssh key, windows are all implemented. CAVEAT - ssh keys are not implemented for Windows Open-AudIT servers as yet.'] = 'Credentials povas havi unu el kelkaj malsamaj tipoj - snmp v. 1 / v. 2, snmp v.3, ssh, ssh ŝlosilo, fenestroj estas ĉiuj efektivigitaj. CAVEAT - cindroŝlosiloj ne estas efektivigitaj por Windows Open-AudIT-serviloj kiel ankoraŭ.';
...
$GLOBALS["lang"]['Custom TCP Ports. Any specific ports we would liuke scanned in addition to the Top TCP Ports. Comma seperated, no spaces.'] = 'Kutimo TCP Havenoj. Ĉiuj specifaj havenoj kiujn ni liuke skanis aldone al la Top TCP Havenoj. Comma secesiis, neniuj spacoj.';

$GLOBALS["lang"]['Custom UDP Ports'] = 'UDP Havenoj';

$GLOBALS["lang"]['Custom UDP Ports. Any specific ports we would liuke scanned in addition to the Top UDP Ports. Comma seperated, no spaces.'] = 'UDP Havenoj. Ĉiuj specifaj havenoj kiujn ni liuke skanis aldone al la Supra UDP Havenoj. Comma secesiis, neniuj spacoj.';

$GLOBALS["lang"]['Customisable Scanning Options per Discovery'] = 'Kutimeblaj Scanning Opcioj per Discovery';
...
$GLOBALS["lang"]['Dashboards and Widgets allow Enterprise licensed customers to create, read, update and delete both of these collections to ensure their homepage is exactly what they need to see. Not only that, but a user is able to set a given dashboard as their own homepage. Everyone does not need to use the same homepage (dashboard), nor the same widgets on that dashboard. Professional licensed customers can choose between two predefined dashboards to set as their own homepage.'] = 'Dashboards kaj Widgets permesas al Enterprise aprobitajn klientojn krei, legi, ĝisdatigi kaj forigi ambaŭ de tiuj kolektoj por certigi ke ilia hejmpaĝo estas precize kion ili devas vidi. Ne nur tio, sed uzanto povas meti antaŭfiksitan dashboard kiel sia propra hejmpaĝo. Ĉiuj ne bezonas uzi la saman hejmpaĝon, nek la samajn ŝtrumpojn sur tiu dashboard. Profesiaj aprobitaj klientoj povas elekti inter du predifinitaj dashboards por komenciĝi kiel sia propra hejmpaĝo.';

$GLOBALS["lang"]['Dashboards provide <i>at a glance</i> important visibility for changes occurring on your network as well as providing quick links to device types, manufacturers, and operating systems and so much more.'] = 'Dashboards provizas <i>ĉe la rigardo</i> Grava videbleco por ŝanĝoj okazantaj sur via reto same kiel disponigado de rapidaj ligiloj al aparatspecoj, produktantoj, kaj operaciumoj kaj tiel multe pli.';

$GLOBALS["lang"]['Dashboards use'] = 'Dashboards uzas';

$GLOBALS["lang"]['Data'] = 'Datumoj';

$GLOBALS["lang"]['Data Export - CSV, XML, JSON'] = 'Data Export - CSV, XML, JSON';

$GLOBALS["lang"]['Data Retention'] = 'Datenoj Retention';
...
$GLOBALS["lang"]['Debugging a Script'] = 'Debuŝante manuskripton';
...
$GLOBALS["lang"]['Default Authentication Level - Set to Connect'] = 'Defaŭlta Authentication Nivelo - Nivelo Aliĝu por konekti';

$GLOBALS["lang"]['Default Impersonation Level - Set to Identify'] = 'Defaŭlta Impersonation Nivelo - Nivelo Aparta al Identigo';

$GLOBALS["lang"]['Default Items'] = 'Defaŭlta ĝi';

$GLOBALS["lang"]['Default Orgs Groups'] = 'Defaŭltaj Orgs Groups';

$GLOBALS["lang"]['Default Roles Groups'] = 'Defaŭltaj Roloj Grupoj';
...
$GLOBALS["lang"]['Deferred'] = 'Antaŭite fare de';
...
$GLOBALS["lang"]['Determine how often you want to run the Baseline check against the database and create a Scheduled Report'] = 'Determini kiom ofte vi volas prizorgi la Bazliniokontrolon kontraŭ la datumbazo kaj krei Scheduled Report';
...
$GLOBALS["lang"]['Device Component Names'] = 'Device Component-nomoj';
...
$GLOBALS["lang"]['Device Matching Rules'] = 'Device Matching Reguloj';
...
$GLOBALS["lang"]['Device Seed Discoveries are a good option if you know that your network consists of a range of subnets, but you are unsure what they are. Seed the discovery with a local router and watch your network unfold before your eyes.'] = 'Device Seed Eltrovaĵoj estas bona opcio se vi scias ke via reto konsistas el vico da subretoj, sed vi estas necertaj kion ili estas. Se vi trovis la malkovron kun loka vojo kaj rigardu vian reton antaŭ viaj okuloj.';
...
$GLOBALS["lang"]['Device and Software and Hardware Auditing'] = 'Device kaj Softvaro kaj Hardware Auditing';
...
$GLOBALS["lang"]['Devices will not be matched if their status is set to <i>deleted</i>. Any other status will allow a match to occur.'] = 'Aparatoj ne estos egalitaj se ilia statuso estas metita al <i>forigita</i>. Ĉiu alia statuso permesos matĉon okazi.';

$GLOBALS["lang"]['Devices with Expired Warranties'] = 'Aparatoj kun Expired Warranties';
...
$GLOBALS["lang"]['Discoveries are at the very heart of what Open-AudIT does. How else would you know <i>Whats On Your Network?</i>'] = 'Eltrovaĵoj estas ĉe la koro de kiu Open-AudIT faras. Kiel vi scius, <i>Kio estas sur via reto?</i>';

$GLOBALS["lang"]['Discoveries are entries that enable you to run a discovery upon a network in a single click, without entering the details of that network each and every time.'] = 'Eltrovaĵoj estas kontribuoj kiuj rajtigas vin prizorgi eltrovaĵon sur reton en ununura klako, sen enirado de la detaloj de tiu reto ĉiun kaj ĉiun fojon.';
...
$GLOBALS["lang"]['Discovery Scan Options are just another item collection. Enterprise users can create, read, update and delete entries as required. Professional users can read all entries, but not create new entries, update existing entries or delete entries. Community users have no GUI that allows access to this collection.'] = 'Discovery-skandalo Opcioj estas nur alia objektokolekto. Enterprise uzantoj povas krei, legi, ĝisdatigi kaj forigi kontribuojn kiel postulate. Profesiaj uzantoj povas legi ĉiujn kontribuojn, sed ne krei novajn kontribuojn, ĝisdatigi ekzistantajn kontribuojn aŭ forigi kontribuojn. Komunumaj uzantoj havas neniun GUI kiu permesas aliron al tiu kolekto.';

$GLOBALS["lang"]['Discovery Scan Types'] = 'Discovery Skaj Specoj';

$GLOBALS["lang"]['Discovery Support'] = 'Discovery Subteno';

$GLOBALS["lang"]['Discovery has stopped working'] = 'Discovery ĉesis labori';
...
$GLOBALS["lang"]['Do you have a perfect example of this configuration? Perhaps a device located in a lab environment or a workstation you use to clone workstation VMs from.'] = 'Ĉu vi havas perfektan ekzemplon de tiu agordo? Eble aparato situanta en laboratoriomedio aŭ specialkomputilo vi uzas por klonlaboration VMs de.';
...
$GLOBALS["lang"]['Download a File'] = 'Elŝutu dosieron';

$GLOBALS["lang"]['Download a file from URL'] = 'Elŝutu dosieron de URL';

$GLOBALS["lang"]['Download the test_windows_client.vbs script directly'] = 'Elŝutu la testiwindows_client.vbs manuskripton rekte';

$GLOBALS["lang"]['Download your updated version from'] = 'Elŝutu vian ĝisdatigitan version de';
...
$GLOBALS["lang"]['Duplicate Devices / Missing Devices'] = 'Duplikat Devices / Missing Devices';
...
$GLOBALS["lang"]['Each IP is scanned with the discovery configured options (see Discovery Scan Options and Discovery - Community vs Professional vs Enterprise on the wiki). In general, Nmap will test for ports 22 (ssh), 135 (wmi), 62078 (iPhone) and UDP 161 (snmp). If 22, 135 or 161 respond the credential list is retrieved and each credential tested in turn. The first working credentials are used for further queries directly from the device. Note - if a device has previously been discovered and has working credentials, those credentials are tested first. Only if those fail are the other credentials then attempted.'] = 'Ĉiu IP estas skanita kun la eltrovaĵo formita opcioj (vidu Discovery Scan Options kaj Discovery - komunumo vs Professional vs Enterprise sur la Vikio). Ĝenerale, Nmap testos por havenoj 22 ( cindro), 135 (wmi), 62078 ( iPhone) kaj UDP 161 (snmp). Se 22, 135 aŭ 161 respondas la lunarkliston estas prenita kaj ĉiu lunarko testita en victurno. La unuaj laborakreditaĵoj estas uzitaj por pliaj demandoj rekte de la aparato. Notu - se aparato antaŭe estis malkovrita kaj havas laborakreditaĵojn, tiuj akreditaĵoj unue estas testitaj. Nur se tiuj malsukcesas estas la aliaj akreditaĵoj tiam provitaj.';

$GLOBALS["lang"]['Each time a device is discovered or an audit result is processed, all rules are retrieved from the database and run against the attributes of the specific device. Rules run against one device at a time - there is no facility to say <i>Run the rules against all devices<i> or <i>Run the rules against these devices<i>. An individual rule will test one or more attributes of the device and if they match the rule, the result will be applied. Several attributes can be tested. Several attributes can be set. Think of this as an If This, Then That system for Open-AudIT.'] = 'Ĉiun fojon aparato estas malkovrita aŭ reviziorezulto estas prilaborita, ĉiuj reguloj estas prenitaj de la datumbazo kaj kuras kontraŭ la atributoj de la specifa aparato. Reguloj kuras kontraŭ unu aparato en tempo - ekzistas neniu instalaĵo diri <i>La reguloj kontraŭ ĉiuj aparatoj<i> aŭ aŭ <i>La reguloj kontraŭ tiuj aparatoj<i>. Individuoregulo testos unu aŭ pluraj atributojn de la aparato kaj se ili egalas la regulon, la rezulto estos aplikita. Pluraj atributoj povas esti testitaj. Pluraj atributoj povas esti metitaj. Pensu pri tio kiel Se tio, tiam tiu sistemo por Open-AudIT.</i></i></i></i>';

$GLOBALS["lang"]['Easily run a discovery upon a network in a single click, without entering the details of that network each and every time.'] = 'Easily prizorgas eltrovaĵon sur reton en ununura klako, sen enirado de la detaloj de tiu reto ĉiun kaj ĉiun fojon.';
...
$GLOBALS["lang"]['Enable Distributed COM on this computer - Option is checked'] = 'Enable Distributed COM sur tiu komputilo - Elekto estas kontrolita';
...
$GLOBALS["lang"]['Enrichment is complete. The CVE has full metadata and is considered stable.'] = 'riĉigo estas kompleta. La CVE havas plenajn metadatenojn kaj estas konsiderita stabila.';
...
$GLOBALS["lang"]['Example Devices'] = 'Ekzemplo: Devices';
...
$GLOBALS["lang"]['Exclude any ports listed from being scanned. Comma seperated, no spaces.'] = 'Ekskludante iujn ajn havenojn listigitajn de esti skanitaj. Comma secesiis, neniuj spacoj.';
...
$GLOBALS["lang"]['Extra and Time based Reporting'] = 'Ekstero kaj tempo bazigis Reporting';
...
$GLOBALS["lang"]['Fixing the Issue'] = 'Fixing la afero';
...
$GLOBALS["lang"]['For'] = 'Ĉar por';

$GLOBALS["lang"]['For <i>Type</i> make sure to select Baseline, and for Group you should select a Group of devices, if applicable to this baseline, that best represent the devices to apply the baseline against. This will prevent erroneous entries.'] = 'Ĉar por <i>Tipo</i> Certigu selekti Bazlinion, kaj por grupo vi devus selekti grupon de aparatoj, se uzeble al tiu bazlinio, kiu plej bone reprezentas la aparatojn por uzi la bazlinion kontraŭ. Tio malhelpos erarajn kontribuojn.';

$GLOBALS["lang"]['For Debian/Ubuntu run, including setting dpkg to remember your override so an apt-get upgrade will not break'] = 'Por Debian/Ubuntu kuro, inkluzive de metado de dpkg por memori vian override tiel apt-ricevi ĝisdatigo ne krevos';

$GLOBALS["lang"]['For SNMP Open-AudIT can use v1, v2 and v3 credentials. The device is queried regardless of it being a router, switch (regular network devices) or a computer (Linux and Windows often run SNMP for monitoring tools).'] = 'Por SNMP Open-AudIT povas uzi v1, v2 kaj v3 akreditaĵoj. La aparato estas pridemandita nekonsiderante ĝi estante itinero, ŝaltilo (regulaj sendostaciaj aparatoj) aŭ komputilo (Linŭ kaj Fenestroj ofte prizorgas SNMP por monitoradiloj).';

$GLOBALS["lang"]['For a primer on cron, see this Wikipedia page'] = 'Por enkonduko sur kno, vidu ĉi tiun paĝon';
...
$GLOBALS["lang"]['For more detailed information, check the Open-AudIT Knowledge Base.'] = 'Por pli detalaj informoj, kontrolu la Open-AudIT Knowledge Base.';

$GLOBALS["lang"]['For more information please see the following guide which includes a video. Use'] = 'Por pli da informoj bonvolu vidi la sekvan gvidiston kiu inkludas vidbendon. Uzo de uzo';
...
$GLOBALS["lang"]['From that page'] = 'De tiu paĝo';

$GLOBALS["lang"]['full_name'] = 'Plena nomo';

$GLOBALS["lang"]['Full Name'] = 'Plena nomo';

$GLOBALS["lang"]['Full cloud auditing with all the details from a regular Open-AudIT audit AND details such as the machine type and size.'] = 'Plena nubo revizianta kun ĉiuj detaloj de regula Open-AudIT-Revizio kaj detaloj kiel ekzemple la maŝinspeco kaj grandeco.';
...
$GLOBALS["lang"]['Get News'] = 'Akiri Novaĵoj';

$GLOBALS["lang"]['Get Started'] = 'Komencu komenci';

$GLOBALS["lang"]['Get a Free License'] = 'Akiri Liberan Permesilon';

$GLOBALS["lang"]['Get familiar with the Open-AudIT platform and explore some of its features.'] = 'Scii kun la Open-AudIT-platformo kaj esplori iujn el ĝiaj ecoj.';
...
$GLOBALS["lang"]['Go back to your Open-AudIT server and create a discovery with the target Windows computers IP Address as the subnet (this will save having to discover the entire subnet again). Run the discovery, taking note of any issues. For any issues found, take appropriate actions.'] = 'Iru reen al via Open-AudIT-servilo kaj krei eltrovaĵon kun la celo Windows komputiloj IP Address kiel la subreto (tio ŝparos devi malkovri la tutan subreton denove). La malkovro, noti pri iuj aferoj. Ĉar iuj aferoj trovis, prenu taŭgajn agojn.';
...
$GLOBALS["lang"]['Go to the <i>Applications</i> -> <i>App registrations</i> menu item on the far left. Search for Open-AudIT. Click the Open-AudIT entry in the list (assuming you named the app Open-AudIT).'] = 'Iru al la <i>Aplikoj</i> > <i>Registrado</i> menuo objekto sur la malproksima maldekstro. Serĉis por Open-AudIT. Klaku la Open-AudIT-eniron en la listo (supozante ke vi nomis la app Open-AudIT).';

$GLOBALS["lang"]['Go to the <i>Certificates and secrets</i> menu item under <i>Manage</i> in the center menu.'] = 'Iru al la <i>Atestiloj kaj sekretoj</i> Manu objekto sub <i>Manaĝo</i> en la centro menuo.';

$GLOBALS["lang"]['Go to the <i>Single sign-on</i> menu item and click SAML for <i>Select a single sign-on method</i>.'] = 'Iru al la <i>Ununura signo-sur</i> menuo objekto kaj klako SAML por <i>Elekti ununuran signo-sur metodon</i>.';
...
$GLOBALS["lang"]['Groups are used as simple lists of devices that match the required conditions. If requested using JSON they return a list of <i>devices.id</i> only. If requested using the web interface, they return the standard column attribute list. Groups can be used for Integrations, Baselines and other items.'] = 'Grupoj estas utiligitaj kiel simplaj listoj de aparatoj kiuj egalas la postulatajn kondiĉojn. Se demandite uzante JSON ili resendas liston de <i>aparatoj.id</i> nur. Se postuladite uzante la interretinterfacon, ili resendas la norman kolumnon atribuas liston. Grupoj povas esti uzitaj por Integriĝoj, Bazlinioj kaj aliaj eroj.';
...
$GLOBALS["lang"]['Have the agent always run the latest audit script (if you upgrade Open-AudIT and manually copy the scripts to the targets, then set cron - you will need to update these scripts for each upgrade).'] = 'Havi la agenton ĉiam prizorgas la plej malfruan reviziomanuskripton (se vi ĝisdatigas Open-AudIT kaj mane kopias la manuskriptojn al la celoj, tiam metitan kron - vi bezonos ĝisdatigi tiujn manuskriptojn por ĉiu ĝisdatigo).';

$GLOBALS["lang"]['Have your user open a command prompt (using <i>Run as Administrator</i>). Paste the below into the prompt to download the Agent.'] = 'Via uzanto malfermas komandan promptilon (uzante <i>Kiel administranto</i>). Paste la malsupre en la promptilon por elŝuti la agenton.';

$GLOBALS["lang"]['Head'] = 'Kapo';

$GLOBALS["lang"]['Heard Island and McDonald Islands'] = 'Heard Island kaj McDonald Insuloj';

$GLOBALS["lang"]['Hebrew'] = 'Hebrea hebrea';
...
$GLOBALS["lang"]['Helps manage and mitigate information security risks'] = 'Helpoj administras kaj mildigas informajn sekurecriskojn';

$GLOBALS["lang"]['Hide Audit Window'] = 'Kaŝu la fenestron';
...
$GLOBALS["lang"]['How Does It Work?'] = 'Kiel ĝi funkcias?';

$GLOBALS["lang"]['How Does it Work?'] = 'Kiel ĝi funkcias?';

$GLOBALS["lang"]['How Long Does it Take'] = 'Kiom longe ĝi prenas';
...
$GLOBALS["lang"]['How does a Device Seed Discovery find known IPs?'] = 'Kiel Device Seed Discovery trovas konataj IPoj?';
...
$GLOBALS["lang"]['I hope this post has alleviated any concerns you have about Open-AudIT and Security. If you have any questions at all, please do not hesitate to reach out to us here at FirstWave. We are always happy to discuss your concerns and needs. And maybe if your question is not something I have addressed here, I can add it here for future users'] = 'Mi esperas, ke ĉi tiu artikolo mildigis iujn zorgojn, kiujn vi havas pri Open-AudIT kaj Sekureco. Se vi havas demandojn entute, bonvolu ne hezitu atingi nin ĉi tie. Ni ĉiam ĝojas diskuti viajn zorgojn kaj bezonojn. Kaj se via demando ne estas io, kion mi traktis ĉi tie, mi povas aldoni ĝin ĉi tie por estontaj uzantoj.';
...
$GLOBALS["lang"]['Identify key stakeholders and assign roles'] = 'Identigu esencajn koncernatojn kaj asignas rolojn';

$GLOBALS["lang"]['Identify the device(s) that are your exemplary, or <i>gold image</i> you want to compare similar devices against.'] = 'Identigu la aparaton (j) kiuj estas via modela, aŭ <i>ora bildo</i> Vi volas kompari similajn aparatojn kontraŭ.';

$GLOBALS["lang"]['Identifying and evaluating security risks'] = 'Identigado kaj analizado de sekurecriskoj';

$GLOBALS["lang"]['If'] = 'Se';

$GLOBALS["lang"]['If a device is individually discovered using the <i>Discover Device</i> link on the device details page, we first check if this device has been discovered previously (by Discovery) and if so, use the discovery options from that scan. If it has not been previously discovered, we revert to the configuration item discovery_default_scan_option the settings.'] = 'Se aparato estas individue malkovrita uzante la <i>Malkovru Device</i> ligo sur la aparato detalpaĝo, ni unue kontrolas se tiu aparato estis malkovrita antaŭe (de Discovery) kaj se tiel, uzas la eltrovaĵo opciojn de tiu skanado. Se ĝi ne estis antaŭe malkovrita, ni revenas al la konfiguracio objektotrovaĵo_defaŭlto la valoroj.';

$GLOBALS["lang"]['If a new Org is created, an LDAP group name is automatically derived from the name. For example, if a new Org is created and is named Test, the corresponding LDAP group will be named open-audit_orgs_test.'] = 'Se nova Org estas kreita, LDAP grupnomo estas aŭtomate derivita de la nomo. Ekzemple, se nova Org estas kreita kaj estas nomita Testo, la ekvivalenta LDAP-grupo estos nomita malferma-audit_orgs_testo.';
...
$GLOBALS["lang"]['If no operator is specified, the default is =. Properties should be fully qualified - ie, devices.hostname (not just hostname).'] = 'Se neniu funkciigisto estas precizigita, la defaŭlto estas =. Trajtoj devus esti plene kvalifikitaj - t.e., aparatoj.hostname (ne ĵus mastro-nomo).';

$GLOBALS["lang"]['If no value is present, supply this value. EG: for system.nmis_group / configuraion.group we use'] = 'Se neniu valoro ĉeestas, provizas tiun valoron. EG: por sistemo.nmis_group / konfiguraion. Grupo kiun ni uzas';
...
$GLOBALS["lang"]['If the Open-AudIT Server has Collectors reporting to it, an additional drop down is provided. You can select this to specify which Collector the task should run on. Only Discovery tasks are supported for Collectors.'] = 'Se la Open-AudIT-Servilo havas kolektantojn raportantajn al ĝi, kroma guto malsupren estas disponigita. Vi povas selekti tion por precizigi kiu kolektanta la taskon devus funkcii. Nur Discovery-taskoj estas apogitaj por kolektantoj.';
...
$GLOBALS["lang"]['If the binary is not found in either of these locations, a warning message will be displayed in the installer.'] = 'Se la binara ne estas trovita en aŭ de tiuj lokoj, avertanta mesaĝo estos elmontrita en la instalilo.';
...
$GLOBALS["lang"]['If the local field is true (bool) or y (string) or Y (string) or 1 (integer) then set the external data to 1.'] = 'Se la loka kampo estas vera (bool) aŭ y (ŝnuro) aŭ Y (ŝnuro) aŭ 1 (integer) tiam metis la eksterajn datenojn al 1.';

$GLOBALS["lang"]['If the local field is true (bool) or y (string) or Y (string) or 1 (integer) then set the external data to y.'] = 'Se la loka kampo estas vera (bool) aŭ y (ŝnuro) aŭ Y (ŝnuro) aŭ 1 (integer) tiam metis la eksterajn datenojn al y.';
...
$GLOBALS["lang"]['If the user logging on to Open-AudIT does not have the access to search OpenLDAP, you can use another account which does have this access. Use the dn_account and dn_password to configure this.'] = 'Se la uzanto registradanta al Open-AudIT ne havas la aliron serĉi OpenLDAP, vi povas uzi alian raporton kiu havas tiun aliron. Uzu la dn_account kaj dn_password por formi tion.';
...
$GLOBALS["lang"]['If this change does not work for you, all is not lost. We have added a configuration item (set to n by default, so it will use not this new option out of the box) called discovery_use_org_id_match. If you change it to y then the OrgID assigned to the device by the discovery will be used in the relevant match rules.'] = 'Se tiu ŝanĝo ne funkcias por vi, ĉio ne estas perdita. Ni aldonis konfiguracion objekto (set al n defaŭlte, tiel ke ĝi ne uzos tiun novan opcion el la kesto) nomita Discovery_use_org_id_-matĉo. Se vi ŝanĝas ĝin al y tiam la OrgID asignita al la aparato per la eltrovaĵo estos uzita en la signifaj matĉoreguloj.';
...
$GLOBALS["lang"]['If you are a supported FirstWave customer,a couple of items will make helping your easier. Open a support ticket with FirstWave and attach the logfile. Also include the output from the Support button on the upper right of the'] = 'Se vi estas apogita unua kliento, kelkaj eroj helpos al via pli facila. Malfermu helpbileton kun FirstWave kaj alkroĉas la tagdosieron. Ankaŭ inkludas la produktaĵon de la Subtena butono sur la supra rajto de la';

$GLOBALS["lang"]['If you are a supported customer and open a support ticket with FirstWave, please attach these files.'] = 'Se vi estas apogita kliento kaj malfermas helpbileton kun FirstWave, bonvolu alkroĉi tiujn dosierojn.';

$GLOBALS["lang"]['If you are having issues with Google Maps API keys or your company does not have access to create Google Maps API keys, please contact the FirstWave support team.'] = 'Se vi havas problemojn kun Google Maps API ŝlosiloj aŭ via firmao ne havas aliron krei Google Maps API-ŝlosilojn, bonvolu kontakti la FirstWave subtenteamon.';
...
$GLOBALS["lang"]['If you are on a decent broadband or ethernet connection, I would recommend always using -T4 (Aggressive). Some people love -T5 (Insane) though it is too aggressive for my taste. People sometimes specify -T2 (Polite) because they think it is less likely to crash hosts or because they consider themselves to be polite in general. They often do not realize just how slow -T2 really is. Their scan may take ten times longer than a default scan. Machine crashes and bandwidth problems are rare with the default timing options -T3 (Normal) and so I normally recommend that for cautious scanners. Omitting version detection is far more effective than playing with timing values at reducing these problems.'] = 'Se vi estas sur deca larĝbendo aŭ etero ligo, mi rekomendus ĉiam uzi - T4 (Agres). Kelkaj homoj amas - T5 (Insane) kvankam ĝi estas tro agresema por mia gusto. Homoj foje precizigas - T2 (Polite) ĉar ili opinias ke estas malpli verŝajne trafi gastigantojn aŭ ĉar ili pripensas sin esti ĝentilaj ĝenerale. Ili ofte ne ekkomprenas ekzakte kiom malrapida - T2 vere estas. Ilia skanado povas preni dek fojojn pli longe ol defaŭlta skanado. Maŝinkraŝoj kaj bendolarĝproblemoj estas raraj kun la defaŭltaj tempigelektoj - T3 (Normal) kaj tiel mi normale rekomendas tion por singardaj skaniloj. Uzanta versio detekto estas multe pli efika ol ludado kun tempigvaloroj ĉe reduktado de tiuj problemoj.';

$GLOBALS["lang"]['If you are running a RedHat or Centos system and you have upgraded Nmap, please reset the SUID on the binary by'] = 'Se vi prizorgas RedHat aŭ Centos-sistemon kaj vi ĝisdatigis Nmap, bonvolu rekomencigi la SUID sur la binara per';
...
$GLOBALS["lang"]['If you do normally set devices_assigned_to_org and the configuration item is enabled, then the OrgID will be used to further refine the match.'] = 'Se vi normale metis aparatojn_assigned_to_org kaj la konfiguraciobjektoj estas ebligitaj, tiam la OrgID estos utiligita por plue rafini la matĉon.';

$GLOBALS["lang"]['If you do not normally set devices_assigned_to_org, then it will have no effect. We only check using the OrgID if it has been set in discovery (or manually in an audit script) and enabled in the configuration.'] = 'Se vi ne normale metis aparatojn, tiam ĝi havos neniun efikon. Ni nur kontrolas uzi la OrgID se ĝi estis metita en eltrovaĵo (aŭ mane en reviziomanuskripto) kaj ebligis en la konfiguracio.';

$GLOBALS["lang"]['If you enable the configuration item, use discovery to assign an Org and then subsequently change the OrgID of a device after discovery then you will likely have a new device created the next time the discovery runs. In this instance, you should probably just unset devices_assigned_to_org before running subsequent discoveries. This is because (in this instance) you have told Open-AudIT <i>these devices from this discovery belong to Org X<i>, but then changed the Org of the device. You have changed the stored devices information. In this case - there is no no longer a device belonging to Org X, so we create a new one.'] = 'Se vi rajtigas la konfiguracion, uzu eltrovaĵon por asigni Org kaj tiam poste ŝanĝi la OrgID de aparato post eltrovaĵo tiam vi verŝajne havos novan aparaton kreis la venontan fojon la eltrovaĵo kuras. En tiu kazo, vi devus verŝajne nur neselektitaj aparatoj - asignis_to_org antaŭ prizorgado de postaj eltrovaĵoj. Tio estas ĉar (en tiu kazo) vi rakontis al Open-AudIT <i>Tiuj aparatoj de tiu eltrovaĵo apartenas al Org X<i>Sed tiam ŝanĝis la Org de la aparato. Vi ŝanĝis la stokitajn aparatojn informo. En tiu kazo, ekzistas jam ne aparato apartenanta al Org X, tiel ke ni kreas novan.</i></i>';

$GLOBALS["lang"]['If you have Anti-Virus software running, allowing the services of Opmantek (omkd), Apache (apache2.2) and MySQL (mysql) to auto start and run is essential. These services are used by Open-AudIT. You should only need to do this once. If your Anti-Virus program keeps prompting you about Open-AudIT, please post to the forums or send an email to support with the name and version of your Anti-Virus software.'] = 'Se vi havas Anti-Virus-softvaron kurantan, permesante al la servoj de Opmantek (omkd), Apache (apache2.2) kaj MySQL (mysql) al aŭtokomenco kaj kuro estas esenca. Tiuj servoj estas uzitaj fare de Open-AudIT. Vi nur devas fari tion unufoje. Se via Anti-Virus-programo observas vin pri Open-AudIT, bonvolu poŝto al la forumoj aŭ sendi retpoŝton al subteno kun la nomo kaj versio de via Anti-Virus-softvaro.';

$GLOBALS["lang"]['If you have working credentials, you can expect the full amount of information possible.<br><br>Obviously, the best way to use Open-AudIT is to have working credentials for the devices being discovered (be they WMI, SSH, or SNMP credentials).<br><br>We also have a page on auditing without credentials.'] = 'Se vi laboras akreditaĵojn, vi povas atendi la plenan kvanton de informoj ebla.<br/><br/>Evidente, la plej bona maniero uzi Open-AudIT devas havi laborakreditaĵojn por la aparatoj estantaj malkovrita (estu ili WMI, SSH, aŭ SNMP-akreditaĵoj).<br/><br/>Ni ankaŭ havas paĝon sur revizio sen akreditaĵoj.';

$GLOBALS["lang"]['If you include the \"id\" field <strong>and</strong> set it with a number, that item will be updated rather than created.'] = 'Se vi inkludas la "id" kampon <strong>kaj</strong> Kun nombro, tiu objekto estos ĝisdatigita prefere ol kreita.';

$GLOBALS["lang"]['If you need to configure Active Directory access, you can usually use the example of <code>cn=Users,dc=your,dc=domain,dc=com</code> for your <code>base_dn</code>. There is no need to set <code>user_dn</code>.'] = 'Se vi devas agordi Aktivan Adresaraliron, vi povas kutime uzi la ekzemplon de <code>cn=Users,dc=your,dc=domain,dc=com</code> por via <code>base_dn</code>. Ne necesas starigi <code>user_dn</code>.';

$GLOBALS["lang"]['If you need to configure OpenLDAP access for your users and a given users access DN is normally <code>uid=username@domain,cn=People,dc=your,dc=domain,dc=com</code> then you should set <code>base_dn</code> to <code>dc=your,dc=domain,dc=com</code> and <code>user_dn</code> to <code>uid=@username@@domain,cn=People</code>. The special words <code>@username</code> and <code>@domain</code> will be replaced by the login details provided by your user on the login page.'] = 'Se vi devas agordi OpenLDAP-aliron por viaj uzantoj kaj antaŭfiksita uzantoj aliras DN estas normale <code>uid=username@domain,cn=People,dc=your,dc=domain,dc=com</code> Tiam vi devus agordi <code>base_dn</code> al la <code>dc=your,dc=domain,dc=com</code> kaj <code>user_dn</code> al la <code>uid=@username@@domain,cn=People</code>. La specialaj vortoj <code>@username</code> kaj <code>@domain</code> estos anstataŭigita per la login detaloj disponigitaj fare de via uzanto sur la ensalutpaĝo.';

$GLOBALS["lang"]['If you run discovery upon a subnet that the Server (or Collector) is directly installed on, you can expect the following for responding devices'] = 'Se vi kuras malkovron sur subreto kiun la Servilo (aŭ kolektanto) estas rekte instalita, vi povas atendi la sekvantan por respondado de aparatoj.';

$GLOBALS["lang"]['If you run discovery upon a subnet that your Server (or Collector) is not directly installed on, you can expect the following for responding devices'] = 'Se vi kuras malkovron sur subreto kiun via Servilo (aŭ kolektanto) ne estas rekte instalita, vi povas atendi la sekvantan por respondaj aparatoj.';

$GLOBALS["lang"]['If you select a List type, an additional field will appear called Values. You should put a comma separated list of selectable values here. These will display in a dropdown box whenever the field is edited.'] = 'Se vi elektas List tipon, kroma kampo aperos nomita Valoroj. Vi devus meti komon apartigita listo de fajnaj valoroj ĉi tie. Tiuj elmontros en guto-kesto kiam la kampo estas redaktita.';

$GLOBALS["lang"]['If you set the values for'] = 'Se vi metis la valorojn por';

$GLOBALS["lang"]['If you want to force your Agents to use a particular configuration, you can supply the ID of the agents entry to use, as below (replace $id with the number of the Agents entry). When this Agent is installed, it will check-in with the sevrer and <strong>only</strong> check that one individual Agent entrys attributes (tests and actions). This may be useful if you are an MSP - create an Agents entry for a particular customer and have their devices all use this entry, which assigns them to an Org and Location.'] = 'Se vi volas devigi viajn agentojn uzi specialan konfiguracion, vi povas provizi la ID de la agentoj eniro por uzi, kiel malsupre (anstataŭigi id kun la nombro da la Agentoj eniro). Kiam tiu agento estas instalita, ĝi kontrolus kun la sevranto kaj <strong>nur nur</strong> Kontrolu tiun individuon Agenteniroj atribuas (testo kaj agoj). Tio povas esti utila se vi estas MSP - krei Agents-eniron por speciala kliento kaj havas iliajn aparatojn ĉiuj uzas tiun eniron, kiu asignas ilin al Org kaj Loko.';

$GLOBALS["lang"]['If you wish to dig in and customize the Integration, click the Advanced button (and try not to be overwhelmed!).'] = 'Se vi deziras fosi en kaj personecigi la Integriĝo, klaki la Altnivelan butonon (kaj provi ne esti superfortita).';

$GLOBALS["lang"]['If you wish to run a Discovery on an externally provided device, select the option and when the Integration is created, so s the Discovery.'] = 'Se vi deziras kuri Discovery sur ekstere disponigita aparato, selektas la opcion kaj kiam la Integriĝo estas kreita, tiel s la Discovery.';

$GLOBALS["lang"]['If you would like to use the script outside of Discovery we have created another endpoint called <i>scripts</i>. See the documentation'] = 'Se vi ŝatus uzi la manuskripton ekstere de Discovery, ni kreis alian finpunkton nomitan <i>manuskriptoj</i>. Vidu la dokumentadon';

$GLOBALS["lang"]['If your user does not have <i>Run as Administrator</i> rights, they can still download the agent (first command above) and run it to submit an audit as below. It will be a one-off audit without the Agent being installed or scheduled.'] = 'Se via uzanto ne havas <i>Kiel administranto</i> Ili daŭre povas elŝuti la agenton (unua komando supre) kaj prizorgi ĝin por alsendi revizion kiel malsupre. Ĝi estos unufoja revizio sen la agento estanta instalita aŭ planita.';
...
$GLOBALS["lang"]['Import multiple {collection} using a CSV.'] = 'Importa multobla { komiksiĝo} uzanta CSV.';
...
$GLOBALS["lang"]['In a second tab or window go to your OKTA console and click <i>Create App Integration</i>.'] = 'En dua klako aŭ fenestro iras al via OKTA-konzolo kaj klako <i>Krei app Integri</i>.';

$GLOBALS["lang"]['In a second tab or window sign-on to your'] = 'En dua klako aŭ fenestrosigno al via';

$GLOBALS["lang"]['In my personal opinion, the best way to find and audit every single item on your network is a Seed Discovery for each subnet, restricted to that subnet (using credentials). Seed Discoveries use switch, router and computer MAC Address tables to not miss a single device. If it is connected to the network and uses TCP/IP, a switch/router/computer has to know it is there - thats just how TCP/IP works. Combine that with custom TCP and/or UDP ports and you should then be able to determine the device type as well. But thats just my personal preference'] = 'En mia persona opinio, la plej bona maniero trovi kaj revizii ĉiun ununuran objekton sur via reto estas Seed Discovery por ĉiu subreto, limigita al tiu subreto (uzante akreditaĵojn). Seed Discoveries uzas ŝanĝon, italon kaj komputilMAC Address tablojn por ne maltrafi ununuran aparaton. Se ĝi estas ligita al la reto kaj uzas TCP/IP, ŝaltilo/router/komputilo devas scii ke ĝi estas tie - tio ĵus kiel TCP/IP funkcias. Kombinu tion kun kutimo TCP kaj/aŭ UDP-havenoj kaj vi tiam devus determini la aparatospecon ankaŭ. Sed tio estas nur mia persona prefero';

$GLOBALS["lang"]['In order for Open-AudIT to be able to apply user permissions on items, we mandate the user of <code>WHERE @filter</code>. If you do not use this format, the queryCreateForm will throw a warning. Only users with the Admin role are permitted to create queries that lack this attribute and even then, only after the configuration item for <i>advanced_queries</i> has been enabled.'] = 'Por Open-AudIT povi apliki uzantpermesojn sur eroj, ni postulas la uzanton de <code>WHERE @filter</code>. Se vi ne uzas tiun formaton, la queryCreateForm ĵetos averton. Nur uzantoj kun la Admin-rolo estas licaj krei demandojn kiuj mankas tiu atributo kaj eĉ tiam, nur post la konfiguracioobjekto por <i>progresintajn klarigojn</i> estis ebligita.';

$GLOBALS["lang"]['In order to enable Google Maps you will need to a Google API Key follow this link and log in with your Google account,'] = 'Por ebligi Google Maps vi bezonos Google API Ŝlosilon sekvi ĉi tiun ligon kaj ensaluti kun via Google konto,';
...
$GLOBALS["lang"]['Integrations can be scheduled as desired. This is left to the user.'] = 'Integriĝo povas esti planita kiel dezirite. Tio estas lasita al la uzanto.';

$GLOBALS["lang"]['Integrations can be scheduled as per Discoveries, Queries, et al.'] = 'Integriĝoj povas esti planitaj kiel per Eltrovaĵoj, Queries, et al.';

$GLOBALS["lang"]['Interactive Dashboards'] = 'Interagaj Dashboards';

$GLOBALS["lang"]['Interactive dashboards provide instant visibility into the status of network inventory allowing IT teams to spot newly discovered devices and unusual device behaviour at a glance.'] = 'Interagaj daŝtabuloj disponigas tujan videblecon en la statuson de sendostacia stokregistro permesanta al IT-teamoj ekvidi lastatempe malkovritajn aparatojn kaj nekutiman aparaton ĉe rigardo.';
...
$GLOBALS["lang"]['Internal Audit'] = 'Interna Audit';

$GLOBALS["lang"]['Internal Audit & Review'] = 'Interna Audit & Revizio';
...
$GLOBALS["lang"]['It <i>Just Works</i> with NMIS'] = 'Ĝi estas <i>Nur funkcias</i> kun NMIS';

$GLOBALS["lang"]['It is available at Menu -> Help ->'] = 'Ĝi estas havebla ĉe Menu - Helpo ->';

$GLOBALS["lang"]['It is important to note that when Open-AudIT determines a match any properties set to <i>y</i> must match exactly (and not be blank) in order for Open-AudIT to determine that the discovered device matches a device already in the database. If none of the properties marked <i>y</i> match, then a new device entry will be created, which could result in duplicate device entries. In situations where properties are duplicated, for example a dbus_id is copied during a VM clone, then an existing device may incorrectly get overwritten/updated rather then a new entry being created resulting in missing devices.'] = 'Estas grave noti ke kiam Open-AudIT determinas matĉon ajnaj trajtoj atribuitaj al <i>y y</i> devas egali precize (kaj ne esti brilaj) por Open-AudIT por determini ke la malkovrita aparato egalas aparaton jam en la datumbazo. Se neniu el la trajtoj markis <i>y y</i> matĉo, tiam nova aparato eniro estos kreita, kiu povis rezultigi duplikataparaton kontribuoj. En situacioj kie trajtoj estas duplikatigitaj, ekzemple dbus_id estas kopiita dum VM klono, tiam ekzistanta aparato povas neĝuste iĝi troskribita/ĝisdatigita prefere tiam nova eniro estanta kreita rezultigante mankantajn aparatojn.';

$GLOBALS["lang"]['It is not uncommon to have an overlapping address space in a given Organisation. Not ideal, but not uncommon.'] = 'Estas ne nekutime havi imbrikitan adresspacon en antaŭfiksita organizo. Ne ideala, sed ne malofta.';

$GLOBALS["lang"]['It is very common for second tier motherboard manufacturers to not set this, to set it to all <i>0</i>s or even all <i>F</i>s.'] = 'Ĝi estas tre ofta por dua parto patrinestraj produktantoj por ne meti tion, por atribui ĝin al ĉio. <i>0 0 0 0</i>aŭ eĉ ĉiuj <i>F</i>s.';
...
$GLOBALS["lang"]['Korean'] = 'korea korea korea';
...
$GLOBALS["lang"]['LDAP was searched for this user and their account was found.'] = 'LDAP estis serĉita por tiu uzanto kaj ilia raporto estis trovita.';

$GLOBALS["lang"]['LDAP was searched for this user and their account was not found. Check the LDAP server logs. The user credentials have worked, but the user was not found. Also check you have specified the correct Base DN attribute when you created the LDAP Server in Open-AudIT.'] = 'LDAP estis serĉita por tiu uzanto kaj ilia raporto ne estis trovita. Kontrolu la LDAP-servilregistrojn. La uzanto akreditaĵoj laboris, sed la uzanto ne estis trovita. Ankaŭ kontrolu, ke vi specifis la ĝustan Bazon DN atribuas kiam vi kreis la LDAP-Servilon en Open-AudIT.';
...
$GLOBALS["lang"]['Line charts must return date or my_date, description or my_description and count.'] = 'Linio kiun furorlisto devas resendi daton aŭ I_date, priskribon aŭ mispriskribon kaj kalkulon.';
...
$GLOBALS["lang"]['List All NMAP Ports, Protocols and Programs for Each Device'] = 'Listo de NMAP Havenoj, Protokoloj kaj Programoj por ĉiu Device';
...
$GLOBALS["lang"]['Maintain records of risk assessments and treatments'] = 'Ĉefaj artikoloj pri riskotaksoj kaj terapioj';
...
$GLOBALS["lang"]['Manage incidents and nonconformities'] = 'Manaĝ okazaĵoj kaj nekonformities';
...
$GLOBALS["lang"]['Matching Devices - Including OrgID'] = 'Matching Devices - Inkluzive de OrgID';

$GLOBALS["lang"]['Matching Linux Devices'] = 'Matching Linux Devices';

$GLOBALS["lang"]['Matching is conducted in the following order'] = 'Matching estas farita en la sekva ordo';
...
$GLOBALS["lang"]['Modifying an Existing Script'] = 'Modifante Existing Script';
...
$GLOBALS["lang"]['More information about debugging this can be found on a helpful Stack Overflow thread'] = 'Pli da informoj pri malkonstruado de tio povas esti trovitaj sur helpema Stack Overflow fadeno';

$GLOBALS["lang"]['Morocco'] = 'Maroko';

$GLOBALS["lang"]['Most likely the Windows firewall (or a third party firewall) is denying the connection attempt.<br><br>Please log on to the target Windows machine and check the firewall settings.'] = 'Plej verŝajne la Fenestroj (aŭ tria partiofajromuro) neas la ligprovon.<br/><br/>Bonvolu ensaluti al la celo Windows maŝino kaj kontroli la fajromuro agordojn.';
...
$GLOBALS["lang"]['Must Respond To Ping. If set, Nmap will fist attempt to send and listen for an ICMP response. If the device does not respond, no further scanning will occur.<br>Previously a device did not have to respond to a ping for Open-AudIT to continue scanning.'] = 'Ni devas respondi al Ping. Se aro, Nmap pugnoprovos sendi kaj aŭskulti por ICMP-respondo. Se la aparato ne respondas, neniu plu skanado okazos.<br/>Antaŭe aparato ne devis respondi al ping por Open-AudIT por daŭrigi skani.';
...
$GLOBALS["lang"]['NOTE - For more info on DateTime formats, see'] = 'NOTO - Por pli da informoj pri Datentempo formatoj, vidas';

$GLOBALS["lang"]['NOTE - If you request a downloaded CSV, XML or JSON format (either a single credential, or the complete collection) the actual credential details will be sent. Not the encrypted string, the actual username, password, community string, etc. Any sensitive details are not displayed in the web GUI, but are made available via other formats. To prevent this export a configuration item is available called decrypt_credentials.'] = 'Se vi petas elŝutitan CSV, XML aŭ JSON formaton (aŭ ununuran lunarkon, aŭ la kompletan kolekton) la faktajn submetiĝemajn detalojn estos senditaj. Ne la ĉifrita kordo, la fakta uzantnomo, pasvorton, komunumkordon, ktp. Ĉiuj sentemaj detaloj ne estas elmontritaj en la retejo GUI, sed estas produktitaj haveblaj per aliaj formatoj. Por malhelpi tiun eksporton konfiguracioobjekto estas havebla nomita malkript_credential\'oj.';

$GLOBALS["lang"]['NOTE - The curly brackets in the data filed should be used as-is (not replaced as per other examples above).'] = 'NEE - La kurbaj krampoj en la datenoj arkivitaj devus esti utiligitaj kiel - estas (ne anstataŭigite kiel per aliaj ekzemploj supre).';
...
$GLOBALS["lang"]['Name: The name you are giving to this field. Ideally it should be unique.'] = 'La nomo, kiun vi donas al tiu kampo. Ideale ĝi devus esti unika.';
...
$GLOBALS["lang"]['Netstat Ports use a combination of port number, protocol and program. If all are present the policy passes.'] = 'Netstat Ports uzas kombinaĵon de havennombro, protokolo kaj programo. Se ĉiuj estas la politiko pasas.';
...
$GLOBALS["lang"]['Network type is set to Local Area Network by default, but can be changed by the user as they see fit. The types supported are below (with thanks to Wikipedia).<br><br>A network can be characterized by its physical capacity or its organizational purpose. Use of the network, including user authorization and access rights, differ accordingly.'] = 'Retospeco estas metita al Local Area Network defaŭlte, sed povas esti ŝanĝita fare de la uzanto kiam ili vidas konvulsion. La tipoj apogitaj estas malsupre (kun dank\'al Vikipedio).<br/><br/>Reto povas esti karakterizita per sia fizika kapacito aŭ ĝia organiza celo. Uzo de la reto, inkluzive de uzantrajtigo kaj alirrajtoj, malsamas sekve.';
...
$GLOBALS["lang"]['Networks are updated with every discovery. Items such as IPs Available and IPs Used, along with Gateways, DHCP and DNS Servers are added as found.'] = 'Retoj estas ĝisdatigitaj kun ĉiu eltrovaĵo. Ĝi estas kiel ekzemple IPs Havebla kaj IPs Used, kune kun Gateways, DHCP kaj DNS Servers estas aldonitaj kiel trovite.';

$GLOBALS["lang"]['Networks respond differently depending on how they are configured. Some routers and/or firewalls can respond <i>on behalf</i> of IPs on the other side of their interfaces to the Open-AudIT Server. It is quite common to see Nmap report a probe for SNMP (UDP port 161) to respond as open|filtered for devices that do and do not exist. This is misleading as there is no device at that IP, yet it ends up with a device entry in the database. 99.9% of the time, it is not Open-AudIT, nor even Nmap, but the network causing this issue. Now that we have the options to treat open|filtered ports as either open or closed, we can eliminate a lot of this confusion. Enterprise users even have the option to change this on a per discovery basis (more than just using the Medium (Classic) item, as above).'] = 'Retoj respondas alimaniere depende de kiel ili estas formitaj. Kelkaj itineroj kaj/aŭ fajromuroj povas respondi <i>nomo</i> IPs sur la alia flanko de iliaj interfacoj al la Open-AudIT-Servilo. Estas tre ofte vidi Nmap-raporton enketo por SNMP (UDP-haveno 161) respondi kiel malfermite por aparatoj kiuj faras kaj ne ekzistas. Tio estas misgvida kiam ekzistas neniu aparato ĉe tiu IP, ankoraŭ ĝi finiĝas supren kun aparatoeniro en la datumbazo. 99.9% de la tempo, ĝi ne estas Open-AudIT, nek eĉ Nmap, sed la reto kaŭzanta tiun temon. Nun ke ni havas la opciojn por trakti malfermajn havenojn kiel aŭ malfermaj aŭ fermitaj, ni povas elimini multe da tiu konfuzo. Enterprise uzantoj eĉ havas la opcion por ŝanĝi tion sur per eltrovaĵo bazo (pli ol ĵus uzante la Medium ( Klasika) objekton, kiel supre).';
...
$GLOBALS["lang"]['News checks-in each time you login for updated queries & packages, configuration recommendations, release announcements, blog posts and more.'] = 'Novaĵo kontrolas - en ĉiu tempo vi ensalutas por ĝisdatigitaj demandoj & pakaĵoj, konfiguraciorekomendoj, publikigas proklamojn, blogpostenojn kaj pli.';

$GLOBALS["lang"]['News is our way of keeping you up-to-date with the latest fixes, announcements, query updates, software versions and more.<br><br>You do not need to keep on top of the wiki or check for new releases, we can send these to you!'] = 'Novaĵo estas nia maniero konservi vin ĝisdata kun la plej malfruaj riparoj, proklamoj, query ĝisdatigoj, softvarversioj kaj pli.<br/><br/>Vi ne bezonas teni supre de la Vikio aŭ ĉeko por novaj eldonoj, ni povas sendi tiujn al vi!';
...
$GLOBALS["lang"]['Next click <i>Create your own application</i>.'] = 'Sekva klako <i>Krei vian propran aplikaĵon</i>.';

$GLOBALS["lang"]['Next, click OK, then right click the Apache 2.4 service and click Restart. Done!'] = 'Venonta, klaki OK, tiam dekstra klakas la apaĉo 2.4 servo kaj klak Restart. Dono!';

$GLOBALS["lang"]['Next, right click the Apache2.4 service and select Properties, then click the Log On tab.'] = 'Venonta, dekstra klakas la apaĉ2.4 servon kaj selektas Trajtojn, tiam klakas la Logon sur klako.';
...
$GLOBALS["lang"]['Nmap cannot determine whether the port is open because packet filtering prevents its probes from reaching the port. The filtering could be from a dedicated firewall device, router rules, or host-based firewall software. These ports frustrate attackers because they provide so little information. Sometimes they respond with ICMP error messages such as type 3 code 13 (destination unreachable: communication administratively prohibited), but filters that simply drop probes without responding are far more common. This forces Nmap to retry several times just in case the probe was dropped due to network congestion rather than filtering. This slows down the scan dramatically.'] = 'Nmap ne povas determini ĉu la haveno estas malferma ĉar pakaĵfiltrado malhelpas siajn enketojn atingado de la haveno. La filtrado povus esti de diligenta fajromura aparato, italreguloj, aŭ mastro-bazita fajromuro softvaro. Tiuj havenoj ŝparas atakantojn ĉar ili disponigas tiel malgrandajn informojn. Foje ili respondas kun ICMP erarmesaĝoj kiel ekzemple tipo 3 kodo 13 (destinado neatingebla: komunikado administre malpermesita), sed filtriloj kiuj simple faligas enketojn sen respondado estas multe pli oftaj. Tiuj fortoj Nmap por reeniri plurajn fojojn ĵus en kazo la enketo estis faligita pro sendostacia obstrukciĝo prefere ol filtrado. Tio bremsas la skanadon dramece.';

$GLOBALS["lang"]['Nmap places ports in this state when it is unable to determine whether a port is open or filtered. This occurs for scan types in which open ports give no response. The lack of response could also mean that a packet filter dropped the probe or any response it elicited. So Nmap does not know for sure whether the port is open or being filtered. The UDP, IP protocol, FIN, NULL, and Xmas scans classify ports this way.'] = 'Nmap lokas havenojn en tiu ŝtato kiam estas nekapabla determini ĉu haveno estas malferma aŭ filtrita. Tio okazas por skanaj tipoj en kiuj malfermaj havenoj donas neniun respondon. La manko de respondo ankaŭ povis signifi ke pakaĵfiltrilo faligis la enketon aŭ ajnan respondon ĝi ellogis. Tiel Nmap ne scias por certa ĉu la haveno estas malferma aŭ esti filtrita. La UDP, IP-protokolo, FIN, NULL, kaj Xmas-skanadoj klasifikas havenojn tiun manieron.';

$GLOBALS["lang"]['Nmap timing details are found on the bottom of this linked page'] = 'Nmap tempigas detalojn estas trovitaj sur la fundo de tiu ligita paĝo';
...
$GLOBALS["lang"]['Not every computer will be able to successfully complete a benchmark. We have seen in some fail in testing for reasons beyond our control. The logs should help point you in the right direction for these items.'] = 'Ne ĉiu komputilo povos sukcese kompletigi komparnormon. Ni vidis en kelkaj malsukcesas en testado pro kialoj preter nia kontrolo. La tagaloj devus helpi montri vin en la dekstra direkto por tiuj eroj.';

$GLOBALS["lang"]['Not in the (comma seperated) list'] = 'Ne en la (komma seperated) listo';
...
$GLOBALS["lang"]['Obtain top management support'] = 'Obtain ĉefa administra subteno';

$GLOBALS["lang"]['October'] = 'Oktobro Oktobro Oktobro Oktobro';

$GLOBALS["lang"]['Offset'] = 'Antaŭite';
...
$GLOBALS["lang"]['On Windows, Open-AudIT uses WMI as it is primary method of auditing. Windows has a notorious reputation where remote WMI is concerned. It tends to either <i>just work</i> or some mystery item on the target requires changing. If you are experiencing difficulty auditing remote Windows PCs, we have created a script called test_windows_client.vbs. You can run this script <strong>locally</strong> on the machine in question, after signing on as the user that is used by Open-AudIT to perform the audit. The script makes <strong>no changes</strong> to the target devices. It checks most (not all) of the items below and generates PASS, FAIL and INFO tags for various properties. NOTE - If your target system is being audited correctly, you should not change any settings. Some of the below do not exist on Windows PCs that are able to be audited and some do exist. Only change settings if your discoveries on particular PCs are not working as intended.'] = 'Sur Fenestroj, Open-AudIT utiligas WMI kiam ĝi estas primara metodo de reviziado. Fenestroj havas konatan reputacion kie malproksima WMI estas maltrankvila. Ĝi tendencas aŭ <i>nur funkcias</i> aŭ iu mistera objekto sur la celo postulas ŝanĝi. Se vi spertas malfacilecon reviziantan malproksimajn Fenestrojn, ni kreis manuskripton nomitan testiwindows_client.vbs. Vi povas kuri ĉi tiun skripton <strong>loke</strong> En la maŝino koncernita, post subskribado kiel la uzanto kiu estas utiligita fare de Open-AudIT por elfari la revizion. La manuskripto faras <strong>Neniuj ŝanĝoj</strong> al la celaparatoj. Ĝi kontrolas la plej grandan parton (ne ĉion) de la eroj malsupre kaj generas PASS, FAIL kaj INFO-etikedojn por diversaj trajtoj. Se via celsistemo estas reviziita ĝuste, vi ne devus ŝanĝi iujn ajn agordojn. Kelkaj el la malsupre ne ekzistas sur Fenestroj kiuj povas esti reviziitaj kaj kelkaj ekzistas. Nur ŝanĝvaloroj se viaj eltrovaĵoj sur specialaj Komputiloj ne funkcias kiel celite.';

$GLOBALS["lang"]['On the Tasks List page, click the <i>Add New</i> button to configure a task.'] = 'Sur la Tasks List paĝo, klakas la <i>Aldonu novan</i> Butono por agordi taskon.';

$GLOBALS["lang"]['On the field <i>Match String</i> you should provide the name of the software that you want to track. You can use the percent sign (%) as a wildcard in where required.'] = 'Sur la kampo <i>Match String</i> Vi devas provizi la nomon de la programaro, kiun vi volas spuri. Vi povas uzi la procentan signon (%) kiel sovaĝan karton en kie necese.';

$GLOBALS["lang"]['On the next page you will be able to select Access Keys and see your key or create a new key.'] = 'Sur la sekva paĝo vi povos elekti Alirajn Ŝlosilojn kaj vidi vian ŝlosilon aŭ krei novan ŝlosilon.';

$GLOBALS["lang"]['On the target Windows PC, run the DCOM utility and verify (or set) the below attributes. Start -> Run, Enter DCOMCNFG and press OK. This will open the DCOMCNFG window.'] = 'Sur la celo Windows PC, prizorgas la DCOM-servaĵon kaj konfirmi (aŭ metis) la sub atributojn. Komencu -> Run, Enter DCOMCNFG kaj gazetaro OK. Tio malfermos la DCOMCNFG-fenestron.';

$GLOBALS["lang"]['On the top right (underneath the menu bar) you will see several buttons. These allow you to select another dashboard, set the current dashboard as your homepage (if it is not already) and edit the current dashboard (if you have permission).'] = 'Sur la supra dekstra (sub la menuodrinkejo) vi vidos plurajn butonojn. Tiuj permesas al vi selekti alian daŝtabulon, metis la nunan dashboard kiel via hejmpaĝo (se ĝi ne estas jam) kaj redakti la nunan daŝtabulon (se vi havas permeson).';

$GLOBALS["lang"]['On-Premise, Not Cloud'] = 'On-Premise, Ne Nubo';

$GLOBALS["lang"]['Once an Additional Field has been created it can be used in queries and groups just like any other attribute in the database.'] = 'Post kiam Additional Field estis kreita ĝi povas esti uzita en demandoj kaj grupoj ekzakte kiel iu alia atributo en la datumbazo.';

$GLOBALS["lang"]['Once commented out, your certificate will be validated, but may also fail this validation if you are using self-signed certificates and have not configured your server correctly.'] = 'Post kiam komentite, via atestilo estos konfirmita, sed ankaŭ povas malsukcesi tiun validumadon se vi uzas mem-subskribitajn atestilojn kaj ne formis vian servilon ĝuste.';
...
$GLOBALS["lang"]['Once those initial queries (snmp, ssh, wmi) are complete, if the device is a supported by the audit scripts (Windows, Linux, OSX, AIX, HP-UX, Solaris and ESXi), the correct audit script will be copied to the target and executed. The audit script will self delete upon completion. The result will be stored on the target machine as an XML file. The Open-AudIT server will then retrieve the result file for processing and delete the result file on the target. The location the audit script is copied to on the target device (at least for SSH audits) is configurable by editing the discovery_linux_script_directory config item. By default it is set to /tmp/. This may need changing if /tmp has noexec set. The result file is then processed and the device details updated within Open-AudIT.'] = 'Post kiam tiuj komencaj demandoj (snmp, ssh, wmi) estas kompletaj, se la aparato estas apogita per la reviziomanuskriptoj (Windows, Linukso, OsX, AIX, HP-UX, Solaris kaj ESXi), la ĝusta reviziomanuskripto estos kopiita al la celo kaj efektivigita. La revizio manuskripto mem forigos sur kompletigo. La rezulto estos stokita sur la celmaŝino kiel XML-dosiero. La Open-AudIT-servilo tiam prenos la rezultan dosieron por pretigo kaj forigi la rezultan dosieron sur la celo. La loko kiun la reviziomanuskripto estas kopiita al sur la celaparato (almenaŭ por SSH-revizioj) estas formita redaktante la eltrovaĵo_linux_script_rektan konfigobjekton. defaŭlte ĝi estas metita al /tmp/. Tio povas bezoni ŝanĝi se /tmp havas noexec metitan. La rezulta dosiero tiam estas prilaborita kaj la aparato detaloj ĝisdatigitaj ene de Open-AudIT.';

$GLOBALS["lang"]['Once you click the execute button, Open-AudIT will spawn a process to initiate the discovery and return the user to the discovery details page. The newly spawned process takes the configured discovery options and executes Nmap commands to determine the initial list of IP addresses to be scanned (or queries Active Directory if that type is used). Each IP to be scanned is placed into a queue. Once the initial process has completed (and there are IPs to be scanned in the queue) a number of processes will be spawned to further scan each IP in parallel. This number of processes is configurable in the configuration, edit the attribute <i>queue_limit</i>. By default this is set to 20.'] = 'Post kiam vi klakas la efektivigitan butonon, Open-AudIT generas procezon por iniciati la eltrovaĵon kaj resendi la uzanton al la eltrovo detalpaĝo. La lastatempe generita procezo prenas la formitajn eltrovaĵoelektojn kaj efektivigas Nmap komandojn por determini la komencan liston de IP-adresoj por esti skanitaj (aŭ demandoj Active Directory se tiu tipo estas uzita). Ĉiu IP esti skanita estas metita en atendovicon. Post kiam la komenca procezo kompletigis (kaj ekzistas IPoj por esti skanita en la atendovico) kelkaj procezoj estos generitaj al plu skana ĉiu IP en paralela. Tiu nombro da procezoj estas konfigurebla en la konfiguracio, redakti la atributon. <i>queue_lima</i>. defaŭlte tio estas metita al 20.';
...
$GLOBALS["lang"]['Open-AudIT can be run on your server in your data center. It does not need access to the internet at all. Even the installation on Linux where we use the distribution package manager for our prerequisites can be negated by you using an in-house and security team-approved package repository.<br><br>Open-AudIT does not store any of your data in the cloud. Even licensing information can be provided without having to access the internet from the Open-AudIT server.<br><br>Sure, it is easier to allow it to access the internet to download packages (including security fixes) for your distribution, but that is up to you and your security policies. Open-AudIT does not need the internet.'] = 'Open-Aud Ĝi povas esti prizorgita sur vian servilon en via datumcentro. Ĝi ne bezonas aliron al interreto. Eĉ la instalaĵo sur Linukso kie ni uzas la distribuan pakaĵmanaĝeron por niaj antaŭkondiĉoj povas esti neigitaj per vi uzante endoman kaj sekurecteam-aprobitan pakaĵodeponejon.<br/><br/>Open-Aud Tio ne enhavas iujn ajn da viaj datumoj en la nubo. Eĉ licencadinformoj povas esti disponigitaj sen devi aliri la Interreton de la Open-AudIT-servilo.<br/><br/>Certe, estas pli facile permesi al ĝi aliri la Interreton por elŝuti pakaĵojn (inkluzive de sekureco fiksas) por via distribuo, sed tio estas ĝis vi kaj via sekureco politikoj. Open-AudIT ne bezonas la interreton.';

$GLOBALS["lang"]['Open-AudIT can download, parse and use NIST CVE Vulnerability reports.'] = 'Open-AudIT povas elŝuti, parse kaj uzi NIST CVE Vulnerability raportoj.';

$GLOBALS["lang"]['Open-AudIT can show in one of several languages. How you can improve this?'] = 'Open-Aud Ĝi povas montri en unu el pluraj lingvoj. Kiel vi povas plibonigi tion?';

$GLOBALS["lang"]['Open-AudIT can store information in additional fields that are associated with each device.'] = 'Open-Aud Ĝi povas stoki informojn en kromaj kampoj kiuj estas rilataj al ĉiu aparato.';

$GLOBALS["lang"]['Open-AudIT can use Microsoft Entra (previously known as Microsoft Azure Active Directory) as an authentication method. This means your user in Open-AudIT can click the Logon using Entra button on the logon page and use their Entra credentials to logon. That user will need to already exist within Open-AudIT (and be assigned'] = 'Open-AudIT povas uzi Microsoft Entra (antaŭe konata kiel Microsoft Azure Aktiva Adresaro) kiel aŭtentikmetodo. Tio signifas vian uzanton en Open-AudIT povas klaki la Logon uzantan Entra butonon sur la logon paĝo kaj uzi iliajn Entra akreditaĵojn al logon. Tiu uzanto devas jam ekzisti ene de Open-AudIT (kaj esti asignita)';

$GLOBALS["lang"]['Open-AudIT can use OKTA as an authentication method. This means your user in Open-AudIT can click the Logon using OKTA button on the logon page and use their OKTA credentials to logon. That user will need to already exist within Open-AudIT (and be assigned Roles and Orgs), but will not need to remember a separate set of logon credentials.'] = 'Open-AudIT povas utiligi OKTA kiel aŭtentikmetodon. Tio signifas vian uzanton en Open-AudIT povas klaki la Logon uzantan OKTA butonon sur la logon paĝo kaj uzi iliajn OKTA akreditaĵojn al logon. Tiu uzanto devos jam ekzisti ene de Open-AudIT (kaj esti asignita Roloj kaj Orgs), sed ne devas memori apartan aron de emblemaj akreditaĵoj.';

$GLOBALS["lang"]['Open-AudIT comes with many queries inbuilt. If you require a specific query and none of the pre-packaged queries fit your needs, it is quite easy to create a new one and load it into Open-AudIT for running.'] = 'Open-AudIT venas kun multaj demandoj enkonstruitaj. Se vi postulas specifan atendon kaj neniu el la antaŭ-pakitaj demandoj konvenas viajn bezonojn, estas tre facile krei novan kaj ŝarĝi ĝin en Open-AudIT por kurado.';
...
$GLOBALS["lang"]['Open-AudIT has a granular permissions system to determine what a user within Open-AudIT can do, and the items he can do it to. Open-AudIT can be entirely self-contained, or use Active Directory or OpenLDAP for authentication and/or authorization.<br><br>It is entirely up to the administrator of Open-AudIT how they would like the Role Based Access Control to work.'] = 'Open-Aud Tio havas grajnecan permeson sistemon determini kion uzanto ene de Open-AudIT povas fari, kaj la eroj li povas fari ĝin. Open-AudIT povas esti totale mem-konservita, aŭ uzi Aktivan Adresaron aŭ OpenLDAP por konfirmo kaj/aŭ aprobo.<br/><br/>Ĝi estas tute supren al la administranto de Open-AudIT kiel ili ŝatus la Rolo Bazita Aliro-Kontrolo por labori.';
...
$GLOBALS["lang"]['Open-AudIT needs specific directory permissions to be able to create files, upload results, etc. Please set as below.'] = 'Open-Aud Ĝi bezonas specifajn adresarpermesojn povi krei dosierojn, alŝuti rezultojn, ktp. Bonvolu sidiĝi.';

$GLOBALS["lang"]['Open-AudIT provides many built-in queries and makes it simple to create your own.'] = 'Open-AudIT disponigas multajn enkonstruitajn demandojn kaj igas ĝin simpla krei vian propran.';

$GLOBALS["lang"]['Open-AudIT ships with inbuilt roles for admin, org_admin and user.<br><br>Generally, a user who is an administrator of the Open-AudIT application itself should have admin and possible org_admin roles.<br><br>A user can have multiple roles. The permission will be applied at the most permissive level - IE, if a user has the roles of user and org_admin, they will be able to create locations because org_admin grants this permission, even though the user role does not.<br><br>The admin role allows access to collections such as configuration, database, groups, ldap servers, logs, queries and roles. Global items that affect the entire application.<br><br>The org_admin role usually allows create, read, update and delete actions for any collection that contains the org_id column. Virtually all data except some of the collections mentioned above will contain an <code>org_id</code> column.<br><br>The user role generally allows read only access to all items with an org_id column.'] = 'Open-Aud IT-ŝipoj kun enkonstruitaj roloj por admin, org_admin kaj uzanto.<br/><br/>Ĝenerale, uzanto kiu estas administranto de la Open-AudIT-aplikaĵo mem devus havi admin kaj eblajn org_admin rolojn.<br/><br/>uzanto povas havi plurajn rolojn. La permeso estos surŝmirita sur la plej permisiva nivelo - IE, se uzanto havas la rolojn de uzanto kaj org_admin, ili povos krei lokojn ĉar org_admin donas tiun permeson, eĉ se la uzantrolo ne faras.<br/><br/>La admin rolo permesas aliron al kolektoj kiel ekzemple konfiguracio, datumbazo, grupoj, ldap serviloj, tagaloj, demandoj kaj roloj. Tutmondaj eroj kiuj influas la tutan aplikon.<br/><br/>La org_admin rolo kutime permesas krei, legi, ĝisdatigi kaj forigi agojn por iu kolekto kiu enhavas la org_id kolonon. Praktike ĉiuj datenoj krom kelkaj el la kolektoj menciitaj supre enhavos <code>org_id</code> kolono.<br/><br/>La uzantrolo ĝenerale permesas legi nur aliron al ĉiuj eroj kun org_id kolono.';

$GLOBALS["lang"]['Open-AudIT ships with inbuilt roles for admin, org_admin and user.<br><br>Generally, a user who is an administrator of the Open-AudIT application itself should have admin and possible org_admin roles.<br><br>A user can have multiple roles. The permission will be applied at the most permissive level - IE, if a user has the roles of user and org_admin, they will be able to create locations because org_admin grants this permission, even though the user role does not.<br><br>The admin role allows access to collections such as configuration, database, groups, ldap servers, logs, queries and roles. Global items that affect the entire application.<br><br>The org_admin role usually allows create, read, update and delete actions for any collection that contains the org_id column. Virtually all data except some of the collections mentioned above will contain an org_id column.<br><br>The user role generally allows read only access to all items with an org_id column.'] = 'Open-Aud IT-ŝipoj kun enkonstruitaj roloj por admin, org_admin kaj uzanto.<br/><br/>Ĝenerale, uzanto kiu estas administranto de la Open-AudIT-aplikaĵo mem devus havi admin kaj eblajn org_admin rolojn.<br/><br/>uzanto povas havi plurajn rolojn. La permeso estos surŝmirita sur la plej permisiva nivelo - IE, se uzanto havas la rolojn de uzanto kaj org_admin, ili povos krei lokojn ĉar org_admin donas tiun permeson, eĉ se la uzantrolo ne faras.<br/><br/>La admin rolo permesas aliron al kolektoj kiel ekzemple konfiguracio, datumbazo, grupoj, ldap serviloj, tagaloj, demandoj kaj roloj. Tutmondaj eroj kiuj influas la tutan aplikon.<br/><br/>La org_admin rolo kutime permesas krei, legi, ĝisdatigi kaj forigi agojn por iu kolekto kiu enhavas la org_id kolonon. Praktike ĉiuj datenoj krom kelkaj el la kolektoj menciitaj supre enhavos org_id kolonon.<br/><br/>La uzantrolo ĝenerale permesas legi nur aliron al ĉiuj eroj kun org_id kolono.';

$GLOBALS["lang"]['Open-AudIT ships with several pre-configured Dashboards. If you are a Professional user, you can select between two of these and set it as your default page when you logon. If you are an Enterprise user, you can not only select between the five preconfigured Dashboards, but you also have the ability to create your own.'] = 'Open-AudIT-ŝipoj kun pluraj antaŭ-konfiguritaj Dashboards. Se vi estas Profesia uzanto, vi povas elekti inter du el tiuj kaj meti ĝin kiel via defaŭlta paĝo kiam vi logon. Se vi estas Enterprise uzanto, vi ne povas nur selekti inter la kvin antaŭkonfiguritaj Dashboards, sed vi ankaŭ havas la kapablon krei vian propran.';

$GLOBALS["lang"]['Open-AudIT should be installed on 64bit Windows <strong>Server</strong> systems only. Windows 10 and Windows 11 are <strong>not</strong> supported.'] = 'Open-AudIT devus esti instalita sur 64b Fenestroj <strong>Servilo</strong> nur sistemoj. Windows 10 kaj Vindozo 11 estas <strong>ne ne ne</strong> apogis.';

$GLOBALS["lang"]['Open-AudIT uses Nmap in its Discovery function. Nmap probes devices for open ports. Devices ideally should respond with open for working ports. Devices often do not respond with this. The varying responses are detailed below.'] = 'Open-AudIT uzas Nmap en ĝia Discovery-funkcio. Nmap probes aparatoj por malfermaj havenoj. Devices ideale devus respondi kun malferma por laborhavenoj. Ofte oni ne respondas al tio. La ŝanĝiĝantaj respondoj estas detalaj malsupre.';

$GLOBALS["lang"]['Open-AudIT uses Nmap in its Discovery function. Without Nmap, Open-AudIT will not function correctly. Every Open-AudIT install assumes Nmap is installed and will also test for it on the Discovery web pages. More information about Open-AudIT and Nmap is available here'] = 'Open-AudIT uzas Nmap en ĝia Discovery-funkcio. Sen Nmap, Open-AudIT ne funkcios ĝuste. Ĉiu Open-AudIT-instalaĵo supozas Nmap estas instalita kaj ankaŭ testos por ĝi sur la Discovery retpaĝoj. Pli da informoj pri Open-AudIT kaj Nmap estas haveblaj ĉi tie';

$GLOBALS["lang"]['Open-AudIT uses Nmap in its Discovery function. Without Nmap, Open-AudIT will not function correctly. Every Open-AudIT install assumes Nmap is installed and will test for it on the Discovery web pages.'] = 'Open-AudIT uzas Nmap en ĝia Discovery-funkcio. Sen Nmap, Open-AudIT ne funkcios ĝuste. Ĉiu Open-AudIT-instalaĵo supozas Nmap estas instalita kaj testos por ĝi sur la Discovery retpaĝoj.';

$GLOBALS["lang"]['Open-AudIT uses credentials to access your devices. These are encrypted and stored, just as you would expect.'] = 'Open-Aud Ĝi uzas akreditaĵojn por aliri viajn aparatojn. Tiuj estas ĉifritaj kaj stokitaj, ekzakte kiam vi atendus.';

$GLOBALS["lang"]['Open-AudIT was written by an English speaking Australian. Everything in the application uses English wording. However Open-AudIT has always supported multiple languages for display. These translations are not always correct, because the developers do not natively speak the language of every translation offered.<br><br>What can you do if something is not correct in the translation?'] = 'Open-AudIT estis skribita fare de anglalingva aŭstraliano. Ĉio en la apliko uzas anglan vortigon. Open-AudIT ĉiam apogis multoblajn lingvojn por ekrano. Tiuj tradukoj ne estas ĉiam ĝustaj, ĉar la programistoj ne indiĝene parolas la lingvon de ĉiu traduko ofertis.<br/><br/>Kion vi povas fari se io ne estas ĝusta en la traduko?';
...
$GLOBALS["lang"]['Option #1 - Change the data'] = 'Elekto 1 Ŝanĝi la datumojn';

$GLOBALS["lang"]['Option #2 - Change the translation file'] = 'Opcio numero 2 - Ŝanĝo la traduko dosiero';

$GLOBALS["lang"]['Optional Agent Based Auditing'] = 'Opcia agento Bazita Auditing';
...
$GLOBALS["lang"]['Orgs in Open-AudIT are a key item. A user has a primary Org as well as a list of Orgs they can access. A user combines this with a list of assigned roles that define what actions they can take on items assigned to the Orgs they have access to. The combination of a users <i>orgs</i> and <i>roles</i> define what they can and cannot do within Open-AudIT.<br><br>Most items in Open-AudIT are assigned to an Org. Devices, Locations, Networks, etc, etc.<br><br>Orgs can have child Orgs. Think of an organisational chart (tree) structure. If a user has access to a specific Org, most of the time (not always) they also have access to that Orgs descendants.'] = 'Orgs en Open-AudIT estas esenca objekto. Uzantoj havas primaran Org same kiel liston de Orgs kiun ili povas aliri. uzanto kombinas tion kun listo de asignitaj roloj kiuj difinas kiujn agojn ili povas akcepti erojn asignitajn al la Orgs kiujn ili havas aliron al. La kombinaĵo de uzantoj <i>orgoj</i> kaj <i>rolojn</i> difinas kion ili povas kaj ne povas fari ene de Open-AudIT.<br/><br/>La plej multaj eroj en Open-AudIT estas asignitaj al Org. Devices, Lokoj, Retoj, ktp.<br/><br/>Orgoj povas havi infanon Orgs. Pensu pri organiza diagramo (arbo) strukturo. Se uzanto havas aliron al specifa Org, la plej granda parto de la tempo (ne ĉiam) ili ankaŭ havas aliron al tiu Orgs posteuloj.';
...
$GLOBALS["lang"]['Our default Integration also enables a discovery on any externally supplied devices. So we ship a default discovery for the Default Integration out of the box. These use the default matching rules, but also enable matching on IP address.'] = 'Nia defaŭlta Integriĝo ankaŭ ebligas malkovron sur iuj ekstere provizitaj aparatoj. Tiel ni ekspedis defaŭltan eltrovaĵon por la Default Integration for el la kesto. Tiuj uzas la defaŭltajn egalajn regulojn, sed ankaŭ ebligas egalan IP-adreson.';

$GLOBALS["lang"]['Our examples will use the <i>type</i> column.'] = 'Niaj ekzemploj uzos la <i>tipo tipo tipo tipo</i> kolono.';

$GLOBALS["lang"]['Our framework uploads files here for processing, then deletes them. Think submitted audit results, etc.'] = 'Nia kadro alŝutas dosierojn ĉi tie por prilaborado, tiam forigas ilin. Pensu pri revizio rezultoj, ktp.';

$GLOBALS["lang"]['Our goal with the initial integrations release was specifically for NMIS to Open-AudIT integration to <i>just work</i>. If you are using the programs on Linux, you can literally click a single button to execute the integration. Nothing more is required. Having said that, the integration itself is extremely configurable - so if something is not to your preference, it can easily be changed.'] = 'Nia celo kun la komencaj integriĝoj estis specife por NMIS al Open-AudIT integriĝo al Open-AudIT <i>nur funkcias</i>. Se vi uzas la programojn sur Linukso, vi povas laŭvorte klaki unu butonon por efektivigi la integriĝon. Nenio pli estas bezonata. Diris ke, la integriĝo mem estas ekstreme fleksebla - tiel se io ne estas al via prefero, ĝi povas facile esti ŝanĝita.';

$GLOBALS["lang"]['Our new feature called Vulnerabilities gives you the ability to quickly determine if any devices are affected by any CVE (Common Vulnerability Exposure) - but how?<br><br>FirstWave constantly consumes the output from the Nist NVD feed. We take this and apply a few restrictions, then extract the affected programs and build a SQL query for reporting. Your Open-AudIT instance reaches out to FirstWave and requests any new vulnerabilities on a regular basis. When it receives a new vulnerability record, it is run against the database and the result stored. Each time a device is processed, all matching vulnerabilities are again executed and the result stored. This means when viewing a vulnerability list, we do not need to calculate all affected devices - we already have the result. When you view an individual vulnerability record, we do indeed recalculate the result for this singular vulnerability.<br><br>So, you are always up to date!<br><br>In addition to this, we also calculate the result of all vulnerabilities for all devices daily (usually at a quiet time, say 2am).<br><br>In your instance of Open-AudIT, we allow you to select which vendors you care about. i.e. there is no use retrieving vulnerability records from a vendor whose software you do not use or have installed. By default, our vendor list is Adobe, Apple, Cisco, Google, Microsoft, Mozilla, and Redhat.<br><br>This all sounds very simple, but behind the scenes a <b>lot</b> is going on. For instance, the CVE record contains a list of affected software - but those software names do not match what we receive when we audit a computer. A good example is Apache. Typically, a CVE record will say the affected software is http_server. In reality, this appears as apache2 (Ubuntu), httpd (Redhat), Apache HTTP Server (Windows) - and others. So, we have to first determine what is the actual name of the program we receive when we ask a computer, and there may be multiple names. After that we must parse the CVE record and create a matching SQL statement. Allowing for multiple program names as above, and multiple versions, version ranges, and even multiple different pieces of software (an example is Thunderbird and Firefox in a single CVE). And your instance of Open-AudIT must take this and apply Orgs filtering as well. And that is just a single CVE. What about determining which CVEs you have and do not have? What about adding a vendor to the list later? So many things to consider!<br><br>As well as the usual reporting, we also have a few new widgets available for Dashboards, based on Vulnerabilities data.'] = 'Nia nova trajto nomita Vulnerabilities donas al vi la kapablon rapide determini ĉu iuj aparatoj estas trafitaj fare de iu CVE (Komuna Vulnerability Exposure) - sed kiel?<br/><br/>FirstWave konstante konsumas la produktaĵon de la Nist NVD-sendo. Ni prenas tion kaj aplikas kelkajn restriktojn, tiam eltiras la trafitajn programojn kaj konstruas SQL-demandon por raportado. Via Open-AudIT-kazo atingas al FirstWave kaj petas iujn novajn vundeblecojn sur regula bazo. Kiam ĝi ricevas novan vundeblecon, ĝi estas prizorgita kontraŭ la datumbazo kaj la rezulto stokita. Ĉiun fojon aparato estas prilaborita, ĉiuj egalaj vundeblecoj denove estas efektivigitaj kaj la rezulto stokita. Tio signifas dum spektado de vundeblecolisto, ni ne bezonas kalkuli ĉiujn trafitajn aparatojn - ni jam havas la rezulton. Kiam vi rigardas individuan vundeblecon, ni efektive rekalkulis la rezulton por tiu eksterordinara vundebleco.<br/><br/>Vi ĉiam estas ĝis nun!<br/><br/>Aldone al tio, ni ankaŭ kalkulas la rezulton de ĉiuj vundeblecoj por ĉiuj aparatoj ĉiutage (kutime en trankvila tempo, diras 2am).<br/><br/>En via kazo de Open-AudIT, ni permesas al vi selekti kiu vendistoj vi zorgas. I.e. ekzistas neniu uzo prenante vundeblecodiskojn de vendisto kies softvaro vi ne uzas aŭ instalis. defaŭlte, nia vendisto listo estas Adobe, Apple, Cisco, Google, Mikrosofto, Mozilla, kaj Redhat.<br/><br/>Ĉio sonas tre simpla, sed malantaŭ la scenoj <b>Multe multe</b> Iru. Ekzemple, la CVE rekordo enhavas liston de trafita softvaro - sed tiuj softvarnomoj ne egalas kion ni ricevas kiam ni revizias komputilon. Bona ekzemplo estas Apache. Tipe, CVE rekordo diros ke la trafita softvaro estas http_server. Fakte, tio prezentiĝas kiel apache2 (Ubuntu), httpd (Redhat), Apache HTTP Server (Windows) - kaj aliaj. Ni devas unue determini kio estas la fakta nomo de la programo kiun ni ricevas kiam ni demandas komputilon, kaj povas ekzisti multoblaj nomoj. Post tio ni devas analizi la CVE-rekordon kaj krei egalan SQL-deklaron. Permesado por multoblaj programnomoj kiel supre, kaj multoblaj versioj, versio intervalas, kaj eĉ multoblaj malsamaj pecoj de softvaro (ekzemplo estas Thunderbird kaj Firefox en ununura CVE). Kaj via kazo de Open-AudIT devas preni tion kaj apliki Orgs filtradon ankaŭ. Kaj tio estas nur ununura CVE. Kion vi havas kaj ne havas? Kion aldoni vendiston al la listo poste? Multaj aferoj por pripensi!<br/><br/>Same kiel la kutima raportado, ni ankaŭ havas kelkajn novajn widgets haveblajn por Dashboards, surbaze de Vulnerabilities datenoj.';
...
$GLOBALS["lang"]['PAExec is a freely-redistributable re-implementation of SysInternal/Microsofts popular PsExec program.  PAExec aims to be a drop in replacement for PsExec, so the command-line usage is identical, with additional options also supported.  This work was originally inspired by Talha Tariqs RemCom.'] = 'PAExec estas libere-redistribuebla re-efektivigo de Sys Internal/Microsofts populara PsExec-programo. PAExec planas esti falo en anstataŭaĵo por PsExec, tiel ke la komandliniouzokutimo estas identa, kun kromaj opcioj ankaŭ apogis. Tiu laboro estis origine inspirita fare de Talha Tariqs RemCom.';
...
$GLOBALS["lang"]['Packages are used to report on things such as <i>banned software</i>, AntiVirus on servers, etc.<br><br>Open-AudIT provides widgets that build upon also supplied repots to detemine the status of antivirus, firewall and other software.'] = 'Pakaĵoj kutimas raporti pri aĵoj kiel ekzemple <i>malpermesita programaro</i>AntiVirus sur serviloj, ktp.<br/><br/>Open-AudIT disponigas widgets kiuj konstruas sur ankaŭ provizitaj ripozoj por krevigi la statuson de antivirus, fajromuro kaj alia softvaro.';
...
$GLOBALS["lang"]['Pie charts must return name or my_name, description or my_description and count.'] = 'Pie-furorlisto devas resendi nomon aŭ My_name, priskribon aŭ mispriskribon kaj kalkulon.';
...
$GLOBALS["lang"]['Please log in and change these ASAP.'] = 'Bonvolu ensaluti kaj ŝanĝi tiujn ASAP.';

$GLOBALS["lang"]['Please log on to the Open-AudIT Server (either Windows or Linux) and run <code>nslookup IP_ADDRESS_OF_TARGET</code> in the command prompt or shell. It must be able to resolve the IP to a name.'] = 'Bonvolu ensaluti al la Open-AudIT-Servilo (aŭ Fenestroj aŭ Linukso) kaj kuri <code>nslookup IP_ADDRESS_OF_TARGET</code> En la komanda promptilo aŭ ŝelo. Ĝi povas solvi la IP al nomo.';
...
$GLOBALS["lang"]['Please send all three files to your support contact at Opmantek and describe your issue.'] = 'Bonvolu sendi ĉiujn tri dosierojn al via subteno kontakto ĉe Opmantek kaj priskribi vian temon.';

$GLOBALS["lang"]['Please set using'] = 'Bonvolu agordi uzante';

$GLOBALS["lang"]['Please visit the homepage at'] = 'Bonvolu viziti la hejmpaĝon ĉe';
...
$GLOBALS["lang"]['Portuguese (Brazil)'] = 'Portugala (Brazilo)';
...
$GLOBALS["lang"]['Prepare for recertification every 3 years'] = 'Preparu ĉiujn 3 jarojn';
...
$GLOBALS["lang"]['Privacy Protocol'] = 'Private Protocol';
...
$GLOBALS["lang"]['Proprietary. If you want to modify HighCharts you may require a'] = 'Proprietary. Se vi volas modifi Altajn Katojn vi povas postuli';

$GLOBALS["lang"]['Protects confidentiality, integrity, and availability of information'] = 'Protektas konfidencon, integrecon, kaj haveblecon de informoj';

$GLOBALS["lang"]['protocol'] = 'Protokolo de Protokolo';

$GLOBALS["lang"]['Protocol'] = 'Protokolo de Protokolo';

$GLOBALS["lang"]['Provide a description and select and expires duration.'] = 'Disponigi priskribon kaj selekti kaj eksvalidiĝas tempodaŭron.';

$GLOBALS["lang"]['Provide a name - we humbly recommand Open-AudIT &#128512;, but you can name it anything you like.<br>From the Open-AudIT form, copy the value for the <i>Redirect URI</i> field and paste it into the <i>Sign-in redirect URIs</i> field in OKTA.<br>The Sign-out redirect URIs is optional, but if you want you can use open-audit/index.php/logout with your Open-AudIT servers http address, as per the screenshot.<br>Normally your Open-AudIT URL will look something like'] = 'Ni humile rekomando Open-AudIT 😀<br/>De la Open-AudIT-formularo, kopias la valoron por la <i>Konsilu URI</i> kampo kaj pasto ĝi en la <i>Sign-in redirektas URIojn</i> kampo en OKTA.<br/>La signo-eliro redirektas URIojn estas laŭvola, sed se vi deziras ke vi povas uzi malferma-audit/index. php/logo kun via Open-AudIT-serviloj http adreso, kiel per la ekranpafo.<br/>Normale via Open-AudIT URL rigardos ion kiel';

$GLOBALS["lang"]['Provided you have the correct credentials, Device Seed Discovery works as follows'] = 'Seed Discovery funkcias kiel sekvas';
...
$GLOBALS["lang"]['Queries are an important part of Open-AudIT. They are what enables you to get meaningful information from all the device data you have discovered. Along with summaries and groups, they provide a powerful mechanism to extract crucial information.'] = 'Queries estas grava parto de Open-AudIT. Ili estas kio rajtigas vin ricevi senchavajn informojn de ĉiuj aparatoj kiujn vi malkovris. Kune kun resumoj kaj grupoj, ili disponigas potencan mekanismon eltiri decidajn informojn.';

$GLOBALS["lang"]['Queries for Groups should select only the'] = 'Queries por grupoj devus selekti nur la';

$GLOBALS["lang"]['Query'] = 'Query';

$GLOBALS["lang"]['Query this Active Directory attribute first to determine the users work unit.'] = 'Query tiu Aktiva Adresaro unue atribuas al la uzantoj laborunuon.';

$GLOBALS["lang"]['Query this Active Directory attribute second to determine the users work unit.'] = 'Query tiu Aktiva Adresaro atribuas sekundon por determini la uzantojn laborunuon.';
...
$GLOBALS["lang"]['Rack Management and Reporting'] = 'Rack Management kaj Reporting';
...
$GLOBALS["lang"]['Repeat until you have a completely discovered and audited Windows PC.'] = 'Ripetu ĝis vi havas tute malkovritan kaj reviziitan Windows PC.';
...
$GLOBALS["lang"]['Request Vulnerability'] = 'Petu Vulnerability';
...
$GLOBALS["lang"]['Retrieve a list of devices in the'] = 'Retrieve listo de aparatoj en la';

$GLOBALS["lang"]['Retrieve a list of devices with OS Name like Windows 2008'] = 'Retrieve listo de aparatoj kun Os Name kiel Fenestroj 2008';

$GLOBALS["lang"]['Retrieve all details about the device with id 88.'] = 'Ĉiuj detaloj pri la aparato kun id 88.';

$GLOBALS["lang"]['Retrieve all devices running Windows.'] = 'Ĉiuj aparatoj kurante fenestrojn.';

$GLOBALS["lang"]['Retrieve all devices with the standard columns'] = 'Ĉiuj aparatoj kun la normaj kolonoj';

$GLOBALS["lang"]['Retrieve the first 10 devices running Windows ordered by hostname'] = 'Retrieve la unuaj 10 aparatoj prizorgantaj Fenestrojn ordonitajn fare de mastro-nomo';

$GLOBALS["lang"]['Retrieve the properties id, ip, hostname, domain, type from all devices'] = 'Retrieve la trajtoj id, ip, mastronomo, domajno, tipo de ĉiuj aparatoj';
...
$GLOBALS["lang"]['Retrieving a List of Credentials'] = 'Retrievante Liston de Credentials';

$GLOBALS["lang"]['Retrieving or Creating'] = 'Retrieving aŭ Kreado';

$GLOBALS["lang"]['Return a collection of devices with the default set of columns (devices.id, devices.icon, devices.type, devices.name, devices.ip, devices.dns_fqdn, devices.identification, devices.description, devices.manufacturer, devices.os_family, devices.status)'] = 'Reveno kolekto de aparatoj kun la defaŭlta aro de kolonoj ( devices.id, aparatoj.icon, aparatoj. tipo, aparatoj.name, aparatoj.ip, aparatoj.dns_fqdn, aparatoj.identification, aparatoj.priskribo, aparatoj.manufacturer, aparatoj.os_familio, aparatoj.status)';
...
$GLOBALS["lang"]['Review current practices against ISO 27001 requirements'] = 'Revizio aktualaj praktikoj kontraŭ ISO 27001 postuloj';
...
$GLOBALS["lang"]['Risk Management'] = 'Riska administrado';
...
$GLOBALS["lang"]['Roles can only be created and edited if you have an Open-AudIT Enterprise license. For most users, the default set of Roles should be all that is required.'] = 'Roloj povas nur esti kreitaj kaj redaktitaj se vi havas Open-AudIT Enterprise licencon. Por la plej multaj uzantoj, la defaŭlta aro de Roloj devus esti ĉiu kiu estas postulata.';
...
$GLOBALS["lang"]['SAN Auto-Discover'] = 'SAN Aŭto-distro';
...
$GLOBALS["lang"]['SQL not containing this condition will result in the widget failing to be executed.'] = 'SQL ne enhavanta tiun kondiĉon rezultigos la draĝon malsukcesantan esti efektivigita.';
...
$GLOBALS["lang"]['Save and run the file. Make sure you run the file as an Administrator in order to install it (right click, Run as Administrator).'] = 'savi kaj prizorgi la dosieron. Certigu ke vi prizorgas la dosieron kiel administranto por instali ĝin (dekstra klako, Run kiel administranto).';

$GLOBALS["lang"]['Save as Default'] = 'Eviti kiel Defaŭl';

$GLOBALS["lang"]['Save the downloaded file.'] = 'Evitu la elŝutitan dosieron.';
...
$GLOBALS["lang"]['Scheduling - discovery, reporting &amp; more'] = 'Scheduling - eltrovaĵo, raportado kaj pli';

$GLOBALS["lang"]['scope'] = 'Scope';

$GLOBALS["lang"]['Scope'] = 'Scope';

$GLOBALS["lang"]['Scope is known as Authorization Scope, representing whether a vulnerability affects resources beyond the original security authority of the vulnerable component.<br><br>The only two valid values for this attribute are'] = 'Scope estas konata kiel Authorization Scope, reprezentante ĉu vundebleco influas resursojn preter la origina sekurecadminstracio de la vundebla komponento.<br/><br/>La nuraj du validaj valoroj por tiu atributo estas';
...
$GLOBALS["lang"]['See above. NOTE - This could also be caused by a self-signed certificate on the LDAP server. We are working to allow for this in a future release.'] = 'Vidu supre. Tio ankaŭ povus esti kaŭzita de mem-subskribita atestilo sur la LDAP-servilo. Ni laboras por permesi tion en estonta liberigo.';

$GLOBALS["lang"]['See our page on enabling'] = 'Vidu nian paĝon ebliga';
...
$GLOBALS["lang"]['Select Admin -> Tasks -> Create Task from the menu.'] = 'Elekti Admin -> Taskoj -> Krei Tasko de la menuo.';

$GLOBALS["lang"]['Select All'] = 'Elektu ĉiujn';

$GLOBALS["lang"]['Select All Devices'] = 'Elekti ĉiujn aparatojn';
...
$GLOBALS["lang"]['Select Menu -> Manage -> Baselines -> List Baselines.'] = 'Elektu menuon -> Manaĝo -> Bazlinioj -> List Baselines.';

$GLOBALS["lang"]['Select a Table'] = 'Elektu tablon';

$GLOBALS["lang"]['Select an accredited certification body'] = 'Elekti akreditan atestadon';

$GLOBALS["lang"]['Select and apply appropriate controls (Annex A)'] = 'Elekti kaj apliki konvenajn kontrolojn ( Annex A)';

$GLOBALS["lang"]['Select the <i>COM Security</i> tab<br><br>Click on Access Permissions Edit Default'] = 'Elektu la <i>COM Sekureco</i> klaĉla klaĉla klako<br/><br/>Klaku sur Aliro Permissions Edit Defaŭlta';

$GLOBALS["lang"]['Select the <i>Sign On</i> tab and copy the value for <i>Issuer</i> (just the URL itself). Paste this into the Open-AudIT <i>Issuer</i> field.'] = 'Elektu la <i>Signo sur</i> Alklaku kaj kopii la valoron por <i>Issuer</i> (La URL mem). En la malferma-AudIT <i>Issuer</i> kampo.';

$GLOBALS["lang"]['Select the <i>This Account</i> checkbox and provide the account name and password.'] = 'Elektu la <i>Ĉi tiu konto</i> Kontrolu skatolo kaj provizas la konto nomo kaj pasvorton.';

$GLOBALS["lang"]['Select the Start menu and type <i>services<.i>. Click the Services icon.'] = 'Elekti la Komencan menuon kaj tipon <i>La servoj<.i>. Klaku la Servoj ikono.</i>';
...
$GLOBALS["lang"]['Self Delete'] = 'Memo Delete';
...
$GLOBALS["lang"]['Set by the audit_domain or discover_domain scripts. Do not set.'] = 'Metite fare de la revizoro aŭ malkovri_domain manuskriptoj. Ne metu.';
...
$GLOBALS["lang"]['Shipped are a set of default items. These can be found by going to menu'] = 'Shipped estas aro de defaŭltaj eroj. Tiuj povas esti trovitaj irante al menuoj';
...
$GLOBALS["lang"]['Should we audit a SAN if the management software is detected.'] = 'Se la administra programaro estas detektita.';

$GLOBALS["lang"]['Should we audit mount points.'] = 'Ĉu ni reviziu la punktojn.';

$GLOBALS["lang"]['Should we audit netstat ports (yes, no, servers only).'] = 'Se ni reviziu retstat havenojn (jes, neniuj, serviloj nur).';
...
$GLOBALS["lang"]['Should we hide the audit script window when executing.'] = 'Se ni kaŝu la aŭditorian fenestron kiam oni ekzekutas.';

$GLOBALS["lang"]['Should we ignore an invalid or self signed SSL certificate and submit the result anyway.'] = 'Se ni ignorus malvalidan aŭ mem subskribis SSL atestilon kaj submetas la rezulton ĉiuokaze.';
...
$GLOBALS["lang"]['Should we retrieve all DNS names'] = 'Ni prenu ĉiujn nomojn';
...
$GLOBALS["lang"]['Should we use the system or user level proxy to submit the audit result.'] = 'Se ni uzu la sistemon aŭ uzantnivelan anstataŭanton por alsendi la reviziorezulton.';
...
$GLOBALS["lang"]['So a script is not working on a recalcitrant device. Grrr. The scripts for Windows, Linux, and MacOS all accept the debugging argument. This can be set in the script itself, or provided on the command line. Run the script using that option set to 5 and you should see in which section of the script the failure occurs. For example'] = 'Tiel manuskripto ne laboras pri recalcitrant aparato. Grrr. La manuskriptoj por Fenestroj, Linukso, kaj MacOS ĉiuj akceptas la malkonstruan argumenton. Tio povas esti metita en la manuskripton mem, aŭ disponigita sur la komandlinio. Run la manuskripto uzanta tiun opcion metitan al 5 kaj vi devus vidi en kiu sekcio de la manuskripto kiun la fiasko okazas. Ekzemple';

$GLOBALS["lang"]['So apart from a regular word, what other options are there - I am glad you asked! As per the standard Open-AudIT API, we have several operators for filtering. Operators that can precede the value are'] = 'Krom regula vorto, kion aliaj opcioj estas tie - mi ĝojas ke vi demandis! Kiel per la norma Open-AudIT API, ni havas plurajn funkciigistojn por filtrado. Operatoroj kiuj povas antaŭi la valoron estas';

$GLOBALS["lang"]['So you have an issue providing Open-AudIT credentials to discover your devices. I have an answer - dont then! Sure, I mean, discovery is the best thing since sliced bread. You do not need to know ahead of time <i>Whats On Your Network</i>. But how can you extract data from devices without providing credentials?<br><br>In the case of computers, an easy option is to copy the appropriate audit script to the target machines and set it to execute on a schedule. More details on the wiki. The machines will send their data to Open-AudIT on that schedule, almost as if you were running discovery. The device simply runs the audit script on a schedule (again, you can read the audit script) as the user you tell it to and sends the output to the server. No credentials are involved at all.<br><br>And now we have Agents for Windows. The advantages of an actual installed Agent are'] = 'Tiel vi havas temon disponigantan Open-AudIT-kreditaĵojn por malkovri viajn aparatojn. Mi havas respondon - ne plu! Mi pensas, ke malkovro estas la plej bona aĵo ekde tranĉaĵigita pano. Vi ne bezonas scii antaŭ tempo <i>Kio estas sur Via Reto</i>. Kiel vi povas eltiri datumojn de aparatoj sen provizi akreditaĵojn?<br/><br/>Koncerne komputilojn, facila opcio devas kopii la konvenan reviziomanuskripton al la celmaŝinoj kaj meti ĝin por efektivigi horaron. Pli da detaloj sur la Vikio. La maŝinoj sendos siajn datumojn al Open-AudIT en tiu horaro, preskaŭ kiel se vi estus atinginta malkovron. La aparato simple prizorgas la reviziomanuskripton en horaro (deno, vi povas legi la reviziomanuskripton) kiel la uzanto vi rakontas ĝin al kaj sendas la produktaĵon al la servilo. Neniuj akreditaĵoj estas implikitaj entute.<br/><br/>Nun ni havas agentojn por Vindozo. La avantaĝoj de fakta instalita agento estas';
...
$GLOBALS["lang"]['Some examples are at the bottom of this page. All endpoints also have a minimum list of required fields. These are below.'] = 'Kelkaj ekzemploj estas ĉe la fundo de tiu paĝo. Ĉiuj finpunktoj ankaŭ havas minimuman liston de postulataj kampoj. Ĉi tiuj estas malsupre.';

$GLOBALS["lang"]['Some of our templates support the new move to dataTables, using server side processing. This massivley improves load times.'] = 'Kelkaj el niaj ŝablonoj apogas la novan movon al datenabloj, uzante servilflankpretigon. Tiu Massivley plibonigas ŝarĝtempojn.';

$GLOBALS["lang"]['Some other error has occurred when attempting to bind to the LDAP server. It is contactable (ie, the <i>connect</i> above has worked), but for some other reason, binding has not occurred. Check the logs on the LDAP server.'] = 'Iu alia eraro okazis dum provado ligi al la LDAP-servilo. Ĝi estas kontaktebla (mi, la <i>ligas</i> supre laboris), sed pro iu alia kialo, ligado ne okazis. Kontrolu la tagalojn sur la LDAP servilo.';

$GLOBALS["lang"]['Something has gone seriously wrong. Open-AudIT cannot read the <i>orgs</i> table.'] = 'io fuŝis serioze. Open-AudIT ne povas legi la <i>orgoj</i> tablo.';

$GLOBALS["lang"]['Something has gone seriously wrong. Open-AudIT cannot read the <i>roles</i> table.'] = 'io fuŝis serioze. Open-AudIT ne povas legi la <i>rolojn</i> tablo.';

$GLOBALS["lang"]['Sometimes agentless discovery just does not fit your use-case. Maybe your PCs have tight firewalls. Maybe they are not on the network when your discoveries are scheduled. Maybe they are used by remote workers. Whatever the case, this is where an agent can help. Install it on the target machine and it will <i>check-in</i> with your Open-AudIT server on a schedule and accept tasks. The most common task the server requests is for the agent to audit itself and send the result.'] = 'Foje senleĝa eltrovaĵo ne konvenas vian uzon. Eble via komputilo havas striktajn fajromurojn. Eble ili ne estas en la reto kiam viaj malkovroj estas planitaj. Eble ili estas uzataj de malproksimaj laboristoj. Kio ajn estas, tio estas kie agento povas helpi. Instali ĝin sur la celmaŝino kaj ĝi <i>Kontrolu-in</i> Kun via Open-AudIT-servilo en horaro kaj akceptas taskojn. La plej ofta tasko la servilpetoj estas por la agento por revizii sin kaj sendi la rezulton.';

$GLOBALS["lang"]['Sort'] = 'Sorĉisto';
...
$GLOBALS["lang"]['Stage 1: Documentation review'] = 'Ĉapitro 1: Dokumenta revizio';
...
$GLOBALS["lang"]['Storage area network'] = 'Storage areo reto';
...
$GLOBALS["lang"]['Submit Online'] = 'Submit Online Online';
...
$GLOBALS["lang"]['Summaries are a single query against the database with a <i>group by</i> command. Using this simple method we can easily create a summary for virtually any attribute.<br><br>We no longer require a separate report for each <i>type</i> of a device. We now simply have a summary that groups by <i>devices.type</i> and shows the result. You can then click on a given type from the list and see the matching devices. In this case, one Summary replaces (potentially) 78 reports (there are 78 device types).<br><br>A summary is different to a query in that a summary is designed to group items by a given attribute then provide a <i>click through</i> link to the actual devices. A query is simply a list of items with no further links. As above - this of a Summary as a combined <i>report + subreport</i>, whereas a query is simply a single Report.<br><br>Summaries have a different collection template to the other resources within Open-AudIT. This template shows the Summary as you would expect and also shows buttons with counts of other resources. This page is designed to be the HomePage of Open-AudIT.'] = 'Summaries estas ununura atendo kontraŭ la datumbazo kun datumbazo kun <i>Grupo de grupo</i> komando. Uzante tiun simplan metodon ni povas facile krei resumon por praktike ajna atributo.<br/><br/>Ni ne plu bezonas apartan raporton por ĉiu <i>tipo tipo tipo tipo</i> de aparato. Ni nun simple havas resumon kiu grupoj de <i>aparatoj. tipo tipo tipo tipo</i> kaj montras la rezulton. Vi tiam povas klaki sur antaŭfiksita tipo de la listo kaj vidi la egalajn aparatojn. En tiu kazo, unu Resumo anstataŭigas (eble) 78 raportojn (ekzistas 78 aparatospecoj).<br/><br/>Resumo estas malsama al demando en tio ke resumo estas dizajnita por grupigi erojn per antaŭfiksita atributo tiam disponigas atributon. <i>Klaku tra klako</i> aliĝi al la faktaj aparatoj. Sekvaĵo estas simple listo de eroj kun neniuj pliaj ligiloj. Kiel supre - tio de Resumo kiel kombinita <i>Raporto + Subreport</i>Dum atendo estas simple ununura Raporto.<br/><br/>Summaries havas malsaman kolektoŝablon al la aliaj resursoj ene de Open-AudIT. Tiu ŝablono montras la Resumon kiel vi atendus kaj ankaŭ montras butonojn kun kalkuloj de aliaj resursoj. Tiu paĝo estas dizajnita por esti la HomePage of Open-AudIT.';

$GLOBALS["lang"]['Summaries are designed to group items by a particular matching column and then to provide a link to individual devices. In the previous versions of Open-AudIT, this would have been two different items - a report and subreport. We have now bundled these into what we call a Summary.'] = 'Summaries estas dizajnitaj por grupigi erojn per speciala egala kolono kaj tiam por disponigi ligon al individuaj aparatoj. En la antaŭaj versioj de Open-AudIT, tio estintus du malsamaj eroj - raporto kaj subraportaĵo. Ni nun fascinis tiujn en kion ni nomas Resumo.';

$GLOBALS["lang"]['Summaries provide drilldown reporting capabilities. Simple, intuitive, powerful.'] = 'Summaries disponigas borillan raportkapablojn. Simpla, intuicia, potenca.';

$GLOBALS["lang"]['Summaries take the same arguments as Queries.'] = 'Summaries prenas la samajn argumentojn kiel Queries.';
...
$GLOBALS["lang"]['Supports compliance with legal and regulatory requirements'] = 'Subtenoj konforme kun laŭleĝaj kaj reguligaj postuloj';

$GLOBALS["lang"]['Suriname'] = 'Surinamo';

$GLOBALS["lang"]['Surveillance Audits:</strong> Annual audits to maintain certification'] = 'Surveillance Audits: Ĉiujaraj revizioj por konservi atestadon';
...
$GLOBALS["lang"]['Tagalog'] = 'La tagaloga tagalo';
...
$GLOBALS["lang"]['Take note of all output and action each item as appropriate.'] = 'Prenu noton de ĉiu produktaĵo kaj ago ĉiu objekto kiel konvene.';

$GLOBALS["lang"]['Tanzania'] = 'Tanzanio Tanzanio';

$GLOBALS["lang"]['Target Computer'] = 'Celo Komputila Komputilo';
...
$GLOBALS["lang"]['Tasks can be one of several distinct types: Baseline, Discovery, Report, Query, Summary or Collector.'] = 'Taskoj povas esti unu el pluraj apartaj tipoj: Bazlinio, Discovery, Raporto, Query, Summary aŭ kolektanto.';
...
$GLOBALS["lang"]['Test Email'] = 'Testa retpoŝto';
...
$GLOBALS["lang"]['Thank you for starting your journey with the best discovery and inventory tool around.'] = 'Dankon pro via vojaĝo kun la plej bona malkovro kaj inventaro.';

$GLOBALS["lang"]['Thanks to'] = 'Dankon pro';

$GLOBALS["lang"]['Thats it! You have just edited the attributes of as many devices as you need to.'] = 'Tio estas! Vi ĵus redaktis la atributojn de tiel multaj aparatoj kiel vi devas.';

$GLOBALS["lang"]['The <i>Roles</i> endpoint allows you to manage the set of permissions(Create, Read, Update, Delete) that are granted to the users and are applied to each endpoint.'] = 'La <i>Roloj</i> Endpoint permesas al vi administri la aron de permesoj (Create, Read, Update, Delete) kiuj estas konceditaj al la uzantoj kaj estas aplikitaj al ĉiu finpunkto.';
...
$GLOBALS["lang"]['The CVE has been marked as invalid or withdrawn in the CVE List. It remains in the NVD but is excluded from default search results.'] = 'La CVE estis markita kiel malvalida aŭ malparolema en la CVE-listo. Ĝi restas en la NVD sed estas ekskludita de defaŭltaj serĉrezultoj.';

$GLOBALS["lang"]['The CVE has been published to the CVE List and included in the NVD dataset. Initial ingestion only.'] = 'La CVE estis publikigita al la CVE-listo kaj inkludita en la NVD datenserio. Komenca konsumado nur.';

$GLOBALS["lang"]['The CVE has been updated after initial analysis. NVD enrichment data may have been revised.'] = 'La CVE estis ĝisdatigita post komenca analizo. NVD riĉigdatenoj eble estis reviziitaj.';

$GLOBALS["lang"]['The CVE identifier.'] = 'La CVE-identigilo.';

$GLOBALS["lang"]['The CVE is actively being enriched with CVSS scores, CWE classifications, reference tags, and CPE applicability.'] = 'La CVE aktive estas riĉigita kun CVSS-dudekopo, CWE-klasifikoj, referencoetikedoj, kaj CPE-aplikebleco.';

$GLOBALS["lang"]['The CVE is not currently prioritized for enrichment due to resource constraints or other reasons.'] = 'La CVE ne estas nuntempe prioritatita pro riĉigo pro rimedlimoj aŭ aliaj kialoj.';

$GLOBALS["lang"]['The CVE is queued for enrichment by NVD analysts. No detailed metadata yet.'] = 'La CVE estas ripetita por riĉigo fare de NVD analizistoj. Neniu detala metadatenoj ankoraŭ.';
...
$GLOBALS["lang"]['The Device Seed Discovery type is the newest highly-effective method for network crawling, giving you the ability to target your network as narrowly or as broadly as you need. It is fast, it works and it is great.'] = 'La Device Seed Discovery-speco estas la plej nova tre efika metodo por reto rampanta, donante al vi la kapablon celi vian reton tiel mallarĝe aŭ tiel larĝe kiel vi bezonas. Ĝi estas rapida, ĝi funkcias kaj ĝi estas bonega.';

$GLOBALS["lang"]['The Discovery Scan Options we ship are detailed in the table below. As above, Enterprise users can create more of these or edit the shipped items.'] = 'La Discovery Skandalo Opcioj, kiujn ni havas, estas detalaj en la tablo malsupre. Kiel supre, Enterprise uzantoj povas krei pli de tiuj aŭ redakti la ekspeditajn erojn.';

$GLOBALS["lang"]['The Elevated User query'] = 'La Elevated User-query';

$GLOBALS["lang"]['The Executables feature scans the disk of a device as part of the audit and checks that every executable file is known to the package manager. Because it uses the package manager, the feature applies to Linux target devices only, and further than that, only rpm or deb based distributions. Anything Redhat or Debian based should work.'] = 'La Executables havas la diskon de aparato kiel parto de la revizio kaj ĉekoj ke ĉiu efektivigebla dosiero estas konata al la pakaĵmanaĝero. Ĉar ĝi uzas la pakaĵmanaĝeron, la trajto validas por Linukso-celaparatoj nur, kaj plu ol tio, nur rpm aŭ laboratorio bazigis distribuojn. Kio ajn Redhat aŭ Debian bazigis devus labori.';

$GLOBALS["lang"]['The FROM'] = 'La FROM';
...
$GLOBALS["lang"]['The ISO/IEC 27001 certification process and its key elements.'] = 'ISO/IEC 27001 atestadoprocezo kaj ĝiaj esencaj elementoj.';
...
$GLOBALS["lang"]['The LDAP server could not be connected to. At all. Check it is pingable from the Open-AudIT server. Check the correct port is open to the Open-AudIT server. An nmap from the Open-AudIT server will show this. Substitute your LDAP servers IP for $ip. Try:<code>nmap -vv $ip</code>'] = 'La LDAP-servilo ne povus esti ligita al. Ĉio. Kontrolu ĝin estas utila de la Open-AudIT-servilo. Kontrolu la ĝustan havenon estas malferma al la Open-AudIT servilo. Nmap de la Open-AudIT-servilo montros tion. Subtenu vian LDAP-servilojn IP por ip. Provu:<code>nmap -vv $ip</code>';

$GLOBALS["lang"]['The LDAP server type is invalid. It should be either <i>active directory</i> or <i>openldap</i>.'] = 'La LDAP-servilspeco estas malvalida. Ĝi devus esti aŭ <i>aktiva direktoro</i> aŭ aŭ <i>malfermado</i>.';
...
$GLOBALS["lang"]['The Linux Open-AudIT installer will test for and if required, install Open-AudITs dependencies from your distributions repository, including setting the Nmap SetUID. This is required for SNMP (UDP 161) detection by a non-root user. This is supported on RedHat/CentOS and Debian/Ubuntu. If you need to manually install Nmap:<br><br>For RedHat/CentOS do (NOTE - if you upgrade using yum, you will need to reapply this <i>chmod</i> setting).'] = 'La Linukso Open-AudIT instalilo testos por kaj se necese, instalas Open-AudIT dependencajojn de via distribuo deponejo, inkluzive de metado de la Nmap SetUID. Tio estas postulata por SNMP (UDP 161) detekto de ne-radika uzanto. Tio estas apogita sur RedHat/CentOS kaj Debian/Ubuntu. Se vi devas mane instali Nmap:<br/><br/>Por RedHat/CentOS faras (NOTE - se vi ĝisdatigas uzi yum, vi bezonos reapliki tion <i>chmod</i> metante).';
...
$GLOBALS["lang"]['The OpenSCAP ecosystem provides multiple tools to assist administrators and auditors with assessment, measurement, and enforcement of security baselines including a wide variety of hardening guides and configuration baselines developed by the open source community, ensuring that you can choose a security policy which best suits the needs of your organization, regardless of its size.'] = 'La OpenSCAP ekosistemo disponigas multoblajn ilojn por helpi administrantojn kaj revizorojn kun takso, mezurado, kaj devigo de sekurecbazlinioj inkluzive de vasta gamo de hardantaj gvidistoj kaj konfiguraciobazlinioj evoluigitaj fare de la malfermfonteckomunumo, certigante ke vi povas elekti sekurecpolitikon kiu plej bone konvenas la bezonojn de via organizo, nekonsiderante ĝia grandeco.';

$GLOBALS["lang"]['The OpenSCAP project is a collection of open source tools for implementing and enforcing this standard, and has been awarded the SCAP 1.2 certification by NIST in 2014.'] = 'La OpenSCAP projekto estas kolekto de malfermfontaj iloj por efektivigado kaj devigado de tiu normo, kaj estis aljuĝita la SCAP 1.2 atestado fare de NIST en 2014.';
...
$GLOBALS["lang"]['The Racks feature is used to manage and visualize your rack use with an Organisation, Location, Building, Floor, Room and Row.'] = 'La Racks-trajto kutimas administri kaj bildigi vian rako-uzon kun organizo, Loko, Konstruaĵo, Floor, Ĉambro kaj Row.';

$GLOBALS["lang"]['The SCAP is a specification for expressing and manipulating security data in standardized ways. SCAP uses several individual specifications in concert to automate continuous monitoring, vulnerability management, and security policy compliance evaluation reporting'] = 'La SCAP estas specifo por esprimado kaj manipulado de sekurecdatenoj laŭ normigitaj manieroj. SCAP uzas plurajn individuajn specifojn en koncerto por aŭtomatigi kontinuan monitoradon, vundebleco-administradon, kaj sekurecpolitikobservtaksadon raportantan raportadon';

$GLOBALS["lang"]['The SELECT'] = 'La SELECT';

$GLOBALS["lang"]['The SELECT section of the query should use full dot notation and also request the field with its full dot name. IE - SELECT devices.id AS `devices.id`. Each field should be selected in this fashion to enable GUI side attribute filtering.'] = 'La SELECT-sekcio de la atendo devus uzi plenan dotnotacion kaj ankaŭ peti la kampon kun ĝia plena punktnomo. IE - SELECT aparatoj. Kiel \'devices.id\' Ĉiu kampo devus esti selektita en tiu modo por ebligi GUI-flankan atributon filtrantan.';
...
$GLOBALS["lang"]['The WHERE'] = 'La ĉielo estas';

$GLOBALS["lang"]['The WHERE section of your SQL <em>must</em> contain'] = 'La sekcio de via SQL <em>Devas</em> enhavas';
...
$GLOBALS["lang"]['The account must have a password; WMI does not allow blank passwords.'] = 'La raporto havendaĵo pasvorton; WMI ne permesas brilajn pasvortojn.';

$GLOBALS["lang"]['The account password must NOT contain \" (double quotes). This is because cscript (and wscript) cannot parse argument values containing double quotes. They are simply stripped. No (before you ask) escaping will not work. This is a cscript limitation and nothing to do with Open-AudIT.'] = 'La konto pasvorton ne devas enhavi "duoblajn citaĵojn". Tio estas ĉar gramo (kaj wscript) ne povas analizi argumentvalorojn enhavantajn duoblajn citaĵojn. Ili estas simple nudigitaj. Neniu (antaŭ ol vi demandas) eskapi ne funkcias. Tio estas tipa limigo kaj nenio farendaĵo kun Open-AudIT.';

$GLOBALS["lang"]['The actual full name of this user.'] = 'La vera plena nomo de ĉi tiu uzanto.';

$GLOBALS["lang"]['The address of the Open-AudIT server submit page.'] = 'La adreso de la Open-AudIT-servilo submetas paĝon.';
...
$GLOBALS["lang"]['The administrator supplied credentials to bind to the LDAP server, but they have not been accepted by the LDAP sevrer. Double check the credentials work on the LDAP server, and then check (or reset them) in the Open-AudIT LDAP Server entry.'] = 'La administranto liveris akreditaĵojn por ligi al la LDAP-servilo, sed ili ne estis akceptitaj fare de la LDAP sevrer. Duobla ĉeko la akreditaĵoj laboras pri la LDAP-servilo, kaj tiam ĉeko (aŭ rekomencas ilin) en la Open-AudIT LDAP Server-eniro.';

$GLOBALS["lang"]['The agent and server are also intelligent enough to self-update the agent if a newer version is installed on the server (say after upgrading Open-AudIT).'] = 'La agento kaj servilo ankaŭ estas sufiĉe inteligentaj por mem-ĝisdatigi la agenton se pli nova versio estas instalita sur la servilo (post ĝisdatigado de Open-AudIT).';

$GLOBALS["lang"]['The agent should download a fresh copy of the audit script, run it and submit the result to the server.'] = 'La agento devus elŝuti freŝan kopion de la reviziomanuskripto, prizorgi ĝin kaj submeti la rezulton al la servilo.';

$GLOBALS["lang"]['The application creates temporary audit scrtips here, copies them to the target machines, then deletes them.'] = 'La apliko kreas provizorajn revizorojn ĉi tie, kopias ilin al la celmaŝinoj, tiam forigas ilin.';
...
$GLOBALS["lang"]['The audit scripts all accept a debugging argument. You can run the script utilizing that and see in more detail what the issue is. And if you cannot figure it out - that is what we are here for! Open a support case and we will get things running in no time.'] = 'La reviziomanuskriptoj ĉiuj akceptas malkonstruan argumenton. Vi povas prizorgi la manuskripton utiligantan tion kaj vidi en pli da detalo kio la temo estas. Kaj se vi ne povas supozi ĝin, tio estas kion ni estas ĉi tie! Malfermu subtenon, kaj ni havos aĵojn kurantajn en neniu tempo.';

$GLOBALS["lang"]['The base path from which to search for Users.'] = 'La bazo vojo de kiu serĉi uzantojn.';

$GLOBALS["lang"]['The below steps are not the fault of or unique to Open-AudIT and would affect <strong>any</strong> discovery application using remote WMI and/or Windows.'] = 'Sub ŝtupoj ne estas la faŭlto de aŭ unika al Open-AudIT kaj influus <strong>iu ajn</strong> Discovery apliko uzanta malproksiman WMI kaj/aŭ Fenestrojn.';
...
$GLOBALS["lang"]['The client ID is the ID of an Azure Active Directory application. The client secret is the key that you give that application.'] = 'La kliento ID estas la ID de Azure Aktiva Adresaro. La kliento sekreto estas la ŝlosilo kiun vi donas al tiu aplikaĵo.';

$GLOBALS["lang"]['The collector is essentially a full install of Open-AudIT in <i>collector</i> mode. The collector is designed to run discovery upon the network it is situated in. It is not restricted to only that network, but ideally it would essentially be one collector per subnet where required. The collector is driven on a schedule by the server and runs discovery upon the network as specified.<br>When in Stand Alone mode the Collector acts as an independant server, simply forwarding all devices found to the main server.<br><br>Once installed and setup, control of the Collector is performed on the Server (not in Stand Alone mode).<br><br>The only required network ports between the collector and server are 80 or 443 (TCP connection established from the Collector to the Server). The Open-AudIT database is not (and cannot be) shared between these installs.<br><br>By default the collector (not in Stand Alone mode) will request from the server any discovery tasks every 5 minutes (you can configure this on the server for new Collectors using the configuration item collector_check_minutes) therefor any discovery tasks for the collector should be scheduled for 0, 5, 10, 15, etc minutes.'] = 'La kolektanto estas esence plena instalaĵo de Open-AudIT en <i>kolektanto</i> reĝimo. La kolektanto estas dizajnita por prizorgi eltrovaĵon sur la reton kiun ĝi estas situanta en. Ĝi ne estas limigita al nur tiu reto, sed ideale ĝi esence estus unu kolektanto per subreto kie necese. La kolektanto estas movita en horaro fare de la servilo kaj prizorgas eltrovaĵon sur la reton kiel precizigite.<br/>Kiam en la Sola reĝimo la kolektanto funkcias kiel endependa servilo, simple plusendi ĉiujn aparatojn trovitajn al la ĉefservilo.<br/><br/>Post instalita kaj aranĝo, kontrolo de la kolektanto estas farita sur la Servilo (ne en Stand Alone-reĝimo).<br/><br/>La nuraj postulataj sendostaciaj havenoj inter la kolektanto kaj servilo estas 80 aŭ 443 (TCP-ligo establita de la kolektanto ĝis la Servilo). La Open-AudIT-datumbazo ne estas (kaj ne povas esti) dividita inter tiuj instalaĵoj.<br/><br/>defaŭlte la kolektanto (ne en Stand Alone reĝimo) petos de la servilo iujn ajn eltrovaĵotaskojn ĉiujn 5 minutojn (vi povas formi tion sur la servilo por novaj kolektantoj uzantaj la konfiguracion ero kolektanto_check_minutes) tie por iuj eltrovaĵotaskoj por la kolektanto devus esti planita por 0, 5, 10, 15, ktp.';

$GLOBALS["lang"]['The collector is essentially a full install of Open-AudIT in <i>collector</i> mode. This mode would reduce visible functionality in an effort to simplify and focus the application. It is designed to collect information about local networks and devices, where firewall and/or network traversal is an issue from the server.'] = 'La kolektanto estas esence plena instalaĵo de Open-AudIT en <i>kolektanto</i> reĝimo. Tiu reĝimo reduktus videblan funkciecon por simpligi kaj enfokusigi la aplikiĝon. Ĝi estas dizajnita por kolekti informojn pri lokaj retoj kaj aparatoj, kie fajromuro kaj/aŭ reto krucas estas temo de la servilo.';
...
$GLOBALS["lang"]['The current date and time in the format: Y-m-d H:i:s.'] = 'La nuna dato kaj tempo en la formato: Y-m-d H: mi:';

$GLOBALS["lang"]['The current date in Y-m-d format.'] = 'La nuna dato en Y-m-d formato.';
...
$GLOBALS["lang"]['The data stored in the database is not showing in the application translated. We leave the data as it is. However, there is nothing to stop you, the user, changing the name (for example) of an item in the database to your language.'] = 'La datenoj stokitaj en la datumbazo ne montras en la aplikiĝo tradukita. Ni lasas la datumojn kiel ĝi estas. Tamen, ekzistas nenio por maldaŭrigi vin, la uzanton, ŝanĝante la nomon (ekzemple) de objekto en la datumbazo al via lingvo.';

$GLOBALS["lang"]['The data you input will be used in a <code>LIKE</code> clause, not (as per the API) an <code>equals</code> clause. Another example - if you input <code>comput</code>, it would still return all computers. And because we are using a <code>LIKE</code> clause, it is case-insensitive.'] = 'La datumoj, kiujn vi enigas, estos uzataj en <code>LIKE</code> paragrafo, ne (kiel per la API) <code>equals</code> paragrafo. Alia ekzemplo - se vi eniras <code>comput</code>Tamen, ĝi ankoraŭ revenos al ĉiuj komputiloj. Ĉar ni uzas la <code>LIKE</code> paragrafo, ĝi estas kazo-insentema.';

$GLOBALS["lang"]['The database schema can be found in the application if the user has database::read permission by going to menu: Admin -> Database ->'] = 'La databaseskemo povas esti trovita en la aplikiĝo se la uzanto havas datumbazon: legu permeson irante al menuo: Admin -> Datumbazo ->';
...
$GLOBALS["lang"]['The default discovery scan option is the UltraFast set.'] = 'La defaŭlta eltrovaĵo skani opcion estas la UltraFast aro.';
...
$GLOBALS["lang"]['The fields associated with an Integration are stored in the database as a JSON array of objects. Each field has the following attributes'] = 'La kampoj asociitaj kun Integriĝo estas stokitaj en la datumbazo kiel JSON aro de objektoj. Ĉiu kampo havas la sekvajn atributojn';
...
$GLOBALS["lang"]['The format of your data should be in the form'] = 'La formato de viaj datumoj devas esti en la formo';
...
$GLOBALS["lang"]['The internal value, reformatted in this format.'] = 'La interna valoro, reformita en tiu formato.';
...
$GLOBALS["lang"]['The logic for device matching is contained in the devices_helper.php file, which on a Linux install can be found here'] = 'La logiko por aparato egala estas enhavita en la aparatoro.php dosiero, kiu sur Linukso-instalaĵo povas esti trovita ĉi tie.';

$GLOBALS["lang"]['The machine-default permission settings do not grant Local Activation permission for the COM Server application with'] = 'La maŝin-defaŭltaj permesokontekstoj ne donas Local Activation-permeson por la COM-Servilo-aplikaĵo kun';
...
$GLOBALS["lang"]['The new Agent runs a PowerShell version of the old audit script in preparation for the depreciation of VBScript (yes, it is coming).'] = 'La nova agento prizorgas PowerShell version de la malnova reviziomanuskripto en preparo por la malpreco de VBScript (jes, ĝi venas).';
...
$GLOBALS["lang"]['The purpose of this licensing page is to list the products and licenses included in Firstwave Commercial products including products based upon open source works.Open-AudIT is licensed from Firstwave under AGPLv3 or later with Enterprise and Professional functionality licensed under commercial terms.Open-AudIT when downloaded from FirstWave may include the following libraries and projects, which are supplied unmodified and licensed as indicated:'] = 'La celo de tiu licencadpaĝo devas listigi la produktojn kaj licencojn inkluditajn en Firstwave Commercial-produktoj inkluzive de produktoj bazitaj sur malfermfontecverkoj. Open-AudIT estas licencita de Firstwave sub AGPLv3 aŭ poste kun Enterprise kaj Profesia funkcieco licencita sub komercaj esprimoj. Open-AudIT kiam elŝutite de FirstWave povas inkludi la sekvajn bibliotekojn kaj projektojn, kiuj estas liveritaj nemodifita kaj licencita kiel indikite:';
...
$GLOBALS["lang"]['The requested properties should be in a comma-separated list. Properties should be fully qualified - ie, system.hostname (not just hostname).'] = 'La petitaj trajtoj devus esti en kom-separita listo. Trajtoj devus esti plene kvalifikitaj - t.e., sistemo.';
...
$GLOBALS["lang"]['The search for group on the LDAP server failed. Check the LDAP server logs. Have you created these groups (for roles and orgs) on the LDAP server and assigned LDAP users to them?'] = 'La serĉo por grupo sur la LDAP-servilo malsukcesis. Kontrolu la LDAP-servilregistrojn. Ĉu vi kreis tiujn grupojn (por roloj kaj orkoj) sur la LDAP-servilo kaj asignis LDAP-uzantojn al ili?';
...
$GLOBALS["lang"]['The standard Nmap timing options. Previously set at T4 (aggressive).'] = 'La norma Nmap tempigas opciojn. Antaŭe metita ĉe T4 (agresa).';
...
$GLOBALS["lang"]['The steps below outline the process.'] = 'La ŝtupoj sub skizas la procezon.';

$GLOBALS["lang"]['The target IP this log entry referers to (if any).'] = 'La celo IP kiun tiu tagalo enmetas al (se entute).';

$GLOBALS["lang"]['The target computer to audit. \".\" means localhost.'] = 'La celkomputilo al revizio. \'\" signifas lokalon.';
...
$GLOBALS["lang"]['The user that was specified exists in LDAP, but Open-AudIT is not configured to consume the LDAP groups for roles and that user does not exist within Open-AudIT. Either select <i>Use LDAP for Roles</i> on the Open-AudIT LDAP Server screen or create this user within Open-AudIT and assign roles and orgs.'] = 'La uzanto kiu estis precizigita ekzistas en LDAP, sed Open-AudIT ne estas formita por konsumi la LDAP-grupojn por roloj kaj tiu uzanto ne ekzistas ene de Open-AudIT. aŭ elekti <i>Uzu LDAP por Roloj</i> Sur la Open-AudIT LDAP Servilekrano aŭ krei tiun uzanton ene de Open-AudIT kaj asignas rolojn kaj orgs.';
...
$GLOBALS["lang"]['Then create a new Auth method in Open-AudIT by going to menu -> Admin -> Auth Methods -> Create Auth. Provide a name and set the <i>type</i> to Entra.'] = 'Tiam krei novan Auth-metodon en Open-AudIT irante al menuo -> Admin -> Auth Metodoj -> Krei Auth. Prenu nomon kaj metis la <i>tipo tipo tipo tipo</i> al Entra.';

$GLOBALS["lang"]['Then you can use Open-AudIT (unsupported) to receive audit data directly from the clients. Discovery <strong>will fail</strong>, but if youre not using Discovery (the main feature Open-AudIT was designed around), you can still get device data. You would need to run the audit scripts directly on the clients using cron, or use the Windows Agent feature (Enterprise only).'] = 'Tiam vi povas uzi Open-AudIT (nepruvita) por ricevi reviziodatenojn rekte de la klientoj. Discovery Discovery <strong>malsukcesos</strong>, sed se vi ne uzas Discovery (la ĉefa trajto Open-AudIT estis dizajnita ĉirkaŭe), vi daŭre povas ricevi aparatodatenojn. Vi devus prizorgi la reviziomanuskriptojn rekte sur la klientoj uzantaj kronon, aŭ uzi la Windows Agent trajton (Enterprizo nur).';

$GLOBALS["lang"]['There is a button to export to JSON. This will display only the device table of attributes. To export the device with all associated component tables, view the device details, then add'] = 'Ekzistas butono por eksporti al JSON. Tio montros nur la aparato tablon de atributoj. Por eksporti la aparaton kun ĉiuj rilataj komponenttabloj, rigardi la aparato detaloj, tiam aldoni';

$GLOBALS["lang"]['There is absolutely no need to manually edit each individual device.'] = 'Ekzistas absolute neniu bezono mane redakti ĉiun individuan aparaton.';

$GLOBALS["lang"]['There is no need to do anything if you are running Open-AudIT on a Linux server.<br><br>Windows clients are just fine and require no special actions, however.... to enable this feature the audit script must be run locally on the target Windows system. It cannot be run remotely as we do with WMI calls when running the audit script on one Windows machine, while targeting a second Windows machine. To do this we need to copy the audit script to the target Windows machine and then run it. Unfortunately the service account that Apache runs under is the Local System account. This account has no access to remote (network based) resources. To work around this issue the service must be run under another account. It is easiest to just use the local Administrator account, but you can try any account you like as long as it has the required privileges. The Local System account has as much local access as the local Administrator account.'] = 'Ekzistas neniu bezono farendaĵo io ajn se vi prizorgas Open-AudIT sur Linukso-servilo.<br/><br/>Fenestroj estas justaj kaj postulas neniujn specialajn agojn, aliflanke ... rajtigi tiun trajton la reviziomanuskripto devas esti prizorgita loke sur la cel Windows-sistemon. Ĝi ne povas esti prizorgita malproksime kiel ni faras kun WMI-vokoj dum prizorgado de la reviziomanuskripto sur unu Fenestrojn, celante duan Fenestrojn. Por fari tion ni devas kopii la reviziomanuskripton al la celo Windows-maŝino kaj tiam prizorgi ĝin. Bedaŭrinde la servokonto ke apaĉkuroj sub estas la Local System-konto. Tiu raporto havas neniun aliron al malproksimaj (reto bazita) resursoj. Por labori ĉirkaŭ tiu temo la servo devas esti prizorgita sub alian raporton. Estas plej facile uzi la lokan Administran konton, sed vi povas provi ajnan raporton vi kiel longe kiel ĝi havas la postulatajn privilegiojn. La Loka Sistemo-konto havas tiel multe da loka aliro kiel la loka Administranto-konto.';
...
$GLOBALS["lang"]['These parameters enable you to audit only what is useful and relevant to you, saving processing time and allowing you to discover your network in an orderly manner.'] = 'Tiuj parametroj ebligas al vi revizii nur kio estas utila kaj signifa al vi, ŝparante pretigtempon kaj permesante al vi malkovri vian reton en bonorda maniero.';

$GLOBALS["lang"]['Thing'] = 'La afero';

$GLOBALS["lang"]['Think of mail.domain1.com and mail.domain2.com - same hostname.'] = 'Pensu pri poŝto. domain1.com kaj poŝto.domain2.com - sama mastronomo.';

$GLOBALS["lang"]['Third'] = 'Tria triono';
...
$GLOBALS["lang"]['This code relys on the great work done by the'] = 'Tiu kodo dependas de la granda laboro farita per la';

$GLOBALS["lang"]['This collectors universally unique identifier.'] = 'Tiuj kolektantoj universale unika identigilo.';

$GLOBALS["lang"]['This column is required by'] = 'Tiu kolono estas postulita per';
...
$GLOBALS["lang"]['This endpoint enables you to add the connections that are part of your network infrastructure, it allows you to customize a variety of attributes, specify where this connection is located and the organization that it belongs.'] = 'Tiu finpunkto rajtigas vin aldoni la ligojn kiuj estas parto de via retinfrastrukturo, ĝi permesas al vi adapti gamon da atributoj, precizigi kie tiu ligo situas kaj la organizo ke ĝi apartenas.';

$GLOBALS["lang"]['This error indicates that SMB1 has been disabled or removed from the target machine. This is normal for modern version of Windows and you will only see this message when the SMB2 connection attempt has failed. If the SMB2 connection fails, we attempt SMB1 to enable discovery on old versions of Windows. If the target Windows machine <i>is</i> running an old version of Windows, it is likely your credentials have failed. In that case, see'] = 'Tiu eraro indikas ke SMB1 estis handikapita aŭ forigita de la celmaŝino. Tio estas normala por moderna versio de Fenestroj kaj vi nur vidos tiun mesaĝon kiam la SMB2-ligprovo malsukcesis. Se la SMB2-ligo malsukcesas, ni provas SMB1 por ebligi eltrovaĵon en malnovaj versioj de Fenestroj. Se la celo de Windows <i>estas</i> Sed vi havas malnovan version de Vindozo, verŝajne viaj akreditaĵoj malsukcesis. En tiu kazo, vidu';

$GLOBALS["lang"]['This error indicates that not enough virtual memory or paging file quota is available to complete the specified operation. You should try again later.'] = 'Tiu eraro indikas ke ne sufiĉe virtuala memoro aŭ paĝiĝa dosierkvoto estas havebla kompletigi la precizigitan operacion. Vi devas provi denove poste.';

$GLOBALS["lang"]['This error indicates the credentials used either are incorrect, do not exist or do not have sufficient privileges to log on remotely to the target Windows machine. You should verify the credentials and check the below.'] = 'Tiu eraro indikas ke la akreditaĵoj uzis aŭ estas malĝustaj, ne ekzistas aŭ ne havas sufiĉajn privilegiojn por registradi sur malproksime al la celo Windows-maŝino. Vi devus kontroli la akreditaĵojn kaj kontroli la malsupre.';

$GLOBALS["lang"]['This example creates a list of all Modules marked as'] = 'Tiu ekzemplo kreas liston de ĉiuj Moduloj markitaj kiel';

$GLOBALS["lang"]['This example creates a list of devices and the open Ports, Protocols, and Programs found by the NMAP scan.'] = 'Tiu ekzemplo kreas liston de aparatoj kaj la malfermaj Havenoj, Protokoloj, kaj Programoj trovitaj per la NMAP-skanado.';

$GLOBALS["lang"]['This example creates a list of devices where the Function or Description fields are blank OR the Purchase Date is the default.'] = 'Tiu ekzemplo kreas liston de aparatoj kie la Funkcio aŭ Priskribo kampoj estas brilaj OR la Aĉetaĵdato estas la defaŭlto.';

$GLOBALS["lang"]['This example query retrieves a list of devices OVER 3 years old. The query uses today'] = 'Tiu ekzemplo query prenas liston de aparatoj OVER 3 jarojn aĝaj. La query hodiaŭ uzas';
...
$GLOBALS["lang"]['This feature, because it has the ability to affect target devices more than usual must be manually enabled. To enable this feature, change the configuration item feature_executables to <i>yes</i>.'] = 'Tiu trajto, ĉar ĝi havas la kapablon influi celaparatojn pli ol kutime devas esti mane ebligita. Por ebligi tiun trajton, ŝanĝi la konfiguracion objektot_eksecutables al <i>jes, jes, jes</i>.';

$GLOBALS["lang"]['This file tells Linux to poll the application to determine if there are any scheduled tasks that should be run.'] = 'Tiu dosiero rakontas al Linukso sondi la petskribon por determini ĉu ekzistas iuj planitaj taskoj kiuj devus esti prizorgitaj.';
...
$GLOBALS["lang"]['This is an optional configuration option, enabled by setting discovery_use_org_id_match in the global configuration.'] = 'Tio estas laŭvola konfiguracio opcio, ebligita metante Discovery_use_org_id_-matĉon en la tutmonda konfiguracio.';
...
$GLOBALS["lang"]['This is likely due to MySQL time being off. MySQL typically uses the host devices time. You can check this by'] = 'Tio verŝajne ŝuldiĝas al MySQL tempo estanta for. MySQL tipe utiligas la mastro-aparaton tempon. Vi povas kontroli tion per';

$GLOBALS["lang"]['This is settable by users and so even though it should be globally unique, there is certainly no guarantee of this.'] = 'Tio estas metita fare de uzantoj kaj tiel eĉ se ĝi devus esti tutmonde unika, ekzistas certe neniu garantio de tio.';
...
$GLOBALS["lang"]['This is to be used as the first point of call when troubleshooting Open-AudIT issues. You can click the Export button on the top right to retrieve this as a JSON file (to be added to the support ticket / email.'] = 'Tio estas uzota kiel la unua punkto de voko kiam ĝenas Open-AudIT-temojn. Vi povas klaki la Eksportbuton sur la supra rajto preni tion kiel JSON-dosiero (por esti aldonita al la helpbileto / retpoŝto.';
...
$GLOBALS["lang"]['This should be commented out after troubleshooting as debug mode will generate a lot of logs on the disk for no benefit.'] = 'Tio devus esti komentita post perturbado kiam debugreĝimo generos multajn tagalojn en la disko por neniu utilo.';

$GLOBALS["lang"]['This should be globally unique, but I have seen instances where it is not.'] = 'Tio devus esti tutmonde unika, sed mi vidis kazojn kie ĝi ne estas.';
...
$GLOBALS["lang"]['This state is used when Nmap is unable to determine whether a port is closed or filtered. It is only used for the IP ID idle scan.'] = 'Tiu ŝtato estas uzita kiam Nmap estas nekapabla determini ĉu haveno estas fermita aŭ filtrita. Ĝi estas nur uzita por la IP ID idle-skanado.';
...
$GLOBALS["lang"]['This will permanently DELETE this license.'] = 'Ĉi tiu permesilo estos ĉiam forigita.';

$GLOBALS["lang"]['This will show you the Bulk Edit form. Any attributes you set on this form will be applied to all selected devices. You can set multiple attributes at once.'] = 'Tio montros al vi la Bulk Edit-formularon. Ĉiuj atributoj kiujn vi metis sur tiun formon estos aplikita al ĉiuj elektitaj aparatoj. Vi povas meti plurajn atributojn tuj.';
...
$GLOBALS["lang"]['To a new file named .env (in the same directory). Now edit that new file and uncomment (remove the #) the line below (line 17)'] = 'Al nova dosiero nomita .env (en la sama adresaro). Nun redaktu tiun novan dosieron kaj nerespekton (remove la numero) la linion malsupre (linio 17)';
...
$GLOBALS["lang"]['To audit a machine, you must have credentials and administrator level access.'] = 'Por revizii maŝinon, vi havendaĵo akreditaĵojn kaj administran nivelaliron.';

$GLOBALS["lang"]['To audit a remote machine on an Active Directory domain, your supplied user (or if none provided, the user running the script) must be a member of the target machines Administrators group (or subgroup).'] = 'Por revizii malproksiman maŝinon sur Aktiva Adresardomajno, via provizita uzanto (aŭ se neniu provizis, la uzanto prizorganta la manuskripton) devas esti membro de la celmaŝinoj-administrantoj-grupo (aŭ subgrupo).';

$GLOBALS["lang"]['To audit a remote machine that is not in a domain, you must use the Administrator account (not <i>an</i> admin account, <i>the</i> Administrator account) on the target PC. #1 and #2'] = 'Revizii malproksiman maŝinon kiu ne estas en domajno, vi devas uzi la Administranto-konton (ne ne en domajno, vi devas uzi la Administran konton). <i>unu el la</i> Admin konto, <i>La</i> Administranto respondecas pri la celo PC. numero 1 kaj numero 2';

$GLOBALS["lang"]['To audit localhost, any supplied credentials are disregarded and the connection is made using the details of the user running the script.'] = 'Por revizii lokanhost, ĉiuj provizitaj akreditaĵoj estas ignoritaj kaj la ligo estas farita uzante la detalojn de la uzanto prizorganta la manuskripton.';

$GLOBALS["lang"]['To compare software we check the name and version. Because version numbers are not all standardised in format, when we receive an audit result we create a new attribute called software_padded which we store in the database along with the rest of the software details for each package. For this reason, baselines using software policies will not work when run against a device that has not been audited by 1.10 (at least). Software policies can test against the version being <i>equal to</i>, <i>greater than</i> or <i>equal to or greater than</i>.'] = 'Por kompari softvaron ni kontrolas la nomon kaj version. Ĉar versio nombroj ne estas ĉiuj normigitaj en formato, kiam ni ricevas reviziorezulton ni kreas novan atributon nomitan softvaripentrita kiun ni stokas en la datumbazo kune kun la resto de la softvardetaloj por ĉiu pakaĵo. Tial, bazlinioj uzantaj softvarpolitikojn ne funkcias dum kuro kontraŭ aparato kiu ne estis reviziita per 1.10 (almenaŭ). Softvarpolitikoj povas testi kontraŭ la versio estanta <i>egala al egala</i>, <i>pli granda ol</i> aŭ aŭ <i>egala al aŭ pli granda ol</i>.';
...
$GLOBALS["lang"]['To filter by a property value, use the property name. Operators that should precede the value are'] = 'Por filtri per domvaloro, uzi la domnomon. Operatoroj kiuj devus antaŭi la valoron estas';

$GLOBALS["lang"]['To install Nmap on Windows, visit the Nmap page at'] = 'Por instali Nmap sur Fenestroj, viziti la Nmap-paĝon ĉe';

$GLOBALS["lang"]['To make the change, just follow the steps below.'] = 'Por fari la ŝanĝon, nur sekvu la paŝojn malsupre.';
...
$GLOBALS["lang"]['To retrieve your key, log in to the AWS Console and select your username, then My Security Credentials.'] = 'Por preni vian ŝlosilon, logi enen al la AWS Console kaj selekti vian uzantnomon, tiam My Security Credentials.';

$GLOBALS["lang"]['To return a specific component item.'] = 'Reiri al Specifa komponanto.';

$GLOBALS["lang"]['To return all items for a compnent type for a specific device.'] = 'Por resendi ĉiujn erojn por kompnentspeco por specifa aparato.';

$GLOBALS["lang"]['To return all items for a component type. If you wanted all software you would use'] = 'Por resendi ĉiujn erojn por komponentspeco. Se vi deziras ĉiujn programarojn vi uzus';
...
$GLOBALS["lang"]['To select devices to be integrated, we use nmis_manage = y, but you might like (for example) type = router. You can also use a Group or Query if you prefer something more complex.'] = 'Por selekti aparatojn por esti integrita, ni uzas nmis_manage = y, sed vi eble ŝatas (ekzemple) tipon = itineranton. Vi ankaŭ povas uzi grupon aŭ Query se vi preferas ion pli kompleksan.';

$GLOBALS["lang"]['To sort by a database column, use'] = 'Por ordigi per datenarkolono, uzo';

$GLOBALS["lang"]['To use this Enterprise feature, you first need to create your user in Open-AudIT as per usual. Assigning a password is not necessary. You do have to assign Roles and Orgs. The username in Open-AudIT should match the Entra <i>preferred username</i> attribute. There is no need for a Full Name or Email - these will be populated from Entra. If you do not know your users <i>preferred username</i>, fear not. You can create the new Auth Method in Open-AudIT and the Enterprise Application in Entra and when a user attempts to sign-on to Open-AudIT without a pre-existing user, check the logs and you will see their <i>preferred username</i> logged for your convienence.'] = 'Por uzi tiun Enterprise trajton, vi unue devas krei vian uzanton en Open-AudIT kiel per kutima. Ne necesas pasvorton. Vi devas asigni rolojn kaj orgojn. La uzantnomo en Open-AudIT devus egali la Entra <i>preferata uzantnomo</i> atribu. Ekzistas neniu bezono de plena nomo aŭ retpoŝto - tiuj estos loĝitaj de Entra. Se vi ne konas viajn uzantojn <i>preferata uzantnomo</i>Ne timu. Vi povas krei la novan Auth Metodon en Open-AudIT kaj la Enterprise Application en Entra kaj kiam uzanto provas subskribi al Open-AudIT sen antaŭekzista uzanto, kontroli la tagalojn kaj vi vidos ilian <i>preferata uzantnomo</i> Kaj vi venis al via batalo.';

$GLOBALS["lang"]['To use this Enterprise feature, you first need to create your user in Open-AudIT as per usual. Assigning a password is not necessary. You do have to assign Roles and Orgs. The username in Open-AudIT should match the OKTA <i>name</i> attribute. There is no need for a Full Name or Email - these will be populated from OKTA. If you do not know your users <i>name<i>, fear not. You can create the new Auth Menthod in Open-AudIT and the Application in OKTA and when a user attempts to sign-on to Open-AudIT without a pre-existing user, check the logs and you will see their <i>name<i> logged for your convienence.<br></p><p>Then create a new Auth method in Open-AudIT by going to menu -> Admin -> Auth Methods -> Create Auth. Provide a name and set the <i>type</i> to Okta.'] = 'Por uzi tiun Enterprise trajton, vi unue devas krei vian uzanton en Open-AudIT kiel per kutima. Ne necesas pasvorton. Vi devas asigni rolojn kaj orgojn. La uzantnomo en Open-AudIT devus egali la OKTA <i>nomo</i> atribu. Ekzistas neniu bezono de plena nomo aŭ retpoŝto - tiuj estos loĝitaj de OKTA. Se vi ne konas viajn uzantojn <i>nomo<i>Ne timu. Vi povas krei la novan Auth Menthod en Open-AudIT kaj la Aplikiĝon en OKTA kaj kiam uzanto provas subskribi al Open-AudIT sen antaŭekzista uzanto, kontroli la tagalojn kaj vi vidos ilian <i>nomo<i> Kaj vi venis al via batalo.<br/><p>Tiam krei novan Auth-metodon en Open-AudIT irante al menuo -> Admin -> Auth Metodoj -> Krei Auth. Prenu nomon kaj metis la <i>tipo tipo tipo tipo</i> Okta.</p></i></i></i></i>';

$GLOBALS["lang"]['To use this feature you must enable the configuration items match_mac (for AWS) and match_hostname (for Azure). This will be done automatically the first time a cloud discovery is executed. For more on Open-AudITs matching rules see HERE: Matching Devices'] = 'Por uzi ĉi tiun trajton vi devas ebligi la agordon erojn matĉo_mac (por AWS) kaj matĉo_hostname (por Azure). Tio estos farita aŭtomate la unuan fojon nubotrovaĵo estas efektivigita. Por pli sur Open-AudIT-egalaj reguloj vidas ĉi tie: Matching Devices';
...
$GLOBALS["lang"]['Top Nmap TCP Ports. The top 10, 100, 1000 ports to scan as per Nmaps &quot;top ports&quot; options.'] = 'Top Nmap TCP Havenoj. La supraj 10, 100, 1000 havenoj por skani kiel per Nmaps "pintaj havenoj-" opcioj.';

$GLOBALS["lang"]['Top Nmap UDP Ports'] = 'Top Nmap UDP Ports';

$GLOBALS["lang"]['Top Nmap UDP Ports. The top 10, 100, 1000 ports to scan as per Nmaps &quot;top ports&quot; options.'] = 'Top Nmap UDP Havenoj. La supraj 10, 100, 1000 havenoj por skani kiel per Nmaps "pintaj havenoj-" opcioj.';
...
$GLOBALS["lang"]['Troubleshooting'] = 'Problemoj';
...
$GLOBALS["lang"]['Type: This can be either a varchar (a text field) or a List (a list of values that can be selected).'] = 'Tipo: Tio povas esti aŭ varchar (tekstokampo) aŭ Listo (listo de valoroj kiuj povas esti selektitaj).';
...
$GLOBALS["lang"]['Undergo Stage 1 audit (documentation review)'] = 'Subgo Stage 1 revizio (dokumentadrevizio)';

$GLOBALS["lang"]['Undergo Stage 2 audit (implementation review)'] = 'Undergo Stage 2 revizio (efektiviga revizio)';
...
$GLOBALS["lang"]['Update Vulnerabilities'] = 'Ĝisdatigo de Vulnerabilities';
...
$GLOBALS["lang"]['Use Service Version Detection. When a detected port is detected as open, if set to <i>y</i>, Nmap will query the target device in an attempt to determine the version of the service running on this port.<br>This can be useful when identifying unclassified devices. This was not previously used.'] = 'Uzu version de la versio. Kiam detektita haveno estas detektita kiel malferma, se metite al <i>y y</i>Nmap query la celaparato en provo determini la version de la servo kuranta sur tiun havenon.<br/>Tio povas esti utila kiam identigi nesekretajn aparatojn. Tio ne estis antaŭe uzata.';

$GLOBALS["lang"]['Use WMI'] = 'Uzu WMI';

$GLOBALS["lang"]['Use a <i>Sign-in method</i> of OIDC - OpenID Connect and an <i>Application Type</i> of Web Application. Click <i>Next</i>.'] = 'Uzu la <i>Sign-in-metodo</i> OIDC - OpenID Konektu kaj <i>Apliki tipon</i> Web Application. Klaku al Click <i>La sekva</i>.';

$GLOBALS["lang"]['Use for Authentication'] = 'Uzo por Authentication';

$GLOBALS["lang"]['Use for Roles'] = 'Uzo por roloj';

$GLOBALS["lang"]['Use the standard install options when displayed and click the <i>I Agree</i>, <i>Next</i> and <i>Install</i> buttons to install Nmap.'] = 'Uzu la normajn instalajn opciojn kiam montrite kaj klakas la <i>Mi agras</i>, <i>La sekva</i> kaj <i>Instalgio</i> butonoj por instali Nmap.';
...
$GLOBALS["lang"]['Users work similar to Netstat Ports. If a user exists with a matching name, status and password details (changeable, expires, required) then the policy passes.'] = 'Uzantoj laboras similaj al Netstat Ports. Se uzanto ekzistas kun egala nomo, statuso kaj pasvorton detaloj (ŝanĝeblaj, eksvalidiĝas, postulis) tiam la politiko pasas.';

$GLOBALS["lang"]['Users, Roles and Orgs'] = 'Uzantoj, Roloj kaj Orgs';

$GLOBALS["lang"]['Uses the CodeIgniter PHP Framework.'] = 'Uzu la kodon Igniter PHP Framework.';
...
$GLOBALS["lang"]['Values: In the case of a <i>list</i> field, this should be a comma separated list of valid values.'] = 'Valoroj: En la kazo de la <i>listo de listo</i> kampo, tio devus esti komma apartigita listo de validaj valoroj.';
...
$GLOBALS["lang"]['Vulnerabilities initially published before 1st January, 2025 (by default). We see no sense in returning vulnerabilities from years prior. This can be changed in the configuration.'] = 'Vulnerabilities komence publikigis antaŭ 1 januaro 2025 ( defaŭlte). Ni vidas neniun sencon en resendado de vundeblecoj de jaroj prioro. Tio povas esti ŝanĝita en la konfiguracio.';
...
$GLOBALS["lang"]['WARNING - When creating a baseline using software policies, at present Centos and RedHat package the kernel using the names <i>kernel</i> and <i>kernel-devel</i>. There can be multiple packages with this name and different versions concurrently installed. Debian based distributions use names like <i>linux-image-3.13.0-24-generic</i>, note the version number is included in the package name. Because RedHat based operating systems use this format and subsequently have multiple identical package names with different versions we currently exclude <i>kernel</i> and <i>kernel-devel</i> from software policies. This may be addressed in a future update.'] = 'WARNING - Dum kreado de bazlinio uzanta softvarpolitikojn, ĉe nunaj Centoj kaj RedHat enpakas la kernon uzantan la nomojn <i>kerno</i> kaj <i>kerno-devel</i>. Povas ekzisti multoblaj pakaĵoj kun tiu nomo kaj malsamaj versioj samtempe instalis. Debiano bazigis distribuojn utiligas nomojn kiel <i>Linŭ-image-3.13.0-24-generic</i>Notu ke la versionombro estas inkludita en la pakaĵnomo. Ĉar RedHat bazigis operaciumojn uzas tiun formaton kaj poste havas multoblajn identajn pakaĵonomojn kun malsamaj versioj kiujn ni nuntempe ekskludas. <i>kerno</i> kaj <i>kerno-devel</i> de softvaraj politikoj. Tio povas esti traktita en estonta ĝisdatigo.';

$GLOBALS["lang"]['WHERE'] = '→ Eventoj:';

$GLOBALS["lang"]['WMI Credentials Requirements'] = 'WMI Credentials Postuloj';

$GLOBALS["lang"]['Wait for it to complete, then paste in this next line to install the Agent.'] = 'Atendu ĝin por kompletigi, poste en tiu venonta linio por instali la agenton.';
...
$GLOBALS["lang"]['We also have an option to Ping Before Scan (important for routers with long lived ARP caches). This is usually a good idea.'] = 'Ni ankaŭ havas opcion al Ping Before Scan (grava por itinerantoj kun longe vivis ARP-deponejojn). Tio estas kutime bona ideo.';

$GLOBALS["lang"]['We also have our action items (which are executed in the order below):'] = 'Ni ankaŭ havas niajn agobjektojn (kiuj estas efektivigitaj en la sinsekvo malsupre):';

$GLOBALS["lang"]['We are often asked this question and the answer most definitely is <i>it depends</i>. It depends on the number of IPs to be scanned, the network connection speed, the speed of the devices being scanned, the type of devices being scanned, the number of different credentials being tested and the speed of the Open-AudIT server. We do not have a calculator that would allow us to input those variables and return a value. It is simply too complex. Generally I limit my discoveries to 256 IP addresses - ie, a /24 subnet. We have had customers scan /16 subnets (65k addresses) and it does work - but it can take a long time. You are much better off scanning in /24 blocks. If you simply do not know what your address ranges are, then this is a good case for a Seed discovery.'] = 'Ni ofte demandas tiun demandon kaj la respondo plej sendube estas <i>dependas</i>. Ĝi dependas de la nombro da IPoj por esti skanita, la sendostacia ligorapideco, la rapideco de la aparatoj estantaj skanita, la speco de aparatoj estantaj skanita, la nombro da malsamaj akreditaĵoj estantaj testita kaj la rapideco de la Open-AudIT-servilo. Ni ne havas kalkulilon kiu permesus al ni enigi tiujn variablojn kaj resendi valoron. Ĝi estas tro kompleksa. Ĝenerale mi limigas miajn eltrovaĵojn al 256 IP-adresoj - t.e., /24 subreto. Ni havis klientojn skani / 16 subretojn (65k adresoj) kaj ĝi funkcias - sed ĝi povas preni longan tempon. Vi estas multe pli bone skana en /24 blokoj. Se vi simple ne scias, kion viaj adresaroj estas, tiam tio estas bona kazo por Seita malkovro.';
...
$GLOBALS["lang"]['We initially setup the default list of scripts with the default options. The list of script is viewable at /scripts. These default scripts cannot be deleted. You can create additional scripts for use by you as required. Your script will be based on one of the existing scripts and have custom options applied. The scripts can then be downloaded from the list page at menu: Discover -> Audit Scripts -> List Audit Scripts.'] = 'Ni komence aranĝos la defaŭltan liston de manuskriptoj kun la defaŭltaj opcioj. La listo de manuskripto estas rigardebla ĉe /manuskriptoj. Tiuj defaŭltaj manuskriptoj ne povas esti forigitaj. Vi povas krei kromajn manuskriptojn por uzo de vi kiel postulate. Via manuskripto estos bazita sur unu el la ekzistantaj manuskriptoj kaj havas kutimo eblojn aplikitaj. La manuskriptoj tiam povas esti elŝutitaj de la listpaĝo ĉe menuo: Malkovru -> Audit Scripts -> List Audit Scripts.';
...
$GLOBALS["lang"]['Welcome to'] = 'Bonvenon al';
...
$GLOBALS["lang"]['What about fields that I want from NMIS that are not in Open-AudIT? We have got you covered. Any fields in the external system (NMIS) that do not exist in Open-AudIT will be automatically created as Open-AudIT Custom fields.'] = 'Kion mi volas de NMIS kiu ne estas en Open-AudIT? Ni kovris vin. Ĉiuj kampoj en la ekstera sistemo (NMIS) kiuj ne ekzistas en Open-AudIT estos aŭtomate kreitaj kiel Open-AudIT Custom kampoj.';

$GLOBALS["lang"]['What about other network devices? Think switches, routers, printers, etc. Obviously, it is best if you can provide some SNMP credentials for these devices. They only need <i>read-only</i> access. But if you do not want to do even that, there is nothing stopping you from running discovery, finding the devices, and making a rule or two to identify them (maybe use MAC Address prefix in combination with open ports, for example). You wont have much information, but you will know they are on the network, what they are, and when the last time they were seen was. You will also see if anything new appears on the network.'] = 'Kio pri aliaj retaparatoj? Pensu ŝaltilojn, ekskursoŝipojn, printilojn, ktp. Ĝi estas plej bona se vi povas disponigi kelkajn SNMP-kreditaĵojn por tiuj aparatoj. Ili nur bezonas <i>Legu nur</i> aliron. Sed se vi ne volas fari eĉ ke, ekzistas nenio ĉesanta vin de prizorgado de eltrovaĵo, trovante la aparatojn, kaj farante regulon aŭ du identigi ilin (eble uzi MAC Address prefikson en kombinaĵo kun malfermaj havenoj, ekzemple). Vi havas multe da informoj, sed vi scios ke ili estas sur la reto, kion ili estas, kaj kiam la lasta tempo ili estis viditaj estis. Vi ankaŭ vidos ĉu io nova aperas sur la reto.';
...
$GLOBALS["lang"]['When Open-AudIT on Linux discovers a Windows machine, in order to execute a remote command we use'] = 'Kiam Open-AudIT sur Linukso malkovras Fenestrojn, por efektivigi malproksiman komandon kiun ni uzas.';
...
$GLOBALS["lang"]['When creating a widget, if you select the <i>Advanced</i> button you will have the ability to upload your own custom SQL.'] = 'Se vi elektas la kukon, se vi elektas la <i>Progresinta</i> Butono vi havos la kapablon alŝuti vian propran kutimon SQL.';
...
$GLOBALS["lang"]['When investigating a Discovery, support will request the Exported Discovery Logs. To retrieve these, go to menu -> Discoveries ->'] = 'Dum esplorado de Discovery, subteno petos la Eksportitan Discovery Logs. Por preni tiujn, iru al menuo - Eltrovaĵoj ->';
...
$GLOBALS["lang"]['When running Open-AudIT on Windows the Apache service account must be that of a <i>regular</i> user (or the Administrator). This is because the <i>Local System</i> account normally used to run Apache has no access to any network resources. IE - We cannot use Apache when running as the Local System account account to copy the audit script to Windows PCs.'] = 'Dum prizorgado de Open-AudIT sur Fenestroj la apaĉservkonto devas esti tiu de apaĉo <i>Regula regula</i> uzanto (aŭ la administranto). Tio estas ĉar la <i>Loka sistemo</i> Raporto normale uzita por prizorgi apaĉon havas neniun aliron al iuj sendostaciaj resursoj. IE - Ni ne povas uzi apaĉ kiam kurante kiel la Loka Sistemo-konto-konto por kopii la reviziomanuskripton al Fenestroj.';

$GLOBALS["lang"]['When the configuration option is set, we take this into account for devices for a certain defined subset of match rules where the configuration item has been enabled. These rules are:'] = 'Kiam la agordo opcio estas metita, ni prenas tion en raporton por aparatoj por certa difinita subaro de matĉoreguloj kie la konfiguraciobjektoj estis ebligitaj. Tiuj reguloj estas:';

$GLOBALS["lang"]['When the rules run in discovery, any matching rules will appear in the discovery log. See below for an example.'] = 'Kiam la reguloj kuras en eltrovaĵo, ĉiuj egalaj reguloj aperas en la eltrovaĵoregistro. Vidu sube por ekzemplo.';
...
$GLOBALS["lang"]['When using Open-AudIT Professional or Enterprise, widgets are available and customisable to be displayed on Dashboards.'] = 'Dum uzado de Open-AudIT Professional aŭ Enterprise, widgets estas haveblaj kaj adaptitaj por esti elmontritaj sur Dashboards.';

$GLOBALS["lang"]['When we are converting an internally selected device to an object for the external system, what should the external data be. EG: integer, string, etc.'] = 'Kiam ni transformas interne elektitan aparaton al objekto por la ekstera sistemo, kio devus la eksteraj datenoj esti. EG: entjero, ŝnuro, ktp.';
...
$GLOBALS["lang"]['Which network should we discover. This should be in the format of'] = 'kiun reton ni devus malkovri. Tio devus esti en la formato de';
...
$GLOBALS["lang"]['Wide area network'] = 'Larĝa areoreto';
...
$GLOBALS["lang"]['Widgets are designed to be used on Dashboards. Enterprise users have complete freedom to create, update and delete widgets as required.'] = 'Widgets estas dizajnita por esti uzita sur Dashboards. Enterprise uzantoj havas kompletan liberecon por krei, ĝisdatigi kaj forigi widgets kiel postulate.';
...
$GLOBALS["lang"]['You are able to define extra directories to be scanned as entries in the Executables collection. When defined, the directory and all sub-directories are scanned for files that are executable. You can also define directories and files to be excluded. When activated, these are injected into the linux audit script and performed whenever it is run (usually as part of a discovery). If you want these in a script you can manually copy to the target, use menu -> Discover -> Scripts -> List Scripts and download the script from there.'] = 'Vi povas difini ekstrajn adresarojn por esti skanitaj kiel kontribuoj en la Executables kolekto. Se difinite, la adresaro kaj ĉiuj sub-direktoj estas skanitaj por dosieroj kiuj estas efektivigeblaj. Vi ankaŭ povas difini adresarojn kaj dosierojn esti ekskluditaj. Se aktivigite, tiuj estas injektitaj en la linŭrevizian manuskripton kaj rezultis kiam ajn ĝi estas prizorgita (kutime kiel parto de eltrovaĵo). Se vi deziras tiujn en manuskripto vi povas mane kopii al la celo, uzi menuon - Malkovru -> List Scripts kaj elŝutas la manuskripton de tie.';

$GLOBALS["lang"]['You are always free to modify the audit scripts themselves to suit your specific requirements. You will need to (re)incorporate those changes whenever you upgrade as they will be overwritten by the default scripts. I would suggest saving a master copy of your modified script, upgrading Open-AudIT, then running a diff between the new default script and your modified script and applying the differences. The audit scripts are native scripts (Windows is VBScript, all others are Bash). Simple and easy to modify - just make sure to have a copy of your changes before you upgrade.'] = 'Vi ĉiam estas libera modifi la reviziomanuskriptojn mem por konveni viajn specifajn postulojn. Vi bezonos (re) imunigi tiujn ŝanĝojn kiam ajn vi ĝisdatigas kiam ili estos overskribitaj per la defaŭltaj manuskriptoj. Mi rekomendas ŝpari majstran kopion de via modifita manuskripto, ĝisdatigante Open-AudIT, tiam kurante fosaĵon inter la nova defaŭlta manuskripto kaj via modifita manuskripto kaj uzante la diferencojn. La reviziomanuskriptoj estas indiĝenaj manuskriptoj (Windows estas VBScript, ĉiuj aliaj estas Bash). Simpla kaj facila por modifi - nur certigu havi kopion de viaj ŝanĝoj antaŭ vi ĝisdatigas.';

$GLOBALS["lang"]['You are running version'] = 'Vi kuras versio';

$GLOBALS["lang"]['You can access the collection using the normal Open-AudIT JSON based API. Just like any other collection. Please see'] = 'Vi povas aliri la kolekton uzante la normalan Open-AudIT JSON bazigis API. Same kiel iu alia kolekto. Bonvolu vidi';

$GLOBALS["lang"]['You can also'] = 'Ankaŭ vi povas';

$GLOBALS["lang"]['You can also see at the bottom of the page a table showing the devices the changes will be applied to.'] = 'Vi ankaŭ povas vidi ĉe la fundo de la paĝo tablon montrantan la aparatojn kiujn la ŝanĝoj estos aplikitaj al.';

$GLOBALS["lang"]['You can also specify properties using the below format.'] = 'Vi ankaŭ povas precizigi trajtojn uzante la sub formato.';

$GLOBALS["lang"]['You can always run the Firstwave VM on your virtual infrastructure (ESX, Azure, et al). The Firstwave VM runs Debian linux and is free from OS licensing concerns and limitations. Or install on your own Linux distro of choice. We support Redhat 9, Ubuntu 20.04, 22.04 and 24.04 as well as Debian 11 and 12.'] = 'Vi ĉiam povas kuri la unuaondo VM sur via virtuala infrastrukturo (ESX, Azure, et al). La Firstwave VM prizorgas Debian linŭ kaj estas libera de Os licencadzorgoj kaj limigoj. Aŭ instali sur via propra Linukso-distro de elekto. Ni apogas Redhat 9, Ubuntu 20.04, 22.04 kaj 24.04 same kiel Debian 11 kaj 12.';

$GLOBALS["lang"]['You can assign devices to a location automatically using'] = 'Vi povas asigni aparatojn al loko aŭtomate uzante';

$GLOBALS["lang"]['You can assign devices using custom'] = 'Vi povas asigni aparatojn uzante kutimon';

$GLOBALS["lang"]['You can audit a remote machine without the using the actual Administrator account by creating a registry key. Create the below key on every machine to be audited and make sure the user credentials used is a member of the Administrators group.'] = 'Vi povas revizii malproksiman maŝinon sen la uzado de la fakta Administranto-konto kreante registroŝlosilon. Kreu la subŝlosilon sur ĉiu maŝino por esti reviziita kaj certigi la uzantakreditaĵojn uzitajn estas membro de la administrantoj grupo.';

$GLOBALS["lang"]['You can certainly run a discovery without any valid credentials on the devices within the network, however, the information retrieved will be a very small subset of what Open-AudIT has the ability to retrieve <i>with</i> credentials.'] = 'Vi povas certe kuri eltrovaĵon sen iuj validaj akreditaĵoj sur la aparatoj ene de la reto, aliflanke, la informoj prenitaj estos tre malgranda subaro de kio Open-AudIT havas la kapablon preni <i>kun</i> akreditaĵoj.';

$GLOBALS["lang"]['You can create a baseline, run it against a group of devices and view the results, add scheduled execution, add more tables for comparison (currently only software, netstat ports and users are enabled), in place baseline editing, archiving of results and more.'] = 'Vi povas krei bazlinion, prizorgi ĝin kontraŭ grupo de aparatoj kaj rigardi la rezultojn, aldoni planitan ekzekuton, aldoni pli da tabloj por komparo (nuntempe nur softvaro, retstat havenoj kaj uzantoj estas ebligitaj), en loko bazlinia redaktado, arkivado de rezultoj kaj pli.';

$GLOBALS["lang"]['You can create a script with all the options for any of the existing audit scripts - not just Windows. AIX, ESX, Linux, OSX and Windows are all covered.'] = 'Vi povas krei manuskripton kun ĉiuj opcioj por iuj da la ekzistantaj reviziomanuskriptoj - ne ĵus Fenestroj. AIX, ESX, Linukso, OSX kaj Fenestroj estas ĉiuj kovritaj.';

$GLOBALS["lang"]['You can customize the entire integration down to which system (NMIS or Open-AudIT) is the authority on a per field basis. There are options to create and/or update devices in Open-AudIT or NMIS. Should we run a discovery on a created or updated device and so much more. There are explanations for each item on the right side of the page.'] = 'Vi povas personecigi la tuta integriĝo malsupren al kiu sistemo (NMIS aŭ Open-AudIT) estas la aŭtoritato sur per kampobazo. Ekzistas opcioj krei kaj/aŭ ĝisdatigi aparatojn en Open-AudIT aŭ NMIS. Se ni havas eltrovaĵon sur kreita aŭ ĝisdatigita aparato kaj tiel multe pli. Ekzistas klarigoj por ĉiu objekto sur la dekstra flanko de la paĝo.';

$GLOBALS["lang"]['You can define an application and associate a device to this application. A device may be associated to more than one application. An application may be associated to more than one device.'] = 'Vi povas difini aplikaĵon kaj asocii aparaton al ĉi tiu aplikaĵo. Aparato povas esti asociita kun pli ol unu aplikaĵo. Apliko povas esti asociita al pli ol unu aparato.';

$GLOBALS["lang"]['You can edit the value of the Additional Field for each individual device on the device details page. View the device details screen, open the section containing the field and (if you have'] = 'Vi povas redakti la valoron de la Additional Field por ĉiu individua aparato sur la aparato detalpaĝo. Vidu la aparaton detalekrano, malfermas la sekcion enhavantan la kampon kaj (se vi havas';
...
$GLOBALS["lang"]['You can manually assign devices using'] = 'Vi povas mane asigni aparatojn uzante';

$GLOBALS["lang"]['You can override this by providing the format option in the URL.'] = 'Vi povas superregi tion disponigante la formatelekton en la URL.';

$GLOBALS["lang"]['You can select individual devices by clicking their check-boxes on the right side or selecting all devices clicking the checkbox on the top right of the table (underneath the Edit button that looks like a pencil).'] = 'Vi povas selekti individuajn aparatojn klakante iliajn kontrolkestojn sur la dekstra flanko aŭ selektante ĉiujn aparatojn klakante la kontrolkeston dekstraflanke de la tablo (sub la Edit-butono kiu aspektas kiel krajono).';

$GLOBALS["lang"]['You can select the devices to be integrated by choosing any attribute in the system (device) table and matching (see menu → Admin → Database → List Tables → system for a list of fields). An attribute match can only match a single value.'] = 'Vi povas selekti la aparatojn por esti integritaj elektante ajnan atributon en la sistemo ( device) tablo kaj egala (vidu menuon → Admin → Datumbazo → List Tables → sistemo por listo de kampoj). Atributmatĉo povas nur egali ununuran valoron.';

$GLOBALS["lang"]['You can turn any server into a collector by going to menu -> Admin -> Collectors -> Make this install a Collector. You will need credentials to log on to the server this install will report in to.'] = 'Vi povas turni ajnan servilon en kolektanton irante al menuo - Admin -> kolektantoj -> Faru ĉi tiun instalin kolektanton. Vi bezonos akreditaĵojn por ensaluti al la servilo, kiun ĉi tiu instalado informos.';

$GLOBALS["lang"]['You can view by clicking on the blue view icon. You can also edit or delete if you have permissions.'] = 'Vi povas vidi per klakado sur la blua vido ikono. Vi povas redakti aŭ forigi se vi havas permeson.';

$GLOBALS["lang"]['You do not have the PHP MBString extension installed. This extension is required.'] = 'Vi ne havas la PHP MBString-etendaĵon instalita. Tiu etendaĵo estas postulata.';

$GLOBALS["lang"]['You do not have the PHP SNMP extension installed. This extension is highly recommended.'] = 'Vi ne havas la PHP SNMP-etendaĵon instalita. Tiu etendaĵo estas tre rekomendinda.';
...
$GLOBALS["lang"]['You may wish to have Active Directory or OpenLDAP authenticate your users, but not provide authorization. To do this, make sure <i>Use for Authentication</i> is set to Y and <i>Use for Roles</i> is set to N. The credentials will be validated by LDAP, but you will need to have the user already created and assigned Roles in Open-AudIT. This also <i>automatically</i> applies to'] = 'Vi povas deziri havi Aktivan Adresaron aŭ OpenLDAP aŭtentikigi viajn uzantojn, sed ne disponigi aprobon. Por fari tion, certigu <i>Uzo por Authentication</i> estas metita al Y kaj <i>Uzo por roloj</i> estas metita al N. La akreditaĵoj estos konfirmitaj fare de LDAP, sed vi bezonos havi la uzanton jam kreita kaj asignis Rolojn en Open-AudIT. Ankaŭ tio <i>aŭtomate aŭtomate aŭtomate aŭtomate</i> aplikas';

$GLOBALS["lang"]['You might have noticed these match rules are for items that might not be globally unique. Some examples:'] = 'Vi eble rimarkis ke tiuj matĉoreguloj estas por eroj kiuj eble ne estas tutmonde unikaj. Kelkaj ekzemploj:';
...
$GLOBALS["lang"]['You should not include the edited_by and edited_date fields. These will be automatically set.'] = 'Vi ne devus inkludi la redaktitan_by- kaj redaktis_datajn kampojn. Tiuj estos aŭtomate metitaj.';

$GLOBALS["lang"]['You should only change the second sentence of text, the'] = 'Vi devus nur ŝanĝi la duan frazon de teksto, la';

$GLOBALS["lang"]['You should substitute the required column (eg, org_id) for ATTRIBUTE_NAME.'] = 'Vi devus anstataŭigi la postulatan kolonon (ekz., org_id) por ATTRIBUTE_NAME.';
...
$GLOBALS["lang"]['You should use only those tables that contain attributes you need. I usually use a left join. For example'] = 'Vi devus uzi nur tiujn tabelojn kiuj enhavas atributojn vi bezonas. Mi kutime uzas maldekstran aliĝon. Ekzemple';

$GLOBALS["lang"]['You will need a'] = 'Vi bezonos';

$GLOBALS["lang"]['You will need the ports for WMI on the Windows firewall opened on each target Windows computer. For Windows Core servers, ensure you allow the firewall connections as per'] = 'Vi bezonos la havenojn por WMI sur la Fenestra fajromuro malfermita sur ĉiu celo Windows komputilo. Por Vindozo Kernaj serviloj, certigu, ke vi permesas al la fajromuraj ligoj kiel per';

$GLOBALS["lang"]['You will see a list of'] = 'Vi vidos liston de';
...
$GLOBALS["lang"]['Your data is your data. You can extract it any time you like. We even helpfully provide exports to CSV, JSON and XML. And we have a JSON API. And you can write custom reports and have those output in CSV, XML, and JSON! Again, it is your data - not anyone else. You can be confident that the security of your data is in your hands.'] = 'Viaj datumoj estas viaj datumoj. Vi povas eltiri ĝin ĉiufoje kiam vi ŝatas. Ni eĉ utile provizas eksportojn al CSV, JSON kaj XML. Ni havas JSON API. Kaj vi povas skribi kutimo raportoj kaj havi tiujn produktaĵojn en CSV, XML, kaj JSON! Denove, ĝi estas via datumo - ne iu alia. Vi povas esti certa, ke la sekureco de viaj datumoj estas en viaj manoj.';
...
$GLOBALS["lang"]['Your user should now be able to logon by clicking the <i>Logon with Entra</i> button on the Open-AudIT logon page. As mentioned above, if the logon fails, please check the logfile and verify the users <i>preferred username</i>.<br><br>And that should be all there is too it. Now your users should have one less set of credentials to remember!<br><br>As always, if you have troubles with this feature, please email'] = 'Via uzanto nun povas logoon klaki la <i>Logon kun Entra</i> butono sur la Open-AudIT-emblemopaĝo. Kiel menciite supre, se la emblemo malsukcesas, bonvolu kontroli la tagdosieron kaj konfirmi la uzantojn <i>preferata uzantnomo</i>.<br/><br/>Kaj tio devus esti ĉio tie estas ankaŭ ĝi. Nun viaj uzantoj devus havi unu malpli aron de akreditaĵoj por memori!<br/><br/>Kiel ĉiam, se vi havas problemojn kun ĉi tiu trajto, bonvolu retpoŝto';

$GLOBALS["lang"]['Your user should now be able to logon by clicking the <i>Logon with OKTA</i> button on the Open-AudIT logon page. As mentioned above, if the logon fails, please check the logfile and verify the users <i>name</i>.<br><br>And that should be all there is too it. Now your users should have one less set of credentials to remember!<br><br>As always, if you have troubles with this feature, please email'] = 'Via uzanto nun povas logoon klaki la <i>Logon kun OKTA</i> butono sur la Open-AudIT-emblemopaĝo. Kiel menciite supre, se la emblemo malsukcesas, bonvolu kontroli la tagdosieron kaj konfirmi la uzantojn <i>nomo</i>.<br/><br/>Kaj tio devus esti ĉio tie estas ankaŭ ĝi. Nun viaj uzantoj devus havi unu malpli aron de akreditaĵoj por memori!<br/><br/>Kiel ĉiam, se vi havas problemojn kun ĉi tiu trajto, bonvolu retpoŝto';
...
$GLOBALS["lang"]['and / or'] = '/ aŭ';

$GLOBALS["lang"]['and a support ticket will be created and actioned.'] = 'kaj helpbileto estos kreita kaj farita.';

$GLOBALS["lang"]['and another'] = 'kaj alia';

$GLOBALS["lang"]['and download the Latest Release self-installer. You may need to scroll down the page to find it.'] = 'Kaj elŝutu la Latesto-Liberigan meminstaliston. Vi povas devi ruligi la paĝon por trovi ĝin.';
...
$GLOBALS["lang"]['and the final lines will likely be of most interest. These lines should give you the exact point at which the login failed.'] = 'La finaj linioj verŝajne estos de plej multe de la intereso. Tiuj linioj devus doni al vi la precizan punkton ĉe kiu la tagalo malsukcesis.';
...
$GLOBALS["lang"]['are required.'] = 'estas postulataj.';

$GLOBALS["lang"]['are used.'] = 'estas uzata.';

$GLOBALS["lang"]['as a device responding on this port.<br>This has caused some customers issues where firewalls respond on behalf of a non-existing device, and hence cause false positive device detection. We now have this attribute available to set per scan.'] = 'Kiel aparato reaganta al tiu haveno.<br/>Tio kaŭzis kelkajn klienttemojn kie fajromuroj respondas nome de neekzistanta aparato, kaj tial kaŭzas malveran pozitivan aparatodetekton. Ni nun havas tiun atributon havebla al aro per skanado.';

$GLOBALS["lang"]['as the reference point and filters out all virtual machines via a check of the system.serial field for VM.'] = 'Kiel la referencopunkto kaj filtras ĉiujn virtualajn maŝinojn per kontrolo de la sistemo. seria kampo por VM.';

$GLOBALS["lang"]['assuming working and client populated DNS'] = 'Supozante labori kaj kliento loĝis DNS';
...
$GLOBALS["lang"]['can be used for user authentication (is the users name and password correct) as well as user authorization (what roles and orgs does a user have).<br><br>If a user is not in the configured LDAP but is in Open-AudIT (eg: the <i>admin</i> user), Open-AudIT will fallback to using itself for both authentication and authorization.<br><br>Open-AudIT uses specific LDAP groups for roles and orgs. A user must be a direct member of these group(s) in order for Open-AudIT to determine that users access.<br><br>When configured correctly, LDAP use can completely remove the need to create users in Open-AudIT. Simply configure Open-AudIT to use LDAP for both authentication and authorization. If the user does not exist in Open-AudIT but does exist in LDAP and their credentials are correct and they are a member of the required groups Open-AudIT will create the user account automatically.'] = 'povas esti uzita por uzantaŭtento (estas la uzantnomo kaj pasvorton ĝusta) same kiel uzantrajtigo (kio roloj kaj orgs faras uzanton havas).<br/><br/>Se uzanto ne estas en la formita LDAP sed estas en Open-AudIT (ekz. <i>Admin</i> Uzanto), Open-AudIT-falos por uzi sin por kaj konfirmo kaj aprobo.<br/><br/>Open-Aud Ĝi uzas specifajn LDAP-grupojn por roloj kaj orgoj. uzanto devas esti rekta membro de tiuj grupo (j) por Open-AudIT por determini ke uzantoj aliras.<br/><br/>Kiam formita ĝuste, LDAP-uzo povas tute forigi la bezonon krei uzantojn en Open-AudIT. Simple agordi Open-AudIT por uzi LDAP por kaj konfirmo kaj aprobo. Se la uzanto ne ekzistas en Open-AudIT sed ekzistas en LDAP kaj iliaj akreditaĵoj estas ĝustaj kaj ili estas membro de la postulataj grupoj Open-AudIT kreos la uzantkonton aŭtomate.';

$GLOBALS["lang"]['can now retrieve details about a file or directory of files and monitor these files for changes as per other attributes in the Open-AudIT database. This feature works out of the box for Linux Open-AudIT servers, but needs a change to the service account name under a Windows Open-AudIT server. Supported clients are Windows and Linux.'] = 'Nun povas preni detalojn pri dosiero aŭ adresaro de dosieroj kaj monitori tiujn dosierojn por ŝanĝoj kiel per aliaj atributoj en la Open-AudIT-datumbazo. Tiu trajto laboras el la kesto por Linukso Open-AudIT-serviloj, sed bezonas ŝanĝon al la servokontonomo sub Windows Open-AudIT-servilo. Subtenitaj klientoj estas Fenestroj kaj Linukso.';

$GLOBALS["lang"]['changed'] = 'ŝanĝiĝis';

$GLOBALS["lang"]['chosen. From there if a port for WMI, SSH or SNMP is detected responding the device is further queried using '] = 'elektita. De tie se haveno por WMI, SSH aŭ SNMP estas detektita respondante la aparaton estas plu pridemandita uzante ';

$GLOBALS["lang"]['cloud'] = 'nubo nubo';

$GLOBALS["lang"]['code'] = 'kodokodo';

$GLOBALS["lang"]['collections and details pages is an icon to execute.'] = 'kolektoj kaj detaloj paĝoj estas ikono por efektivigi.';
...
$GLOBALS["lang"]['column will contain either <i>y</i> or <i>n</i>. This indicates if this row is currently present on the device. For example software may be installed (which would result in <i>software.current = y</i>), but on a subsequent audit it may not be detected. Open-AudIT will then change this rows current attribute to <i>n</i>.'] = 'La kolumno enhavos aŭ <i>y y</i> aŭ aŭ <i>n</i>. Tio indikas se tiu vico ĉeestas nuntempe sur la aparato. Ekzemple, softvaro povas esti instalita (kiu rezultigus en <i>Komputilo = y</i>Sed sur posta revizio ĝi ne povas esti detektita. Open-AudIT tiam ŝanĝos tiun vicojn aktualan atributon al <i>n</i>.';
...
$GLOBALS["lang"]['does <strong>not</strong> provide vulnerability reports for the following'] = 'faras <strong>ne ne ne</strong> provizas vundeblecojn raportojn por la sekvanta';
...
$GLOBALS["lang"]['for this information.'] = 'por ĉi tiu informo.';

$GLOBALS["lang"]['from Audit Script Result'] = 'De Audit Script Result';

$GLOBALS["lang"]['from NMIS'] = 'de NMIS';

$GLOBALS["lang"]['from address LocalHost (Using LRPC) running in the application container'] = 'de adreso LocalHost (Using LRPC) kuranta en la aplikiĝujo';
...
$GLOBALS["lang"]['have a working reverse DNS resolvable IP to the target Windows PC.'] = 'havas laboron inversa DNS-solvebla IP al la celo Windows PC.';
...
$GLOBALS["lang"]['if you clone a Linux virtual machine, unless you manually regenerate this (and in my experience, people do not) it will remain the same.'] = 'Se vi klonas Linukso virtuala maŝino, se vi mane regeneras tion (kaj en mia sperto, homoj ne) ĝi restos la sama.';
...
$GLOBALS["lang"]['installer will test for the presence of Nmap in its standard install locations of'] = 'instalilo testos por la ĉeesto de Nmap en ĝiaj normaj instalaj lokoj de';
...
$GLOBALS["lang"]['is next on the list and Open-AudIT can use password and key authentication. Open-AudIT can also use a sudo enabled user as opposed to the root use directly (although it can also use root). For best results, the root user or a sudo enabled user should be used (see Auditing Linux without root and Target Client Configuration on the wiki). Windows devices can also run ssh, however if Open-AudIT detects this it will stop the SSH queries and instead use WMI (assuming working WMI credentials).'] = 'La listo kaj Open-AudIT povas uzi pasvorton kaj esencan konfirmon. Open-AudIT ankaŭ povas uzi sekson rajtigis uzanton kontraste al la radikuzo rekte (kvankam ĝi ankaŭ povas uzi radikon). Por plej bonaj rezultoj, la radika uzanto aŭ plonĝo rajtigis uzanton devus esti uzitaj (vidu Auditing Linukson sen radiko kaj Target Customer Configuration sur la Vikio). Fenestroj ankaŭ povas prizorgi cindron, aliflanke se Open-AudIT detektas tion ĝi ĉesigos la SSH-demandojn kaj anstataŭe uzas WMI (supozante laborajn WMI-akreditaĵojn).';
...
$GLOBALS["lang"]['key required to retrieve lat/long and display map. See'] = 'ŝlosilo postulata por preni lat/longan kaj ekranmapon. Vidu';
...
$GLOBALS["lang"]['on devices where'] = 'sur aparatoj kie';
...
$GLOBALS["lang"]['or'] = 'aŭ aŭ';

$GLOBALS["lang"]['or the GitHub page at'] = 'aŭ la GitHub-paĝo ĉe';

$GLOBALS["lang"]['other'] = 'aliaj aliaj';

$GLOBALS["lang"]['package'] = 'pakaĵoj';

$GLOBALS["lang"]['page. Export your LDAP server from menu -> Admin -> LDAP Servers -> Details to JSON and save and include this data as well.'] = 'paĝo. Eksportu vian LDAP-servilon de menuo -> Admin -> LDAP-Serviloj -> Detaloj al JSON kaj savo kaj inkludas tiujn datenojn ankaŭ.';
...
$GLOBALS["lang"]['rights) you can click on the field value to edit it.'] = 'Vi povas klaki sur la kampo valoro redakti ĝin.';
...
$GLOBALS["lang"]['service failed to start due to the following error'] = 'servo ne komenciĝis pro la sekva eraro';
...
$GLOBALS["lang"]['table'] = 'tablo tablo';

$GLOBALS["lang"]['table and insert the original rows.'] = 'tablo kaj enmetas la originajn vicojn.';

$GLOBALS["lang"]['team'] = 'Teama teamo';

$GLOBALS["lang"]['text. The first is the array index and should be left as-is. The index is used in the templates to lookup the translated text.'] = 'teksto. La unua estas la aro-indekso kaj devus esti lasita kiel-estas. La indekso estas uzita en la ŝablonoj por levi la tradukitan tekston.';

$GLOBALS["lang"]['then clicking on the details button for the table.'] = 'upon sur; pri; je upper supra; ŝudorso uppermost';

$GLOBALS["lang"]['then clicking on the details button for the table. Device details are stored in the'] = 'upon sur; pri; je upper supra; ŝudorso uppermost Device detaloj estas stokitaj en la';

$GLOBALS["lang"]['timestamp'] = 'La tempo';

$GLOBALS["lang"]['to'] = 'al la';

$GLOBALS["lang"]['to create an item of this type'] = 'krei eron de ĉi tiu tipo';

$GLOBALS["lang"]['to the URL, you will get the full database entry, including all component tables, of a given device.'] = 'Al la URL, vi ricevos la plenan databasen eniron, inkluzive de ĉiuj komponentoj tabloj, de antaŭfiksita aparato.';
...
$GLOBALS["lang"]['true or false (in JSON context)'] = 'vera aŭ falsa (en JSON kunteksto)';

$GLOBALS["lang"]['unallocated'] = 'nealirebla';

$GLOBALS["lang"]['unauthorised'] = 'neaŭtoritate';

$GLOBALS["lang"]['unchanged'] = 'senŝanĝa';
...
$GLOBALS["lang"]['uses the data collected from your devices and matches the software installed with the value provided, it counts the matches calculates how many licenses have been used and how many are left. It allows the use of wildcards on the <i>match string</i> field which matches the software.name attribute.'] = 'La datenoj kolektitaj de viaj aparatoj kaj matĉoj la programaro instalita kun la valoro provizita, ĝi kalkulas la matĉojn kalkuli kiom multaj permesiloj estis utiligitaj kaj kiom multaj estas forlasitaj. Ĝi permesas la uzon de sovaĝkartoj sur la <i>Situo de kordoj</i> kampo kiu kongruas kun la programaro. nomo atribuas.';

$GLOBALS["lang"]['using the main menu items.'] = 'Uzante la ĉefajn menuo erojn.';
...
$GLOBALS["lang"]['with devices::update permission.'] = 'Kun aparatoj: Ĝisdatpermeso.';

$GLOBALS["lang"]['with the Sign-On Redirect URI being'] = 'Kun la Sign-Sur-Ĉefo-Ambaŭo';

$GLOBALS["lang"]['with the intention of providing simple and intuitive access in a manner familiar to developers. In addition to this API, the web interface will use the same request format and supply some additional actions (eg: HTML forms for creating items).'] = 'Kun la intenco de disponigado de simpla kaj intuicia aliro en maniero konata al programistoj. Aldone al tiu API, la interretinterfaco uzos la saman peti formaton kaj provizos kelkajn kromajn agojn (ekz. HTML-formularoj por kreado de eroj).';
...
$GLOBALS["lang"]['you will assign any found devices to that Org or Location.'] = 'Vi asignas iujn ajn trovitajn aparatojn al tiu Org aŭ Loko.';
