...
$GLOBALS["lang"][', but will not need to remember a separate set of logon credentials.'] = ', mais n\'aura pas besoin de se souvenir d\'un ensemble séparé d\'identificateurs de logo.';
...
$GLOBALS["lang"]['. To enable this, edit the configuration item for '] = '. Pour cela, modifiez l\'élément de configuration pour ';
...
$GLOBALS["lang"]['A Metropolitan area network (MAN) is a large computer network that usually spans a city or a large campus.'] = 'Un réseau métropolitain (MAN) est un grand réseau informatique qui s\'étend habituellement sur une ville ou un grand campus.';

$GLOBALS["lang"]['A Seed discovery uses an initial IP to retrieve the IPs of any other devices it knows about, adds those IPs to the list and scans those - again asking for any IPs those additional devices knows about. Rinse and repeat. It is intelligent enough to know if it has already scanned a given IP in its execution and discards any already scanned (or even on the list to be scanned).'] = 'A La découverte de semences utilise une IP initiale pour récupérer les IP de tous les autres appareils qu\'elle connaît, ajoute ces IP à la liste et scanne ceux - encore une fois demander des IP de ces appareils supplémentaires. Rincer et répéter. Il est suffisamment intelligent pour savoir s\'il a déjà scanné une IP donnée dans son exécution et il rejette toute IP déjà scannée (ou même sur la liste à scanner).';

$GLOBALS["lang"]['A Subnet discovery will scan the IPs provided.'] = 'Une découverte Subnet va scanner les IP fournies.';

$GLOBALS["lang"]['A URL provided to the agent which will then download the file and store it on the local disk.'] = 'Une URL fournie à l\'agent qui téléchargera ensuite le fichier et le stockera sur le disque local.';

$GLOBALS["lang"]['A URL to a file to download.'] = 'Une URL vers un fichier à télécharger.';

$GLOBALS["lang"]['A backbone network is part of a computer network infrastructure that provides a path for the exchange of information between different LANs or sub-networks. A backbone can tie together diverse networks within the same building, across different buildings, or over a wide area.<br><br>For example, a large company might implement a backbone network to connect departments that are located around the world. The equipment that ties together the departmental networks constitutes the network backbone. When designing a network backbone, network performance and network congestion are critical factors to take into account. Normally, the backbone network capacity is greater than that of the individual networks connected to it.<br><br>Another example of a backbone network is the Internet backbone, which is the set of wide area networks (WANs) and core routers that tie together all networks connected to the Internet.'] = 'Un réseau de base fait partie d\'une infrastructure de réseau informatique qui permet d\'échanger des informations entre différents réseaux locaux ou sous-réseaux. Une colonne vertébrale peut relier différents réseaux au sein d\'un même bâtiment, entre différents bâtiments ou sur une vaste superficie.<br/><br/>Par exemple, une grande entreprise pourrait mettre en place un réseau de base pour relier les départements situés dans le monde entier. L\'équipement qui relie les réseaux ministériels constitue l\'épine dorsale du réseau. Lors de la conception d\'un réseau de base, la performance du réseau et la congestion du réseau sont des facteurs critiques à prendre en compte. Normalement, la capacité du réseau de base est supérieure à celle des réseaux individuels qui y sont connectés.<br/><br/>Un autre exemple de réseau de base est l\'épine dorsale de l\'Internet, qui est l\'ensemble de réseaux étendus (WAN) et de routeurs de base qui relient tous les réseaux connectés à Internet.';
...
$GLOBALS["lang"]['A campus area network (CAN) is made up of an interconnection of LANs within a limited geographical area. The networking equipment (switches, routers) and transmission media (optical fiber, copper plant, Cat5 cabling, etc.) are almost entirely owned by the campus tenant / owner (an enterprise, university, government, etc.).<br><br>For example, a university campus network is likely to link a variety of campus buildings to connect academic colleges or departments, the library, and student residence halls.'] = 'Un réseau d\'aires de campus (CAN) est constitué d\'une interconnexion de réseaux locaux dans une zone géographique limitée. L\'équipement de réseautage (interrupteurs, routeurs) et les supports de transmission (fibre optique, usine de cuivre, câblage Cat5, etc.) appartiennent presque entièrement au locataire/propriétaire du campus (entreprise, université, gouvernement, etc.).<br/><br/>Par exemple, un réseau de campus universitaire devrait relier divers bâtiments de campus pour relier les collèges ou départements universitaires, la bibliothèque et les résidences étudiantes.';

$GLOBALS["lang"]['A closed port is accessible (it receives and responds to Nmap probe packets), but there is no application listening on it. They can be helpful in showing that a host is up on an IP address (host discovery, or ping scanning), and as part of OS detection. Because closed ports are reachable, it may be worth scanning later in case some open up. Administrators may want to consider blocking such ports with a firewall. Then they would appear in the filtered state, discussed next.'] = 'Un port fermé est accessible (il reçoit et répond aux paquets de sondes Nmap), mais il n\'y a pas d\'application qui l\'écoute. Ils peuvent être utiles pour montrer qu\'un hôte est sur une adresse IP (découverte de l\'hôte, ou balayage de ping), et dans le cadre de la détection OS. Parce que les ports fermés sont accessibles, il peut être utile de scanner plus tard au cas où certains s\'ouvrent. Les administrateurs peuvent vouloir envisager de bloquer ces ports avec un pare-feu. Puis ils apparaîtraient à l\'état filtré, discutés ensuite.';
...
$GLOBALS["lang"]['A location name will help you to find these devices in the future.'] = 'Un nom d\'emplacement vous aidera à trouver ces appareils à l\'avenir.';
...
$GLOBALS["lang"]['A new user logged in to Open-AudIT and was authenticated and authorized by the LDAP sever. That user was then created in Open-AudIT and logged in. Success.'] = 'Un nouvel utilisateur s\'est connecté à Open-Audit et a été authentifié et autorisé par le LDAP sever. Cet utilisateur a ensuite été créé dans Open-Audit et connecté. Succès.';
...
$GLOBALS["lang"]['A person has an account in the Open-AudIT application. Their user account has a list of associated Roles and Organizations. The roles the user has determines WHAT they can do. The Organizations a user has determines WHICH items they can act upon.<br><br>When a user requests to perform an operation (create, read, update, delete) on a collection item, the roles are consulted to see if they are allowed to perform that action, then the orgs are consulted to determine if the collection item belongs to an org the user has permission to act on.'] = 'Une personne a un compte dans l\'application Open-Audit. Leur compte utilisateur contient une liste des rôles et organisations associés. Les rôles de l\'utilisateur déterminent ce qu\'ils peuvent faire. Les organisations sur lesquelles l\'utilisateur détermine sur quels éléments il peut agir.<br/><br/>Lorsqu\'un utilisateur demande à effectuer une opération (créer, lire, mettre à jour, supprimer) sur un élément de collection, les rôles sont consultés pour voir s\'ils sont autorisés à effectuer cette action, alors les orgs sont consultés pour déterminer si l\'élément de collection appartient à un org l\'utilisateur a la permission d\'agir.';

$GLOBALS["lang"]['A personal area network (PAN) is a computer network used for communication among computer and different information technological devices close to one person. Some examples of devices that are used in a PAN are personal computers, printers, fax machines, telephones, PDAs, scanners, and even video game consoles. A PAN may include wired and wireless devices. The reach of a PAN typically extends to 10 meters. A wired PAN is usually constructed with USB and FireWire connections while technologies such as Bluetooth and infrared communication typically form a wireless PAN.'] = 'Un réseau de zones personnelles (PAN) est un réseau informatique utilisé pour la communication entre les ordinateurs et différents dispositifs technologiques de l\'information proches d\'une personne. Quelques exemples d\'appareils utilisés dans un PAN sont les ordinateurs personnels, les imprimantes, les télécopieurs, les téléphones, les PDA, les scanners et même les consoles de jeux vidéo. Un PAN peut comprendre des appareils filaires et sans fil. La portée d\'un PAN s\'étend généralement à 10 mètres. Un PAN câblé est généralement construit avec des connexions USB et FireWire tandis que des technologies comme le Bluetooth et la communication infrarouge forment généralement un PAN sans fil.';

$GLOBALS["lang"]['A query is essentially a SQL statement. This statement is run against the database with the automatic addition of the limit, filtered to apply to only those requested items and only those items the user has permission to view. A Query can be created using menu -> Manage -> Queries -> Create Queries. Queries contain an org_id and are hence restricted to the appropriate users. A user must have the org_admin or reporter role(s) to create, update or delete a query. All users can execute a query. A query has a name attribute used for the menu item as well as a menu category attribute. This tells the Open-Audit GUI which submenu to place the query in. There is also menu display which should be set to <i>y</i> to enable the query in the GUI (<i>n</i> to prevent the query from appearing at all). The query would still run if called using its <code>id</code>, regardless of menu displays value.'] = 'Une requête est essentiellement une requête SQL. Cette déclaration est exécutée contre la base de données avec l\'ajout automatique de la limite, filtrée pour s\'appliquer uniquement aux éléments demandés et à ceux que l\'utilisateur a la permission de voir. Une requête peut être créée en utilisant le menu -> Gérer -> Questions -> Créer des questions. Les requêtes contiennent un org_id et sont donc limitées aux utilisateurs appropriés. Un utilisateur doit avoir le(s) rôle(s) org_admin ou reporter pour créer, mettre à jour ou supprimer une requête. Tous les utilisateurs peuvent exécuter une requête. Une requête a un attribut de nom utilisé pour l\'élément de menu ainsi qu\'un attribut de catégorie de menu. Cela indique à l\'interface graphique ouverte dans quel sous-menu placer la requête. Il y a aussi l\'affichage de menu qui doit être réglé à <i>y</i> pour activer la requête dans l\'interface graphique (<i>n</i> pour empêcher l\'apparition de la requête). La requête serait toujours exécutée si appelé en utilisant son <code>id</code>, quel que soit le menu affiche la valeur.';

$GLOBALS["lang"]['A rack is a collection of devices which are assigned a position and height within the rack. A device can optionally have a picture associated with it. A rack is placed in a row. We have created a very granular system for positioning of racks, which is as follows. At the top level (as always) is the Organisation (Org). An Org can have multiple locations (as has always been the case). With the addition of the Racks feature, a location can now contain one or more Buildings. A building can contain one or more Floors. A floor can contain one or more Rooms. A room can contain one or more Rows. This sounds like a lot of work, but defaults are created for you. Create a new Location and the sub-components will be automatically created for you. If you need more items (buildings, rooms, etc) you can add them as you like. A rack can also be part of a <i>pod</i> of racks. The pod attribute works as a tag, rather than a strict hierarchical inheritance model as per buildings, floors, etc.<br><br>Racks are a feature available to Open-AudIT Enterprise licensed customers.'] = 'Un rack est une collection de dispositifs qui sont assignés une position et une hauteur dans le rack. Un appareil peut en option avoir une image associée. Un rack est placé dans une rangée. Nous avons créé un système très granulaire pour le positionnement des racks, qui est comme suit. Au niveau supérieur (comme toujours) se trouve l\'Organisation (Org). Un Org peut avoir plusieurs emplacements (comme cela a toujours été le cas). Avec l\'ajout de la fonction Racks, un emplacement peut maintenant contenir un ou plusieurs bâtiments. Un bâtiment peut contenir un ou plusieurs étages. Un étage peut contenir une ou plusieurs chambres. Une pièce peut contenir une ou plusieurs rangées. Cela ressemble à beaucoup de travail, mais par défaut sont créés pour vous. Créez un nouveau lieu et les sous-composants seront automatiquement créés pour vous. Si vous avez besoin de plus d\'articles (bâtiments, chambres, etc) vous pouvez les ajouter comme vous voulez. Un rack peut également faire partie d\'un <i>pod</i> des racks. L\'attribut pod fonctionne comme une balise, plutôt qu\'un modèle hiérarchique d\'héritage strict selon les bâtiments, les planchers, etc.<br/><br/>Les racks sont une fonctionnalité disponible pour les clients autorisés Open-Audit Enterprise.';
...
$GLOBALS["lang"]['A seed discovery is another type of discovery, where you provide the IP of a single <i>seed</i> device. This device is audited, and any IPs it knows are then added to the list of IPs to be audited. Then, those devices are audited and any IPs they know are also added to the list of IPs for auditing. This process then continues within the parameters configured by the user.'] = 'Une découverte de semences est un autre type de découverte, où vous fournissez l\'IP d\'un seul <i>de semence</i> dispositif. Cet appareil est vérifié et tous les IP qu\'il connaît sont ensuite ajoutés à la liste des IP à vérifier. Ensuite, ces dispositifs sont audités et tous les IP qu\'ils connaissent sont également ajoutés à la liste des IP pour l\'audit. Ce processus se poursuit ensuite dans les paramètres configurés par l\'utilisateur.';

$GLOBALS["lang"]['A short description of the log entry.'] = 'Une brève description de l\'entrée du journal.';

$GLOBALS["lang"]['A storage area network (SAN) is a dedicated network that provides access to consolidated, block level data storage. SANs are primarily used to make storage devices, such as disk arrays, tape libraries, and optical jukeboxes, accessible to servers so that the devices appear like locally attached devices to the operating system. A SAN typically has its own network of storage devices that are generally not accessible through the local area network by other devices. The cost and complexity of SANs dropped in the early 2000s to levels allowing wider adoption across both enterprise and small to medium-sized business environments.'] = 'Un réseau de zone de stockage (SAN) est un réseau dédié qui permet d\'accéder au stockage de données de niveau bloc consolidé. Les SAN sont principalement utilisés pour rendre les périphériques de stockage, tels que les réseaux de disques, les bibliothèques de bandes et les jukebox optiques, accessibles aux serveurs de sorte que les périphériques apparaissent comme des périphériques fixés localement au système d\'exploitation. Un SAN possède généralement son propre réseau d\'appareils de stockage qui ne sont généralement pas accessibles par le réseau local par d\'autres appareils. Le coût et la complexité des PAN ont chuté au début des années 2000 à des niveaux permettant une adoption plus large tant dans les entreprises que dans les petites et moyennes entreprises.';
...
$GLOBALS["lang"]['Access Model'] = 'Modèle d\'accès';
...
$GLOBALS["lang"]['Access to the admin$ share and RPC uses the SMB2 protocol.'] = 'L\'accès au partage admin$ et RPC utilise le protocole SMB2.';
...
$GLOBALS["lang"]['After an Integration has been created, when you view the details of an Integration you will notice a field named Debug. This is set to no by default. Changing it to yes provides extra logging when an Integration is executed. Debug should not be left as yes. This is because the debug output will contain everything retrieved from external systems - including items such as WMI and SNMP credentials. The debug option should be used only when an issue has occurred and you wish to dig deeper in to see if you can determine why.'] = 'Après la création d\'une intégration, lorsque vous consultez les détails d\'une intégration, vous remarquerez un champ nommé Debug. Ceci est défini à non par défaut. Le modifier en oui fournit une session supplémentaire lorsqu\'une intégration est exécutée. Le débogage ne devrait pas être laissé comme oui. C\'est parce que la sortie de débogage contiendra tout ce qui a été récupéré des systèmes externes - y compris des éléments tels que les identifiants WMI et SNMP. L\'option de débogage ne doit être utilisée que lorsqu\'un problème s\'est produit et vous souhaitez approfondir votre recherche pour voir si vous pouvez déterminer pourquoi.';

$GLOBALS["lang"]['After completing the above, uninstall the agent.'] = 'Après avoir complété ce qui précède, désinstallez l\'agent.';
...
$GLOBALS["lang"]['All device sub-tables contain a couple of important columns.'] = 'Toutes les sous-tables de l\'appareil contiennent quelques colonnes importantes.';

$GLOBALS["lang"]['All devices with a type like computer.'] = 'Tous les appareils avec un type comme un ordinateur.';

$GLOBALS["lang"]['All devices with a type of computer or router.'] = 'Tous les appareils avec un type d\'ordinateur ou de routeur.';
...
$GLOBALS["lang"]['All tasks can be created the same in Windows and Linux. Tasks use the CRON method for scheduling execution.'] = 'Toutes les tâches peuvent être créées de la même manière dans Windows et Linux. Les tâches utilisent la méthode CRON pour planifier l\'exécution.';

$GLOBALS["lang"]['Along with this request for information, we send back to FirstWave datapoints that will give us some much needed information on feature use and your installation.'] = 'En plus de cette demande d\'informations, nous renvoyons aux points de données FirstWave qui nous donneront quelques informations très nécessaires sur l\'utilisation des fonctionnalités et votre installation.';
...
$GLOBALS["lang"]['An Org (organization) is the owner of most items in collections within Open-AudIT. With the exception of global items like <i>configuration</i>, most items are assigned to (owned by) an Org. A user has access to those items in a collection, that below to an Org the user has permission on.'] = 'Un Org (organisation) est le propriétaire de la plupart des objets dans les collections dans Open-Audit. À l\'exception des articles mondiaux comme <i>configuration</i>, la plupart des articles sont attribués à (propriété) un Org. Un utilisateur a accès à ces éléments dans une collection, qui ci-dessous à un Org l\'utilisateur a la permission sur.';

$GLOBALS["lang"]['An application is actively accepting TCP connections, UDP datagrams or SCTP associations on this port. Finding these is often the primary goal of port scanning. Security-minded people know that each open port is an avenue for attack. Attackers and pen-testers want to exploit the open ports, while administrators try to close or protect them with firewalls without thwarting legitimate users. Open ports are also interesting for non-security scans because they show services available for use on the network.'] = 'Une application accepte activement les connexions TCP, les datagrammes UDP ou les associations SCTP sur ce port. C\'est souvent le but principal de la numérisation des ports. Les gens soucieux de la sécurité savent que chaque port ouvert est une voie d\'attaque. Les attaquants et les testeurs de stylos veulent exploiter les ports ouverts, tandis que les administrateurs essaient de les fermer ou de les protéger avec des pare-feu sans déjouer les utilisateurs légitimes. Les ports ouverts sont également intéressants pour les scans de non-sécurité parce qu\'ils montrent les services disponibles pour utilisation sur le réseau.';
...
$GLOBALS["lang"]['An educated guess to the identity and type of device'] = 'Une idée éclairée de l\'identité et du type d\'appareil';
...
$GLOBALS["lang"]['An enterprise private network is a network that a single organization builds to interconnect its office locations (e.g., production sites, head offices, remote offices, shops) so they can share computer resources.'] = 'Un réseau privé d\'entreprise est un réseau qu\'une seule organisation construit pour interconnecter ses bureaux (p. ex. sites de production, siège social, bureaux éloignés, magasins) afin de partager les ressources informatiques.';

$GLOBALS["lang"]['An entry can be created using the web interface if the current user logged in has a role that contains the'] = 'Une entrée peut être créée en utilisant l\'interface web si l\'utilisateur actuel connecté a un rôle qui contient le';
...
$GLOBALS["lang"]['An open|filtered port is considered open (and will trigger device detection).<br>Previously, Open-AudIT considered an Nmap response of'] = 'Un port ouvert est considéré comme ouvert (et déclenchera la détection de l\'appareil).<br/>Précédemment... IT a considéré une réponse Nmap de';
...
$GLOBALS["lang"]['And lastly, not so much a security issue - more peace of mind. The data structures are open and documented. You can view them'] = 'Enfin, pas tant un problème de sécurité - plus de tranquillité d\'esprit. Les structures de données sont ouvertes et documentées. Vous pouvez les voir';

$GLOBALS["lang"]['And provide a name - we humbly recommend Open-AudIT &#128512;, but you can name it anything you like. Make sure the option for <i>Integrate any other application you do not find in the gallery (Non-gallery)</i> is selected. And then click <i>Create<i>.'] = 'Et fournir un nom - nous vous recommandons humblement Open-Audit, mais vous pouvez le nommer tout ce que vous voulez. Assurez-vous que l\'option pour <i>Intégrez toute autre application que vous ne trouvez pas dans la galerie (non-gallery)</i> est sélectionné. Et puis cliquez <i>Créer<i>.</i></i>';
...
$GLOBALS["lang"]['Any attributes followed by a * indicate that CVSS data less than v4 was used to complete this field. By default, we attempt to use v4 fields, however if they are not populated we will fallback to the previous version(s) for attributes.'] = 'Tous les attributs suivis d\'un * indiquent que les données CVSS inférieures à v4 ont été utilisées pour remplir ce champ. Par défaut, nous essayons d\'utiliser les champs v4, mais s\'ils ne sont pas peuplés, nous reviendrons aux versions précédentes pour les attributs.';

$GLOBALS["lang"]['Any devices will be assigned to this Org when they run their audit script (if set).'] = 'Tout appareil sera affecté à cet Org lorsqu\'il exécutera son script d\'audit (si défini).';
...
$GLOBALS["lang"]['Any discovered devices will be assigned to this Location when they run their audit script (if set).'] = 'Tout périphérique découvert sera affecté à cet emplacement lorsqu\'il exécutera son script d\'audit (si défini).';
...
$GLOBALS["lang"]['Any user uploaded images are placed here.'] = 'Toutes les images téléchargées par l\'utilisateur sont placées ici.';
...
$GLOBALS["lang"]['Applications are an Enterprise only feature.'] = 'Les applications ne sont qu\'une fonctionnalité Enterprise.';

$GLOBALS["lang"]['Applications are being introduced in Open-AudIT 2.2 with a view to expand on the concept as further development is made.'] = 'Des applications sont en cours d\'introduction dans Open-Audit 2.2 en vue de développer le concept à mesure que des développements seront faits.';
...
$GLOBALS["lang"]['Assign any audited devices to this Org. Leave blank to leave device in currently assigned Org (or to set default).'] = 'Attribuer tout appareil audité à cet Org. Laisser en blanc pour laisser l\'appareil dans Org actuellement assigné (ou pour définir par défaut).';

$GLOBALS["lang"]['Assign the Device to a Location'] = 'Attribuer l\'appareil à un emplacement';
...
$GLOBALS["lang"]['Attempt to ping the device if we are not auditing localhost.'] = 'Tentative de ping l\'appareil si nous n\'auditons pas localhost.';
...
$GLOBALS["lang"]['Authentication Protocol'] = 'Protocole d\'authentification';
...
$GLOBALS["lang"]['Awaiting Analysis'] = 'En attente d\'une analyse';
...
$GLOBALS["lang"]['Baselines enable you to combine audit data with a set of attributes you have previously defined (your baseline) to determine compliance of devices.'] = 'Les données de base vous permettent de combiner les données de vérification avec un ensemble d\'attributs que vous avez précédemment définis (votre base de référence) pour déterminer la conformité des appareils.';
...
$GLOBALS["lang"]['Because we try to be as transparent as possible, here is your actual data that we send.'] = 'Parce que nous essayons d\'être le plus transparent possible, voici vos données réelles que nous envoyons.';

$GLOBALS["lang"]['Being able to determine which machines are configured in the same way is a major part of systems administration and auditing – and now reporting on that will be made simple and automated. Once you define your baseline it will automatically run against a set of devices on a predetermined schedule. The output of these executed baselines will be available for web viewing, importing into a third party system or even as a printed report.<br><br>For auditing and management purposes it can be advantageous to baseline individual devices against a fixed, known good device. Baselines enable you to combine audit data with a set of attributes you have previously defined (your baseline) to determine compliance of devices.'] = 'Être en mesure de déterminer quelles machines sont configurées de la même manière est une partie importante de l\'administration et de l\'audit des systèmes – et maintenant en rendre compte sera rendu simple et automatisé. Une fois que vous définissez votre base de référence, il fonctionnera automatiquement contre un ensemble de dispositifs sur un calendrier prédéterminé. La sortie de ces lignes de base exécutées sera disponible pour l\'affichage sur le Web, l\'importation dans un système tiers ou même sous forme de rapport imprimé.<br/><br/>À des fins d\'audit et de gestion, il peut être avantageux pour les appareils individuels de référence contre un bon appareil fixe et connu. Les données de base vous permettent de combiner les données de vérification avec un ensemble d\'attributs que vous avez précédemment définis (votre base de référence) pour déterminer la conformité des appareils.';
...
$GLOBALS["lang"]['Benchmark Tasks are created automatically when a benchmark is created.'] = 'Les tâches de benchmark sont créées automatiquement lorsqu\'un benchmark est créé.';

$GLOBALS["lang"]['Benchmark execution and processing can take a lengthy amount of time, hence the preference to schedule them and not run them ad-hoc.'] = 'L\'exécution et le traitement des repères peuvent prendre beaucoup de temps, d\'où la préférence de les programmer et de ne pas les exécuter ad-hoc.';
...
$GLOBALS["lang"]['Browse down the tree to Console Root -> Component Services -> Computers -> My Computer<br><br>Right click on <i>My Computer</i> and select properties<br><br>Select the <i>Default Properties</i> tab'] = 'Parcourez l\'arbre vers la racine Console -> Services des composantes -> Ordinateurs -> Mon ordinateur<br/><br/>Clic droit sur <i>Mon ordinateur</i> et sélectionnez les propriétés<br/><br/>Sélectionnez la <i>Propriétés par défaut</i> onglet';
...
$GLOBALS["lang"]['Bulk Edit Form'] = 'Formulaire d\'édition en vrac';
...
$GLOBALS["lang"]['But I Only Have Windows Client Machines Available!'] = 'Mais je n\'ai que les machines clients Windows disponibles!';
...
$GLOBALS["lang"]['Click on <i>Properties</i> under the <i>Manage</i> header in the central menu column. Copy the <i>User Access URL</i>. Once copied, paste it into yout text editor. You will need to copy one section of this field.<br><br>Our example field looks like this<br><code>https://launcher.myapps.microsoft.com/api/signin/5d97003c-g24b-346e-9932-77db6470b939?tenantId=cf406343-1a96-4f7c-0cc6-46e86dddabf3</code>.<br><br>The section we need is <code>cf406343-1a96-4f7c-0cc6-46e86dddabf3</code> (the tenant ID). This is used in Open-AudIT as the <i>Tenant</i> field, so paste it in there.'] = 'Cliquez sur <i>Propriétés</i> sous la <i>Gérer</i> header dans la colonne de menu centrale. Copier <i>URL d\'accès de l\'utilisateur</i>. Une fois copié, collez-le dans l\'éditeur de texte de yout. Vous devrez copier une section de ce champ.<br/><br/>Notre champ exemple ressemble à ceci<br/><code>https://launcher.myapps.microsoft.com/api/signin/5d97003c-g24b-346e-9932-77db6470b939?tenantId=cf406343-1a96-4f7c-0cc6-46e86dddabf3</code>.<br/><br/>La section dont nous avons besoin est : <code>cf406343-1a96-4f7c-0cc6-46e86dddabf3</code> (l\'identité du locataire). Ceci est utilisé dans Open-Audit comme <i>Locataire</i> Et collez-le là-dedans.';

$GLOBALS["lang"]['Click on App Registrations to create a new Application, then click New Application Registration. Give it a name (I used Open-AudIT), select Web app / API as the type and provide any URL (the URL is not important) and now click Create.'] = 'Cliquez sur Enregistrements d\'applications pour créer une nouvelle application, puis cliquez sur Enregistrement de nouvelles applications. Donnez-lui un nom (j\'ai utilisé Open-Audit), sélectionnez Web app / API comme type et fournir n\'importe quelle URL (l\'URL n\'est pas importante) et maintenant cliquez sur Créer.';
...
$GLOBALS["lang"]['Click the icon to the right of the field you wish to edit. Change the field and click the green icon to submit.'] = 'Cliquez sur l\'icône à droite du champ que vous souhaitez modifier. Changez le champ et cliquez sur l\'icône verte à soumettre.';
...
$GLOBALS["lang"]['Configurable Role Based Access Control (RBAC)'] = 'Contrôle d\'accès par rôle configurable (RBC)';
...
$GLOBALS["lang"]['Configure the agent server-side to perform audits on a schedule'] = 'Configurer le côté serveur de l\'agent pour effectuer des audits selon un calendrier';
...
$GLOBALS["lang"]['Copy the <i>Application ID</i> field and paste it into the Open-AudIT <i>Client ID</i> field for the new Auth Method.'] = 'Copier <i>ID de l\'application</i> et collez-le dans l\'Open-Audit <i>Identification du client</i> champ pour la nouvelle méthode Auth.';

$GLOBALS["lang"]['Copy the <i>Client ID</i> and paste it into the Open-AudIT <i>Client ID</i> field.<br>If there is no secret, click <i>Generate new secret</i>, then copy the value and paste it into the Open-AudIT <i>Client Secret</i> field.'] = 'Copier <i>Identification du client</i> et le coller dans l\'Open-Audit <i>Identification du client</i> sur le terrain.<br/>S\'il n\'y a pas de secret, cliquez <i>Générer un nouveau secret</i>, puis copier la valeur et la coller dans l\'Open-Audit <i>Client Secret</i> sur le terrain.';
...
$GLOBALS["lang"]['Create a Statement of Applicability (SoA)'] = 'Créer une déclaration d\'applicabilité (SoA)';
...
$GLOBALS["lang"]['Creating a SQL Statement for Groups'] = 'Création d\'une déclaration SQL pour les groupes';

$GLOBALS["lang"]['Creating a SQL Statement for Queries'] = 'Création d\'une déclaration SQL pour les requêtes';

$GLOBALS["lang"]['Creating an Integration'] = 'Création d\'une intégration';
...
$GLOBALS["lang"]['Credentials are stored in the <i>credentials</i> database table. The actual credential information is encrypted in storage. When a Discovery is run, a device has its specific credentials retrieved from the database, decrypted and tested. If these fail the list of credentials is also retrieved, decrypted and then tested against the device starting with credentials known to have worked previously. Device specific credentials are stored at an individual device level in the <i>credential</i> table (note - no <i>s</i> in the table name). SSH keys are tested before SSH username / password. When testing SSH, credentials will also be marked as working with sudo or being root.'] = 'Les pouvoirs sont conservés dans le <i>pouvoirs</i> tableau de données. L\'information relative aux titres de compétence est cryptée dans le stockage. Lorsqu\'un Discovery est exécuté, un appareil a ses identifiants spécifiques récupérés de la base de données, déchiffrés et testés. Si ceux-ci échouent, la liste d\'identifications est également récupérée, déchiffrée et ensuite testée contre le périphérique en commençant par des identifiants connus pour avoir fonctionné précédemment. Les identifiants spécifiques à l\'appareil sont stockés à un niveau individuel de l\'appareil <i>certificat</i> tableau (note - non) <i>s</i> dans le nom de la table). Les clés SSH sont testées avant le nom d\'utilisateur / mot de passe SSH. Lors du test SSH, les identifiants seront également marqués comme travaillant avec sudo ou étant root.';

$GLOBALS["lang"]['Credentials can have one of a few different types - snmp v.1 / v.2, snmp v.3, ssh, ssh key, windows are all implemented. CAVEAT - ssh keys are not implemented for Windows Open-AudIT servers as yet.'] = 'Les lettres de créances peuvent avoir l\'un des différents types - snmp v.1 / v.2, snmp v.3, ssh, ssh key, windows sont tous implémentés. CAVEAT - les clés ssh ne sont pas encore implémentées pour les serveurs Windows Open-Audit.';
...
$GLOBALS["lang"]['Custom TCP Ports. Any specific ports we would liuke scanned in addition to the Top TCP Ports. Comma seperated, no spaces.'] = 'Ports TCP personnalisés. Tous les ports spécifiques que nous liuke scanner en plus des Ports Top TCP. Comma séparé, pas d\'espace.';

$GLOBALS["lang"]['Custom UDP Ports'] = 'UDP personnalisé Ports';

$GLOBALS["lang"]['Custom UDP Ports. Any specific ports we would liuke scanned in addition to the Top UDP Ports. Comma seperated, no spaces.'] = 'Ports UDP personnalisés. Tous les ports spécifiques que nous liuke scanner en plus des ports UDP Top. Comma séparé, pas d\'espace.';
...
$GLOBALS["lang"]['Dashboards and Widgets allow Enterprise licensed customers to create, read, update and delete both of these collections to ensure their homepage is exactly what they need to see. Not only that, but a user is able to set a given dashboard as their own homepage. Everyone does not need to use the same homepage (dashboard), nor the same widgets on that dashboard. Professional licensed customers can choose between two predefined dashboards to set as their own homepage.'] = 'Les tableaux de bord et les Widgets permettent aux clients sous licence Enterprise de créer, lire, mettre à jour et supprimer ces deux collections pour s\'assurer que leur page d\'accueil est exactement ce qu\'ils ont besoin de voir. Non seulement cela, mais un utilisateur est en mesure de définir un tableau de bord donné comme leur propre page d\'accueil. Chacun n\'a pas besoin d\'utiliser la même page d\'accueil (tableau de bord), ni les mêmes widgets sur ce tableau de bord. Les clients professionnels autorisés peuvent choisir entre deux tableaux de bord prédéfinis à définir comme leur propre page d\'accueil.';

$GLOBALS["lang"]['Dashboards provide <i>at a glance</i> important visibility for changes occurring on your network as well as providing quick links to device types, manufacturers, and operating systems and so much more.'] = 'Les tableaux de bord fournissent <i>en un coup d\'oeil</i> visibilité importante pour les changements survenant sur votre réseau ainsi que fournir des liens rapides aux types d\'appareils, aux fabricants et aux systèmes d\'exploitation et bien plus encore.';
...
$GLOBALS["lang"]['Define the context of the organization (internal/external issues)'] = 'Définir le contexte de l\'organisation (questions internes/externes)';
...
$GLOBALS["lang"]['Discoveries are at the very heart of what Open-AudIT does. How else would you know <i>Whats On Your Network?</i>'] = 'Les découvertes sont au cœur de ce que fait Open-Audit. Comment le savez-vous ? <i>Qu\'y a-t-il sur votre réseau?</i>';

$GLOBALS["lang"]['Discoveries are entries that enable you to run a discovery upon a network in a single click, without entering the details of that network each and every time.'] = 'Les découvertes sont des entrées qui vous permettent d\'exécuter une découverte sur un réseau en un seul clic, sans entrer les détails de ce réseau à chaque fois.';
...
$GLOBALS["lang"]['Do not forget about the Open-AudIT wiki for all your documentation.'] = 'N\'oubliez pas le wiki Open-Audit pour toute votre documentation.';

$GLOBALS["lang"]['Do not forget there is a mountain of documentation on the wiki'] = 'N\'oubliez pas qu\'il y a une montagne de documentation sur le wiki';
...
$GLOBALS["lang"]['Each IP is scanned with the discovery configured options (see Discovery Scan Options and Discovery - Community vs Professional vs Enterprise on the wiki). In general, Nmap will test for ports 22 (ssh), 135 (wmi), 62078 (iPhone) and UDP 161 (snmp). If 22, 135 or 161 respond the credential list is retrieved and each credential tested in turn. The first working credentials are used for further queries directly from the device. Note - if a device has previously been discovered and has working credentials, those credentials are tested first. Only if those fail are the other credentials then attempted.'] = 'Chaque IP est scanné avec les options de découverte configurées (voir Discovery Scan Options et Discovery - Community vs Professional vs Enterprise sur le wiki). En général, Nmap testera les ports 22 (ssh), 135 (wmi), 62078 (iPhone) et UDP 161 (snmp). Si 22, 135 ou 161 répondent, la liste des titres de compétence est récupérée et chaque titre de compétence est testé à son tour. Les premières références de travail sont utilisées pour d\'autres requêtes directement à partir de l\'appareil. Remarque - si un appareil a déjà été découvert et a des références de travail, ces références sont testées en premier. Ce n\'est qu\'en cas d\'échec que les autres pouvoirs ont été tentés.';

$GLOBALS["lang"]['Each time a device is discovered or an audit result is processed, all rules are retrieved from the database and run against the attributes of the specific device. Rules run against one device at a time - there is no facility to say <i>Run the rules against all devices<i> or <i>Run the rules against these devices<i>. An individual rule will test one or more attributes of the device and if they match the rule, the result will be applied. Several attributes can be tested. Several attributes can be set. Think of this as an If This, Then That system for Open-AudIT.'] = 'Chaque fois qu\'un périphérique est découvert ou qu\'un résultat d\'audit est traité, toutes les règles sont récupérées dans la base de données et exécutées en fonction des attributs du périphérique spécifique. Les règles s\'appliquent à un appareil à la fois - il n\'y a pas de facilité à dire <i>Exécuter les règles contre tous les appareils<i> ou <i>Exécuter les règles contre ces appareils<i>. Une règle individuelle testera un ou plusieurs attributs de l\'appareil et s\'ils correspondent à la règle, le résultat sera appliqué. Plusieurs attributs peuvent être testés. Plusieurs attributs peuvent être définis. Pensez à cela comme un Si ceci, alors ce système pour Open-Audit.</i></i></i></i>';
...
$GLOBALS["lang"]['Endpoint'] = 'Point d\'arrivée';
...
$GLOBALS["lang"]['Enrichment is complete. The CVE has full metadata and is considered stable.'] = 'L\'enrichissement est terminé. Le CVE a des métadonnées complètes et est considéré stable.';
...
$GLOBALS["lang"]['Establish an information security policy'] = 'Établir une politique de sécurité de l\'information';
...
$GLOBALS["lang"]['Example Org Chart with Access'] = 'Exemple d\'organigramme avec accès';
...
$GLOBALS["lang"]['Exclude IP Addresses (individual IP - 192.168.1.20, ranges - 192.168.1.30-40 or subnets - 192.168.1.100/30) listed from being scanned. Comma seperated, no spaces.'] = 'À l\'exclusion des adresses IP (particuliers IP - 192.168.1.20, gammes - 192.168.1.30-40 ou sous-réseaux - 192.168.1.100/30) énumérées d\'être numérisées. Comma séparé, pas d\'espace.';
...
$GLOBALS["lang"]['Exclude any ports listed from being scanned. Comma seperated, no spaces.'] = 'Exclut tous les ports listés d\'être numérisés. Comma séparé, pas d\'espace.';
...
$GLOBALS["lang"]['First focus on what the end need is: are you trying to baseline software, users, or Netstat data? What is the important thing(s) to compare and report on?'] = 'Se concentrer d\'abord sur ce qu\'est le besoin final : essayez-vous de référencer des logiciels, des utilisateurs ou des données Netstat ? Quelle est la ou les choses importantes à comparer et à rapporter?';
...
$GLOBALS["lang"]['For <i>Type</i> make sure to select Baseline, and for Group you should select a Group of devices, if applicable to this baseline, that best represent the devices to apply the baseline against. This will prevent erroneous entries.'] = 'Pour <i>Type</i> Assurez-vous de sélectionner Baseline, et pour Groupe, vous devez sélectionner un Groupe d\'appareils, s\'il y a lieu, qui représente le mieux les appareils pour appliquer la base de référence. Cela empêchera les entrées erronées.';

$GLOBALS["lang"]['For Debian/Ubuntu run, including setting dpkg to remember your override so an apt-get upgrade will not break'] = 'Pour l\'exécution Debian/Ubuntu, y compris la configuration de dpkg pour se souvenir de votre surcharge, une mise à jour apt-get ne se brisera pas';

$GLOBALS["lang"]['For SNMP Open-AudIT can use v1, v2 and v3 credentials. The device is queried regardless of it being a router, switch (regular network devices) or a computer (Linux and Windows often run SNMP for monitoring tools).'] = 'Pour SNMP Open-Audit peut utiliser v1, v2 et v3. L\'appareil est interrogé, qu\'il s\'agisse d\'un routeur, d\'un commutateur (dispositifs réseau réguliers) ou d\'un ordinateur (Linux et Windows exécutent souvent SNMP pour les outils de surveillance).';
...
$GLOBALS["lang"]['For more detailed information, check the Open-AudIT Knowledge Base.'] = 'Pour plus d\'informations, consultez la base de connaissances Open-Audit.';
...
$GLOBALS["lang"]['For more information, see'] = 'Pour plus d\'informations, voir';
...
$GLOBALS["lang"]['Full cloud auditing with all the details from a regular Open-AudIT audit AND details such as the machine type and size.'] = 'Audit en nuage complet avec tous les détails d\'un audit Open-Audit régulier ET des détails tels que le type de machine et la taille.';
...
$GLOBALS["lang"]['Go back to your Open-AudIT server and create a discovery with the target Windows computers IP Address as the subnet (this will save having to discover the entire subnet again). Run the discovery, taking note of any issues. For any issues found, take appropriate actions.'] = 'Retournez sur votre serveur Open-Audit et créez une découverte avec l\'adresse IP des ordinateurs Windows cible en tant que sous-réseau (ceci permettra d\'enregistrer à nouveau la découverte de tout le sous-réseau). Exécutez la découverte, en prenant note de tout problème. Pour toute question trouvée, prendre les mesures appropriées.';

$GLOBALS["lang"]['Go the target Windows PC (or use RDP) and log on as the user used by your discovery credential set.'] = 'Allez sur le PC Windows cible (ou utilisez RDP) et connectez-vous en tant qu\'utilisateur utilisé par votre jeu de certificats de découverte.';

$GLOBALS["lang"]['Go to menu'] = 'Aller au menu';

$GLOBALS["lang"]['Go to the <i>Applications</i> -> <i>App registrations</i> menu item on the far left. Search for Open-AudIT. Click the Open-AudIT entry in the list (assuming you named the app Open-AudIT).'] = 'Allez au <i>Demandes</i> -> <i>Enregistrement des demandes</i> menu à l\'extrême gauche. Rechercher Open-Audit. Cliquez sur l\'entrée Open-Audit dans la liste (en supposant que vous avez nommé l\'application Open-Audit).';
...
$GLOBALS["lang"]['Have the agent always run the latest audit script (if you upgrade Open-AudIT and manually copy the scripts to the targets, then set cron - you will need to update these scripts for each upgrade).'] = 'Demandez à l\'agent de toujours exécuter le dernier script d\'audit (si vous mettez à niveau Open-Audit et copiez manuellement les scripts vers les cibles, puis définissez cron - vous devrez mettre à jour ces scripts pour chaque mise à jour).';

$GLOBALS["lang"]['Have your user open a command prompt (using <i>Run as Administrator</i>). Paste the below into the prompt to download the Agent.'] = 'Demandez à votre utilisateur d\'ouvrir une commande <i>Exécuter comme administrateur</i>) . Collez ce qui suit dans l\'invite à télécharger l\'Agent.';
...
$GLOBALS["lang"]['Helps manage and mitigate information security risks'] = 'Aide à gérer et à atténuer les risques liés à la sécurité de l\'information';

$GLOBALS["lang"]['Hide Audit Window'] = 'Cacher la fenêtre d\'audit';
...
$GLOBALS["lang"]['Identify information assets'] = 'Identifier les éléments d\'information';
...
$GLOBALS["lang"]['If no operator is specified, the default is =. Properties should be fully qualified - ie, devices.hostname (not just hostname).'] = 'Si aucun opérateur n\'est spécifié, la valeur par défaut est =. Les propriétés doivent être entièrement qualifiées - par exemple, devices.hostname (pas seulement hostname).';

$GLOBALS["lang"]['If no value is present, supply this value. EG: for system.nmis_group / configuraion.group we use'] = 'Si aucune valeur n\'est présente, fournir cette valeur. EG: pour system.nmis_group / configuration. groupe que nous utilisons';
...
$GLOBALS["lang"]['If the OS Family (as reported by the device) contains this item, pass.</li>'] = 'Si la famille OS (tel que rapporté par l\'appareil) contient cet élément, passez.';
...
$GLOBALS["lang"]['If the binary is not found in either of these locations, a warning message will be displayed in the installer.'] = 'Si le binaire n\'est trouvé dans aucun de ces emplacements, un message d\'avertissement sera affiché dans l\'installateur.';
...
$GLOBALS["lang"]['If the primary IP (as reported by the device) is in this subnet, pass.</li>'] = 'Si l\'IP primaire (tel que rapporté par l\'appareil) se trouve dans ce sous-réseau, passez.';

$GLOBALS["lang"]['If the user account does not actually exist within Open-AudIT and <code>use_authorisation</code> is set, the user will be created. If it does exist, details such as email, full name, etc will be populated.'] = 'Si le compte utilisateur n\'existe pas dans Open-Audit et <code>use_authorisation</code> est défini, l\'utilisateur sera créé. Si elle existe, des détails tels que le courriel, le nom complet, etc. seront remplis.';

$GLOBALS["lang"]['If the user either does not have valid credentials or is not in at least one Open-AudIT Role and Group (when using <code>use_authorisation</code>), Open-AudIT will fallback to using local Open-AudIT user details and attempt authentication and authorization there. Failing that, the user will be denied access.'] = 'Si l\'utilisateur n\'a pas d\'identifiants valides ou n\'est pas dans au moins un rôle et un groupe Open-Audit <code>use_authorisation</code>) , Open-Audit va revenir à l\'utilisation des détails de l\'utilisateur local Open-Audit et tenter l\'authentification et l\'autorisation là. À défaut, l\'utilisateur se verra refuser l\'accès.';
...
$GLOBALS["lang"]['If the user logging on to Open-AudIT does not have the access to search OpenLDAP, you can use another account which does have this access. Use the dn_account and dn_password to configure this.'] = 'Si l\'utilisateur se connecte à Open-Audit n\'a pas l\'accès à la recherche OpenLDAP, vous pouvez utiliser un autre compte qui a cet accès. Utilisez dn_account et dn_password pour configurer cela.';

$GLOBALS["lang"]['If the value is not set, the current timestamp will be used.'] = 'Si la valeur n\'est pas définie, l\'horodatage courant sera utilisé.';
...
$GLOBALS["lang"]['If you add a Location Type, add those icons to'] = 'Si vous ajoutez un Type d\'emplacement, ajoutez ces icônes à';

$GLOBALS["lang"]['If you add a device type, to display the associated icon you will have to manually copy the .svg formatted file to the directory'] = 'Si vous ajoutez un type de périphérique, pour afficher l\'icône associée, vous devrez copier manuellement le fichier formaté .svg dans le répertoire';

$GLOBALS["lang"]['If you are a supported FirstWave customer,a couple of items will make helping your easier. Open a support ticket with FirstWave and attach the logfile. Also include the output from the Support button on the upper right of the'] = 'Si vous êtes un client de FirstWave pris en charge, un couple d\'articles vous aidera plus facilement. Ouvrez un ticket de support avec FirstWave et attachez le fichier journal. Inclure également la sortie à partir du bouton Support en haut à droite de la';

$GLOBALS["lang"]['If you are a supported customer and open a support ticket with FirstWave, please attach these files.'] = 'Si vous êtes un client pris en charge et ouvrez un ticket d\'assistance avec FirstWave, veuillez joindre ces fichiers.';

$GLOBALS["lang"]['If you are having issues with Google Maps API keys or your company does not have access to create Google Maps API keys, please contact the FirstWave support team.'] = 'Si vous avez des problèmes avec les clés API Google Maps ou si votre entreprise n\'a pas accès à la création des clés API Google Maps, veuillez contacter l\'équipe de support FirstWave.';

$GLOBALS["lang"]['If you are on Windows or your NMIS server is remote, you will need to supply the URL, username and password to access that server.'] = 'Si vous êtes sous Windows ou si votre serveur NMIS est distant, vous devrez fournir l\'URL, le nom d\'utilisateur et le mot de passe pour accéder à ce serveur.';

$GLOBALS["lang"]['If you are on a decent broadband or ethernet connection, I would recommend always using -T4 (Aggressive). Some people love -T5 (Insane) though it is too aggressive for my taste. People sometimes specify -T2 (Polite) because they think it is less likely to crash hosts or because they consider themselves to be polite in general. They often do not realize just how slow -T2 really is. Their scan may take ten times longer than a default scan. Machine crashes and bandwidth problems are rare with the default timing options -T3 (Normal) and so I normally recommend that for cautious scanners. Omitting version detection is far more effective than playing with timing values at reducing these problems.'] = 'Si vous êtes sur une connexion haut débit ou éthernet décente, je recommanderais toujours d\'utiliser -T4 (Agressive). Certaines personnes aiment -T5 (Insane) bien qu\'il soit trop agressif à mon goût. Les gens précisent parfois -T2 (Polite) parce qu\'ils pensent qu\'il est moins probable de planter des hôtes ou parce qu\'ils se considèrent comme polis en général. Ils ne se rendent souvent pas compte à quel point lent -T2 est vraiment. Leur balayage peut prendre dix fois plus de temps qu\'un balayage par défaut. Les pannes de machines et les problèmes de bande passante sont rares avec les options de timing par défaut -T3 (Normal) et je recommande donc normalement que pour les scanners prudents. La détection d\'omission de version est beaucoup plus efficace que de jouer avec des valeurs de temps pour réduire ces problèmes.';
...
$GLOBALS["lang"]['If you do normally set devices_assigned_to_org and the configuration item is enabled, then the OrgID will be used to further refine the match.'] = 'Si vous définissez normalement devices_assigned_to_org et que l\'élément de configuration est activé, l\'OrgID sera utilisé pour affiner la correspondance.';

$GLOBALS["lang"]['If you do not normally set devices_assigned_to_org, then it will have no effect. We only check using the OrgID if it has been set in discovery (or manually in an audit script) and enabled in the configuration.'] = 'Si vous ne définissez pas normalement devices_assigned_to_org, cela n\'aura aucun effet. Nous vérifions uniquement en utilisant l\'OrgID s\'il a été configuré dans la découverte (ou manuellement dans un script d\'audit) et activé dans la configuration.';

$GLOBALS["lang"]['If you enable the configuration item, use discovery to assign an Org and then subsequently change the OrgID of a device after discovery then you will likely have a new device created the next time the discovery runs. In this instance, you should probably just unset devices_assigned_to_org before running subsequent discoveries. This is because (in this instance) you have told Open-AudIT <i>these devices from this discovery belong to Org X<i>, but then changed the Org of the device. You have changed the stored devices information. In this case - there is no no longer a device belonging to Org X, so we create a new one.'] = 'Si vous activez l\'élément de configuration, utilisez la découverte pour assigner un Org puis changez ensuite l\'OrgID d\'un périphérique après la découverte, alors vous aurez probablement un nouvel appareil créé la prochaine fois que la découverte s\'exécutera. Dans ce cas, vous devriez probablement juste désinstaller devices_assigned_to_org avant de lancer des découvertes ultérieures. C\'est parce que (dans ce cas) vous avez dit Open-Audit <i>ces dispositifs de cette découverte appartiennent à Org X<i>, mais a ensuite changé l\'Org de l\'appareil. Vous avez changé les informations des appareils stockés. Dans ce cas - il n\'y a plus de dispositif appartenant à Org X, donc nous en créons un nouveau.</i></i>';

$GLOBALS["lang"]['If you have Anti-Virus software running, allowing the services of Opmantek (omkd), Apache (apache2.2) and MySQL (mysql) to auto start and run is essential. These services are used by Open-AudIT. You should only need to do this once. If your Anti-Virus program keeps prompting you about Open-AudIT, please post to the forums or send an email to support with the name and version of your Anti-Virus software.'] = 'Si vous avez le logiciel Anti-Virus en cours d\'exécution, permettre aux services d\'Opmantek (omkd), Apache (apache2.2) et MySQL (mysql) de démarrer et d\'exécuter automatiquement est essentiel. Ces services sont utilisés par Open-Audit. Tu ne devrais avoir besoin de faire ça qu\'une seule fois. Si votre programme Anti-Virus continue de vous inciter à parler d\'Open-Audit, veuillez poster sur les forums ou envoyer un e-mail pour soutenir avec le nom et la version de votre logiciel Anti-Virus.';

$GLOBALS["lang"]['If you have working credentials, you can expect the full amount of information possible.<br><br>Obviously, the best way to use Open-AudIT is to have working credentials for the devices being discovered (be they WMI, SSH, or SNMP credentials).<br><br>We also have a page on auditing without credentials.'] = 'Si vous avez des références de travail, vous pouvez vous attendre à la quantité complète d\'information possible.<br/><br/>De toute évidence, la meilleure façon d\'utiliser Open-Audit est d\'avoir des identifiants de travail pour les appareils découverts (qu\'ils soient WMI, SSH ou SNMP).<br/><br/>Nous avons également une page sur l\'audit sans références.';
...
$GLOBALS["lang"]['If you run discovery upon a subnet that your Server (or Collector) is not directly installed on, you can expect the following for responding devices'] = 'Si vous lancez une découverte sur un sous-réseau sur lequel votre serveur (ou collecteur) n\'est pas installé directement, vous pouvez vous attendre à ce qui suit pour répondre aux appareils';

$GLOBALS["lang"]['If you select a List type, an additional field will appear called Values. You should put a comma separated list of selectable values here. These will display in a dropdown box whenever the field is edited.'] = 'Si vous sélectionnez un type de liste, un champ supplémentaire apparaîtra appelé Valeurs. Vous devriez mettre une liste séparée de virgules de valeurs sélectionnables ici. Celles-ci s\'affichent dans une boîte déroulante chaque fois que le champ est édité.';

$GLOBALS["lang"]['If you set the values for'] = 'Si vous définissez les valeurs pour';

$GLOBALS["lang"]['If you want to force your Agents to use a particular configuration, you can supply the ID of the agents entry to use, as below (replace $id with the number of the Agents entry). When this Agent is installed, it will check-in with the sevrer and <strong>only</strong> check that one individual Agent entrys attributes (tests and actions). This may be useful if you are an MSP - create an Agents entry for a particular customer and have their devices all use this entry, which assigns them to an Org and Location.'] = 'Si vous voulez forcer vos Agents à utiliser une configuration particulière, vous pouvez fournir l\'ID de l\'entrée des Agents à utiliser, comme ci-dessous (remplacer $id avec le numéro de l\'entrée Agents). Lorsque cet Agent est installé, il s\'enregistrera avec le sevrer et <strong>seulement</strong> vérifier qu\'une personne Attributs d\'entrée d\'agent (tests et actions). Cela peut être utile si vous êtes un MSP - créez une entrée Agents pour un client particulier et que leurs appareils utilisent tous cette entrée, qui les assigne à un Org et Location.';

$GLOBALS["lang"]['If you wish to dig in and customize the Integration, click the Advanced button (and try not to be overwhelmed!).'] = 'Si vous souhaitez creuser et personnaliser l\'intégration, cliquez sur le bouton Avancé (et essayez de ne pas être dépassé !).';

$GLOBALS["lang"]['If you wish to run a Discovery on an externally provided device, select the option and when the Integration is created, so s the Discovery.'] = 'Si vous souhaitez lancer une Discovery sur un appareil fourni de l\'extérieur, sélectionnez l\'option et lorsque l\'intégration est créée, alors s la Discovery.';
...
$GLOBALS["lang"]['If your user does not have <i>Run as Administrator</i> rights, they can still download the agent (first command above) and run it to submit an audit as below. It will be a one-off audit without the Agent being installed or scheduled.'] = 'Si votre utilisateur n\'a pas <i>Exécuter comme administrateur</i> droits, ils peuvent toujours télécharger l\'agent (première commande ci-dessus) et l\'exécuter pour soumettre un audit comme ci-dessous. Ce sera une vérification ponctuelle sans que l\'agent soit installé ou programmé.';
...
$GLOBALS["lang"]['In a second tab or window go to your OKTA console and click <i>Create App Integration</i>.'] = 'Dans un deuxième onglet ou fenêtre, allez sur votre console OKTA et cliquez <i>Créer l\'intégration de l\'application</i>.';

$GLOBALS["lang"]['In a second tab or window sign-on to your'] = 'Dans un deuxième onglet ou une fenêtre s\'identifier à votre';

$GLOBALS["lang"]['In my personal opinion, the best way to find and audit every single item on your network is a Seed Discovery for each subnet, restricted to that subnet (using credentials). Seed Discoveries use switch, router and computer MAC Address tables to not miss a single device. If it is connected to the network and uses TCP/IP, a switch/router/computer has to know it is there - thats just how TCP/IP works. Combine that with custom TCP and/or UDP ports and you should then be able to determine the device type as well. But thats just my personal preference'] = 'À mon avis, la meilleure façon de trouver et de vérifier chaque élément de votre réseau est une découverte de semences pour chaque sous-réseau, limitée à ce sous-réseau (en utilisant des références). Seed Discoveries utilise des tables d\'adresse MAC, routeur et ordinateur pour ne pas manquer un seul appareil. S\'il est connecté au réseau et utilise TCP/IP, un commutateur/routeur/ordinateur doit savoir qu\'il est là - c\'est juste comment TCP/IP fonctionne. Combinez cela avec les ports TCP et/ou UDP personnalisés et vous devriez alors être en mesure de déterminer le type de périphérique ainsi. Mais c\'est juste ma préférence personnelle';

$GLOBALS["lang"]['In order for Open-AudIT to be able to apply user permissions on items, we mandate the user of <code>WHERE @filter</code>. If you do not use this format, the queryCreateForm will throw a warning. Only users with the Admin role are permitted to create queries that lack this attribute and even then, only after the configuration item for <i>advanced_queries</i> has been enabled.'] = 'Pour qu\'Open-Audit puisse appliquer les permissions des utilisateurs sur les articles, nous mandatons l\'utilisateur de <code>WHERE @filter</code>. Si vous n\'utilisez pas ce format, la requêteCreateForm lancera un avertissement. Seuls les utilisateurs avec le rôle Admin sont autorisés à créer des requêtes qui manquent de cet attribut et même alors, seulement après l\'élément de configuration pour <i>requêtes avancées</i> a été activé.';

$GLOBALS["lang"]['In order to enable Google Maps you will need to a Google API Key follow this link and log in with your Google account,'] = 'Pour activer Google Maps, vous aurez besoin d\'une clé API Google suivre ce lien et vous connecter avec votre Compte Google,';

$GLOBALS["lang"]['In order to use the Azure Rest API, you will need to create an Azure Active Directory Application that is used for authentication.'] = 'Pour utiliser l\'API Azure Rest, vous devrez créer une application Azure Active Directory qui est utilisée pour l\'authentification.';
...
$GLOBALS["lang"]['In the case where we store several fields (usually in JSON format) inside a BIGTEXT MySQL field (eg: credentials.credentials - the credentials column in the credentials table), you should use the format'] = 'Dans le cas où nous stockons plusieurs champs (habituellement au format JSON) à l\'intérieur d\'un champ BIGTEXT MySQL (par exemple: identifiants. identifiants - la colonne des identifiants dans le tableau des identifiants), vous devez utiliser le format';

$GLOBALS["lang"]['In the command prompt shell, navigate to the download directory (likely <code>cd Downloads</code>).'] = 'Dans l\'invite de commande shell, naviguez vers le répertoire de téléchargement (probablement <code>cd Downloads</code>) .';
...
$GLOBALS["lang"]['Integrations can be scheduled as desired. This is left to the user.'] = 'Les intégrations peuvent être programmées comme souhaité. Ceci est laissé à l\'utilisateur.';
...
$GLOBALS["lang"]['Interactive dashboards provide instant visibility into the status of network inventory allowing IT teams to spot newly discovered devices and unusual device behaviour at a glance.'] = 'Les tableaux de bord interactifs offrent une visibilité instantanée sur l\'état de l\'inventaire du réseau, ce qui permet aux équipes informatiques de repérer en un coup d\'œil les appareils nouvellement découverts et leur comportement inhabituel.';
...
$GLOBALS["lang"]['LDAP was searched for this user and their account was not found. Check the LDAP server logs. The user credentials have worked, but the user was not found. Also check you have specified the correct Base DN attribute when you created the LDAP Server in Open-AudIT.'] = 'LDAP a été recherché pour cet utilisateur et son compte n\'a pas été trouvé. Vérifiez les journaux du serveur LDAP. Les références utilisateur ont fonctionné, mais l\'utilisateur n\'a pas été trouvé. Vérifiez également que vous avez spécifié le bon attribut Base DN lorsque vous avez créé le serveur LDAP dans Open-Audit.';
...
$GLOBALS["lang"]['Lowercase Hostname'] = 'Nom d\'hôte en minuscules';
...
$GLOBALS["lang"]['Matching Devices - Including OrgID'] = 'Dispositifs d\'appariement - y compris OrgID';

$GLOBALS["lang"]['Matching Linux Devices'] = 'Correspondance des périphériques Linux';

$GLOBALS["lang"]['Matching is conducted in the following order'] = 'Le jumelage est effectué dans l\'ordre suivant :';
...
$GLOBALS["lang"]['More information about debugging this can be found on a helpful Stack Overflow thread'] = 'Plus d\'informations sur le débogage peuvent être trouvés sur un fil utile Stack Overflow';
...
$GLOBALS["lang"]['NOTE - For more info on DateTime formats, see'] = 'NOTE - Pour plus d\'informations sur les formats DateTime, voir';

$GLOBALS["lang"]['NOTE - If you request a downloaded CSV, XML or JSON format (either a single credential, or the complete collection) the actual credential details will be sent. Not the encrypted string, the actual username, password, community string, etc. Any sensitive details are not displayed in the web GUI, but are made available via other formats. To prevent this export a configuration item is available called decrypt_credentials.'] = 'REMARQUE - Si vous demandez un format CSV, XML ou JSON téléchargé (soit un seul titre, soit la collection complète), les détails réels du titre seront envoyés. Pas la chaîne chiffrée, le nom d\'utilisateur réel, mot de passe, chaîne communautaire, etc. Tous les détails sensibles ne sont pas affichés dans l\'interface graphique Web, mais sont rendus disponibles via d\'autres formats. Pour empêcher cette exportation, un élément de configuration est disponible appelé decrypt_credentials.';

$GLOBALS["lang"]['NOTE - The curly brackets in the data filed should be used as-is (not replaced as per other examples above).'] = 'REMARQUE - Les crochets bouclés dans les données déposées doivent être utilisés comme tels (pas remplacés par d\'autres exemples ci-dessus).';
...
$GLOBALS["lang"]['Network type is set to Local Area Network by default, but can be changed by the user as they see fit. The types supported are below (with thanks to Wikipedia).<br><br>A network can be characterized by its physical capacity or its organizational purpose. Use of the network, including user authorization and access rights, differ accordingly.'] = 'Le type de réseau est défini par défaut sur le réseau local, mais peut être modifié par l\'utilisateur comme bon lui semble. Les types pris en charge sont ci-dessous (avec grâce à Wikipédia).<br/><br/>Un réseau peut être caractérisé par sa capacité physique ou son but organisationnel. L\'utilisation du réseau, y compris l\'autorisation des utilisateurs et les droits d\'accès, diffère en conséquence.';
...
$GLOBALS["lang"]['Next, right click the Apache2.4 service and select Properties, then click the Log On tab.'] = 'Ensuite, faites un clic droit sur le service Apache2.4 et sélectionnez Propriétés, puis cliquez sur l\'onglet Log On.';
...
$GLOBALS["lang"]['No devices are in the database.'] = 'Aucun appareil n\'est dans la base de données.';
...
$GLOBALS["lang"]['Note that the 100 device Enterprise license does not include support.'] = 'Notez que la licence d\'entreprise de 100 appareils n\'inclut pas le support.';
...
$GLOBALS["lang"]['Now for the Subscription ID, click All Services, Subscriptions and copy it.'] = 'Maintenant, pour l\'ID d\'abonnement, cliquez sur Tous les Services, Abonnements et copiez-le.';

$GLOBALS["lang"]['Now we need to provide the Azure Active Directory application access to your subscription.<br><br>Click on Resource Groups and then the resource group you would like your Azure Active Directory Application to have access to.<br><br>Click Add. The role should be Contributor and then search for the app (Open-AudIT). Then click Save.<br><br>Now the application has access to the subscription, so we can make API calls. The API calls will be requested on behalf of the application, not your user.'] = 'Maintenant, nous devons fournir l\'accès de l\'application Azure Active Directory à votre abonnement.<br/><br/>Cliquez sur Groupes de ressources puis sur le groupe de ressources auquel vous souhaitez accéder.<br/><br/>Cliquez sur Ajouter. Le rôle devrait être Contributeur puis rechercher l\'application (Open-Audit). Puis cliquez sur Enregistrer.<br/><br/>Maintenant, l\'application a accès à l\'abonnement, afin que nous puissions faire des appels API. Les appels API seront demandés au nom de l\'application, et non de votre utilisateur.';
...
$GLOBALS["lang"]['On the target Windows PC, run the DCOM utility and verify (or set) the below attributes. Start -> Run, Enter DCOMCNFG and press OK. This will open the DCOMCNFG window.'] = 'Sur le PC Windows cible, exécutez l\'utilitaire DCOM et vérifiez (ou définissez) les attributs ci-dessous. Démarrer -> Exécutez, entrez DCOMCNFG et appuyez sur OK. Cela ouvrira la fenêtre DCOMCNFG.';

$GLOBALS["lang"]['On the top right (underneath the menu bar) you will see several buttons. These allow you to select another dashboard, set the current dashboard as your homepage (if it is not already) and edit the current dashboard (if you have permission).'] = 'En haut à droite (sous la barre de menu) vous verrez plusieurs boutons. Ils vous permettent de sélectionner un autre tableau de bord, de définir le tableau de bord actuel comme votre page d\'accueil (si ce n\'est pas déjà fait) et de modifier le tableau de bord actuel (si vous avez la permission).';

$GLOBALS["lang"]['On-Premise, Not Cloud'] = 'Sur site, pas en nuage';

$GLOBALS["lang"]['Once an Additional Field has been created it can be used in queries and groups just like any other attribute in the database.'] = 'Une fois qu\'un champ supplémentaire a été créé, il peut être utilisé dans les requêtes et les groupes comme n\'importe quel autre attribut de la base de données.';

$GLOBALS["lang"]['Once commented out, your certificate will be validated, but may also fail this validation if you are using self-signed certificates and have not configured your server correctly.'] = 'Une fois commenté, votre certificat sera validé, mais peut aussi échouer si vous utilisez des certificats autosignés et n\'avez pas configuré votre serveur correctement.';
...
$GLOBALS["lang"]['Once you have done this, Open-AudIT will attempt to verify your user logon details against the configured Auth Method. If the user has valid credentials and <code>use_authorisation</code> is set, Open-AudIT will ask for the list of groups that the user belongs to. If the user is in the corresponding groups for Open-AudIT Roles and Orgs, those Roles and Orgs will be applied to that user.'] = 'Une fois que vous l\'aurez fait, Open-Audit tentera de vérifier les détails de votre logo utilisateur par rapport à la méthode Auth configurée. Si l\'utilisateur a des identifiants valides et <code>use_authorisation</code> est défini, Open-Audit demandera la liste des groupes auxquels l\'utilisateur appartient. Si l\'utilisateur est dans les groupes correspondants pour Open-Audit Rôles et Orgs, ces Rôles et Orgs seront appliqués à cet utilisateur.';

$GLOBALS["lang"]['Once you have generated a Baseline Definition you can schedule it to be run against a specified group of devices.'] = 'Une fois que vous avez généré une définition de base, vous pouvez la programmer pour être exécuté sur un groupe spécifié d\'appareils.';

$GLOBALS["lang"]['Once you have those items, in Open-AudIT Enterprise you can go to menu -> Discover -> Clouds -> Create Clouds, select the <i>Amazon AWS</i> type and paste them in. Done.'] = 'Une fois que vous avez ces éléments, dans Open-Audit Enterprise vous pouvez aller au menu -> Découvrir -> Nuages -> Créer Nuages, sélectionnez le <i>Amazone</i> Tapez et collez-les. C\'est fait.';

$GLOBALS["lang"]['Once you have those items, in Open-AudIT Enterprise you can go to menu -> Discover -> Clouds -> Create Clouds, select the <i>Microsoft Azure</i> type and paste them in. Done.'] = 'Une fois que vous avez ces éléments, dans Open-Audit Enterprise vous pouvez aller au menu -> Découvrir -> Nuages -> Créer Nuages, sélectionnez le <i>Microsoft Azure</i> Tapez et collez-les. C\'est fait.';

$GLOBALS["lang"]['Once you have your cloud credentials, it is merely a matter of creating a new cloud and running the discovery - or scheduling first/future discoveries. Make sure you also have the credentials required to log on to your cloud machines, and it is all done for you just like a regular discovery. Credentials for your cloud'] = 'Une fois que vous avez vos identifiants cloud, il s\'agit simplement de créer un nouveau nuage et de faire tourner la découverte - ou de planifier les premières découvertes/futures. Assurez-vous également d\'avoir les identifiants nécessaires pour vous connecter à vos machines cloud, et tout est fait pour vous comme une découverte régulière. Pouvoirs relatifs à votre nuage';
...
$GLOBALS["lang"]['Open-AudIT Professional has the ability to choose from a pre-defined list of discovery scan options, per discovery.'] = 'Audit ouvert Professional a la possibilité de choisir parmi une liste prédéfinie d\'options de numérisation de découverte, par découverte.';

$GLOBALS["lang"]['Open-AudIT Professional. The worlds'] = 'Open-Audit Professionnel. Le monde';

$GLOBALS["lang"]['Open-AudIT can be configured to use LDAP servers (Microsoft Active Directory and/or OpenLDAP) to authenticate and authorize a user and in addition, to create a user account in Open-AudIT using assigned roles and orgs based on LDAP group membership. It can also use'] = 'Aud ouvert L\'informatique peut être configurée pour utiliser des serveurs LDAP (Microsoft Active Directory et/ou OpenLDAP) pour authentifier et autoriser un utilisateur et, en outre, pour créer un compte utilisateur dans Open-Audit en utilisant des rôles et des orgs attribués en fonction de l\'adhésion au groupe LDAP. Il peut également utiliser';

$GLOBALS["lang"]['Open-AudIT can be run on your server in your data center. It does not need access to the internet at all. Even the installation on Linux where we use the distribution package manager for our prerequisites can be negated by you using an in-house and security team-approved package repository.<br><br>Open-AudIT does not store any of your data in the cloud. Even licensing information can be provided without having to access the internet from the Open-AudIT server.<br><br>Sure, it is easier to allow it to access the internet to download packages (including security fixes) for your distribution, but that is up to you and your security policies. Open-AudIT does not need the internet.'] = 'Aud ouvert L\'informatique peut être exécutée sur votre serveur dans votre centre de données. Il n\'a pas besoin d\'accéder à Internet du tout. Même l\'installation sur Linux où nous utilisons le gestionnaire de paquets de distribution pour nos prérequis peut être annulée par vous en utilisant un dépôt de paquets interne et approuvé par l\'équipe de sécurité.<br/><br/>Aud ouvert IT ne stocke aucune de vos données dans le cloud. Même les informations de licence peuvent être fournies sans avoir à accéder à Internet depuis le serveur Open-Audit.<br/><br/>Bien sûr, il est plus facile de lui permettre d\'accéder à Internet pour télécharger des paquets (y compris des correctifs de sécurité) pour votre distribution, mais cela dépend de vous et de vos politiques de sécurité. Open-Audit n\'a pas besoin d\'Internet.';
...
$GLOBALS["lang"]['Open-AudIT can show in one of several languages. How you can improve this?'] = 'Aud ouvert L\'informatique peut apparaître dans l\'une des langues. Comment pouvez-vous améliorer cela?';
...
$GLOBALS["lang"]['Open-AudIT can use Microsoft Entra (previously known as Microsoft Azure Active Directory) as an authentication method. This means your user in Open-AudIT can click the Logon using Entra button on the logon page and use their Entra credentials to logon. That user will need to already exist within Open-AudIT (and be assigned'] = 'Open-Audit peut utiliser Microsoft Entra (anciennement appelé Microsoft Azure Active Directory) comme méthode d\'authentification. Cela signifie que votre utilisateur dans Open-Audit peut cliquer sur Logon en utilisant le bouton Entra sur la page de connexion et utiliser leurs identifiants Entra pour se connecter. Cet utilisateur devra déjà exister dans Open-Audit (et être assigné';

$GLOBALS["lang"]['Open-AudIT can use OKTA as an authentication method. This means your user in Open-AudIT can click the Logon using OKTA button on the logon page and use their OKTA credentials to logon. That user will need to already exist within Open-AudIT (and be assigned Roles and Orgs), but will not need to remember a separate set of logon credentials.'] = 'Open-Audit peut utiliser OKTA comme méthode d\'authentification. Cela signifie que votre utilisateur dans Open-Audit peut cliquer sur Logon en utilisant le bouton OKTA sur la page de connexion et utiliser leurs identifiants OKTA pour se connecter. Cet utilisateur devra déjà exister au sein d\'Open-Audit (et être assigné Rôles et Orgs), mais n\'aura pas besoin de se souvenir d\'un ensemble distinct d\'identificateurs de logo.';
...
$GLOBALS["lang"]['Open-AudIT should be installed on 64bit Windows <strong>Server</strong> systems only. Windows 10 and Windows 11 are <strong>not</strong> supported.'] = 'Open-Audit doit être installé sur Windows 64bit <strong>Serveur</strong> seulement. Windows 10 et Windows 11 sont <strong>pas</strong> L\'aide est accordée.';
...
$GLOBALS["lang"]['Open-AudIT was written by an English speaking Australian. Everything in the application uses English wording. However Open-AudIT has always supported multiple languages for display. These translations are not always correct, because the developers do not natively speak the language of every translation offered.<br><br>What can you do if something is not correct in the translation?'] = 'Open-Audit a été écrit par un Australien parlant anglais. Tout dans l\'application utilise la formulation anglaise. Cependant Open-Audit a toujours supporté plusieurs langues pour l\'affichage. Ces traductions ne sont pas toujours correctes, car les développeurs ne parlent pas nativement la langue de chaque traduction offerte.<br/><br/>Que pouvez-vous faire si quelque chose n\'est pas correct dans la traduction?';
...
$GLOBALS["lang"]['Optional Agent Based Auditing'] = 'Vérification facultative fondée sur l\'agent';
...
$GLOBALS["lang"]['Other than that restriction, you are free to select attributes as required. It is a good idea to use the menu'] = 'En dehors de cette restriction, vous êtes libre de sélectionner des attributs selon les besoins. C\'est une bonne idée d\'utiliser le menu';

$GLOBALS["lang"]['Others'] = 'Autres';

$GLOBALS["lang"]['Our default Integration also enables a discovery on any externally supplied devices. So we ship a default discovery for the Default Integration out of the box. These use the default matching rules, but also enable matching on IP address.'] = 'Notre intégration par défaut permet également une découverte sur tout appareil fourni de l\'extérieur. Donc, nous expédions une découverte par défaut pour l\'intégration par défaut hors de la boîte. Ceux-ci utilisent les règles de correspondance par défaut, mais permettent également de faire correspondre l\'adresse IP.';
...
$GLOBALS["lang"]['Please visit the homepage at'] = 'Veuillez visiter la page d\'accueil à';
...
$GLOBALS["lang"]['Proprietary. If you want to modify HighCharts you may require a'] = 'Propriétaire. Si vous voulez modifier HighCharts, vous pouvez avoir besoin d\'un';

$GLOBALS["lang"]['Protects confidentiality, integrity, and availability of information'] = 'Protège la confidentialité, l\'intégrité et la disponibilité de l\'information';
...
$GLOBALS["lang"]['Query this Active Directory attribute first to determine the users work unit.'] = 'Interrogez d\'abord cet attribut Active Directory pour déterminer l\'unité de travail des utilisateurs.';

$GLOBALS["lang"]['Query this Active Directory attribute second to determine the users work unit.'] = 'Interrogez cet attribut Active Directory deuxième pour déterminer l\'unité de travail des utilisateurs.';
...
$GLOBALS["lang"]['Repeat until you have a completely discovered and audited Windows PC.'] = 'Répétez jusqu\'à ce que vous ayez un PC Windows complètement découvert et vérifié.';
...
$GLOBALS["lang"]['Required AWS user permissions'] = 'Autorisations requises de l\'utilisateur AWS';
...
$GLOBALS["lang"]['Retrieve all details about the device with id 88.'] = 'Récupérer tous les détails sur l\'appareil avec id 88.';
...
$GLOBALS["lang"]['SQL not containing this condition will result in the widget failing to be executed.'] = 'SQL ne contenant pas cette condition entraînera l\'échec du widget à être exécuté.';
...
$GLOBALS["lang"]['Save and run the file. Make sure you run the file as an Administrator in order to install it (right click, Run as Administrator).'] = 'Enregistrer et lancer le fichier. Assurez-vous d\'exécuter le fichier en tant qu\'administrateur afin de l\'installer (clic droit, Exécuter en tant qu\'administrateur).';
...
$GLOBALS["lang"]['Security Content Automation Protocol'] = 'Protocole d\'automatisation du contenu de sécurité';
...
$GLOBALS["lang"]['Select the <i>COM Security</i> tab<br><br>Click on Access Permissions Edit Default'] = 'Sélectionnez la <i>COMMISSION ÉCONOMIQUE POUR L\'EUROPE Sécurité</i> onglet<br/><br/>Cliquez sur Autorisations d\'accès Modifier par défaut';

$GLOBALS["lang"]['Select the <i>Sign On</i> tab and copy the value for <i>Issuer</i> (just the URL itself). Paste this into the Open-AudIT <i>Issuer</i> field.'] = 'Sélectionnez la <i>Signer</i> onglet et copier la valeur pour <i>Émetteur</i> (juste l\'URL elle-même). Coller ceci dans l\'Open-Audit <i>Émetteur</i> sur le terrain.';
...
$GLOBALS["lang"]['Select the Start menu and type <i>services<.i>. Click the Services icon.'] = 'Sélectionnez le menu Démarrer et tapez <i>services <.i>. Cliquez sur l\'icône Services.</i>';

$GLOBALS["lang"]['Select the type of Auth Menthod to create and input the relevant details.'] = 'Sélectionnez le type d\'Auth Menthod pour créer et saisir les détails pertinents.';
...
$GLOBALS["lang"]['Setting up Discovery on a subnet is almost identical to running a regular Discovery via the web interface. The only additional items are the scheduled hour and day(s) and a name for the Scheduled Task itself. You can take advantage of this to schedule multiple discoveries using different sets of credentials.<br><br>As per the Subnet Discovery, the Active Directory Discovery is also simply the same fields as a regular Active Directory Discovery with the addition of a day, hour(s) and name.<br><br>If the Open-AudIT Server has Collectors reporting to it, an additional drop down is provided. You can select this to specify which Collector the task should run on. Only Discovery tasks are supported for Collectors. Specify the same items as a regular Discovery, but provide the alternate Collector to run this task.'] = 'Configurer Discovery sur un sous-réseau est presque identique à exécuter une Discovery régulière via l\'interface web. Les seuls éléments supplémentaires sont l\'heure et le jour prévus et un nom pour la tâche programmée elle-même. Vous pouvez en profiter pour planifier plusieurs découvertes en utilisant différents ensembles d\'identifiants.<br/><br/>Selon le Subnet Discovery, l\'Active Directory Discovery est aussi simplement les mêmes champs qu\'une Active Directory Discovery régulière avec l\'ajout d\'une journée, d\'une heure ou d\'un nom.<br/><br/>Si le serveur Open-Audit a des collecteurs qui lui rendent compte, une goutte d\'eau supplémentaire est fournie. Vous pouvez sélectionner ceci pour spécifier quel Collector la tâche doit être exécutée. Seules les tâches Discovery sont prises en charge pour les Collectors. Spécifiez les mêmes éléments qu\'une Discovery régulière, mais fournissez le collecteur alternatif pour exécuter cette tâche.';
...
$GLOBALS["lang"]['Shipped are a set of default items. These can be found by going to menu'] = 'Expédié sont un ensemble d\'éléments par défaut. Vous pouvez les trouver en allant au menu';
...
$GLOBALS["lang"]['Should we convert the hostname to lowercase.'] = 'Si nous convertissons le nom d\'hôte en minuscules.';
...
$GLOBALS["lang"]['Should we hide the audit script window when executing.'] = 'Si nous cachons la fenêtre du script d\'audit lors de l\'exécution.';
...
$GLOBALS["lang"]['Some other error has occurred when attempting to bind to the LDAP server. It is contactable (ie, the <i>connect</i> above has worked), but for some other reason, binding has not occurred. Check the logs on the LDAP server.'] = 'Une autre erreur s\'est produite lors de la tentative de se lier au serveur LDAP. Il est contactable (c\'est-à-dire <i>Connexion</i> ci-dessus a fonctionné), mais pour une autre raison, il n\'y a pas de liaison. Vérifiez les journaux sur le serveur LDAP.';
...
$GLOBALS["lang"]['Sometimes agentless discovery just does not fit your use-case. Maybe your PCs have tight firewalls. Maybe they are not on the network when your discoveries are scheduled. Maybe they are used by remote workers. Whatever the case, this is where an agent can help. Install it on the target machine and it will <i>check-in</i> with your Open-AudIT server on a schedule and accept tasks. The most common task the server requests is for the agent to audit itself and send the result.'] = 'Parfois, la découverte sans agent ne correspond pas à votre cas d\'utilisation. Peut-être que vos PC ont des pare-feu serrés. Peut-être ne sont-ils pas sur le réseau quand vos découvertes sont programmées. Ils sont peut-être utilisés par des travailleurs éloignés. Quoi qu\'il en soit, c\'est là qu\'un agent peut aider. Installez-le sur la machine cible et il sera <i>enregistrement</i> avec votre serveur Open-Audit sur un calendrier et accepter les tâches. La tâche la plus courante que demande le serveur est que l\'agent se vérifie et envoie le résultat.';
...
$GLOBALS["lang"]['Stage 2: Implementation and effectiveness review'] = 'Étape 2 : Examen de la mise en œuvre et de l\'efficacité';
...
$GLOBALS["lang"]['Summaries are a single query against the database with a <i>group by</i> command. Using this simple method we can easily create a summary for virtually any attribute.<br><br>We no longer require a separate report for each <i>type</i> of a device. We now simply have a summary that groups by <i>devices.type</i> and shows the result. You can then click on a given type from the list and see the matching devices. In this case, one Summary replaces (potentially) 78 reports (there are 78 device types).<br><br>A summary is different to a query in that a summary is designed to group items by a given attribute then provide a <i>click through</i> link to the actual devices. A query is simply a list of items with no further links. As above - this of a Summary as a combined <i>report + subreport</i>, whereas a query is simply a single Report.<br><br>Summaries have a different collection template to the other resources within Open-AudIT. This template shows the Summary as you would expect and also shows buttons with counts of other resources. This page is designed to be the HomePage of Open-AudIT.'] = 'Résumés sont une requête unique contre la base de données avec un <i>groupe par</i> commande. En utilisant cette méthode simple, nous pouvons facilement créer un résumé pour pratiquement n\'importe quel attribut.<br/><br/>Nous n\'avons plus besoin d\'un rapport distinct pour chaque <i>type</i> d\'un dispositif. Nous avons maintenant simplement un résumé que les groupes <i>dispositifs. type</i> et montre le résultat. Vous pouvez ensuite cliquer sur un type donné dans la liste et voir les appareils correspondants. Dans ce cas, un résumé remplace (potentiellement) 78 déclarations (il existe 78 types d\'appareils).<br/><br/>Un résumé est différent d\'une requête en ce sens qu\'un résumé est conçu pour regrouper des éléments par un attribut donné <i>cliquez sur</i> lien vers les appareils réels. Une requête est simplement une liste d\'éléments sans autres liens. Comme ci-dessus - celui d\'un résumé comme un ensemble <i>rapport + sous-rapport</i>, alors qu\'une requête n\'est qu\'un seul rapport.<br/><br/>Les résumés ont un modèle de collecte différent des autres ressources de Open-Audit. Ce modèle montre le Sommaire comme vous vous y attendez et montre également des boutons avec le nombre d\'autres ressources. Cette page est conçue pour être la Page d\'accueil de Open-Audit.';

$GLOBALS["lang"]['Summaries are designed to group items by a particular matching column and then to provide a link to individual devices. In the previous versions of Open-AudIT, this would have been two different items - a report and subreport. We have now bundled these into what we call a Summary.'] = 'Les résumés sont conçus pour regrouper les éléments par une colonne de correspondance particulière, puis pour fournir un lien vers des appareils individuels. Dans les versions précédentes d\'Open-Audit, il s\'agirait de deux éléments différents - un rapport et un sous-rapport. Nous les avons maintenant regroupés dans ce que nous appelons un résumé.';
...
$GLOBALS["lang"]['Tasks can be one of several distinct types: Baseline, Discovery, Report, Query, Summary or Collector.'] = 'Les tâches peuvent être l\'un de plusieurs types distincts : base de données, découverte, rapport, requête, résumé ou collecteur.';
...
$GLOBALS["lang"]['Tennant ID'] = 'Numéro d\'identification';
...
$GLOBALS["lang"]['Thank you for starting your journey with the best discovery and inventory tool around.'] = 'Merci de commencer votre voyage avec le meilleur outil de découverte et d\'inventaire autour.';

$GLOBALS["lang"]['Thanks to'] = 'Grâce à';

$GLOBALS["lang"]['Thats it! You have just edited the attributes of as many devices as you need to.'] = 'C\'est ça ! Vous venez d\'éditer les attributs de autant d\'appareils que vous en avez besoin.';

$GLOBALS["lang"]['The <i>Roles</i> endpoint allows you to manage the set of permissions(Create, Read, Update, Delete) that are granted to the users and are applied to each endpoint.'] = 'Les <i>Rôles</i> endpoint vous permet de gérer l\'ensemble des permissions (Créer, Lire, Mettre à jour, Supprimer) qui sont accordées aux utilisateurs et appliquées à chaque endpoint.';

$GLOBALS["lang"]['The API uses a cookie. You can request a cookie by sending a POST to the URL below, containing the username and password attributes and values:'] = 'L\'API utilise un cookie. Vous pouvez demander un cookie en envoyant un POST à l\'URL ci-dessous, contenant les attributs et les valeurs du nom d\'utilisateur et du mot de passe:';
...
$GLOBALS["lang"]['The Attributes endpoint allows you to add customized values to different attributes in Open-AudIT, at the moment this feature works on the Class, Environment, Status and Type attributes on Devices, the Type attribute for both Locations and Orgs as well as the Menu Category for Queries. If you view an item of one of the prvious types (say view a Lkocation) you will notice the Type attribute must be selected from a drop-down box. This is where those values are stored. Hence, if you would like to add a new Type to be chosen for a Location, add it using the Attributes feature.'] = 'Le paramètre Attributs vous permet d\'ajouter des valeurs personnalisées à différents attributs dans Open-Audit, pour le moment cette fonctionnalité fonctionne sur les attributs Classe, Environnement, État et Type des périphériques, l\'attribut Type pour les emplacements et les orgs ainsi que la catégorie Menu pour les requêtes. Si vous visualisez un élément de l\'un des types prvieux (disons afficher un Lkocation), vous remarquerez que l\'attribut Type doit être sélectionné dans une boîte déroulante. C\'est là que ces valeurs sont stockées. Par conséquent, si vous souhaitez ajouter un nouveau Type à choisir pour un Emplacement, ajoutez-le en utilisant la fonctionnalité Attributs.';
...
$GLOBALS["lang"]['The CVE has been published to the CVE List and included in the NVD dataset. Initial ingestion only.'] = 'Le CVE a été publié sur la liste des CVE et inclus dans l\'ensemble de données du NVD. ingestion initiale seulement.';

$GLOBALS["lang"]['The CVE has been updated after initial analysis. NVD enrichment data may have been revised.'] = 'Le CVE a été mis à jour après l\'analyse initiale. Les données sur l\'enrichissement en NVD peuvent avoir été révisées.';

$GLOBALS["lang"]['The CVE identifier.'] = 'L\'identificateur CVE.';

$GLOBALS["lang"]['The CVE is actively being enriched with CVSS scores, CWE classifications, reference tags, and CPE applicability.'] = 'Le CVE est activement enrichi de scores CVSS, de classifications CWE, d\'étiquettes de référence et d\'applicabilité CPE.';

$GLOBALS["lang"]['The CVE is not currently prioritized for enrichment due to resource constraints or other reasons.'] = 'À l\'heure actuelle, la priorité n\'est pas accordée à l\'enrichissement en raison de contraintes de ressources ou d\'autres raisons.';

$GLOBALS["lang"]['The CVE is queued for enrichment by NVD analysts. No detailed metadata yet.'] = 'Le CVE est en attente d\'enrichissement par les analystes du NVD. Pas encore de métadonnées détaillées.';
...
$GLOBALS["lang"]['The Device Seed Discovery type is the newest highly-effective method for network crawling, giving you the ability to target your network as narrowly or as broadly as you need. It is fast, it works and it is great.'] = 'Le type Device Seed Discovery est la nouvelle méthode très efficace pour le rampage en réseau, vous donnant la possibilité de cibler votre réseau aussi étroitement ou aussi largement que vous avez besoin. C\'est rapide, ça marche et c\'est génial.';

$GLOBALS["lang"]['The Discovery Scan Options we ship are detailed in the table below. As above, Enterprise users can create more of these or edit the shipped items.'] = 'Le balayage de découverte Les options que nous expédions sont détaillées dans le tableau ci-dessous. Comme ci-dessus, les utilisateurs d\'Enterprise peuvent en créer plus ou modifier les articles expédiés.';

$GLOBALS["lang"]['The Elevated User query'] = 'La requête de l\'utilisateur élevé';

$GLOBALS["lang"]['The Executables feature scans the disk of a device as part of the audit and checks that every executable file is known to the package manager. Because it uses the package manager, the feature applies to Linux target devices only, and further than that, only rpm or deb based distributions. Anything Redhat or Debian based should work.'] = 'La fonction Executables scanne le disque d\'un appareil dans le cadre de l\'audit et vérifie que chaque fichier exécutable est connu du gestionnaire de paquets. Parce qu\'il utilise le gestionnaire de paquets, la fonctionnalité s\'applique uniquement aux périphériques cibles Linux, et plus encore, seulement les distributions basées sur rpm ou deb. Tout ce qui est basé sur Redhat ou Debian devrait fonctionner.';
...
$GLOBALS["lang"]['The LDAP server could not be connected to. At all. Check it is pingable from the Open-AudIT server. Check the correct port is open to the Open-AudIT server. An nmap from the Open-AudIT server will show this. Substitute your LDAP servers IP for $ip. Try:<code>nmap -vv $ip</code>'] = 'Le serveur LDAP n\'a pas pu être connecté. Du tout. Vérifiez qu\'il est pingable depuis le serveur Open-Audit. Vérifiez que le bon port est ouvert au serveur Open-Audit. Une nmap du serveur Open-Audit va l\'afficher. Remplacez votre IP de serveurs LDAP par $ip. Essayez :<code>nmap -vv $ip</code>';
...
$GLOBALS["lang"]['The LDAP server was connected to and the user credentials accepted for bind.'] = 'Le serveur LDAP a été connecté et les identifiants d\'utilisateur acceptés pour lier.';

$GLOBALS["lang"]['The Linux Open-AudIT installer will test for and if required, install Open-AudITs dependencies from your distributions repository, including setting the Nmap SetUID. This is required for SNMP (UDP 161) detection by a non-root user. This is supported on RedHat/CentOS and Debian/Ubuntu. If you need to manually install Nmap:<br><br>For RedHat/CentOS do (NOTE - if you upgrade using yum, you will need to reapply this <i>chmod</i> setting).'] = 'L\'installateur Linux Open-Audit testera et, si nécessaire, installera les dépendances Open-Audits à partir de votre dépôt de distributions, y compris la configuration du Nmap SetUID. Ceci est requis pour la détection SNMP (UDP 161) par un utilisateur non root. Ceci est supporté sur RedHat/CentOS et Debian/Ubuntu. Si vous devez installer manuellement Nmap:<br/><br/>Pour RedHat/CentOS faire (NOTE - si vous mettez à niveau à l\'aide de yum, vous devrez réappliquer cette <i>Chmod</i> réglage).';
...
$GLOBALS["lang"]['The National Institute of Standards and Technology is the federal technology agency. They advance official technology, measurement science and standards.'] = 'L\'Institut national des normes et de la technologie est l\'organisme fédéral de technologie. Ils font progresser la technologie officielle, la science de la mesure et les normes.';
...
$GLOBALS["lang"]['The OpenSCAP ecosystem provides multiple tools to assist administrators and auditors with assessment, measurement, and enforcement of security baselines including a wide variety of hardening guides and configuration baselines developed by the open source community, ensuring that you can choose a security policy which best suits the needs of your organization, regardless of its size.'] = 'L\'écosystème OpenSCAP offre de nombreux outils pour aider les administrateurs et les vérificateurs à évaluer, mesurer et appliquer les niveaux de référence en matière de sécurité, y compris une grande variété de guides de durcissement et de niveaux de référence de configuration élaborés par la communauté open source, en s\'assurant que vous pouvez choisir une politique de sécurité qui correspond le mieux aux besoins de votre organisation, quelle que soit sa taille.';

$GLOBALS["lang"]['The OpenSCAP project is a collection of open source tools for implementing and enforcing this standard, and has been awarded the SCAP 1.2 certification by NIST in 2014.'] = 'Le projet OpenSCAP est une collection d\'outils libres pour la mise en œuvre et l\'application de cette norme, et a reçu la certification SCAP 1.2 du NIST en 2014.';
...
$GLOBALS["lang"]['The Racks feature is used to manage and visualize your rack use with an Organisation, Location, Building, Floor, Room and Row.'] = 'La fonction Racks est utilisée pour gérer et visualiser l\'utilisation de votre rack avec une organisation, emplacement, bâtiment, étage, chambre et ligne.';
...
$GLOBALS["lang"]['The Standards functionality in Open-AudIT allows you to, ahead of time, complete the questions auditors require when completing ISO 27001 certification.'] = 'La fonctionnalité Standards dans Open-Audit vous permet, à l\'avance, de remplir les questions que les auditeurs doivent remplir lors de la certification ISO 27001.';
...
$GLOBALS["lang"]['The WHERE'] = 'L\'endroit';
...
$GLOBALS["lang"]['The account must have a password; WMI does not allow blank passwords.'] = 'Le compte doit avoir un mot de passe; WMI n\'autorise pas les mots de passe vides.';

$GLOBALS["lang"]['The account password must NOT contain \" (double quotes). This is because cscript (and wscript) cannot parse argument values containing double quotes. They are simply stripped. No (before you ask) escaping will not work. This is a cscript limitation and nothing to do with Open-AudIT.'] = 'Le mot de passe du compte ne doit PAS contenir \" (double guillemets). C\'est parce que cscript (et wscript) ne peut pas analyser les valeurs d\'argument contenant des guillemets doubles. Ils sont simplement dépouillés. Non (avant de demander) l\'évasion ne fonctionnera pas. C\'est une limitation de cscript et rien à voir avec Open-Audit.';

$GLOBALS["lang"]['The actual full name of this user.'] = 'Le nom complet de cet utilisateur.';

$GLOBALS["lang"]['The address of the Open-AudIT server submit page.'] = 'L\'adresse du serveur Open-Audit soumet la page.';

$GLOBALS["lang"]['The administrator supplied credentials that were successfully used to bind to LDAP.'] = 'L\'administrateur a fourni des justificatifs d\'identité qui ont été utilisés avec succès pour se lier à LDAP.';

$GLOBALS["lang"]['The administrator supplied credentials to bind to the LDAP server, but they have not been accepted by the LDAP sevrer. Double check the credentials work on the LDAP server, and then check (or reset them) in the Open-AudIT LDAP Server entry.'] = 'L\'administrateur a fourni des identifiants pour se lier au serveur LDAP, mais ils n\'ont pas été acceptés par le sevrer LDAP. Vérifiez les identifiants sur le serveur LDAP, puis vérifiez (ou réinitialisez-les) dans l\'entrée Open-Audit LDAP Server.';

$GLOBALS["lang"]['The agent and server are also intelligent enough to self-update the agent if a newer version is installed on the server (say after upgrading Open-AudIT).'] = 'L\'agent et le serveur sont également suffisamment intelligents pour se mettre à jour automatiquement l\'agent si une version plus récente est installée sur le serveur (par exemple après la mise à jour d\'Open-Audit).';

$GLOBALS["lang"]['The agent should download a fresh copy of the audit script, run it and submit the result to the server.'] = 'L\'agent doit télécharger une nouvelle copie du script d\'audit, l\'exécuter et soumettre le résultat au serveur.';

$GLOBALS["lang"]['The application creates temporary audit scrtips here, copies them to the target machines, then deletes them.'] = 'L\'application crée ici des brouillons d\'audit temporaires, les copie aux machines cibles, puis les supprime.';
...
$GLOBALS["lang"]['The audit script will use the files[ ] array and retrieve the file details.'] = 'Le script d\'audit utilisera le tableau fichiers[ ] et récupérera les détails du fichier.';
...
$GLOBALS["lang"]['The credentials supplied by the user have failed.'] = 'Les identifiants fournis par l\'utilisateur ont échoué.';

$GLOBALS["lang"]['The credentials username.'] = 'Le nom d\'utilisateur d\'identification.';

$GLOBALS["lang"]['The current date and time in the format: Y-m-d H:i:s.'] = 'Date et heure actuelles dans le format: Y-m-d C\'est vrai.';
...
$GLOBALS["lang"]['The data stored in the database is not showing in the application translated. We leave the data as it is. However, there is nothing to stop you, the user, changing the name (for example) of an item in the database to your language.'] = 'Les données stockées dans la base de données ne sont pas affichées dans l\'application traduite. Nous laissons les données telles quelles. Cependant, rien n\'empêche l\'utilisateur de changer le nom (par exemple) d\'un élément de la base de données dans votre langue.';

$GLOBALS["lang"]['The data you input will be used in a <code>LIKE</code> clause, not (as per the API) an <code>equals</code> clause. Another example - if you input <code>comput</code>, it would still return all computers. And because we are using a <code>LIKE</code> clause, it is case-insensitive.'] = 'Les données que vous entrez seront utilisées dans une <code>LIKE</code> clause, pas (selon l\'API) <code>equals</code> clause. Un autre exemple - si vous entrez <code>comput</code>, il retournerait toujours tous les ordinateurs. Et parce que nous utilisons <code>LIKE</code> clause, il est insensible aux cas.';

$GLOBALS["lang"]['The database schema can be found in the application if the user has database::read permission by going to menu: Admin -> Database ->'] = 'Le schéma de base de données peut être trouvé dans l\'application si l\'utilisateur a la base de données::lire la permission en allant au menu: Admin -> Base de données ->';
...
$GLOBALS["lang"]['The default discovery scan option is the UltraFast set.'] = 'L\'option de recherche par défaut est l\'ensemble UltraFast.';
...
$GLOBALS["lang"]['The exploited vulnerability can affect resources beyond the security authority of the vulnerable component. This usually means a privilege or trust boundary is crossed (for example, escaping from a container to the host OS).'] = 'La vulnérabilité exploitée peut affecter des ressources au-delà de l\'autorité de sécurité de la composante vulnérable. Cela signifie généralement qu\'un privilège ou une limite de confiance est franchi (par exemple, s\'échapper d\'un conteneur à l\'OS hôte).';

$GLOBALS["lang"]['The exploited vulnerability only impacts resources within the same security authority as the vulnerable component. In other words, the attacker’s actions stay within the original trust boundary.'] = 'La vulnérabilité exploitée n\'a d\'incidence que sur les ressources de la même autorité de sécurité que la composante vulnérable. En d\'autres termes, les actions de l\'agresseur restent à l\'intérieur de la limite de confiance initiale.';
...
$GLOBALS["lang"]['The fields associated with an Integration are stored in the database as a JSON array of objects. Each field has the following attributes'] = 'Les champs associés à une intégration sont stockés dans la base de données comme un tableau d\'objets JSON. Chaque champ possède les attributs suivants :';
...
$GLOBALS["lang"]['The logic for device matching is contained in the devices_helper.php file, which on a Linux install can be found here'] = 'La logique pour l\'appariement des périphériques est contenue dans le fichier devices_helper.php, qui sur une installation Linux peut être trouvé ici';

$GLOBALS["lang"]['The machine-default permission settings do not grant Local Activation permission for the COM Server application with'] = 'Les paramètres d\'autorisation par défaut de la machine ne permettent pas l\'activation locale de l\'application COM Server avec';
...
$GLOBALS["lang"]['The new Agent runs a PowerShell version of the old audit script in preparation for the depreciation of VBScript (yes, it is coming).'] = 'Le nouvel Agent exécute une version PowerShell de l\'ancien script d\'audit en préparation de l\'amortissement de VBScript (oui, il arrive).';
...
$GLOBALS["lang"]['The offset is the count of devices you wish to return data from.'] = 'Le décalage est le nombre d\'appareils que vous souhaitez retourner des données.';
...
$GLOBALS["lang"]['The order of information retrieval is snmp, ssh, wmi.'] = 'L\'ordre de recherche de l\'information est snmp, ssh, wmi.';

$GLOBALS["lang"]['The orientation of this device.'] = 'L\'orientation de cet appareil.';

$GLOBALS["lang"]['The password (if not using the user running the script).'] = 'Le mot de passe (si l\'utilisateur n\'utilise pas le script).';
...
$GLOBALS["lang"]['The primary method for authorization (what a user can do) is now based on the users Roles. Roles are defined as admin, org_admin, reporter, and user by default. Each role has a set of permissions (Create, Read, Update, Delete) for each endpoint. Standard roles as shipped should cover 99.9 percent of use-cases. The ability to define additional roles and edit existing roles is enabled in Open-AudIT Enterprise.'] = 'La principale méthode d\'autorisation (ce qu\'un utilisateur peut faire) est maintenant basée sur les rôles des utilisateurs. Les rôles sont définis par admin, org_admin, reporter et utilisateur par défaut. Chaque rôle a un ensemble de permissions (Créer, Lire, Mettre à jour, Supprimer) pour chaque paramètre. Les rôles standard tels que expédiés devraient couvrir 99,9 % des cas d\'utilisation. La possibilité de définir des rôles supplémentaires et de modifier des rôles existants est activée dans Open-Audit Enterprise.';
...
$GLOBALS["lang"]['The target computer to audit. \".\" means localhost.'] = 'L\'ordinateur cible à vérifier. \".\" signifie localhost.';
...
$GLOBALS["lang"]['The unfiltered state means that a port is accessible, but Nmap is unable to determine whether it is open or closed. Only the ACK scan, which is used to map firewall rulesets, classifies ports into this state. Scanning unfiltered ports with other scan types such as Window scan, SYN scan, or FIN scan, may help resolve whether the port is open.'] = 'L\'état non filtré signifie qu\'un port est accessible, mais Nmap est incapable de déterminer s\'il est ouvert ou fermé. Seul l\'analyse ACK, qui est utilisé pour mapper les règles du pare-feu, classe les ports dans cet état. Scanner des ports non filtrés avec d\'autres types de scan tels que Window Scan, SYN Scan ou FIN Scan, peut aider à résoudre si le port est ouvert.';
...
$GLOBALS["lang"]['The user in Active Directory / OpenLDAP must be a direct member of the required Open-AudIT groups for Roles and Orgs. A member of a group that is a member another group that is a member of the Open-AudIT group will not work.'] = 'L\'utilisateur dans Active Directory / OpenLDAP doit être un membre direct des groupes Open-Audit requis pour les rôles et les orgs. Un membre d\'un groupe qui est membre d\'un autre groupe qui est membre du groupe Open-Audit ne fonctionnera pas.';

$GLOBALS["lang"]['The user is in LDAP and their credentials are valid, but is not in any of the Open-AudIT LDAP groups for Orgs.'] = 'L\'utilisateur est en LDAP et ses identifiants sont valides, mais n\'est dans aucun des groupes Open-Audit LDAP pour Orgs.';

$GLOBALS["lang"]['The user is in LDAP and their credentials are valid, but is not in any of the Open-AudIT LDAP groups for Roles.'] = 'L\'utilisateur est en LDAP et ses identifiants sont valides, mais n\'est dans aucun des groupes Open-Audit LDAP pour les rôles.';

$GLOBALS["lang"]['The user is in LDAP and their credentials are valid, but is not in any of the required Open-AudIT LDAP groups.'] = 'L\'utilisateur est dans LDAP et leurs identifiants sont valides, mais n\'est dans aucun des groupes LDAP Open-Audit requis.';

$GLOBALS["lang"]['The user is in the LDAP group that matches this Org.'] = 'L\'utilisateur est dans le groupe LDAP qui correspond à cet Org.';

$GLOBALS["lang"]['The user is in the LDAP group that matches this Role.'] = 'L\'utilisateur est dans le groupe LDAP qui correspond à ce rôle.';

$GLOBALS["lang"]['The user is not in the LDAP group that matches this Org.'] = 'L\'utilisateur n\'est pas dans le groupe LDAP qui correspond à cet Org.';

$GLOBALS["lang"]['The user is not in the LDAP group that matches this Role.'] = 'L\'utilisateur n\'est pas dans le groupe LDAP qui correspond à ce rôle.';

$GLOBALS["lang"]['The user that was specified exists in LDAP, but Open-AudIT is not configured to consume the LDAP groups for roles and that user does not exist within Open-AudIT. Either select <i>Use LDAP for Roles</i> on the Open-AudIT LDAP Server screen or create this user within Open-AudIT and assign roles and orgs.'] = 'L\'utilisateur qui a été spécifié existe dans LDAP, mais Open-Audit n\'est pas configuré pour consommer les groupes LDAP pour les rôles et cet utilisateur n\'existe pas dans Open-Audit. Soit sélectionner <i>Utiliser LDAP pour les rôles</i> sur l\'Open-Audit LDAP Écran serveur ou créez cet utilisateur dans Open-Audit et assignez des rôles et des orgs.';

$GLOBALS["lang"]['The username (if not using the user running the script).'] = 'Nom d\'utilisateur (si l\'utilisateur n\'utilise pas le script).';
...
$GLOBALS["lang"]['The users details were not retrieved from LDAP. Check the LDAP server logs.'] = 'Les détails des utilisateurs n\'ont pas été récupérés de LDAP. Vérifiez les journaux du serveur LDAP.';
...
$GLOBALS["lang"]['Then create a new Auth method in Open-AudIT by going to menu -> Admin -> Auth Methods -> Create Auth. Provide a name and set the <i>type</i> to Entra.'] = 'Puis créez une nouvelle méthode Auth dans Open-Audit en allant au menu -> Admin -> Méthodes d\'évaluation -> Créez Auth. Fournir un nom et définir le <i>type</i> pour Entra.';

$GLOBALS["lang"]['Then you can use Open-AudIT (unsupported) to receive audit data directly from the clients. Discovery <strong>will fail</strong>, but if youre not using Discovery (the main feature Open-AudIT was designed around), you can still get device data. You would need to run the audit scripts directly on the clients using cron, or use the Windows Agent feature (Enterprise only).'] = 'Ensuite, vous pouvez utiliser Open-Audit (sans support) pour recevoir les données d\'audit directement des clients. Découverte <strong>échouera</strong>, mais si vous n\'utilisez pas Discovery (la fonction principale Open-Audit a été conçue autour), vous pouvez toujours obtenir des données de l\'appareil. Vous devrez exécuter les scripts d\'audit directement sur les clients en utilisant cron, ou utiliser la fonctionnalité Windows Agent (Entreprise seulement).';

$GLOBALS["lang"]['There is a button to export to JSON. This will display only the device table of attributes. To export the device with all associated component tables, view the device details, then add'] = 'Il y a un bouton pour exporter vers JSON. Ceci n\'affichera que la table des attributs du périphérique. Pour exporter l\'appareil avec toutes les tables de composants associées, voir les détails de l\'appareil, puis ajouter';

$GLOBALS["lang"]['There is absolutely no need to manually edit each individual device.'] = 'Il n\'est absolument pas nécessaire de modifier manuellement chaque appareil.';

$GLOBALS["lang"]['There is no need to do anything if you are running Open-AudIT on a Linux server.<br><br>Windows clients are just fine and require no special actions, however.... to enable this feature the audit script must be run locally on the target Windows system. It cannot be run remotely as we do with WMI calls when running the audit script on one Windows machine, while targeting a second Windows machine. To do this we need to copy the audit script to the target Windows machine and then run it. Unfortunately the service account that Apache runs under is the Local System account. This account has no access to remote (network based) resources. To work around this issue the service must be run under another account. It is easiest to just use the local Administrator account, but you can try any account you like as long as it has the required privileges. The Local System account has as much local access as the local Administrator account.'] = 'Il n\'est pas nécessaire de faire quoi que ce soit si vous utilisez Open-Audit sur un serveur Linux.<br/><br/>Les clients de Windows sont très bien et ne nécessitent aucune action spéciale, cependant.... pour activer cette fonctionnalité le script d\'audit doit être exécuté localement sur le système Windows cible. Il ne peut pas être exécuté à distance comme nous le faisons avec les appels WMI lors de l\'exécution du script d\'audit sur une machine Windows, tout en ciblant une seconde machine Windows. Pour ce faire, nous devons copier le script d\'audit sur la machine Windows cible, puis l\'exécuter. Malheureusement, le compte de service sous Apache est le compte système local. Ce compte n\'a pas accès aux ressources distantes (en réseau). Pour résoudre ce problème, le service doit être géré sous un autre compte. Il est plus facile de simplement utiliser le compte d\'administrateur local, mais vous pouvez essayer n\'importe quel compte que vous aimez tant qu\'il a les privilèges requis. Le compte Système local a autant d\'accès local que le compte Administrateur local.';
...
$GLOBALS["lang"]['Think of mail.domain1.com and mail.domain2.com - same hostname.'] = 'Pensez à mail.domain1.com et mail.domain2.com - même nom d\'hôte.';
...
$GLOBALS["lang"]['This Org has no AD group specified. Check the roles details within Open-AudIT.'] = 'Cet Org n\'a pas de groupe AD spécifié. Vérifiez les détails des rôles dans Open-Audit.';

$GLOBALS["lang"]['This Org has no AD group specified. Check the roles details within Open-AudIT. <span class=\"confluence-link\">Have you created these groups (for orgs) on the LDAP server and assigned LDAP users to them?'] = 'Cet Org n\'a pas de groupe AD spécifié. Vérifiez les détails des rôles dans Open-Audit. <span class=\'\"confluence-link\"\'>Avez-vous créé ces groupes (pour les orgs) sur le serveur LDAP et leur a assigné des utilisateurs LDAP ?</span>';

$GLOBALS["lang"]['This Role has no AD group specified. Check the roles details within Open-AudIT.'] = 'Ce rôle n\'a pas de groupe AD spécifié. Vérifiez les détails des rôles dans Open-Audit.';
...
$GLOBALS["lang"]['This code relys on the great work done by the'] = 'Ce code s\'appuie sur le grand travail accompli par le';
...
$GLOBALS["lang"]['This example creates a list of devices and the open Ports, Protocols, and Programs found by the NMAP scan.'] = 'Cet exemple crée une liste des appareils et des ports, protocoles et programmes ouverts trouvés par l\'analyse NMAP.';

$GLOBALS["lang"]['This example creates a list of devices where the Function or Description fields are blank OR the Purchase Date is the default.'] = 'Cet exemple crée une liste des appareils où les champs Fonction ou Description sont vides OU la date d\'achat est la valeur par défaut.';

$GLOBALS["lang"]['This example query retrieves a list of devices OVER 3 years old. The query uses today'] = 'Cette requête d\'exemple récupère une liste de périphériques de plus de 3 ans. La requête utilise aujourd\'hui';
...
$GLOBALS["lang"]['This feature, because it has the ability to affect target devices more than usual must be manually enabled. To enable this feature, change the configuration item feature_executables to <i>yes</i>.'] = 'Cette fonctionnalité, car elle a la capacité d\'affecter les appareils cibles plus que d\'habitude doit être activée manuellement. Pour activer cette fonctionnalité, changez l\'élément de configuration feature_executables en <i>oui</i>.';

$GLOBALS["lang"]['This file tells Linux to poll the application to determine if there are any scheduled tasks that should be run.'] = 'Ce fichier demande à Linux d\'interroger l\'application pour déterminer s\'il y a des tâches programmées qui devraient être exécutées.';

$GLOBALS["lang"]['This form provides a simple way to get started discovering the devices on your network. For more (much more) detailed options, you can individually create'] = 'Ce formulaire fournit une façon simple de commencer à découvrir les appareils sur votre réseau. Pour plus d\'options détaillées, vous pouvez créer individuellement';

$GLOBALS["lang"]['This is also the way that PAExec works.'] = 'C\'est aussi la façon dont PAExec fonctionne.';

$GLOBALS["lang"]['This is an optional configuration option, enabled by setting discovery_use_org_id_match in the global configuration.'] = 'Il s\'agit d\'une option de configuration optionnelle, activée en configurant Discovery_use_org_id_match dans la configuration globale.';
...
$GLOBALS["lang"]['This is likely due to MySQL time being off. MySQL typically uses the host devices time. You can check this by'] = 'Ceci est probablement dû à l\'absence de MySQL. MySQL utilise généralement le temps des appareils hôtes. Vous pouvez vérifier cela par';

$GLOBALS["lang"]['This is settable by users and so even though it should be globally unique, there is certainly no guarantee of this.'] = 'Ceci est défini par les utilisateurs et donc, même si elle doit être unique au niveau mondial, il n\'y a certainement aucune garantie à ce sujet.';

$GLOBALS["lang"]['This is the directory where we store any attachments to devices.'] = 'C\'est le répertoire où nous stockons les pièces jointes aux périphériques.';

$GLOBALS["lang"]['This is to be used as the first point of call when troubleshooting Open-AudIT issues. You can click the Export button on the top right to retrieve this as a JSON file (to be added to the support ticket / email.'] = 'Ceci doit être utilisé comme premier point d\'appel lors du dépannage des problèmes Open-Audit. Vous pouvez cliquer sur le bouton Exporter en haut à droite pour récupérer ce fichier JSON (à ajouter au ticket/e-mail de support).';

$GLOBALS["lang"]['This issue is under investigation.'] = 'Cette question fait l\'objet d\'une enquête.';
...
$GLOBALS["lang"]['This security permission can be modified using the Component Services administrative tool.'] = 'Cette autorisation de sécurité peut être modifiée à l\'aide de l\'outil administratif Component Services.';
...
$GLOBALS["lang"]['This should be globally unique, but I have seen instances where it is not.'] = 'Cela devrait être unique au niveau mondial, mais j\'ai vu des cas où ce n\'est pas le cas.';

$GLOBALS["lang"]['This should be set to either 1 or the height of the rack.'] = 'Ceci doit être réglé à 1 ou la hauteur du rack.';

$GLOBALS["lang"]['This should be the fully qualified field name in the database. Currently columns from the system, fields and credentials tables are supported. EG: system.nmis_role.'] = 'Il devrait s\'agir du nom de champ entièrement qualifié dans la base de données. Actuellement, les colonnes du système, les champs et les tableaux d\'identification sont pris en charge. EG: system.nmis_role.';

$GLOBALS["lang"]['This state is used when Nmap is unable to determine whether a port is closed or filtered. It is only used for the IP ID idle scan.'] = 'Cet état est utilisé lorsque Nmap est incapable de déterminer si un port est fermé ou filtré. Il n\'est utilisé que pour le scan de ralenti IP ID.';
...
$GLOBALS["lang"]['This will show you the Bulk Edit form. Any attributes you set on this form will be applied to all selected devices. You can set multiple attributes at once.'] = 'Cela vous montrera le formulaire d\'édition en vrac. Tous les attributs que vous définissez sur ce formulaire seront appliqués à tous les appareils sélectionnés. Vous pouvez définir plusieurs attributs à la fois.';
...
$GLOBALS["lang"]['To enable a remote machine (Vista or above) to be audited that is not on a domain, by an account in the Administrators group, other than the actual Administrator account see the below section on UAC.'] = 'Pour permettre l\'audit d\'une machine distante (Vista ou supérieure) qui n\'est pas dans un domaine, par un compte du groupe Administrateurs, autre que le compte Administrateur réel, voir la section ci-dessous sur UAC.';
...
$GLOBALS["lang"]['To execute the Windows powershell script, open a command prompt as Administrator and use the following command'] = 'Pour exécuter le script powershell de Windows, ouvrez une invite de commande en tant qu\'administrateur et utilisez la commande suivante';

$GLOBALS["lang"]['To execute the audit script, open a terminal and use the following command'] = 'Pour exécuter le script d\'audit, ouvrez un terminal et utilisez la commande suivante';
...
$GLOBALS["lang"]['To retrieve the Tenant ID. Open the Azure portal click on Azure Active Directory, Properties and the Tenant ID is displayed as your Directory ID - do not blame me for the name mismatch, that is how Microsoft roll.'] = 'Pour récupérer l\'identité du locataire. Ouvrez le portail Azure cliquez sur Azure Active Directory, Properties and the Tenant ID is displayed as your Directory ID - ne me blâmez pas pour l\'inadéquation du nom, c\'est ainsi que Microsoft roule.';

$GLOBALS["lang"]['To retrieve your key, log in to the AWS Console and select your username, then My Security Credentials.'] = 'Pour récupérer votre clé, connectez-vous à la console AWS et sélectionnez votre nom d\'utilisateur, puis Mes pouvoirs de sécurité.';
...
$GLOBALS["lang"]['To use this Enterprise feature, you first need to create your user in Open-AudIT as per usual. Assigning a password is not necessary. You do have to assign Roles and Orgs. The username in Open-AudIT should match the Entra <i>preferred username</i> attribute. There is no need for a Full Name or Email - these will be populated from Entra. If you do not know your users <i>preferred username</i>, fear not. You can create the new Auth Method in Open-AudIT and the Enterprise Application in Entra and when a user attempts to sign-on to Open-AudIT without a pre-existing user, check the logs and you will see their <i>preferred username</i> logged for your convienence.'] = 'Pour utiliser cette fonctionnalité Enterprise, vous devez d\'abord créer votre utilisateur dans Open-Audit comme d\'habitude. L\'attribution d\'un mot de passe n\'est pas nécessaire. Vous devez attribuer des rôles et des orgs. Le nom d\'utilisateur dans Open-Audit doit correspondre à l\'Entra <i>Nom d\'utilisateur préféré</i> attribut. Il n\'est pas nécessaire d\'avoir un nom complet ou un courriel - ceux-ci seront peuplés d\'Entra. Si vous ne connaissez pas vos utilisateurs <i>Nom d\'utilisateur préféré</i>Ne crains rien. Vous pouvez créer la nouvelle méthode Auth dans Open-Audit et l\'application Enterprise dans Entra et quand un utilisateur tente de se connecter à Open-Audit sans utilisateur préexistant, vérifiez les journaux et vous verrez leur <i>Nom d\'utilisateur préféré</i> enregistré pour votre convienence.';

$GLOBALS["lang"]['To use this Enterprise feature, you first need to create your user in Open-AudIT as per usual. Assigning a password is not necessary. You do have to assign Roles and Orgs. The username in Open-AudIT should match the OKTA <i>name</i> attribute. There is no need for a Full Name or Email - these will be populated from OKTA. If you do not know your users <i>name<i>, fear not. You can create the new Auth Menthod in Open-AudIT and the Application in OKTA and when a user attempts to sign-on to Open-AudIT without a pre-existing user, check the logs and you will see their <i>name<i> logged for your convienence.<br></p><p>Then create a new Auth method in Open-AudIT by going to menu -> Admin -> Auth Methods -> Create Auth. Provide a name and set the <i>type</i> to Okta.'] = 'Pour utiliser cette fonctionnalité Enterprise, vous devez d\'abord créer votre utilisateur dans Open-Audit comme d\'habitude. L\'attribution d\'un mot de passe n\'est pas nécessaire. Vous devez attribuer des rôles et des orgs. Le nom d\'utilisateur dans Open-Audit doit correspondre à l\'OKTA <i>nom</i> attribut. Il n\'est pas nécessaire d\'avoir un nom complet ou un courriel - ceux-ci seront peuplés d\'OKTA. Si vous ne connaissez pas vos utilisateurs <i>nom<i>Ne crains rien. Vous pouvez créer la nouvelle Auth Menthod dans Open-Audit et l\'application dans OKTA et quand un utilisateur tente de se connecter à Open-Audit sans utilisateur préexistant, vérifiez les journaux et vous verrez leur <i>nom<i> enregistré pour votre convienence.<br/><p>Puis créez une nouvelle méthode Auth dans Open-Audit en allant au menu -> Admin -> Méthodes d\'évaluation -> Créez Auth. Fournir un nom et définir le <i>type</i> à Okta.</p></i></i></i></i>';

$GLOBALS["lang"]['To use this feature you must enable the configuration items match_mac (for AWS) and match_hostname (for Azure). This will be done automatically the first time a cloud discovery is executed. For more on Open-AudITs matching rules see HERE: Matching Devices'] = 'Pour utiliser cette fonctionnalité, vous devez activer les éléments de configuration match_mac (pour AWS) et match_hostname (pour Azure). Cela sera fait automatiquement la première fois qu\'une découverte de nuage est exécutée. Pour plus d\'informations sur les règles d\'appariement Open-Audits voir ICI: Appareils de correspondance';

$GLOBALS["lang"]['To view the details of a query, the standard URL structure of /open-audit/index.php/queries/{$id} should be used.'] = 'Pour afficher les détails d\'une requête, la structure URL standard de /open-audit/index. php/queries/{$id} doit être utilisé.';
...
$GLOBALS["lang"]['Try Open-AudIT Enterprise, on us without a time limit. All the features of Enterprise. Limited to 20 devices.'] = 'Essayez Open-Audit Enterprise, sur nous sans limite de temps. Toutes les caractéristiques d\'Enterprise. Limité à 20 appareils.';

$GLOBALS["lang"]['Try all the latest features with a FREE 100 device license of Open-AudIT Enterprise. Please read the '] = 'Essayez toutes les dernières fonctionnalités avec une licence d\'appareil GRATUIT 100 de Open-Audit Enterprise. Veuillez lire la ';
...
$GLOBALS["lang"]['Undergo Stage 1 audit (documentation review)'] = 'Vérification de l\'étape 1 (examen des documents)';

$GLOBALS["lang"]['Undergo Stage 2 audit (implementation review)'] = 'Vérification de l\'étape 2 (examen de la mise en œuvre)';
...
$GLOBALS["lang"]['Update an attribute of a {collection} entry.'] = 'Mettre à jour un attribut d\'une entrée {collection}.';
...
$GLOBALS["lang"]['Use Service Version Detection. When a detected port is detected as open, if set to <i>y</i>, Nmap will query the target device in an attempt to determine the version of the service running on this port.<br>This can be useful when identifying unclassified devices. This was not previously used.'] = 'Utiliser la détection de version de service. Lorsqu\'un port détecté est détecté comme ouvert, si défini comme <i>y</i>, Nmap va interroger le périphérique cible dans une tentative de déterminer la version du service en cours d\'exécution sur ce port.<br/>Cela peut être utile pour identifier les appareils non classifiés. Cela n\'a pas été utilisé auparavant.';
...
$GLOBALS["lang"]['Use the standard install options when displayed and click the <i>I Agree</i>, <i>Next</i> and <i>Install</i> buttons to install Nmap.'] = 'Utilisez les options d\'installation standard lors de l\'affichage et cliquez sur <i>Je suis d\'accord</i>, <i>Suivant</i> et <i>Installer</i> boutons pour installer Nmap.';
...
$GLOBALS["lang"]['Values: In the case of a <i>list</i> field, this should be a comma separated list of valid values.'] = 'Valeurs : Dans le cas <i>liste</i> champ, il devrait s\'agir d\'une liste de valeurs valides séparées par des virgules.';
...
$GLOBALS["lang"]['View the discovery in question, then click the Support button in the top right toolbar. This will provide the discovery settings, config items, the discovery device list as well as the logs for this particular discovery.'] = 'Visualisez la découverte en question, puis cliquez sur le bouton Support dans la barre d\'outils en haut à droite. Cela fournira les paramètres de découverte, les éléments de configuration, la liste des périphériques de découverte ainsi que les journaux de cette découverte particulière.';
...
$GLOBALS["lang"]['WARNING - When creating a baseline using software policies, at present Centos and RedHat package the kernel using the names <i>kernel</i> and <i>kernel-devel</i>. There can be multiple packages with this name and different versions concurrently installed. Debian based distributions use names like <i>linux-image-3.13.0-24-generic</i>, note the version number is included in the package name. Because RedHat based operating systems use this format and subsequently have multiple identical package names with different versions we currently exclude <i>kernel</i> and <i>kernel-devel</i> from software policies. This may be addressed in a future update.'] = 'ATTENTION - Lors de la création d\'une base de référence en utilisant des politiques logicielles, actuellement Centos et RedHat paquetent le noyau en utilisant les noms <i>noyau</i> et <i>développement du noyau</i>. Il peut y avoir plusieurs paquets avec ce nom et différentes versions installées simultanément. Les distributions basées sur Debian utilisent des noms comme <i>linux-image-3.13.0-24-générique</i>, noter que le numéro de version est inclus dans le nom du paquet. Parce que les systèmes d\'exploitation basés sur RedHat utilisent ce format et ont ensuite plusieurs noms de paquets identiques avec différentes versions, nous excluons actuellement <i>noyau</i> et <i>développement du noyau</i> des politiques de logiciels. Cela pourrait être abordé dans une mise à jour future.';

$GLOBALS["lang"]['WHERE'] = 'OÙ';

$GLOBALS["lang"]['WMI Credentials Requirements'] = 'Exigences relatives aux pouvoirs de l \' OMM';

$GLOBALS["lang"]['Wait for it to complete, then paste in this next line to install the Agent.'] = 'Attendez qu\'il soit terminé, puis collez dans cette prochaine ligne pour installer l\'Agent.';
...
$GLOBALS["lang"]['We also have an option to Ping Before Scan (important for routers with long lived ARP caches). This is usually a good idea.'] = 'Nous avons également une option pour Ping Before Scan (important pour les routeurs avec des caches ARP de longue durée). C\'est généralement une bonne idée.';

$GLOBALS["lang"]['We also have our action items (which are executed in the order below):'] = 'Nous avons également nos éléments d\'action (qui sont exécutés dans l\'ordre ci-dessous):';

$GLOBALS["lang"]['We are often asked this question and the answer most definitely is <i>it depends</i>. It depends on the number of IPs to be scanned, the network connection speed, the speed of the devices being scanned, the type of devices being scanned, the number of different credentials being tested and the speed of the Open-AudIT server. We do not have a calculator that would allow us to input those variables and return a value. It is simply too complex. Generally I limit my discoveries to 256 IP addresses - ie, a /24 subnet. We have had customers scan /16 subnets (65k addresses) and it does work - but it can take a long time. You are much better off scanning in /24 blocks. If you simply do not know what your address ranges are, then this is a good case for a Seed discovery.'] = 'On nous pose souvent cette question et la réponse est très certainement : <i>ça dépend</i>. Cela dépend du nombre d\'IP à scanner, de la vitesse de connexion réseau, de la vitesse des appareils à scanner, du type d\'appareils à scanner, du nombre d\'identifications différentes à tester et de la vitesse du serveur Open-Audit. Nous n\'avons pas de calculateur qui nous permettrait d\'entrer ces variables et de retourner une valeur. C\'est simplement trop complexe. En général, je limite mes découvertes à 256 adresses IP - c\'est-à-dire un sous-réseau /24. Nous avons eu des clients scanner /16 sous-réseaux (65k adresses) et cela fonctionne - mais cela peut prendre beaucoup de temps. Vous êtes beaucoup mieux hors balayage dans 24 blocs. Si vous ne savez tout simplement pas quelles sont vos plages d\'adresses, alors c\'est un bon cas pour une découverte de semences.';
...
$GLOBALS["lang"]['When Open-AudIT on Linux discovers a Windows machine, in order to execute a remote command we use'] = 'Lorsque Open-Audit sur Linux découvre une machine Windows, afin d\'exécuter une commande distante que nous utilisons';

$GLOBALS["lang"]['When Open-AudIT on Windows discovers a Windows machine, in order to execute a remote command we use'] = 'Lorsque Open-Audit sur Windows découvre une machine Windows, afin d\'exécuter une commande distante que nous utilisons';

$GLOBALS["lang"]['When Open-AudIT receives data about a device, either by discovering the device during an audit run or by the user importing the device, it must determine if this discovered device matches a device that already exists within its database, or if it is a new device that should be added. Open-AudIT uses a series of twelve property matches to determine this. The Match Rules work as OR comparisons, not AND. This means the first rule that matches a field in the discovered device to one in the dB resolves as an existing device. All Matching Rules have to fail in order for a device to be new and result in a new record being created.'] = 'Quand Open-Aud L\'informatique reçoit des données sur un appareil, soit en découvrant l\'appareil lors d\'une vérification, soit par l\'utilisateur qui importe l\'appareil, elle doit déterminer si cet appareil découvert correspond à un appareil qui existe déjà dans sa base de données, soit s\'il s\'agit d\'un nouvel appareil qui devrait être ajouté. Open-Audit utilise une série de douze correspondances de propriété pour déterminer cela. Les règles de correspondance fonctionnent comme des comparaisons OU, pas ET. Cela signifie la première règle qui correspond à un champ dans le périphérique découvert à un dans la résolution dB comme un périphérique existant. Toutes les règles de correspondance doivent échouer pour qu\'un appareil soit nouveau et qu\'un nouvel enregistrement soit créé.';

$GLOBALS["lang"]['When POSTing data, you must include an access token. An access token is generated with every request type, so make a GET (for example) and Accept: application/json, parse the response for meta→access_token, and include that with your request. This should be placed in the field data[access_token], IE, the top level.'] = 'Lorsque POSTing données, vous devez inclure un jeton d\'accès. Un jeton d\'accès est généré avec chaque type de requête, donc faire un GET (par exemple) et Accepter: application/json, analyser la réponse pour meta→access_token, et inclure cela avec votre demande. Ceci devrait être placé dans le champ data[access_token], IE, le niveau supérieur.';

$GLOBALS["lang"]['When a device is Discovered the audit script will be injected with the file (or directory) details. Both audit_linux.sh and audit_windows.vbs will be populated, regardless of the file path. If you are thinking <i>but putting a Linux path into a Windows machine will break things!</i>, it wont break, you just wont receive any data from that file or directory entry.<br>Retrieved details will be stored in the <i>file</i> database table and are stored like any other attribute. File details will be stored as any other attribute and generate alerts if any of the following attributes change - <i>full_name</i>, <i>hash</i>, <i>inode</i>, <i>last_changed</i>. The table contain a system_id, first_seen, last_seen and current columns as well as the file details.<br>Attributes recorded are:<br><ul><li>Windows - name, size, directory, SHA1 hash (of the file contents), last changed, permissions, owner, version (file permitting).</li><br><li>Linux - name, size, directory, SHA1 hash (of the file contents), last changed, meta data last changed, permissions, owner, group, inode.</li></ul>You will see a section in both the Windows and Linux audit scripts as below'] = 'Lorsqu\'un périphérique est découvert, le script d\'audit sera injecté avec les détails du fichier (ou du répertoire). Audit_linux.sh et audit_windows.vbs seront tous deux remplis, quel que soit le chemin du fichier. Si vous pensez <i>mais mettre un chemin Linux dans une machine Windows va casser les choses!</i>, il ne s\'est pas cassé, vous ne recevrez tout simplement aucune donnée de ce fichier ou répertoire entrée.<br/>Les détails récupérés seront stockés dans le <i>fichier</i> table de base de données et sont stockés comme tout autre attribut. Les détails du fichier seront stockés comme tout autre attribut et généreront des alertes si l\'un des attributs suivants change - <i>_Nom complet</i>, <i>Hasch</i>, <i>diode</i>, <i>_dernière modification</i>. La table contient un system_id, first_seen, last_seen et les colonnes actuelles ainsi que les détails du fichier.<br/>Les attributs enregistrés sont les suivants:<br/><ul><li>Windows - nom, taille, répertoire, SHA1 hash (du contenu du fichier), dernière modification, permissions, propriétaire, version (si le fichier le permet).</li><br/><li>Linux - nom, taille, répertoire, SHA1 hash (du contenu du fichier), dernière modification, méta données dernière modification, permissions, propriétaire, groupe, inode.</li></ul>Vous verrez une section dans les scripts d\'audit Windows et Linux comme ci-dessous';

$GLOBALS["lang"]['When a discovery is run, the relevant discovery scan option is chosen and those settings are used by Nmap to scan the target devices.  The scan options determine which ports nmap scans, how fast they scan and whether or not nmap ping is first used to determine if the IP is live or not.'] = 'Lorsqu\'une découverte est exécutée, l\'option de numérisation de découverte pertinente est choisie et ces paramètres sont utilisés par Nmap pour scanner les appareils cibles. Les options de numérisation déterminent quels ports nmap scanne, à quelle vitesse ils scannent et si nmap ping est utilisé pour déterminer si l\'IP est en direct ou non.';

$GLOBALS["lang"]['When a discovery is run, the relevant discovery scan option is chosen and those settings used by Nmap to scan the target devices. If no option set is chosen, the default configuration item (discovery_default_scan_option) is selected and used. Open-AudIT Community will use the default options as per the configuration for all discoveries.'] = 'Lorsqu\'une découverte est exécutée, l\'option de numérisation de découverte pertinente est choisie et les paramètres utilisés par Nmap pour scanner les appareils cibles. Si aucune option n\'est choisie, l\'élément de configuration par défaut (découverte_default_scan_option) est sélectionné et utilisé. Open-Audit Community utilisera les options par défaut selon la configuration pour toutes les découvertes.';

$GLOBALS["lang"]['When a subnet discovery is executed it first runs, if selected, an Nmap ping scan on the range or IP addresses. Any device responding will be port scanned. If an Nmap ping scan is not requested, each IP is individually port scanned. Which ports? That is determined by the'] = 'Lorsqu\'une découverte de sous-réseau est exécutée, elle exécute d\'abord, si elle est sélectionnée, un balayage Nmap ping sur la plage ou les adresses IP. Tout appareil répondant sera balayé. Si un scan Nmap ping n\'est pas demandé, chaque IP est scannée individuellement. Quels ports ? Cela est déterminé par le';

$GLOBALS["lang"]['When auditing a Linux device via SSH, some Linux distributions do not allow sudo commands to be passed without a TTY (which we are doing). To completely audit one of these linux distributions it is best to supply the root user credentials. If no root is supplied and sudo without a TTY is not possible, the audit script will be run but will not contain the amount of data as would otherwise. Subsequent audits using root (or run locally using sudo) will therefore provide extra details about the system and generate several <i>changes</i>.'] = 'Lors de l\'audit d\'un périphérique Linux via SSH, certaines distributions Linux ne permettent pas que les commandes sudo soient passées sans TTY (que nous faisons). Pour vérifier complètement l\'une de ces distributions linux, il est préférable de fournir les identifiants de l\'utilisateur racine. Si aucune racine n\'est fournie et que le sudo sans ATS n\'est pas possible, le script d\'audit sera exécuté mais ne contiendra pas la quantité de données comme autrement. Des audits ultérieurs utilisant root (ou exécuter localement en utilisant sudo) fourniront donc des détails supplémentaires sur le système et généreront plusieurs <i>changements</i>.';

$GLOBALS["lang"]['When combining devices, which system is the authoritative source for information.'] = 'Lorsque vous combinez des dispositifs, quel système est la source d\'information faisant autorité.';
...
$GLOBALS["lang"]['When creating a widget, if you select the <i>Advanced</i> button you will have the ability to upload your own custom SQL.'] = 'Lors de la création d\'un widget, si vous sélectionnez <i>Avancé</i> bouton vous aurez la possibilité de télécharger votre propre SQL personnalisé.';
...
$GLOBALS["lang"]['When investigating a Discovery, support will request the Exported Discovery Logs. To retrieve these, go to menu -> Discoveries ->'] = 'Lors de l\'enquête sur une découverte, le support demandera les journaux de découverte exportés. Pour les récupérer, allez au menu -> Découvertes ->';

$GLOBALS["lang"]['When matching a Linux based device, we prefer to use the Dbus id concatenated with the hostname. We can also use other options as per the below table, but we can retrieve the Dbus ID without root. To retrieve the UUID (from the motherboard), we need to run dmidecode, which does require root. Unfortunately, when you clone an ESXi guest, the Dbus ID does not get recreated - hence our concatenating this with the hostname. There is a good article linked here that details the <i>why</i> of hardware IDs.'] = 'Lors de la correspondance avec un appareil basé sur Linux, nous préférons utiliser le Dbus id concaténé avec le nom d\'hôte. Nous pouvons également utiliser d\'autres options selon le tableau ci-dessous, mais nous pouvons récupérer l\'ID Dbus sans root. Pour récupérer l\'UUID (à partir de la carte mère), nous devons exécuter dmidecode, ce qui nécessite root. Malheureusement, lorsque vous clonez un invité ESXi, l\'ID Dbus ne se recrée pas - d\'où notre concaténation avec le nom d\'hôte. Il y a un bon article lié ici qui détaille <i>Pourquoi</i> des pièces d\'identité matérielles.';

$GLOBALS["lang"]['When requesting JSON, by default no limit is set. When requesting screen display, the limit is set to 1000 by default. This can be changed in the configuration. See the <i>page_size</i> item'] = 'Lorsque vous demandez JSON, par défaut aucune limite n\'est fixée. Lorsque vous demandez l\'affichage de l\'écran, la limite est fixée à 1000 par défaut. Cela peut être modifié dans la configuration. Voir <i>_dimensionner la page</i> Objet';
...
$GLOBALS["lang"]['When running Open-AudIT on Windows the Apache service account must be that of a <i>regular</i> user (or the Administrator). This is because the <i>Local System</i> account normally used to run Apache has no access to any network resources. IE - We cannot use Apache when running as the Local System account account to copy the audit script to Windows PCs.'] = 'Lors de l\'exécution d\'Open-Audit sur Windows, le compte de service Apache doit être celui d\'un <i>régulière</i> utilisateur (ou l\'administrateur). C\'est parce que les <i>Système local</i> compte normalement utilisé pour exécuter Apache n\'a pas accès à des ressources réseau. IE - Nous ne pouvons pas utiliser Apache lors de l\'exécution en tant que compte du système local pour copier le script d\'audit sur les PC Windows.';

$GLOBALS["lang"]['When the configuration option is set, we take this into account for devices for a certain defined subset of match rules where the configuration item has been enabled. These rules are:'] = 'Lorsque l\'option de configuration est définie, nous en prenons en compte pour les appareils pour un sous-ensemble défini de règles de correspondance où l\'élément de configuration a été activé. Ces règles sont les suivantes:';

$GLOBALS["lang"]['When the rules run in discovery, any matching rules will appear in the discovery log. See below for an example.'] = 'Lorsque les règles s\'exécutent en découverte, toutes les règles correspondantes apparaissent dans le journal de découverte. Voir ci-dessous pour un exemple.';
...
$GLOBALS["lang"]['Widgets are designed to be used on Dashboards. Enterprise users have complete freedom to create, update and delete widgets as required.'] = 'Les widgets sont conçus pour être utilisés sur les tableaux de bord. Les utilisateurs d\'entreprise ont toute la liberté de créer, mettre à jour et supprimer des widgets selon les besoins.';
...
$GLOBALS["lang"]['You can create a baseline, run it against a group of devices and view the results, add scheduled execution, add more tables for comparison (currently only software, netstat ports and users are enabled), in place baseline editing, archiving of results and more.'] = 'Vous pouvez créer une base de référence, l\'exécuter sur un groupe de périphériques et afficher les résultats, ajouter l\'exécution programmée, ajouter plus de tableaux à comparer (actuellement seuls les logiciels, les ports netstat et les utilisateurs sont activés), en place l\'édition de base, l\'archivage des résultats et plus encore.';
...
$GLOBALS["lang"]['You can select the devices to be integrated by choosing any attribute in the system (device) table and matching (see menu → Admin → Database → List Tables → system for a list of fields). An attribute match can only match a single value.'] = 'Vous pouvez sélectionner les appareils à intégrer en choisissant n\'importe quel attribut dans la table système (device) et la correspondance (voir menu → Admin → Base de données → Liste des tableaux → système pour une liste de champs). Une correspondance d\'attribut ne peut correspondre qu\'à une seule valeur.';

$GLOBALS["lang"]['You can turn any server into a collector by going to menu -> Admin -> Collectors -> Make this install a Collector. You will need credentials to log on to the server this install will report in to.'] = 'Vous pouvez transformer n\'importe quel serveur en un collecteur en allant au menu -> Admin -> Collecteurs -> Faites en sorte que cela installe un Collector. Vous aurez besoin d\'identifications pour vous connecter au serveur auquel cette installation se rapporte.';

$GLOBALS["lang"]['You can view by clicking on the blue view icon. You can also edit or delete if you have permissions.'] = 'Vous pouvez voir en cliquant sur l\'icône vue bleue. Vous pouvez également modifier ou supprimer si vous avez des permissions.';

$GLOBALS["lang"]['You do not have the PHP MBString extension installed. This extension is required.'] = 'Vous n\'avez pas installé l\'extension PHP MBString. Cette prolongation est nécessaire.';

$GLOBALS["lang"]['You do not have the PHP SNMP extension installed. This extension is highly recommended.'] = 'Vous n\'avez pas installé l\'extension PHP SNMP. Cette extension est fortement recommandée.';
...
$GLOBALS["lang"]['You should use a header line containing the names of the columns you wish to populate, then your data lines below that.'] = 'Vous devriez utiliser une ligne d\'en-tête contenant les noms des colonnes que vous souhaitez peupler, puis vos lignes de données en dessous.';

$GLOBALS["lang"]['You should use only those tables that contain attributes you need. I usually use a left join. For example'] = 'Vous ne devez utiliser que les tables qui contiennent les attributs dont vous avez besoin. J\'utilise habituellement une jointure gauche. Par exemple';

$GLOBALS["lang"]['You will need a'] = 'Vous aurez besoin d\'un';

$GLOBALS["lang"]['You will need the ports for WMI on the Windows firewall opened on each target Windows computer. For Windows Core servers, ensure you allow the firewall connections as per'] = 'Vous aurez besoin des ports pour WMI sur le pare-feu Windows ouvert sur chaque ordinateur Windows cible. Pour Windows Serveurs de base, assurez-vous d\'autoriser les connexions pare-feu selon';
...
$GLOBALS["lang"]['Your Host is'] = 'Votre L\'hôte est';
...
$GLOBALS["lang"]['and download the Latest Release self-installer. You may need to scroll down the page to find it.'] = 'et téléchargez l\'auto-installation de la dernière version. Vous devrez peut-être faire défiler la page pour la trouver.';

$GLOBALS["lang"]['and go to Applications -> Enterprise Applications (far left menu), then click <i>New application</i>.'] = 'et allez dans Applications -> Applications d\'entreprise (menu à gauche), puis cliquez sur <i>Nouvelle demande</i>.';

$GLOBALS["lang"]['and its current time is'] = 'et son heure actuelle est';

$GLOBALS["lang"]['and looks for a warranty expiration date prior to today.'] = 'et cherche une date d\'expiration de garantie avant aujourd\'hui.';
...
$GLOBALS["lang"]['as a device responding on this port.<br>This has caused some customers issues where firewalls respond on behalf of a non-existing device, and hence cause false positive device detection. We now have this attribute available to set per scan.'] = 'comme un appareil répondant sur ce port.<br/>Cela a causé certains problèmes de clients où les pare-feu répondent au nom d\'un appareil non existant, et donc provoquer une détection fausse positive de l\'appareil. Nous avons maintenant cet attribut disponible pour définir par scan.';
...
$GLOBALS["lang"]['can be used for user authentication (is the users name and password correct) as well as user authorization (what roles and orgs does a user have).<br><br>If a user is not in the configured LDAP but is in Open-AudIT (eg: the <i>admin</i> user), Open-AudIT will fallback to using itself for both authentication and authorization.<br><br>Open-AudIT uses specific LDAP groups for roles and orgs. A user must be a direct member of these group(s) in order for Open-AudIT to determine that users access.<br><br>When configured correctly, LDAP use can completely remove the need to create users in Open-AudIT. Simply configure Open-AudIT to use LDAP for both authentication and authorization. If the user does not exist in Open-AudIT but does exist in LDAP and their credentials are correct and they are a member of the required groups Open-AudIT will create the user account automatically.'] = 'peut être utilisé pour l\'authentification de l\'utilisateur (est le nom de l\'utilisateur et le mot de passe correct) ainsi que l\'autorisation de l\'utilisateur (ce que les rôles et les orgs d\'un utilisateur ont).<br/><br/>Si un utilisateur n\'est pas dans le LDAP configuré mais est dans Open-Audit (par exemple: <i>administrateur</i> user), Open-Audit va revenir à s\'utiliser pour l\'authentification et l\'autorisation.<br/><br/>Aud ouvert La TI utilise des groupes LDAP spécifiques pour les rôles et les orgs. Un utilisateur doit être un membre direct de ces groupes afin que Open-Audit détermine l\'accès des utilisateurs.<br/><br/>Une fois configuré correctement, LDAP peut supprimer complètement le besoin de créer des utilisateurs dans Open-Audit. Il suffit de configurer Open-Audit pour utiliser LDAP pour l\'authentification et l\'autorisation. Si l\'utilisateur n\'existe pas dans Open-Audit mais qu\'il existe dans LDAP et que ses identifiants sont corrects et qu\'ils sont membres des groupes requis Open-Audit créera automatiquement le compte utilisateur.';

$GLOBALS["lang"]['can now retrieve details about a file or directory of files and monitor these files for changes as per other attributes in the Open-AudIT database. This feature works out of the box for Linux Open-AudIT servers, but needs a change to the service account name under a Windows Open-AudIT server. Supported clients are Windows and Linux.'] = 'peut maintenant récupérer des détails sur un fichier ou un répertoire de fichiers et surveiller ces fichiers pour les modifications selon les autres attributs de la base de données Open-Audit. Cette fonctionnalité fonctionne à partir de la boîte pour les serveurs Linux Open-Audit, mais a besoin d\'un changement au nom du compte de service sous un serveur Windows Open-Audit. Les clients pris en charge sont Windows et Linux.';

$GLOBALS["lang"]['changed'] = 'changé';

$GLOBALS["lang"]['chosen. From there if a port for WMI, SSH or SNMP is detected responding the device is further queried using '] = 'choisi. A partir de là, si un port pour WMI, SSH ou SNMP est détecté répondant à l\'appareil est interrogé en utilisant ';
...
$GLOBALS["lang"]['column will contain either <i>y</i> or <i>n</i>. This indicates if this row is currently present on the device. For example software may be installed (which would result in <i>software.current = y</i>), but on a subsequent audit it may not be detected. Open-AudIT will then change this rows current attribute to <i>n</i>.'] = 'colonne contiendra soit <i>y</i> ou <i>n</i>. Ceci indique si cette ligne est actuellement présente sur l\'appareil. Par exemple, un logiciel peut être installé (ce qui entraînerait <i>logiciel.current = y</i>), mais lors d\'une vérification ultérieure, il peut ne pas être détecté. Open-Audit changera alors cet attribut courant des lignes en <i>n</i>.';
...
$GLOBALS["lang"]['for authentication'] = 'pour l\'authentification';

$GLOBALS["lang"]['for this information.'] = 'pour cette information.';

$GLOBALS["lang"]['from Audit Script Result'] = 'à partir du résultat du script d\'audit';

$GLOBALS["lang"]['from NMIS'] = 'de la NMIS';

$GLOBALS["lang"]['from address LocalHost (Using LRPC) running in the application container'] = 'de l\'adresse LocalHost (Using LRPC) dans le conteneur d\'application';
...
$GLOBALS["lang"]['has not been set'] = 'n\'a pas été défini';
...
$GLOBALS["lang"]['have the ability to be executed. On the'] = 'avoir la capacité d\'être exécuté. Sur le';
...
$GLOBALS["lang"]['installer will test for the presence of Nmap in its standard install locations of'] = 'l\'installateur testera la présence de Nmap dans ses emplacements d\'installation standard de';
...
$GLOBALS["lang"]['removed from display, but has been set'] = 'supprimé de l\'affichage, mais a été défini';
...
$GLOBALS["lang"]['service failed to start due to the following error'] = 'service a échoué à démarrer en raison de l\'erreur suivante';
...
$GLOBALS["lang"]['table and insert the original rows.'] = 'et insérer les lignes d\'origine.';

$GLOBALS["lang"]['team'] = 'équipe';

$GLOBALS["lang"]['text. The first is the array index and should be left as-is. The index is used in the templates to lookup the translated text.'] = 'Texte. Le premier est l\'index du tableau et devrait être laissé tel quel. L\'index est utilisé dans les modèles pour rechercher le texte traduit.';
...
$GLOBALS["lang"]['to the URL, you will get the full database entry, including all component tables, of a given device.'] = 'à l\'URL, vous obtiendrez l\'entrée complète de la base de données, y compris toutes les tables de composants, d\'un périphérique donné.';

$GLOBALS["lang"]['to the user'] = 'à l\'utilisateur';
...
$GLOBALS["lang"]['with Local and Remote access permissions set.'] = 'avec les permissions d\'accès local et distant.';

$GLOBALS["lang"]['with devices::update permission.'] = 'avec les périphériques::mise à jour de la permission.';

$GLOBALS["lang"]['with the Sign-On Redirect URI being'] = 'avec l\'URI Sign-On Redirect';

$GLOBALS["lang"]['with the intention of providing simple and intuitive access in a manner familiar to developers. In addition to this API, the web interface will use the same request format and supply some additional actions (eg: HTML forms for creating items).'] = 'avec l\'intention de fournir un accès simple et intuitif d\'une manière familière aux développeurs. En plus de cette API, l\'interface web utilisera le même format de requête et fournira quelques actions supplémentaires (par exemple: formulaires HTML pour créer des éléments).';

$GLOBALS["lang"]['yes'] = 'oui';

$GLOBALS["lang"]['you do not require a HighCharts license to use Firstwave products. License'] = 'vous n\'avez pas besoin d\'une licence HighCharts pour utiliser les produits Firstwave. Licence';
