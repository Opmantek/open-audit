<?php
$GLOBALS["lang"][' Default, currently '] = ' Difino, nessun tentativo ';

$GLOBALS["lang"][' If something does not work as expected, your first thing to do is check the logs.'] = ' Se io ne funkcias kiel atendite, via unua a faro farndaoo estas controli la tagalojn.';
...
$GLOBALS["lang"][', of which we supply over thirty as a default set. Professional users cannot alter these, but an Enterprise user has complete customisation abilities - including creating your own.'] = 'De kiu ni maksas pli ol tridek kiel dea... Profesiaj uzantoj ne povas ршений tiujn, sed Enterprise uzanto havas kompletajn specialadaptitajn kapablojn - inkluzive de kreado de via propa.';

$GLOBALS["lang"][', you <i>must</i> be using https on your Open-AudIT server to use Entra for Auth. Please configure Apache to use <strong>https</strong> before configuring Entra for auth.'] = '- Oui. <i>Devas</i> Uzi https sur via Open- Audit- servilo por uzi Entra por Auth. Bonvolu agordi a remomendaro por uzi <strong>Htps</strong> Entra por Auth.';

$GLOBALS["lang"]['. To enable this, edit the configuration item for '] = '. Por obbligo, redakki la konfiguracion objectko por ';

$GLOBALS["lang"]['10 Minutes'] = '10 per cento';

$GLOBALS["lang"]['15 Minutes'] = '15.';

$GLOBALS["lang"]['30 Minutes'] = '30 per cento';
...
$GLOBALS["lang"]['<p>A network is derived from discovery entries and device attributes.<br> <br></p>'] = '<p>Reto estas risolto de eltrova.o kontribouj kaj aparato atroducas.<br/> <br/></p>';

$GLOBALS["lang"]['<p>A summary will display a list of items, grouped by the distinct values of the attribute specified by the <code>table</code> and <code>column</code> attributes.<br> <br>When a summary is executed, the result will be a list of distinct values for that <code>table</code> and <code>column</code>. There will be links on the values that allow the user to see the matching devices.<br> <br>If the attribute of <code>extra_columns</code> is populated, the resulting page will contain these columns in addition to the standard device columns.<br> <br></p>'] = '<p>Rezumo montros Listn de eroj, grupigitaj per la apartaj valoroj de la atention a prezigita per la <code>table</code> Kaj <code>column</code> De l\'Aide.<br/> <br/>Kiam resuro estas efekkivigita, la rezulto estos lista de apartaj valoroj portio. <code>table</code> Kaj <code>column</code>. Eksistas ligiloj sur la Valoroj kiuj permesas al la uzanto vidi la egalajn aparatojn.<br/> <br/>Il contributo <code>extra_columns</code> La rezulta pa<br/> <br/></p>';

$GLOBALS["lang"]['<p>Agents let you audit PCs without a discovery. Install the agent and it will check-in with the server each day and audit itself. It does not matter if your computers are firewalled, audit data will still appear in Open-AudIT.</p><p>When testing <strong>if</strong> an agent should perform actions, all three tests must pass (if the test is set). <strong>Then</strong> the actions are taken.</p>'] = '<p>Agentoj lasas vin un transfugedi Komputilojn sen malkovro. Instali la agenton kaj εi kontraus kun la servilo Ne gravas se viaj komputiloj estas pare- feu, revizio datumoj ankora</p><p>Testas de Kiam oni <strong>Se</strong> Agente devus elfari agojn, <strong>Tiam la</strong> La agoj estas prenitaj.</p>';

$GLOBALS["lang"]['<p>Applications are defined by you, the user and stored for Open-AudIT to use and associate with devices.<br> <br></p>'] = '<p>Aplikoj estas difinitaj tariffa de vi, la uzanto kaj stokita por Open- Audit por uzi kaj asocii kun aparatoj.<br/> <br/></p>';
...
$GLOBALS["lang"]['<p>Being able to determine which machines are configured the same is a major part of systems administration and auditing &ndash; and now reporting on that will be made simple and automated. Once you define your baseline it will automatically run against a set of devices on a predetermined schedule. The output of these executed baselines will be available for web viewing, importing into a third party system or even as a printed report.<br> <br> Baselines enable you to combine audit data with a set of attributes you have previously defined (your baseline) to determine compliance of devices.<br> <br> For example - you might create a baseline from a device running Centos 6 which acts as one of your apache servers in a cluster. You know this particular server is configured just the way you want it but you are unsure if other servers in the cluster are configured exactly the same. Baselines enables you to determine this.<br> <br> </p>'] = '<p>Povas determini kiuj ma apretinoj estas formitaj la sama estas grava parto de sistum amministrativicio kaj revizio - kaj nun raportante privio estas farita simma kaj a skeptomatigita. Post kiam vi difinas linn bazlinion εi a skeptidtomate kuris kontraluc aro de aparatoj en ankeriasnevalt obellaks määratud horaro. La produktado de tiuj efekkivigitaj bazlinioj estas hasbla por interretspektado, importe en trian partian sistemon a spective e kiel presita raporto.<br/> <br/> Bazlinioj rajtigas vin kombini reviziodatenojn kun aro de atentioj kiuj vi anta<br/> <br/> Ekzample, vi eble kreos bazlinion de aparato prizorgata Centojn 6 kiu funkcias kiel unu el viaj apa reomendarserviloj en areto. L\'Unione europea<br/> <br/> </p>';
...
$GLOBALS["lang"]['<p>Define your racks and assign devices into their positions. You already have your devices in Open-AudIT and you know your locations. Open-AudIT extends this to allow you to create a rack and assign devices to it. Open-AudIT will even provide a visualisation of the rack and the devices contained within. If you provide a device picture, that picture will be used in the visualisation. You can look at the rack on the screen and see the same items you would see if you were standing in front of it.<br> <br></p>'] = '<p>Difini viajn rakojn kaj asagi aparatojn en iliajn poziciojn. Vijam havas viajn aparatojn en Open- Audit kaj vi scias viajn lokojn. Audit etendasment por permesi al vi krei rakon kaj asigni aparatojn al εi. Audit e Se vi disponigas aparatobildon, tiu bildo esto uzita en la bildigo. Vi povas rigardi la rakon sur la ekrano kaj vidi la samajn erojn vidus se vi staris anta. Ah.<br/> <br/></p>';

$GLOBALS["lang"]['<p>Devices on your network need to be managed. But how do you keep your records up to date? A spreadsheet - defintley not. That will be out of date in hours, if not days. Why manually try to keep up. Use Open-AudIT to automatically scan your networks and record your devices - manufacturer, model, serial and more than 100 other attributes. Full lists of software, services, disks, open ports, users, etc. Automatically see if an attribute has been added, removed or changed.<br> <br>Once Open-AudIT is setup, you can sit back and relax. Have change reports emailed to you on a schedule, for example - what new devices did we discover this week? What new software was installed this week? Were there any hardware changes last month?<br> <br>Expand on the stored fields easily with your own custom attributes.<br> <br>Even add devices that are not connected to your network or those devices your Open-AudIT server cannot reach.<br> <br>Computers, switches, routers, printers or any other device on your network - Open-AudIT can audit them all.<br> <br></p>'] = '<p>Aplikas via reto murtaa esti alkalmazás. Kiel vi tenas viajn discojn εis nunna? Ekskurseto - définition ne. Tio esto el dato en horoj, se ne tagoj. Kial vi prova elliti. Uzu Open- Aud IT por a Spectivetomate skani viajn retojn kaj registrei viajn aparatojn Plenaj listaj de softvaro, servoj, disquete, malfermaj hasnoj, uzantoj, ktp. Epäilty Tomata vido se atentio a estis aldonita, forigita epäilty täään pilaita.<br/> <br/>Kiam pubblico Open- Audit estas aranaño, vi povas sidi malanta Tu veux bien? Kio nova programmaro estis instaliata Či- semajne? Te Sientes Mal?<br/> <br/>Aplikita sur la stokitaj kapoj kun facile via propra kutimo atteria come.<br/> <br/>E agenda aldoni paratojn kiuj ne estasligitaj al kaudu reto a Spective tiuj aparatoj via Open- Audit servilo ne povas atingi.<br/> <br/>Komputiloj, тaltiloj, alkuristoj, printiloj a epäillyn ajna alias aparato sur via reto - Open- Audit povas revizii ilin † iuj.<br/> <br/></p>';
...
$GLOBALS["lang"]['<p>If you select a List type, the "values" field will be enabled. You should put a comma separated list of selectable values here. These will display in a dropdown box whenever the field is edited.<br> <br>Like most other attributes, Fields can be bulk edited. Use the Bulk Edit function as you normally would and you will see the Fields are available for input.<br> <br>View the device details screen, open the section containing the field and (if you have sufficient access) you can click on the field value to edit it.<br> <br></p>'] = '<p>Se vi elektas Lista tipon, la "valoroj" kampo esto ebligitaj. Vi devus meti komon apartigita Lista de fajnaj valoroj clari huulet. Tiuj elmontros en goto- kesto kiam la kampo estas redaktita.<br/> <br/>Kiel la pléj indennitàj aliasj atregultoj, Kampoj povas esti grocaj redactis. Uzu la Bulk Edit- funkcion kiam vi normale faris kaj vidos ke la Kampoj estas hasblaj por eniga.<br/> <br/>Vidante la aparaton detalekrano, malfermi la sekcion enhavantan la kampon kaj (se vi havas sufibraan aliron) Vi povas klaki sur la kampvalo por redakki... in.<br/> <br/></p>';

$GLOBALS["lang"]['<p>In the ever-changing world of computer security where new vulnerabilities are being discovered and patched every day, enforcing security compliance must be a continuous process. It also needs to include a way to make adjustments to policies, as well as periodic assessment and risk monitoring. The OpenSCAP ecosystem provides tools and customizable policies for a quick, cost-effective and flexible implementation of these processes.</p>'] = '<p>En la iam- ajna- varia mondo de komputionskuleco kie novaj vundeblecoj estas malkovritaj kaj pecetigitaj... La OpenSCAP ekositemo disponigas iljn kaj adattaitajn politikojn por rafa, kostefika kaj freksebla efektivigo de tiaj procezoj.</p>';
...
$GLOBALS["lang"]['<p>Quickly view the status of devices on your network.<br> <br></p>'] = '<p>Rapide rigardi la stazione di aparatoj sur via reto.<br/> <br/></p>';
...
$GLOBALS["lang"]['<p>Simple, intuitive, accurate geographic mapping provided by Google Maps. Open-AudIT leverages Google Maps to provide live, interactive geographic mapping of device locations. Automated conversion of street addresses to geocodes and longitude / latitude.<br> <br>
        </p>'] = '<p>Simpla, intuicia, preaza geografia folliado disponigita per Google Maps. Audit- fortuloj ouvert Google Maps por disponigi vivan, interagan geografian mapadon de aparatolokoj. Ashitomata konverti<br/> <br/></p>';
...
$GLOBALS["lang"]['<p>When using Regex for matching, a helpful page can be found on the <a href="https://www.php.net/manual/en/regexp.reference.meta.php" target="_blank"> PHP website</a>. Some differences to Perl Regex can be found <a href="https://www.php.net/manual/en/reference.pcre.pattern.differences.php" target="_blank">here</a>.</p>'] = '<p>Dum uzado Reex por egalado, utila pa graduano povas esti trovareta sur la <a href="https://www.php.net/manual/en/regexp.reference.meta.php" target="_blank"> Rete di PHP</a>. Kelkaj diferencoj al Perl Regex povas esti trovaretaj <a href="https://www.php.net/manual/en/reference.pcre.pattern.differences.php" target="_blank">?</a>.</p>';
...
$GLOBALS["lang"]['<p>Your racks help refine exactly where your devices are located.<br> <br></p>'] = '<p>Viaj rakoj auttas rafini precize kie viajj situazione.<br/> <br/></p>';

$GLOBALS["lang"]['<strong>NOTE</strong> - You are accessing this URL from the local Open-AudIT server. The downloaded script will not be able to submit when run on any other machine. If you need to audit other machines, please download the script from any remote machine, not using a browser on the Open-AudIT server itself.'] = '<strong>I</strong> Vi Aliris URL de la loka Open- Servilo Audit. L\'apretutita manikripto ne povas submeti Se vi bezonas revizii alpijn ma apretinojn, bonvolu el apretuti la manikripton de iu malpreksima ma divonaino, ne uzante retumonilon sur la Open- Audit- servilo mem.';
...
$GLOBALS["lang"]['A JSON array of objects matching the software name taken from the CVE, enriched with the software name retrieved by Open-AudIT.'] = 'JSON aro de obietktoj egalante la softvarnomon prenitan de la CVE, ri proporciónigita kun la softvarnomo prenita fare de Open- Audit.';
...
$GLOBALS["lang"]['A JSON object containing an array of attributes to change if the match occurs.'] = 'JSON- objekto enhavanta aron de ategortoj por šan';
...
$GLOBALS["lang"]['A backbone network is part of a computer network infrastructure that provides a path for the exchange of information between different LANs or sub-networks. A backbone can tie together diverse networks within the same building, across different buildings, or over a wide area.<br><br>For example, a large company might implement a backbone network to connect departments that are located around the world. The equipment that ties together the departmental networks constitutes the network backbone. When designing a network backbone, network performance and network congestion are critical factors to take into account. Normally, the backbone network capacity is greater than that of the individual networks connected to it.<br><br>Another example of a backbone network is the Internet backbone, which is the set of wide area networks (WANs) and core routers that tie together all networks connected to the Internet.'] = 'Malanta Spino povas ligi kune diversspecajn retojn ene de la sama konstura.<br/><br/>Ekming, gra firmao eble efektivigos spinoreton por ligi sekciojn kiuj situaziones Čirka. La mondo. La kipa Dum dizajnado de sendacia spino, retefikeco kaj sendacia obstrukci.o estas kritikaj faktoroj enkalkuli. Normale, la spino- retkapacito estas pli ossega ol tiu de la Infinesduaj retoj ligitaj al εi.<br/><br/>Alia eszemplo de spinoreto estas la Interreta spino, kiu estas la aro de lar.aj aretoj (WANoj) kaj kenvoj kiuj ligas kune .iujn retojn ligitaj al la Interreto.';
...
$GLOBALS["lang"]['A comma separated list of values, one of which can be selected.'] = 'Komo apartigiad Lister de Valoroj, unu el kiuj povas esti selektita.';
...
$GLOBALS["lang"]['A dashboard is made up of three columns and two rows of what we call <i>widgets</i>. A widget is very similar to a summary, only we take the summary concept a bit further. Widgets are created in a simple fashion using a couple of drop down boxes - or you can elect to use your own SQL for complete customisability.'] = 'Da triboard konsistas el tri kolumnoj kaj du vicoj de kion ni nomas <i>D\'accordo.</i>. Ao estas tre simpa al revo, nur ni prenas la resegan concepton iomete plu. Vidinad estas kreita en simplia modo uzanta paron da guto malsupren kestoj - katlus vi povas elekti uzi vian propran SQL por kompleta kutimo.';
...
$GLOBALS["lang"]['A package is a piece of installed softare. A package has a type - antivirus, approved, backup, banned, cloud, firewall, ignored, license or other.'] = 'Pakao estas peco de secretita moolo. Paka';

$GLOBALS["lang"]['A password (stored as a hash) that enables logon when using application authentication.'] = 'pasvorton (venkita kiel hash) kiu rajtigas tunnuksen dum uzado de apliki consignaaluctentigo.';
...
$GLOBALS["lang"]['ack_by'] = 'A.';

$GLOBALS["lang"]['Ack By'] = 'A.';
...
$GLOBALS["lang"]['action_devices_assigned_to_location'] = 'Ago cucito määratud al Loko';

$GLOBALS["lang"]['Action Devices Assigned To Location'] = 'Ago cucito määratud al Loko';

$GLOBALS["lang"]['action_devices_assigned_to_org'] = 'Ago cucito määratud al Org';

$GLOBALS["lang"]['Action Devices Assigned To Org'] = 'Ago cucito määratud al Org';

$GLOBALS["lang"]['action_download'] = 'El seniti pilao';

$GLOBALS["lang"]['Action Download'] = 'El seniti pilao';

$GLOBALS["lang"]['action_uninstall'] = 'Pois asennus';

$GLOBALS["lang"]['Action Uninstall'] = 'Pois asennus';
...
$GLOBALS["lang"]['actioned_date'] = 'Agitazioni';

$GLOBALS["lang"]['Actioned Date'] = 'Agitazioni';
...
$GLOBALS["lang"]['Activate Key'] = 'Attivazione ';

$GLOBALS["lang"]['Activate a free Enterprise license'] = 'Attivare la Liberación Licencia de empresa';
...
$GLOBALS["lang"]['Address audit findings and corrective actions'] = 'Direktaj revizio rezultoj kaj korektaj';
...
$GLOBALS["lang"]['All'] = 'OTTOBRE';

$GLOBALS["lang"]['All IPs'] = 'Alternatiuj IPj';

$GLOBALS["lang"]['All Policies'] = 'MINISTÈ POLÍTICA';

$GLOBALS["lang"]['All Queued Items'] = 'нани нани нани нани нани нани нани нани нани ни ни нани нани нани нани нани ни нани нани ни нани ни нанани ни ни ни ни нани ни ни ни нани ни нани нани ни ни нани ни ни ни нани ни нанани ни ни ни ни нани ни ни нани ни ни ни ни ни ни ни нанани ни ни ни ни н';
...
$GLOBALS["lang"]['All devices without a type of switch and printer. Essentially the same as the above query.'] = ' imitazione paratoj sen speco de galtilo kaj printilo. Esence la sama kiel la sopra demando.';
...
$GLOBALS["lang"]['An array of object representing external links to more information.'] = 'Aro de objectkto reprezentanta eksterajn ligilojn al pli da informatoj.';

$GLOBALS["lang"]['An educated guess to the identity and type of device'] = 'klera konjekto al la identeco kaj speco de aparato';

$GLOBALS["lang"]['An encrypted JSON document containing the required attributes depending on the <code>credentials.type</code>.'] = 'JSON- dokumento enhavanta la postulatajn atregultojn dipende de la <code>credentials.type</code>.';
...
$GLOBALS["lang"]['An entry can be created using the web interface if the current user logged in has a role that contains the'] = 'Eniro povas esti kreita uzante la interretinterfacon se la nuna uzanto recordsdis en havason rol kiu enhavas';
...
$GLOBALS["lang"]['An open|filtered port is considered open (and will trigger device detection).<br>Previously, Open-AudIT considered an Nmap response of'] = 'Malfermita hano estas konsiderita malferma (kaj ellasos aparatodetekton).<br/>Anta';
...
$GLOBALS["lang"]['And provide a name - we humbly recommend Open-AudIT &#128512;, but you can name it anything you like. Make sure the option for <i>Integrate any other application you do not find in the gallery (Non-gallery)</i> is selected. And then click <i>Create<i>.'] = 'Ni humile remomendas Open- Audit... <i>Integri ajnan alias aplika... su vi ne Trovas en la galerio (no- galerii)</i> Estas ektita. Kaj poste klaki <i>Krei<i>.</i></i>';
...
$GLOBALS["lang"]['AntiVirus'] = 'Anticipo';
...
$GLOBALS["lang"]['Any TCP ports (comma seperated, no spaces) you wish to exclude from this discovery. Only available when using Nmap 7+.'] = ' (komma seperato, neniuj spacoj) vi deziras eskludi de tiu eltrova. Nur havbla dum uzado de Nmap 7 +.';

$GLOBALS["lang"]['Any UDP ports (comma seperated, no spaces) you wish to exclude from this discovery. Only available when using Nmap 7+.'] = ' imitazione UDP- havenoj (komma seperite, neniuj spacoj) vi deziras eskludi de tiu eltrova. Nur havbla dum uzado de Nmap 7 +.';
...
$GLOBALS["lang"]['Any attributes followed by a * indicate that CVSS data less than v4 was used to complete this field. By default, we attempt to use v4 fields, however if they are not populated we will fallback to the previous version(s) for attributes.'] = ' Imitaiuj ategortoj sekvitaj per defa.lte, ni proves uzi v4 kapampjn, aliflanke se ili ne estas lo...';
...
$GLOBALS["lang"]['Any discovered devices will be assigned to this Location if set. Links to <code>locations.id</code>.'] = ' Il s \'agit d\'un program d\'aide à l\'mploi. Ligiloj al <code>locations.id</code>.';

$GLOBALS["lang"]['Any discovered devices will be assigned to this Location when they run their audit script (if set).'] = ' aparato estos asignitaj al tiu loko kiam ili prizorgas sian reviziomanuskripton (se aro).';

$GLOBALS["lang"]['Any discovered devices will be assigned to this Location when they run their audit script (if set). Links to <code>locations.id</code>.'] = ' aparato estos asignitaj al tiu loko kiam ili prizorgas sian reviziomanuskripton (se aro). Ligiloj al <code>locations.id</code>.';

$GLOBALS["lang"]['Any discovered devices will be assigned to this Org if set. If not set, they are assigned to the <code>org_id</code> of this discovery. Links to <code>orgs.id</code>.'] = ' personalizadoiuj malkovritaj aparato estos asignitaj al tiu Org se aro. Il n\'y a pas d\'austers <code>org_id</code> De tiu malkovro. Ligiloj al <code>orgs.id</code>.';

$GLOBALS["lang"]['Any files found in this manner are stored in the <i>executable</i> table as per any other device component.'] = 'Azonosító a los dosierojtrovitaj en tiu manieros stokitaj en la <i>Ekzekuebla</i> Tablo kiel per iu alias aparato komponanto.';
...
$GLOBALS["lang"]['Any user uploaded images are placed here.'] = 'Mezcla uzanto al apretitis Chei hulet.';

$GLOBALS["lang"]['Application'] = 'Apliko';

$GLOBALS["lang"]['Application Definitions'] = 'Aplikoi';

$GLOBALS["lang"]['application_id'] = 'Numero d\'identificazione';

$GLOBALS["lang"]['Application ID'] = 'Numero d\'identificazione';
...
$GLOBALS["lang"]['applications'] = 'Aplikoi';
...
$GLOBALS["lang"]['Approved Packages'] = 'Aplikitaj pakoi';

$GLOBALS["lang"]['April'] = 'J\'ai une idée.';

$GLOBALS["lang"]['Arabic'] = 'Arabaarabuertorico. kg';
...
$GLOBALS["lang"]['Are you sure? This will reset the queue processing count and could cause load on the server.'] = '? Des Vicertas? Tio rekomencos la atendoprentigogokalkulon kaj povis kaizi родельноNo sobre la servilo.';
...
$GLOBALS["lang"]['Armenia'] = 'Come funziona?';
...
$GLOBALS["lang"]['Ask me later'] = 'Domanda';

$GLOBALS["lang"]['Ask the Community for help or contribute answers for others.'] = 'Richiesta la Komunumon por holdi a';

$GLOBALS["lang"]['aspect_ratio'] = 'Aspekto suhtarv';

$GLOBALS["lang"]['Aspect Ratio'] = 'Aspekto suhtarv';

$GLOBALS["lang"]['Asset ID'] = 'Kieli- instali Numero d\'identificazione';

$GLOBALS["lang"]['asset_ident'] = 'Tunnide';

$GLOBALS["lang"]['Asset Ident'] = 'Tunnide';
...
$GLOBALS["lang"]['Assign Device to Cluster'] = 'Määäära Seade al klaster';

$GLOBALS["lang"]['Assign Device to Location'] = 'Omista seade al Loko';

$GLOBALS["lang"]['Assign Device to Organisation'] = 'Määäära Voir aussi Seade al organiso';
...
$GLOBALS["lang"]['Assign an ISMS manager or team'] = 'Attribuzione ISMS- mana suya';
...
$GLOBALS["lang"]['At present we can use netstat_ports, software and users.'] = 'Nun ni povas uzi retstat _ porto, programemaro kaj uzantoj.';
...
$GLOBALS["lang"]['attachment'] = 'Henkillis';
...
$GLOBALS["lang"]['Audit Mount Point'] = 'Tarkaszte';
...
$GLOBALS["lang"]['Audit Software'] = 'Kahtlustius programmaemiaro';

$GLOBALS["lang"]['Audit Status'] = 'Szobrok de Kaflustuse';

$GLOBALS["lang"]['Audit Win32 Product'] = 'Revizita Win32 Produkta prodotto';

$GLOBALS["lang"]['Audit Windows'] = 'Reponsabile del lavoro';
...
$GLOBALS["lang"]['Australia'] = 'Kahtlusti';

$GLOBALS["lang"]['Austria'] = 'Kathlustuslause';

$GLOBALS["lang"]['Auth'] = 'Risp.:';

$GLOBALS["lang"]['auth'] = 'Risp.:';

$GLOBALS["lang"]['Auth Methods'] = 'Auth Metodoj';

$GLOBALS["lang"]['Authenticate only'] = 'No.';
...
$GLOBALS["lang"]['authority_key_ident'] = 'Toritato di petrolio';

$GLOBALS["lang"]['Authority Key Ident'] = 'Toritato di petrolio';

$GLOBALS["lang"]['Auto'] = 'Kahtlustus';

$GLOBALS["lang"]['auto_renew'] = 'Novità';

$GLOBALS["lang"]['Auto Renew'] = 'Novità';

$GLOBALS["lang"]['Auto populated by the Open-AudIT Server.'] = 'Kaphlustus lo bendita tariffe de la Open- Audit- Servilo.';

$GLOBALS["lang"]['AutoRenew'] = 'Kahtlustuttorenovi';

$GLOBALS["lang"]['automatable'] = 'Kahtlusal';

$GLOBALS["lang"]['Automatable'] = 'Kahtlusal';

$GLOBALS["lang"]['Automatically populated based on the Collectors OS.'] = 'Epäilty, cuten lo...';

$GLOBALS["lang"]['availability'] = 'Disponibile';

$GLOBALS["lang"]['Availability'] = 'Disponibile';

$GLOBALS["lang"]['Available Benchmarks'] = 'Havebla kriteeriumidi';

$GLOBALS["lang"]['Awaiting Analysis'] = 'Atendante Analizzo';
...
$GLOBALS["lang"]['BTU Total'] = 'BTl ISTRUZIONE';
...
$GLOBALS["lang"]['base_score'] = 'Tunnista';

$GLOBALS["lang"]['Base Score'] = 'Tunnista';
...
$GLOBALS["lang"]['baselines_policies'] = 'Bazlinioi Politikoi';

$GLOBALS["lang"]['Baselines Policies'] = 'Bazlinioi Politikoi';
...
$GLOBALS["lang"]['Below you can see an example Org Chart. If a user has permission on the <i>Finance A</i> Org, they also have permission on the descendant Orgs of Dept A, B & C. This is regardless of the collection requested.<br><br>If the collection requested allows ascendants, then the user will also have access to Company #1 and Default Org items. This is for (as above) queries, groups, et al.<br><br>Note - A user may have access to a query from Default Org, but that is the query itself not the result. The result will only show devices that the user has access to - IE devices from Finance A and Dept A, B & C.'] = 'Malsupre vi povas vidi ekzemplon Organigramma. Le Conseil de l\'Europe <i>Financo</i> - C\'è l\'est quoi? havas permeson sur la posteulo. Orgs de Dept A, B & C Tio estas nekonsiderante la kolekto petis.<br/><br/>Se la kolekto petis permesas aspintojn, tiam la uzanto anka epäilty havos aliron al firmao numero 1 kaj Oletus org erojn. Tio estas por (kiel supre) requestoj, grupoj et al.<br/><br/>Notu: uzanto povas havi aliron al demando de Alapértelmezett Org, seditio estas la atendo mem ne la rezulto. La rezulto nur montras aparato kiujn la uzanto havas aliro al - IE aparatoj de Finance A kaj Dept A, B & C';

$GLOBALS["lang"]['Benchmark'] = 'Voce principale:';
...
$GLOBALS["lang"]['Boolean'] = 'Boolés';

$GLOBALS["lang"]['Boolean 1/0'] = '1 / 0';

$GLOBALS["lang"]['Boolean y/n'] = 'Boolés';
...
$GLOBALS["lang"]['Both forms of'] = 'L\'Ambasciata permoj de';
...
$GLOBALS["lang"]['British Virgin Islands'] = 'Britaj Virgulinsurloj';

$GLOBALS["lang"]['Browse down the tree to Console Root -> Component Services -> Computers -> My Computer<br><br>Right click on <i>My Computer</i> and select properties<br><br>Select the <i>Default Properties</i> tab'] = 'Navega la liukoinen la arbo al Console Root Komponettaj servoj - limit anza Komputiloj - No mia komputio<br/><br/>Rekte klaki sur <i>Mia komputio</i> Traduzione:<br/><br/>Elektu <i>Défia</i> kla retrave';
...
$GLOBALS["lang"]['btu_total'] = 'Btu Totale';

$GLOBALS["lang"]['Btu Total'] = 'Btu Totale';

$GLOBALS["lang"]['build_number'] = 'Nombron';

$GLOBALS["lang"]['Build Number'] = 'Nombron';
...
$GLOBALS["lang"]['Bulk Edit Form'] = 'Forma di edición de Bulk';
...
$GLOBALS["lang"]['business_requirements'] = 'KOMERCAJ postulo';

$GLOBALS["lang"]['Business Requirements'] = 'KOMERCAJ postulo';
...
$GLOBALS["lang"]['By'] = 'Antalucita';

$GLOBALS["lang"]['By default we integrate all devices with their nmis_manage attribute set to <i>y</i>. With 4.2.0 we also ship a Rule that says <i>If we discover a device and it has a valid SNMP OID, mark that device as managed by NMIS</i>. Obviously you can disable this if it is not what you want.'] = 'l\'utilazione di metita al <i>Oui.</i>. Kun 4.2.0 ni anka regulan kiu diras <i>Se ni malkovras aparaton kaj εi havas validan SNMP OID, martas tiun aparaton kiel administrite tariffa de NMIS</i>. L\'utilizzazione della tecnologia dell\'informazione dans le domaine de l\'informatique et de l\'informatica a été améliorée.';

$GLOBALS["lang"]['By default, we skip certificate validation because customers tend to use self-signed certificates. To enable certificate validation, edit the file below'] = 'Défia Por ebligi aestilon validumado, redakki la dosiron sub sub';
...
$GLOBALS["lang"]['Calculated when integration is run and contains a JSON representation of the devices in this integration. Each links to <code>devices.id</code>.'] = 'Kalkuli kiam integriγo estas prizorgita kaj enhavas JSON- reprezentadon de la aparatoj en tiu integri graduateo. Firma <code>devices.id</code>.';

$GLOBALS["lang"]['Calculated when integration is run and contains a JSON representation of the locations in this integration. Each links to <code>locations.id</code>.'] = 'Kalkulis kiam integri rupturao estas prizorgita kaj enhavas JSON reprezentadon de la lokoj en tiu integri beato. Firma <code>locations.id</code>.';
...
$GLOBALS["lang"]['Call up a command prompt by clicking Start and searching for <code>command</code>'] = 'Voki kommundo quistilon klakante Komencon kaj ser previsto <code>command</code>';
...
$GLOBALS["lang"]['Can be set by discovery or user.'] = 'Povas esti metita per eltrova......';

$GLOBALS["lang"]['Can be set by discovery or user. Uses the ID from the locations table.'] = 'Povas esti metita per eltrova...... Uzu la ID de la tablo de la lokoj.';
...
$GLOBALS["lang"]['caption'] = 'C\'e\' piu\' vrai.';
...
$GLOBALS["lang"]['certificates'] = 'Atestilo';
...
$GLOBALS["lang"]['Chad'] = 'Firma';

$GLOBALS["lang"]['Change'] = 'C\'e\' un dit.';

$GLOBALS["lang"]['change_id'] = 'Henkilókorti';

$GLOBALS["lang"]['Change ID'] = 'Henkilókorti';
...
$GLOBALS["lang"]['Check for SSH on these ports'] = 'Kontrau per SSH sur tiuj hasnoi';
...
$GLOBALS["lang"]['Click on OK and close the DCOMCNFG window.<br><br>The above changes will require a reboot to take effect.'] = 'Klaku sur OK kaj fermo la DCOMCNFG- fenestoni.<br/><br/> imitazione- supraj шan graduateoj postulos entereurasigi por ekvalidi.';
...
$GLOBALS["lang"]['Client ID'] = 'Numero d\'identificazione Kliendi';
...
$GLOBALS["lang"]['client_site_name'] = 'Condividi su Twitter';

$GLOBALS["lang"]['Client Site Name'] = 'Condividi su Twitter';

$GLOBALS["lang"]['Close'] = 'Fermu prokszim';

$GLOBALS["lang"]['Closed'] = 'Fermi!';
...
$GLOBALS["lang"]['Cloud Network'] = 'Pilveví';

$GLOBALS["lang"]['clouds'] = 'NUBLE';
...
$GLOBALS["lang"]['Collector'] = 'Condividi su Twitter';

$GLOBALS["lang"]['Collector (UUID)'] = 'kolektanto (UID)';

$GLOBALS["lang"]['Collector / Server is an Enterprise only feature. Enterprise customers receive one Collector license for free. Additional Collector licenses can be purchased as required.'] = 'Servilo estas nur Enterprise. Entreprisklientoj risovas unu koletantlicencon por libera. Kromaj kolektantricoj povas esti a';

$GLOBALS["lang"]['Collector / Server is designed so that you can have a remote or <i>collector</i>  instance of Open-AudIT running on a remote machine. That collector instance might be in another security zone, subnet, cloud hosting instance or at a customer site.  The remote collector is then doing all the discovering and auditing of devices locally avoiding networking and firewalling complexity.  The Collector once it has registered is completely controlled by the <i>server</i>.  This means you only need an HTTP or HTTPS connection from that Collector to the Server.'] = 'Servilo estas dizajnita tien che vi povas havi malprossiman katlustus <i>Condividi su Twitter</i> Ekzemplo de Open- Audit kuranta sur malpreksima ma apretino. Tiu koletantkazo eble estos en alias sekureczono, subreto, nubo bastiganta kazon épäilty en kleentoloko. La malpreksima kolektanto tiam faras la tutan malkovradon kaj revizion de aparatoj loke evitante interkonektadon kaj fajromurantan kompleksecon. La kolektanto post kiam εi registri estas tute kontrolita tariffa de la <i>Servilo servilo servilo servilo</i>. Tio signfas ke vi nur bezonas HTTP epäilty HTTPS- ligon de tiu kolektanto al la Servilo.';
...
$GLOBALS["lang"]['command_time_to_execute'] = 'Il tempo al tempo';

$GLOBALS["lang"]['Command Time To Execute'] = 'Il tempo al tempo';
...
$GLOBALS["lang"]['common_name'] = 'No.';

$GLOBALS["lang"]['Common Name'] = 'No.';
...
$GLOBALS["lang"]['Community Questions'] = 'Komunumaj richiesta';

$GLOBALS["lang"]['Community String'] = 'Kordo';

$GLOBALS["lang"]['Comoros the'] = 'Komoorid';

$GLOBALS["lang"]['Compact'] = 'Condividi su Google';
...
$GLOBALS["lang"]['Conduct a risk assessment'] = 'Faru Rissotak';
...
$GLOBALS["lang"]['Conducted by an accredited body in two stages'] = 'Gvidite tariffe de estima korpo en du standioj';
...
$GLOBALS["lang"]['Configuration Change Detection and Reporting'] = 'Konfiguracio Rilevamento del cambio kaj aruandlus';

$GLOBALS["lang"]['Configure'] = 'La jenaj paεoj ligas';

$GLOBALS["lang"]['Configure the agent server-side to perform audits on a schedule'] = 'Akkeli la agento- servilo- sideon por elfari reviziojn en horaro';
...
$GLOBALS["lang"]['Consider filtered Ports Open'] = 'Konsideru instaliloni Buon divertimento';

$GLOBALS["lang"]['Consider open|filtered Ports Open'] = 'Konsideru malferman Buon divertimento';
...
$GLOBALS["lang"]['Context Name'] = 'Nomo.';

$GLOBALS["lang"]['Continuously improve the ISMS'] = 'D \'autres plibonigi la ISMS';

$GLOBALS["lang"]['contractual_obligations'] = 'Kontraktaj kondivolvoi';

$GLOBALS["lang"]['Contractual Obligations'] = 'Kontraktaj kondivolvoi';

$GLOBALS["lang"]['Cook Islands'] = 'Curiore Carnerloj';
...
$GLOBALS["lang"]['Copy the <i>Application ID</i> field and paste it into the Open-AudIT <i>Client ID</i> field for the new Auth Method.'] = 'Kopiu <i>Numero d\'identificazione</i> Kampo kaj pasto εi en la Open- Audit <i>Numero d\'identificazione Kliendi</i> Kampo por la nova Auth Metodo.';

$GLOBALS["lang"]['Copy the <i>Client ID</i> and paste it into the Open-AudIT <i>Client ID</i> field.<br>If there is no secret, click <i>Generate new secret</i>, then copy the value and paste it into the Open-AudIT <i>Client Secret</i> field.'] = 'Kopiu <i>Numero d\'identificazione Kliendi</i> Kaj en la malferma- Audit <i>Numero d\'identificazione Kliendi</i> C\'e\' Kampo.<br/>Se ne eksistas sekreto, klako <i>Generi novan sekreton</i>Tiam kopii la valoron kaj paston εi en la Open- Audit <i>La sekreta klivento</i> C\'e\' Kampo.';

$GLOBALS["lang"]['Copy the value and paste it into the Open-AudIT form for the <i>Client Secret</i> field.'] = 'Kopio la valoro kaj pasto εi en la Open- Audit- formuleron por la <i>La sekreta klivento</i> C\'e\' Kampo.';
...
$GLOBALS["lang"]['Costa Rica'] = 'C\'e\' piu\' vrai.';
...
$GLOBALS["lang"]['create_internal_from_external'] = 'Kreu interna de Ekstera';

$GLOBALS["lang"]['Create Internal From External'] = 'Kreu interna de Ekstera';

$GLOBALS["lang"]['Create NMIS Devices from Open-AudIT'] = 'NMISIONE Krei Destinivos de Open- Audit';
...
$GLOBALS["lang"]['created_date'] = 'Condividi su Twitter';

$GLOBALS["lang"]['Created Date'] = 'Condividi su Twitter';
...
$GLOBALS["lang"]['Creating Widgets'] = 'Kreanta vidina';
...
$GLOBALS["lang"]['Creating an Integration'] = 'Krei integri rottura';
...
$GLOBALS["lang"]['Credentials Client ID'] = 'Carte d\'identità di Cléncelles Kliento';

$GLOBALS["lang"]['Credentials Subscription ID'] = 'Registrazione di credito ID';

$GLOBALS["lang"]['Credentials Tenant ID'] = 'Identificación del arrendario';

$GLOBALS["lang"]['Credentials are stored in the <i>credentials</i> database table. The actual credential information is encrypted in storage. When a Discovery is run, a device has its specific credentials retrieved from the database, decrypted and tested. If these fail the list of credentials is also retrieved, decrypted and then tested against the device starting with credentials known to have worked previously. Device specific credentials are stored at an individual device level in the <i>credential</i> table (note - no <i>s</i> in the table name). SSH keys are tested before SSH username / password. When testing SSH, credentials will also be marked as working with sudo or being root.'] = 'Credenciales estas stokita en la <i>Akredita</i> Tablo de datumbazo. La faktaj lurkinformoj estas Čifritaj en stokado. Kiam Discovery estas prizorgita, aparato havas siajn specifajn akredita.ojn prenitainn de la datumbazo, de prospettivacirifrita kaj presente. Se tiuj malsukcesas la listan de akredita.oj ankaregiestas prenitaj, de prospettivacirifritaj kaj tiam prescitaj kontra Seade spécintaj akredita. In questo caso, la Commissione ha adottato una direttiva che modifica la direttiva 77/388/CEE. <i>→ Eventoj:</i> Tablo (ne): <i>Tiglio</i> en la tablonomo. SH-aprettosiloj estas estetaj anta. SSH-Urantinomo / pasvorton. Dum testado de SSH, akredita... oj anka...';
...
$GLOBALS["lang"]['Customisable Scanning Options per Discovery'] = 'Kutimeblaj skaneeriv Opcioj per Découverte';
...
$GLOBALS["lang"]['Dashboards provide <i>at a glance</i> important visibility for changes occurring on your network as well as providing quick links to device types, manufacturers, and operating systems and so much more.'] = 'Nincs magyar neve <i>Che c\'e\'?</i> Grava videbleco por шанивениненаннинананнанниваннининина, proktantoj, kaj opéraciumej kaj tieel multe pli.';
...
$GLOBALS["lang"]['Data Retention'] = 'Datanoj Säilitamiini';
...
$GLOBALS["lang"]['dataset_title'] = 'Tunnista';

$GLOBALS["lang"]['Dataset Title'] = 'Tunnista';

$GLOBALS["lang"]['date'] = 'Data de la dato';
...
$GLOBALS["lang"]['date_of_manufacture'] = 'Data de fabrikado';

$GLOBALS["lang"]['Date Of Manufacture'] = 'Data de fabrikado';

$GLOBALS["lang"]['date_paid'] = 'Dato Makscan';

$GLOBALS["lang"]['Date Paid'] = 'Dato Makscan';

$GLOBALS["lang"]['date_received'] = 'La data ricevis';

$GLOBALS["lang"]['Date Received'] = 'La data ricevis';
...
$GLOBALS["lang"]['DateTime Y-M-D H:M:S'] = 'Data de tempo Y- M- D H: M: S';
...
$GLOBALS["lang"]['Debugging'] = 'Silumini';

$GLOBALS["lang"]['Debugging a Script'] = 'Debu diversaante kézműves';

$GLOBALS["lang"]['December'] = 'Decembro Decembro';
...
$GLOBALS["lang"]['Deferred'] = 'Anta skeptite tariffe';
...
$GLOBALS["lang"]['Delete'] = 'Supremi';

$GLOBALS["lang"]['Delete Example Devices'] = 'Ekzample, la par défautvolaj aparato';
...
$GLOBALS["lang"]['Delete from Cluster'] = 'Para di cluster';
...
$GLOBALS["lang"]['detail'] = 'Destinazione';
...
$GLOBALS["lang"]['Determine risk treatment options'] = 'Determinazione del risquetraktadajn eblojn';
...
$GLOBALS["lang"]['device'] = 'Destinazione';

$GLOBALS["lang"]['Device'] = 'Destinazione';

$GLOBALS["lang"]['Device Audits'] = 'Auditorías de dispositivis';
...
$GLOBALS["lang"]['Device Matching Rules'] = 'Sobivus Seadme Regulos';
...
$GLOBALS["lang"]['Device Types'] = 'Destitivo Tipologia';

$GLOBALS["lang"]['Device and Software and Hardware Auditing'] = 'Seade kaj Softvaro kaj Riistvara auditeerimin';

$GLOBALS["lang"]['Device is in the Subnet'] = 'Prodotti chimiques en la Subnet';

$GLOBALS["lang"]['Devices'] = 'Aparatoi';

$GLOBALS["lang"]['devices_assigned_to_location'] = 'Aplikas al loko';

$GLOBALS["lang"]['Devices Assigned To Location'] = 'Aplikas al loko';
...
$GLOBALS["lang"]['Devices Collection'] = 'Dispositivi Kolento';

$GLOBALS["lang"]['Devices Created in '] = 'Aparatoj kreitai fr ';

$GLOBALS["lang"]['Devices Created in Open-AudIT'] = 'Aplikas en Audit';

$GLOBALS["lang"]['devices_default_display_columns'] = 'Seamete vaikekuva Colonoj';

$GLOBALS["lang"]['Devices Default Display Columns'] = 'Seamete vaikekuva Colonoj';

$GLOBALS["lang"]['Devices Found Last 7 Days'] = 'Aparatoj Trovis lastajn 7 tagojn';

$GLOBALS["lang"]['Devices Found Today'] = 'Informazioni sulla prenotazione';

$GLOBALS["lang"]['Devices Found Yesterday'] = 'Aparatoj Trovis hiera';

$GLOBALS["lang"]['Devices Missing Information'] = 'Informazioni sull\'utente';
...
$GLOBALS["lang"]['Devices Selected from '] = 'Destinazioni ';

$GLOBALS["lang"]['Devices Selected from Open-AudIT'] = 'Deviceso Elektita de Open- Audit';

$GLOBALS["lang"]['Devices Updated in '] = 'Aplikitai fr ';
...
$GLOBALS["lang"]['Devices will not be matched if their status is set to <i>deleted</i>. Any other status will allow a match to occur.'] = 'Aparatoj ne estos egalitaj se ili statuo ces <i>Forigita</i>. imitare alias stato permesos mat Okazi.';

$GLOBALS["lang"]['Devices with Expired Warranties'] = 'Aparatoj kun aegunud tagatizzata';
...
$GLOBALS["lang"]['direction'] = 'Condividi su Google Nom de la ville (facultatif, sans doute pas besoin de traduction)';
...
$GLOBALS["lang"]['discovery_run'] = 'Decuverte';

$GLOBALS["lang"]['Discovery Run'] = 'Decuverte';

$GLOBALS["lang"]['discovery_scan_options'] = 'Opcioj di scansione di Découverte';

$GLOBALS["lang"]['Discovery Scan Options'] = 'Opcioj di scansione di Découverte';

$GLOBALS["lang"]['Discovery Scan Options are just another item collection. Enterprise users can create, read, update and delete entries as required. Professional users can read all entries, but not create new entries, update existing entries or delete entries. Community users have no GUI that allows access to this collection.'] = 'Découverts-skandalo Opcioj estas nur alias objektokolekto. Entreprisuzantoj povas krei, legi, εisdatigi kaj forigi kontriboujn kiel postulat. La plupart des États membres de l\'Union européenne (UE) ont adottaé des mesures Visant à réduire les émission de gaz à effet de serre. Komunumaj uzantoj havas neniun GUI kiu permesas aliro al tiu koletto.';

$GLOBALS["lang"]['Discovery Scan Types'] = 'Découverte Skaj Specoj';

$GLOBALS["lang"]['Discovery Support'] = 'Sous- téno Découverte';

$GLOBALS["lang"]['Discovery has stopped working'] = 'Découverte Česis laborioso';

$GLOBALS["lang"]['disk'] = 'Prélèvement';

$GLOBALS["lang"]['Disk'] = 'Prélèvement';

$GLOBALS["lang"]['display_version'] = 'Informazioni generali';

$GLOBALS["lang"]['Display Version'] = 'Informazioni generali';
...
$GLOBALS["lang"]['Do not show me again'] = 'Neve al mi denota';
...
$GLOBALS["lang"]['Do you want to use secure transport (LDAPS) or regular unencrypted LDAP.'] = ' imitau vi volas uzi sekuran transporton (LDAPS) un regolamentato ne verlaifritan LDAP.';
...
$GLOBALS["lang"]['Does the license apply to child Orgs.'] = 'La permesilo valida per infanoj.';

$GLOBALS["lang"]['domain'] = 'Puhataworld. kg';

$GLOBALS["lang"]['Domain'] = 'Puhataworld. kg';

$GLOBALS["lang"]['domain_controller_address'] = 'Domeenikontrolleri - indirizzo';

$GLOBALS["lang"]['Domain Controller Address'] = 'Domeenikontrolleri - indirizzo';
...
$GLOBALS["lang"]['Download a File'] = 'El apretutu dosi';

$GLOBALS["lang"]['Download a file from URL'] = 'El apretu dosieron de URL';
...
$GLOBALS["lang"]['Download your updated version from'] = 'El apretu finan εisdatigitan versione de';
...
$GLOBALS["lang"]['EULA'] = 'Epäiltyropa Un anno';

$GLOBALS["lang"]['Each IP is scanned with the discovery configured options (see Discovery Scan Options and Discovery - Community vs Professional vs Enterprise on the wiki). In general, Nmap will test for ports 22 (ssh), 135 (wmi), 62078 (iPhone) and UDP 161 (snmp). If 22, 135 or 161 respond the credential list is retrieved and each credential tested in turn. The first working credentials are used for further queries directly from the device. Note - if a device has previously been discovered and has working credentials, those credentials are tested first. Only if those fail are the other credentials then attempted.'] = ' imitaiu IP estas skanita kun la eltrova.o formita opcioj (vidu Discovery Scan Options kaj Discovery - komunumo vs Professional vs Enterprise sur la Vikio). Se 22, 135 a. 161 risposta come la lurkliston estas prenita kaj La uuaj laborakredita.oj estas uzitaj por pliaj demandoj rekte de la aparato. Notu - se aparato anta Nur se tiaj malsukcesas estas la aleliaj akredita.oj tiam providontaj.';

$GLOBALS["lang"]['Each time a device is discovered or an audit result is processed, all rules are retrieved from the database and run against the attributes of the specific device. Rules run against one device at a time - there is no facility to say <i>Run the rules against all devices<i> or <i>Run the rules against these devices<i>. An individual rule will test one or more attributes of the device and if they match the rule, the result will be applied. Several attributes can be tested. Several attributes can be set. Think of this as an If This, Then That system for Open-AudIT.'] = 'Mezcla de este aparato esta malkovrita a reviziorezulto estas prilaborita, Regeloj kuris kontra epäilty unu aparato en tempo... <i>La reguloj kontra Iuj aparatoi<i> a <i>La reguloj kontra<i>. Personuopregico tetos unu a rezulto estas aplikita. Pluraj atregultoj povas esti recontaj. Pluraj atregultoj povas esti mititaj. Pensu privio kiel Setio, tiam tiu sistemo por Open- Audit.</i></i></i></i>';
...
$GLOBALS["lang"]['edit_log'] = 'Registrazione Editar';

$GLOBALS["lang"]['Edit Log'] = 'Registrazione Editar';

$GLOBALS["lang"]['editable'] = 'Muokattava';

$GLOBALS["lang"]['Editable'] = 'Muokattava';

$GLOBALS["lang"]['edited_by'] = 'Anta skeptite tariffe';

$GLOBALS["lang"]['Edited By'] = 'Anta skeptite tariffe';

$GLOBALS["lang"]['edited_date'] = 'Condividi su Facebook';

$GLOBALS["lang"]['Edited Date'] = 'Condividi su Facebook';
...
<strong>Neniu</strong> La sukcesa atako ne deposas de la regionjo kaj ekzekutkondrircaoj de la vundebla sistemo. La atakanto povas atendi povi atingi la vundeblecon ka efektijvigi la atingojn sub Čiuj a la pleij vantaggij kazoj de la vundebleco.
...
Vetkurkondio tuhoaa esti gajnita por sukcese ekspluati la vundeblecon. La sukceseco de la atako estas condi previstasigita de ekzekutkontrircaoj kiuj ne estas sub plena controlo de la atakanto. La atako povas devi esti lan curveita multoblaj tempoj kontra

Pitäkää kiinni. La atakanto murtaa injekki sin en la logikan retpadon inter la celo kaj la rimedo postuladita tariffe de la viktimo (ekz. voundblecoj postulantaj sur- pafilan atakanton).';

$GLOBALS["lang"]['El Salvador'] = 'Salvadoro';

$GLOBALS["lang"]['email'] = 'Repo reciso';

$GLOBALS["lang"]['Email'] = 'Repo reciso';

$GLOBALS["lang"]['email_address'] = 'Repo reciso';

$GLOBALS["lang"]['Email Address'] = 'Repo reciso';

$GLOBALS["lang"]['Email Configuration'] = 'Retpo divonato Konfiguracio';

$GLOBALS["lang"]['Email to send test to'] = 'Le présent règlement est obligatoire dans tous ses élements et directement applicabili dans tout État membre.';

$GLOBALS["lang"]['Enable'] = 'Habilitáci';
...
$GLOBALS["lang"]['enabled'] = 'Lubrificante';

$GLOBALS["lang"]['Enabled'] = 'Lubrificante';

$GLOBALS["lang"]['Enabling the Feature Under Windows'] = 'Sous la fenestro';

$GLOBALS["lang"]['encryption'] = 'Azione';

$GLOBALS["lang"]['Encryption'] = 'Azione';

$GLOBALS["lang"]['encryption_method'] = 'Metodo di Akripto';

$GLOBALS["lang"]['Encryption Method'] = 'Metodo di Akripto';

$GLOBALS["lang"]['encryption_status'] = 'Enkripciostatuso';

$GLOBALS["lang"]['Encryption Status'] = 'Enkripciostatuso';

$GLOBALS["lang"]['end_date'] = 'Fino alla data';

$GLOBALS["lang"]['End Date'] = 'Fino alla data';

$GLOBALS["lang"]['End OF Life Product ID'] = 'Fino al prodotto vivo';

$GLOBALS["lang"]['end_of_life'] = 'Fino a la vivo';

$GLOBALS["lang"]['End Of Life'] = 'Fino a la vivo';

$GLOBALS["lang"]['end_of_production'] = 'Fino a Produktado';

$GLOBALS["lang"]['End Of Production'] = 'Fino a Produktado';

$GLOBALS["lang"]['end_of_service'] = 'Fino de servo';

$GLOBALS["lang"]['End Of Service'] = 'Fino de servo';

$GLOBALS["lang"]['end_of_service_life'] = 'Fino a la vivo';

$GLOBALS["lang"]['End Of Service Life'] = 'Fino a la vivo';

$GLOBALS["lang"]['Endpoint'] = 'Finpunkto';

$GLOBALS["lang"]['English'] = 'Angla';

$GLOBALS["lang"]['Enhances regulatory compliance'] = 'Plibonigas Osservatorio reguligan';

$GLOBALS["lang"]['Enrichment is complete. The CVE has full metadata and is considered stable.'] = 'Rivistago estas kompleta. La CVE a plenajn metadatenojn kaj estas konsiderita stabilizzasa.';
...
$GLOBALS["lang"]['Enterprise private network'] = 'Imprenditoria';
...
$GLOBALS["lang"]['Establish an information security policy'] = 'Létrehozás informano sekurrecpolitikon';

$GLOBALS["lang"]['Established'] = 'Stabilimento';
...
$GLOBALS["lang"]['Evaluate the ISMS internally'] = 'Analizu la ISMS';

$GLOBALS["lang"]['Every'] = '?';

$GLOBALS["lang"]['Every Day'] = 'Firma';

$GLOBALS["lang"]['Example'] = 'Ekzemplo';

$GLOBALS["lang"]['Example Devices'] = 'Ekzemplo: Hävitä';

$GLOBALS["lang"]['Example Org Chart with Access'] = 'Ekzemplo Org Grafico Kun Aliro';
...
$GLOBALS["lang"]['Exclude IP Addresses'] = 'Adresoj IP extrait';
...
$GLOBALS["lang"]['exclusion_reasons'] = 'C\'e\' piu\' vrai.';

$GLOBALS["lang"]['Exclusion Reasons'] = 'C\'e\' piu\' vrai.';

$GLOBALS["lang"]['executable'] = 'Eksplusebla';

$GLOBALS["lang"]['Executable'] = 'Eksplusebla';

$GLOBALS["lang"]['executable_id'] = 'Henkilókorti';

$GLOBALS["lang"]['Executable ID'] = 'Henkilókorti';
...
$GLOBALS["lang"]['Existing Room'] = 'Sala eksistens?';
...
$GLOBALS["lang"]['exploit_maturity'] = 'Käytä Maturismo';

$GLOBALS["lang"]['Exploit Maturity'] = 'Käytä Maturismo';
...
$GLOBALS["lang"]['External Field Types'] = 'Ekstera kampo Tipologia';
...
$GLOBALS["lang"]['FAQ'] = 'Richiesta KKK';
...
$GLOBALS["lang"]['field_id'] = 'Numéro d\'identificazione del Kampo';

$GLOBALS["lang"]['Field ID'] = 'Numéro d\'identificazione del Kampo';
...
$GLOBALS["lang"]['Fiji the Fiji Islands'] = 'Fi fluidioj la Fi pilaioj consulloi';
...
$GLOBALS["lang"]['files_id'] = 'Numéro d\'identificazione di Doseroj';

$GLOBALS["lang"]['Files ID'] = 'Numéro d\'identificazione di Doseroj';

$GLOBALS["lang"]['filter'] = 'Szulfátok';

$GLOBALS["lang"]['Filter'] = 'Szulfátok';

$GLOBALS["lang"]['filtered'] = 'Stati Uniti';
...
$GLOBALS["lang"]['first_seen'] = 'Unità';

$GLOBALS["lang"]['First Seen'] = 'Unità';
...
$GLOBALS["lang"]['FirstWave'] = 'Un\'altra volta.';

$GLOBALS["lang"]['Fix'] = 'Correzione';

$GLOBALS["lang"]['Fixed'] = 'Fiksita Fiksita';

$GLOBALS["lang"]['Fixing the Issue'] = 'Fijación de la afero';

$GLOBALS["lang"]['Floor'] = 'eta / 1993 / o';

$GLOBALS["lang"]['Follow any of the links below and discover how to use Open-AudIT to find out <b>Whats On Your Network?</b>'] = 'Sekku jujn da laligiloj malsupre kaj malkovri kiel uzi Open- Audit por malkovri <b>Kio estas sur läbi reto?</b>';

$GLOBALS["lang"]['For'] = 'Henkillis';

$GLOBALS["lang"]['For <i>Type</i> make sure to select Baseline, and for Group you should select a Group of devices, if applicable to this baseline, that best represent the devices to apply the baseline against. This will prevent erroneous entries.'] = 'Henkillis <i>Tipo</i> Certigu selekki Bazlinion, kaj por grupo vi devus selekti grupon de aparatoj, se uzeble al tiu bazlinio, kiu plej os reprezentas la aparatojn por uzi la bazlinion kontrauna. Tio malhelpos erajn kontriboujn.';
...
$GLOBALS["lang"]['For SNMP Open-AudIT can use v1, v2 and v3 credentials. The device is queried regardless of it being a router, switch (regular network devices) or a computer (Linux and Windows often run SNMP for monitoring tools).'] = 'Por SNMP Apri- Audit povas uzi v1, v2 kaj v3 akredita. La aparato estas orgullosomandita nekonsiderante εi estante itinero, тaltilo (regulaj sendostaciaj paratoj) a Kahtlus komputio (Lin)';
...
$GLOBALS["lang"]['For further details information, see the wiki.'] = 'Por Pliaj informatoj, Vikion.';
...
$GLOBALS["lang"]['For more information please see the following guide which includes a video. Use'] = 'Por pli da informatoj bonvolu vidi la sekvan gvidiston kiu inkludas vidbendon. Uzo';

$GLOBALS["lang"]['For more information, see'] = 'Por pli da informatoj, vidu';
...
$GLOBALS["lang"]['Friday'] = 'Vendres';

$GLOBALS["lang"]['From 100 Devices'] = 'Aparatoi';
...
$GLOBALS["lang"]['German'] = 'Allegati';

$GLOBALS["lang"]['Germany'] = 'Saksa';

$GLOBALS["lang"]['Get Lat/Long'] = 'Hangi Lat / Lungo';

$GLOBALS["lang"]['Get News'] = 'Akiri Novaoj';

$GLOBALS["lang"]['Get Started'] = 'Mondial. descrizione unità nelle liste';
...
$GLOBALS["lang"]['Getting Started'] = 'Mondial. descrizione unità nelle liste';
...
$GLOBALS["lang"]['Go back to your Open-AudIT server and create a discovery with the target Windows computers IP Address as the subnet (this will save having to discover the entire subnet again). Run the discovery, taking note of any issues. For any issues found, take appropriate actions.'] = 'Iru reen al via Open- Audit- servilo kaj krei eltrova... su kun la celo Windows komputiloj IP Aadress kiel la subreto (tio diverraparos devi malkovri la tutan subreton denove). La malkovro, noti pri juj aferoj. Imitaar juj aferoj Trovis, prenu ta.gajn agojn.';

$GLOBALS["lang"]['Go the target Windows PC (or use RDP) and log on as the user used by your discovery credential set.'] = 'Iru al la celo PC Windows (a';

$GLOBALS["lang"]['Go to menu'] = 'Iru al menu';

$GLOBALS["lang"]['Go to the <i>Applications</i> -> <i>App registrations</i> menu item on the far left. Search for Open-AudIT. Click the Open-AudIT entry in the list (assuming you named the app Open-AudIT).'] = 'Iru al la <i>Aplikoi</i> ■ <i>Jogosultság</i> menuo objekto sur la malpreksima maldekstro. Serčis por Open- Audit. Klaku la Open- Audit- eniron en la lista (supozante ke vi nomis la app Open- Audit).';

$GLOBALS["lang"]['Go to the <i>Certificates and secrets</i> menu item under <i>Manage</i> in the center menu.'] = 'Iru al la <i>Atestiloj kaj sekretoj</i> Manu dedecto <i>Gépkocsi</i> en la centro menuo.';

$GLOBALS["lang"]['Go to the <i>Single sign-on</i> menu item and click SAML for <i>Select a single sign-on method</i>.'] = 'Iru al la <i>Ununura signo- sur</i> menu objekto kaj klako SAML por <i>Elekti ununuran signo- sur metodonte</i>.';

$GLOBALS["lang"]['Google Compute Fields'] = 'Google Computen kentät';

$GLOBALS["lang"]['Google JSON Credentials'] = 'Google JSON Kredencialit';

$GLOBALS["lang"]['Google Maps API Key'] = 'Google Maps in solutusrajapinta';

$GLOBALS["lang"]['Great, then you can help! Send FirstWave the text shown in the GUI and what should be shown. We will include that in the language file so going forward, the translation is improved and you do not need to worry about updating it for every release!'] = 'Csont, vi povas holdi! Unie sémi Ondo la teksto montrita en la GUI kaj kio dev esti montrita. Ni inkludocation en la lingvodosiero tien iranta anta consapevole, la traduko estas plibonigita kaj vi ne bezonas maltrankvili pri εisdatigado de εi por.';

$GLOBALS["lang"]['Greater Than'] = 'Pli gra';
...
$GLOBALS["lang"]['Have the agent always run the latest audit script (if you upgrade Open-AudIT and manually copy the scripts to the targets, then set cron - you will need to update these scripts for each upgrade).'] = 'Vive la agente ';
...
$GLOBALS["lang"]['Help and Frequently Asked Questions'] = 'Aiuto De la demande';

$GLOBALS["lang"]['Helps manage and mitigate information security risks'] = 'Administratore Helpoj kaj letigas informajn sekurrecriskoj';
...
$GLOBALS["lang"]['Hindi'] = 'La situazione';
...
$GLOBALS["lang"]['host'] = 'Gastiganizzazione Nom de la ville (facultatif, sans doute pas besoin de traduction)';
...
$GLOBALS["lang"]['How Long Does it Take'] = 'Prenas di Kiom lowe';

$GLOBALS["lang"]['How and Why is'] = 'Kiel kaj kial estas';

$GLOBALS["lang"]['How and Why is Open-AudIT More Secure'] = 'Kiel kaj kial estas Audit aperto Pli Sekura';
...
$GLOBALS["lang"]['How the vulnerability is exploited (e.g., Network, Adjacent, Local, Physical).'] = 'Kiel la vundebleco estas ekspluatita (ekz., Reto, Amministrazione, Lokulo, Fizika).';
...
$GLOBALS["lang"]['hyperthreading'] = 'Hüperlõi';
...
$GLOBALS["lang"]['id'] = 'Tunnide';

$GLOBALS["lang"]['ID'] = 'ID';

$GLOBALS["lang"]['IF'] = 'SI';

$GLOBALS["lang"]['IMPORTANT'] = 'OBIETTIVO';
...
$GLOBALS["lang"]['IP Addresses'] = 'Adresoi IP';
...
$GLOBALS["lang"]['id_number'] = 'Tunnistè';

$GLOBALS["lang"]['Id Number'] = 'Tunnistè';
...
$GLOBALS["lang"]['Identify key stakeholders and assign roles'] = 'Idegu esencajn preoccupazioneatojn kaj disegni rolojn';

$GLOBALS["lang"]['Identify the device(s) that are your exemplary, or <i>gold image</i> you want to compare similar devices against.'] = 'Idegu la aparaton (j) kiuj estas via modela, kaptlus <i>Bilancia</i> Vi vola kompari simparajn aparatojn kontrayn.';

$GLOBALS["lang"]['Identifying and evaluating security risks'] = 'Identigado kaj analizado de sekurecriskoi';

$GLOBALS["lang"]['If'] = 'Se';

$GLOBALS["lang"]['If a device is individually discovered using the <i>Discover Device</i> link on the device details page, we first check if this device has been discovered previously (by Discovery) and if so, use the discovery options from that scan. If it has not been previously discovered, we revert to the configuration item discovery_default_scan_option the settings.'] = 'Se aparato estas injalue malkovrita uzante la <i>Dispositivo di Malkovru</i> ligo sur la aparato detalpa fluido, ni unue kontrolas se tiu aparato estis malkovrita anta guide (de Discovery) kaj se tien, uzas la eltrova.o opciojn de tia skanado. Se εi ne estis anta.e malkovrita, ni revenas al konfiguracio objecttotrova.o _ deva...';
...
$GLOBALS["lang"]['If any of these (comma seperated, no spaces) ports are detected, assume SSH is running on them and use them for auditing. No need to add this port to the Custom TCP ports - it will be added automatically.'] = 'Se iu el tiiuj (komma seeteraj, neniuj spacoj) hasnoj estas detektitititaj, supozas SSH kuris sur ilin kaj uzas ilin por reviziado. Neniu bezono aldoni tiun hasnon al la Custom TCP- havenoj - εi estos aldonita a limittomate.';

$GLOBALS["lang"]['If no operator is specified, the default is =. Properties should be fully qualified - ie, devices.hostname (not just hostname).'] = 'Se neniu funkciigisto estas prezigita, la deva... Trajtoj devus esti plène kvalifikitaj - insegnare, aparatoj. Petefenyimi (ne ';

$GLOBALS["lang"]['If no value is present, supply this value. EG: for system.nmis_group / configuraion.group we use'] = 'Se neniu Valoro... Estas... EG: por sistemo.nmis _ gruppo / konfiguraion. Grupo kiun ni uzas';
...
$GLOBALS["lang"]['If the following conditions are met:<br><ul><li>a Role has an assigned ad_group</li><li>an Org has an assigned ad_group</li><li>an LDAP Server has use_roles set to y</li><li>a user exists in LDAP (be it Active Directory or OpenLDAP) and is in the assigned ad_groups</li></ul>That user can log on to Open-AudIT without an account in Open-AudIT needing to be created. Open-AudIT will query the LDAP in question and if the user is in the required groups but not in Open-AudIT, their user attributes (name, full name, email,  roles, orgs, etc) within Open-AudIT will be automatically populated and they will be logged on.<br> <br>'] = 'Se la sekvaj kontircaoj estas rencontitaj:<br/><ul><li>Rolo havas asignitaan ad _ gruppo</li><li>Groupe ad _ ad _ d "Org hava asignitaan</li><li>LDAP Servilo havas la uzon de yroles</li><li>Uzanto eksistas en LDAP (estu... i Aktiva Adresaro a epäillyt OpenLDAP) kaj estas en la asignita ad _ grupoj.</li></ul>Tiu uzanto povas ensaluti al Open- Audit sen raporto en Open- Audit- bezono esti kreita. Open- Audit requeste la LDAP riguarda kaj se la uzanto estas en la postulataj grupoj sed ne en Open- Audit, iliaj uzant atinattoj (nomo, plena nomo, retpo registrato, roloj, orgoj, ktp.) ene de Open- Audit estos a skeptomate lo.<br/> <br/>';
...
$GLOBALS["lang"]['If you are having issues with Google Maps API keys or your company does not have access to create Google Maps API keys, please contact the FirstWave support team.'] = 'Se vi havas problemojn kun Google Maps API рlosiloj media ffirmao ne havas alron krei Google Maps AP- divertalosilojn, bonvolu kontakki la FirstWave subtenseamon.';
...
$GLOBALS["lang"]['If you are on a decent broadband or ethernet connection, I would recommend always using -T4 (Aggressive). Some people love -T5 (Insane) though it is too aggressive for my taste. People sometimes specify -T2 (Polite) because they think it is less likely to crash hosts or because they consider themselves to be polite in general. They often do not realize just how slow -T2 really is. Their scan may take ten times longer than a default scan. Machine crashes and bandwidth problems are rare with the default timing options -T3 (Normal) and so I normally recommend that for cautious scanners. Omitting version detection is far more effective than playing with timing values at reducing these problems.'] = 'Se vi estas sur deka gradidabendo a difetto etero ligo, mi remomendus Čiam uzi T4 (Agres). Kelkaj homoj amas - T5 (Insane) kvankam liquiciulici estos tro concordasema por mia gusto. Homoj foje prezigas Ili overse ne ekkomprenas ekzakte kiom malladrapa - T2 vere estas. Ilia skanado povas preni dek fojojn pli lowe ol deva guidlta skanado. Ma apretinkra apretoj kaj bendolarεproblemooj estas raraj kun la dea guidtlataj tempigelektoj - T3 (normaalne) kaj tien mi normale rekomendastion por singardaj skaniloj. Uzanta versio detekto estas multe pli efika ol ludado kun tempigvaloroj Reduktado de tiauj problemoj.';
...
$GLOBALS["lang"]['Ignored'] = 'Non lo so.';

$GLOBALS["lang"]['image'] = 'Bildo';

$GLOBALS["lang"]['Image'] = 'Bildo';

$GLOBALS["lang"]['Images'] = 'Bildo';
...
$GLOBALS["lang"]['Implement selected controls and procedures'] = 'Kontroli elektitajn kontrolojn';
...
$GLOBALS["lang"]['Import'] = 'Tuo padre';

$GLOBALS["lang"]['Import Example Data'] = 'Datario di Gravaj';
...
$GLOBALS["lang"]['In my personal opinion, the best way to find and audit every single item on your network is a Seed Discovery for each subnet, restricted to that subnet (using credentials). Seed Discoveries use switch, router and computer MAC Address tables to not miss a single device. If it is connected to the network and uses TCP/IP, a switch/router/computer has to know it is there - thats just how TCP/IP works. Combine that with custom TCP and/or UDP ports and you should then be able to determine the device type as well. But thats just my personal preference'] = 'En mia persona opinio, la plei bona maniero trovato kaj revizii Seemmned Discoveries uzas ð антельна, italon kaj komputil MAC direttocción tablojn por ne maltrafi ununuran aparaton. Sei consiglio estasligita al reto kaj uzas TCP / IP, grialtilo / router / komputio des sci ke εi estas tie Kombinuation kun kutimo TCP kaj / a. Sed tio estas nur mia persona prefero';

$GLOBALS["lang"]['In order for Open-AudIT to be able to apply user permissions on items, we mandate the user of <code>WHERE @filter</code>. If you do not use this format, the queryCreateForm will throw a warning. Only users with the Admin role are permitted to create queries that lack this attribute and even then, only after the configuration item for <i>advanced_queries</i> has been enabled.'] = 'Por Open- Aud IT povi apliki uzantpermesojn sur eroy, ni postulas la uzanton de <code>WHERE @filter</code>. Se vi ne uzas tiun forman, la questione Forma... Nur uzantoj kun la Admino estas licaj krei demandeojn kiuj mankas tiu atantia a kaj e lluvia tiam nur post la konfiguracioobjekto <i>öntsük le a borítékot</i> Becslések szerint ebligita.';

$GLOBALS["lang"]['In order to enable Google Maps you will need to a Google API Key follow this link and log in with your Google account,'] = 'Google Maps vi bezonos API Google ';
...
$GLOBALS["lang"]['In the (comma seperated) list'] = 'En la (komma conseratud) Elenco';

$GLOBALS["lang"]['In the case of <code>in</code> and <code>notin</code>, you should enclose the values in round brackets and separate them using a comma (just a comma, not a comma, then space).<br><br>With these operators you can filter quite comprehensively.<br><br>When you add data and filter on multiple columns, those columns are combined using <strong>AND</strong>. You cannot filter using an <strong>OR</strong> condition. With the inclusion of <code>notin</code>, you should be able to get most searches working. And for those that do really require unsupported and complex selections, you can always write an actual query.'] = '# En la kazo de <code>in</code> Kaj <code>notin</code>Vi devus fermo la valorojn en rondaj krampoj kaj apartigi ili uzante komon (nur komo, ne komo, tiam spaco).<br/><br/>Kun tiau funkciigistoj vi povas filti tre amplekse.<br/><br/>Kiam vi aldonas datenojn kaj instalilon sur multoblaj kolonoj, tiaj kolonoj estas Kombintaj uzante <strong>Kaj Kaj</strong>. L\'Unione européenne <strong>a</strong> C\'è Kandičo. Kun la inkludo <code>notin</code>L\'objectif est de faire en sorte que l\'ense de la people soit en mesure d\'attecindre ses objectifs. Kaj por tiauj kiuj vere postulas nepruvitajn kaj kompleksajn selektadojn, vi Čiam povas skribi faktan atendon.';

$GLOBALS["lang"]['In the case where we store several fields (usually in JSON format) inside a BIGTEXT MySQL field (eg: credentials.credentials - the credentials column in the credentials table), you should use the format'] = 'En la kazo kie ni stokas plurajn kampjn (kutime en JSON formaat) ene de BIGTExT MySQL kampo (ekz. akredita.oj). La mia vita';
...
$GLOBALS["lang"]['Install OpenScap if required'] = 'Instali Scap se natasterites';
...
$GLOBALS["lang"]['instance_tags'] = 'Gruppo asiatico';

$GLOBALS["lang"]['Instance Tags'] = 'Gruppo asiatico';

$GLOBALS["lang"]['instance_type'] = 'Tipo di seconda';

$GLOBALS["lang"]['Instance Type'] = 'Tipo di seconda';
...
$GLOBALS["lang"]['integrations_log'] = 'Italiaprovincia. descrizione unità nelle liste';

$GLOBALS["lang"]['Integrations Log'] = 'Italiaprovincia. descrizione unità nelle liste';
...
$GLOBALS["lang"]['interface_id'] = 'Criteri di Identificación Interviza';

$GLOBALS["lang"]['Interface ID'] = 'Criteri di Identificación Interviza';

$GLOBALS["lang"]['interface_type'] = 'Lidi tipo';

$GLOBALS["lang"]['Interface Type'] = 'Lidi tipo';

$GLOBALS["lang"]['Internal'] = 'Interna Interna';

$GLOBALS["lang"]['Internal Audit'] = 'Auditeur internazionale';
...
$GLOBALS["lang"]['Internal JSON array of valid access tokens for this user.'] = 'Interna JSON aro de valida aliro ';

$GLOBALS["lang"]['Introduction'] = 'Enkonduko';

$GLOBALS["lang"]['invoice'] = 'La moda';
...
$GLOBALS["lang"]['ip_address_internal_a'] = 'Direzione generale dell\'Ambiente';

$GLOBALS["lang"]['Ip Address Internal A'] = 'Direzione generale dell\'Ambiente';

$GLOBALS["lang"]['ip_address_internal_b'] = 'Nemzetközi szervezetek B';

$GLOBALS["lang"]['Ip Address Internal B'] = 'Nemzetközi szervezetek B';

$GLOBALS["lang"]['ip_all_count'] = 'Ip Kaikki luv.';

$GLOBALS["lang"]['Ip All Count'] = 'Ip Kaikki luv.';
...
$GLOBALS["lang"]['Is this account active? If set to <code>n</code>, the user cannot logon.'] = '? Te Sientes Aktiva? Se vi meti <code>n</code>La uzanto ne povas logon.';
...
$GLOBALS["lang"]['Italian'] = 'Itália. descrizione unità nelle liste';
...
$GLOBALS["lang"]['Japanese'] = 'Japon Japano';
...
$GLOBALS["lang"]['LDAP Group'] = 'LDAPiù gruppò';
...
$GLOBALS["lang"]['last_changed'] = 'La lasta';

$GLOBALS["lang"]['Last Changed'] = 'La lasta';

$GLOBALS["lang"]['last_finished'] = 'Las Vegas';

$GLOBALS["lang"]['Last Finished'] = 'Las Vegas';
...
$GLOBALS["lang"]['last_os_update'] = 'Ultima Realización de Os';

$GLOBALS["lang"]['Last Os Update'] = 'Ultima Realización de Os';
...
$GLOBALS["lang"]['last_seen_by'] = 'Condividi su Facebook Antalucita';

$GLOBALS["lang"]['Last Seen By'] = 'Condividi su Facebook Antalucita';

$GLOBALS["lang"]['last_user'] = 'Uzanto';

$GLOBALS["lang"]['Last User'] = 'Uzanto';

$GLOBALS["lang"]['Last up is WMI. For Windows as in Linux, a user with Administrator level access is preferred (see Target Client Configuration on the wiki).'] = 'La lada estas WMI. Por Fenestroj kiel en Linukso, uzanto kun amministrazionento nivelaliro estas preferito (vidu Target Customer Configuration sur la Vikio).';

$GLOBALS["lang"]['lastModified'] = 'Viimati mudetuo';
...
$GLOBALS["lang"]['Learn About'] = 'Las Vegas';

$GLOBALS["lang"]['Learn More'] = 'Lanci su';
...
$GLOBALS["lang"]['Less Than'] = 'Malpì';

$GLOBALS["lang"]['Less Than or Equals'] = 'Malpli sur kahtlus egala';
...
$GLOBALS["lang"]['Level of privileges needed to exploit (None, Low, High).'] = 'Nivelo de adattaacionj necesaj por ekspluati (puudub, madal, kõrge).';

$GLOBALS["lang"]['Liberia'] = 'Libertà';
...
$GLOBALS["lang"]['Like most other attributes, Additional Fields can be bulk edited. Use the Bulk Edit function as you normally would and you will see the Additional Fields are available for input.'] = 'Kiel la pléj indennitàj alfaj atemploj, ylimääräistä Champs povas esti groca redactis. Uzu la Bulk Edit- funkcion kiam vi normale faris kaj vidos la aggiuntive Fields estas hasblaj por eniga.';
...
$GLOBALS["lang"]['Line charts must return date or my_date, description or my_description and count.'] = 'Linio kiun furorlisto murtaa simile daton kaptlus I _ data, prikribon kaptluse mispriskribon kaj kalkulon.';

$GLOBALS["lang"]['link'] = 'Ligilo';
...
$GLOBALS["lang"]['Linux Packages'] = 'Linukso';

$GLOBALS["lang"]['List'] = 'Elenco delle liste';
...
$GLOBALS["lang"]['List Devices'] = 'Elenco di aparatoi';

$GLOBALS["lang"]['List Discoveries'] = 'Elenco di malkovroj';

$GLOBALS["lang"]['list_table_format'] = 'Elenco di Formato de Tabla';

$GLOBALS["lang"]['List Table Format'] = 'Elenco di Formato de Tabla';

$GLOBALS["lang"]['List Tables'] = 'Elenco dei tabeloj';
...
$GLOBALS["lang"]['log'] = 'Rekisters';

$GLOBALS["lang"]['Log'] = 'Rekisters';

$GLOBALS["lang"]['log_format'] = 'Esercitazioni';

$GLOBALS["lang"]['Log Format'] = 'Esercitazioni';
...
$GLOBALS["lang"]['log_status'] = 'Rekisters';

$GLOBALS["lang"]['Log Status'] = 'Rekisters';
...
$GLOBALS["lang"]['Luxembourg'] = 'Luksemburgo';
...
$GLOBALS["lang"]['Manage Licenses'] = 'Mondial. descrizione unità nelle liste';
...
$GLOBALS["lang"]['Match'] = 'Partido partido';
...
$GLOBALS["lang"]['Mauritania'] = 'Kahtlustajani';
...
$GLOBALS["lang"]['members'] = 'Membro della Commissione';
...
$GLOBALS["lang"]['meta_last_changed'] = 'La lasta';

$GLOBALS["lang"]['Meta Last Changed'] = 'La lasta';
...
$GLOBALS["lang"]['Metropolitan area network'] = 'Metropolivena areoreto';
...
$GLOBALS["lang"]['Modified'] = 'Modifitari';
...
$GLOBALS["lang"]['More Information'] = 'Informazioni su Pliaj';

$GLOBALS["lang"]['More Secure'] = 'Pli sekura';

$GLOBALS["lang"]['More elaborate SQL can used to group attributes within a range. Below shows the SQL for devices not seen in a pie chart grouped by last seen date ranges.'] = 'Pli kompleksa SQL povas esti uzita por grupigi atperiojn ene de intervallo. Malsupre montre la SQL por aparatoj ne vidite en piirakka kaavio grupigita per latte viditaj datointervaloj.';

$GLOBALS["lang"]['More information about debugging this can be found on a helpful Stack Overflow thread'] = 'Pli da informaoj pri malkonstruado de tio povas esti trovaretaj sur helpema Korstna ülevoolu fadeno';

$GLOBALS["lang"]['Morocco'] = 'Maroko';

$GLOBALS["lang"]['Most likely the Windows firewall (or a third party firewall) is denying the connection attempt.<br><br>Please log on to the target Windows machine and check the firewall settings.'] = 'Plej ver seppne la Fenestroj (a...<br/><br/>Bonvolu ensaluti al celo Windows ma apretino kaj kontroli la fajromuro agordojn.';
...
$GLOBALS["lang"]['Mozambique'] = 'Mosambico';

$GLOBALS["lang"]['Must Respond To Ping. If set, Nmap will fist attempt to send and listen for an ICMP response. If the device does not respond, no further scanning will occur.<br>Previously a device did not have to respond to a ping for Open-AudIT to continue scanning.'] = 'Ni tuhoa reaktion al Ping. Se aro, Nmap Pugnoprovos senti kaj a shortsapti por ICMP- risposta. Se la aparato ne responseas, neniu plu skanado okazos.<br/>Anta';

$GLOBALS["lang"]['Must Respond to Ping'] = 'Repons';
...
$GLOBALS["lang"]['NMIS Device Selection'] = 'Sélección de dispositivi NMIS';

$GLOBALS["lang"]['NMIS Field Name'] = 'NMI Nombre de campo';
...
$GLOBALS["lang"]['NOTE - For more info on DateTime formats, see'] = 'NOTO - Por pli da informatoj pri Datenttempo formaj, Vidas';
...
$GLOBALS["lang"]['net_index'] = 'Indice';

$GLOBALS["lang"]['Net Index'] = 'Indice';

$GLOBALS["lang"]['Netherlands Antilles'] = 'Paesi Bassi';
...
$GLOBALS["lang"]['New Floor Name'] = 'Nimi de Nova';

$GLOBALS["lang"]['New Room Name'] = 'Nova imitazione';

$GLOBALS["lang"]['New Row Name'] = 'Novità';
...
$GLOBALS["lang"]['Next, click OK, then right click the Apache 2.4 service and click Restart. Done!'] = 'Venonta, klaki OK, tiam dekstra klakas la apa planeo 2.4 servo kaj klak Redémarrer. C\'è Dono!';
...
$GLOBALS["lang"]['nmis_business_service'] = 'Servizi aux entreprises de Nmis';

$GLOBALS["lang"]['Nmis Business Service'] = 'Servizi aux entreprises de Nmis';
...
$GLOBALS["lang"]['No Devices Returned'] = 'Neniu cerchio revenis';
...
$GLOBALS["lang"]['No Results'] = 'Negativo';
...
$GLOBALS["lang"]['Norfolk Island'] = 'Norfolkina';
...
$GLOBALS["lang"]['Not Equals'] = 'Ne egala';
...
$GLOBALS["lang"]['November'] = 'Novembro Novembro';
...
$GLOBALS["lang"]['OUTPUTS'] = 'TULEMUS';

$GLOBALS["lang"]['oae_manage'] = 'Oae Gerer';

$GLOBALS["lang"]['Oae Manage'] = 'Oae Gerer';

$GLOBALS["lang"]['object_ident'] = 'Objektoj Identificazione';

$GLOBALS["lang"]['Object Ident'] = 'Objektoj Identificazione';

$GLOBALS["lang"]['Obtain top management support'] = 'Obtenga la direttiva administrativa subteno';
...
$GLOBALS["lang"]['On the top right (underneath the menu bar) you will see several buttons. These allow you to select another dashboard, set the current dashboard as your homepage (if it is not already) and edit the current dashboard (if you have permission).'] = 'Sur la sopra dekstra (sub la menuolinkejo) vidos plurajn butonojn. Tiuj permesas al vi selekti alphin da aprettabulon, metis la nunan armatuurlaud kiel via hejmpa armato (se licensili ne estas jam) kaj redakki la nunan da ejerciciotabulon (se vi havas perminon).';
...
$GLOBALS["lang"]['Once you have chosen your devices to edit, click the pencil button on the top right of the table.'] = 'Poste kiam vi elektis viajn aparatojn redakki, klaki la krajonon sur la sopra rajto de la tabla.';
...
$GLOBALS["lang"]['One of either <code>active directory</code> or <code>openldap</code>.'] = 'Un\'altra volta. <code>active directory</code> a <code>openldap</code>.';
...
$GLOBALS["lang"]['Open-AudIT Professional. The world\\'] = 'Profesional de Open- Audit. Il mondo estas';
...
$GLOBALS["lang"]['Open-AudIT can use Microsoft Entra (previously known as Microsoft Azure Active Directory) as an authentication method. This means your user in Open-AudIT can click the Logon using Entra button on the logon page and use their Entra credentials to logon. That user will need to already exist within Open-AudIT (and be assigned'] = 'Apri- Audit povas uzi Microsoft Entra (anta... konata kiel Microsoft Azure Aktiva Adresaro) kiel a guidikmetodo. Tio signfas vian uzanton en Open- Audit povas klaki la Logon uzantan Entra buton sur la logon pacomingo kaj uzi iliajn Entra akredita. Tiu uzanto murtaa jam eksisti ene de Open- Audit (kaj eti asignita)';
...
$GLOBALS["lang"]['Open-AudIT comes with many queries inbuilt. If you require a specific query and none of the pre-packaged queries fit your needs, it is quite easy to create a new one and load it into Open-AudIT for running.'] = 'Open- Aud IT venas kun indennitàj richiestaoj enconruitaj. Se vi postulas specifan atendon kaj neniu el la anta...';
...
$GLOBALS["lang"]['Open-AudIT has a powerful change detection engine. Any device attributes that are added, removed or changed will be detected and stored. These changes can be reported upon and the relevant data confirmed as to what was expected from your company change and release process.<br><br>When a device is audited, attributes are divided into sections which correspond to tables in the database.<br><br>Each device (computer, router, printer, et al) has an entry in the <code>devices</code> table. Each entry in the devices table has an <code>id</code> column. This value is unique - it is an auto-incrementing id.<br><br>When the audit result is processed, each item in each section has its audit result compared to what is in the database.<br><br>For each section, if the key columns (see below table) contain the identical values, it is considered already installed and has its <code>last_seen</code> attribute updated. No change_log entry is created.<br><br>If any of the key columns do not match, it is considered a new attribute and is inserted. A <code>change_log</code> entry is created if the device had other attributes already present in the table.<br><br>At the completion of the audit processing, any database items that have not been updated (or inserted) are considered to not be present. The <code>current</code> attribute for this item is set to <i>n</i> and a change_log entry is generated.<br><br>So, we can determine if something is currently installed - the current column is <i>y</i>.<br><br>We can determine when something was initially detected - the <i>first_seen</i>.<br><br>We can determine if something was installed after the initial audit - first seen will be different in the component and device tables.<br><br>We can determine if something is not currently installed, but previously was - current = <i>n</i>.<br><br>We can determine the last time we detected an item - last_seen.<br><br>At any given point, we can determine what was on a system - by using the audit_log table and selecting the relevant components based on first_seen and last_seen.<br><br>Each section and its matching key columns are below.<br><br>NOTE - There are some exceptions as detailed below.<br><br>*1 - For network cards, if the computer is a VMware Esx machine it also uses the net_index and connection columns.<br><br>*2 - For partitions, f the computer is an AIX machine, we use the partition name.'] = 'Ava- Aud.i havas commercan шанном un detektomotoron. [...] Tiuj sur kaj la medifaj datenoj konfirmitaj kiel al kio estis atendita de via firmao explakanaεo kaj eldonprocezo.<br/><br/>Kiam aparato estas reviziita, atregultoj estas distitaj en sekciojn kiuj egalrilatas al tabloj en la datumbazo.<br/><br/> aparato (komputio, tiineranto, printilo, et al) havas eniron en la <code>devices</code> Tablo. Mezcla en la tablo de aparatoj havas <code>id</code> Kolono. Tiu Valoro estas unika - εi estas a skepto-inklina id.<br/><br/>Kiam la reviziorezulto estas prilaborita Sekcio havas sian reviziorezulton komparte kun kio estas en la datumbazo.<br/><br/>Porno <code>last_seen</code> Actif à εisdatigita. Neniu griteno estas kreita.<br/><br/>Se ette de la esencaj kolonoj ne egalas, εi estas konsiderita nova atigita a kaj estas enigita. A.A. <code>change_log</code> eniro estas kreita se la aparato havis alpijn atrophojn jam nunaj en la tabelo.<br/><br/>Alternativae la kompletigo de la reviziopretigo La <code>current</code> Atributo por titu objektto estas atinacita al <i>n</i> Ranso estas generita.<br/><br/>Tiel, ni povas determini <i>Oui.</i>.<br/><br/>Ni povas determi kiam io estis komence detektita - la <i>La vita</i>.<br/><br/>Ni povas determini <br/><br/>Ni povas determini Roveru io ne estas nuntempe secretita, sed anta guide estis... <i>n</i>.<br/><br/>Ni povas determi lastan fojon kiam ni detektis objectkton - lastan.<br/><br/>Iu anta.fiksita punkto, ni povas determi ki estis sur sistemo. utiligante la revizoran tablon kaj selektante la medifajn kompontojn bazitaj sur uua _ visto kaj ultimo _ vidn.<br/><br/> Imitaiu sekcio kaj... jaj egalaj esencaj kolonoj estas malsupre.<br/><br/>Eksistas kelkaj esceptoj kiel detalaj malsupre.<br/><br/>. 1 - Por sendostaciaj kartoj, se la komputio estas VMware Esx- marajeino εi ankareazas la tt _ index kajligokolonojn.<br/><br/>2 ';

$GLOBALS["lang"]['Open-AudIT is a program designed to track and report on your IT and related assets details and configuration. Open-AudIT can tell \"What\\'] = 'Open- Aud IT estas programma dizajnita por prindi kaj rastori pri via IT kaj rilataj aktiva.oj detaloj kaj konfiguracio. Ouvrir- Audit povas diri "Kio"';
...
$GLOBALS["lang"]['Open-AudIT should be installed on 64bit Windows <strong>Server</strong> systems only. Windows 10 and Windows 11 are <strong>not</strong> supported.'] = 'Open- Audit devus esti instalia sur 64b Fenestroj <strong>Servizio</strong> Nur sistemoj. Windows 10 kaj Vindozo 11 estas <strong>Oui.</strong> Apogis.';

$GLOBALS["lang"]['Open-AudIT uses Nmap in its Discovery function. Nmap probes devices for open ports. Devices ideally should respond with open for working ports. Devices often do not respond with this. The varying responses are detailed below.'] = 'Apri- Audit Uzas Nmap en Žia Discopy- funkcio. Nmap sondid aparatoj por malfermaj hasnoj. Destinivos idéale devus responsi kun malferma por laborhavenoj. Il s \'agit d\' une réaction de type al tio. La réponseoj estas detalaj malsupre.';

$GLOBALS["lang"]['Open-AudIT uses Nmap in its Discovery function. Without Nmap, Open-AudIT will not function correctly. Every Open-AudIT install assumes Nmap is installed and will also test for it on the Discovery web pages. More information about Open-AudIT and Nmap is available here'] = 'Apri- Audit Uzas Nmap en Žia Discopy- funkcio. Sen Nmap, Audit ne funkcios εuste. Alternativaiu Open- Audit- secreta.o supozas Nmap estas secretita kaj ankai tetos por εi sur la Discovery retpa fapoj. Pli da informatooj pri Open- Audit kaj Nmap nämä havblaj clari huulet';

$GLOBALS["lang"]['Open-AudIT uses Nmap in its Discovery function. Without Nmap, Open-AudIT will not function correctly. Every Open-AudIT install assumes Nmap is installed and will test for it on the Discovery web pages.'] = 'Apri- Audit Uzas Nmap en Žia Discopy- funkcio. Sen Nmap, Audit ne funkcios εuste. Alternatituiu Open- Audit- secreta.o supozas Nmap estas secretita kaj tetos por εi sur la Discovery retpaγoj.';
...
$GLOBALS["lang"]['Optional Agent Based Auditing'] = 'Auditoría de Opcia agente Bazita';
...
$GLOBALS["lang"]['Organisations can extend and enhance the level of detail that is stored against every discovered device using custom fields and the open core allows for easy integration into CMDB, event management and ticketing systems.'] = 'Organizoj povas etendi kaj plifottigi la nivelon detalo kiu estas stokita kontra Il y a aussi un size nombre d\'établissements et de centers d\'enseignement.';

$GLOBALS["lang"]['orgs'] = 'Orgoglio';

$GLOBALS["lang"]['Orgs'] = 'Orgoglio';

$GLOBALS["lang"]['Orgs Name'] = 'Orgs nomo';

$GLOBALS["lang"]['Orgs in Open-AudIT are a key item. A user has a primary Org as well as a list of Orgs they can access. A user combines this with a list of assigned roles that define what actions they can take on items assigned to the Orgs they have access to. The combination of a users <i>orgs</i> and <i>roles</i> define what they can and cannot do within Open-AudIT.<br><br>Most items in Open-AudIT are assigned to an Org. Devices, Locations, Networks, etc, etc.<br><br>Orgs can have child Orgs. Think of an organisational chart (tree) structure. If a user has access to a specific Org, most of the time (not always) they also have access to that Orgs descendants.'] = 'Orgs en Open- Audit estas esenca objectko. Uzantoj havas primaran Org mismo kiel Lister de Orgas kiun ili povas aliri. Uzanto Kombinastion kun lista de asignitaj roloj kiuj difinas kiujn fajn ili povas akcepti erojn asignitaj al la Orgs kiujn ili havas aliro al. La kobina <i>Orgoglio</i> Kaj <i>Les</i> difinas kion ili povas kaj ne povas fari ene de Open- Audit.<br/><br/>La plej indennitàj eroj en Open- Audit estas asignitaj al Org. Dispositivos, Lokoj, Retoj, ktp.<br/><br/>Orgoj povas havi Infanon Orgs. Pensu pri organiza kaavio (arbo) strukturo. Se uzanto havas al specifa Org, la plei granda parto de la tempo (ne...) ili ankai havas al tiu Orgs posteuloj.';
...
$GLOBALS["lang"]['os_license_code'] = 'Código de licenza de Os';

$GLOBALS["lang"]['Os License Code'] = 'Código de licenza de Os';
...
$GLOBALS["lang"]['Overall severity score (0–10).'] = 'Yheens';
...
$GLOBALS["lang"]['POSTing data'] = 'Voce principale:';
...
$GLOBALS["lang"]['Packages are used to report on things such as <i>banned software</i>, AntiVirus on servers, etc.<br><br>Open-AudIT provides widgets that build upon also supplied repots to detemine the status of antivirus, firewall and other software.'] = 'Paka <i>Programma di Malpermesita</i>AntiVirus sur serviloj, ktp.<br/><br/>Open- Aud IT diszponigas widgets kiuj koronuas sur anka...';
...
$GLOBALS["lang"]['Parameters'] = 'Parametro';
...
$GLOBALS["lang"]['permissions'] = 'Permeso';
...
$GLOBALS["lang"]['Personal area network'] = 'Személy';

$GLOBALS["lang"]['Peru'] = 'Pérou';

$GLOBALS["lang"]['Philippines'] = 'Filippinoj Filippinoj Filippinoj Filippinoj';

$GLOBALS["lang"]['phone'] = 'Telefonare';

$GLOBALS["lang"]['Phone'] = 'Telefonare';

$GLOBALS["lang"]['Physical CPUs'] = 'Fizika CPUs';
...
$GLOBALS["lang"]['Pie charts must return name or my_name, description or my_description and count.'] = 'Tuhoa pié- furorlisto Rendeni Nomonin. Epäiltyni sur Prescribon.';
...
$GLOBALS["lang"]['Plan and conduct internal audits'] = 'Condividi su Facebook Internazionale';
...
$GLOBALS["lang"]['Please log in and change these ASAP.'] = 'Bonvolu ensaluti kaj шan stabilizzasici tiaujn au plus vite.';
...
$GLOBALS["lang"]['ports_in_order'] = 'Condividi su Facebook';

$GLOBALS["lang"]['Ports In Order'] = 'Condividi su Facebook';

$GLOBALS["lang"]['ports_stop_after'] = 'Portasin pysähdyspaika';

$GLOBALS["lang"]['Ports Stop After'] = 'Portasin pysähdyspaika';

$GLOBALS["lang"]['Portugal, Portuguese Republic'] = 'Portogallo, portougala respubliko';
...
$GLOBALS["lang"]['Post-Certification'] = 'Segreteria di Stato';

$GLOBALS["lang"]['postcode'] = 'Poggtkodo';

$GLOBALS["lang"]['Postcode'] = 'Poggtkodo';

$GLOBALS["lang"]['power_circuit'] = 'Potenzia';

$GLOBALS["lang"]['Power Circuit'] = 'Potenzia';

$GLOBALS["lang"]['power_sockets'] = 'Potenco';

$GLOBALS["lang"]['Power Sockets'] = 'Potenco';

$GLOBALS["lang"]['Predictable'] = 'Anta...';

$GLOBALS["lang"]['Preferences'] = 'Pref.';

$GLOBALS["lang"]['Prepare for recertification every 3 years'] = 'Préparatio';

$GLOBALS["lang"]['Prerequisites'] = 'Fratture';
...
$GLOBALS["lang"]['printer_port_name'] = 'Nombre de puerto de impressionzionnión';

$GLOBALS["lang"]['Printer Port Name'] = 'Nombre de puerto de impressionzionnión';
...
$GLOBALS["lang"]['Privacy Protocol'] = 'Protocollo';

$GLOBALS["lang"]['privileges_required'] = 'Privilegioj domanda';

$GLOBALS["lang"]['Privileges Required'] = 'Privilegioj domanda';
...
$GLOBALS["lang"]['Processors'] = 'La vita';
...
$GLOBALS["lang"]['program'] = 'Oh.';

$GLOBALS["lang"]['Program'] = 'Oh.';

$GLOBALS["lang"]['Properties'] = 'Trajto';

$GLOBALS["lang"]['Proprietary. If you want to modify HighCharts you may require a'] = 'Propietario. Se vi vola modifi Altajn Katajn vi povas postuli';
...
$GLOBALS["lang"]['published_date'] = 'Condividi su Twitter';

$GLOBALS["lang"]['Published Date'] = 'Condividi su Twitter';
...
$GLOBALS["lang"]['purchase_order'] = 'Ačeti odontoiatria';

$GLOBALS["lang"]['Purchase Order'] = 'Ačeti odontoiatria';
...
$GLOBALS["lang"]['Query this Active Directory attribute first to determine the users work unit.'] = 'Aktiva Adresaro unue assistues al uzantoj laborunuon.';

$GLOBALS["lang"]['Query this Active Directory attribute second to determine the users work unit.'] = 'Aktiva Adresaro atracias sekundon por determini la uzantojn laborunuon.';
...
$GLOBALS["lang"]['Queued Device Audits'] = 'Auditorías de dispositivi en espera';

$GLOBALS["lang"]['Queued IP Scans'] = 'Eskaneos IP puestos en consulta';
...
$GLOBALS["lang"]['rack_id'] = 'Numero d\'identificazione';

$GLOBALS["lang"]['Rack ID'] = 'Numero d\'identificazione';
...
$GLOBALS["lang"]['Rejected'] = 'Rejekcita';

$GLOBALS["lang"]['rel'] = 'Reili';

$GLOBALS["lang"]['Rel'] = 'Reili';

$GLOBALS["lang"]['Release'] = 'Libertà';

$GLOBALS["lang"]['remediation'] = 'Reparzione';
...
$GLOBALS["lang"]['Repeat until you have a completely discovered and audited Windows PC.'] = 'Ripetu εis vi havas tute malkovritan kaj reviziitan PC Windows.';
...
$GLOBALS["lang"]['Request Method'] = 'Metodo di Peta';

$GLOBALS["lang"]['Request Vulnerability'] = 'Petu haavatavus';

$GLOBALS["lang"]['Request a Specific CVE'] = 'CREAZIONE';
...
$GLOBALS["lang"]['Reset'] = 'Taasta l\'hashtestami';

$GLOBALS["lang"]['Reset All Data'] = 'Anstata skeptigi Da non perdere';
...
$GLOBALS["lang"]['Resources'] = 'Resursocon.';
...
$GLOBALS["lang"]['Restore my Licenses'] = 'Regime del personale';

$GLOBALS["lang"]['Restrict to Private'] = 'Restrikto al privato';

$GLOBALS["lang"]['Restrict to Subnet'] = 'Restrikko al Subnet';

$GLOBALS["lang"]['result'] = 'RISULTATI';
...
$GLOBALS["lang"]['Retrieve the first 10 devices running Windows ordered by hostname'] = 'Récupérer la unuaj 10 aparato prizorgantaj Fenestrojn ordonitaj to mastro- nomo';
...
$GLOBALS["lang"]['retrieved'] = 'Presenza';

$GLOBALS["lang"]['Retrieved'] = 'Presenza';

$GLOBALS["lang"]['retrieved_ident'] = 'Tunnide';

$GLOBALS["lang"]['Retrieved Ident'] = 'Tunnide';

$GLOBALS["lang"]['retrieved_name'] = 'Prenita nomo';

$GLOBALS["lang"]['Retrieved Name'] = 'Prenita nomo';

$GLOBALS["lang"]['Retrieved from the device - Windows:Win32_ComputerSystemProduct, Linux:dmidecode, MacOS:system_profiler, ESXi:vim-cmd hostsvc/hostsummary, HP-UX:machinfo, Solaris:smbios, AIX:uname.'] = 'Prenite de la aparato - Fenestroj: Win32 _ ComputerSystemProduit, Linukso: dmidecode MacOS: sistema _ profilar, ESXi: vim- cmd gastigantojvc / hostsummery, HP- UX: machinfo, Solaris: smbios, AIX: uname.';

$GLOBALS["lang"]['Retrieving a List of Credentials'] = 'Recherche Liste de Verification de Poderes';

$GLOBALS["lang"]['Retrieving or Creating'] = 'Rekuperaator a Keado';
...
$GLOBALS["lang"]['risk_assesment_result'] = 'Risultato della valutazione';

$GLOBALS["lang"]['Risk Assesment Result'] = 'Risultato della valutazione';
...
$GLOBALS["lang"]['Roles can only be created and edited if you have an Open-AudIT Enterprise license. For most users, the default set of Roles should be all that is required.'] = 'Roloj povas nur esti kreitaj kaj redaktitaj se vi havas licenza Open- Audit Enterprise. La deva guidlta aro de Roloj devus esti Čiu kiu estas postulata.';

$GLOBALS["lang"]['Romania'] = 'Rumanio';

$GLOBALS["lang"]['Romanian'] = 'Rumana romana';

$GLOBALS["lang"]['Room'] = 'Tunnista';
...
$GLOBALS["lang"]['Saudi Arabia'] = 'Saoud-Arabia';

$GLOBALS["lang"]['Save and run the file. Make sure you run the file as an Administrator in order to install it (right click, Run as Administrator).'] = 'Savi Kaj Prizorgi la dosiron. Certigu che vi prizorgas la dosieron kiel administrateur por instali liquidin (deksstra klako, Run kiel administrateur).';
...
$GLOBALS["lang"]['Scheduling - discovery, reporting &amp; more'] = 'Programma - Eltrova';
...
$GLOBALS["lang"]['script_timeout'] = 'Premio Antalutsiit de la tempo';

$GLOBALS["lang"]['Script Timeout'] = 'Premio Antalutsiit de la tempo';
...
$GLOBALS["lang"]['Search'] = 'Serve';

$GLOBALS["lang"]['Search For a Device'] = 'Serès';

$GLOBALS["lang"]['Searching Using DataTables'] = 'Serrugante Uzante etmenetrend';
...
$GLOBALS["lang"]['Select All'] = 'Elektu Governo';
...
$GLOBALS["lang"]['Select the <i>Sign On</i> tab and copy the value for <i>Issuer</i> (just the URL itself). Paste this into the Open-AudIT <i>Issuer</i> field.'] = 'Elektu <i>Segnale sur</i> Alklaku kaj kopii la Valon por <i>Parodiste</i> (La URL mem). En la malferma- Audit <i>Parodiste</i> C\'e\' Kampo.';

$GLOBALS["lang"]['Select the <i>This Account</i> checkbox and provide the account name and password.'] = 'Elektu <i>Firma</i> Kontrou skatolo kaj suppezas la konto nomo kaj pasvorton.';
...
$GLOBALS["lang"]['sensitivity'] = 'Sensibile';
...
$GLOBALS["lang"]['series'] = 'Serio di serio';

$GLOBALS["lang"]['Series'] = 'Serio di serio';

$GLOBALS["lang"]['server'] = 'Servizio';
...
$GLOBALS["lang"]['Server Is'] = 'Servizi';

$GLOBALS["lang"]['server_item'] = 'Tema Servilo';

$GLOBALS["lang"]['Server Item'] = 'Tema Servilo';

$GLOBALS["lang"]['Server Status'] = 'Servizio';

$GLOBALS["lang"]['Servers'] = 'Servizi';

$GLOBALS["lang"]['Servers Only'] = 'Informazioni generali';
...
$GLOBALS["lang"]['service_network'] = 'Voce principale:';

$GLOBALS["lang"]['Service Network'] = 'Voce principale:';
...
$GLOBALS["lang"]['service_type'] = 'Servono Tipo';

$GLOBALS["lang"]['Service Type'] = 'Servono Tipo';
...
$GLOBALS["lang"]['Set by the audit_domain or discover_domain scripts. Do not set.'] = 'Metite tariffa de la revizoro épäilty malkovri _ domain manikriptoj. Ne metu.';
...
$GLOBALS["lang"]['Seychelles'] = 'Segnalazioni';
...
$GLOBALS["lang"]['shared'] = 'Denominazione';
...
$GLOBALS["lang"]['Shipped are a set of default items. These can be found by going to menu'] = 'Laevatud estas aro decha. Tiuj povas esti trovaretaj irante al menu';
...
$GLOBALS["lang"]['Should this file (or pattern) be used to exclude files from being reported. Normally, to audit files, this is set to <code>y</code>.'] = 'Se tiu dosiero (un... padrono) kutimas ekskludi dosierojn de esti raportita. Normale, por a guiddi dosierojn, tio estas atinacita al <code>y</code>.';
...
$GLOBALS["lang"]['Should we hide the audit script window when executing.'] = 'Se ni ka agnu la a scetticatorian fanestronikiam oni ekzekutas.';
...
$GLOBALS["lang"]['Should we match a device based mac address even if its a known likely duplicate from VMware.'] = 'Se ni egalas aparaton bazitán makan adreson e. se εia konata rivelacna duplikato de VMware.';
...
$GLOBALS["lang"]['Should we ping the IP before attempting to scan it? If it does not respond to the ping, skip this device.'] = '? Te Sientes Mal? Il n \'y a pas de réaction en ce qui riguarda le ping, le transsaltu tiunn aparato.';
...
$GLOBALS["lang"]['Should we retrieve all DNS names'] = 'Ni prenu Governanceujn';
...
$GLOBALS["lang"]['Should we use the win32_product WMI class (not recommended by Microsoft) when retrieving installed software.'] = 'Se ni uzus la venkon32 _ prodotto WMI klaso (ne remomendite tariffe de Mikrosofto) dum prenado de secretita softvaro.';
...
$GLOBALS["lang"]['Site A'] = 'Condividi su Facebook';

$GLOBALS["lang"]['Site B'] = 'Rete';
...
$GLOBALS["lang"]['Slovenian'] = 'La Slovanea';

$GLOBALS["lang"]['Smart Status'] = 'Esecuzione del processo';
...
$GLOBALS["lang"]['snmp_enterprise_id'] = 'Numero d\'identificazione';

$GLOBALS["lang"]['Snmp Enterprise ID'] = 'Numero d\'identificazione';

$GLOBALS["lang"]['snmp_enterprise_name'] = 'Nom de l\'entreprise Snmp';

$GLOBALS["lang"]['Snmp Enterprise Name'] = 'Nom de l\'entreprise Snmp';

$GLOBALS["lang"]['snmp_oid'] = 'Oid S';

$GLOBALS["lang"]['Snmp Oid'] = 'Oid S';

$GLOBALS["lang"]['snmp_timeout'] = 'Snmp aikakatkaisu';

$GLOBALS["lang"]['Snmp Timeout'] = 'Snmp aikakatkaisu';

$GLOBALS["lang"]['snmp_version'] = 'Versione Snmp';

$GLOBALS["lang"]['Snmp Version'] = 'Versione Snmp';

$GLOBALS["lang"]['So a script is not working on a recalcitrant device. Grrr. The scripts for Windows, Linux, and MacOS all accept the debugging argument. This can be set in the script itself, or provided on the command line. Run the script using that option set to 5 and you should see in which section of the script the failure occurs. For example'] = 'Tiel kézműves ne laboras pri rekalsitant aparato. La kézműves por Fenestroj, Linukso, kaj MacOS Čiuj akceptas la malkonstruan argomentoon. Tio povas esti metita en la kézműves mem, epäilty disponigita sur la komandlinio. Run la manikripto uzanta tiun opcion metian al 5 kaj vi devus vidi en kiu sekcio de la manikripto kiun la fiasko okazas. Ekzample';
...
$GLOBALS["lang"]['Software Found Last 7 Days'] = 'Programma di recherche la 7';

$GLOBALS["lang"]['Software Found Today'] = 'Hodia';

$GLOBALS["lang"]['Software Found Yesterday'] = 'La programmazione Trovis hiera';
...
$GLOBALS["lang"]['Solomon Islands'] = 'Salomonoi';

$GLOBALS["lang"]['Somalia, Somali Republic'] = 'somalio, soma reguliko';

$GLOBALS["lang"]['Some collections can be executed - queries, etc - see below.'] = 'Kelkaj kolektoj povas esti efektivititaj - esigeoj, ktp - Vidas malsupre.';
...
$GLOBALS["lang"]['Some other error has occurred when attempting to bind to the LDAP server. It is contactable (ie, the <i>connect</i> above has worked), but for some other reason, binding has not occurred. Check the logs on the LDAP server.'] = 'Iu alias eraro okazis dum provado ligi al la LDAP- servilo. i estas kontaktebla (mi, la) <i>Lizazi</i> Supre laboris, sed pro iu alias kialo, ligado ne okazis. Kontrou la tagalojn sur la LDAP servilo.';

$GLOBALS["lang"]['Something has gone seriously wrong. Open-AudIT cannot read the <i>orgs</i> table.'] = 'Io fu apretado es serio. Audit ouvert ne povas legi la <i>Orgoglio</i> Tablo.';
...
$GLOBALS["lang"]['South Georgia and the South Sandwich Islands'] = 'Suda Kartelio kaj la Suda Sandvi offerteuloj';
...
$GLOBALS["lang"]['speed_up_a'] = 'Rapido supren la aavistus la';

$GLOBALS["lang"]['Speed Up A'] = 'Rapido supren la aavistus la';
...
$GLOBALS["lang"]['Stage 1: Documentation review'] = 'Tunnista 1: Dokumenta revizio';

$GLOBALS["lang"]['Stage 2: Implementation and effectiveness review'] = 'Scène 2: Efektivigo kaj efikecrevizio';
...
$GLOBALS["lang"]['sub_resource_id'] = 'Numero d\'identificazione Suba Rimedo';

$GLOBALS["lang"]['Sub Resource ID'] = 'Numero d\'identificazione Suba Rimedo';

$GLOBALS["lang"]['sub_type'] = 'Subtipo';

$GLOBALS["lang"]['Sub Type'] = 'Subtipo';

$GLOBALS["lang"]['subject_key_ident'] = 'Sous...';

$GLOBALS["lang"]['Subject Key Ident'] = 'Sous...';
...
$GLOBALS["lang"]['Summaries take the same arguments as Queries.'] = 'Kokkuvõte prenas la samajn argomentaojn kiel Päringud.';
...
$GLOBALS["lang"]['Tajikistan'] = 'Taficiali';

$GLOBALS["lang"]['Take note of all output and action each item as appropriate.'] = 'Prénu not the ';
...
$GLOBALS["lang"]['Test 1'] = '1 Saggio 1';
...
$GLOBALS["lang"]['test_os'] = 'Testo';

$GLOBALS["lang"]['Test Os'] = 'Testo';

$GLOBALS["lang"]['test_subnet'] = 'Testo del testo';

$GLOBALS["lang"]['Test Subnet'] = 'Testo del testo';

$GLOBALS["lang"]['tests'] = 'Testo';

$GLOBALS["lang"]['Tests'] = 'Testo';

$GLOBALS["lang"]['Text'] = 'Teksto Teksto';

$GLOBALS["lang"]['Thai'] = 'Tajlandworld. kg';
...
$GLOBALS["lang"]['The <i>Roles</i> endpoint allows you to manage the set of permissions(Create, Read, Update, Delete) that are granted to the users and are applied to each endpoint.'] = 'La mia <i>Roloj</i> Endpoint permesas al vi amministrazione la aron de permesoj (Loo, loe, uuenda, kustuta) kiuj estas konceditaj al la uzantoj kaj estas aplikitaj al claru finpunkto.';
...
$GLOBALS["lang"]['The Discovery Scan Options we ship are detailed in the table below. As above, Enterprise users can create more of these or edit the shipped items.'] = 'La Discovery Skandalo Opcioj, kiujn ni havas, estas depalaj en la tello malsupre. Kiel supre, Enterprise Uzantoj povas krei pli de tiauj medio redakki la ekspeditajn erojn.';

$GLOBALS["lang"]['The Elevated User query'] = 'Kőrgendatud kasutajapäring';

$GLOBALS["lang"]['The Executables feature scans the disk of a device as part of the audit and checks that every executable file is known to the package manager. Because it uses the package manager, the feature applies to Linux target devices only, and further than that, only rpm or deb based distributions. Anything Redhat or Debian based should work.'] = 'La Exécutables havas la disquete de aparato kiel parto de la revizio kaj... Per ulteriori informazioni, rivolgersi a: Kio ajn Redhat a. Debian bazigis devus labori.';

$GLOBALS["lang"]['The FROM'] = 'La mia';
...
$GLOBALS["lang"]['The ID from the devices table (the devices.name will be displayed) of the NTU at this end of the connection. Links to <code>devices.id</code>.'] = 'La ID de la paratoj tablo (la aparatoj). Nomo estos elmontrita de la NTU Che tiu fino de la ligo. Ligiloj al <code>devices.id</code>.';

$GLOBALS["lang"]['The ID from the imported benchmark policy.'] = 'La ID de la precisioneta komparnormo politiko.';
...
$GLOBALS["lang"]['The ID of this orgs parent org. Linked to <code>orgs.id</code>'] = 'La ID de tiu orgepatro org. Ali / 1993 / i <code>orgs.id</code>';
...
$GLOBALS["lang"]['The NVD assigned base status.'] = 'La NVD firma bazstatuson.';
...
$GLOBALS["lang"]['The OS this package should be reported against. Blank for all. Use the percent sign % as a wildcard. Will be tested against os_group, os_family and os_name in that order.'] = 'La OS tiu paka.o devus esti raportita kontra épäilty. Pour Oni uzas la rean modon (AS- finajxon). Estos presente Kontra stide os _ gruppo, os _ familio kaj ostnomo en tiu pesekvo.';
...
$GLOBALS["lang"]['The SNMP v3 Privacy Passphrase.'] = 'La SNMP v3 Passfrase privato.';
...
$GLOBALS["lang"]['The SQL cannot contain <strong>WHERE @filter OR</strong>. That SQL will not be executed, however <strong>WHERE @filter AND</strong> queries are allowed.'] = 'La SQL ne povas enhavi <strong>Tunnista</strong>. Ke SQL ne estos ekzekutita, tamen <strong>Saluto [esprimas al vi] - [iu persono, kiu persono need] Blazio.</strong> les condizioni de vie et de travail.';

$GLOBALS["lang"]['The SQL queries used in Open-AudIT require the use of the backtick - ` character and NOT the standard single quote for fields. On most US Windows keyboards the backtick key is located in the top-left of the keyboard along with the tilde ~. On a US Mac keyboard the backtick key is located next to the SHIFT key. The standard single quote is still used to enclose values as the examples below illustrate.'] = 'La SQL- demandoj uzitaj en Open- Audit postulas la uzon de la backtick - karaktero kaj NE la norma unununura cita. La plej questionej usonaj Fenestroj klavaroj la backtick calosilo situazioni en la pint- maldekstro de la klavaro kune la tilde. Sur US Mac klavaro la backtick calosilo situazione come pléj preksime al la Shift- seplosilo. La norma ununura cita';
...
$GLOBALS["lang"]['The User endpoint allows you to manage user accounts within Open-AudIT.'] = 'La Uzanta finpunkto permesas al vi rightr uzantkontojn ene de Open- Audit.';

$GLOBALS["lang"]['The WHERE'] = 'La Čielo estas';

$GLOBALS["lang"]['The WHERE section of your SQL <em>must</em> contain'] = 'La sekcio de via SQL <em>Devas</em> Inhava';

$GLOBALS["lang"]['The Windows'] = 'La guerra';
...
$GLOBALS["lang"]['The attribute to test (from the <code>devices</code> table).'] = 'Il contributo al testo (de la) <code>devices</code> Tablo.';

$GLOBALS["lang"]['The attribute to test (must match an external field name from below).'] = 'La atention a al testo (devas egali eksteran kampan nomon de malsupre).';

$GLOBALS["lang"]['The attributes for discovery scan options are as below.'] = 'Il contributo di eltrova';

$GLOBALS["lang"]['The audit script upon which to base your customisations.'] = 'La revizio manikripto sur kiu bazigi viajn special fluidojn.';
...
$GLOBALS["lang"]['The credentials supplied by the user have failed.'] = 'La akredita...';
...
$GLOBALS["lang"]['The current date in Y-m-d format.'] = 'La nuna dato in formato Y- m- d.';
...
$GLOBALS["lang"]['The date this item was changed or added (read only). NOTE - This is the timestamp from the server.'] = 'La data tiu objectto estis дальна Tio estas la tempostapo de la servilo.';
...
$GLOBALS["lang"]['The debug level (will output to command prompt window). Lower means less output with 0 being no output.'] = 'La debug nivelo (volas kommundi prostan fanestroni). Pli malta signfas malpli prodotto.';
...
$GLOBALS["lang"]['The foreign table to reference. Should be one of: devices, locations, orgs or queries.'] = 'La francese tablo al referenco. Estu unu el: aparatoj, lokoj, orkoj a requideoj.';

$GLOBALS["lang"]['The format of your data should be in the form'] = 'La formattazione della viaj datumoj brunces esti en la formo';

$GLOBALS["lang"]['The format used for the output to be emailed.'] = 'La forma uzita por la produzione';
...
$GLOBALS["lang"]['The group that provides a list of devices for the integration. Links to <code>groups.id</code>.'] = 'La Grupo kiu disponi Lisn de aparatoj por la integri <code>groups.id</code>.';
...
$GLOBALS["lang"]['The internal value, reformatted in this format.'] = 'La International Valoro, riformaita en tiu formaat.';
...
$GLOBALS["lang"]['The line number assigned by the provider to the line at this end of the connection.'] = 'Lionombro asignita tariffe de la produezanto al la linio -Tiu fino de la ligo.';

$GLOBALS["lang"]['The location the rack is located in. Links to <code>locations.id</code>.'] = 'La loko kiun la rako situazione fr. Ligiloj al <code>locations.id</code>.';
...
$GLOBALS["lang"]['The locations suite.'] = 'La serie de lokoj.';
...
$GLOBALS["lang"]['The minute of the hour when this task should execute (* for every minute).'] = 'La minuto de la horo kiam tiu tapo devus efektivigi (* por urbaniu).';
...
$GLOBALS["lang"]['The new Agent runs a PowerShell version of the old audit script in preparation for the depreciation of VBScript (yes, it is coming).'] = 'La nova agento prizorgas Poder Shell versione de la malnova reviziomanuskripto en preparo por la malpreco de VBScript (je, ';
...
$GLOBALS["lang"]['The number of critical severity vulnerabilities held by FirstWave (not in your database).'] = 'La nombro da kritikaj firmacoj tenitaj tariffa de FirstWave (ne en via datumbazo).';
...
$GLOBALS["lang"]['The number of high severity vulnerabilities held by FirstWave (not in your database).'] = 'La nombro daalta fairco vundeblecoj tenitaj tariffa de FirstWave (ne en via datumbazo).';

$GLOBALS["lang"]['The number of low severity vulnerabilities held by FirstWave (not in your database).'] = 'La nombro da malta ghiaia vundeblej tenitaj tariffa de FirstWave (ne en via datumbazo).';

$GLOBALS["lang"]['The number of medium severity vulnerabilities held by FirstWave (not in your database).'] = 'La nombro da mezaj firmacoj tenitaj tariffa de FirstWave (ne en via datumbazo).';
...
$GLOBALS["lang"]['The path to the file or directory. Directories should end with a trailing slash.'] = 'La vojo al la dosiero a. dosierujo. Direktoroj murtaa finitai kun migrovojo.';

$GLOBALS["lang"]['The physical depth (in CMs) of the rack.'] = 'La fizika profundo (en CM) de la rako.';

$GLOBALS["lang"]['The physical height (in CMs) of the rack.'] = 'La fizika aliteco (en CM) de la rako.';
...
$GLOBALS["lang"]['The purpose of this licensing page is to list the products and licenses included in Firstwave Commercial products including products based upon open source works.Open-AudIT is licensed from Firstwave under AGPLv3 or later with Enterprise and Professional functionality licensed under commercial terms.Open-AudIT when downloaded from FirstWave may include the following libraries and projects, which are supplied unmodified and licensed as indicated:'] = 'La celo de tiu licencadpa graduateo breacs listigi la produktojn kaj licencojn inkluditaj en Firstwave Commercial- produktoj inkluzive de produktoj bazitaj sur malfermfontecverkoj. Open- Audit estas licencita de Firstwave sub AGPLv3 un rispetto poste kun Enterprise kaj Profesia funkcieco licencita sub komercaj esprimej. Open- Audit kiam el apretutite de FirstWave povas inkludi la sekvajn bibliotekojn kaj projektojn, kiuj estas maksataj nemodifita kaj licencita kiel indikite:';

$GLOBALS["lang"]['The query that provides a list of devices for the integration. Links to <code>queries.id</code>.'] = 'La aendo kiu disponigas Figyelj de aparatoj por la integri / 1993 / o Ligiloj al <code>queries.id</code>.';
...
$GLOBALS["lang"]['The search for group on the LDAP server failed. Check the LDAP server logs. Have you created these groups (for roles and orgs) on the LDAP server and assigned LDAP users to them?'] = 'La ser orientalilada por grupo sur la LDAP- servilo malsukcesis. Kontrou la LDAP- servilregistrojn. imitazione del kreis tiujn grupojn (por roloj kaj orkoj) sur la LDAP- servilo kaj asignis LDAP- uzantojn al ili?';
...
$GLOBALS["lang"]['The software end-of-life date.'] = 'La programmazione fino de viva dato.';

$GLOBALS["lang"]['The software end-of-service-life date.'] = 'La programmazione fino de servo viva dato.';
...
$GLOBALS["lang"]['The steps below outline the process.'] = 'La apparenza атитов sub skizas la procezon.';
...
$GLOBALS["lang"]['The total BTU output by this rack.'] = 'La totala BTU- prodotto.o de tiu rako.';
...
$GLOBALS["lang"]['The unfiltered state means that a port is accessible, but Nmap is unable to determine whether it is open or closed. Only the ACK scan, which is used to map firewall rulesets, classifies ports into this state. Scanning unfiltered ports with other scan types such as Window scan, SYN scan, or FIN scan, may help resolve whether the port is open.'] = 'La neperorita gritato signfas ke hasno estas alirebla, sed Nmap estas nekapabla determi -Estas malferma katlus fermota. Nur la ACK- skanado, kiu kutimas mapi fajromurajn reguletojn, klasifikas hasnojn en tiun quirestaton. Scanante nefilitajn hasnojn kun alfaj malabundaj tipoj kiel ekzample Fenestra skanado, SYN- skanado, katlus FIN- skanado, povas helpi solvi U la Havenno estas malferma.';
...
$GLOBALS["lang"]['The user that was specified exists in LDAP, but Open-AudIT is not configured to consume the LDAP groups for roles and that user does not exist within Open-AudIT. Either select <i>Use LDAP for Roles</i> on the Open-AudIT LDAP Server screen or create this user within Open-AudIT and assign roles and orgs.'] = 'La uzanto kiu estis prezigita eksistas en LDAP, sed Open- Audit ne estas formita por konsumi la LDAP- grupojn por roloj kaj tiu uzanto ne ekzistas ene de Open- Audit. Kaphlususelekti <i>Uzu LDAP su Roloj</i> Sur la Open AudIT LDAP Servilkrano epäilty krei tien uzanton ene de Open- AudIT kaj alisignas rolojn kaj orgs.';
...
$GLOBALS["lang"]['The width of this device.'] = 'Larεo de tiu.';
...
$GLOBALS["lang"]['Then you can use Open-AudIT (unsupported) to receive audit data directly from the clients. Discovery <strong>will fail</strong>, but if youre not using Discovery (the main feature Open-AudIT was designed around), you can still get device data. You would need to run the audit scripts directly on the clients using cron, or use the Windows Agent feature (Enterprise only).'] = 'Tiam vi povas uzi Open- Audit (nepruvita) por rizvi reviziodatenojn rekte de la klientoj. Decuverte <strong>malsukcesos</strong>, sed se vi ne uzas Discovery (la Vi devus prizorgi la reviziomanuskriptojn rekte sur la klientoj uzantaj Kronon, a. uzi la Windows Agent trajton (Enterprizo nur).';
...
$GLOBALS["lang"]['There is no need to do anything if you are running Open-AudIT on a Linux server.<br><br>Windows clients are just fine and require no special actions, however.... to enable this feature the audit script must be run locally on the target Windows system. It cannot be run remotely as we do with WMI calls when running the audit script on one Windows machine, while targeting a second Windows machine. To do this we need to copy the audit script to the target Windows machine and then run it. Unfortunately the service account that Apache runs under is the Local System account. This account has no access to remote (network based) resources. To work around this issue the service must be run under another account. It is easiest to just use the local Administrator account, but you can try any account you like as long as it has the required privileges. The Local System account has as much local access as the local Administrator account.'] = 'Eksistas neniu bezono farenda.o io ajn se vi prizorgas Open- Audit sur Linukso- servilo.<br/><br/>Fenestroj estas justaj kaj postulas neniujn specialajn agojn, aliflanke... rajtigi tiun trajton la reviziomanuskripto provises et prizorgita loke sur la cel Windows- sistemon. Por farition ni murs kopii la reviziomanuskripton al la celo Windows- ma agotadono kaj tiam prizorgi εin. Beda auditrinde la servikonto ke apa planekuroj sub estas la Local System- konto. Tiu raporto havas neniun aliron al malpreksimaj (reto bazita) resursoj. Por labori... irka epäilty tiu temo la servo brunces esti prizorgita sublison. Estas plej facile uzi la lokan Administrateur konton, sed vi povas providation ajnan raporton vi kiel lowe kiel εi havas la postulatajn saltjn. La Loka Sistemo- konto havas tien multe da loka aliro kiel la loka Administramento - koto.';

$GLOBALS["lang"]['These are only examples. You may need to adjust these attributes to suit your particular LDAP.'] = 'Tiuj estas nur ekzemoj. LDAP est un program d\'éducation et de formation pour les jeunes.';

$GLOBALS["lang"]['These parameters enable you to audit only what is useful and relevant to you, saving processing time and allowing you to discover your network in an orderly manner.'] = 'Tiuj insegnamento ebligas al vi revizii nur kio estas utila kaj inspecfa al vi, шparante pretigtempon kaj permesante al vi malkovri vin reton en bonorda maniero.';
...
$GLOBALS["lang"]['This example creates a list of devices and the open Ports, Protocols, and Programs found by the NMAP scan.'] = 'Tiu ekzemplo kreas Listn de aparatoj kaj la malfermaj Havenoj, Protokolaj, kaj Progmoj Trotaj per la NMAP-skanado.';
...
$GLOBALS["lang"]['This example query retrieves a list of devices OVER 3 years old. The query uses today'] = 'Tiu ekzemplo kysely prenas listan de aparatoj sur 3 jerga a ritmoaj. La richiesta hodia guzas';
...
$GLOBALS["lang"]['This item must match the value of the attribute selected.'] = 'Tiu objekto murtaa egali la Valon de la atentia a selektita.';

$GLOBALS["lang"]['This license expires on'] = 'Alternativai tiiu permesilo liquido finito';
...
$GLOBALS["lang"]['This should be set to either 1 or the height of the rack.'] = 'Tio devus esti metita al';

$GLOBALS["lang"]['This should be the fully qualified field name in the database. Currently columns from the system, fields and credentials tables are supported. EG: system.nmis_role.'] = 'Tio devus esti la tute kvalifikita kampa nomo en la datumbazo. Nuntempe kolonoj de la simemo, kamopj kaj akredita. Oj estas apogitaj. EG: sistemo.nmis _ ruolo.';

$GLOBALS["lang"]['This state is used when Nmap is unable to determine whether a port is closed or filtered. It is only used for the IP ID idle scan.'] = 'Tiu шgestas uzita kiam Nmap estas nekapabla determi Ei estas fermota a Kahtlusfilita. Estas nur uzita por la IP ID joutokäynti- skanado.';
...
$GLOBALS["lang"]['This will permanently DELETE this license.'] = ' imitazione di te - Oui.';

$GLOBALS["lang"]['This will show you the Bulk Edit form. Any attributes you set on this form will be applied to all selected devices. You can set multiple attributes at once.'] = 'Tio montros al vi la Bulk Editer- formuleron. Il s \'agit de l\'ensemble de l\' Union européenne.';

$GLOBALS["lang"]['Thursday'] = 'Káposztafélés';

$GLOBALS["lang"]['time_caption'] = 'Tempo pealdis';

$GLOBALS["lang"]['Time Caption'] = 'Tempo pealdis';

$GLOBALS["lang"]['time_daylight'] = 'Il tempo del tempo';

$GLOBALS["lang"]['Time Daylight'] = 'Il tempo del tempo';

$GLOBALS["lang"]['Time to Execute'] = 'Il tempo';

$GLOBALS["lang"]['timeout'] = 'Tempo';

$GLOBALS["lang"]['Timeout'] = 'Tempo';

$GLOBALS["lang"]['Timeout Per Target (Seconds)'] = 'Aegumine sihtm';

$GLOBALS["lang"]['Timeout per Target. Wait for X seconds for a target response.'] = 'Tempo per Celo. Atendu X sekundojn por celo.';

$GLOBALS["lang"]['Timesatamp'] = 'Prémipitário';

$GLOBALS["lang"]['Timestamp'] = 'Il tempo';
...
$GLOBALS["lang"]['To actually execute the query, append a /execute, thus /open-audit/index.php/queries/{$id}/execute.'] = 'Por fakte efektivigi la richiesta, apendigas / ececute, tien / malfermi- audit / index. php / query / {id} / eksecute.';
...
$GLOBALS["lang"]['To execute the Windows powershell script, open a command prompt as Administrator and use the following command'] = 'Por efektivigi la Fenestrojn, malfermi komand quistilon kiel amministrazionento kaj uzi la sekvan kommundon';
...
$GLOBALS["lang"]['To filter by a property value, use the property name. Operators that should precede the value are'] = 'Por filti per domvaloro, uzi la domnomon. Operaioj kiuj devus anta.i la valoron estas';
...
$GLOBALS["lang"]['To make the change, just follow the steps below.'] = 'Por fori la шенуn нений, nur sekku la pa apretojn malsupre.';
...
$GLOBALS["lang"]['Turks and Caicos Islands'] = 'Turco kaj Caïque Commerloj';
...
$GLOBALS["lang"]['Type: This can be either a varchar (a text field) or a List (a list of values that can be selected).'] = 'Tipo: Tio povas esti a scettico varchar (tekstokampo) uno scettico Listo (listo de valoroj kiuj povas et selektititaj).';
...
$GLOBALS["lang"]['Undergoing Analysis'] = 'Subiranta analizzo';

$GLOBALS["lang"]['Unfiltered'] = 'Néperhita';

$GLOBALS["lang"]['uninstall'] = 'Destinazione';
...
$GLOBALS["lang"]['United States Minor Outlying Islands'] = 'Utilizzo di Malgrandaj Commerloj';

$GLOBALS["lang"]['United States Virgin Islands'] = 'Utilizzo di Virgulininsulaj';

$GLOBALS["lang"]['United States of America'] = 'Norvège';

$GLOBALS["lang"]['Unknown'] = 'Nekonatao Nekonata';
...
$GLOBALS["lang"]['Update'] = 'C\'è la première fois qu\' il s \'agit de';
...
$GLOBALS["lang"]['Update an attribute of a {collection} entry.'] = 'Isdatigu attribuzione de eniro.';
...
$GLOBALS["lang"]['Updated each time discovery has been executed with IPs that have been scanned by Nmap.'] = 'C\'e\' il prix de Nmap.';
...
$GLOBALS["lang"]['Updating'] = ' Esaminare la situazione';
...
$GLOBALS["lang"]['Use Service Version Detection. When a detected port is detected as open, if set to <i>y</i>, Nmap will query the target device in an attempt to determine the version of the service running on this port.<br>This can be useful when identifying unclassified devices. This was not previously used.'] = 'Uzu versión de la versio. Kiam detektita hasno estas detektita kiel malferma, se metite al <i>Oui.</i>Nmap request la celaparato en promo determi la versione de la servo kuranta sur tiun hasnon.<br/>Tio povas esti utila kiam identigami nesekretajn aparatojn. Tio ne estis anta... uzata.';

$GLOBALS["lang"]['Use WMI'] = 'Uzu WMI';

$GLOBALS["lang"]['Use a <i>Sign-in method</i> of OIDC - OpenID Connect and an <i>Application Type</i> of Web Application. Click <i>Next</i>.'] = 'Uzu la <i>Metodoosi sisselogimi</i> OIDC - OpenID Konektu kaj <i>Apliki tipon</i> Helyszín Web d\'mentségek. Klakou al Click <i>La Sekva</i>.';

$GLOBALS["lang"]['Use for Authentication'] = 'Uzo per Autentimiini';

$GLOBALS["lang"]['Use for Roles'] = 'Uzo por roloj';

$GLOBALS["lang"]['Use the standard install options when displayed and click the <i>I Agree</i>, <i>Next</i> and <i>Install</i> buttons to install Nmap.'] = 'Uzu la normajn installjn opciojn kiam montrite kaj klakas la <i>Mi agras</i>♪ <i>La Sekva</i> Kaj <i>Instalgio</i> Butonoj por instali Nmap.';
...
$GLOBALS["lang"]['Used by OpenLDAP only.'] = 'Uzita tariffa de OpenLDAP nur.';

$GLOBALS["lang"]['Used internally when discovering a single device.'] = 'Uzita interna dum malkovrado de ununura aparatito.';

$GLOBALS["lang"]['Used internally when discovering a single device. Links to <code>devices.id</code>.'] = 'Uzita interna dum malkovrado de ununura aparatito. Ligiloj al <code>devices.id</code>.';

$GLOBALS["lang"]['Used when LDAP servers have been configured to populate a users details - this includes the Orgs to which they have access. If a user is in this LDAP group, they are assigned this org.'] = 'Uzita kiam LDAP- serviloj estis formitaj por popolariigi uzantdetalojn - tio inkludas la Orgs al kiuj ili havas alron. LDAP- grupo, ili rivas tiun org.';

$GLOBALS["lang"]['Used when LDAP servers have been configured to populate a users details - this includes the Roles which they are assigned. If a user is in this LDAP group, they are assigned this role.'] = 'Uzita kiam LDAP- serviloj estis formitaj por popolariigi uzantdetalojn -tio inkludas la rolojn kiujn ili rizvas. Se uzanto estas en tiu LDAP- grupo, ili rivas tiun rolon.';

$GLOBALS["lang"]['Used when searching OpenLDAP to match a users uid to a groups members. Default of <code>memberUid</code>. Used by OpenLDAP only.'] = 'Uzita dum ser revelado Programma OpenLDAP por egali uzantojn kojn al grupoj membroj. Defa deutlto de <code>memberUid</code>. Uzita tariffa de OpenLDAP nur.';
...
$GLOBALS["lang"]['User Membership Attribute'] = 'Afrique. descrizione unità nelle liste';
...
$GLOBALS["lang"]['Usually should be set to 3.'] = 'Kutime oni tuhoa doni al 3.';
...
$GLOBALS["lang"]['valid_from'] = 'Val Gardena';

$GLOBALS["lang"]['Valid From'] = 'Val Gardena';

$GLOBALS["lang"]['valid_from_raw'] = 'Anta skeptite tariffe de Raw';

$GLOBALS["lang"]['Valid From Raw'] = 'Anta skeptite tariffe de Raw';

$GLOBALS["lang"]['valid_to'] = 'Condividi su Facebook';

$GLOBALS["lang"]['Valid To'] = 'Condividi su Facebook';

$GLOBALS["lang"]['valid_to_raw'] = 'Valida al crudo';

$GLOBALS["lang"]['Valid To Raw'] = 'Valida al crudo';

$GLOBALS["lang"]['Valid Values'] = 'Validità';
...
$GLOBALS["lang"]['Values: In the case of a <i>list</i> field, this should be a comma separated list of valid values.'] = 'Bonjour. # It la kazo # <i>Elenco delle liste</i> Kampo, tio devus esti komm apartigita lista de validaj valoroj.';
...
$GLOBALS["lang"]['variable'] = 'Variante Varia';

$GLOBALS["lang"]['Variable'] = 'Variante Varia';

$GLOBALS["lang"]['Various'] = 'Diversai';
...
$GLOBALS["lang"]['vendors'] = 'Vendristo';

$GLOBALS["lang"]['Vendors'] = 'Vendristo';

$GLOBALS["lang"]['Venezuela'] = 'Condividi su Twitter';

$GLOBALS["lang"]['Version'] = 'Versio versi';

$GLOBALS["lang"]['version_padded'] = 'Versio pehmusttu';

$GLOBALS["lang"]['Version Padded'] = 'Versio pehmusttu';
...
$GLOBALS["lang"]['Vietnamese'] = 'Vjetnama vjetnamanos';

$GLOBALS["lang"]['View'] = 'Vido';

$GLOBALS["lang"]['View All'] = 'Riikardi Governo';
...
$GLOBALS["lang"]['vm_vendor'] = 'C\'è una cosa da dire,';

$GLOBALS["lang"]['Vm Vendor'] = 'C\'è una cosa da dire,';
...
$GLOBALS["lang"]['vulnerabilities_cache'] = 'Vulnerabilidati';

$GLOBALS["lang"]['Vulnerabilities Cache'] = 'Vulnerabilidati';

$GLOBALS["lang"]['Vulnerabilities and Results'] = 'Vulnercoj kaj rezultoj';

$GLOBALS["lang"]['Vulnerabilities initially published before 1st January, 2025 (by default). We see no sense in returning vulnerabilities from years prior. This can be changed in the configuration.'] = 'Vulnerabilidades komence publikigis antaitis 1 tammikuuro 2025 (defa.lte). Ni Vidas neniun sencon en resendado de vundundblecoj de jaroj prio. Tio povas esti шеннимita en la konfiguracio.';
...
$GLOBALS["lang"]['We also have an option to Ping Before Scan (important for routers with long lived ARP caches). This is usually a good idea.'] = 'C\'e\' piu\' vrai. Tio estas kutime bona ideo.';

$GLOBALS["lang"]['We also have our action items (which are executed in the order below):'] = 'C\'e\' piu\' vrai.';

$GLOBALS["lang"]['We are often asked this question and the answer most definitely is <i>it depends</i>. It depends on the number of IPs to be scanned, the network connection speed, the speed of the devices being scanned, the type of devices being scanned, the number of different credentials being tested and the speed of the Open-AudIT server. We do not have a calculator that would allow us to input those variables and return a value. It is simply too complex. Generally I limit my discoveries to 256 IP addresses - ie, a /24 subnet. We have had customers scan /16 subnets (65k addresses) and it does work - but it can take a long time. You are much better off scanning in /24 blocks. If you simply do not know what your address ranges are, then this is a good case for a Seed discovery.'] = 'Ni oarte domanda di rilancio kaj la reaktiono pléj sendube estas <i>Sôltlane</i>. Tämä asetus sur kaikilta osiltaan velvoittava, ja sitä sovelletaan sellaenaan kaikissa jäsenvaltioissa. Ni ne havas kalkulilon kiu permesus al ni enigi tiujn variablojn kaj rendi valoron. Estas Tro kompleksa. Ni havis klientojn skani / 16 subretojn (65k adresoj) kaj εi funkcias - sed εi povas preni longan tempon. Il s \'agit d\' un programma di formazione à l\'intendation des jeunes. Se vi semplicemente ne scias, kion viaj adresaroj estas, tiamtio estas bona kazo por Seita malkovro.';
...
$GLOBALS["lang"]['We hope you find Open-AudIT as useful as we do.'] = 'Ni esperas ke vi tropos Apri- Audit kiel utila kiel ni faras.';
...
$GLOBALS["lang"]['Website'] = 'Condividi su Facebook';
...
$GLOBALS["lang"]['What about other network devices? Think switches, routers, printers, etc. Obviously, it is best if you can provide some SNMP credentials for these devices. They only need <i>read-only</i> access. But if you do not want to do even that, there is nothing stopping you from running discovery, finding the devices, and making a rule or two to identify them (maybe use MAC Address prefix in combination with open ports, for example). You wont have much information, but you will know they are on the network, what they are, and when the last time they were seen was. You will also see if anything new appears on the network.'] = 'Kio prieliaj retaparatoj? C\'è una direttiva che riguarda la protezione dei lavoratori dipendenti. Ili nur bezonas <i>Legun</i> Aliron. Sed se vi volas fari e agenda ke, ekzistas nenio .esanta vin de prizorgado de eltrova.o, Trovante la aparatojn, kaj farante regulon a reguld du identgi ilin (eble uzi MAC Adresse prefikson en Kombinao kun malfermaj havenoj, ekzample). Vi havas multe da informatooj, sed vi cios ke ili estas sur la reto, kion ili estas, kaj kiam lalla tempo ili estis viditaj estis. Vi ankai vidos -Nova aperas sur la reto.';
...
$GLOBALS["lang"]['What is the type of this location. Allowable types held in <code>attributes</code> table.'] = 'Kio estas la speco de tiu loko. Pour plus d\'informazioni: <code>attributes</code> Tablo.';
...
$GLOBALS["lang"]['When creating a widget, if you select the <i>Advanced</i> button you will have the ability to upload your own custom SQL.'] = 'Voir la liste dei prodotti <i>Progresità Nom de la ville (facultatif, sans doute pas besoin de traduction)</i> Butono vi havos la kapablon al fleuti linnun propran kutimon SQL.';
...
$GLOBALS["lang"]['When we are converting an internally selected device to an object for the external system, what should the external data be. EG: integer, string, etc.'] = 'Kiam ni Transformas interna elektitan aparaton al objektto por la ekstera sistemo, kio devolus la eksteraj datenoj esti. Entjero, grinuro, ktp.';
...
$GLOBALS["lang"]['Which OS this benchmark applies to.'] = 'Kiu OS tiu kompanormo valideeeeerib por.';

$GLOBALS["lang"]['Which devices should Open-AudIT create from the external system (if any). Using All, None or a given Attribute.'] = 'Kiuj aparatoi Open- Audit krei de la ekstera sistemo (se entute). Uzante, neniu, epäilty Attributo.';
...
$GLOBALS["lang"]['Widgets are designed to be used on Dashboards. Enterprise users have complete freedom to create, update and delete widgets as required.'] = 'Vidinad estas dizajnita por esti uzita sur Dashboard. Impresa uzantoj havas komplettan decrecon por krei, liquidalisdatigi kaj forigi vidinad kiel postulat.';
...
$GLOBALS["lang"]['You can audit a remote machine without the using the actual Administrator account by creating a registry key. Create the below key on every machine to be audited and make sure the user credentials used is a member of the Administrators group.'] = 'Vi povas revizii maltraksiman ma diversainon sen la uzado de la fakta Administramento -kon kreante registro divertalosilon. Kreu la sub felosio ';
...
$GLOBALS["lang"]['You do not have the PHP SNMP extension installed. This extension is highly recommended.'] = 'L\'iniziativa «Obiettivo de cette» e la comunicazione. Tiu etendaoo estas tre remomendinda.';
...
$GLOBALS["lang"]['You may wish to have Active Directory or OpenLDAP authenticate your users, but not provide authorization. To do this, make sure <i>Use for Authentication</i> is set to Y and <i>Use for Roles</i> is set to N. The credentials will be validated by LDAP, but you will need to have the user already created and assigned Roles in Open-AudIT. This also <i>automatically</i> applies to'] = 'Vi povas deziri havi Aktivan Adresaron sur kaptlus OpenLDAP a skeptigi viajn uzantojn, sed ne disponigi apschon. Por farition, certigu <i>Uzo per Autentimiini</i> estas metita al Y kaj <i>Uzo por roloj</i> Estas metita al N. La akredita.oj estos konfirmitaj ad LDAP, sed vi bezonos havi la uzanton jam kreita kaj asignis Rolojn en Open- Audit. Anka <i>un kaptlus, et kaptlustatakse</i> aplikaa';
...
$GLOBALS["lang"]['You should not include the edited_by and edited_date fields. These will be automatically set.'] = 'Vi ne devus inkludi la redaktitan _ by- kaj redaktis _ datajn kampjn. Tiuj ottaa vastaan epäillyn.';

$GLOBALS["lang"]['You should only change the second sentence of text, the'] = 'L\'evoluzione della Comunità européenne';
...
$GLOBALS["lang"]['You should use only those tables that contain attributes you need. I usually use a left join. For example'] = 'Devus uzi nur tiujn tabelojn kiuj enhavas atentojn vi bezonas. Mi kutime uzas maldekstran ali liquidin. Ekzample';
...
$GLOBALS["lang"]['Your Licenses'] = 'C\'è la première fois que l\' la parle de la';
...
$GLOBALS["lang"]['Your Microsoft Azure Subscription ID.'] = 'ID descrizione de Microsoft Azure.';
...
$GLOBALS["lang"]['Your data is your data. You can extract it any time you like. We even helpfully provide exports to CSV, JSON and XML. And we have a JSON API. And you can write custom reports and have those output in CSV, XML, and JSON! Again, it is your data - not anyone else. You can be confident that the security of your data is in your hands.'] = 'Viaj datumoj estas viaj datumoj. Je ne sais pas. Il s \'agit de dispositions utiles dice que eksportojn al CSV, JSON kaj XML. API Ni Havas Json. C\'est ce qu \'on appelle "Kaj vi povas skribi kutimo raportoj kaj havi tiujn prodotto"... ojn en CSV, XML, kaj JSON! Denove, εi estas via datumo - ne u alias. Vi povas esti certa, ke la sekureco de viaj datumoj estas en viaj manoj.';
...
$GLOBALS["lang"]['Your description of this item.'] = 'Pari priskribo ';

$GLOBALS["lang"]['Your generic name for this piece of software'] = 'Via nomo por I tiu peco de programmaro';

$GLOBALS["lang"]['Your generic version for this piece of software'] = 'Via εenerala versio por Ciu tiu peco de programmaaro';
...
$GLOBALS["lang"]['Your user should now be able to logon by clicking the <i>Logon with OKTA</i> button on the Open-AudIT logon page. As mentioned above, if the logon fails, please check the logfile and verify the users <i>name</i>.<br><br>And that should be all there is too it. Now your users should have one less set of credentials to remember!<br><br>As always, if you have troubles with this feature, please email'] = 'Via uzanto apáca povas logo klaki la <i>Logon kun OKTA</i> Butono sur la Open- Audit - tunnuksenoplasiao. Kiel menciite supre, se la logo malsukcesas, bonvolu kontroli la tagdosieron kaj konfirmi la uzantojn <i>No.</i>.<br/><br/>Kaj tio devus esti. Nun viaj uzantoj devus havi unu malpli aron de akredita... oj por memori!<br/><br/>Kiel klaram, se vi havas problemojn kun ';
...
$GLOBALS["lang"]['active/active'] = 'importo in unità (reali)';

$GLOBALS["lang"]['active/passive'] = 'Aktiva / pasiva';

$GLOBALS["lang"]['advertisement'] = 'REKLAMO';

$GLOBALS["lang"]['alert'] = 'Atteggiamento';

$GLOBALS["lang"]['all'] = 'Che cosa?';
...
$GLOBALS["lang"]['and the final lines will likely be of most interest. These lines should give you the exact point at which the login failed.'] = 'La finaj linioj ver kindjne estos de plei multe de la intereso. Tiuj linioj devus doni al vi la prezan punkton Malsukcesis.';
...
$GLOBALS["lang"]['auto'] = 'kaptlustustoz';
...
$GLOBALS["lang"]['column. The'] = 'Kolono. La mia';
...
$GLOBALS["lang"]['database'] = 'Condividi su Google';

$GLOBALS["lang"]['debug'] = 'Silumiste';

$GLOBALS["lang"]['delegated'] = 'Delégita';
...
$GLOBALS["lang"]['details'] = 'Detaloj detaloj';
...
$GLOBALS["lang"]['does not equal'] = 'descrizione unità nelle liste';
...
Gravaj funkcioj kiuj devus esti reestigitaj rache sed povas havi iomete pli longan normalgtempon.
...
$GLOBALS["lang"]['first'] = 'Un\'altra volta';
...
$GLOBALS["lang"]['for this information.'] = 'C\'è un informatore.';
...
$GLOBALS["lang"]['google'] = 'Google Google Google Google';

$GLOBALS["lang"]['greater or equals'] = 'Pli grandaj a kahtlus egalaj';

$GLOBALS["lang"]['greater than'] = 'descrizione unità nelle liste';

$GLOBALS["lang"]['group'] = 'Grupo de grupo';

$GLOBALS["lang"]['has not been set'] = 'ne estis metita';

$GLOBALS["lang"]['have a working reverse DNS resolvable IP to the target Windows PC.'] = 'havas laboron inversa DNS- risolvebla IP al celo PC Windows.';

$GLOBALS["lang"]['have the ability to be executed. On the'] = 'Havas la kapablon esti efektivitita. La mia vita';
...
$GLOBALS["lang"]['is an international standard for managing information security. It provides a framework for establishing, implementing, maintaining, and continually improving an Information Security Management System (ISMS).'] = 'estas internationalcia normo por appropriaterado de informasekureco. ';
...
$GLOBALS["lang"]['licenses'] = 'I bambini';
...
$GLOBALS["lang"]['managed'] = 'L\'amministrazione';

$GLOBALS["lang"]['methods'] = 'Métado';
...
$GLOBALS["lang"]['not applicable'] = 'Necessura Nom de la ville (facultatif, sans doute pas besoin de traduction)';

$GLOBALS["lang"]['not in'] = 'Ne abbiamo bisogno.';

$GLOBALS["lang"]['not like'] = 'griaták';

$GLOBALS["lang"]['notice'] = 'Rimarko';

$GLOBALS["lang"]['notification'] = 'Nei luoghi di lavoro';

$GLOBALS["lang"]['okta'] = 'Okta';

$GLOBALS["lang"]['on devices where'] = 'Suggerimento';
...
$GLOBALS["lang"]['partition'] = 'Condividi su Google';

$GLOBALS["lang"]['pass'] = 'In questo modo';
...
$GLOBALS["lang"]['permissions required per endpoint'] = 'Permesoj postulitai per finpunkto';
...
$GLOBALS["lang"]['service failed to start due to the following error'] = 'servo di domens';
...
$GLOBALS["lang"]['starts with'] = 'Condividi su Google';
...
$GLOBALS["lang"]['top'] = 'Plej sopra pinto';
...
unassigned - The default until set.'] = ' Imitaefa sekreto - Armea / registara klasifiko. Divulgazione kaūs escete gravan danεeron al nacia sekureco.

Sekreto - Armea / registrara klasifiko. Divulgazione kaūs gravan difekton en nacia sekureco.

Konfenencivo - Armea / registro kaj Secteur privato- klasifiko. Datenoj kiuj estas konfidencaj inkludas komercsekretojn, intelektajn datenojn, apliki confermativo aoprogramman kodon, kajelijn datennojn kiuj povis grave afluenzi la organison se nealuctorizita rive okloazis. Datenoj sur tiu nivelo estus hasblaj nur al personaro en la organiso kies laborbezonoj, a. estas rekte rilatattaj al, la aliritaj datenoj. Aliro al konfidencaj datennoj kutime postulas apuron por
...
Sentema - Armea / registraro kaj Privatsektora klasifiko. Datenoj kiuj estas sentiemaj inkludas organizajn financajn informatojn kaj postulas ekstrajn iniciatojn certigi εian CIA kaj prezecon. Divulgazione povas damaεi la nacian sekurecon.

Publika - privata sektoro. Publikaj datenoj estas datenoj kiuj estas Ekzemploj de publikaj datennoj inkludas kiom indennitàj homoj laboras en la organiso kaj jion produktoj organiso produktas a vendas.
...
$GLOBALS["lang"]['update'] = 'descrizione unità nelle liste';

$GLOBALS["lang"]['uses the data collected from your devices and matches the software installed with the value provided, it counts the matches calculates how many licenses have been used and how many are left. It allows the use of wildcards on the <i>match string</i> field which matches the software.name attribute.'] = 'La datenoj koletitaj de viaj aparatoj kaj matrugaoj la programraro instalia kun la Valoro providoita, εi kalkulas la mat agendezojn kalkuli kiam multaj permesiloj estis utiligitaj kaj kiam utilej estas forlasitaj. Permesas la uzon de sova stablekartoj sur la <i>Situo de Kordoj</i> Kampo kiu konguas kun la programmaro. Nomo attribútum.';

$GLOBALS["lang"]['using the main menu items.'] = 'Urante ';

$GLOBALS["lang"]['valid'] = 'voimassa';

$GLOBALS["lang"]['version'] = 'Versioni delle versioni';

$GLOBALS["lang"]['virtualisation'] = 'Virtuali';

$GLOBALS["lang"]['warning'] = 'Averto';

$GLOBALS["lang"]['web'] = 'WEB WEB WEB WEB WEB WEB WEB WEB WEB WEB';

$GLOBALS["lang"]['with Local and Remote access permissions set.'] = 'Kun lokaj kaj Remote- aliro permesoj metis.';

$GLOBALS["lang"]['with devices::update permission.'] = 'C\'e\' piu\' moi. Isdatermeso.';

$GLOBALS["lang"]['with the Sign-On Redirect URI being'] = 'La Sign- Sur- imitaefo- Amba.o';

$GLOBALS["lang"]['with the intention of providing simple and intuitive access in a manner familiar to developers. In addition to this API, the web interface will use the same request format and supply some additional actions (eg: HTML forms for creating items).'] = 'Kun la intenco de disponigado de simplia kaj intuicia aliro en maniero konata al programmastoj. Aldone al tiu API, la interretinterfaco uzos la saman peti formaton kaj supézos kalkajn kromajn agojn (ekz. HTML- formuleroj por kreado de eroj).';
