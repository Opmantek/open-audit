...
<br>
See our page on enabling <a href="/index.php/faq?name=Running Open-AudIT Apache Service Under Windows">Running Open-AudIT Apache Service Under Windows</a></p>'] = '<p>..<br/><br/>Именно. Bu hesab uzaq (въК основа на мрежа) rekursuna daxil deyil. Именно.<br/><br/> да го направим, да го направим. <a href="/index.php/faq?name=Running Open-AudIT Apache Service Under Windows">. Apache големоглавеК</a></p>';
...
$GLOBALS["lang"]['<p>When using Regex for matching, a helpful page can be found on the <a href="https://www.php.net/manual/en/regexp.reference.meta.php" target="_blank"> PHP website</a>. Some differences to Perl Regex can be found <a href="https://www.php.net/manual/en/reference.pcre.pattern.differences.php" target="_blank">here</a>.</p>'] = '<p> Je to tak. <a href="https://www.php.net/manual/en/regexp.reference.meta.php" target="_blank"> PHP saytţnda</a>.. <a href="https://www.php.net/manual/en/reference.pcre.pattern.differences.php" target="_blank">- Да.</a>.</p>';
...
$GLOBALS["lang"]['A JSON array of objects matching the software name taken from the CVE, enriched with the software name retrieved by Open-AudIT.'] = 'CVE- dan alganan proqram adgam il... uyğun olaraq, Open- Audit t... r... find... n alganan proqram adgah uyğunlaşdşrīlmşdşr.';

$GLOBALS["lang"]['A JSON array of values to test for this vulnerability.'] = 'Bu boşluğu test üçün qiym... tl... r JSON sīra.';
...
$GLOBALS["lang"]['A JSON document containing the required attributes overriding the chosen discovery_scan_options.'] = 'Seçilmişm... lumat _ scan _ options üz... rind... lodenem olan xüsusiyyy... tl... ri olan JSON nümayişi.';
...
$GLOBALS["lang"]['A JSON object containing an array of attributes to change if the match occurs.'] = 'Mac meydana çţxţrsa, bir sţra xüsusiyyyyyy...';
...
$GLOBALS["lang"]['A Metropolitan area network (MAN) is a large computer network that usually spans a city or a large campus.'] = 'A Metropolitan sah... si (MAN) bir ş... h... r. v... ya böyük bir kampaniya yayşlmşşböyük kompüter ş... h... ridir.';
...
$GLOBALS["lang"]['A calculated field that displays the number of times this piece of software was found on the computers in the selected Org (and its descendants if configured).'] = 'Bu proqram nömr... sinin nömr... sini göst... rdiyi hesablanmşsah... si seçilmişOrg (ve onun qonaqlaror)';

$GLOBALS["lang"]['A campus area network (CAN) is made up of an interconnection of LANs within a limited geographical area. The networking equipment (switches, routers) and transmission media (optical fiber, copper plant, Cat5 cabling, etc.) are almost entirely owned by the campus tenant / owner (an enterprise, university, government, etc.).<br><br>For example, a university campus network is likely to link a variety of campus buildings to connect academic colleges or departments, the library, and student residence halls.'] = 'Bir kampaniya sah... si (CAN) müxt... lif cografi sah... sind... Je to tak?<br/><br/>Ünvan: Az... rbaycan Respublikasēn Prezidenti, Az... rbaycan Respublikaső, Az... rbaycan Respublikasēnīn Prezidenti, Az... rbaycan Respublikasīn Presidenti, Az... rbaycan Respublikasēnīnīn Prezidenti, Az... rbaycan Respublikasēn Prezidnti, Az... rbaycan Respublikasīnīn Prezidenti, Az... rbaycan Respublikīnīn Prezidenti, Azrbaycan Respublikasīn Prezidnti, Azrbayjan Respublikasīnīn Presīnti, Azzlīnti, Azzzlnti, Azrbaycan';
...
$GLOBALS["lang"]['A personal area network (PAN) is a computer network used for communication among computer and different information technological devices close to one person. Some examples of devices that are used in a PAN are personal computers, printers, fax machines, telephones, PDAs, scanners, and even video game consoles. A PAN may include wired and wireless devices. The reach of a PAN typically extends to 10 meters. A wired PAN is usually constructed with USB and FireWire connections while technologies such as Bluetooth and infrared communication typically form a wireless PAN.'] = 'Müxt голиК информации texnologiyalarħarasīnda kompüter v гон мО кст голмилим информации texnologiyalarħarasīnda Именно.';
...
$GLOBALS["lang"]['A vulnerability can be editied and more specific package names provided where the enrichment data is insufficient or the generated SQL is not quite correct.'] = 'Bir çatīşmazlişd... st... kl... ndirilmişv... daha xüsusi paketi adlarşnīd... st... kl... y... bil... r.';
...
$GLOBALS["lang"]['access_token'] = 'ДостъК до токен';

$GLOBALS["lang"]['Access Token'] = 'ДостъК до токен';
...
$GLOBALS["lang"]['All Queued Items'] = '"Трафлымхсулар"';
...
$GLOBALS["lang"]['Are you sure? This will remove all queue entries and prevent the remaining IPs from being discovered.'] = '.. Bu, bütün sşra girişl... ri aradan qaldşracaq v... qeyd edilmişIPs qarşsşnşalşr.';
...
$GLOBALS["lang"]['As we run Discoveries and collect device results we populate the list of networks. The Blessed Subnets feature uses this list of networks to only accept data from devices on those networks.'] = 'Happy Subnets xüsusiyyäti bu ş@@';
...
$GLOBALS["lang"]['best_practises'] = 'Nejlepší Pracktiss';

$GLOBALS["lang"]['Best Practises'] = 'Nejlepší Pracktiss';
...
$GLOBALS["lang"]['Bouvet Island (Bouvetoya)'] = '-';
...
$GLOBALS["lang"]['Browse down the tree to Console Root -> Component Services -> Computers -> My Computer<br><br>Right click on <i>My Computer</i> and select properties<br><br>Select the <i>Default Properties</i> tab'] = '..<br/><br/>. <i>- Да.</i> ..<br/><br/>Не, не, не. <i>.</i> подпрозореК';
...
$GLOBALS["lang"]['Chinese (traditional)'] = '-';

$GLOBALS["lang"]['Choose'] = '- Да.';

$GLOBALS["lang"]['Choose (select OS first)'] = '-';
...
$GLOBALS["lang"]['Click on App Registrations to create a new Application, then click New Application Registration. Give it a name (I used Open-AudIT), select Web app / API as the type and provide any URL (the URL is not important) and now click Create.'] = 'Yeni proqram yaratmaq üçün App Registrations basīn, sonra yeni Application Registration okuyun. Именно.';
...
$GLOBALS["lang"]['Click the Edit button for <i>Basic SAML Configuration</i>.'] = '.. <i>Základní SAML голота</i>.';
...
$GLOBALS["lang"]['Complexity of the attack (Low or High).'] = 'hücum Kompelksi (Aşagşv год. ya yüksk).';
...
$GLOBALS["lang"]['create_internal_from_external'] = 'Daxili yaradţlmasmanador. kgm';

$GLOBALS["lang"]['Create Internal From External'] = 'Daxili yaradţlmasmanador. kgm';
...
$GLOBALS["lang"]['Define the context of the organization (internal/external issues)'] = '-';
...
$GLOBALS["lang"]['Device Seed Discoveries are a good option if you know that your network consists of a range of subnets, but you are unsure what they are. Seed the discovery with a local router and watch your network unfold before your eyes.'] = 'Domen adņqeydiyyatdan keçirt ';
...
$GLOBALS["lang"]['Discovery Queue Count'] = 'AxtarşşQeydiyyat';
...
$GLOBALS["lang"]['Example Org Chart with Access'] = 'ДостъК до картата на Оря';
...
$GLOBALS["lang"]['Exclude TCP Ports'] = 'TCP porty';
...
$GLOBALS["lang"]['For <i>Type</i> make sure to select Baseline, and for Group you should select a Group of devices, if applicable to this baseline, that best represent the devices to apply the baseline against. This will prevent erroneous entries.'] = 'Axtarşş@@ <i>- Да.</i> Именно.';
...
$GLOBALS["lang"]['Go to the <i>Certificates and secrets</i> menu item under <i>Manage</i> in the center menu.'] = '.. <i>.</i> . <i>Qeydiyyat</i> - Ano.';
...
$GLOBALS["lang"]['hash'] = ' {\ cHFFFFFF} {\ cHFFFFFF}';
...
$GLOBALS["lang"]['How the vulnerability is exploited (e.g., Network, Adjacent, Local, Physical).'] = 'Qarşşq nec... istismar edilir (напр. Network, Additional, Local, Fizik).';
...
$GLOBALS["lang"]['IP Last Seen'] = 'IP syn viděn';
...
$GLOBALS["lang"]['If no value is present, supply this value. EG: for system.nmis_group / configuraion.group we use'] = ' год.: sistem üçün.nmis _ group / configuraion. Не, не.';
...
$GLOBALS["lang"]['If the Open-AudIT Server has Collectors reporting to it, an additional drop down is provided. You can select this to specify which Collector the task should run on. Only Discovery tasks are supported for Collectors.'] = 'Open- Audit Server \'n buraxdīşşkollektorlar varsa, гор dalla verilir. Именно.';
...
$GLOBALS["lang"]['If the following conditions are met:<br><ul><li>a Role has an assigned ad_group</li><li>an Org has an assigned ad_group</li><li>an LDAP Server has use_roles set to y</li><li>a user exists in LDAP (be it Active Directory or OpenLDAP) and is in the assigned ad_groups</li></ul>That user can log on to Open-AudIT without an account in Open-AudIT needing to be created. Open-AudIT will query the LDAP in question and if the user is in the required groups but not in Open-AudIT, their user attributes (name, full name, email,  roles, orgs, etc) within Open-AudIT will be automatically populated and they will be logged on.<br> <br>'] = '..<br/><ul><li>Rol ad _ group t по şkal edir</li><li>- Да.</li><li>- Да.</li><li>bir istifad... çi LDAP var (bu aktiv Directory v... ya OpenLDAP) v... verilmişad _ groups</li></ul>Именно.<br/> <br/>';

$GLOBALS["lang"]['If the local field is true (bool) or y (string) or Y (string) or 1 (integer) then set the external data to 1.'] = '- Да.';

$GLOBALS["lang"]['If the local field is true (bool) or y (string) or Y (string) or 1 (integer) then set the external data to y.'] = 'Yerli sah... sin doğru (bool) v... y y (string) v... y Y (estering) v... ya 1 (integer) olaraq xarici m... lumatrary y.';

$GLOBALS["lang"]['If the primary IP (as reported by the device) is in this subnet, pass.</li>'] = '.';

$GLOBALS["lang"]['If the user account does not actually exist within Open-AudIT and <code>use_authorisation</code> is set, the user will be created. If it does exist, details such as email, full name, etc will be populated.'] = ' Na druhou stranu. <code>use_authorisation</code> Именно.';
...
$GLOBALS["lang"]['In the (comma seperated) list'] = '(coma seperated) siyahşsņ@@';
...
$GLOBALS["lang"]['ip_audited_count'] = 'Ip Audited say';

$GLOBALS["lang"]['Ip Audited Count'] = 'Ip Audited say';
...
$GLOBALS["lang"]['nmis_name'] = 'Nmis AdoptusCity in California USA';

$GLOBALS["lang"]['Nmis Name'] = 'Nmis AdoptusCity in California USA';
...
$GLOBALS["lang"]['Note - Selecting a parent will automatically provide access to its children (although it wont be shown here).'] = 'Qeyd - Bir uşaq seçm... k avtomatik olaraq uşaqlarşna daxil ed... c... k (burada göst... rilm...';
...
$GLOBALS["lang"]['On the target Windows PC, run the DCOM utility and verify (or set) the below attributes. Start -> Run, Enter DCOMCNFG and press OK. This will open the DCOMCNFG window.'] = 'Windows PC haqqinda, DCOM faydalşçalşşr v... aşagşdakşxüsusiyyyyy... t... klif edir...';
...
$GLOBALS["lang"]['One of: antivirus, backup, firewall, approved, banned, ignored or other.'] = 'Biri: антивирус, поддръжка, защитна стена, t голя к... siz, göz...';
...
$GLOBALS["lang"]['Open-AudIT ships with inbuilt roles for admin, org_admin and user.<br><br>Generally, a user who is an administrator of the Open-AudIT application itself should have admin and possible org_admin roles.<br><br>A user can have multiple roles. The permission will be applied at the most permissive level - IE, if a user has the roles of user and org_admin, they will be able to create locations because org_admin grants this permission, even though the user role does not.<br><br>The admin role allows access to collections such as configuration, database, groups, ldap servers, logs, queries and roles. Global items that affect the entire application.<br><br>The org_admin role usually allows create, read, update and delete actions for any collection that contains the org_id column. Virtually all data except some of the collections mentioned above will contain an <code>org_id</code> column.<br><br>The user role generally allows read only access to all items with an org_id column.'] = 'Именно.<br/><br/>- Да.<br/><br/>Именно.<br/><br/>admin rol formasiya, baza, qruplar, ldap server, logs, sorgular v гол...<br/><br/>Org _ admin rolu........... Именно. <code>org_id</code> - Да.<br/><br/>..';

$GLOBALS["lang"]['Open-AudIT ships with inbuilt roles for admin, org_admin and user.<br><br>Generally, a user who is an administrator of the Open-AudIT application itself should have admin and possible org_admin roles.<br><br>A user can have multiple roles. The permission will be applied at the most permissive level - IE, if a user has the roles of user and org_admin, they will be able to create locations because org_admin grants this permission, even though the user role does not.<br><br>The admin role allows access to collections such as configuration, database, groups, ldap servers, logs, queries and roles. Global items that affect the entire application.<br><br>The org_admin role usually allows create, read, update and delete actions for any collection that contains the org_id column. Virtually all data except some of the collections mentioned above will contain an org_id column.<br><br>The user role generally allows read only access to all items with an org_id column.'] = 'Именно.<br/><br/>- Да.<br/><br/>Именно.<br/><br/>admin rol formasiya, baza, qruplar, ldap server, logs, sorgular v гол...<br/><br/>Org _ admin rolu........... Именно.<br/><br/>..';
...
$GLOBALS["lang"]['Report on your devices, networks and more'] = 'Sizin cihazlarín, ş... h... rl... r. v... daha çox';
...
$GLOBALS["lang"]['Retrieved from the device - Windows:Win32_ComputerSystemProduct, Linux:dmidecode, MacOS:system_profiler, ESXi:vim-cmd hostsvc/hostsummary, HP-UX:machinfo, Solaris:smbios, AIX:uname.'] = ' Retrieve: Win32 _ ComputerSystemProduct, Linux: dmidecode, MacOS: system _ profiler, ESXi: vim-cmd hostvc / hostsummary, HPUX -: machinfo, ';
...
$GLOBALS["lang"]['Running Open-AudIT Apache Service Under Windows'] = '. Apache големоглавеК';
...
$GLOBALS["lang"]['SQL not containing this condition will result in the widget failing to be executed.'] = 'Bu xidm. ed.n SQL, widget-da itra olunacacq.';
...
$GLOBALS["lang"]['Select the <i>COM Security</i> tab<br><br>Click on Access Permissions Edit Default'] = 'Не, не, не. <i>.</i> подпрозореК<br/><br/>Proqram';
...
$GLOBALS["lang"]['site_hours_b'] = 'Сайт SaatlarņB';

$GLOBALS["lang"]['Site Hours B'] = 'Сайт SaatlarņB';
...
$GLOBALS["lang"]['Sudo Password (optional)'] = '-';
...
$GLOBALS["lang"]['The Attributes endpoint allows you to add customized values to different attributes in Open-AudIT, at the moment this feature works on the Class, Environment, Status and Type attributes on Devices, the Type attribute for both Locations and Orgs as well as the Menu Category for Queries. If you view an item of one of the prvious types (say view a Lkocation) you will notice the Type attribute must be selected from a drop-down box. This is where those values are stored. Hence, if you would like to add a new Type to be chosen for a Location, add it using the Attributes feature.'] = 'Българактеристики крайна точка Open- Audit müxt... H.r.y.r.r.v., Orgs üçün Tip xüsusiyyyyy.tl.ri, h.mçi üçün Menkulator Kateqoriyasī. - Да.';
...
$GLOBALS["lang"]['The CVE has been marked as invalid or withdrawn in the CVE List. It remains in the NVD but is excluded from default search results.'] = 'CVE CVE siyahşsşqeyd olunmuşv го gieri alşnmşdşr. Bu NVD-da saxlayşr, lakin original axtarşşn... tic... l... ri Istina edilir.';
...
$GLOBALS["lang"]['The CVE is queued for enrichment by NVD analysts. No detailed metadata yet.'] = 'CVE NVD analitikl... ri t... r... find... n z... ng üçün smalangur.';
...
$GLOBALS["lang"]['The Executables feature scans the disk of a device as part of the audit and checks that every executable file is known to the package manager. Because it uses the package manager, the feature applies to Linux target devices only, and further than that, only rpm or deb based distributions. Anything Redhat or Debian based should work.'] = 'Изпълнители xüsusi procedur bir his... si kimi bir al... - Za prvé:';
...
$GLOBALS["lang"]['The JSON record from Mitre.'] = '-';
...
$GLOBALS["lang"]['The OpenSCAP project is a collection of open source tools for implementing and enforcing this standard, and has been awarded the SCAP 1.2 certification by NIST in 2014.'] = 'OpenSCAP laih... si bu standart t... NIST t прищракване на SCAP 1.2 sertifikatlaşdşrīlmşşdūr.';
...
$GLOBALS["lang"]['The Racks feature is used to manage and visualize your rack use with an Organisation, Location, Building, Floor, Room and Row.'] = 'Racks xüsusiyyyyyy... Да, Бина. Кат, Oda v год. Row il... d... st... k istifad...';

$GLOBALS["lang"]['The SCAP is a specification for expressing and manipulating security data in standardized ways. SCAP uses several individual specifications in concert to automate continuous monitoring, vulnerability management, and security policy compliance evaluation reporting'] = 'SCAP standartlaşdşrşlmşyollarla t голя к... sizliyi veril... nm... v... manipule etm... k üçün bir spesifikasiyadīr...';
...
$GLOBALS["lang"]['The address of the Open-AudIT server submit page.'] = 'Open- Audit сървър в ünvanņ@@';
...
$GLOBALS["lang"]['The attribute to test (must match an external field name from below).'] = 'Tesin xüsusiyyyyyy... (aşaşdan xarici bir sah... si adīil... eşl... yir).';
...
$GLOBALS["lang"]['The audit script will use the files[ ] array and retrieve the file details.'] = 'Audit script fayllarņistifad по-малко от [] mass v.';
...
$GLOBALS["lang"]['The current date in Y-m-d format.'] = 'Y- m- d formationşnda cari tarix.';
...
$GLOBALS["lang"]['The exploited vulnerability can affect resources beyond the security authority of the vulnerable component. This usually means a privilege or trust boundary is crossed (for example, escaping from a container to the host OS).'] = 'Не, не. Bu, bir imtiyaz v го я гом голиятт хаята keçirilir (örnegin, ev sahibi OS bir konteyner qarşsţnşalmq).';
...
$GLOBALS["lang"]['The group of devices on which the baseline was run against.'] = 'Bazalşn qarşşişl гон cyhazlar qrupu.';
...
$GLOBALS["lang"]['The importance of this baseline (not used yet).'] = 'Bu üslubunun говмилиии (heşistifad по етм...).';
...
$GLOBALS["lang"]['The name given to this user (used to login). Ideally it should be unique.'] = 'Bu istifad... çiy... verilmişadņ( girişetm... k üçün istifad... olunur)...';

$GLOBALS["lang"]['The name of the associated cloud (if required).'] = '.';

$GLOBALS["lang"]['The name of the software package, as audited by Open-AudIT. Use the percent sign % as a wildcard.'] = 'Open- Aud IT t гонят баксилан proqram paketinin adņ. - Да.';
...
$GLOBALS["lang"]['The only required permission / policy name (in our testing) is'] = 'Yalnīz lodenīm olan m';
...
$GLOBALS["lang"]['The recommended process of addressing and fixing identified security vulnerabilities. This typically involves applying patches, updates, or other measures to eliminate the risk posed by the vulnerabilities.'] = 'Müasir t голя к... sizlik açţqlarşnşqarşlaşdşrmaq v... qarşşlaşdma prosesi. Не, не.';
...
$GLOBALS["lang"]['The timestamp after which, this task should run. For example, run a task after the 1st June 2017 at 10am, set it to <code>2017-06-01 09:59:00</code>. This value should be zero padded (ie, 09, not 9). This value defaults to <code>2000-01-01 00:00:00</code> which means by default, a scheduled task will run at next scheduled execution time.'] = 'Sonrakşvaxtlar, bu qurgu işl год. 10: <code>2017-06-01 09:59:00</code>. Именно. <code>2000-01-01 00:00:00</code> Именно.';

$GLOBALS["lang"]['The top 10, 100 or 1000 (or none) TCP ports commonly in use according to Nmap.'] = 'ТоК 10, 100 v... 1000 (ya da heņbir) TCP portlarņNmap gör... istifad... olunur.';

$GLOBALS["lang"]['The top 10, 100 or 1000 (or none) UDP ports commonly in use according to Nmap.'] = 'ТоК 10, 100 v... 1000 (ya da heşbir) UDP portlarņNmap gör... istifad... olunur.';
...
$GLOBALS["lang"]['The unfiltered state means that a port is accessible, but Nmap is unable to determine whether it is open or closed. Only the ACK scan, which is used to map firewall rulesets, classifies ports into this state. Scanning unfiltered ports with other scan types such as Window scan, SYN scan, or FIN scan, may help resolve whether the port is open.'] = 'Нефилтриран dövl.t bir portun erişilebilir olduğu anlambhina gelir, lakin Nmap açīq v го qarşşlaşdīrmaq olacaq...';
...
$GLOBALS["lang"]['The web directory on the host that Open-AudIT is installed (requires a trailing slash).'] = 'Open- Audit- nin quraşdşrdşşşşiev sah... sind... web klassikaső (bir izl... şdirm...).';
...
$GLOBALS["lang"]['This description is auto-populated and should ideally be left as-is.'] = 'Bu tarif auto- populated v го compiеален olaraq sol olmalţdţr.';
...
$GLOBALS["lang"]['This example creates a list of devices where the Function or Description fields are blank OR the Purchase Date is the default.'] = 'Bu nümun... funksiya v... ya m... lumat sah... si boşolduğu v...';
...
$GLOBALS["lang"]['To actually execute the query, append a /execute, thus /open-audit/index.php/queries/{$id}/execute.'] = 'Sorğu icra etm год. üçün, proqram bir / екзекутират, bel го / open-одит / index.php / queries / {$id} / execute.';
...
$GLOBALS["lang"]['To view the details of a query, the standard URL structure of /open-audit/index.php/queries/{$id} should be used.'] = 'Bir sorgounun m... lumatlarīn, / open-одит / index standart URL strukturunu baxīn. fp / questions / {$id} istifad. olunmalīdīr.';
...
$GLOBALS["lang"]['uninstall'] = 'provincie Italy. kgm kgm';
...
$GLOBALS["lang"]['United States Minor Outlying Islands'] = 'Америка Бирлщшмим Штатлария';
...
$GLOBALS["lang"]['Use a <i>Sign-in method</i> of OIDC - OpenID Connect and an <i>Application Type</i> of Web Application. Click <i>Next</i>.'] = '- Да. <i>- Да.</i> OIDC - OpenID Connect v по Bir <i>- Да.</i> {\ cHFFFFFF} {\ cHFFFFFF} {\ cHFFFFFF} {\ cHFFFFFF} {\ cHFFFFFF} {\ cHFFFFFF} {\ cHFFFFFF} {\ cHFFFFFF} {\ cHFFFFFF} {\ cHFFFFFF} {\ cHFFFFFF} {\ cHFFFFFF} {\ cHFFFFFF} {\ cHFFFFFF} {\ cHFFFFFF} {\ cHFFFFFF} {\ cHFFFFFF} {\ cHFFFFFFFF} {\ cHFFFFFFFFFF} {\ cHFFFFFFFFFFFF} {\ cHFFFFFFFFFFFFFFFF} {\ cHFFFFFFFFFFFFFFFFFF} {\ cHFFFFFFFFFFFFFFFFFFFFFFFFFFFF} {\ cHFFFF} {\ cHFFFFFFFFFFFFFFFFFFFF} {\ cHFFFF} {\ cHFFFFFFFF} {\ cHFFFFAxtar <i>- Да.</i>.';
...
$GLOBALS["lang"]['Used when LDAP servers have been configured to populate a users details - this includes the Roles which they are assigned. If a user is in this LDAP group, they are assigned this role.'] = 'Именно. Bu LDAP qrupunda bir istifad... çi varsa, onlar bu rol q... buledilir.';

$GLOBALS["lang"]['Used when searching OpenLDAP to match a users uid to a groups members. Default of <code>memberUid</code>. Used by OpenLDAP only.'] = '- Да. <code>memberUid</code>Именно.';
...
$GLOBALS["lang"]['View Device'] = 'Cihaz axtarşş@@';
...
$GLOBALS["lang"]['WARNING - When creating a baseline using software policies, at present Centos and RedHat package the kernel using the names <i>kernel</i> and <i>kernel-devel</i>. There can be multiple packages with this name and different versions concurrently installed. Debian based distributions use names like <i>linux-image-3.13.0-24-generic</i>, note the version number is included in the package name. Because RedHat based operating systems use this format and subsequently have multiple identical package names with different versions we currently exclude <i>kernel</i> and <i>kernel-devel</i> from software policies. This may be addressed in a future update.'] = 'ВНИМАНИЯ- Proqram siyas.tl.rini istifad. etdiyiniz zaman, mövcud Centos v.... <i> Name</i> Qeydiyyat <i> Ядро-девел</i>. Именно. <i>Linux- image- 3.13.0-0- generikum</i>.. <i> Name</i> Qeydiyyat <i> Ядро-девел</i> ..';
...
$GLOBALS["lang"]['When requesting JSON, by default no limit is set. When requesting screen display, the limit is set to 1000 by default. This can be changed in the configuration. See the \\'] = 'JSON t... r... find... n ist... y... n, heglibir limit t... şkal edir. да го направим, да го направим.';

$GLOBALS["lang"]['When retrieve an external device, should we run discovery upon it?'] = '..';

$GLOBALS["lang"]['When running Open-AudIT on Windows the Apache service account must be that of a <i>regular</i> user (or the Administrator). This is because the <i>Local System</i> account normally used to run Apache has no access to any network resources. IE - We cannot use Apache when running as the Local System account account to copy the audit script to Windows PCs.'] = '(.) <i>Не, не, не.</i> ... <i>..</i> .. Domen adşqeydiyyatdan keçirt. IE - Biz Windows PCs одитен скрипт kopyalamaq üçün Yerli Sistem hesabņhesabņkimi çalşşr zaman Apache istifad.';
...
$GLOBALS["lang"]['wmi_fails'] = 'Wmi başarşsşz';

$GLOBALS["lang"]['Wmi Fails'] = 'Wmi başarşsşz';
...
$GLOBALS["lang"]['You can always run the Firstwave VM on your virtual infrastructure (ESX, Azure, et al). The Firstwave VM runs Debian linux and is free from OS licensing concerns and limitations. Or install on your own Linux distro of choice. We support Redhat 9, Ubuntu 20.04, 22.04 and 24.04 as well as Debian 11 and 12.'] = '(ESX, Azure, et al). "Llkwave VM", "Debian Linux çalşşr" срещия "OS lisenziya m... lumatlarşv... год.';
...
$GLOBALS["lang"]['Your Microsoft Azure Client Secret.'] = '-';
...
$GLOBALS["lang"]['in Inputs can have the following values.'] = 'Girişaşaşdşdakşqiym.tl. r. o';
