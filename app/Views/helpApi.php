...
foreach ($collections as $collection) {
    if (in_array($collection, ['baselines_policies', 'baselines_results', 'components', 'database', 'discovery_log', 'feeds', 'integrations_log', 'integrations_rules', 'logs', 'maps', 'nmis', 'rack_devices', 'sessions', 'support', 'chart', 'help', 'reports', 'search', 'errors'])) {
        continue;
    } else {
        $title = $collection;
