...
$intro = '<p>' . __('Tasks can be one of several distinct types: Baseline, Discovery, Report, Query, Summary or Collector.') . '</p>
    <br>
...
$body = '<h2>' . __('Notes') . '</h2>
<p>' . __('All tasks can be created the same in Windows and Linux. Tasks use the CRON method for scheduling execution.') . '<br>
<br>
Minute: (0-59)<br>
<br>
Hour: (0-23)<br>
...
Day of Week: (0-6)<br>
<br>
' . __('For a primer on cron, see this Wikipedia page') . ': <a href="https://en.wikipedia.org/wiki/Cron" target="_blank">https://en.wikipedia.org/wiki/Cron</a>.<br>
<br>
' . __('On the Tasks List page, click the <i>Add New</i> button to configure a task.') . '<br>
<br>
' . __('Choose the type of the task from the first drop down. This will configure the additional fields required depending on the type of task.') . '<br>
<br>
' . __('If the Open-AudIT Server has Collectors reporting to it, an additional drop down is provided. You can select this to specify which Collector the task should run on. Only Discovery tasks are supported for Collectors.') . '<br>
<br>

<h5>' . __('Baselines') . '</h5>
' . __('Once you have generated a Baseline Definition you can schedule it to be run against a specified group of devices.') . '
<br>
<br>
