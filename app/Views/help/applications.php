...
' . __('Applications have been revised in Open-AudIT 6.1.0 and will only improve.') . '</p>
    ...
    <p>Where a relationship is named <i>_external</i>, this is meant to indicate there is no entry in Open-AudIT for this item. It also may or may not be a part of the Organisation physically or contractually.</p>';
