...
<p>' . __('Any files found in this manner are stored in the \'executable\' table as per any other device component.') . '</p>

<p>' . __('This feature, because it has the ability to affect target devices more than usual must be manually enabled. To enable this feature, change the configuration item feature_executables to \'yes\'.') . '</p>';
...
<p>' . __('As the audit script uses bash, you can use the wildcard of * when you\'re defining directories and exclusions.') . '</p>';
