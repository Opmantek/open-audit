...
<ul class="list-group list-group-flush">
    <li class="list-group-item"><strong><?= __('NOTE') ?></strong> - <?= __('The below steps are not the fault of or unique to Open-AudIT and would affect <strong>any</strong> discovery application using remote WMI and/or Windows.') ?></li>
