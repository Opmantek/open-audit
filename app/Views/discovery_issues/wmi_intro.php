...
<p>Download the test_windows_client.vbs script directly <a href="/open-audit/index.php/util/test_windows_client">here</a>.<br>
<br />
...
<ul class="list-group list-group-flush">
    ...
    <li class="list-group-item">Start a web browser and go to <a href="/open-audit/index.php/util/test_windows_client">http://YOUR_SERVER/open-audit/index.php/util/test_windows_client</a>. Save the downloaded file.</li>
