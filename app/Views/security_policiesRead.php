                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-6">
                            ...
                            <?= read_field('fix_notes', $resource->fix_notes, $dictionary->columns->fix_notes, $update) ?>

                            <div class="row" style="padding-top:16px;">
                                <div class="offset-2 col-8" style="position:relative;">
                                    <label for="sql" class="form-label"><?= __('Notes') ?></label>
                                    <div class="input-group">
                                        <textarea class="form-control" rows="6" id="notes" name="notes" data-original-value="<?= $resource->notes ?>" disabled><?= html_entity_decode($resource->notes) ?></textarea>
                                        <?php if ($update) { ?>
                                    ...
                                    <div class="form-text form-help float-end" style="position: absolute; right: 0;" data-attribute="notes" data-dictionary="<?= $dictionary->columns->description ?>"><span><br></span></div>
                                </div>
                            </div>
                            ...
                            <div class="row" style="padding-top:16px;">
                                <div class="offset-2 col-8" style="position:relative;">
                                    ...
                                    <div class="input-group">
                                        <textarea class="form-control" rows="6" id="check" name="check" data-original-value="<?= $resource->check ?>" disabled><?= html_entity_decode($resource->check) ?></textarea>
                                        <?php if ($update) { ?>
                                        <div class="float-end" style="padding-left:4px;">
                                    ...
                                    <div class="form-text form-help float-end" style="position: absolute; right: 0;" data-attribute="check" data-dictionary="<?= $dictionary->columns->description ?>"><span><br></span></div>
                                </div>
                            </div>
                            ...
                            <div class="row" style="padding-top:16px;">
                                <div class="offset-2 col-8" style="position:relative;">
                                    ...
                                    <div class="input-group">
                                        <textarea class="form-control" rows="6" id="commands" name="commands" data-original-value="<?= $resource->commands ?>" disabled><?= html_entity_decode($resource->commands) ?></textarea>
                                        <?php if ($update) { ?>
                                        <div class="float-end" style="padding-left:4px;">
                                    ...
                                    <div class="form-text form-help float-end" style="position: absolute; right: 0;" data-attribute="commands" data-dictionary="<?= $dictionary->columns->description ?>"><span><br></span></div>
                                </div>
                            </div>
