                        ...
                        <div class="col-md-6">
                            <div class="offset-2 col-8">
                                ...
                                <?php if (!empty($dictionary->columns)) { ?>
                                    <?php $fields = array('name', 'org_id', 'type', 'ssh', 'wmi', 'snmp') ?>
...
window.onload = function () {
    $(document).ready(function () {
        ...
        var $microsoft = '<?= create_text_field('data[attributes][credentials][subscription_id]', __('Subscription ID'), $dictionary->attributes->create) ?><?= create_text_field('data[attributes][credentials][tenant_id]', __('Tenant ID'), $dictionary->attributes->create) ?><?= create_text_field('data[attributes][credentials][client_id]', __('Client ID'), $dictionary->attributes->create) ?><?= create_text_field('data[attributes][credentials][client_secret]', __('Client Secret'), $dictionary->attributes->create) ?>';
