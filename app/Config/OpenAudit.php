...
{
    # leave for backwards compat $this->displayVersion = '6.0.1';
    public string $displayVersion = '6.0.1';
    public int $appVersion = 20251130;
    ...
    public string $feature_vulnerabilities_alert_date;
