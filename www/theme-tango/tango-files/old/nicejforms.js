...
jQuery.NiceJForms = {
	options : {
		...
		imagesPath               : "/oa/system/application/views/files/css/images/default/"
		// other options here
	},
	...
	build : function(options)
	{
		...
		// TODO - below is a hack to stop validator error. file not found.
		// not sure what to do - image appears not to be needed ?
